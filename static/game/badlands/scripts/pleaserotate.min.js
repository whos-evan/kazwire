...
!(function () {
	...
	function b(a) {
		document.documentElement &&
			...
			(document.documentElement.className += ' pleaserotate-' + a));
	}
	function c(a) {
		var b;
		for (b = 0; b < p.length; b++) a.insertRule(p[b], 0);
		for (
			a.insertRule('#pleaserotate-backdrop { z-index: ' + o.zIndex + '}', 0),
				o.allowClickBypass && a.insertRule('#pleaserotate-backdrop { cursor: pointer }', 0),
				o.forcePortrait &&
					a.insertRule('#pleaserotate-backdrop { -webkit-transform-origin: 50% }', 0),
				b = 0;
			b < q.length;
			b++
		)
			CSSRule.WEBKIT_KEYFRAMES_RULE
				? a.insertRule('@-webkit-keyframes ' + q[b], 0)
				: CSSRule.MOZ_KEYFRAMES_RULE
				? a.insertRule('@-moz-keyframes ' + q[b], 0)
				: CSSRule.KEYFRAMES_RULE && a.insertRule('@keyframes ' + q[b], 0);
	}
	function d() {
	...
	function e() {
		...
		a.setAttribute('id', 'pleaserotate-backdrop'),
			b.setAttribute('id', 'pleaserotate-container'),
			c.setAttribute('id', 'pleaserotate-message'),
			a.appendChild(b),
			b.appendChild(null !== o.iconNode ? o.iconNode : f()),
			b.appendChild(c),
			c.appendChild(document.createTextNode(o.message)),
			d.appendChild(document.createTextNode(o.subMessage)),
			c.appendChild(d),
	...
	function h() {
		var a,
			c = (l && !o.forcePortrait) || (!l && o.forcePortrait);
		c ? ((a = o.onShow()), b('showing')) : ((a = o.onHide()), b('hiding')),
			(void 0 === a || a) && ((k.Showing = c), g(c));
	}
	function i() {
		return window.innerWidth < window.innerHeight;
	}
	function j() {
		return !m && o.onlyMobile
			? void (n || ((n = !0), g(!1), b('hiding'), o.onHide()))
			: void (l !== i() && ((l = i()), h()));
	}
	var k = {},
		l = null,
	...
	(k.start = function (c) {
		...
		(k.onShow = function (a) {
			(o.onShow = a), n && ((n = !1), (l = null), j());
		}),
		(k.onHide = function (a) {
			(o.onHide = a), n && ((l = null), (n = !1), j());
		}),
		(k.Showing = !1),
		'function' == typeof define && define.amd
			...
			? (b('initialized'), (module.exports = k))
			: (b('initialized'),
			  (window.PleaseRotate = k),
			  a(window.PleaseRotateOptions),
