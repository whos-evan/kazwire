...
})(
  {
        ...
        e.exports = function (n, e) {
          ...
          return (f[n] =
            ...
            !l(function () {
              if (r && !a) return !0;
              var n = { length: -1 };
              r ? u(n, 1, { enumerable: !0, get: s }) : (n[1] = 1),
                t.call(n, i, o);
            }));
        };
      },
      ...
      function (n, e, t) {
        ...
        (e.exports = function (n, e, t, r, i) {
          ...
          if (i) o = n;
            ...
            if ("function" != typeof (s = h(n)))
              throw TypeError("Target is not iterable");
            if (g(s)) {
              for (a = 0, l = b(n.length); a < l; a++)
                if (
                  (c = r ? p(v((f = n[a]))[0], f[1]) : p(n[a])) &&
                  c instanceof d
                )
                  return c;
              return new d(!1);
    ...
    63: [
      function (n, e, t) {
        ...
        e.exports = function (n, e, t) {
          n &&
            !i((n = t ? n : n.prototype), o) &&
            r(n, o, { configurable: !0, value: e });
        };
      },
      {
        "../internals/has": 27,
    ...
    73: [
      function (n, e, t) {
        ...
        e.exports = function (n, e) {
          if (!i(n)) return n;
          var t, r;
          if (e && "function" == typeof (t = n.toString) && !i((r = t.call(n))))
            return r;
          if ("function" == typeof (t = n.valueOf) && !i((r = t.call(n))))
            return r;
          if (
            !e &&
    ...
    77: [
      function (n, e, t) {
        ...
        e.exports = function (n) {
          return (
            o(c, n) ||
              (a && o(u, n) ? (c[n] = u[n]) : (c[n] = f("Symbol." + n))),
            c[n]
          );
        };
      },
          ...
          { target: "Array", proto: !0, forced: !a || !l },
          {
            slice: function (n, e) {
              ...
              if (
                ...
                return b.call(o, a, l);
              for (
                r = new (void 0 === t ? Array : t)(y(l - a, 0)), i = 0;
                a < l;
                a++, i++
              )
                a in o && v(r, i, o[a]);
      ...
      function (n, e, t) {
        ...
        function i(n, e, t) {
          ...
          Z
            ...
            (i = d["on" + n])
              ? i(r)
              : n === $ && C("Unhandled promise rejection", t);
        }
        function s(e, t, r, i) {
          return function (n) {
            e(t, r, n, i);
      ...
      function (n, e, t) {
        ...
        function a(n, e, t, r) {
          (o = t),
            ...
            window.parent.postMessage(
              { message: "hook", event: n, payload: e },
              "*"
            );
        }
        var l = {
        ...
        var c = {
          ...
          updateLevel: function (n) {
            window.parent.postMessage(
              { message: "updateLevel", level: n },
              "*"
            );
          },
          updateScore: function (n) {
            window.parent.postMessage(
              { message: "updateScore", score: n },
              "*"
            );
          },
          hook: a,
          ping: function (n, e) {
            window.parent.postMessage(
              { message: "ping", event: n, payload: e },
              "*"
            );
          },
          rewardAd: function () {
        ...
        window.addEventListener("message", function (n) {
          ...
          "pause" === t
            ...
            : "hookFail" === t &&
              (s(e.payload), (o = function () {}), (s = function () {}));
        }),
          (window.GamePix = c);
      },
      {
