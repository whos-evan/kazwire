...
})(
  {
    ...
    8: [
      function (e, t, n) {
        ...
        function f(e, t, n, r, i, o) {
          ...
          for (
            var l = L(s.buffer).bytes, c = a + s.byteOffset, u = r(+i), f = 0;
            f < t;
            f++
          )
            l[c + f] = u[o ? f : t - f - 1];
        ...
        if (d) {
          ...
          (G = function (e) {
            g(this, G, R);
            var t = j(e);
            I(this, { bytes: k.call(new Array(t), 0), byteLength: t }),
              y || (this.byteLength = t);
          }),
            (D = function (e, t, n) {
              g(this, D, P), g(e, G, P);
            ...
            b(D[M], {
              ...
              getUint32: function (e, t) {
                return (
                  a(u(this, 4, e, 1 < arguments.length ? t : void 0)) >>> 0
                );
              },
      ...
      function (e, t, n) {
        ...
        t.exports = function (e, t, n) {
          var r,
            ...
            h = 0;
          if (
            (y && (p = b(p, 2 < f ? n : void 0, 2)),
            null == d || (u == Array && m(d)))
          )
            for (i = new u((r = w(c.length))); h < r; h++)
              (l = y ? p(c[h], h) : c[h]), j(i, h, l);
          else
            for (
              s = (a = d.call(c)).next, i = new u();
              !(o = s.call(a)).done;
              h++
            )
        ...
        t.exports = y
          ? function (e, t) {
              ...
              var n = o(this),
                ...
                i = r - 1;
              for (
                1 < arguments.length && (i = l(i, a(t))), i < 0 && (i = r + i);
                0 <= i;
                i--
              )
          ...
          if (
            (b &&
              ...
              k !== Object.prototype &&
                ...
                (T ||
                  w(l) === k ||
                  (j ? j(l, k) : "function" != typeof l[_] && A(l, _, v)),
                x(l, f, !0, !0),
                T && (S[f] = v))),
            i == L &&
              d &&
            ...
            if (
              ((c = { values: s(L), keys: o ? h : s("keys"), entries: s(I) }),
              a)
            )
      ...
      function (e, t, n) {
        ...
        (t.exports = function (e, t, n, r, i) {
          ...
          if (i) o = e;
            ...
            if ("function" != typeof (a = g(e)))
              throw TypeError("Target is not iterable");
            if (h(a)) {
              for (s = 0, l = b(e.length); s < l; s++)
                if (
                  (c = r ? p(d((f = e[s]))[0], f[1]) : p(e[s])) &&
                  c instanceof y
                )
                  return c;
              return new y(!1);
          ...
          for (u = o.next; !(f = u.call(o)).done; )
            if (
              "object" == typeof (c = m(o, p, f.value, r)) &&
              c &&
              c instanceof y
            )
              return c;
        ...
        (c[h] = !0),
          (t.exports =
            ...
            function (e, t) {
              ...
              return (
                null !== e
                  ? ((r[y] = a(e)), (n = new r()), (r[y] = null), (n[h] = e))
                  : (n = b()),
                void 0 === t ? n : s(n, t)
              );
            });
    ...
    112: [
      function (e, t, n) {
        "use strict";
        function d(e, t) {
          for (var n = 0, r = t.length, i = new (z(e))(r); n < r; )
            i[n] = t[n++];
          return i;
        }
        function r(e, t) {
        ...
        function i(e, t) {
          return (
            X(e) && "symbol" != typeof t && t in e && String(+t) == String(t)
          );
        }
        function o(e, t) {
            ...
            (t.exports = function (e, t, o) {
              function u(e, i) {
                G(e, i, {
                  get: function () {
                    return (
                      (e = i), (t = N(this)).view[n](e * f + t.byteOffset, !0)
                    );
                    var e, t;
                  },
                  set: function (e) {
      ...
      function (e, t, n) {
        ...
        t.exports = function (e, t, n) {
          var r,
            ...
            y = b(c);
          if (null != y && !v(y))
            for (l = (s = y.call(c)).next, c = []; !(a = l.call(s)).done; )
              c.push(a.value);
          for (
            p && 2 < u && (f = g(f, n, 2)),
              i = h(c.length),
        ...
        r(
          {
            target: "Array",
            stat: !0,
            forced: !e("../internals/check-correctness-of-iteration")(function (
              e
            ) {
              Array.from(e);
            }),
          ...
          { target: "Array", proto: !0, forced: !s || !l },
          {
            slice: function (e, t) {
              ...
              if (
                ...
                return b.call(o, s, l);
              for (
                r = new (void 0 === n ? Array : n)(v(l - s, 0)), i = 0;
                s < l;
                s++, i++
              )
                s in o && d(r, i, o[s]);
      ...
      function (e, t, n) {
        ...
        function i(e, t, n) {
          ...
          Q
            ...
            (i = y["on" + e])
              ? i(r)
              : e === Z && R("Unhandled promise rejection", n);
        }
        function a(t, n, r, i) {
          return function (e) {
            t(n, r, e, i);
    ...
    139: [
      function (e, t, n) {
        ...
        function i(e, t) {
          var n = (ne[e] = A($[Y]));
          return (
            z(n, { type: B, tag: e, description: t }),
            f || (n.description = t),
            n
          );
        }
        ...
        function o(e, t) {
          ...
          if (n !== J || !h(ne, r) || h(re, r)) {
            var i = Q(n, r);
            return (
              !i || !h(ne, r) || (h(n, H) && n[H][r]) || (i.enumerable = !0), i
            );
          }
        }
        function a(e) {
        ...
        var s = e("../internals/export"),
          ...
          pe = function (e) {
            ...
            return (
              ...
              (!(n || !h(this, t) || !h(ne, t) || (h(this, H) && this[H][t])) ||
                n)
            );
          },
          ye = function (e) {
              ...
              (c._invoke =
                ...
                function (e, t) {
                  ...
                  for (s.method = e, s.arg = t; ; ) {
                    ...
                    "throw" === i.type &&
                      ((l = b), (s.method = "throw"), (s.arg = i.arg));
                  }
                })),
              c
            );
                          ...
                          return new Promise(function (e, t) {
                            ...
                            (n.responseType = "text"),
                              ...
                              n.addEventListener(
                                ...
                                function () {
                                  t(
                                    new Error("HTTP GET canceled for url " + r)
                                  );
                                },
                                !1
                              ),
                              ...
                              return regeneratorRuntime.wrap(function (e) {
                                for (;;)
                                  switch ((e.prev = e.next)) {
                                    ...
                                    case 3:
                                      return (
                                        (n = e.sent), (e.next = 6), c(n.url)
                                      );
                                    case 6:
                                      if (
                                        ((r = e.sent), n.close(), r.runtimes)
                                      ) {
                                        e.next = 11;
                                        break;
                                      }
                                      throw new Error(
                                        "Can't find runtimes property in gpx.json"
                                      );
                                    case 11:
                                      if ((i = r.runtimes.web)) {
                                        e.next = 14;
                                      ...
                                      throw new Error(
                                        "Game bundle is not for web sdk"
                                      );
                                    case 14:
                ...
                return (
                  "webgl" === t[0] &&
                    ...
                    i.forEach(function (e) {
                      !0 === u[e]
                        ? console.warn(
                            "WARN! Removing blacklisted extension",
                            e
                          )
                        : r.push(e);
                    }),
                    ...
                    l &&
                      ...
                      ((d = o).bindTexture = (function (n) {
                        return function (e, t) {
                          return (
                            e === d.TEXTURE_2D && (b.activeTexture = t), n(e, t)
                          );
                        };
