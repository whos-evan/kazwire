(function (scope) {
		...
		(function (e, n) {
			...
			i.Hasher = l.extend({
				...
				_createHmacHelper: function (e) {
					return function (n, t) {
						return new f.HMAC.init(e, t).finalize(n);
					};
				}
			});
			var f = (t.algo = {});
	...
	!(function (e) {
		for (
			...
			d && (8 > c && (s[c] = a(e.pow(u, 0.5))), (o[c] = a(e.pow(u, 1 / 3))), c++), u++;
		}
		var v = [],
			t = (t.SHA256 = r.extend({
				_doReset: function () {
	...
	!(function (e) {
		...
		!(function (e) {
			!(function (e) {
				(e[(e.Undefined = 0)] = 'Undefined'), (e[(e.Rejected = 1)] = 'Rejected');
		...
		!(function (n) {
			var t = e.logging.GALogger,
				...
				s = (function () {
					function n() {}
					return (
						(n.validateBusinessEvent = function (e, i, r, s, o) {
							return n.validateCurrency(e)
						...
						(n.validateResourceEvent = function (i, s, o, a, u, c, d) {
							return i == e.EGAResourceFlowType.Undefined
								? (t.i('Validation fail - resource event - flowType: Invalid flow type.'), !1)
								: s
								? r.stringArrayContainsString(c, s)
										...
										? a
											? n.validateEventPartLength(a, !1)
												...
												: (t.i(
												  ...
												  !1)
											: (t.i('Validation fail - resource event - itemType: Cannot be (null)'), !1)
										: (t.i(
									...
									: (t.i(
									  ...
									  !1)
								: (t.i('Validation fail - resource event - currency: Cannot be (null)'), !1);
						}),
						(n.validateProgressionEvent = function (i, r, s, o) {
							if (i == e.EGAProgressionStatus.Undefined)
								return t.i('Validation fail - progression event: Invalid progression status.'), !1;
							if (o && !s && r)
								return (
									t.i(
						...
						(n.validateDesignEvent = function (e, i) {
							return n.validateEventIdLength(e)
						...
						(n.validateErrorEvent = function (i, r) {
							return i == e.EGAErrorSeverity.Undefined
								? (t.i('Validation fail - error event - severity: Severity was unsupported value.'),
								  !1)
						...
						(n.validateSdkErrorEvent = function (e, r, s) {
							return (
								!!n.validateKeys(e, r) &&
								(s !== i.Undefined ||
									(t.i('Validation fail - sdk error event - type: Type was unsupported value.'),
									!1))
							);
						}),
						(n.validateKeys = function (e, n) {
							return !(!r.stringMatch(e, /^[A-z0-9]{32}$/) || !r.stringMatch(n, /^[A-z0-9]{40}$/));
						}),
						...
						(n.validateAndCleanInitRequestResponse = function (e) {
							if (null == e)
								return t.w('validateInitRequestResponse failed - no response dictionary.'), null;
							var n = {};
							try {
								n.enabled = e.enabled;
							} catch (e) {
								return (
									t.w("validateInitRequestResponse failed - invalid type in 'enabled' field."), null
								);
							}
							try {
								var i = e.server_ts;
								if (!(i > 0))
									return (
										t.w("validateInitRequestResponse failed - invalid value in 'server_ts' field."),
										null
									);
								n.server_ts = i;
							} catch (n) {
						...
						(n.validateDimension01 = function (e, n) {
							return !e || !!r.stringArrayContainsString(n, e);
						}),
						...
						(n.validateArrayOfStrings = function (e, n, i, r, s) {
							var o = r;
							if ((o || (o = 'Array'), !s))
								return t.i(o + ' validation failed: array cannot be null. '), !1;
							if (0 == i && 0 == s.length)
								return t.i(o + ' validation failed: array cannot be empty. '), !1;
							if (e > 0 && s.length > e)
								return (
									t.i(
										o +
						...
						(n.validateGender = function (n) {
							if (isNaN(Number(e.EGAGender[n]))) {
								if (
									...
									return (
										t.i("Validation fail - gender: Has to be 'male' or 'female'. Was: " + n), !1
									);
							} else if (
								n == e.EGAGender[e.EGAGender.Undefined] ||
								(n != e.EGAGender[e.EGAGender.Male] && n != e.EGAGender[e.EGAGender.Female])
							)
								return t.i("Validation fail - gender: Has to be 'male' or 'female'. Was: " + n), !1;
							return !0;
						}),
						(n.validateBirthyear = function (e) {
							return (
								!(e < 0 || e > 9999) ||
								(t.i('Validation fail - birthYear: Cannot be (null) or invalid range.'), !1)
							);
						}),
				...
				return (
					...
					(e.getBrowserVersionString = function () {
						...
						if (/trident/i.test(t[1]))
							return (e = /\brv[ :]+(\d+)/g.exec(n) || []), 'IE ' + (e[1] || '');
						if ('Chrome' === t[1] && null != (e = n.match(/\b(OPR|Edge|UBrowser)\/(\d+)/)))
							return e
								.slice(1)
								.join(' ')
								.replace('OPR', 'Opera')
			...
			var s = (function () {
				...
				return (
					...
					(e.isStoreTooLargeForEvents = function () {
						return (
							e.instance.eventsStore.length + e.instance.sessionsStore.length > e.MaxNumberOfEntries
						);
					}),
					...
					(e.save = function () {
						if (!e.isStorageAvailable()) return void i.w('Storage is not available, cannot save.');
					...
					(e.load = function () {
						if (!e.isStorageAvailable()) return void i.w('Storage is not available, cannot load.');
						try {
		...
		!(function (n) {
			var t = e.validators.GAValidator,
				...
				c = (function () {
					...
					return (
						(n.setUserId = function (e) {
							(n.instance.userId = e), n.cacheIdentifier();
						}),
						(n.getIdentifier = function () {
							return n.instance.identifier;
						}),
						(n.isInitialized = function () {
							return n.instance.initialized;
						}),
						(n.setInitialized = function (e) {
							n.instance.initialized = e;
						}),
						(n.getSessionStart = function () {
							return n.instance.sessionStart;
						}),
						(n.getSessionNum = function () {
							return n.instance.sessionNum;
						}),
						(n.getTransactionNum = function () {
							return n.instance.transactionNum;
						}),
						(n.getSessionId = function () {
							return n.instance.sessionId;
						}),
						(n.getCurrentCustomDimension01 = function () {
							return n.instance.currentCustomDimension01;
						}),
						(n.getCurrentCustomDimension02 = function () {
							return n.instance.currentCustomDimension02;
						}),
						(n.getCurrentCustomDimension03 = function () {
							return n.instance.currentCustomDimension03;
						}),
						(n.getGameKey = function () {
							return n.instance.gameKey;
						}),
						(n.getGameSecret = function () {
							return n.instance.gameSecret;
						}),
						(n.getAvailableCustomDimensions01 = function () {
							return n.instance.availableCustomDimensions01;
						}),
						(n.setAvailableCustomDimensions01 = function (e) {
							t.validateCustomDimensions(e) &&
								((n.instance.availableCustomDimensions01 = e),
								n.validateAndFixCurrentDimensions(),
								r.i(
									'Set available custom01 dimension values: (' + i.joinStringArray(e, ', ') + ')'
								));
						}),
						(n.getAvailableCustomDimensions02 = function () {
							return n.instance.availableCustomDimensions02;
						}),
						(n.setAvailableCustomDimensions02 = function (e) {
							t.validateCustomDimensions(e) &&
								((n.instance.availableCustomDimensions02 = e),
								n.validateAndFixCurrentDimensions(),
								r.i(
									'Set available custom02 dimension values: (' + i.joinStringArray(e, ', ') + ')'
								));
						}),
						(n.getAvailableCustomDimensions03 = function () {
							return n.instance.availableCustomDimensions03;
						}),
						(n.setAvailableCustomDimensions03 = function (e) {
							t.validateCustomDimensions(e) &&
								((n.instance.availableCustomDimensions03 = e),
								n.validateAndFixCurrentDimensions(),
								r.i(
									'Set available custom03 dimension values: (' + i.joinStringArray(e, ', ') + ')'
								));
						}),
						(n.getAvailableResourceCurrencies = function () {
							return n.instance.availableResourceCurrencies;
						}),
						(n.setAvailableResourceCurrencies = function (e) {
							t.validateResourceCurrencies(e) &&
								((n.instance.availableResourceCurrencies = e),
								r.i('Set available resource currencies: (' + i.joinStringArray(e, ', ') + ')'));
						}),
						(n.getAvailableResourceItemTypes = function () {
							return n.instance.availableResourceItemTypes;
						}),
						(n.setAvailableResourceItemTypes = function (e) {
							t.validateResourceItemTypes(e) &&
								((n.instance.availableResourceItemTypes = e),
								r.i('Set available resource item types: (' + i.joinStringArray(e, ', ') + ')'));
						}),
						(n.getBuild = function () {
							return n.instance.build;
						}),
						(n.setBuild = function (e) {
							(n.instance.build = e), r.i('Set build version: ' + e);
						}),
						(n.getUseManualSessionHandling = function () {
							return n.instance.useManualSessionHandling;
						}),
						(n.prototype.setDefaultId = function (e) {
							(this.defaultUserId = e || ''), n.cacheIdentifier();
						}),
						(n.getDefaultId = function () {
							return n.instance.defaultUserId;
						}),
						(n.getSdkConfig = function () {
							var e,
								t = 0;
						...
						(n.setBirthYear = function (e) {
							(n.instance.birthYear = e),
								s.setItem(n.BirthYearKey, e.toString()),
								r.i('Set birth year: ' + e);
						}),
						(n.incrementSessionNum = function () {
							var e = n.getSessionNum() + 1;
							n.instance.sessionNum = e;
						}),
						(n.incrementTransactionNum = function () {
							var e = n.getTransactionNum() + 1;
							n.instance.transactionNum = e;
						}),
						(n.incrementProgressionTries = function (e) {
							var t = n.getProgressionTries(e) + 1;
							n.instance.progressionTries[e] = t;
							var i = {};
							(i.progression = e), (i.tries = t), s.insert(a.Progression, i, !0, 'progression');
						}),
						(n.getProgressionTries = function (e) {
							return e in n.instance.progressionTries ? n.instance.progressionTries[e] : 0;
						}),
						(n.clearProgressionTries = function (e) {
							e in n.instance.progressionTries && delete n.instance.progressionTries[e];
							var t = [];
							t.push(['progression', u.Equal, e]), s.delete(a.Progression, t);
						}),
						(n.setKeys = function (e, t) {
							(n.instance.gameKey = e), (n.instance.gameSecret = t);
						}),
						(n.setManualSessionHandling = function (e) {
							(n.instance.useManualSessionHandling = e), r.i('Use manual session handling: ' + e);
						}),
						(n.getEventAnnotations = function () {
							var e = {};
							(e.v = 2),
							...
							return (
								...
								n.instance.facebookId && (e[n.FacebookIdKey] = n.instance.facebookId),
								n.instance.gender && (e[n.GenderKey] = n.instance.gender),
								0 != n.instance.birthYear && (e[n.BirthYearKey] = n.instance.birthYear),
								e
							);
						}),
						(n.getSdkErrorEventAnnotations = function () {
							var e = {};
							(e.v = 2),
						...
						(n.getClientTsAdjusted = function () {
							var e = i.timeIntervalSince1970(),
								r = e + n.instance.clientServerTimeOffset;
							return t.validateClientTs(r) ? r : e;
						}),
						(n.sessionIsStarted = function () {
							return 0 != n.instance.sessionStart;
						}),
						(n.cacheIdentifier = function () {
							n.instance.userId
								? (n.instance.identifier = n.instance.userId)
								: n.instance.defaultUserId && (n.instance.identifier = n.instance.defaultUserId);
						}),
						(n.ensurePersistedStates = function () {
							...
							e.setDefaultId(
								...
								(e.sessionNum =
									null != s.getItem(n.SessionNumKey) ? Number(s.getItem(n.SessionNumKey)) : 0),
								(e.transactionNum =
								...
								e.facebookId
									...
									: ((e.facebookId =
											null != s.getItem(n.FacebookIdKey) ? s.getItem(n.FacebookIdKey) : ''),
									  e.facebookId),
								e.gender
									? s.setItem(n.GenderKey, e.gender)
									: ((e.gender = null != s.getItem(n.GenderKey) ? s.getItem(n.GenderKey) : ''),
									  e.gender),
								e.birthYear && 0 != e.birthYear
									? s.setItem(n.BirthYearKey, e.birthYear.toString())
									: ((e.birthYear =
											null != s.getItem(n.BirthYearKey) ? Number(s.getItem(n.BirthYearKey)) : 0),
									  e.birthYear),
								e.currentCustomDimension01
									? s.setItem(n.Dimension01Key, e.currentCustomDimension01)
									: ((e.currentCustomDimension01 =
											null != s.getItem(n.Dimension01Key) ? s.getItem(n.Dimension01Key) : ''),
									  e.currentCustomDimension01),
								e.currentCustomDimension02
									? s.setItem(n.Dimension02Key, e.currentCustomDimension02)
									: ((e.currentCustomDimension02 =
											null != s.getItem(n.Dimension02Key) ? s.getItem(n.Dimension02Key) : ''),
									  e.currentCustomDimension02),
								e.currentCustomDimension03
									? s.setItem(n.Dimension03Key, e.currentCustomDimension03)
									: ((e.currentCustomDimension03 =
											null != s.getItem(n.Dimension03Key) ? s.getItem(n.Dimension03Key) : ''),
									  e.currentCustomDimension03);
							var t =
								null != s.getItem(n.SdkConfigCachedKey) ? s.getItem(n.SdkConfigCachedKey) : '';
							if (t) {
						...
						(n.calculateServerTimeOffset = function (e) {
							return e - i.timeIntervalSince1970();
						}),
						(n.validateAndFixCurrentDimensions = function () {
		...
		!(function (n) {
			var t = e.utilities.GAUtilities,
				...
				r = (function () {
					function e() {}
					return (
						(e.execute = function (n, r, s, o) {
							if ((e.countMap[r] || (e.countMap[r] = 0), !(e.countMap[r] >= e.MaxCount))) {
								var a = t.getHmac(o, s),
					...
					return (
						(e.prototype.requestInit = function (i) {
							var r = t.getGameKey(),
								...
								a = JSON.stringify(o);
							if (!a) return void i(n.EGAHTTPApiResponse.JsonEncodeFailed, null);
							var u = this.createPayloadData(a, this.useGzip),
								c = [];
							c.push(a), e.sendRequest(s, u, c, this.useGzip, e.initRequestCallback, i);
						}),
						(e.prototype.sendEventsInArray = function (i, r, s) {
							if (0 != i.length) {
								var o = t.getGameKey(),
									...
									u = JSON.stringify(i);
								if (!u) return void s(n.EGAHTTPApiResponse.JsonEncodeFailed, null, r, i.length);
								var c = this.createPayloadData(u, this.useGzip),
									d = [];
								d.push(u),
									d.push(r),
									d.push(i.length.toString()),
									e.sendRequest(a, c, d, this.useGzip, e.sendEventInArrayRequestCallback, s);
							}
						}),
						...
						(e.sendEventInArrayRequestCallback = function (t, i, r, s) {
							void 0 === s && (s = null);
							var o = (s[0], s[1], s[2]),
								a = parseInt(s[3]),
								u = '',
							...
							var d = e.instance.processRequestResponse(c, t.statusText, u, 'Events');
							if (d != n.EGAHTTPApiResponse.Ok && d != n.EGAHTTPApiResponse.BadRequest)
								return void r(d, null, o, a);
							var l = u ? JSON.parse(u) : {};
							if (null == l) return void r(n.EGAHTTPApiResponse.JsonDecodeFailed, null, o, a);
						...
						(e.initRequestCallback = function (t, i, r, o) {
							void 0 === o && (o = null);
							var a = (o[0], o[1], ''),
								u = 0;
							(a = t.responseText), (u = t.status);
							var c = a ? JSON.parse(a) : {},
								d = e.instance.processRequestResponse(u, t.statusText, a, 'Init');
							if (d != n.EGAHTTPApiResponse.Ok && d != n.EGAHTTPApiResponse.BadRequest)
								return void r(d, null);
							if (null == c) return void r(n.EGAHTTPApiResponse.JsonDecodeFailed, null);
						...
						(e.sdkErrorTypeToString = function (e) {
							switch (e) {
			...
			var t = e.store.GAStore,
				...
				f = (function () {
					...
					return (
						...
						(n.addBusinessEvent = function (e, i, r, a, u) {
							if ((void 0 === u && (u = null), !d.validateBusinessEvent(e, i, u, r, a)))
								return void c.instance.sendSdkErrorEvent(l.Rejected);
							var f = {};
							s.incrementTransactionNum(),
								t.setItem(s.TransactionNumKey, s.getTransactionNum().toString()),
								(f.event_id = r + ':' + a),
						...
						(n.addResourceEvent = function (t, i, r, a, u) {
							if (
						...
						(n.addProgressionEvent = function (t, i, r, a, u, f) {
							...
							f && t != e.EGAProgressionStatus.Start && (m.score = u),
								t === e.EGAProgressionStatus.Fail && s.incrementProgressionTries(g),
						...
						(n.addDesignEvent = function (e, t, i) {
						...
						(n.addErrorEvent = function (e, t) {
							var i = n.errorSeverityToString(e);
							if (!d.validateErrorEvent(e, t)) return void c.instance.sendSdkErrorEvent(l.Rejected);
							var r = {};
						...
						(n.processEvents = function (e, s) {
							try {
								...
								l.push(['status', r.Equal, 'new']),
									e && (d.push(['category', r.Equal, e]), l.push(['category', r.Equal, e]));
								var f = [];
								f.push(['status', u]);
								var v = t.select(i.Events, d);
								if (!v || 0 == v.length) return void o.i('Event queue: No events to send');
								if (v.length > n.MaxEventCount) {
									if (!(v = t.select(i.Events, d, !0, n.MaxEventCount))) return;
									var g = v[v.length - 1],
										m = g.client_ts;
									if ((d.push(['client_ts', r.LessOrEqual, m]), !(v = t.select(i.Events, d))))
										return;
									l.push(['client_ts', r.LessOrEqual, m]);
								}
								if (
									(o.i('Event queue: Sending ' + v.length + ' events.'), !t.update(i.Events, f, l))
								)
									return;
						...
						(n.processEventsCallback = function (e, s, a, c) {
							var d = [];
							if ((d.push(['status', r.Equal, a]), e === u.Ok))
								t.delete(i.Events, d), o.i('Event queue: ' + c + ' events sent.');
						...
						(n.cleanupEvents = function () {
							t.update(i.Events, [['status', 'new']]);
						}),
						(n.fixMissingSessionEndEvents = function () {
							var e = [];
							e.push(['session_id', r.NotEqual, s.getSessionId()]);
							var u = t.select(i.Sessions, e);
							if (u && 0 != u.length) {
								o.i(u.length + ' session(s) located with missing session_end event.');
						...
						(n.addEventToStore = function (e) {
							...
							try {
								if (
									...
									return void o.w('Database too large. Event has been blocked.');
								...
								(f.status = 'new'),
									...
									e.category == n.CategorySessionEnd
										? t.delete(i.Sessions, [['session_id', r.Equal, u.session_id]])
										: ((f = {}),
										  (f.session_id = u.session_id),
						...
						(n.updateSessionStore = function () {
							if (s.sessionIsStarted()) {
								var e = {};
								(e.session_id = s.instance.sessionId),
									(e.timestamp = s.getSessionStart()),
									(e.event = a.encode64(JSON.stringify(s.getEventAnnotations()))),
									t.insert(i.Sessions, e, !0, 'session_id'),
									t.isStorageAvailable() && t.save();
							}
						}),
						(n.addDimensionsToEvent = function (e) {
							e &&
						...
						(n.resourceFlowTypeToString = function (n) {
							return n == e.EGAResourceFlowType.Source ||
						...
						(n.progressionStatusToString = function (n) {
							return n == e.EGAProgressionStatus.Start ||
						...
						(n.errorSeverityToString = function (n) {
							return n == e.EGAErrorSeverity.Debug ||
								n == e.EGAErrorSeverity[e.EGAErrorSeverity.Debug]
								? 'debug'
								: n == e.EGAErrorSeverity.Info || n == e.EGAErrorSeverity[e.EGAErrorSeverity.Info]
								? 'info'
								: n == e.EGAErrorSeverity.Warning ||
								  n == e.EGAErrorSeverity[e.EGAErrorSeverity.Warning]
								? 'warning'
								: n == e.EGAErrorSeverity.Error || n == e.EGAErrorSeverity[e.EGAErrorSeverity.Error]
								? 'error'
					...
					return (
						...
						(e.getNextBlock = function () {
							...
							return e.instance.blocks.hasItems() &&
								...
								? e.instance.blocks.peek().async && e.instance.blocks.peek().running
				...
				return (
					(l.init = function () {
						if (
							...
							(l.methodMap.configureSdkGameEngineVersion = l.configureSdkGameEngineVersion),
							(l.methodMap.configureGameEngineVersion = l.configureGameEngineVersion),
							...
							(l.methodMap.setEnabledManualSessionHandling = l.setEnabledManualSessionHandling),
					...
					(l.gaCommand = function () {
						...
						n.length > 0 &&
							...
							(n.length > 1
								? e.GameAnalytics.methodMap[n[0]].apply(null, Array.prototype.slice.call(n, 1))
					...
					(l.configureBuild = function (e) {
						void 0 === e && (e = ''),
							n.performTaskOnGAThread(function () {
								return l.isSdkReady(!0, !1)
									? void t.w('Build version must be set before SDK is initialized.')
									: a.validateBuild(e)
									? void r.setBuild(e)
									: void t.i(
					...
					(l.configureUserId = function (e) {
						void 0 === e && (e = ''),
							n.performTaskOnGAThread(function () {
								return l.isSdkReady(!0, !1)
									? void t.w('A custom user id must be set before SDK is initialized.')
									: a.validateUserId(e)
									? void r.setUserId(e)
									: void t.i(
					...
					(l.initialize = function (e, i) {
						...
						(s.async = !0),
							...
							(s.block = function () {
								return l.isSdkReady(!0, !1)
									? void t.w('SDK already initialized. Can only be called once.')
									: a.validateKeys(e, i)
					...
					(l.addErrorEvent = function (t, i) {
						void 0 === t && (t = e.EGAErrorSeverity.Undefined),
							...
							o.updateConnectionType(),
							n.performTaskOnGAThread(function () {
								l.isSdkReady(!0, !0, 'Could not add error event') && d.addErrorEvent(t, i);
							});
					}),
					...
					(l.setCustomDimension01 = function (e) {
						void 0 === e && (e = ''),
							n.performTaskOnGAThread(function () {
								if (!a.validateDimension01(e, r.getAvailableCustomDimensions01()))
									return void t.w(
					...
					(l.setCustomDimension02 = function (e) {
						void 0 === e && (e = ''),
							n.performTaskOnGAThread(function () {
								if (!a.validateDimension02(e, r.getAvailableCustomDimensions02()))
									return void t.w(
					...
					(l.setCustomDimension03 = function (e) {
						void 0 === e && (e = ''),
							n.performTaskOnGAThread(function () {
								if (!a.validateDimension03(e, r.getAvailableCustomDimensions03()))
									return void t.w(
					...
					(l.startNewSessionCallback = function (e, s) {
						if (e === u.Ok && s) {
							...
							e == u.Unauthorized
								? (t.w('Initialize SDK failed - Unauthorized'), (r.instance.initAuthorized = !1))
								: (e === u.NoResponse || e === u.RequestTimeout
										? t.i(
												'Init call (session start) failed - no response. Could be offline or timeout.'
										  )
										: e === u.BadResponse || e === u.JsonEncodeFailed || e === u.JsonDecodeFailed
										? t.i(
										...
										: (e !== u.BadRequest && e !== u.UnknownResponseCode) ||
										  t.i('Init call (session start) failed - bad request or unknown response.'),
								  null == r.instance.sdkConfig
										? null != r.instance.sdkConfigCached
											? (t.i('Init call (session start) failed - using cached init values.'),
											  (r.instance.sdkConfig = r.instance.sdkConfigCached))
											: (t.i('Init call (session start) failed - using default init values.'),
											  (r.instance.sdkConfig = r.instance.sdkConfigDefault))
										: t.i('Init call (session start) failed - using cached init values.'),
								  (r.instance.initAuthorized = !0));
						if (
							((r.instance.clientServerTimeOffset = r.instance.sdkConfig.time_offset
								? r.instance.sdkConfig.time_offset
								: 0),
							!r.isEnabled())
						)
							return t.w('Could not start session: SDK is disabled.'), void n.stopEventQueue();
