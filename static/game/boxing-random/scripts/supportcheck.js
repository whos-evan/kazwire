...
(function () {
	...
	if (missingFeatures.length === 0 && !isKasperskyScriptInjected) window['C3_IsSupported'] = true;
	else {
		...
		if (/android/i.test(ua))
			...
			msgText +=
				'<br><br>Note: using the <strong>iOS simulator</strong> requires <strong>Xcode 12+</strong>. Otherwise try testing on a real device instead.';
