...
!(function (a, b) {
	...
	(r.fn = r.prototype =
		...
		r.extend({
			...
			makeArray: function (a, b) {
				var c = b || [];
				return (
					null != a && (w(Object(a)) ? r.merge(c, 'string' == typeof a ? [a] : a) : h.call(c, a)), c
				);
			},
				...
				if ((c = d.relative[a[i].type])) m = [ta(ua(m), c)];
					...
					if (((c = d.filter[a[i].type].apply(null, a[i].matches)), c[u])) {
						...
						return xa(
							i > 1 && ua(m),
							i > 1 &&
								sa(a.slice(0, i - 1).concat({ value: ' ' === a[i - 2].type ? '*' : '' })).replace(
									P,
									'$1'
								),
							c,
	...
	var E,
		...
		G = (r.fn.init = function (a, b, c) {
			...
			if (((c = c || E), 'string' == typeof a)) {
				if (
					((e =
						'<' === a[0] && '>' === a[a.length - 1] && a.length >= 3 ? [null, a, null] : F.exec(a)),
					!e || (!e[1] && b))
				)
			...
			if (!A.test(a))
				for (; d < e; d++)
					for (c = this[d]; c && c !== b; c = c.parentNode)
						if (
							c.nodeType < 11 &&
							(g ? g.index(c) > -1 : 1 === c.nodeType && r.find.matchesSelector(c, a))
						) {
							f.push(c);
							break;
						}
										...
										: function () {
												try {
													...
													r.Deferred.exceptionHook && r.Deferred.exceptionHook(a, k.stackTrace),
														b + 1 >= f &&
															(d !== N && ((h = void 0), (i = [a])), c.rejectWith(h, i));
												}
										  };
								b
									? k()
									: (r.Deferred.getStackHook && (k.stackTrace = r.Deferred.getStackHook()),
									  a.setTimeout(k));
							};
						}
						return r
	...
	function Z(a) {
		return (
			'true' === a ||
			('false' !== a && ('null' === a ? null : a === +a + '' ? +a : X.test(a) ? JSON.parse(a) : a))
		);
	}
	function $(a, b, c) {
		var d;
				...
				if (void 0 === a) {
					if (this.length && ((e = W.get(f)), 1 === f.nodeType && !V.get(f, 'hasDataAttrs'))) {
						...
						while (c--)
							g[c] &&
								((d = g[c].name),
								0 === d.indexOf('data-') && ((d = r.camelCase(d.slice(5))), $(f, d, e[d])));
		...
		for (var c, d, e = [], f = 0, g = a.length; f < g; f++)
			(d = a[f]),
				d.style &&
					...
					b
						? ('none' === c &&
								((e[f] = V.get(d, 'display') || null), e[f] || (d.style.display = '')),
	...
	function pa(a, b, c, d, e) {
		...
		while ((f = m[n++]))
			if (d && r.inArray(f, d) > -1) e && e.push(f);
				...
				((j = r.contains(f.ownerDocument, f)), (g = ma(l.appendChild(f), 'script')), j && na(g), c)
			) {
				k = 0;
	...
	(r.event = {
		...
		remove: function (a, b, c, d, e) {
			...
			if (q && (i = q.events)) {
				...
				while (j--)
					if (
						((h = ta.exec(b[j]) || []), (n = p = h[1]), (o = (h[2] || '').split('.').sort()), n)
					) {
						(l = r.event.special[n] || {}),
	...
	var ya =
		...
		Ca = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;
	function Da(a, b) {
		return r.nodeName(a, 'table') && r.nodeName(11 !== b.nodeType ? b : b.firstChild, 'tr')
				...
				for (k = h[h.length - 1].ownerDocument, r.map(h, Fa), l = 0; l < i; l++)
					(j = h[l]),
						ka.test(j.type || '') &&
							...
							r.contains(k, j) &&
							(j.src ? r._evalUrl && r._evalUrl(j.src) : p(j.textContent.replace(Ca, ''), k));
		}
		return a;
	}
	function Ja(a, b, c) {
		for (var d, e = b ? r.filter(b, a) : a, f = 0; null != (d = e[f]); f++)
			c || 1 !== d.nodeType || r.cleanData(ma(d)),
				d.parentNode &&
					(c && r.contains(d.ownerDocument, d) && na(ma(d, 'script')), d.parentNode.removeChild(d));
		return a;
	}
	r.extend({
			...
			'margin' === c && (g += r.css(a, c + ba[f], !0, e)),
				d
					? ('content' === c && (g -= r.css(a, 'padding' + ba[f], !0, e)),
					  'margin' !== c && (g -= r.css(a, 'border' + ba[f] + 'Width', !0, e)))
	...
	function eb(a, b, c) {
		for (
			var d, e = (hb.tweeners[b] || []).concat(hb.tweeners['*']), f = 0, g = e.length;
			f < g;
			f++
		)
	...
	function hb(a, b, c) {
		...
		for (gb(k, j.opts.specialEasing); f < g; f++)
			if ((d = hb.prefilters[f].call(j, a, k, j.opts)))
				return (
					r.isFunction(d.stop) && (r._queueHooks(j.elem, j.opts.queue).stop = r.proxy(d.stop, d)), d
				);
		return (
			r.map(k, eb, j),
			...
			attr: function (a, b, c) {
				...
				if (3 !== f && 8 !== f && 2 !== f)
					return 'undefined' == typeof a.getAttribute
						? r.prop(a, b, c)
						: ((1 === f && r.isXMLDoc(a)) ||
								(e = r.attrHooks[b.toLowerCase()] || (r.expr.match.bool.test(b) ? ib : void 0)),
						  void 0 !== c
								? null === c
				...
				if (e)
					return (
						...
						b && 'get' in b && void 0 !== (c = b.get(e, 'value'))
							? c
							: ((c = e.value), 'string' == typeof c ? c.replace(ob, '') : null == c ? '' : c)
					);
			}
		}
	}),
					...
					get: function (a) {
						...
						for (d = f < 0 ? i : g ? f : 0; d < i; d++)
							if (
								...
								(c.selected || d === f) &&
									!c.disabled &&
									(!c.parentNode.disabled || !r.nodeName(c.parentNode, 'optgroup')))
							) {
	...
	function xb(a, b, c, d) {
		...
		if (r.isArray(b))
			r.each(b, function (b, e) {
				c || tb.test(a)
					? d(a, e)
					: xb(a + '[' + ('object' == typeof e && null != e ? b : '') + ']', e, c, d);
			});
			...
			var e,
				...
				y = {
					...
					setRequestHeader: function (a, b) {
						return (
							null == k && ((a = w[a.toLowerCase()] = w[a.toLowerCase()] || a), (v[a] = b)), this
						);
					},
			...
			(l = r.event && o.global),
				...
				o.hasContent
					...
					: ((n = o.url.slice(f.length)),
					  ...
					  o.cache === !1 &&
							((f = f.replace(Ab, '$1')), (n = (sb.test(f) ? '&' : '?') + '_=' + rb++ + n)),
					  (o.url = f + n)),
				o.ifModified &&
		...
		r.each(['get', 'post'], function (a, b) {
			r[b] = function (a, c, d, e) {
				return (
					...
					r.ajax(
						r.extend({ url: a, type: b, dataType: e, data: c, success: d }, r.isPlainObject(a) && a)
					)
				);
			};
		}),
	...
	r.ajaxSetup({
		...
		r.ajaxPrefilter('json jsonp', function (b, c, d) {
			...
			if (h || 'jsonp' === b.dataTypes[0])
				return (
					(e = b.jsonpCallback =
						r.isFunction(b.jsonpCallback) ? b.jsonpCallback() : b.jsonpCallback),
					h
						? (b[h] = b[h].replace(Rb, '$1' + e))
						: b.jsonp !== !1 && (b.url += (sb.test(b.url) ? '&' : '?') + b.jsonp + '=' + e),
		...
		(r.parseHTML = function (a, b, c) {
			...
			return (
				...
				f
					? [b.createElement(f[1])]
					: ((f = pa([a], b, g)), g && g.length && r(g).remove(), r.merge([], f.childNodes))
			);
		}),
