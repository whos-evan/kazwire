...
})(
	{
			...
			function (e, t, n) {
				(function (o, i) {
					!(function (e, o) {
						...
						function b(e, t, o) {
							t.constructor === e.constructor && o === d && t.constructor.resolve === c
								? m(e, t)
								: o === W
								? (E(e, W.error), (W.error = null))
								: void 0 === o
								? _(e, t)
								: n(o)
								? p(e, t, o)
						...
						function _(e, t) {
							e._state === Y &&
								((e._result = t), (e._state = Q), 0 !== e._subscribers.length && N(w, e));
						}
						function E(e, t) {
							e._state === Y && ((e._state = V), (e._result = t), N(y, e));
						}
						function A(e, t, n, o) {
						...
						function w(e) {
							var t = e._subscribers,
								n = e._state;
							if (0 !== t.length) {
								for (var o = void 0, i = void 0, r = e._result, s = 0; s < t.length; s += 3)
									(o = t[s]), (i = t[s + n]), o ? T(n, o, i, r) : i(r);
						...
						function T(e, t, o, i) {
							...
							if (r) {
								if (
									((s = D(o, i)) === W ? ((c = !0), (a = s.error), (s.error = null)) : (d = !0),
									t === s)
								)
									return void E(t, h());
							} else (s = i), (d = !0);
							t._state !== Y ||
								(r && d ? v(t, s) : c ? E(t, a) : e === Q ? _(t, s) : e === V && E(t, s));
						}
						function S(e, t) {
							try {
								t(
						...
						function R(e) {
							(e[z] = J++), (e._state = void 0), (e._result = void 0), (e._subscribers = []);
						}
						function I() {
							...
							X = (function () {
								...
								return (
									...
									(e.prototype._eachEntry = function (e, t) {
										...
										if (o === c) {
											var i = g(e);
											if (i === d && e._state !== Y) this._settledAt(e._state, t, e._result);
									...
									(e.prototype._settledAt = function (e, t, n) {
										var o = this.promise;
										o._state === Y &&
											(this._remaining--, e === V ? E(o, n) : (this._result[t] = n)),
							...
							Z = (function () {
								function e(t) {
									(this[z] = C()),
										...
										(this._subscribers = []),
										u !== t &&
											('function' != typeof t && x(), this instanceof e ? S(this, t) : k());
								}
								return (
		...
		4: [
			function (e, t, n) {
				...
				function a() {
					m && f && ((m = !1), f.length ? (p = f.concat(p)) : (b = -1), p.length && d());
				}
				function d() {
					if (!m) {
						var e = r(a);
				...
				(g.nextTick = function (e) {
					...
					p.push(new c(e, t)), 1 !== p.length || m || r(d);
				}),
					...
					(g.off = u),
					(g.removeListener = u),
					(g.removeAllListeners = u),
					(g.emit = u),
					(g.prependListener = u),
					(g.prependOnceListener = u),
						...
						return (
							...
							(this._initBody = function (e) {
								if (((this._bodyInit = e), e))
									...
									else if (b.searchParams && URLSearchParams.prototype.isPrototypeOf(e))
										this._bodyText = e.toString();
									else if (b.arrayBuffer && b.blob && y(e))
										(this._bodyArrayBuffer = u(e.buffer)),
											(this._bodyInit = new Blob([this._bodyArrayBuffer]));
									else {
										if (!b.arrayBuffer || (!ArrayBuffer.prototype.isPrototypeOf(e) && !_(e)))
							...
							(e.fetch = function (e, t) {
								return new Promise(function (n, o) {
									...
									(r.onload = function () {
										...
										'include' === i.credentials && (r.withCredentials = !0),
										'responseType' in r && b.blob && (r.responseType = 'blob'),
							...
							i(e, [
								...
								},
								{
									...
									value: function (e, t, n) {
										...
										this._getListenerIdx(e, t, n) >= 0 ||
											((o = { callback: t, scope: n }),
							...
							i(e, [
								{
									...
									value: function () {
										...
										(i.style.position = 'fixed'),
											...
											o.appendChild(i);
										var r = document.getElementById('gdsdk__pauseGame'),
											s = document.getElementById('gdsdk__resumeGame'),
											a = document.getElementById('gdsdk__showBanner'),
											d = document.getElementById('gdsdk__cancel'),
											c = document.getElementById('gdsdk__demo'),
											u = document.getElementById('gdsdk__midrollTimer'),
											l = document.getElementById('gdsdk__hbgdDebug'),
											h = document.getElementById('gdsdk__hbgdConfig'),
											g = document.getElementById('gdsdk__closeDebug');
										localStorage.getItem('gd_tag')
											? ((c.innerHTML = 'Revert Vast tag'), (c.style.background = '#ff8c1c'))
											: ((c.innerHTML = 'Demo VAST tag'), (c.style.background = '#44a5ab')),
											localStorage.getItem('gd_midroll')
												? ((u.innerHTML = 'Revert delay'), (u.style.background = '#ff8c1c'))
												: ((u.innerHTML = 'Disable delay'), (u.style.background = '#44a5ab')),
							...
							i(e, [
								{
									key: 'send',
									value: function (e, t) {
										var n = [this._config.gameId, this._config.parentDomain, this._config.hours];
										t &&
											t.length > 0 &&
											t.forEach(function (e) {
												return n.push(e);
											}),
											(n = encodeURIComponent(r.Base64.encode(JSON.stringify(n)))),
											fetch(this._url + '?tp=com.gdsdk.' + e + '&ar=' + n + '&ts=' + Date.now());
									}
								}
							]),
							e
		...
		10: [
				...
				var i = (function () {
					...
					c = (function () {
						function e(t, n, i) {
							...
							d = this;
							var c = { debug: !1, width: 640, height: 360, locale: 'en' };
							(this.options = i ? (0, s.extendDefaults)(c, i) : c),
								(this.prefix = 'gdsdk__'),
								(this.adsLoader = null),
								...
								(this.parentDomain = (0, s.getParentDomain)()),
								(this.parentUrl = (0, s.getParentUrl)()),
								(this.maxPrerollCount = 1),
								(this.requestedPrerollCount = 0),
								(this.requestedMidrollCount = 0),
								(this.canRequestPreroll = function () {
									return a.requestedPrerollCount < a.maxPrerollCount;
								}),
								(this.userDeclinedPersonalAds =
							...
							i(e, [
								{
									...
									value: function () {
										var e = this;
										this._startSafetyTimer(12e3, 'start()'),
											this.eventBus.subscribe('AD_SDK_LOADER_READY', function () {
								...
								},
								{
									...
									value: function () {
										...
										return new Promise(function (t, n) {
											if (e.requestRunning)
												(0, a.dankLog)('AD_SDK_REQUEST', 'A request is already running', 'warning');
											else {
												(e.requestRunning = !0),
													1 === e.adTypeCount && (e.adCount = 0),
													e.adCount++,
													e.adTypeCount++;
												try {
													localStorage.getItem('gd_debug') && localStorage.getItem('gd_tag')
														? t(localStorage.getItem('gd_tag'))
														: e
																._tunnlReportingKeys()
																.then(function (o) {
																	void 0 === window.idhbgd.requestAds &&
																		n("Prebid.js wrapper script hit an error or didn't exist!");
																	var i =
																		(o.nsid ? o.nsid : 'TNL_T-17102571517') +
																		'/' +
																		(o.tid ? o.tid : 'TNL_NS-18101700058');
																	delete o.nsid,
																		delete o.tid,
																		(0, a.dankLog)('AD_SDK_AD_UNIT', i, 'info');
																	var r = o.consent_string
																		? o.consent_string
																		: 'BOWJjG9OWJjG9CLAAAENBx-AAAAiDAAA';
																	Object.assign(o, {
																		tnl_system: '1',
																		tnl_content_category: e.category.toLowerCase()
																	}),
																		void 0 !== window.ga &&
																			window.ga('gd.send', {
																				hitType: 'event',
																				eventCategory: 'AD_REQUEST',
																				eventAction: e.parentDomain,
																				eventLabel: i
																			});
																	var s = '0' === e.userDeclinedPersonalAds;
																	window.idhbgd.que.push(function () {
																		window.idhbgd.setAdserverTargeting(o),
																			window.idhbgd.setDfpAdUnitCode(i),
																			window.idhbgd.setRefererUrl(encodeURIComponent(e.parentUrl)),
																			window.idhbgd.allowPersonalizedAds(s),
																			window.idhbgd.setDefaultGdprConsentString(r),
									...
									value: function () {
										...
										return new Promise(function (t) {
											...
											n =
												...
												'm.hopy.com' !== s.getParentDomain
													? 'page_url=' + encodeURIComponent(e.parentUrl)
													: 'bundle=com.hopy.frivgames';
											var o = (0, s.getMobilePlatform)(),
												i = 1 === e.adTypeCount ? 'preroll1' : 'midroll' + e.adCount.toString(),
												r = (0, s.getQueryString)('ch', window.location.href),
												a = (0, s.getQueryString)('ch_date', window.location.href),
												d = r ? '&ch=' + r : '',
												c = a ? '&ch_date=' + a : '',
												u =
													'https://pub.tunnl.com/opphb?' +
													n +
													'&player_width=' +
													e.options.width +
													'&player_height=' +
													e.options.height +
													'&ad_type=video_image&os=' +
													o +
													'&game_id=' +
													e.gameId +
													'&ad_position=' +
											...
											fetch(l)
												...
												.catch(function (n) {
													...
													var o = {
														...
														tnl_pw: e.options.width,
														tnl_ph: e.options.height,
														tnl_pt: '22',
														tnl_pid: 'P-17101800031',
														tnl_paid: '17',
														tnl_ad_type: 'video_image',
														tnl_asset_id: e.gameId.toString(),
														tnl_ad_pos: i,
														tnl_skippable: '1',
														tnl_cp1: '',
														tnl_cp2: '',
									...
									value: function (e) {
										if ('undefined' != typeof google)
											try {
												...
												if (
													((t.adTagUrl = e),
													(0, a.dankLog)('AD_SDK_TAG_URL', t.adTagUrl, 'success'),
													(t.linearAdSlotWidth = this.options.width),
													(t.linearAdSlotHeight = this.options.height),
													(t.nonLinearAdSlotWidth = this.options.width),
													(t.nonLinearAdSlotHeight = this.options.height),
													...
													window.ga('gd.send', {
														hitType: 'event',
														eventCategory: 1 === this.adTypeCount ? 'AD_PREROLL' : 'AD_MIDROLL',
														eventAction:
															this.parentDomain + ' | h' + o + ' d' + i + ' m' + r + ' y' + s,
														eventLabel: e
													});
												}
								...
								},
								{
									...
									value: function (e) {
										this.eventBus.broadcast('AD_SDK_ERROR', {
											...
											message: e,
											status: 'error',
											analytics: { category: this.eventCategory, action: 'AD_SDK_ERROR', label: e }
										}),
											this.cancel(),
								...
								},
								{
									...
									value: function () {
										...
										this.adContainer &&
											...
											setTimeout(
												function () {
													(e.adContainer.style.transform = 'translateX(-9999px)'),
														(e.adContainer.style.zIndex = '0'),
														e.thirdPartyContainer &&
															((e.thirdPartyContainer.style.transform = 'translateX(-9999px)'),
															(e.thirdPartyContainer.style.zIndex = '0'));
												},
										...
										this.adContainer &&
											...
											setTimeout(function () {
												(e.adContainer.style.opacity = '1'),
													e.thirdPartyContainer && (e.thirdPartyContainer.style.opacity = '1');
											}, 10));
									}
								},
								{
								...
								},
								{
									...
									value: function () {
										...
										(n.id = this.prefix + 'advertisement_slot'),
											...
											this.thirdPartyContainer
												...
												: (this.adContainer.appendChild(n), t.appendChild(this.adContainer)),
											window.addEventListener('resize', function () {
												var t =
													...
													o =
														...
														document.documentElement.clientHeight ||
														document.body.clientHeight;
												(e.options.width = e.thirdPartyContainer
													? e.thirdPartyContainer.offsetWidth
													: t),
													(e.options.height = e.thirdPartyContainer
														? e.thirdPartyContainer.offsetHeight
														: o),
									...
									value: function (e) {
										...
										switch (e.type) {
											...
											case google.ima.AdEvent.Type.CONTENT_PAUSE_REQUESTED:
												(a = 'CONTENT_PAUSE_REQUESTED'),
													(d =
														'Fired when content should be paused. This usually happens right before an ad is about to cover the content.');
												break;
											case google.ima.AdEvent.Type.CONTENT_RESUME_REQUESTED:
												(a = 'CONTENT_RESUME_REQUESTED'),
													(d =
													...
													this.adsLoaderPromise
														.then(function () {
															...
															t.eventBus.broadcast('AD_SDK_FINISHED', {
																...
																status: 'success',
																analytics: {
																	category: 'AD_SDK_FINISHED',
																	action: t.parentDomain,
																	label: 'h' + o + ' d' + i + ' m' + r + ' y' + s
																}
															});
														})
														.catch(function () {
											...
											case google.ima.AdEvent.Type.IMPRESSION:
												...
												try {
													if (void 0 !== window.pbjsgd) {
														...
														this.options.debug && console.log('Winner(s)', c),
															c.length > 0
																? c.forEach(function (e) {
																		void 0 !== window.ga &&
																			...
																			window.ga('gd.send', {
																				hitType: 'event',
																				eventCategory: 'IMPRESSION_' + e.bidder.toUpperCase(),
																				eventAction: t.parentDomain,
																				eventLabel: 'h' + o + ' d' + i + ' m' + r + ' y' + s
																			});
																  })
																: void 0 !== window.ga &&
																  window.ga('gd.send', {
											...
											if (void 0 !== window.ga) {
												...
												this.eventBus.broadcast('AD_ERROR', {
													...
													analytics: {
														category: 'AD_ERROR',
														action:
															e.getError().getErrorCode().toString() ||
															e.getError().getVastErrorCode().toString(),
														label: t
													}
												});
											}
											if (void 0 !== window.pbjsgd) {
												var n = window.pbjsgd.getHighestCpmBids();
												this.options.debug && console.log('Failed winner(s) ', n),
													n.length > 0
														? n.forEach(function (t) {
																var n = t.adId ? t.adId : null,
																	o = t.creativeId ? t.creativeId : null;
																void 0 !== window.ga &&
																	t.bidder &&
																	window.ga('gd.send', {
																		hitType: 'event',
																		eventCategory: 'AD_ERROR_' + t.bidder.toUpperCase(),
																		eventAction:
																			e.getError().getErrorCode().toString() ||
																			e.getError().getVastErrorCode().toString(),
																		eventLabel: n + ' | ' + o
														...
														: void 0 !== window.ga &&
														  window.ga('gd.send', {
																...
																eventAction:
																	e.getError().getErrorCode().toString() ||
																	e.getError().getVastErrorCode().toString(),
																eventLabel: e.getError().getMessage()
														  });
											}
										} catch (e) {
											console.log(e);
								...
								},
								{
									...
									value: function (e, t) {
										var n = this;
										(0, a.dankLog)('AD_SAFETY_TIMER', 'Invoked timer from: ' + t, 'success'),
								...
								},
								{
									...
									value: function (e) {
										if (
											...
											((0, a.dankLog)('AD_SAFETY_TIMER', 'Cleared timer set at: ' + e, 'success'),
										...
										d.parentNode.insertBefore(s, d),
											...
											googletag.cmd.push(function () {
												...
												(i[0] = googletag
													...
													googletag.pubads().setTargeting('crossid', e),
													googletag.pubads().setTargeting('crosstags', t),
													googletag.pubads().setTargeting('crosscategory', n),
													googletag.pubads().disableInitialLoad(),
													googletag.enableServices(),
													googletag.display(o.prefix + 'baguette'),
													googletag.pubads().refresh([i[0]]);
											});
									}
								}
							]),
			...
			{ '../components/EventBus': 7, '../modules/common': 13, '../modules/dankLog': 14 }
		],
		11: [
			function (e, t, n) {
				'use strict';
				var o =
					...
					r =
						'object' === ('undefined' == typeof GD_OPTIONS ? 'undefined' : o(GD_OPTIONS)) &&
						GD_OPTIONS
							? GD_OPTIONS
							: window.gdApi && 'object' === o(window.gdApi.q[0][0]) && window.gdApi.q[0][0]
							? window.gdApi.q[0][0]
							: {};
				window.gdApi &&
					'object' === o(window.gdApi.q[0][0]) &&
					window.gdApi.q[0][0] &&
					(r.hasOwnProperty('advertisementSettings') ||
						(r.advertisementSettings = { autoplay: !0 })),
					(window.gdsdk = new i.default(r)),
		...
		12: [
			function (e, t, n) {
				...
				var a = o(e('../package.json')),
					...
					u = o(e('./components/ImplementationTest')),
					l = o(e('./components/MessageRouter')),
					h = e('./modules/dankLog'),
					g = e('./modules/common'),
					f = null,
					p = (function () {
						function e(t) {
							...
							this.options = t ? (0, g.extendDefaults)(o, t) : o;
							var r = a.default.version,
								s = console.log(
									'%c %c %c GameDistribution.com HTML5 SDK | Version: ' + r + ' %c %c %c',
									'background: #9854d8',
									'background: #6c2ca7',
							...
							var u = (0, g.getParentUrl)(),
								p = (0, g.getParentDomain)();
							(this.msgrt = new l.default({
							...
							if ((this._analytics(m, p), ['razda.com', '74.127.72.247'].indexOf(p) > -1))
								return (
									void 0 !== window.ga &&
										window.ga('gd.send', {
											hitType: 'event',
									...
									void (document.location =
										'/blocked.html?domain=' + p + '&localTime=' + new Date().getHours())
								);
							var b = [];
							(this.options.testing = this.options.testing || b.indexOf(p) > -1),
								this.options.testing &&
									(0, h.dankLog)('SDK_TESTING_ENABLED', this.options.testing, 'info'),
								(this.whitelabelPartner = !1);
							var v = (0, g.getQueryParams)('xanthophyll');
							v.hasOwnProperty('xanthophyll') &&
								'true' === v.xanthophyll &&
								((this.whitelabelPartner = !0),
								(0, h.dankLog)('SDK_WHITELABEL', this.whitelabelPartner, 'success'));
							try {
								if ('developer.gamedistribution.com' === p) {
									...
									('html5.api.gamedistribution.com' !== p && 'localhost:3000' !== p) ||
							...
							(new Image().src =
								...
								this.eventBus.subscribe('SDK_BLOCKED', function (e) {
									return n._onEvent(e);
								}),
								...
								this.eventBus.subscribe('SDK_GDPR_TRACKING', function (e) {
									return n._onEvent(e);
								}),
								this.eventBus.subscribe('SDK_GDPR_TARGETING', function (e) {
									return n._onEvent(e);
								}),
								this.eventBus.subscribe('SDK_GDPR_THIRD_PARTY', function (e) {
									return n._onEvent(e);
								}),
								...
								this.eventBus.subscribe('AD_SDK_FINISHED', function (e) {
									n._onEvent(e), n._checkPrerollRequest(e);
								}),
								...
								this.eventBus.subscribe('CONTENT_RESUME_REQUESTED', function (e) {
									if (
										...
										'developer.gamedistribution.com' === p ||
											!0 === new RegExp('^localhost').test(p))
									) {
										new Image().src =
											'https://game.api.gamedistribution.com/game/hasapi/' + n.options.gameId;
										try {
											var t = JSON.stringify({
												type: 'GD_SDK_IMPLEMENTED',
												gameID: n.options.gameId
											});
								...
								(this.videoAdInstance = new d.default(
							...
							var y = new Promise(function (e) {
								var t = {
									...
									o =
										'https://game.api.gamedistribution.com/game/get/' +
										t.gameId.replace(/-/g, '') +
										'/?domain=' +
										p +
										'&localTime=' +
										new Date().getHours(),
									i = new Request(o, { method: 'GET' });
								fetch(i)
									.then(function (e) {
										var t = e.headers.get('content-type');
										if (t && -1 !== t.indexOf('application/json')) return e.json();
									...
									.then(function (o) {
										if (o.error) (0, h.dankLog)('SDK_GAME_DATA_READY', o.error, 'warning');
										else if (o.success) {
											var i = {
												gameId: o.result.game.gameMd5,
												advertisements: o.result.game.enableAds,
												preroll: o.result.game.preRoll,
												midroll: 6e4 * o.result.game.timeAds,
												title: o.result.game.title,
												tags: o.result.game.tags,
												category: o.result.game.category,
												assets: o.result.game.assets,
												displaySecondPrerollIfFirstOneShort:
													o.result.game.displaySecondPrerollIfFirstOneShort
											};
											(t = (0, g.extendDefaults)(t, i)).displaySecondPrerollIfFirstOneShort &&
												(n.videoAdInstance.maxPrerollCount = 2),
												(0, h.dankLog)('SDK_GAME_DATA_READY', t, 'success');
										}
										e(t);
									})
									.catch(function (n) {
										(0, h.dankLog)('SDK_GAME_DATA_READY', n, 'success'), e(t);
									});
							});
							y
								.then(function (e) {
									(n.videoAdInstance.gameId = e.gameId),
										(n.videoAdInstance.category = e.category),
										(n.videoAdInstance.tags = e.tags);
									try {
										localStorage.getItem('gd_debug') &&
											(localStorage.getItem('gd_tag') &&
												(n.videoAdInstance.tag = localStorage.getItem('gd_tag')),
											localStorage.getItem('gd_midroll') &&
									...
									if (e.advertisements) {
										var t =
											[
												...
												'spilgames.com',
												'spilcloud.com'
											].indexOf(p) > -1 && document.cookie.indexOf('ogdpr_tracking=1') < 0;
										e.preroll
											? (n.videoAdInstance.options.autoplay || t) && n._createSplash(e, t)
								...
								(this.readyPromise = Promise.all([y, this.videoAdInstance.adsLoaderPromise])
									.then(function (e) {
										return (
											n.eventBus.broadcast('SDK_READY', {
												name: 'SDK_READY',
											...
											n.options.onInit('Everything is ready.'),
											e[0]
										);
									})
									.catch(function () {
										return (
											n.eventBus.broadcast('SDK_ERROR', {
												name: 'SDK_ERROR',
											...
											n.options.onError('The SDK failed.'),
											!1
										);
									}));
						}
							...
							s(e, [
								{
									key: '_gdpr',
									value: function (e) {
										var t = document.location.search.indexOf('gdpr-tracking') >= 0,
											n = document.location.search.indexOf('gdpr-tracking=1') >= 0,
											o = '',
											i = '';
										t
											? n
												? ((o = 'General Data Protection Regulation is set to allow tracking.'),
												  (i = 'success'))
												: ((o = 'General Data Protection Regulation is set to disallow tracking.'),
												  (i = 'warning'))
											: ((o =
											...
											this.eventBus.broadcast('SDK_GDPR_TRACKING', {
												...
												status: i,
												analytics: {
													category: 'SDK_GDPR_TRACKING',
													action: e,
													label: t ? (n ? '1' : '0') : 'not set'
												}
											});
										var r = document.location.search.indexOf('gdpr-targeting') >= 0,
											s = document.location.search.indexOf('gdpr-targeting=1') >= 0,
											a = '',
											d = '';
										r
											? s
											...
											: ((a =
											  ...
											  (d = 'warning')),
											this.eventBus.broadcast('SDK_GDPR_TARGETING', {
												name: 'SDK_GDPR_TARGETING',
												message: a,
												status: d,
												analytics: {
													category: 'SDK_GDPR_TARGETING',
													action: e,
													label: r ? (s ? '1' : '0') : 'not set'
												}
											});
										var c = document.location.search.indexOf('gdpr-third-party') >= 0,
											u = document.location.search.indexOf('gdpr-third-party=1') >= 0,
											l = '',
											h = '';
										c
											? u
											...
											: ((l =
											  ...
											  (h = 'warning')),
											this.eventBus.broadcast('SDK_GDPR_THIRD_PARTY', {
												name: 'SDK_GDPR_THIRD_PARTY',
												message: l,
												status: h,
												analytics: {
													category: 'SDK_GDPR_THIRD_PARTY',
													action: e,
													label: c ? (u ? '1' : '0') : 'not set'
												}
											});
									}
								},
										...
										(0, g.getScript)(
											...
											.then(function () {
												window.ga(
													'create',
													'UA-102601800-1',
													{ name: 'gd', cookieExpires: 7776e3 },
													'auto'
												),
													window.ga('gd.send', 'pageview'),
													e || window.ga('gd.set', 'anonymizeIp', !0);
											})
											.catch(function (e) {
												(0, h.dankLog)('SDK_LOAD_SCRIPT', e, 'error');
											}),
											e ||
												(0, g.getScript)(
													...
													.then(function () {
														n.readyPromise.then(function (e) {
															'object' === r(window._cc13998) &&
																'function' == typeof window._cc13998.bcpf &&
																'function' == typeof window._cc13998.bcpw &&
																(window._cc13998.bcpw('act', 'play'),
																window._cc13998.bcpw('int', 'domain : ' + t),
								...
								},
								{
									...
									value: function (e, t) {
										...
										o = o
											? 'https://img.gamedistribution.com/' + o.name
											: e.assets[0].hasOwnProperty('name')
											? 'https://img.gamedistribution.com/' + e.assets[0].name
										...
										var c = this.options.flashSettings.splashContainerId
										...
										t
											? document
													.getElementById(this.options.prefix + 'splash-button')
													.addEventListener('click', function () {
														var e = new Date();
														e.setDate(e.getDate() + 90),
															(document.cookie =
																'ogdpr_tracking=1; expires=' + e.toUTCString() + '; path=/'),
															n.showBanner();
													})
											: d.addEventListener('click', function () {
													n.showBanner();
								...
								{
									key: '_checkPrerollRequest',
									value: function () {
										var e = this;
										this.videoAdInstance.canRequestPreroll() &&
								...
								},
								{
									...
									value: function () {
										...
										this.readyPromise
											.then(function (t) {
												t.advertisements && !e.whitelabelPartner
													? void 0 !== e.adRequestTimer
														? new Date().valueOf() - e.adRequestTimer.valueOf() < t.midroll
															? ((0, h.dankLog)(
																	'SDK_SHOW_BANNER',
															...
															: ((0, h.dankLog)(
															  ...
															  e.videoAdInstance.requestedMidrollCount++,
															  e.videoAdInstance
																	.requestAd()
																	.then(function (t) {
																		return e.videoAdInstance.loadAd(t);
															  ...
															  e.msgrt.send(
																	'req.ad.midroll.' + e.videoAdInstance.requestedMidrollCount
															  ))
														: ((0, h.dankLog)(
																'SDK_SHOW_BANNER',
														  ...
														  (e.adRequestTimer = new Date()),
														  (e.videoAdInstance.requestAttempts = 0),
														  e.videoAdInstance.requestedPrerollCount++,
														  e.videoAdInstance
																.requestAd()
																.then(function (t) {
																	return e.videoAdInstance.loadAd(t);
														  ...
														  e.msgrt.send(
																'req.ad.preroll.' + e.videoAdInstance.requestedPrerollCount
														  ))
											...
											.catch(function (e) {
												(0, h.dankLog)('SDK_SHOW_BANNER', e, 'error');
											});
									}
								},
								{ key: 'customLog', value: function (e) {} },
								...
								},
								{
									...
									value: function () {
										try {
											new u.default(this.options.testing).start(),
												localStorage.setItem('gd_debug', !0);
										} catch (e) {
											console.log(e);
										}
			...
			},
			{
				'../package.json': 6,
				'./components/EventBus': 7,
				'./components/ImplementationTest': 8,
				'./components/MessageRouter': 9,
				'./components/VideoAd': 10,
				'./modules/common': 13,
				'./modules/dankLog': 14,
				'es6-promise/auto': 1,
				'whatwg-fetch': 5
				...
				Object.defineProperty(n, '__esModule', { value: !0 }),
					...
					(n.getParentUrl = function () {
						...
						if (e.gd_sdk_referrer_url)
							return (
								console.log('self-hosted referrer URL:', e.gd_sdk_referrer_url),
						...
						if (-1 !== document.referrer.indexOf('gameplayer.io')) {
							...
							if (n) {
								...
								'' !== r &&
									...
									'{spilgames}' !== r &&
									'{portal name}' !== r &&
									(t = 'https://' + (t = (r = s(r)).replace(/^(?:https?:\/\/)?(?:\/\/)?/i, '')));
							}
					...
					try {
						if (localStorage.getItem('gd_debug')) {
							var i =
								...
								r = console.log(
									'[' + (Date.now() - o) / 1e3 + 's]%c %c %c gdsdk %c %c %c ' + e + ' ',
									'background: #9854d8',
									'background: #6c2ca7',
									'color: #fff; background: #450f78;',
									'background: #6c2ca7',
