...
class SelectorCtrl {
	...
	setupTemplate() {
		...
		this.el = dom.create('div', 'selector selectbox', [this.btnLeft, this.btnRight, this.labelEl]);
		return this.el;
	}
	...
	updateLabel() {
		...
		if (this.selectCallback) this.selectCallback(this.choices[this.selectionIndex]);
