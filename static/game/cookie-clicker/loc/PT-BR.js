AddLanguage('PT-BR', 'portuguese', {
	...
	'%1 sugar lump': ['%1 torrão de açúcar', '%1 torrões de açúcar'],
	'%1 heavenly chip': ['%1 gota divina', '%1 gotas divinas'],
	'%1 golden cookie': ['%1 cookie dourado', '%1 cookies dourados'],
	'%1 building': ['%1 construção', '%1 construções'],
	'%1 upgrade': ['%1 melhoria', '%1 melhorias'],
	Yes: 'Sim',
	No: 'Não',
	...
	'visual improvements; disabling may improve performance':
		'melhorias visuais; desativar pode melhorar o desempenho',
	...
	'display boxes around upgrades and achievements in Stats':
		'exibe caixas perto das melhorias e conquistas nas Estatísticas ',
	'Alt font': 'Fonte alternativa',
	'your cookies are displayed using a monospace font':
		'seus cookies são exibidos com uma fonte monoespaçada',
	...
	'the game will ask you to confirm when you close the window':
		'o jogo vai pedir para você confirmar quando fechar a janela',
	Defocus: 'Desfocar',
	'the game will be less resource-intensive when out of focus':
		'o jogo fará um uso menos intenso dos recursos quando estiver fora de foco ',
	...
	'the game will ask you to confirm before spending sugar lumps':
		'o jogo vai pedir para você confirmar antes de gastar torrões de açúcar',
	'Custom grandmas': 'Vovós personalizadas',
	'some grandmas will be named after Patreon supporters':
		'algumas vovós receberão os nomes dos apoiadores do Patreon ',
	...
	"on slower computers, the game will put itself in sleep mode when it's inactive and starts to lag out; offline CpS production kicks in during sleep mode":
		'em computadores mais lentos, o jogo vai entrar em modo de suspensão quando estiver inativo e começar a ter lag; a produção offline de CpS é iniciada no modo de suspensão',
	'Music in background': 'Música em plano de fundo',
	"music will keep playing even when the game window isn't focused":
		'a música continuará tocando mesmo se a janela do jogo estiver de foco',
	'Cloud saving': 'Salvamento na nuvem',
	'allow use of Steam Cloud for save backups':
		'permite que você use a Nuvem Steam para guardar backups.',
	...
	'allows optimizations for screen readers; game will reload':
		'permite otimizações para leitores de tela. O jogo será reiniciado.',
	'Discord status': 'Status no Discord',
	'if Discord is on, show your game info as activity status':
		'se o Discord estiver ligado, mostra informações do jogo como status de atividade.',
	Language: 'Idioma',
	'Language: %1': 'Idioma: %1',
	...
	'These are feats that are either unfair or difficult to attain. They do not give milk.':
		'Esses são feitos injustos ou difíceis de alcançar. Eles não dão leite.',
	...
	'with %1 ascension': ['com %1 ascensão ', 'com %1 ascensões'],
	...
	'Milk is gained with each achievement. It can unlock unique upgrades over time.':
		'Leite é obtido a cada conquista. Ele pode desbloquear melhorias únicas com o tempo.',
	...
	'Cookie Clicker is a javascript game by %1 and %2.':
		'Cookie Clicker é um jogo em javascript criado por %1 e %2.',
	...
	"This version of Cookie Clicker is 100% free, forever. Want to support us so we can keep developing games? Here's some ways you can help:%1":
		'Esta versão do Cookie Clicker é 100% gratuita, para sempre. Quer nos apoiar para que continuemos desenvolvendo jogos? Aqui estão algumas formas de ajudar:%1',
	"Note: if you find a new bug after an update and you're using a 3rd-party add-on, make sure it's not just your add-on causing it!":
		'Observação: se encontrar algum bug depois de uma atualização e você estiver usando uma extensão de outra empresa, certifique-se de que ele não está sendo causado pela extensão.',
	'Warning: clearing your browser cache or cookies <small>(what else?)</small> will result in your save being wiped. Export your save and back it up first!':
		'Aviso: limpar o cache e os cookies <small>(o que mais?)</small> do seu navegador causará a exclusão do seu arquivo de salvamento. Exporte o seu arquivo de salvamento e faça um backup antes!',
	...
	'This feature is not yet available in your language.':
		'Esse recurso ainda não está disponível no seu idioma.',
	...
	'Cookie Clicker is in sleep mode and generating offline cookies.':
		'O Cookie Clicker está no modo de suspensão e gerando cookies offline.',
	...
	'(this happens when too many frames are skipped at once,<br>usually when the game has been running in the background for a while)<br>(you can turn this feature off in the settings menu)':
		'(isso acontece quando quadros demais são pulados de uma só vez,<br>normalmente quando o jogo fica rodando em segundo plano por um tempo)<br>(você pode desligar essa funcionalidade no menu de configurações)',
	'Are you sure you want to close Cookie Clicker?':
		'Tem certeza que deseja fechar o Cookie Clicker?',
	...
	'Hello again! Just a reminder that you may want to back up your Cookie Clicker save every once in a while, just in case.<br>To do so, go to Options and hit "Export save" or "Save to file"!':
		'Olá de novo! Apenas um lembrete de que talvez você queira fazer um backup do seu arquivo de salvamento do Cookie Clicker de vez em quando, só para garantir.<br>Para fazer isso, vá para Opções e clique em "Exportar salvamento" ou "Salvar em arquivo"!',
	'Save manually (the game autosaves every 60 seconds; shortcut: ctrl+S)':
		'Salvar manualmente (o jogo faz o salvamento automático a cada 60 segundos; atalho: ctrl+S)',
	'You can use this to backup your save or to transfer it to another computer (shortcut for import: ctrl+O)':
		'Você pode usar isso para fazer um backup do seu arquivo de salvamento ou para transferi-lo para outro computador (atalho para importar: ctrl+O)',
	...
	'This is your save code.<br>Copy it and keep it somewhere safe!':
		'Este é o seu código de salvamento.<br>Faça uma cópia e guarde em um lugar seguro!',
	'Import save': 'Importar salvamento',
	'Please paste in the code that was given to you on save export.':
		'Cole o código que foi dado a você quando exportou o salvamento.',
	...
	'Oops, looks like the import string is all wrong!':
		'Opa! Parece que a sequência de importação está toda errada!',
	'You are attempting to load a save from a future version (v. %1; you are using v. %2).':
		'Você está tentando carregar um salvamento de uma versão futura (v. %1; você está usando a v. %2).',
	"Sorry, you can't import saves from the classic version.":
		'Desculpe. Você não pode importar salvamentos da versão clássica.',
	'Wipe save': 'Excluir o salvamento',
	'Delete all your progress, including your achievements':
		'Exclui todo o seu progresso, incluindo suas conquistas',
	'Do you REALLY want to wipe your save?<br><small>You will lose your progress, your achievements, and your heavenly chips!</small>':
		'Deseja MESMO excluir seu salvamento?<br><small>Você vai perder seu progresso, suas conquistas e as suas gotas divinas!</small>',
	"Whoah now, are you really, <b><i>REALLY</i></b> sure you want to go through with this?<br><small>Don't say we didn't warn you!</small>":
		'Espera aí. Você tem certeza <b><i>MESMO</i></b> que quer continuar com isso?<br><small>Não diga que não avisamos!</small>',
	...
	'Only use mods from trusted sources. Some mods may require a game restart to take effect.':
		'Use mods apenas de fontes confiáveis. Alguns mods podem necessitar que o jogo seja reiniciado pra fazerem efeito.',
	Enable: 'Habilitar',
	Disable: 'Desabilitar',
	...
	'This tool allows you to upload new mods to the Steam Workshop.<br>You need to select a mod folder containing a properly-formatted %1 file.<br>See the included sample mods for examples.':
		'Essa ferramenta permite que você carregue novos mods na Oficina Steam.<br>Você precisa selecionar uma pasta de mods contendo um arquivo %1 adequadamente formatado.<br>Veja as amostras de mod inclusas como exemplo.',
	...
	'These are the mods present in your save data. You may delete some of this data to make your save file smaller.':
		'Esses são os mods presentes nos seus dados de salvamento. Você pode excluir alguns desses dados para deixar seu arquivo menor.',
	'(loaded)': '(carregado)',
	'%1 char': ['%1 caractere', '%1 caracteres'],
	...
	'You are currently playing Cookie Clicker on the <b>%1</b> protocol.<br>The <b>%2</b> version uses a different save slot than this one.<br>Click this lock to reload the page and switch to the <b>%2</b> version!':
		'No momento, você está jogando Cookie Clicker no protocolo <b>%1</b>.<br>A versão <b>%2</b> usa um espaço de salvamento diferente desta.<br>Clique nesse cadeado para recarregar a página e mudar para a versão <b>%2</b>!',
	'+%1 more notification.': ['+%1 notificação a mais.', '+%1 notificações a mais.'],
	Christmas: 'Natal',
	...
	"Because you've baked a <b>billion cookies</b> in total, you are now attracting <b>sugar lumps</b>. They coalesce quietly near the top of your screen, under the Stats button.<br>You will be able to harvest them when they're ripe, after which you may spend them on all sorts of things!":
		'Como você assou um <b>bilhão de cookies</b> no total, agora você está atraindo <b>torrões de açúcar</b>. Eles se aderem discretamente na parte superior da sua tela, sob o botão Estatísticas.<br>Você poderá colhê-los quando eles estiverem prontos. Depois disso, você poderá gastá-los em várias coisas!',
	'A <b>sugar lump</b> is coalescing here, attracted by your accomplishments.':
		'Um <b>torrão de açúcar</b> está se aderindo aqui, atraído pelos seus feitos.',
	'Your sugar lumps mature after <b>%1</b>,<br>ripen after <b>%2</b>,<br>and fall after <b>%3</b>.':
		'Seus torrões de açúcar ficam maduros depois de <b>%1</b>,<br>prontos depois de <b>%2</b>,<br>e caem depois de <b>%3</b>.',
	'&bull; Sugar lumps can be harvested when mature, though if left alone beyond that point they will start ripening (increasing the chance of harvesting them) and will eventually fall and be auto-harvested after some time.<br>&bull; Sugar lumps are delicious and may be used as currency for all sorts of things.<br>&bull; Once a sugar lump is harvested, another one will start growing in its place.<br>&bull; Note that sugar lumps keep growing when the game is closed.':
		'• Os torrões de açúcar podem ser colhidos quando estiverem maduros, mas se deixados sozinhos por mais tempo que isso, eles vão começar a ficar prontos (aumentando as chances de colheita) e, eventualmente, vão cair e ser colhidos automaticamente depois de um tempo.<br>• Torrões de açúcar são deliciosos e podem ser usados como moeda para várias coisas.<br>• Quando um torrão de açúcar é colhido, outro vai começar a crescer em seu lugar.<br>• Observe que os torrões continuam crescendo quando o jogo é fechado.',
	'This sugar lump has been exposed to time travel shenanigans and will take an excruciating <b>%1</b> to reach maturity.':
		'Esse torrão de açúcar foi exposto a umas coisas de viagem no tempo e vai levar excruciantes <b>%1</b> para amadurecer.',
	'This sugar lump is still growing and will take <b>%1</b> to reach maturity.':
		'Este torrão de açúcar ainda está crescendo e vai levar <b>%1</b> para amadurecer.',
	"This sugar lump is mature and will be ripe in <b>%1</b>.<br>You may <b>click it to harvest it now</b>, but there is a <b>50% chance you won't get anything</b>.":
		'Este torrão de açúcar está maduro e estará pronto em <b>%1</b>.<br>Você pode <b>clicar para colhê-lo agora</b>, mas há uma chance de <b>50% de você não obter nada</b>.',
	'<b>This sugar lump is ripe! Click it to harvest it.</b><br>If you do nothing, it will auto-harvest in <b>%1</b>.':
		'<b>Este torrão de açúcar está pronto! Clique nele para colher.</b><br>Se você não fizer nada, ele será colhido automaticamente em <b>%1</b>.',
	'This sugar lump grew to be <b>bifurcated</b>; harvesting it has a 50% chance of yielding two lumps.':
		'Este torrão de açúcar começou a se tornar <b>bifurcado</b>; colhê-lo tem uma chance de 50% de render dois torrões de açúcar.',
	'This sugar lump grew to be <b>golden</b>; harvesting it will yield 2 to 7 lumps, your current cookies will be doubled (capped to a gain of 24 hours of your CpS), and you will find 10% more golden cookies for the next 24 hours.':
		'Este torrão de açúcar começou a se tornar <b>dourado</b>; colhê-lo vai render de 2 a 7 torrões, seus cookies atuais serão dobrados (limitados a um ganho de 24 horas do seu CpS), e você encontrará 10% mais cookies dourados pelas próximas 24 horas.',
	'This sugar lump was affected by the elders and grew to be <b>meaty</b>; harvesting it will yield between 0 and 2 lumps.':
		'Este torrão de açúcar foi afetado pelas ancestrais e cresceu até ficar <b>carnudo</b>; colhê-lo vai render entre 0 e 2 torrões.',
	'This sugar lump is <b>caramelized</b>, its stickiness binding it to unexpected things; harvesting it will yield between 1 and 3 lumps and will refill your sugar lump cooldowns.':
		'Este torrão de açúcar é <b>caramelizado</b>, com sua viscosidade o unindo a coisas inesperadas; colhê-lo vai render entre 1 e 3 torrões e vai reabastecer seus tempos de espera de torrões.',
	...
	'Your cookies have been doubled.<br>+10% golden cookies for the next 24 hours.':
		'Seus cookies foram dobrados.<br>+10% de cookies dourados pelas próximas 24 horas.',
	...
	Heralds: 'Arautos',
	'%1 herald': ['%1 arauto', '%1 arautos'],
	"Heralds couldn't be loaded. There may be an issue with our servers, or you are playing the game locally.":
		'Não foi possível carregar os arautos. Talvez nossos servidores estejam com problema, ou pode ser que você esteja jogando localmente.',
	'There are no heralds at the moment. Please consider <b>donating to our Patreon</b>!':
		'Não há nenhum arauto no momento. Considere <b>doar para o nosso Patreon</b>!',
	'selflessly inspiring a boost in production for everyone, resulting in %1.':
		'inspirando, de forma altruísta, um impulso na produção de todos, resultando em %1.',
	'+%1% cookies per second': '+%1% cookies por segundo',
	'You are in a <b>Born again</b> run, and are not currently benefiting from heralds.':
		'Você está em uma sequência de <b>Nascido de novo</b>, e no momento, não se beneficia de arautos.',
	'You own the <b>Heralds</b> upgrade, and therefore benefit from the production boost.':
		'Você possui a melhoria <b>Arautos</b>, portanto, se beneficia do impulso na produção.',
	'To benefit from the herald bonus, you need a special upgrade you do not yet own. You will permanently unlock it later in the game.':
		'Para se beneficiar do bônus do arauto, você precisa de uma melhoria especial que ainda não possui. Você vai desbloqueá-la permanentemente com o avançar do jogo.',
	'<b>Heralds</b> are people who have donated to our highest Patreon tier, and are limited to 100.<br>Each herald gives everyone +1% CpS.<br>Heralds benefit everyone playing the game, regardless of whether you donated.':
		'<b>Arautos</b> são pessoas que doaram para o nível mais alto do nosso Patreon. Eles são limitados a 100.<br>Cada arauto dá +1% CpS para todo mundo.<br>Os arautos beneficiam todos os jogadores, tendo eles doado ou não.',
	'Every %1 current players on Steam generates <b>1 herald</b>, up to %2 heralds.<br>Each herald gives everyone +1% CpS.':
		'Cada %1 jogadores atuais na Steam geram <b>1 arauto</b>, até %2 arautos.<br>Cada arauto dá a todo mundo +1% de CpS.',
	'+%1!': '/',
	...
	'Sweet!<br><small>Found 1 sugar lump!</small>':
		'Legal!<br><small>Encontrou 1 torrão de açúcar!</small>',
	'Lucky!': 'Que sorte!',
	'Ruin!': 'Ruína!',
	...
	'Cookie chain broken.<br><small>You made %1.</small>':
		'Corrente de cookies quebrada.<br><small>Você conseguiu %1.</small>',
	'Cookie blab': [
	...
	'Lets you use two dragon auras simultaneously':
		'Te permite usar duas auras de dragões simultaneamente',
	...
	'<b>One tenth</b> of every other dragon aura, <b>combined</b>.':
		'<b>Um décimo</b> de todas as outras auras de dragão <b>combinadas</b>.',
	'Switching your aura is <b>free</b> because you own no buildings.':
		'Como você não possui nenhuma construção, trocar de aura é <b>grátis</b>.',
	'The cost of switching your aura is <b>%1</b>.<br>This will affect your CpS!':
		'O custo para trocar de aura é <b>%1</b>.<br>Isso vai afetar o seu CpS!',
	...
	'You feel like making cookies. But nobody wants to eat your cookies.':
		'Você tem vontade de fazer cookies. Mas ninguém quer comer seus cookies.',
	'Your first batch goes to the trash. The neighborhood raccoon barely touches it.':
		'A sua primeira fornada vai para o lixo. O guaxinim da vizinhança quase nem toca nela.',
	'Your family accepts to try some of your cookies.':
		'A sua família aceita experimentar alguns dos seus cookies.',
	...
	'People are starting to talk about your cookies.':
		'As pessoas estão começando a falar dos seus cookies.',
	'Your cookies are talked about for miles around.':
		'A quilômetros de distância, as pessoas já falam dos seus cookies.',
	...
	'People come from very far away to get a taste of your cookies.':
		'As pessoas vêm de muito longe para experimentar seus cookies.',
	'Kings and queens from all over the world are enjoying your cookies.':
		'Reis e rainhas do mundo todo gostam dos seus cookies.',
	...
	'A national day has been created in honor of your cookies.':
		'Um feriado nacional foi criado em homenagem aos seus cookies.',
	'Your cookies have been named a part of the world wonders.':
		'Seus cookies foram nomeados parte das maravilhas do mundo.',
	'History books now include a whole chapter about your cookies.':
		'Livros de história agora têm um capítulo inteiro sobre os seus cookies.',
	'Your cookies have been placed under government surveillance.':
		'Seus cookies foram colocados sob a vigilância do governo.',
	...
	'Strange creatures from neighboring planets wish to try your cookies.':
		'Estranhas criaturas de planetas vizinhos gostariam de experimentar os seus cookies.',
	'Elder gods from the whole cosmos have awoken to taste your cookies.':
		'Deusas ancestrais de todo o cosmo acordaram para experimentar seus cookies.',
	'Beings from other dimensions lapse into existence just to get a taste of your cookies.':
		'Seres de outras dimensões passam a existir só para experimentar seus cookies.',
	...
	'The universe has now turned into cookie dough, to the molecular level.':
		'O universo se transformou em massa de cookie em nível molecular.',
	...
	'A local news station runs a 10-minute segment about your cookies. Success!<br><small>(you win a cookie)</small>':
		'Um jornal local faz uma reportagem de 10 minutos sobre os seus cookies. Sucesso!<br><small>(você ganha um cookie)</small>',
	...
	'You gain <b>one hour</b> of your CpS (capped at double your bank).':
		'Você ganha <b>uma hora</b> do seu CpS (limitado ao dobro do seu banco).',
	...
	'Your prestige level is currently <b>%1</b>.<br>(CpS +%2%)':
		'Atualmente, seu nível de prestígio é <b>%1</b>.<br>(CpS +%2%)',
	...
	'Ascending now would grant you<br><b>1 prestige level</b> (+1% CpS)<br>and <b>1 heavenly chip</b> to spend.':
		'Ascender agora te daria<br><b>1 nível de prestígio</b> (+1% CpS)<br>e <b>1 gota divina</b> para gastar.',
	'Ascending now would grant you<br><b>%1 prestige levels</b> (+%2% CpS)<br>and <b>%3 heavenly chips</b> to spend.':
		'Ascender agora te daria<br><b>%1 níveis de prestígio</b> (+%2% CpS)<br>e <b>%3 gotas divinas</b> para gastar.',
	'You need <b>%1 more cookies</b> for the next level.':
		'Você precisa de <b>mais %1 cookies</b> para o próximo nível.',
	'Do you REALLY want to ascend?<div class="line"></div>You will lose your progress and start over from scratch.<div class="line"></div>All your cookies will be converted into prestige and heavenly chips.':
		'Você quer MESMO ascender?<div class="line"></div>Você vai perder o seu progresso e começar de novo do início.<div class="line"></div>Todos os seus cookies serão convertidos em prestígio e gotas divinas.',
	...
	'You will keep your achievements, building levels and sugar lumps.':
		'Você vai continuar com as suas conquistas, níveis de construções e torrões de açúcar.',
	...
	'%1 prestige level': ['%1 nível de prestígio', '%1 níveis de prestígio'],
	...
	"You are ascending.<br>Drag the screen around<br>or use arrow keys!<br>When you're ready,<br>click Reincarnate.":
		'Você está ascendendo.<br>Arraste a tela<br>ou use as setas do teclado!<br>Quando estiver tudo pronto,<br>clique em Reencarnar.',
	'Each prestige level grants you a permanent <b>+%1% CpS</b>.<br>The more levels you have, the more cookies they require.':
		'Cada nível de prestígio te dá <b>+%1% CpS</b> permanentes.<br>Quanto mais níveis tiver, mais cookies serão necessários.',
	'Heavenly chips are used to buy heavenly upgrades.<br>You gain <b>1 chip</b> every time you gain a prestige level.':
		'Gotas divinas são usadas na compra de melhorias divinas.<br>Você ganha <b>1 gota</b> cada vez que ganha um nível de prestígio.',
	"Click this once you've bought<br>everything you need!":
		'Clique nisto quando tiver comprado<br>tudo que você precisa!',
	...
	'Challenge modes apply special modifiers to your next ascension.<br>Click to change.':
		'Modos de desafio aplicam modificadores especiais à sua próxima ascensão.<br>Clique para mudar.',
	...
	"It's <b>Valentine's season</b>!<br>Love's in the air and cookies are just that much sweeter!":
		'É a <b>temporada do Dia dos Namorados</b>!<br>O amor está no ar e os cookies estão um pouco mais doces!',
	'Business Day!': 'Dia dos Negócios!',
	"It's <b>Business season</b>!<br>Don't panic! Things are gonna be looking a little more corporate for a few days.":
		'É a <b>temporada dos negócios</b>!<br>Não entre em pânico! As coisas vão parecer um pouco mais corporativas por alguns dias.',
	'Halloween!': 'Dia das Bruxas!',
	"It's <b>Halloween season</b>!<br>Everything is just a little bit spookier!":
		'É a <b>temporada do Dia das Bruxas</b>!<br>Tudo está um pouco mais assustador!',
	...
	"It's <b>Christmas season</b>!<br>Bring good cheer to all and you just may get cookies in your stockings!":
		'É a <b>temporada do Natal</b>!<br>Se deixar os outros felizes, talvez você ganhe cookies nas suas meias na lareira!',
	'Easter!': 'Páscoa!',
	"It's <b>Easter season</b>!<br>Keep an eye out and you just might click a rabbit or two!":
		'É a <b>temporada de Páscoa</b>!<br>Fique de olho e você pode acabar clicando em um coelho ou dois!',
	'[Tag]Heavenly': 'Divina',
	...
	'Upgrade is vaulted and will not be auto-purchased.':
		'A melhoria está bloqueada e não será comprada automaticamente.',
	...
	'Will <b>instantly purchase</b> every upgrade you can afford, starting from the cheapest one.<br>Upgrades in the <b>vault</b> will not be auto-purchased.<br>You may place an upgrade into the vault by <b>Shift-clicking</b> on it.':
		'<b>Comprará instantaneamente</b> todas as melhorias pelas quais você puder pagar, começando pela mais barata.<br>Melhorias <b>bloqueadas</b> não serão compradas automaticamente.<br>Você pode bloquear uma melhoria com <b>Shift+clique</b>.',
	...
	'all combined, these boosts account for <b>%1</b> per second (<b>%2%</b> of total CpS)':
		'combinados, esses impulsos correspondem a <b>%1</b> por segundo (<b>%2%</b> do CpS total)',
	'owned: %1': 'obtidos: %1',
	'free: %1!': 'grátis: %1!',
	'Level %1 %2': 'Nível %1 %2',
	...
	'Levelling up this building unlocks a minigame.':
		'Subir o nível desta construção desbloqueia um minigame.',
	...
	'Names in white were submitted by our supporters on Patreon.':
		'Os nomes em letras brancas foram enviados por nossos apoiadores no Patreon.',
	'You can also press %1 to bulk-buy or sell %2 of a building at a time, or %3 for %4.':
		'Você também pode pressionar %1 para comprar ou vender %2 de uma construção por vez, ou %3 para %4.',
	Investment: 'Investimento',
	"You're not sure what this does, you just know it means profit.":
		'Você não tem certeza do que isso faz, mas sabe que significa lucro.',
	Cursor: '/',
	cursor: '/',
	cursors: 'cursores',
	'%1 cursor': ['%1 cursor', '%1 cursores'],
	'[Cursor quote]Autoclicks once every 10 seconds.':
		'Clica uma vez a cada 10 segundos automaticamente.',
	...
	'[Mine business quote]These give you the edge you need to outsell those pesky competitors.':
		'Isso te dá a vantagem que você precisa para vender mais do que aqueles competidores irritantes.',
	Factory: 'Fábrica',
	factory: 'fábrica',
	factories: 'fábricas',
	...
	'[Factory business quote]Mass production is the future of baking. Seize the day, and synergize!':
		'A produção em massa é o futuro da feitura de cookies. Aproveite o dia com sinergia!',
	Bank: 'Banco',
	bank: 'banco',
	banks: 'bancos',
	'%1 bank': ['%1 banco', '%1 bancos'],
	...
	"[Bank business quote]Business folks with a nose for profit, ready to finance your venture as long as there's money to be made.":
		'Pessoas de negócios com um bom olho para o lucro e prontos para financiar o seu empreendimento, contanto que seja possível ganhar dinheiro assim.',
	Temple: 'Templo',
	temple: 'templo',
	temples: 'templos',
	...
	'[Temple business quote]Your social media page is going viral! Amassing likes is the key to a lasting online presence and juicy advertising deals.':
		'O seu perfil na internet está viralizando! Acumular curtidas é a chave para uma presença online duradoura e saborosos acordos de publicidade.',
	'Wizard tower': 'Torre de bruxos',
	'wizard tower': 'torre de bruxos',
	'wizard towers': 'torres de bruxos',
	'%1 wizard tower': ['%1 torre de bruxos', '%1 torres de bruxos'],
	...
	'[Wizard tower business quote]Cookie memes are all the rage! With just the right amount of social media astroturfing, your brand image will be all over the cyberspace.':
		'Memes de cookies são muito populares! Com a quantidade certa de manipulação de mídias sociais, a imagem da sua marca vai parar em todos os cantos do ciberespaço.',
	Shipment: 'Carregamento',
	shipment: 'carregamento',
	shipments: 'carregamentos',
	'%1 shipment': ['%1 carregamento', '%1 carregamentos'],
	'[Shipment quote]Brings in fresh cookies from the cookie planet.':
		'Traz cookies frescos do planeta cookie.',
	...
	'[Shipment business quote]A gigantic cookie emporium - your very own retail chain.':
		'Um empório de cookies gigante. A sua própria cadeia de varejo.',
	'Alchemy lab': 'Laboratório de alquimia',
	'alchemy lab': 'laboratório de alquimia',
	'alchemy labs': 'laboratórios de alquimia',
	'%1 alchemy lab': ['%1 laboratório de alquimia', '%1 laboratórios de alquimia'],
	...
	"[Alchemy lab business quote]You're officially on the stock market, and everyone wants a piece!":
		'Você está oficialmente no mercado de ações, e todo mundo quer um pedaço!',
	Portal: '/',
	portal: '/',
	portals: 'portais',
	'%1 portal': ['%1 portal', '%1 portais'],
	...
	'[Portal business quote]Your cookies have their own sitcom! Hilarious baking hijinks set to the cheesiest laughtrack.':
		'Seus cookies têm o próprio seriado de TV! Palhaçadas hilárias ao fazer cookies, acompanhadas de risadas falsas.',
	'Time machine': 'Máquina do tempo',
	'time machine': 'máquina do tempo',
	'time machines': 'máquinas do tempo',
	'%1 time machine': ['%1 máquina do tempo', '%1 máquinas do tempo'],
	'[Time machine quote]Brings cookies from the past, before they were even eaten.':
		'Traz cookies do passado, antes mesmo de eles terem sido comidos.',
	...
	'[Time machine business quote]Cookie theme parks, full of mascots and roller-coasters. Build one, build a hundred!':
		'Parques com o tema cookies, cheios de mascotes e montanhas-russas. Construa uma, construa uma centena!',
	'Antimatter condenser': 'Condensador antimatéria',
	'antimatter condenser': 'condensador antimatéria',
	'antimatter condensers': 'condensadores antimatéria',
	'%1 antimatter condenser': ['%1 condensador antimatéria', '%1 condensadores antimatéria'],
	'[Antimatter condenser quote]Condenses the antimatter in the universe into cookies.':
		'Condensa a antimatéria do universo em cookies.',
	...
	'[Antimatter condenser business quote]A virtual currency, already replacing regular money in some small countries.':
		'Uma moeda virtual que já está substituindo o dinheiro comum em alguns países pequenos.',
	Prism: 'Prisma',
	prism: 'prisma',
	prisms: 'prismas',
	...
	"[Prism business quote]You've made it to the top, and you can now buy entire nations to further your corporate greed. Godspeed.":
		'Você chegou ao topo, e agora você pode comprar nações inteiras para expandir a sua ganância corporativa. Vá com Deus.',
	Chancemaker: 'Criador do acaso',
	chancemaker: 'criador do acaso',
	chancemakers: 'criadores do acaso',
	'%1 chancemaker': ['%1 criador do acaso', '%1 criadores do acaso'],
	'[Chancemaker quote]Generates cookies out of thin air through sheer luck.':
		'Gera cookies repentinamente através de pura sorte.',
	...
	"[Chancemaker business quote]Actually, you know what's cool? A whole planet dedicated to producing, advertising, selling, and consuming your cookies.":
		'Na verdade, você sabe o que é legal? Um planeta inteiro dedicado a produzir, propagandear, vender e consumir seus cookies.',
	'Fractal engine': 'Motor fractal',
	'fractal engine': 'motor fractal',
	'fractal engines': 'motores fractais',
	'%1 fractal engine': ['%1 motor fractal', '%1 motores fractais'],
	'[Fractal engine quote]Turns cookies into even more cookies.':
		'Transforma cookies em ainda mais cookies.',
	...
	'[Fractal engine business quote]Only through political dominion can you truly alter this world to create a brighter, more cookie-friendly future.':
		'Apenas através da dominação política você poderá alterar de verdade este mundo para criar um futuro mais iluminado e inclinado aos cookies.',
	'Javascript console': 'Console de javascript',
	'javascript console': 'console de javascript',
	'javascript consoles': 'consoles de javascript',
	'%1 javascript console': ['%1 console de javascript', '%1 consoles de javascript'],
	'[Javascript console quote]Creates cookies from the very code this game was written in.':
		'Cria cookies a partir do próprio código no qual este jogo foi escrito.',
	...
	'[Javascript console business quote]Taking many forms -religion, culture, philosophy- a doctrine may, when handled properly, cause a lasting impact on civilizations, reshaping minds and people and ensuring all future generations share a singular goal - the production, and acquisition, of more cookies.':
		'Assumindo várias formas — religião, cultura, filosofia —, a doutrina, se usada adequadamente, pode causar um impacto duradouro nas civilizações, remodelando mentes e pessoas, e garantindo que as futuras gerações compartilhem um único objetivo — a produção e aquisição de mais cookies.',
	Idleverse: 'Ocioverso',
	idleverse: 'ocioverso',
	idleverses: 'ocioversos',
	'%1 idleverse': ['%1 ocioverso', '%1 ocioversos'],
	"[Idleverse quote]There's been countless other idle universes running alongside our own. You've finally found a way to hijack their production and convert whatever they've been making into cookies!":
		'Já houve incontáveis ocioversos em funcionamento ao mesmo tempo que o nosso. Você finalmente encontrou uma forma de roubar a produção deles e converter o que quer que eles estivessem fazendo em cookies!',
	...
	'[Idleverse business quote]Sometimes the best way to keep going up is sideways. Diversify your ventures through non-cookie investments.':
		'Às vezes, a melhor maneira de continuar é de lado. Diversifique as suas aventuras em investimentos não relacionados a cookies. ',
	'Cortex baker': 'Confeiteiro de córtex',
	'cortex baker': 'confeiteiro de córtex',
	'cortex bakers': 'confeiteiros de córtex',
	'%1 cortex baker': ['%1 confeiteiro de córtex', '%1 confeiteiros de córtex'],
	'[Cortex baker quote]These artificial brains the size of planets are capable of simply dreaming up cookies into existence. Time and space are inconsequential. Reality is arbitrary.':
		'Esses cérebros artificiais do tamanho de planetas são capazes de criar cookies só sonhando com eles. Tempo e espaço são inconsequentes. A realidade é arbitrária.',
	...
	"[Cortex baker business quote]There's only so many ways you can bring in more profit. Or is there? Hire the most brilliant experts in the known universe and let them scrape their brains for you!":
		'Existe um limite nos jeitos de obter mais lucro. Ou será que não? Contrate os especialistas mais brilhantes no universo conhecido e deixa eu vasculhar o cérebro deles por você!',
	CpS: '/',
	...
	'All cookie production <b>multiplied by %1</b>.':
		'Toda a produção de cookies <b>multiplicada por %1</b>.',
	'+%1 CpS': '/',
	...
	'Tiered upgrades for <b>%1</b> provide an extra <b>+%2%</b> production.<br>Only works with unshackled upgrade tiers.':
		'Melhorias de categoria para <b>%1</b> dão <b>+%2%</b> de produção extra.<br>Só funciona com categorias melhoria libertadas.',
	'Unshackles all <b>%1-tier upgrades</b>, making them more powerful.<br>Only applies to unshackled buildings.':
		'Liberta todas as <b>melhorias de categoria %1</b>, tornando-os mais poderosos.<br>Só se aplica a construções libertadas.',
	'The mouse and cursors are <b>twice</b> as efficient.':
		'O mouse e os cursores são <b>duas vezes</b> mais poderosos.',
	'The mouse and cursors gain <b>+%1</b> cookies for each non-cursor building owned.':
		'Os mouses e os cursores ganham <b>+%1</b> cookies para cada construção sem cursor possuída.',
	'Grandmas gain <b>+%1% CpS</b> for each non-grandma building.':
		'As vovós ganham <b>+%1% CpS</b> para cada construção sem vovós.',
	'You gain <b>more CpS</b> the more milk you have.':
		'Quanto mais leite você tiver, <b>mais CpS</b> você ganha.',
	...
	'Cookie production multiplier <b>+%1% permanently</b>.':
		'Multiplicador da produção de cookies <b>+%1% permanentemente</b>.',
	"Cookie production multiplier <b>+%1% per Santa's levels.</b>":
		'Multiplicador da produção de cookies <b>+%1% por nível do Papai Noel.</b>',
	'Cookie production multiplier <b>+%1%</b> for every year Cookie Clicker has existed (currently: <b>+%2%</b>).':
		'Multiplicador da produção de cookies <b>+%1%</b> para cada ano de existência do Cookie Clicker (atualmente: <b>+%2%</b>).',
	'Cookie production multiplier <b>+%1%</b> for every building type level %2 or higher.':
		'Multiplicador da produção de cookies <b>+%1%</b> para cada tipo de construção de nível %2 ou mais alto.',
	...
	'Grandma-operated science lab and leisure club.<br>Grandmas are <b>4 times</b> as efficient.<br><b>Regularly unlocks new upgrades</b>.':
		'Laboratório de ciências e clube de lazer operado por vovós<br>As vovós são <b>4 vezes</b> mais eficientes.<br><b>Desbloqueia novas melhorias regularmente</b>.',
	...
	'Note: the grandmothers are growing restless. Do not encourage them.':
		'Observação: as vovós estão ficando inquietas. Não as encoraje.',
	'Note: proceeding any further in scientific research may have unexpected results. You have been warned.':
		'Observação: continuar com as pesquisas científicas pode ter resultados inesperados. O aviso foi dado.',
	...
	"<b>Warning:</b> purchasing this will have unexpected, and potentially undesirable results!<br><small>It's all downhill from here. You have been warned!</small><br><br>Purchase anyway?":
		'<b>Aviso:</b> comprar isso terá resultados inesperados e potencialmente indesejados!<br><small>É só ladeira abaixo a partir daqui. O aviso foi dado!</small><br><br>Comprar assim mesmo?',
	'Contains the wrath of the elders, at least for a while.':
		'Contém a ira das ancestrais, pelo menos por um tempo.',
	"Puts a permanent end to the elders' wrath, at the cost of %1% of your CpS.":
		'Põe um fim permanente à ira das ancestrais, pelo custo de %1% do seu CpS.',
	'You will get %1% of your CpS back, but the grandmatriarchs will return.':
		'Você vai receber %1% do seu CpS de volta, mas as vótriarcas retornarão.',
	...
	'Golden cookies appear <b>twice as often</b> and stay <b>twice as long</b>.':
		'Os cookies dourados aparecem <b>com o dobro da frequência</b> e ficam <b>pelo dobro do tempo</b>.',
	'Golden cookies appear <b>%1%</b> more often.':
		'Cookies dourados aparecem com uma frequência <b>%1%</b> maior.',
	'Golden cookies appear <b>%1%</b> more often during %2.':
		'Cookies dourados aparecem com uma frequência <b>%1%</b> maior durante %2.',
	'Golden cookies appear <b>really often</b>.':
		'Cookies dourados aparecem <b>com muita frequência</b>.',
	'Golden cookie effects last <b>twice as long</b>.':
		'Os efeitos dos cookies dourados duram <b>o dobro do tempo</b>.',
	'Golden cookie effects last <b>%1%</b> longer.':
		'Os efeitos dos cookies dourados duram <b>%1%</b> mais.',
	...
	'<b>+%1% CpS</b> per golden cookie on-screen, multiplicative.':
		'<b>+%1% CpS</b> por cookie dourado na tela. Multiplicativo.',
	'With no buffs and no golden cookies on screen, selling your most powerful building has <b>%1% chance to summon one</b>.':
		'Sem vantagens e cookies dourados na tela, vender a sua construção mais poderosa te dá uma <b>chance de %1% de invocar um</b>.',
	'Confers various powers to your minigames while active.<br>See the bottom of each minigame for more details.':
		'Confere vários poderes aos seus minijogos quando ativo.<br>Veja embaixo de cada minijogo para mais detalhes.',
	...
	'Can toggle upgrades on and off at will in the stats menu.':
		'Você pode ligar e desligar as melhorias quando quiser no menu de estatísticas.',
	'You keep producing cookies even while the game is closed.':
		'Você continua produzindo cookies mesmo com o jogo fechado.',
	'Unlocks <b>%1%</b> of the potential of your prestige level.':
		'Desbloqueia <b>%1%</b> do potencial do seu nível de prestígio.',
	'Subsequent research will be <b>%1 times</b> as fast.':
		'A pesquisa subsequente será <b>%1 vezes</b> mais rápida.',
	'Wrinklers appear <b>%1 times</b> as fast.':
		'Os enrugadores aparecem <b>%1 vezes</b> mais rápido.',
	...
	'Wrinklers explode into <b>%1% more cookies</b>.':
		'Os enrugadores explodem em <b>%1% mais cookies</b>.',
	...
	'Reindeer appear <b>%1%</b> more often.':
		'As renas aparecem com uma frequência <b>%1%</b> maior.',
	'Reindeer appear <b>twice as frequently</b>.':
		'As renas aparecem com uma frequência <b>duas vezes maior</b>.',
	...
	'Buildings sell back for <b>%1%</b> instead of %2%.':
		'Em vez de %2%, as construções são vendidas por <b>%1%</b>.',
	...
	'All buildings and upgrades are <b>%1% cheaper</b>.':
		'Todas as construções e melhorias são <b>%1% mais baratas</b>.',
	'%1 are <b>%2%</b> more efficient and <b>%3%</b> cheaper.':
		'%1 são <b>%2%</b> mais eficientes e <b>%3%</b> mais baratos.',
	'Cookie upgrades are <b>%1 times cheaper</b>.':
		'As melhorias de cookies são <b>%1 vezes mais baratas</b>.',
	...
	'Allows you to <b>trigger seasonal events</b> at will, for a price.':
		'Permite que você <b>acione eventos de temporada</b> quando quiser, por um preço.',
	'Triggers <b>%1 season</b> for the next 24 hours.<br>Triggering another season will cancel this one.<br>Cost scales with unbuffed CpS and increases with every season switch.':
		'Aciona a <b>temporada %1</b> pelas próximas 24 horas.<br>Acionar outra temporada vai cancelar a atual.<br>O custo aumenta com o CpS sem vantagem e com cada mudança de temporada.',
	...
	"You haven't switched seasons this ascension yet.":
		'Você ainda não mudou de temporada nesta ascensão.',
	"You've switched seasons <b>once</b> this ascension.":
		'Você mudou de temporada <b>uma vez</b> nesta ascensão.',
	"You've switched seasons <b>%1 times</b> this ascension.":
		'Você mudou de temporada <b>%1 vezes</b> nesta ascensão.',
	'Cookie production <b>multiplied by 1,000</b>.':
		'Produção de cookies <b>multiplicada por 1.000</b>.',
	'Other eggs appear <b>%1% more frequently</b>.':
		'Outros ovos aparecem com <b>%1% mais frequência</b>.',
	...
	'Christmas cookies drop <b>%1%</b> more often.':
		'Cookies de Natal são gerados com uma frequência <b>%1%</b> maior.',
	'Spooky cookies drop <b>%1%</b> more often.':
		'Cookies assustadores são gerados com uma frequência <b>%1%</b> maior.',
	'Heart cookies are <b>%1%</b> more powerful.':
		'Cookies de coração são <b>%1%</b> mais poderosos.',
	"You continually gain <b>more CpS the longer you've played</b> in the current ascension.":
		'Você continuamente ganha <b>mais CpS quanto mais tempo você tiver jogado</b> na ascensão atual.',
	...
	'Placing an upgrade in this slot will make its effects <b>permanent</b> across all playthroughs.':
		'Colocar uma melhoria neste espaço vai tornar seus efeitos <b>permanente</b> para cada vez que você jogar.',
	...
	'Here are all the upgrades you\'ve purchased last playthrough.<div class="line"></div>Pick one to permanently gain its effects!<div class="line"></div>You can reassign this slot anytime you ascend.':
		'Aqui estão todas as melhorias que você comprou na última vez que jogou.<div class="line"></div>Escolha uma para ganhar seus efeitos permanentemente!<div class="line"></div>Você pode reatribuir este espaço toda vez que ascender.',
	...
	'You gain another <b>+%1%</b> of your regular CpS while the game is closed.':
		'Você ganha mais <b>+%1%</b> do seu CpS padrão enquanto o jogo estiver fechado.',
	'You gain another <b>+%1%</b> of your regular CpS while the game is closed, for a total of <b>%2%</b>.':
		'Você ganha mais <b>+%1%</b> do seu CpS padrão enquanto o jogo estiver fechado, atingindo um total de <b>%2%</b>.',
	...
	'Allows you to purchase a <b>crumbly egg</b> once you have earned 1 million cookies.':
		'Permite que você compre um <b>ovo quebradiço</b> depois de ter ganhado 1 milhão de cookies.',
	'Unlocks the <b>cookie dragon egg</b>.': 'Desbloqueia o <b>ovo do dragão de cookie</b>.',
	'Synergy upgrades are <b>%1% cheaper</b>.':
		'As melhorias de sinergia se tornam <b>%1% mais baratas</b>.',
	'You retain optimal cookie production while the game is closed for <b>%1 more days</b>.':
		'Você mantém a produção ideal de cookies enquanto o jogo estiver fechado por <b>%1 mais dias</b>.',
	'You retain optimal cookie production while the game is closed for twice as long, for a total of <b>%1</b>.':
		'Você mantém a produção ideal de cookies enquanto o jogo estiver fechado pelo dobro do tempo, atingindo um total de <b>%1</b>.',
	'Unlocks the <b>golden switch</b>, which passively boosts your CpS by %1% but disables golden cookies.':
		'Desbloqueia o <b>interruptor dourado</b>, que reforça passivamente o seu CpS em %1%, mas desabilita os cookies dourados.',
	'Turning this on will give you a passive <b>+%1% CpS</b>, but prevents golden cookies from spawning.<br>Cost is equal to 1 hour of production.':
		'Ligar isso vai te dar uma produção passiva de <b>+%1% do CpS</b>, mas impede que cookies dourados surjam.<br>O custo é igual a 1 hora de produção.',
	'The switch is currently giving you a passive <b>+%1% CpS</b>; it also prevents golden cookies from spawning.<br>Turning it off will revert those effects.<br>Cost is equal to 1 hour of production.':
		'Atualmente, o interruptor está te dando uma produção passiva de <b>+%1% do CpS</b>; ele também impede que cookies dourados surjam.<br>Desligá-lo reverterá esses efeitos.<br>O custo é igual a 1 hora de produção.',
	'Unlocks the <b>milk selector</b>, letting you pick which milk is displayed under your cookie.<br>Comes with a variety of basic flavors.':
		'Desbloqueia o <b>seletor de leite</b>, o que permite que você escolha qual leite é exibido sob o seu cookie.<br>Vem com uma variedade de sabores básicos.',
	'Contains more exotic flavors for your milk selector.':
		'Contém mais sabores exóticos para o seu seletor de leite.',
	'Lets you pick what flavor of milk to display.':
		'Deixa você escolher qual sabor de leite exibir.',
	'Unlocks the <b>golden cookie sound selector</b>, which lets you pick whether golden cookies emit a sound when appearing or not.':
		'Desbloqueia o <b>seletor de som de cookie dourado</b>, que permite que você escolha se os cookies dourados emitem um som ao aparecer ou não.',
	'Lets you change the sound golden cookies make when they spawn.':
		'Deixa você mudar o som que os cookies dourados fazem quando eles surgem.',
	'No sound': 'Sem som',
	Chime: 'Sino',
	Fortune: 'Destino',
	Cymbal: 'Pratos',
	...
	'Unlocks the <b>jukebox</b>, which allows you to play through every sound file in the game.':
		'Libera a <b>jukebox</b>, que permite que você ouça cada arquivo de som do jogo.',
	...
	"Unlocks the <b>background selector</b>, letting you select the game's background.<br>Comes with a variety of basic flavors.":
		'Desbloqueia o <b>seletor de plano de fundo</b>, permitindo que você selecione o plano de fundo do jogo.<br>Vem com uma variedade de sabores básicos.',
	...
	'While the golden switch is on, you gain an additional <b>+%1% CpS</b> per golden cookie upgrade owned.':
		'Enquanto o interruptor dourado estiver ligado, você ganha <b>+%1% CpS</b> por cada melhoria de cookie dourado que possuir.',
	'All upgrades are <b>%1% cheaper per %2</b>.':
		'Todas as melhorias são <b>%1% mais baratas por %2</b>.',
	'Unlocks a new tier of upgrades that affect <b>2 buildings at the same time</b>.<br>Synergies appear once you have <b>%1</b> of both buildings.':
		'Desbloqueia um novo nível de melhorias que afetam <b>2 construções ao mesmo tempo</b>.<br>Sinergias aparecem uma vez que você tiver <b>%1</b> das duas construções.',
	'Golden cookies (and all other things that spawn, such as reindeer) have <b>%1% chance of being doubled</b>.':
		'Cookies dourados (e todas as outras coisas que surgem, como renas) têm <b>%1% de chance de serem dobrados</b>.',
	'Cookie production <b>reduced to 0</b>.': 'Produção de cookies <b>reduzida a 0</b>.',
	'Sugar lumps coalesce <b>a whole lot faster</b>.':
		'Torrões de açúcar aderem <b>bem mais rápido</b>.',
	'<b>+%1%</b> prestige level effect on CpS.':
		'<b>+%1%</b> no efeito do nível de prestígio em CpS.',
	'<b>+%1%</b> prestige level effect on CpS.<br><b>+%2%</b> golden cookie effect duration.<br><b>+%3%</b> golden cookie lifespan.':
		'<b>+%1%</b> no efeito do nível de prestígio em CpS.<br><b>+%2%</b> no efeito da duração do cookie dourado.<br><b>+%3%</b> no tempo de vida do cookie dourado.',
	'Each unspent sugar lump (up to %1) gives <b>+%2% CpS</b>.<div class="warning">Note: this means that spending sugar lumps will decrease your CpS until they grow back.</div>':
		'Cada torrão de açúcar não usado (até %1) dá <b>+%2% CpS</b>.<div class="warning">Aviso: isso significa que usar os torrões de açúcar vai reduzir seus CpS até que eles cresçam de volta.</div>',
	'Once an ascension, you may use the "Sugar frenzy" switch to <b>triple your CpS</b> for 1 hour, at the cost of <b>1 sugar lump</b>.':
		'Uma vez por ascensão, você pode usar o interruptor de "Frenesi de açúcar" para <b>triplicar seu CpS</b> por 1 hora, pelo custo de <b>1 torrão de açúcar</b>.',
	'Each grandma (up to %1) makes sugar lumps ripen <b>%2</b> sooner.':
		'Cada vovó (até %1) faz com que os torrões de açúcar fiquem prontos <b>%2</b> mais rápido.',
	'Activating this will <b>triple your CpS</b> for 1 hour, at the cost of <b>1 sugar lump</b>.':
		'Ativar isso vai <b>triplicar seus CpS</b> por 1 hora, pelo custo de <b>1 torrão de açúcar</b>.',
	...
	'Garden plants grow every second.<br>Garden seeds are free to plant.<br>You can switch soils at any time.':
		'As plantas do jardim crescem a cada segundo.<br>As sementes do jardim são grátis para o plantio.<br>Você pode trocar de solo a qualquer momento.',
	...
	'Sugar lumps are <b>twice as likely</b> to be unusual.':
		'Pedaços de açúcar têm <b>duas vezes mais probabilidade</b> de serem incomuns.',
	...
	'Bifurcated sugar lumps appear <b>%1% more often</b> and are <b>%2% more likely</b> to drop 2 lumps.':
		'Torrões de açúcar bifurcados aparecem com <b>%1% mais frequência</b> e têm <b>%2% mais chance</b> de deixar 2 torrões.',
	'Mouse over a wrinkler to see how many cookies are in its stomach.':
		'Passe o cursor por cima de um enrugador para ver quantos cookies ele tem no estômago.',
	'Unlocks the <b>Buy all</b> feature, which lets you instantly purchase every upgrade in your store (starting from the cheapest one).<br>Also unlocks the <b>Vault</b>, a store section where you can place upgrades you do not wish to auto-buy.':
		'Desbloqueia a funcionalidade <b>Comprar tudo</b>, que deixa você automaticamente comprar cada melhoria na sua loja (começando com a mais barata).<br>Também libera o <b>Bloqueio</b>, uma seção da loja onde você pode colocar as melhorias que não desejar comprar automaticamente.',
	'Mouse over an upgrade to see its tier.<br><small>Note: only some upgrades have tiers. Tiers are purely cosmetic and have no effect on gameplay.</small>':
		'Passe o cursor por cima de uma melhoria para ver sua categoria.<br><small>Aviso: apenas algumas melhorias possuem categorias. Categorias são apenas por estética e não têm efeito na jogabilidade.</small>',
	'You now benefit from the boost provided by <b>heralds</b>.<br>Each herald gives you <b>+1% CpS</b>.<br>Look on the purple flag at the top to see how many heralds are active at any given time.':
		'Você agora se beneficia do impulso dos <b>arautos</b>.<br>Cada arauto dá <b>+1% CpS</b>.<br>Olhe a bandeira roxa no topo para ver quantos arautos estão ativos em um determinado momento.',
	'Seasonal random drops have a <b>1/5 chance</b> to carry over through ascensions.':
		'Itens sazonais aleatórios têm <b>uma chance de 1 em 5</b> de serem levados junto em ascensões.',
	"Unlocks <b>extra price information</b>.<br>Each displayed cost now specifies how long it'll take you to afford it, and how much of your bank it represents.":
		'Desbloqueia <b>informação extra sobre preços</b>.<br>Cada custo exibido agora especifica quanto tempo você levará para pagá-lo e quanto do seu saldo ele representa.',
	'Unlocks the <b>shimmering veil</b>, a switch that passively boosts your CpS by <b>%1%</b>.<br>You start with the veil turned on; however, it is very fragile, and clicking the big cookie or any golden cookie or reindeer will turn it off, requiring %2 of CpS to turn back on.':
		'Desbloqueia <b>véu citilante</b>, um interruptor que passivamente dá um impulso de <b>%1%</b> aos seus CpS.<br>Você começa com o véu ligado; no entanto, ele é muito frágil, e clicar no cookie grande ou em qualquer cookie dourado ou rena o desligará, e será necessário %2 CpS para ligar de volta.',
	'Boosts your cookie production by <b>%1%</b> when active.<br>The veil is very fragile and will break if you click the big cookie or any golden cookies or reindeer.<br><br>Once broken, turning the veil back on costs %2 of unbuffed CpS.':
		'Aumenta sua produção de cookies em <b>%1%</b> quando ativo.<br>O véu é muito frágil e se partirá se você clicar no cookie grande ou em qualquer cookie dourado ou rena.<br><br>Uma vez partido, o custo para ligar o véu novamente é de %2 CpS sem vantagens.',
	...
	'The <b>shimmering veil</b> is more resistant, and has a <b>%1% chance</b> not to break. It also gives <b>+%2%</b> more CpS.':
		'O <b>véu citilante</b> é mais resistente e tem <b>%1% de chance</b> de não partir. Ele também dá <b>+%2%</b> CpS.',
	'Active.': 'Ativo.',
	'The reinforced membrane protects the shimmering veil.':
		'A membrana reforçada protege o véu cintilante.',
	...
	'Prior to purchasing the <b>%1</b> upgrade in a run, random drops are <b>%2 times more common</b>.':
		'Antes de comprar a melhoria <b>%1</b> em uma sequência, itens aleatórios são <b>%2 vezes mais comuns</b>.',
	...
	"You don't know what you have until you've lost it.":
		'Você não sabe o valor do que tem até perder.',
	...
	'The news ticker may occasionally have <b>fortunes</b>, which may be clicked for something good.':
		'O quadro de notícias pode ter <b>sortes</b> de vez em quando, você pode clicar nelas para ganhar algo bom.',
	'Through clever accounting, this actually makes kitten upgrades <b>%1% cheaper</b>.':
		'Por meio de contabilidade inteligente, isso torna as atualizações de gatinhos <b>%1% mais baratas</b>.',
	'Unlocks the ability to <b>pet your dragon</b> by clicking on it once hatched.':
		'Desbloqueia a habilidade de <b>fazer carinho no seu dragão</b> ao clicar nele depois que ele nascer.',
	'Cost scales with CpS, but %1 times cheaper with a fully-trained dragon.':
		'O custo aumenta com os CpS, mas é %1 vezes mais barato com um dragão totalmente treinado.',
	'Golden cookies may trigger a <b>Dragon Harvest</b>.':
		'Cookies dourados podem ativar uma <b>Colheita Dracônica</b>.',
	'Golden cookies may trigger a <b>Dragonflight</b>.':
		'Cookies dourados podem ativar <b>Voo do Dragão</b>.',
	'Dragon harvest and Dragonflight are <b>%1% stronger</b>.':
		'Colheita Dracônica e Voo do Dragão são <b>%1% mais fortes</b>.',
	'Kittens are <b>%1%</b> more effective.': 'Gatinhos são <b>%1%</b> mais eficientes.',
	'Each kitten upgrade boosts %1 CpS by <b>%2%</b>.':
		'Cada melhoria de gatinho aumenta CpS de %1 em <b>%2%</b>.',
	...
	'Cursor levels boost clicks by <b>%1%</b> each (up to cursor level %2).':
		'Níveis de cursor aumentam cliques em <b>%1%</b> cada (até nível %2 de cursor).',
	'<b>%1</b> are now effective up to cursor level %2.':
		'<b>%1</b> agora são eficazes até nível %2 de cursor.',
	...
	'Golden and wrath cookie effect duration +%1%.':
		'Duração do efeito dos cookies dourados e furiosos +%1%.',
	...
	'Selling buildings triggers a buff boosted by how many buildings were sold.':
		'Vender construções ativa um buff, ampliado pela quantidade de construções vendidas.',
	'Buff boosts clicks by +%1% for every building sold for %2 seconds.':
		'O buff aumenta os cliques em +%1% para cada construção vendida por %2 segundos.',
	'CpS bonus fluctuating between %1 and %2 over time.':
		'Bônus de CpS flutuando entre %1 e %2 ao longo do tempo.',
	...
	'All golden cookies are wrath cookies with a greater chance of a negative effect.':
		'Todos os cookies dourados são cookies furiosos com maior chance de efeito negativo.',
	'Wrinklers appear %1% faster and digest %2% more cookies.':
		'Enrugadores aparecem %1% mais rápido e digerem %2% mais cookies.',
	'Effect is only active when your total amount of buildings ends with 0.':
		'O efeito só estará ativo quando o total de construções terminar com 0.',
	...
	'Make <b>%1</b> by only having clicked <b>%2 times</b>.':
		'Faça <b>%1</b> só tendo clicado <b>%2 times</b>.',
	'Make <b>%1</b> with <b>no</b> cookie clicks.':
		'Faça <b>%1</b> sem ter clicado no cookie <b>nenhuma</b> vez.',
	'Get to <b>%1</b> baked with <b>no upgrades purchased</b>.':
		'Chegue a <b>%1</b> assados sem comprar <b>nenhuma</b> melhoria.',
	...
	'Have at least <b>1 of the most expensive object, 2 of the second-most expensive, 4 of the next</b> and so on (capped at %1).':
		'Tenha pelo menos <b>1 do objeto mais caro, 2 do segundo mais caro, 4 do próximo</b> e assim por diante (máximo de %1).',
	'Have at least <b>10 of the most expensive object, 20 of the second-most expensive, 30 of the next</b> and so on.':
		'Tenha pelo menos <b>10 do objeto mais caro, 20 do segundo mais caro, 30 do próximo</b> e assim por diante.',
	...
	'Appease the grandmatriarchs at least <b>once</b>.':
		'Apazigue as vótriarcas pelo menos <b>uma vez</b>.',
	'Appease the grandmatriarchs at least <b>%1 times</b>.':
		'Apazigue as vótriarcas pelo menos <b>%1 vezes</b>.',
	...
	'Unlock <b>100%</b> of your heavenly chips power.':
		'Desbloqueie <b>100%</b> do seu poder de gotas celestiais.',
	'You have <b>1 chance in %1</b> every second of earning this achievement.':
		'Você tem <b>1 chance e %1</b> por segundo de ganhar essa conquista.',
	...
	'Unlock <b>every Halloween-themed cookie</b>.<div class="line"></div>Owning this achievement makes Halloween-themed cookies drop more frequently in future playthroughs.':
		'Desbloqueie <b>todos os cookies com tema de Halloween</b>.<div class="line"></div>Ter essa conquista faz com que os cookies com tema de Halloween apareçam com mais frequência em partidas futuras.',
	...
	'Unlock <b>every Christmas-themed cookie</b>.<div class="line"></div>Owning this achievement makes Christmas-themed cookies drop more frequently in future playthroughs.':
		'Desbloqueie <b>todos os cookies com tema de Natal</b>.<div class="line"></div>Ter essa conquista faz com que os cookies com tema de Natal apareçam com mais frequência em partidas futuras.',
	'Pop <b>1 reindeer</b>.': 'Estoure <b>1 rena</b>.',
	'Pop <b>%1 reindeer</b>.': 'Estoure <b>%1 renas</b>.',
	'Pop a reindeer <b>during an elder frenzy</b>.':
		'Estoure uma rena <b>durante um frenesi ancestral</b>.',
	'Unlock <b>every Valentine-themed cookie</b>.':
		'Desbloqueia <b>todos os cookies com tema de Dia dos Namorados</b>.',
	'Click the tiny cookie.': 'Clique no minicookie.',
	'This is for baking %1 and making it on the local news.':
		'Isso é por assar %1 e chegar ao noticiário local.',
	'Name yourself <b>Orteil</b>.<div class="warning">Note: usurpers incur a -%1% CpS penalty until they rename themselves something else.</div>':
		'Coloque seu nome como <b>Orteil</b>.<div class="warning">Aviso: usurpadores têm uma penalidade de -%1% CpS até que troquem o nome para outra coisa.</div>',
	...
	'Unlock <b>all the eggs</b>.<div class="line"></div>Owning this achievement makes eggs drop more frequently in future playthroughs.':
		'Desbloqueie <b>todos os ovos</b>.<div class="line"></div>Ter essa conquista faz com que os ovos apareçam com mais frequência em partidas futuras.',
	...
	'Own <b>%1</b> upgrades and <b>%2</b> buildings.':
		'Adquira <b>%1</b> melhorias e <b>%2</b> construções.',
	'Own <b>%1</b> heavenly upgrades.': 'Tenha <b>%1</b> melhorias divinas.',
	'Burst the near-extinct <b>shiny wrinkler</b>.':
		'Exploda o quase extinto <b>enrugador brilhante</b>.',
	'Click a golden cookie <b>less than 1 second after it spawns</b>.':
		'Clique em um cookie dourado <b>em menos de um segundo depois que ele surgir</b>.',
	'Click a golden cookie <b>less than 1 second before it dies</b>.':
		'Clique em um cookie dourado <b>menos de um segundo antes de ele sumir</b>.',
	...
	"Successfully harvest a coalescing sugar lump before it's ripe.":
		'Colha com sucesso um torrão de açúcar antes que ele fique pronto.',
	...
	'Have <b>%1</b> golden cookies simultaneously.':
		'Tenha <b>%1</b> cookies dourados ao mesmo tempo.',
	'Manage a cookie legacy for <b>at least a year</b>.':
		'Administre um legado de cookies por <b>pelo menos um ano</b>.',
	...
	'Fill every tile of the biggest garden plot with plants.':
		'Preencha todos os espaços do maior terreno do jardim com plantas.',
	...
	'Convert a complete seed log into sugar lumps by sacrificing your garden to the sugar hornets.<div class="line"></div>Owning this achievement makes seeds <b>%1% cheaper</b>, plants mature <b>%2% sooner</b>, and plant upgrades drop <b>%3% more</b>.':
		'Converta um registro de sementes completo em torrões de açúcar sacrificando seu jardim às vespas de açúcar.<div class="line"></div>Ter essa conquista torna as sementes <b>%1% mais baratas</b>, as plantas amadurecem <b>%2% mais rápido</b> e as melhorias de planta caem <b>%3% mais</b>.',
	'Ascend with exactly <b>%1</b>.': 'Ascenda com exatamente <b>%1</b>.',
	'Have your <b>reinforced membrane</b> protect the <b>shimmering veil</b>.':
		'Faça a <b>membrana reforçada</b> proteger o <b>véu cintilante</b>.',
	'Own every <b>fortune upgrade</b>.<div class="line"></div>Owning this achievement makes fortunes appear <b>twice as often</b>; unlocked fortune upgrades also have a <b>%1% chance</b> to carry over after ascending.':
		'Adquira cada <b>melhoria de sorte</b>.<div class="line"></div>Possuir essa conquista faz as sortes aparecerem <b>com o dobro da frequência</b>; melhorias de sorte desbloqueadas também têm uma <b>chance de %1%</b> de continuar após a ascensão.',
	'Make your first stock market profit.': 'Faça seu primeiro lucro no mercado de ações.',
	'Own at least <b>%1</b> of a stock market good.':
		'Tenha pelo menos <b>%1</b> de um bem do mercado de ações.',
	'Own at least <b>%1</b> of every stock market good.':
		'Possuir pelo menos <b>%1</b> de cada bem do mercado de ações.',
	'Make <b>a day</b> of CpS ($%1) in 1 stock market sale.':
		'Ganhe <b>um dia</b> de CpS ($%1) em 1 venda no mercado de ações.',
	'Spend <b>a day</b> of CpS ($%1) in 1 stock market purchase.':
		'Gaste <b>um dia</b> de CpS ($%1) em 1 compra no mercado de ações.',
	'Have your stock market profits surpass <b>a whole year</b> of CpS ($%1).':
		'Faça com que seus lucros no mercado de ações ultrapassem <b>um ano inteiro</b> de CpS ($%1).',
	'Unlock the <b>highest-tier</b> stock market headquarters.':
		'Desbloqueie a sede do mercado de ações de <b>categoria mais alta</b>.',
	'Have your stock market profits surpass <b>$%1</b>.':
		'Faça com que seus lucros no mercado de ações ultrapassem <b>$%1</b>.',
	...
	"Click one of Santa's helper grandmas during Christmas season.":
		'Clique em um dos ajudantes de Papai Noel durante a temporada de Natal.',
	Frenzy: 'Frenesi',
	...
	'Cookie production halted for %1,<br>but each click is worth %2 of CpS.':
		'Produção de cookies interrompida por %1,<br>Mas cada clique vale %2 do CpS.',
	...
	'You find %1% more golden cookies for the next %2.':
		'Você encontra %1% mais cookies dourados pelos próximos %2.',
	...
	"[Baker's wheat quote]A plentiful crop whose hardy grain is used to make flour for pastries.":
		'Uma planta abundante cujo grão resistente é usado para fazer farinha para massas.',
	...
	'[Thumbcorn quote]A strangely-shaped variant of corn. The amount of strands that can sprout from one seed is usually in the single digits.':
		'Uma variante de milho com um formato estranho. O número de plantas que pode brotar de uma semente normalmente não chega a dois dígitos.',
	...
	"[Cronerice quote]Not only does this wrinkly bulb look nothing like rice, it's not even related to it either; its closest extant relative is the weeping willow.":
		'Além dessa coisa enrugada não parecer nada com arroz, ela não é nem relacionada com ele; seu parente mais próximo existente é o salgueiro-chorão.',
	...
	'[Gildmillet quote]An ancient staple crop, famed for its golden sheen. Was once used to bake birthday cakes for kings and queens of old.':
		'Uma planta ancestral e resistente, famosa por seu brilho dourado. Era usada em bolos de aniversário de reis e rainhas antigos.',
	...
	'[Ordinary clover quote]<i>Trifolium repens</i>, a fairly mundane variety of clover with a tendency to produce four leaves. Such instances are considered lucky by some.':
		'<i>Trifolium repens</i>, uma variedade bem mundana de trevo, com uma tendência de produzir quatro folhas. Algumas consideram que, se isso acontecer, eles dão sorte.',
	...
	'[Golden clover quote]A variant of the ordinary clover that traded its chlorophyll for pure organic gold. Tragically short-lived, this herb is an evolutionary dead-end - but at least it looks pretty.':
		'Uma variante do trevo comum que trocou sua clorofila por ouro orgânico puro. Com uma vida tragicamente curta, essa erva é um beco sem saída evolucionário, mas é bonita, pelo menos.',
	...
	'[Shimmerlily quote]These little flowers are easiest to find at dawn, as the sunlight refracting in dew drops draws attention to their pure-white petals.':
		'É mais fácil encontrar flores no alvorecer, já que a luz do sol refratando nas gotas de orvalho atrai a atenção para suas pétalas de um branco puro.',
	...
	'[Elderwort quote]A very old, long-forgotten subspecies of edelweiss that emits a strange, heady scent. There is some anecdotal evidence that these do not undergo molecular aging.':
		'Uma subespécie muito antiga e esquecida há muito tempo que tem um estranho aroma inebriante. Há evidências anedóticas de que ela não envelhece em nível molecular.',
	...
	'[Bakeberry quote]A favorite among cooks, this large berry has a crunchy brown exterior and a creamy red center. Excellent in pies or chicken stews.':
		'Queridinha dos cozinheiros, essa grande baga tem um exterior marrom crocante e um centro vermelho cremoso. Excelente em tortas ou ensopados de frango.',
	...
	'[Chocoroot quote]A tangly bramble coated in a sticky, sweet substance. Unknown genetic ancestry. Children often pick these from fields as-is as a snack.':
		'Uma planta com espinhos coberta de uma substância doce e pegajosa. Ancestralidade genética desconhecida. Crianças frequentemente as colhem dos campos e comem como um lanche.',
	...
	'[White chocoroot quote]A pale, even sweeter variant of the chocoroot. Often impedes travelers with its twisty branches.':
		'Uma variante pálida e ainda mais doce do que a Choco-raiz. Frequentemente impede a passagem com seus ramos retorcidos.',
	...
	'[White mildew quote]A common rot that infests shady plots of earth. Grows in little creamy capsules. Smells sweet, but sadly wilts quickly.':
		'Um fungo comum que infesta porções sombreadas de terra. Cresce em pequenas cápsulas cremosas. Tem um cheiro doce, mas murcha rápido, infelizmente.',
	...
	'[Brown mold quote]A common rot that infests shady plots of earth. Grows in odd reddish clumps. Smells bitter, but thankfully wilts quickly.':
		'Um fungo comum que infesta porções sombreadas de terra. Cresce em grupos estranhos e avermelhados. Tem um cheiro amargo, mas murcha rápido, felizmente.',
	...
	'[Meddleweed quote]The sign of a neglected farmland, this annoying weed spawns from unused dirt and may sometimes spread to other plants, killing them in the process.':
		'Sinais de terras negligenciadas, essa erva irritante surge da terra não usada e pode, às vezes, se espalhar para outras plantas, matando-as no processo.',
	...
	"[Whiskerbloom quote]Squeezing the translucent pods makes them excrete a milky liquid, while producing a faint squeak akin to a cat's meow.":
		'Espremer suas cápsulas transparentes faz com que elas excretem um líquido leitoso enquanto produzem um guincho fraco parecido com o miar de um gato.',
	Chimerose: 'Rosa Sino',
	'[Chimerose quote]Originating in the greener flanks of polar mountains, this beautiful flower with golden accents is fragrant enough to make any room feel a little bit more festive.':
		'Originária dos flancos verdes de montanhas polares, essa linda flor com traços dourados é perfumada o suficiente para deixar qualquer ambiente um pouco mais festivo.',
	...
	'[Nursetulip quote]This flower grows an intricate root network that distributes nutrients throughout the surrounding soil. The reason for this seemingly altruistic behavior is still unknown.':
		'Essa flor desenvolve uma intrincada rede de raízes que distribui nutrientes pelo solo ao redor. Os motivos para esse comportamento aparentemente altruísta ainda são desconhecidos.',
	Drowsyfern: 'Samambaia Sonolenta',
	'[Drowsyfern quote]Traditionally used to brew a tea that guarantees a good night of sleep.':
		'Tradicionalmente usada como um chá que garante uma boa noite de sono.',
	...
	'[Wardlichen quote]The metallic stench that emanates from this organism has been known to keep insects and slugs away.':
		'O cheiro metálico que emana deste organismo é conhecido por manter os insetos e lesmas afastados.',
	...
	'[Keenmoss quote]Fuzzy to the touch and of a vibrant green. In plant symbolism, keenmoss is associated with good luck for finding lost objects.':
		'De um verde vibrante e fofinho ao toque. No simbolismo das plantas, musgo-afiado é associado com boa sorte para encontrar objetos perdidos.',
	...
	'[Queenbeet quote]A delicious taproot used to prepare high-grade white sugar. Entire countries once went to war over these.':
		'Uma raiz deliciosa usada no preparo de açúcar refinado de alta qualidade. Vários países chegaram a ir à guerra por causa dela.',
	...
	'[Juicy queenbeet quote]A delicious taproot used to prepare high-grade white sugar. Entire countries once went to war over these.<br>It looks like this one has grown especially sweeter and juicier from growing in close proximity to other queenbeets.':
		'Uma raiz deliciosa usada no preparo de açúcar refinado de alta qualidade. Vários países chegaram a ir à guerra por causa dela.<br>Parece que essa cresceu especialmente mais doce e suculenta por ter crescido próxima de outras beterrabas-rainhas.',
	...
	'[Duketater quote]A rare, rich-tasting tuber fit for a whole meal, as long as its strict harvesting schedule is respected. Its starch has fascinating baking properties.':
		'Um tubérculo raro e saboroso, adequado para uma refeição completa, desde que seu período de colheita seja respeitado rigorosamente. Seu amido tem propriedades culinárias fascinantes.',
	...
	'[Crumbspore quote]An archaic mold that spreads its spores to the surrounding dirt through simple pod explosion.':
		'Um fungo arcaico que espalha seus esporos pela terra ao redor simplesmente por meio da explosão de uma de suas cápsulas.',
	...
	'[Doughshroom quote]Jammed full of warm spores; some forest walkers often describe the smell as similar to passing by a bakery.':
		'Cheio de esporos quentinhos; quem passa pela floresta costuma descrever o cheiro como semelhante ao de se passar por uma confeitaria.',
	...
	'[Glovemorel quote]Touching its waxy skin reveals that the interior is hollow and uncomfortably squishy.':
		'Tocar em sua pele cerosa revela que o interior é oco e desconfortavelmente mole.',
	Cheapcap: 'Bartinho',
	'[Cheapcap quote]Small, tough, and good in omelettes. Some historians propose that the heads of dried cheapcaps were once used as currency in some bronze age societies.':
		'Pequeno, duro e bom em omeletes. Alguns historiadores propõem que as cabeças de baratinhos secos já foram usadas como moeda em algumas sociedades da idade do bronze.',
	...
	"[Fool's bolete quote]Named for its ability to fool mushroom pickers. The fool's bolete is not actually poisonous, it's just extremely bland.":
		'Batizado pela sua habilidade de enganar coletores de cogumelos. O porcini dos tolos não é realmente venenoso, só é muito sem graça.',
	...
	"[Wrinklegill quote]This mushroom's odor resembles that of a well-done steak, and is said to whet the appetite - making one's stomach start gurgling within seconds.":
		'O odor desse cogumelo lembra o de um bife bem passado, e dizem que abre o apetite, fazendo o estômago começar a roncar em segundos.',
	...
	'[Green rot quote]This short-lived mold is also known as "emerald pebbles", and is considered by some as a pseudo-gem that symbolizes good fortune.':
		'Este fungo de vida curta também é conhecido como "seixo esmeralda" e é considerado por alguns como uma pseudo-joia que simboliza boa sorte.',
	...
	'[Shriekbulb quote]A nasty vegetable with a dreadful quirk : its flesh resonates with a high-pitched howl whenever it is hit at the right angle by sunlight, moonlight, or even a slight breeze.':
		'Um vegetal desagradável com uma peculiaridade terrível: sua carne ressoa com um uivo estridente sempre que é atingida no ângulo certo pela luz do sol, do luar ou até por uma leve brisa.',
	...
	'[Tidygrass quote]The molecules this grass emits are a natural weedkiller. Its stems grow following a predictable pattern, making it an interesting -if expensive- choice for a lawn grass.':
		'As moléculas que esta grama emite são um herbicida natural. Seus caules crescem seguindo um padrão previsível, tornando-a uma escolha interessante, ainda que cara, para um gramado.',
	...
	'[Everdaisy quote]While promoted by some as a superfood owing to its association with longevity and intriguing geometry, this elusive flower is actually mildly toxic.':
		'Embora promovida por alguns como um superalimento devido à sua associação com longevidade e geometria intrigante, esta flor elusiva é, na verdade, levemente tóxica.',
	Ichorpuff: 'Puficor',
	'[Ichorpuff quote]This puffball mushroom contains sugary spores, but it never seems to mature to bursting on its own. Surrounding plants under its influence have a very slow metabolism, reducing their effects but lengthening their lifespan.':
		'Este cogumelo felpudo de bolinha contém esporos açucarados, mas nunca parece amadurecer o bastante para estourar por conta própria. As plantas ao seu redor sob sua influência têm um metabolismo muito lento, reduzindo seus efeitos, mas prolongando a vida útil delas.',
	'Garden information': 'Informações do jardim',
	'Your garden is frozen, providing no effects.':
		'Seu jardim está congelado, não fornece efeito algum.',
	...
	'Instantly harvest all plants in your garden.':
		'Colhe instantaneamente todas as plantas do seu jardim.',
	...
	'%1 to harvest all mature plants of this type.':
		'%1 para colher todas as plantas maduras desse tipo.',
	Freeze: 'Congelar',
	'Cryogenically preserve your garden.<br>Plants no longer grow, spread or die; they provide no benefits.<br>Soil cannot be changed.<div class="line"></div>Using this will effectively pause your garden.':
		'Preserve criogenicamente o seu jardim.<br>As plantas deixam de crescer, se espalhar e morrer, não fornecendo nenhum benefício.<br>O solo não pode ser alterado.<div class="line"></div>Ao usar isso, seu jardim será efetivamente pausado.',
	...
	'A swarm of sugar hornets comes down on your garden, <span class="red">destroying every plant as well as every seed you\'ve unlocked</span> - leaving only a %1 seed.<br>In exchange, they will grant you <span class="green">%2</span>.<br>This action is only available with a complete seed log.':
		'Um enxame de vespas do açúcar ataca seu jardim, <span class="red">destruindo todas as plantas e todas as sementes que você desbloqueou</span> - deixando apenas uma semente de %1.<br>Em troca, elas darão <span class="green">%2</span>.<br>Essa ação só está disponível com um registro de sementes completo.',
	'Do you REALLY want to sacrifice your garden to the sugar hornets?<br><small>You will be left with an empty plot and only the %1 seed unlocked.<br>In return, you will gain <b>%2 sugar lumps</b>.</small>':
		'Você quer MESMO sacrificar seu jardim para as vespas do açúcar?<br><small>Você ficará com um terreno vazio e apenas a semente de %1 desbloqueada.<br>Em troca, ganhará <b>%2 torrões de açúcar</b>.</small>',
	...
	"You've sacrificed your garden to the sugar hornets, destroying your crops and your knowledge of seeds.<br>In the remains, you find <b>%1 sugar lumps</b>.":
		'Você sacrificou seu jardim para as vespas do açúcar, destruindo suas plantações e seu conhecimento sobre as sementes.<br>Nos restos, você encontra <b>%1 torrões de açúcar</b>.',
	immortal: 'imortal',
	'predictable growth': 'crescimento estimado',
	'surrounding plants (%1x%1) age %2% faster':
		'plantas ao redor (%1x%1) envelhecem %2% mais rápido',
	'surrounding plants (%1x%1) age %2% slower':
		'plantas ao redor (%1x%1) envelhecem %2% mais devagar',
	'surrounding plants (%1x%1) are %2% more efficient':
		'plantas ao redor (%1x%1) são %2% mais eficientes',
	'surrounding plants (%1x%1) are %2% less efficient':
		'plantas ao redor (%1x%1) são %2% menos eficientes',
	'surrounding tiles (%1x%1) develop no weeds or fungus':
		'espaços ao redor (%1x%1) não adquirem ervas daninhas ou fungos',
	'harvest when mature for +%1 of CpS (max. %2% of bank)':
		'colha quando estiver madura pra +%1 de CpS (máximo de %2% do banco)',
	...
	'explodes into up to %1 of CpS at the end of its lifecycle (max. %2% of bank)':
		'explode em até %1 de CpS no fim de seu ciclo de vida (máximo de %2% do banco)',
	'cannot handle cold climates; %1% chance to die when frozen':
		'não lida bem com climas frios; %1% de chance de morrer quando congelada',
	'the unfortunate result of some plant combinations':
		'o triste resultado de algumas combinações de plantas',
	...
	'You will be able to change your soil again in %1.':
		'Você poderá mudar seu solo novamente em %1.',
	'Click to use this type of soil for your whole field.':
		'Clique para usar esse tipo de solo no seu campo todo.',
	Dirt: 'Terra',
	"Simple, regular old dirt that you'd find in nature.":
		'A velha e simples terra comum que você encontra na natureza.',
	Fertilizer: 'Fertilizante',
	'Soil with a healthy helping of fresh manure. Plants grow faster but are less efficient.':
		'Solo com a saudável ajuda do esterco fresco. As plantas crescem mais rápido, mas são menos eficientes.',
	Clay: 'Barro',
	'Rich soil with very good water retention. Plants grow slower but are more efficient.':
		'Solo rico com uma retenção de água muito boa. As plantas crescem mais devagar, mas são mais eficientes.',
	Pebbles: 'Seixos',
	"Dry soil made of small rocks tightly packed together. Not very conducive to plant health, but whatever falls off your crops will be easy to retrieve.<br>Useful if you're one of those farmers who just want to find new seeds without having to tend their garden too much.":
		'Solo seco feito de pequenas pedras compactadas firmemente. Não muito propício à saúde das plantas, mas tudo que cair de suas plantações poderá ser recolhido facilmente.<br>Útil se você for um daqueles fazendeiros que só quer encontrar novas sementes sem ter que cuidar demais do seu jardim.',
	...
	'Soil made of bits and pieces of bark and sawdust. Helpful for young sprouts to develop, not so much for mature plants.':
		'Solo feito com pedacinhos de casca e serragem. Útil para pequenos brotos se desenvolverem, mas não muito para plantas maduras.',
	...
	'<b>%1% chance</b> of collecting seeds automatically when plants expire':
		'<b>chance de %1%</b> de coletar sementes automaticamente quando plantas perecerem',
	'plants spread and mutate <b>%1 times more</b>':
		'as plantas se espalham e sofrem mutação <b>%1 vezes mais</b>',
	...
	'This tile of soil is empty.<br>Pick a seed and plant something!':
		'Esse espaço de solo está vazio.<br>Escolha uma semente e plante algo!',
	...
	'may reproduce, will drop seed when harvested':
		'pode se reproduzir, deixará uma semente quando colhida',
	...
	'Click to refill your soil timer and trigger <b>1</b> plant growth tick with <b>x%1</b> spread and mutation rate for %2.':
		'Clique para recarregar o temporizador do solo e ativar <b>1</b> tique de crescimento de planta com taxa de propagação e mutação <b>x%1</b> por %2.',
	...
	'Plot size: %1<br>(Upgrades with farm level)':
		'Tamanho do terreno: %1<br>(Aumenta com o nível da fazenda)',
	'Garden plants age and mutate %1% faster.':
		'Plantas de jardim crescem e sofrem mutações %1% mais rápido.',
	'while plant is alive; scales with plant growth':
		'enquanto a planta está viva; aumenta conforme o crescimento da planta',
	Dungeon: 'Calabouço',
	Grimoire: 'Grimório',
	'This is your magic meter. Each spell costs magic to use.<div class="line"></div>Your maximum amount of magic varies depending on your amount of <b>Wizard towers</b>, and their level.<div class="line"></div>Magic refills over time. The lower your magic meter, the slower it refills.':
		'Esse é o seu medidor de magia. Cada feitiço custa magia pra ser usado.<div class="line"></div>Sua quantidade máxima de magia varia dependendo de sua quantidade de <b>Torres de Feitiçaria</b> e do nível delas.<div class="line"></div>A magia recarrega com o tempo. Quanto mais baixo o seu medidor de magia, mais devagar ele recarrega.',
	...
	'Click to refill <b>%1 units</b> of your magic meter for %2.':
		'Clique pra recarregar <b>%1 unidades</b> do seu medidor de magia por %2.',
	'Grimoire spells are %1% cheaper but fail %1% more.':
		'Feitiços do Grimório são %1% mais baratos mas falham %1% mais vezes.',
	'Conjure Baked Goods': 'Conjurar Produtos Assados',
	'Summon half an hour worth of your CpS, capped at %1% of your cookies owned.':
		'Invoca a quantidade de seus CpS produzidos em meia hora, limitado a %1% dos cookies que você tem.',
	'Trigger a %1-minute clot and lose %1 minutes of CpS.':
		'Ativa um coágulo de %1 minuto e perde %1 minutos de CpS.',
	...
	'Summon a random golden cookie. Each existing golden cookie makes this spell +%1% more likely to backfire.':
		'Invoca um cookie dourado aleatório. Cada cookie dourado existente aumenta a chance desse feitiço causar o efeito contrário em +%1%.',
	...
	'All active buffs gain %1% more time (up to %2 more minutes).':
		'Todas as vantagens ativas ganham mais %1% de tempo (por até mais %2 minutos).',
	'All active buffs are shortened by %1% (up to %2 minutes shorter).':
		'Todas as vantagens ativas têm seu tempo reduzido em  %1% (por até menos %2 minutos).',
	...
	'The spell picks a random building you could afford if you had twice your current cookies, and gives it to you for free. The building selected must be under %1, and cannot be your most-built one (unless it is your only one).':
		'O feitiço escolhe uma construção aleatória que você poderia pagar se tivesse o dobro de seus cookies atuais e te dá de graça. A construção selecionada deve custar menos de %1, e não pode ser a que você mais construiu (a não ser que seja a sua única).',
	...
	'One of your %1<br>disappears in a puff of smoke.':
		'Uma de suas construções de %1<br>desaparece em uma nuvem de fumaça.',
	...
	'Cast a random spell at half the magic cost, with twice the chance of backfiring.':
		'Lança um feitiço aleatório pela metade do custo de magia, com chance dobrada de efeito contrário.',
	...
	'Instantly summon a wrinkler if conditions are fulfilled.':
		'Invoca um enrugador instantaneamente se as condições forem satisfeitas.',
	...
	'Spells backfire %1 times less for the next %2 minutes.':
		'Efeitos contrários ocorrem %1 vezes menos pelos próximos %2 minutos.',
	'Spells backfire %1 times more for the next %2 minutes.':
		'Efeitos contrários ocorrem %1 vezes mais pelos próximos %2 minutos.',
	...
	'[GOD 1 QUOTE]An immortal life spent focusing on the inner self, away from the distractions of material wealth.':
		'Uma vida imortal focada na contemplação do ser interior, longe das distrações da riqueza material.',
	...
	'[GOD 2 QUOTE]This sleazy spirit revels in the lust for quick easy gain and contempt for the value of steady work.':
		'Esse espírito banal se regozija na cobiça por ganhos rápidos e fáceis e despreza o valor do trabalho estável.',
	...
	'[GOD 3 QUOTE]The embodiment of natural disasters. An impenetrable motive drives the devastation caused by this spirit.':
		'A encarnação de desastres naturais. Uma motivação impenetrável impulsiona a devastação causada por esse espírito.',
	...
	"[GOD 4 QUOTE]This spirit knows about everything you'll ever do, and enjoys dispensing a harsh judgment.":
		'Esse espírito sabe de tudo o que você fará na vida, e se alegra em impor um julgamento severo.',
	...
	'[GOD 5 QUOTE]This is the spirit of merry getaways and regretful Monday mornings.':
		'Esse é o espírito das escapadas divertidas e das manhãs de segunda arrependidas.',
	...
	"[GOD 6 QUOTE]All things that be and ever will be were scripted long ago by this spirit's inscrutable tendrils.":
		'Tudo o que há e o que há de ser foi elaborado há muito tempo pelas garras inescrutáveis desse espírito.',
	...
	'[GOD 7 QUOTE]This spirit enjoys a good cheese after a day of hard work.':
		'Esse espírito gosta de um bom queijo depois de um dia de trabalho duro.',
	...
	'[GOD 8 QUOTE]While this spirit has many regrets, helping you rule the world through constant industrialization is not one of them.':
		'Apesar desse espírito ter muitos arrependimentos, te ajudar a dominar o mundo através da industrialização constante não é um deles.',
	...
	'[GOD 9 QUOTE]A caring spirit said to contain itself, inwards infinitely.':
		'Um espírito atencioso que supostamente se contém em seu interior, infinitamente.',
	...
	'[GOD 10 QUOTE]This spirit enjoys poking foul beasts and watching them squirm, but has no love for its own family.':
		'Esse espírito gosta de atiçar bestas horríveis e vê-las se contorcerem, mas não tem amor por sua própria família.',
	...
	'[GOD 11 QUOTE]You will find that life gets just a little bit sweeter if you can motivate this spirit with tidy numbers and properly-filled tax returns.':
		'Você descobrirá que a vida fica um pouquinho mais doce se puder motivar esse espírito com contas organizados e impostos de renda declarados devidamente.',
	...
	'If a golden cookie is clicked, this spirit is unslotted and all worship swaps will be used up.':
		'Se um cookie dourado for clicado, esse espírito deixará esse espaço e todos os pontos de adoração serão consumidos.',
	'Each time you slot a spirit, you use up one worship swap.<div class="line"></div>If you have 2 swaps left, the next one will refill after %1.<br>If you have 1 swap left, the next one will refill after %2.<br>If you have 0 swaps left, you will get one after %3.<div class="line"></div>Unslotting a spirit costs no swaps.':
		'Cada vez que coloca um espírito num espaço, você usa um ponto de adoração.<div class="line"></div>Se tiver 2 pontos sobrando, o próximo recarregará depois de %1.<br>Se tiver 1 ponto sobrando, o próximo recarregará depois de %2.<br>Se não tiver nenhum ponto sobrando, ganhará um depois de %3.<div class="line"></div>Retirar um espírito não custa pontos.',
	'Click to refill all your worship swaps for %1.':
		'Clique pra recarregar todos os seus pontos de adoração por %1.',
	...
	'The jade slot behaves as a ruby slot and the ruby slot behaves as a diamond slot.':
		'O espaço de jade age como um espaço de rubi, e o espaço de rubi age como um espaço de diamante.',
	...
	'You may increase your storage space by upgrading your offices and by buying more %1. You also get %2 extra storage space per %3 level (currently: <b>+%4</b>).':
		'Você pode aumentar seu espaço de armazenamento melhorando seus escritórios e comprando mais %1. Você também ganha %2 espaço de armazenamento extra por nível de %3 (atualmente: <b>+%4</b>).',
	'The average worth of this stock and how high it can peak depends on the building it is tied to, along with the level of your %1.':
		'O valor médio dessa ação e o quanto ela pode subir depende da construção a qual ela está ligada, e também do seu nível de %1.',
	'%1 the hide button to toggle all other stocks.':
		'%1 o botão ocultar pra alternar entre todas as outras ações.',
	'stock:': 'ação:',
	...
	'You cannot buy and sell this stock in the same tick.':
		'Você não pode comprar e vender essa ação no mesmo tique.',
	...
	'It is fully upgraded. Its lavish interiors, spanning across innumerable floors, are host to many a decadent party, owing to your nigh-unfathomable wealth.':
		'Está completamente melhorado. Seu interior luxuoso, estendendo-se por inúmeros andares, hospeda incontáveis funcionários decadentes, devido à sua riqueza praticamente intangível.',
	...
	'+%1% base warehouse space for all goods':
		'+%1% de espaço de armazém base para todos os produtos',
	'Brokers:': 'Corretores:',
	...
	'Buying goods normally incurs overhead costs of <b>%1% extra</b>. Each broker you hire reduces that cost by <b>%2%</b>.':
		'Comprar produtos geralmente implica custos de overhead de <b>%1% extras</b>. Cada corretor contratado reduz esse custo em <b>%2%</b>.',
	'Current overhead costs thanks to your brokers: <b>+%1%</b>':
		'Custos de overhead atuais graças aos seus corretores: <b>+%1%</b>',
	"Buying a broker costs %1 of CpS (that's $%2).":
		'Comprar um corretor custa %1 de CpS (isso é $%2).',
	"Maximum number of brokers you can own: %1 (the highest amount of grandmas you've owned this run, divided by 10, plus your grandma level)":
		'Quantidade máxima de corretores que você pode ter: %1 (a maior quantidade de vovós que você teve nessa partida, dividido por 10, mais o nível de sua vovó)',
	'Brokers are Wall Street-class grandmas versed in the ways of finance. Stockbroker grandmas work hard and play hard, and will fight telephone in hand to get your clients the best possible deals - with a sizeable profit margin for you, of course.':
		'Corretores são vovós nível Wall Street versadas no mundo das finanças. Vovós corretoras de valores trabalham duro e jogam duro, e lutarão com o telefone em mãos pra conseguir os melhores negócios possíveis pra seus clientes – com uma margem de lucro considerável pra você, é claro.',
	...
	'Click to refill your opportunity timer (and give a quick burst to your economy) for %1.':
		'Clique para recarregar seu temporizador de oportunidade (e dê uma rápida acelerada em sua economia) por %1.',
	'Profits: %1. All prices are in $econds of your highest raw cookies per second.':
		'Lucros: %1. Todos os preços estão em $egundos de seu recorde mais alto de cookies por segundo.',
	...
	'[Upgrade name 55]Dark chocolate-coated cookies':
		'Cookies com cobertura de chocolate meio-amargo',
	...
	'[Upgrade name 96]Round chocolate british tea biscuits':
		'Biscoitos sortidos redondos de chocolate',
	'[Upgrade name 97]Round british tea biscuits with heart motif':
		'Biscoitos sortidos redondos de coração',
	'[Upgrade name 98]Round chocolate british tea biscuits with heart motif':
		'Biscoitos sortidos redondos de coração de chocolate',
	...
	'[Upgrade name 318]Some other super-tiny fundamental particle? Probably?':
		'Alguma outra partícula fundamental superminúscula? Provavelmente?',
	...
	'[Upgrade name 335]Dark chocolate butter biscuit':
		'Biscoito amanteigado de chocolate meio-amargo',
	...
	'[Upgrade name 400]Lavender chocolate butter biscuit':
		'Biscoito amanteigado de chocolate lavanda',
	...
	'[Upgrade name 442]Kitten assistants to the regional manager':
		'Gatinhos assistentes do gerente regional',
	...
	'[Upgrade name 477]Synthetic chocolate green honey butter biscuit':
		'Biscoito amanteigado de mel verde com chocolate sintético',
	'[Upgrade name 478]Royal raspberry chocolate butter biscuit':
		'Biscoito amanteigado de chocolate de framboesa real',
	'[Upgrade name 479]Ultra-concentrated high-energy chocolate butter biscuit':
		'Biscoito amanteigado de chocolate com alto teor energético ultraconcentrado',
	...
	'[Upgrade name 497]Pure pitch-black chocolate butter biscuit':
		'Biscoito amanteigado de chocolate puro muito amargo',
	...
	'[Upgrade name 553]A chocolate chip cookie but with the chips picked off for some reason':
		'Um cookie de gotas de chocolate mas alguém arrancou as gotas por algum motivo',
	...
	'[Upgrade name 718]Milkhelp&reg; lactose intolerance relief tablets':
		'Comprimidos Milkhelp® de alívio da intolerância à lactose',
	...
	'[Achievement name 225]He who controls the cookies controls the universe':
		'Aquele que controla os cookies controla o universo',
	...
	"[Achievement name 228]We're gonna need a bigger bakery":
		'Vamos precisar de uma confeitaria maior',
	...
	'[Achievement name 230]Brought to you by the letter <div style="display:inline-block;background:url(img/money.png);width:16px;height:16px;"></div>':
		'Trazido ao pé da letra <div style="display:inline-block;background:url(img/money.png);width:16px;height:16px;"></div>',
	...
	"[Achievement name 255]And now for my next trick, I'll need a volunteer from the audience":
		'Para meu próximo truque, preciso de um voluntário da plateia',
	...
	'[Achievement name 259]cookie clicker forever and forever a hundred years cookie clicker, all day long forever, forever a hundred times, over and over cookie clicker adventures dot com':
		'cookie clicker para todo o sempre cem anos de cookie clicker, o dia inteiro para sempre, eternamente cem vezes, aventuras com cookie clicker sem parar ponto com',
	...
	'[Achievement name 301]Neither snow nor rain nor heat nor gloom of night':
		'Os objetos saíram para entrega',
	...
	'[Achievement name 327]Grandma needs a new pair of shoes':
		'A vovó precisa de um novo par de sapatos',
	...
	'[Achievement name 349]What happens in the vortex stays in the vortex':
		'O que acontece no vórtice fica no vórtice',
	...
	"[Achievement name 357]Save your breath because that's all you've got left":
		'Economize o fôlego, porque é só isso que você tem',
	...
	"[Achievement name 361]Don't get used to yourself, you're gonna have to change":
		'Não se acostume consigo mesmo, pois você vai precisar mudar',
	'[Achievement name 362]Objects in the mirror dimension are closer than they appear':
		'Objetos na dimensão espelhada estão mais próximos do que aparentam',
	...
	'[Achievement name 376]All the other kids with the pumped up clicks':
		'Gosto tanto de você, cliquezinho',
	...
	'[Achievement name 421]For more information on this achievement, please refer to its title':
		'Para mais informações sobre esta conquista, consulte seu título',
	"[Achievement name 422]I'm so meta, even this achievement":
		'Sou tão metalinguístico, até nesta conquista',
	...
	"[Achievement name 429]I think it's safe to say you've got it made":
		'É seguro dizer que você tem a vida feita',
	...
	"[Achievement name 442]Dude what if we're all living in a simulation like what if we're all just code on a computer somewhere":
		'Cara, e se todo mundo estiver vivendo em uma simulação, tipo, e se todos forem só códigos em algum computador por aí?',
	...
	'[Achievement name 495]Mountain out of a molehill, but like in a good way':
		'Se você não vai até a montanha, a montanha vai até você, mas no bom sentido',
	...
	'[Achievement name 506]Flip a cookie. Chips, I win. Crust, you lose.':
		'Vamos tirar no cookie. Gotas, eu venço. Crosta, você perde.',
	...
	'[Achievement name 521]Reject reality, substitute your own':
		'Rejeite a realidade, substitua a sua',
	...
	'[Achievement name 544]A trademarked portmanteau of "imagination" and "engineering"':
		'Uma palavra registrada juntando "imaginação" e "engenharia"',
	...
	'[Achievement name 573]By will alone I set my mind in motion':
		'Apenas pela vontade eu coloco minha mente em ação',
	...
	'[Achievement name 586]What do you get for the baker who has everything':
		'O que dar ao confeiteiro que tem tudo',
