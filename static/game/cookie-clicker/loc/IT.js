AddLanguage('IT', 'italian', {
	...
	grandmapocalypse: '/',
	'%1 cookie': ['%1 biscotto', '%1 biscotti'],
	'%1 sugar lump': ['%1 zolletta di zucchero', '%1 zollette di zucchero'],
	'%1 heavenly chip': ['%1 scaglia celestiale', '%1 scaglie celestiali'],
	'%1 golden cookie': ['%1 biscotto dorato', '%1 biscotti dorati'],
	'%1 building': ['%1 struttura', '%1 strutture'],
	'%1 upgrade': ['%1 potenziamento', '%1 potenziamenti'],
	Yes: 'Sì',
	No: '/',
	...
	Esc: '/',
	Cookies: 'Biscotti',
	'%1 day': ['%1 giorno', '%1 giorni'],
	'%1 hour': ['%1 ora', '%1 ore'],
	'%1 minute': ['%1 minuto', '%1 minuti'],
	'%1 second': ['%1 secondo', '%1 secondi'],
	...
	'visual improvements; disabling may improve performance':
		'miglioramenti grafici; se disattivata, potrebbe incrementare le prestazioni',
	...
	'display boxes around upgrades and achievements in Stats':
		'racchiude in un contorno i potenziamenti e gli obiettivi nelle Statistiche',
	'Alt font': 'Font alternativo',
	'your cookies are displayed using a monospace font':
		'la quantità di biscotti viene mostrata con un carattere monospazio',
	...
	"on slower computers, the game will put itself in sleep mode when it's inactive and starts to lag out; offline CpS production kicks in during sleep mode":
		'sui computer più lenti, il gioco entra automaticamente in modalità riposo quando è inattivo e inizia a rallentare; durante la modalità riposo si attiva la produzione offline di B/s',
	'Music in background': 'Musica in sottofondo',
	"music will keep playing even when the game window isn't focused":
		'la musica continuerà a suonare anche quando la finestra di gioco non è più in primo piano',
	'Cloud saving': 'Salvataggio sul cloud',
	'allow use of Steam Cloud for save backups':
		'consente di utilizzare Steam Cloud per il salvataggio di backup',
	...
	'allows optimizations for screen readers; game will reload':
		'consente ottimizzazioni per le utilità per la lettura dello schermo; la partita verrà ricaricata',
	'Discord status': 'Stato su Discord',
	'if Discord is on, show your game info as activity status':
		"Se Discord è attivo, mostra le tue informazioni di gioco come stato dell'attività",
	Language: 'Lingua',
	'Language: %1': 'Lingua: %1',
	...
	'These are feats that are either unfair or difficult to attain. They do not give milk.':
		'Queste imprese non sono ingiuste né difficili da completare. Non ricevi latte.',
	...
	'with %1 ascension': ['con %1 ascensione', 'con %1 ascensioni'],
	...
	'Milk is gained with each achievement. It can unlock unique upgrades over time.':
		'Ottieni latte per ogni obiettivo raggiunto. Nel tempo può sbloccare potenziamenti unici.',
	'Rank %1': 'Grado %1',
	Automatic: 'Auto',
	...
	'Cookie Clicker is a javascript game by %1 and %2.':
		'Cookie Clicker è un gioco in javascript sviluppato da %1 e %2.',
	...
	"This version of Cookie Clicker is 100% free, forever. Want to support us so we can keep developing games? Here's some ways you can help:%1":
		"L'attuale versione di Cookie Clicker è completamente gratuita e lo sarà per sempre. Vuoi aiutarci a sviluppare altri giochi? Ecco cosa puoi fare:%1",
	"Note: if you find a new bug after an update and you're using a 3rd-party add-on, make sure it's not just your add-on causing it!":
		"Nota: se trovi un bug in seguito a un aggiornamento, assicurati che la causa non sia l'utilizzo di eventuali estensioni di terze parti!",
	'Warning: clearing your browser cache or cookies <small>(what else?)</small> will result in your save being wiped. Export your save and back it up first!':
		'Avvertenza: eliminando la cache o i cookie <small>(e perché mai vorresti farlo?)</small> del browser, cancellerai il tuo salvataggio. Ricordati di esportarlo ed eseguire un backup prima di procedere!',
	'Version history': 'Cronologia aggiornamenti',
	'Official website': 'Sito Web ufficiale',
	'Note: links will open in your web browser.':
		'Nota: i collegamenti si apriranno nel tuo browser Web.',
	'Note: older update notes are in English.':
		'Nota: le note di aggiornamento meno recenti sono in inglese.',
	'This feature is not yet available in your language.':
		'Questa funzionalità non è ancora disponibile nella tua lingua.',
	...
	'Cookie Clicker is in sleep mode and generating offline cookies.':
		'Cookie Clicker è in modalità riposo e sta generando biscotti offline.',
	...
	'(this happens when too many frames are skipped at once,<br>usually when the game has been running in the background for a while)<br>(you can turn this feature off in the settings menu)':
		'(questo accade quando vengono saltati troppi fotogrammi in contemporanea,<br>generalmente quando il gioco funziona a lungo in background)<br>(puoi disattivare questa funzione dal menu delle impostazioni)',
	...
	'Hello again! Just a reminder that you may want to back up your Cookie Clicker save every once in a while, just in case.<br>To do so, go to Options and hit "Export save" or "Save to file"!':
		'Ci rivediamo! Vogliamo solo ricordati di eseguire regolarmente un backup del salvataggio di Cookie Clicker: non si sa mai.<br>Per farlo, vai alle Opzioni e premi "Esporta salvataggio" o "Salva in un file"!',
	'Save manually (the game autosaves every 60 seconds; shortcut: ctrl+S)':
		'Salva manualmente (il gioco salva automaticamente ogni 60 secondi; scorciatoia: Ctrl+S)',
	'You can use this to backup your save or to transfer it to another computer (shortcut for import: ctrl+O)':
		'Queste opzioni ti permettono di eseguire un backup del salvataggio o di trasferirlo su un altro computer (scorciatoia importazione: Ctrl+O)',
	'Save to file': 'Salva in un file',
	'Load from file': 'Carica da file',
	'Use this to keep backups on your computer':
		'Queste opzioni ti permettono di conservare le copie di backup sul tuo computer',
	'Export save': 'Esporta salvataggio',
	'This is your save code.<br>Copy it and keep it somewhere safe!':
		'Questo è il codice del tuo salvataggio.<br>Copialo e conservalo in un luogo sicuro!',
	'Import save': 'Importa salvataggio',
	'Please paste in the code that was given to you on save export.':
		"Inserisci il codice ottenuto all'esportazione del salvataggio.",
	...
	'Oops, looks like the import string is all wrong!':
		'Ops, sembra che la stringa di importazione sia sbagliata!',
	'You are attempting to load a save from a future version (v. %1; you are using v. %2).':
		'Stai tentando di importare il salvataggio di una versione successiva (v. %1; la tua versione attuale: v. %2).',
	"Sorry, you can't import saves from the classic version.":
		'Siamo spiacenti, non puoi importare salvataggi dalla versione classica.',
	'Wipe save': 'Elimina salvataggio',
	'Delete all your progress, including your achievements':
		'Cancella tutti i tuoi progressi, compresi gli obiettivi',
	'Do you REALLY want to wipe your save?<br><small>You will lose your progress, your achievements, and your heavenly chips!</small>':
		'Vuoi DAVVERO eliminare il salvataggio?<br><small>Perderai tutti i progressi, gli obiettivi e le scaglie celestiali!</small>',
	"Whoah now, are you really, <b><i>REALLY</i></b> sure you want to go through with this?<br><small>Don't say we didn't warn you!</small>":
		'Ehi, hai davvero, <b><i>DAVVERO</i></b> intenzione di procedere?<br><small>Non dire che non ti abbiamo avvisato!</small>',
	...
	'Only use mods from trusted sources. Some mods may require a game restart to take effect.':
		'Usa solo mod da fonti fidate. Alcune mod per funzionare richiedono il riavvio del gioco.',
	Enable: 'Attiva',
	Disable: 'Disattiva',
	...
	'This tool allows you to upload new mods to the Steam Workshop.<br>You need to select a mod folder containing a properly-formatted %1 file.<br>See the included sample mods for examples.':
		'Questo strumento ti consente di caricare nuove mod nel Workshop di Steam.<br>Dovrai selezionare una cartella mod contenente un file %1 adeguatamente formattato.<br>Vedi le mod campione incluse come esempio.',
	'Mod data': 'Dati mod',
	...
	'These are the mods present in your save data. You may delete some of this data to make your save file smaller.':
		'Queste sono le mod presenti nei tuoi dati di salvataggio. Puoi cancellare alcuni di questi dati per ridurre il file di salvataggio.',
	'(loaded)': '(caricata)',
	'%1 char': ['%1 carattere', '%1 caratteri'],
	'Check mod data': 'Verifica dati mod',
	'view and delete save data created by mods':
		'visualizza ed elimina i dati di salvataggio creati dalle mod',
	...
	'You are currently playing Cookie Clicker on the <b>%1</b> protocol.<br>The <b>%2</b> version uses a different save slot than this one.<br>Click this lock to reload the page and switch to the <b>%2</b> version!':
		'Stai attualmente giocando a Cookie Clicker sul protocollo <b>%1</b>.<br>La versione <b>%2</b> utilizza uno slot di salvataggio differente rispetto a quella attuale.<br>Fai clic per ricaricare la pagina e passare alla versione <b>%2</b>!',
	'+%1 more notification.': ['+%1 notifica.', '+%1 notifiche.'],
	Christmas: 'Natale',
	...
	"Because you've baked a <b>billion cookies</b> in total, you are now attracting <b>sugar lumps</b>. They coalesce quietly near the top of your screen, under the Stats button.<br>You will be able to harvest them when they're ripe, after which you may spend them on all sorts of things!":
		'Hai infornato un totale di un <b>miliardo di biscotti</b>, quindi hai iniziato ad attirare <b>zollette di zucchero</b>. Si formano lentamente nella parte superiore dello schermo, sotto il pulsante delle Statistiche.<br>Potrai raccoglierle quando sono mature e spenderle in mille modi diversi!',
	'A <b>sugar lump</b> is coalescing here, attracted by your accomplishments.':
		'Una <b>zolletta di zucchero</b> è in corso di formazione, attratta dai tuoi successi.',
	'Your sugar lumps mature after <b>%1</b>,<br>ripen after <b>%2</b>,<br>and fall after <b>%3</b>.':
		'Le tue zollette di zucchero crescono dopo <b>%1</b>,<br>maturano dopo <b>%2</b>,<br>e cadono dopo <b>%3</b>.',
	...
	"This sugar lump is mature and will be ripe in <b>%1</b>.<br>You may <b>click it to harvest it now</b>, but there is a <b>50% chance you won't get anything</b>.":
		"Questa zolletta di zucchero è cresciuta e maturerà tra <b>%1</b>.<br>Puoi <b>fare clic per raccoglierla subito</b>, ma c'è <b>una probabilità del 50% di non ottenere nulla</b>.",
	'<b>This sugar lump is ripe! Click it to harvest it.</b><br>If you do nothing, it will auto-harvest in <b>%1</b>.':
		'<b>Questa zolletta di zucchero è matura! Fai clic per raccoglierla.</b><br>Se non intervieni, verrà raccolta automaticamente tra <b>%1</b>.',
	'This sugar lump grew to be <b>bifurcated</b>; harvesting it has a 50% chance of yielding two lumps.':
		'Questa zolletta di zucchero è diventata <b>biforcuta</b>; se la raccogli, avrai il 50% di probabilità di ottener due zollette.',
	'This sugar lump grew to be <b>golden</b>; harvesting it will yield 2 to 7 lumps, your current cookies will be doubled (capped to a gain of 24 hours of your CpS), and you will find 10% more golden cookies for the next 24 hours.':
		'Questa zolletta di zucchero è diventata <b>dorata</b>; se la raccogli potrai ottenere da 2 a 7 zollette, la tua quantità di biscotti attuale verrà raddoppiata (fino a un valore equivalente a 24 ore dei B/s) e avrai il 10% in più di probabilità di trovare biscotti dorati nelle prossime 24 ore.',
	'This sugar lump was affected by the elders and grew to be <b>meaty</b>; harvesting it will yield between 0 and 2 lumps.':
		'Questa zolletta di zucchero è stata influenzata dalle anziane ed è diventata <b>succosa</b>; se la raccogli potrai ottenere da 0 a 2 zollette.',
	'This sugar lump is <b>caramelized</b>, its stickiness binding it to unexpected things; harvesting it will yield between 1 and 3 lumps and will refill your sugar lump cooldowns.':
		'Questa zolletta di zucchero è diventata <b>caramellata</b> e si è appiccicata a sorprese inaspettate; se la raccogli potrai ottenere da 1 a 3 zollette e azzerare i tempi di ricarica delle zollette.',
	...
	'Your cookies have been doubled.<br>+10% golden cookies for the next 24 hours.':
		'Hai raddoppiato i tuoi biscotti.<br>+10% di biscotti dorati per le prossime 24 ore.',
	...
	Heralds: 'Araldi',
	'%1 herald': ['%1 araldo', '%1 araldi'],
	"Heralds couldn't be loaded. There may be an issue with our servers, or you are playing the game locally.":
		'Impossibile caricare gli araldi. Potrebbe essersi verificato un problema interno ai nostri server, oppure stai giocando in modalità locale.',
	'There are no heralds at the moment. Please consider <b>donating to our Patreon</b>!':
		'Al momento non ci sono araldi disponibili. Che ne dici di <b>donare sul nostro Patreon</b>?',
	'selflessly inspiring a boost in production for everyone, resulting in %1.':
		'stanno inspirando in modo disinteressato un incremento della produzione per tutti, risultando in %1.',
	'+%1% cookies per second': '+%1% biscotti al secondo',
	'You are in a <b>Born again</b> run, and are not currently benefiting from heralds.':
		'Stai giocando a una campagna <b>Rinascita</b> e attualmente non ottieni bonus dagli araldi.',
	'You own the <b>Heralds</b> upgrade, and therefore benefit from the production boost.':
		'Possiedi il potenziamento <b>Araldi</b>, quindi ottieni i bonus di incremento della produzione.',
	'To benefit from the herald bonus, you need a special upgrade you do not yet own. You will permanently unlock it later in the game.':
		'Per ottenere il bonus degli araldi hai bisogno di un potenziamento che non possiedi ancora. Lo sbloccherai permanentemente più avanti nel gioco.',
	'<b>Heralds</b> are people who have donated to our highest Patreon tier, and are limited to 100.<br>Each herald gives everyone +1% CpS.<br>Heralds benefit everyone playing the game, regardless of whether you donated.':
		'Gli <b>araldi</b> sono 100 sostenitori che hanno donato la quota massima sul nostro Patreon.<br>Ogni araldo concede a tutti un bonus di +1% B/s.<br>Gli araldi favoriscono tutti i giocatori, anche coloro che non hanno fatto donazioni.',
	'Every %1 current players on Steam generates <b>1 herald</b>, up to %2 heralds.<br>Each herald gives everyone +1% CpS.':
		'Ogni %1 giocatori attuali su Steam generano<b>1 araldo</b>, fino a %2 araldi.<br>Ciascun araldo conferisce a tutti +1% BpS.',
	'+%1!': '/',
	...
	'Sweet!<br><small>Found 1 sugar lump!</small>':
		'Fantastico!<br><small>Hai trovato una zolletta di zucchero!</small>',
	'Lucky!': 'Che fortuna!',
	'Ruin!': 'Che disgrazia!',
	...
	'Cookie chain broken.<br><small>You made %1.</small>':
		'Combo di biscotti interrotta.<br><small>Hai ottenuto %1.</small>',
	'Cookie blab': [
	...
	'Select an aura from those your dragon knows.':
		"Seleziona un'aura tra quelle imparate dal drago.",
	'<b>One tenth</b> of every other dragon aura, <b>combined</b>.':
		'<b>Una combinazione</b> di <b>un decimo</b> di ogni altra aura del drago.',
	'Switching your aura is <b>free</b> because you own no buildings.':
		"Cambiare l'aura è <b>gratuito</b> perché non possiedi strutture.",
	'The cost of switching your aura is <b>%1</b>.<br>This will affect your CpS!':
		"Cambiare l'aura ti costerà <b>%1</b>.<br>Avrà effetto sui B/s!",
	...
	'You feel like making cookies. But nobody wants to eat your cookies.':
		'Hai voglia di infornare biscotti. Ma nessuno vuole mangiarli.',
	'Your first batch goes to the trash. The neighborhood raccoon barely touches it.':
		'La prima infornata finisce nella spazzatura. Il procione di quartiere li sfiora appena.',
	'Your family accepts to try some of your cookies.':
		'La tua famiglia accetta di provare i tuoi biscotti.',
	...
	'People are starting to talk about your cookies.':
		'Le persone cominciano a parlare dei tuoi biscotti.',
	'Your cookies are talked about for miles around.':
		"Per miglia e miglia non si parla d'altro che dei tuoi biscotti.",
	...
	'Your cookies sell very well in distant countries.':
		'Le vendite dei tuoi biscotti si impennano in paesi lontani.',
	'People come from very far away to get a taste of your cookies.':
		'Le persone giungono da ogni dove per assaggiare i tuoi biscotti.',
	'Kings and queens from all over the world are enjoying your cookies.':
		'Re e regine di tutto il mondo adorano i tuoi biscotti.',
	'There are now museums dedicated to your cookies.':
		'Sono stati inaugurati musei dedicati ai tuoi biscotti.',
	'A national day has been created in honor of your cookies.':
		'È stata creata una festa nazionale in onore dei tuoi biscotti.',
	'Your cookies have been named a part of the world wonders.':
		'I tuoi biscotti sono stati inseriti tra le meraviglie del mondo.',
	'History books now include a whole chapter about your cookies.':
		'I libri di storia includono un intero capitolo dedicato ai tuoi biscotti.',
	'Your cookies have been placed under government surveillance.':
		'Il governo ha posto sotto sorveglianza i tuoi biscotti.',
	...
	'Strange creatures from neighboring planets wish to try your cookies.':
		'Strane creature da pianeti vicini vogliono assaggiare i tuoi biscotti.',
	'Elder gods from the whole cosmos have awoken to taste your cookies.':
		'Antichi dèi di interi universi si sono risvegliati per assaggiare i tuoi biscotti.',
	'Beings from other dimensions lapse into existence just to get a taste of your cookies.':
		"Creature di altre dimensioni scivolano nell'esistenza solo per assaggiare i tuoi biscotti.",
	...
	'The universe has now turned into cookie dough, to the molecular level.':
		"Ogni singola molecola dell'universo si è trasformata in impasto per biscotti.",
	'Your cookies are rewriting the fundamental laws of the universe.':
		"I tuoi biscotti stanno riscrivendo le leggi fondamentali dell'universo.",
	'A local news station runs a 10-minute segment about your cookies. Success!<br><small>(you win a cookie)</small>':
		'Un notiziario locale trasmette un segmento di 10 minuti sui tuoi biscotti. Vittoria!<br><small>(vinci un biscotto)</small>',
	...
	'You gain <b>one hour</b> of your CpS (capped at double your bank).':
		"Ottieni una quantità pari a <b>un'ora</b> dei B/s (fino al doppio di quanto possiedi).",
	...
	'Your prestige level is currently <b>%1</b>.<br>(CpS +%2%)':
		'Il tuo livello di prestigio attuale è <b>%1</b>.<br>(+%2% B/s)',
	...
	'Ascending now would grant you<br><b>1 prestige level</b> (+1% CpS)<br>and <b>1 heavenly chip</b> to spend.':
		'Se ascendi ora otterrai<br><b>1 livello di prestigio</b> (+1% B/s)<br>e <b>1 scaglia celestiale</b> da spendere.',
	'Ascending now would grant you<br><b>%1 prestige levels</b> (+%2% CpS)<br>and <b>%3 heavenly chips</b> to spend.':
		'Se ascendi ora otterrai<br><b>%1 livelli di prestigio</b> (+%2% B/s)<br>e <b>%3 scaglie celestiali</b> da spendere.',
	'You need <b>%1 more cookies</b> for the next level.':
		'Ti servono <b>ancora %1 biscotti</b> per passare al livello successivo.',
	'Do you REALLY want to ascend?<div class="line"></div>You will lose your progress and start over from scratch.<div class="line"></div>All your cookies will be converted into prestige and heavenly chips.':
		'Vuoi DAVVERO ascendere?<div class="line"></div>Perderai i tuoi progressi e ricomincerai da zero.<div class="line"></div>Tutti i tuoi biscotti verranno convertiti in prestigio e scaglie celestiali.',
	...
	'You will keep your achievements, building levels and sugar lumps.':
		'Manterrai tutti gli obiettivi, i livelli delle strutture e le zollette di zucchero.',
	...
	'%1 prestige level': ['%1 livello di prestigio', '%1 livelli di prestigio'],
	...
	"You are ascending.<br>Drag the screen around<br>or use arrow keys!<br>When you're ready,<br>click Reincarnate.":
		'Stai ascendendo.<br>Trascina la schermata con il mouse<br>o usa le frecce!<br>Quando hai finito,<br>fai clic su Reincarnati.',
	'Each prestige level grants you a permanent <b>+%1% CpS</b>.<br>The more levels you have, the more cookies they require.':
		'Ogni livello di prestigio garantisce un bonus permanente di <b>+%1% B/s</b>.<br>Più livelli possiedi, maggiore la quantità di biscotti richiesta.',
	'Heavenly chips are used to buy heavenly upgrades.<br>You gain <b>1 chip</b> every time you gain a prestige level.':
		'Puoi usare le scaglie celestiali per acquistare potenziamenti celestiali.<br>Ottieni <b>1 scaglia</b> per ogni livello di prestigio raggiunto.',
	"Click this once you've bought<br>everything you need!":
		'Fai clic quando hai acquistato<br>tutto ciò che ti serve!',
	...
	'Challenge modes apply special modifiers to your next ascension.<br>Click to change.':
		'Le modalità sfida applicano speciali modificatori alla tua ascensione successiva.<br>Fai clic per cambiare.',
	...
	"It's <b>Valentine's season</b>!<br>Love's in the air and cookies are just that much sweeter!":
		"ৄÈ la <b>stagione di San Valentino</b>!<br>L'amore è nell'aria e i biscotti sono davvero più dolci!",
	'Business Day!': 'Aprile aziendale!',
	"It's <b>Business season</b>!<br>Don't panic! Things are gonna be looking a little more corporate for a few days.":
		'ৄÈ la <b>stagione di Aprile aziendale</b>!<br>Niente panico! Per qualche giorno tutto avrà un aspetto più imprenditoriale.',
	'Halloween!': '/',
	"It's <b>Halloween season</b>!<br>Everything is just a little bit spookier!":
		'ৄÈ la <b>stagione di Halloween</b>!<br>Tutto è leggermente più spettrale!',
	'Christmas time!': 'Natale!',
	"It's <b>Christmas season</b>!<br>Bring good cheer to all and you just may get cookies in your stockings!":
		'ৄÈ la <b>stagione di Natale</b>!<br>Diffondi il buonumore, potrai trovare dei biscotti nella calza!',
	'Easter!': 'Pasqua!',
	"It's <b>Easter season</b>!<br>Keep an eye out and you just might click a rabbit or two!":
		'ৄÈ la <b>stagione di Pasqua</b>!<br>Tieni gli occhi aperti, potresti fare clic su qualche coniglio di passaggio!',
	...
	'Upgrade is vaulted and will not be auto-purchased.':
		'Il potenziamento si trova nel deposito e non verrà acquistato automaticamente.',
	...
	'Will <b>instantly purchase</b> every upgrade you can afford, starting from the cheapest one.<br>Upgrades in the <b>vault</b> will not be auto-purchased.<br>You may place an upgrade into the vault by <b>Shift-clicking</b> on it.':
		'<b>Acquista immediatamente</b> i potenziamenti che puoi permetterti, a partire dal più economico.<br>I potenziamenti nel <b>deposito</b> non verranno acquistati automaticamente.<br>Puoi riporre un potenziamento nel deposito con <b>Shift+clic</b>.',
	...
	'all combined, these boosts account for <b>%1</b> per second (<b>%2%</b> of total CpS)':
		'questi bonus combinati totalizzano <b>%1</b> al secondo (<b>%2%</b> dei B/s complessivi)',
	...
	'Levelling up this building unlocks a minigame.':
		'Aumentando il livello di questa struttura sbloccherai un minigioco.',
	...
	'Names in white were submitted by our supporters on Patreon.':
		'I nomi in bianco sono stati suggeriti dai nostri sostenitori su Patreon.',
	'You can also press %1 to bulk-buy or sell %2 of a building at a time, or %3 for %4.':
		'Puoi premere %1 per acquistare o vendere in una volta sola %2 unità di una struttura, o %3 per %4 unità.',
	Investment: 'Investimento',
	"You're not sure what this does, you just know it means profit.":
		'Non sai bene come funzioni, sai solo che significa profitti.',
	Cursor: 'Cursore',
	cursor: 'cursore',
	cursors: 'cursori',
	'%1 cursor': ['%1 cursore', '%1 cursori'],
	...
	'[Cursor business quote]Essential in flattening dough. The first step in cookie-making.':
		"Fondamentale per stendere l'impasto. Il primo passo nella preparazione dei biscotti.",
	Grandma: 'Nonna',
	grandma: 'nonna',
	grandmas: 'nonne',
	'%1 grandma': ['%1 nonna', '%1 nonne'],
	'[Grandma quote]A nice grandma to bake more cookies.':
		"Un'adorabile nonna per infornare più biscotti.",
	'[Grandma business name]Oven': 'Forno',
	'[Grandma business quote]A crucial element of baking cookies.':
		'Elemento cruciale per cuocere i biscotti.',
	Farm: 'Fattoria',
	farm: 'fattoria',
	farms: 'fattorie',
	'%1 farm': ['%1 fattoria', '%1 fattorie'],
	'[Farm quote]Grows cookie plants from cookie seeds.':
		'Coltiva piante di biscotti da semi di biscotti.',
	'[Farm business name]Kitchen': 'Cucina',
	'[Farm business quote]The more kitchens, the more cookies your employees can produce.':
		'Maggiore il numero di cucine, più biscotti potranno sfornare i tuoi dipendenti.',
	Mine: 'Miniera',
	mine: 'miniera',
	mines: 'miniere',
	'%1 mine': ['%1 miniera', '%1 miniere'],
	'[Mine quote]Mines out cookie dough and chocolate chips.':
		'Estrae impasto per biscotti e scaglie di cioccolato.',
	...
	'[Mine business quote]These give you the edge you need to outsell those pesky competitors.':
		'Il vantaggio perfetto per surclassare le vendite dei tuoi molesti concorrenti.',
	Factory: 'Fabbrica',
	factory: 'fabbrica',
	factories: 'fabbriche',
	'%1 factory': ['%1 fabbrica', '%1 fabbriche'],
	...
	'[Factory business quote]Mass production is the future of baking. Seize the day, and synergize!':
		"La produzione di massa è il futuro della pasticceria. Cogli l'attimo e sinergizza!",
	Bank: 'Banca',
	bank: 'banca',
	banks: 'banche',
	'%1 bank': ['1% banca', '1% banche'],
	...
	"[Bank business quote]Business folks with a nose for profit, ready to finance your venture as long as there's money to be made.":
		"Gente d'affari con un fiuto per il profitto, pronta a finanziare la tua impresa finché garantisce un ritorno economico.",
	Temple: 'Tempio',
	temple: 'tempio',
	temples: 'templi',
	'%1 temple': ['%1 tempio', '%1 templi'],
	...
	'[Temple business quote]Your social media page is going viral! Amassing likes is the key to a lasting online presence and juicy advertising deals.':
		'La tua pagina social sta diventando virale! Accumulare mi piace è essenziale per una duratura presenza online e succulenti contratti pubblicitari.',
	'Wizard tower': 'Torre del mago',
	'wizard tower': 'torre del mago',
	'wizard towers': 'torri dei maghi',
	'%1 wizard tower': ['%1 torre del mago', '%1 torri dei maghi'],
	...
	'[Wizard tower business quote]Cookie memes are all the rage! With just the right amount of social media astroturfing, your brand image will be all over the cyberspace.':
		"I meme sui biscotti sono all'ultimo grido! Con una dose adeguata di astroturfing, l'immagine del tuo marchio prenderà d'assalto il cyberspazio.",
	Shipment: 'Razzo',
	shipment: 'razzo',
	shipments: 'razzi',
	'%1 shipment': ['%1 razzo', '%1 razzi'],
	'[Shipment quote]Brings in fresh cookies from the cookie planet.':
		'Consegna biscotti freschi dal pianeta dei biscotti.',
	...
	'[Shipment business quote]A gigantic cookie emporium - your very own retail chain.':
		'Un gigantesco emporio dei biscotti, la tua catena di distribuzione personale.',
	'Alchemy lab': 'Laboratorio alchemico',
	'alchemy lab': 'laboratorio alchemico',
	'alchemy labs': 'laboratori alchemici',
	'%1 alchemy lab': ['%1 laboratorio alchemico', '%1 laboratori alchemici'],
	...
	"[Alchemy lab business quote]You're officially on the stock market, and everyone wants a piece!":
		'Fai ufficialmente parte del mercato azionario e tutti vogliono una quota!',
	Portal: 'Portale',
	portal: 'portale',
	portals: 'portali',
	'%1 portal': ['%1 portale', '%1 portali'],
	...
	'[Portal business quote]Your cookies have their own sitcom! Hilarious baking hijinks set to the cheesiest laughtrack.':
		'I tuoi biscotti sono protagonisti di una sitcom! Esilaranti peripezie di pasticceria accompagnate da scadenti risate registrate.',
	'Time machine': 'Macchina del tempo',
	'time machine': 'macchina del tempo',
	'time machines': 'macchine del tempo',
	'%1 time machine': ['%1 macchina del tempo', '%1 macchine del tempo'],
	'[Time machine quote]Brings cookies from the past, before they were even eaten.':
		'Trasporta biscotti dal passato, persino da epoche in cui ancora non esistevano.',
	...
	'[Time machine business quote]Cookie theme parks, full of mascots and roller-coasters. Build one, build a hundred!':
		'Parchi a tema sui biscotti, pieni di mascotte e montagne russe. Costruiscine uno, costruiscine cento!',
	'Antimatter condenser': 'Condensatore di antimateria',
	'antimatter condenser': 'condensatore di antimateria',
	'antimatter condensers': 'condensatori di antimateria',
	'%1 antimatter condenser': ['%1 condensatore di antimateria', '%1 condensatori di antimateria'],
	'[Antimatter condenser quote]Condenses the antimatter in the universe into cookies.':
		"Condensa l'antimateria dell'universo trasformandola in biscotti.",
	...
	'[Antimatter condenser business quote]A virtual currency, already replacing regular money in some small countries.':
		'Valuta virtuale che in alcuni piccoli paesi sta già sostituendo la moneta corrente.',
	Prism: 'Prisma',
	prism: 'prisma',
	prisms: 'prismi',
	'%1 prism': ['%1 prisma', '%1 prismi'],
	...
	"[Prism business quote]You've made it to the top, and you can now buy entire nations to further your corporate greed. Godspeed.":
		"Hai raggiunto l'apice e ora puoi acquistare intere nazioni per soddisfare la tua incessante brama imprenditoriale. Buona fortuna.",
	Chancemaker: 'Sorteggiatore',
	chancemaker: 'sorteggiatore',
	chancemakers: 'sorteggiatori',
	'%1 chancemaker': ['%1 sorteggiatore', '%1 sorteggiatori'],
	'[Chancemaker quote]Generates cookies out of thin air through sheer luck.':
		'Crea biscotti dal nulla basandosi puramente sulla fortuna.',
	...
	"[Chancemaker business quote]Actually, you know what's cool? A whole planet dedicated to producing, advertising, selling, and consuming your cookies.":
		'Sai cosa sarebbe grandioso? Un intero pianeta dedicato a produrre, pubblicizzare, vendere e consumare i tuoi biscotti.',
	'Fractal engine': 'Motore frattale',
	'fractal engine': 'motore frattale',
	'fractal engines': 'motori frattali',
	'%1 fractal engine': ['%1 motore frattale', '%1 motori frattali'],
	'[Fractal engine quote]Turns cookies into even more cookies.':
		'Moltiplica i biscotti in un numero superiore di biscotti.',
	...
	'[Fractal engine business quote]Only through political dominion can you truly alter this world to create a brighter, more cookie-friendly future.':
		'Solo mediante il dominio politico potrai davvero trasformare il mondo per creare un futuro migliore e biscosostenibile.',
	'Javascript console': 'Console javascript',
	'javascript console': 'console javascript',
	'javascript consoles': 'console javascript',
	'%1 javascript console': ['%1 console javascript', '%1 console javascript'],
	'[Javascript console quote]Creates cookies from the very code this game was written in.':
		'Crea biscotti utilizzando il codice sorgente stesso del gioco.',
	...
	'[Javascript console business quote]Taking many forms -religion, culture, philosophy- a doctrine may, when handled properly, cause a lasting impact on civilizations, reshaping minds and people and ensuring all future generations share a singular goal - the production, and acquisition, of more cookies.':
		"Una dottrina può assumere molte forme (religione, cultura, filosofia) e, se utilizzata opportunamente, può provocare un impatto duraturo sulle civiltà, plasmando menti e persone e facendo in modo che tutte le generazioni future condividano un obiettivo comune: la produzione e l'acquisizione di più biscotti.",
	Idleverse: 'Passiverso',
	idleverse: 'passiverso',
	idleverses: 'passiversi',
	'%1 idleverse': ['%1 passiverso', '%1 passiversi'],
	"[Idleverse quote]There's been countless other idle universes running alongside our own. You've finally found a way to hijack their production and convert whatever they've been making into cookies!":
		'Accanto alla nostra realtà si dispiegano innumerevoli universi passivi. Finalmente hai trovato un modo per sabotare la loro produzione e trasformare qualsiasi cosa abbiano realizzato in biscotti!',
	...
	'[Idleverse business quote]Sometimes the best way to keep going up is sideways. Diversify your ventures through non-cookie investments.':
		'A volte la scelta migliore è muoversi trasversalmente. Diversifica le tue imprese con investimenti esterni ai biscotti.',
	'Cortex baker': 'Cervello artificiale panettiere',
	'cortex baker': 'cervello artificiale panettiere',
	'cortex bakers': 'cervelli artificiali panettieri',
	'%1 cortex baker': ['%1 cervello artificiale panettiere', '%1 cervelli artificiali panettieri'],
	'[Cortex baker quote]These artificial brains the size of planets are capable of simply dreaming up cookies into existence. Time and space are inconsequential. Reality is arbitrary.':
		'Questi cervelli artificiali dalle dimensioni planetarie sono in grado di far materializzare biscotti con la sola forza del pensiero. Per loro spazio e tempo sono irrilevanti. La realtà è un concetto relativo.',
	...
	"[Cortex baker business quote]There's only so many ways you can bring in more profit. Or is there? Hire the most brilliant experts in the known universe and let them scrape their brains for you!":
		"Ci sono così tanti modi con cui puoi aumentare i profitti. O forse no? Assumi gli esperti più brillanti dell'universo conosciuto e lascia che si spremano le meningi per te!",
	CpS: 'BpS',
	...
	'All cookie production <b>multiplied by %1</b>.':
		'Tutta la produzione di biscotti è <b>moltiplicata per %1</b>.',
	'+%1 CpS': '+%1 B/s',
	...
	'Tiered upgrades for <b>%1</b> provide an extra <b>+%2%</b> production.<br>Only works with unshackled upgrade tiers.':
		'I potenziamenti multilivelo per <b>%1</b> forniscono un <b>+%2%</b> di produzione extra.<br>Funziona solo con potenziamenti multilivelo senza catene.',
	'Unshackles all <b>%1-tier upgrades</b>, making them more powerful.<br>Only applies to unshackled buildings.':
		'Libera dalle catene tutti i <b>potenziamenti di livello %1</b>, rendendoli più potenti.<br>Applicabile solo a strutture senza catene.',
	'The mouse and cursors are <b>twice</b> as efficient.':
		"<b>Raddoppia</b> l'efficienza del mouse e dei cursori",
	'The mouse and cursors gain <b>+%1</b> cookies for each non-cursor building owned.':
		'Mouse e cursori ottengono <b>+%1</b> biscotti per ogni struttura diversa da un cursore in tuo possesso.',
	'Grandmas gain <b>+%1% CpS</b> for each non-grandma building.':
		'Le nonne ottengono <b>+%1% B/s</b> per ogni struttura diversa da una nonna.',
	...
	'Cookie production multiplier <b>+%1% permanently</b>.':
		'Moltiplicatore di produzione biscotti <b>permanentemente +%1%</b>.',
	"Cookie production multiplier <b>+%1% per Santa's levels.</b>":
		'Moltiplicatore di produzione biscotti <b>+%1% per ogni livello di Babbo Natale</b>.',
	'Cookie production multiplier <b>+%1%</b> for every year Cookie Clicker has existed (currently: <b>+%2%</b>).':
		'Moltiplicatore di produzione biscotti <b>+%1%</b> per ogni anno di vita di Cookie Clicker (attualmente: <b>+%2%</b>).',
	'Cookie production multiplier <b>+%1%</b> for every building type level %2 or higher.':
		'Moltiplicatore di produzione biscotti <b>+%1%</b> per ogni tipo di struttura di livello %2 o superiore.',
	...
	'Multiplies the gain from %1 by <b>%2</b>.':
		'Moltiplica per <b>%2</b> la rendita di queste unità: %1.',
	'Grandma-operated science lab and leisure club.<br>Grandmas are <b>4 times</b> as efficient.<br><b>Regularly unlocks new upgrades</b>.':
		'Centro ricreativo e laboratorio scientifico gestito dalle nonne.<br>Le nonne sono <b>4 volte</b> più efficienti.<br><b>Sblocca regolarmente nuovi potenziamenti</b>.',
	...
	'Note: the grandmothers are growing restless. Do not encourage them.':
		"Nota: l'inquietudine comincia a serpeggiare tra le nonne. Non incoraggiarle.",
	'Note: proceeding any further in scientific research may have unexpected results. You have been warned.':
		'Nota: continuare ulteriormente la ricerca scientifica potrebbe portare risultati inattesi. Consideralo un avvertimento.',
	...
	"<b>Warning:</b> purchasing this will have unexpected, and potentially undesirable results!<br><small>It's all downhill from here. You have been warned!</small><br><br>Purchase anyway?":
		'<b>Avvertenza:</b> questo acquisto porterà risultati inattesi e potenzialmente indesiderabili!<br><small>Da qui è tutta discesa. Consideralo un avvertimento!</small><br><br>Vuoi procedere comunque?',
	'Contains the wrath of the elders, at least for a while.':
		'Contiene la furia delle anziane, almeno per il momento.',
	"Puts a permanent end to the elders' wrath, at the cost of %1% of your CpS.":
		'Pone per sempre fine alla furia delle anziane al costo di %1% dei tuoi B/s.',
	'You will get %1% of your CpS back, but the grandmatriarchs will return.':
		'Recupererai %1% dei tuoi B/s, ma le matriarche torneranno.',
	...
	'Golden cookies appear <b>twice as often</b> and stay <b>twice as long</b>.':
		'<b>Raddoppia la frequenza</b> e il <b>tempo di permanenza</b> dei biscotti dorati.',
	'Golden cookies appear <b>%1%</b> more often.':
		'Aumenta del <b>%1%</b> la frequenza dei biscotti dorati.',
	'Golden cookies appear <b>%1%</b> more often during %2.':
		"Aumenta del <b>%1%</b> la frequenza dei biscotti dorati durante l'evento di %2.",
	...
	'Golden cookie effects last <b>twice as long</b>.':
		'<b>Raddoppia la durata</b> degli effetti dei biscotti dorati.',
	'Golden cookie effects last <b>%1%</b> longer.':
		'Aumenta del <b>%1%</b> la durata degli effetti dei biscotti dorati.',
	'Golden cookies stay <b>%1%</b> longer.':
		'Aumenta del <b>%1%</b> il tempo di permanenza dei biscotti dorati.',
	'Golden cookies give <b>%1%</b> more cookies.':
		'Aumenta del <b>%1%</b> i biscotti ottenuti dai biscotti dorati.',
	'Wrath cookies give <b>%1%</b> more cookies.':
		'Aumenta del <b>%1%</b> i biscotti ottenuti dai biscotti furia.',
	'<b>+%1% CpS</b> per golden cookie on-screen, multiplicative.':
		'<b>+%1% B/s</b> per ogni biscotto dorato presente sullo schermo (moltiplicativo).',
	'With no buffs and no golden cookies on screen, selling your most powerful building has <b>%1% chance to summon one</b>.':
		'Se non ci sono bonus o biscotti dorati sullo schermo, vendere la struttura più potente garantisce il <b>%1% di probabilità di evocarne uno</b>.',
	'Confers various powers to your minigames while active.<br>See the bottom of each minigame for more details.':
		'Quando attivo, conferisce vari poteri ai tuoi minigiochi.<br>Per ulteriori dettagli, guarda la parte inferiore di ciascun minigioco.',
	'Elder pledges last <b>twice</b> as long.':
		'<b>Raddoppia</b> la durata dei giuramenti alle anziane.',
	'Can toggle upgrades on and off at will in the stats menu.':
		'Puoi attivare e disattivare a piacimento i potenziamenti dal menu delle statistiche.',
	'You keep producing cookies even while the game is closed.':
		'Continui a produrre biscotti anche dopo la chiusura del gioco.',
	'Unlocks <b>%1%</b> of the potential of your prestige level.':
		'Sblocca il <b>%1%</b> del potenziale del tuo livello di prestigio.',
	'Subsequent research will be <b>%1 times</b> as fast.':
		'Le ricerche successive saranno <b>%1 volte</b> più rapide.',
	'Wrinklers appear <b>%1 times</b> as fast.':
		'I divoratori compariranno <b>%1 volte</b> più rapidamente.',
	...
	'Wrinklers explode into <b>%1% more cookies</b>.':
		"<b>Aumenta del %1% i biscotti</b> generati dall'esplosione dei divoratori.",
	...
	'Cost scales with how many eggs you own.':
		'Il costo varia in base alla quantità di uova possedute.',
	...
	'Buildings sell back for <b>%1%</b> instead of %2%.':
		'Vendi le strutture in cambio di <b>%1%</b> invece che di %2%.',
	'All buildings are <b>%1% cheaper</b>.':
		'Il costo di tutte le strutture è <b>ridotto del %1%</b>.',
	'All upgrades are <b>%1% cheaper</b>.':
		'Il costo di tutti i potenziamenti è <b>ridotto del %1%</b>.',
	'All buildings and upgrades are <b>%1% cheaper</b>.':
		'Il costo di tutte le strutture e i potenziamenti è <b>ridotto del %1%</b>.',
	'%1 are <b>%2%</b> more efficient and <b>%3%</b> cheaper.':
		"Aumenta del <b>%2%</b> l'efficienza di queste unità: %1; il loro costo è ridotto del <b>%3%</b>.",
	'Cookie upgrades are <b>%1 times cheaper</b>.':
		'I potenziamenti biscotto sono <b>%1 volte meno costosi</b>.',
	'Random drops are <b>%1% more common</b>.':
		'<b>Aumenta del %1%</b> la probabilità di ritrovamenti casuali.',
	...
	'Allows you to <b>trigger seasonal events</b> at will, for a price.':
		'Per il giusto prezzo, ti consente di <b>attivare gli eventi stagionali</b> a piacimento.',
	'Triggers <b>%1 season</b> for the next 24 hours.<br>Triggering another season will cancel this one.<br>Cost scales with unbuffed CpS and increases with every season switch.':
		"Attiva la <b>stagione di %1</b> per le prossime 24 ore.<br>Attivando un'altra stagione interromperai quella in corso.<br>Il costo varia in base ai B/s senza bonus e aumenta a ogni cambio di stagione.",
	...
	"You haven't switched seasons this ascension yet.":
		"Non hai ancora cambiato stagione durante l'attuale ascensione.",
	"You've switched seasons <b>once</b> this ascension.":
		"Durante l'attuale ascensione hai cambiato stagione <b>una volta</b>.",
	"You've switched seasons <b>%1 times</b> this ascension.":
		"Durante l'attuale ascensione hai cambiato stagione <b>%1 volte</b>.",
	'Cookie production <b>multiplied by 1,000</b>.':
		'La produzione di biscotti è <b>moltiplicata per 1.000</b>.',
	'Other eggs appear <b>%1% more frequently</b>.':
		'<b>Aumenta del %1% la frequenza</b> delle uova.',
	...
	'Christmas cookies drop <b>%1%</b> more often.':
		'Aumenta del <b>%1%</b> il ritrovamento di biscotti natalizi.',
	'Spooky cookies drop <b>%1%</b> more often.':
		'Aumenta del <b>%1%</b> il ritrovamento di biscotti spettrali.',
	'Heart cookies are <b>%1%</b> more powerful.':
		'I biscotti cuore sono più potenti del <b>%1%</b>.',
	"You continually gain <b>more CpS the longer you've played</b> in the current ascension.":
		"<b>Più a lungo giochi all'ascensione attuale, maggiore la quantità di B/s</b> che guadagni in modo continuato.",
	...
	'Contains an assortment of rich butter cookies.':
		'Contiene un assortimento di golosi biscotti al burro.',
	'Contains an assortment of delicious pastries.':
		'Contiene un assortimento di deliziosi pasticcini.',
	...
	'Placing an upgrade in this slot will make its effects <b>permanent</b> across all playthroughs.':
		'Posiziona un potenziamento in questo slot per rendere i suoi effetti <b>permanenti</b> in ogni campagna.',
	...
	'Here are all the upgrades you\'ve purchased last playthrough.<div class="line"></div>Pick one to permanently gain its effects!<div class="line"></div>You can reassign this slot anytime you ascend.':
		'Qui trovi tutti i potenziamenti acquistati nell\'ultima campagna.<div class="line"></div>Scegline uno per ottenerne gli effetti in modo permanente!<div class="line"></div>Puoi riassegnare questo slot a ogni ascensione.',
	'You now <b>keep making cookies while the game is closed</b>, at the rate of <b>%1%</b> of your regular CpS and up to <b>1 hour</b> after the game is closed.<br>(Beyond 1 hour, this is reduced by a further %2% - your rate goes down to <b>%3%</b> of your CpS.)':
		"D'ora in avanti <b>continuerai a produrre biscotti dopo la chiusura del gioco</b>, con un ritmo pari al <b>%1%</b> dei tuoi B/s standard e fino a <b>1 ora</b> dalla chiusura.<br>(Trascorsa un'ora, il ritmo viene ridotto ulteriormente del %2%, portandolo al <b>%3%</b> dei tuoi B/s.)",
	'You gain another <b>+%1%</b> of your regular CpS while the game is closed.':
		'Ottieni un ulteriore <b>+%1%</b> dei tuoi B/s standard quando il gioco è chiuso.',
	'You gain another <b>+%1%</b> of your regular CpS while the game is closed, for a total of <b>%2%</b>.':
		'Ottieni un ulteriore <b>+%1%</b> dei tuoi B/s standard quando il gioco è chiuso, per un totale pari al <b>%2%</b>.',
	'You start with <b>%1</b>.': 'Inizi con <b>%1</b>.',
	'Allows you to purchase a <b>crumbly egg</b> once you have earned 1 million cookies.':
		'Ti consente di acquistare un <b>uovo friabile</b> una volta ottenuto 1 milione di biscotti.',
	'Unlocks the <b>cookie dragon egg</b>.': "Sblocca l'<b>uovo del drago biscottato</b>.",
	'Synergy upgrades are <b>%1% cheaper</b>.':
		'Il costo dei potenziamenti sinergia è <b>ridotto del %1%</b>.',
	'You retain optimal cookie production while the game is closed for <b>%1 more days</b>.':
		'Mantieni una produzione ottimale di biscotti per <b>%1 giorni aggiuntivi</b> quando il gioco è chiuso.',
	'You retain optimal cookie production while the game is closed for twice as long, for a total of <b>%1</b>.':
		'Raddoppia il tempo di mantenimento di una produzione ottimale di biscotti quando il gioco è chiuso, per un totale di <b>%1</b>.',
	'Unlocks the <b>golden switch</b>, which passively boosts your CpS by %1% but disables golden cookies.':
		"Sblocca l'<b>interruttore dorato</b>, che conferisce un bonus passivo del %1% ai B/s ma disattiva i biscotti dorati.",
	'Turning this on will give you a passive <b>+%1% CpS</b>, but prevents golden cookies from spawning.<br>Cost is equal to 1 hour of production.':
		'Attivandolo, otterrai un bonus passivo pari a <b>+%1% B/s</b>, ma impedirai la generazione di biscotti dorati.<br>Il costo equivale a 1 ora di produzione.',
	'The switch is currently giving you a passive <b>+%1% CpS</b>; it also prevents golden cookies from spawning.<br>Turning it off will revert those effects.<br>Cost is equal to 1 hour of production.':
		"Attualmente l'interruttore ti conferisce un bonus passivo pari a <b>+%1% B/s</b>, ma impedisce la generazione di biscotti dorati.<br>Disattivandolo, annullerai gli effetti.<br>Il costo equivale a 1 ora di produzione.",
	'Unlocks the <b>milk selector</b>, letting you pick which milk is displayed under your cookie.<br>Comes with a variety of basic flavors.':
		'Sblocca il <b>selettore di latte</b>, con cui potrai scegliere il tipo di latte mostrato sotto il biscotto.<br>Include una serie di gusti base.',
	'Contains more exotic flavors for your milk selector.':
		'Contiene gusti più esotici per il selettore di latte.',
	'Lets you pick what flavor of milk to display.':
		'Ti permette di scegliere il gusto di latte mostrato.',
	'Unlocks the <b>golden cookie sound selector</b>, which lets you pick whether golden cookies emit a sound when appearing or not.':
		'Sblocca il <b>selettore audio dei biscotti dorati</b>, con cui potrai decidere se riprodurre o meno il suono alla comparsa dei biscotti dorati.',
	'Lets you change the sound golden cookies make when they spawn.':
		'Ti consente di modificare il suono di comparsa dei biscotti dorati.',
	'No sound': 'Nessuno',
	Chime: 'Tintinnio',
	Fortune: 'Fortuna',
	Cymbal: 'Piatti',
	...
	'Unlocks the <b>jukebox</b>, which allows you to play through every sound file in the game.':
		'Sblocca il <b>jukebox</b>, che ti consente di riprodurre tutti i file audio del gioco.',
	...
	"Unlocks the <b>background selector</b>, letting you select the game's background.<br>Comes with a variety of basic flavors.":
		'Sblocca il <b>selettore dello sfondo</b>, con cui potrai scegliere lo sfondo del gioco.<br>Include una serie di gusti base.',
	...
	'This is the first heavenly upgrade; it unlocks the <b>Heavenly chips</b> system.<div class="line"></div>Each time you ascend, the cookies you made in your past life are turned into <b>heavenly chips</b> and <b>prestige</b>.<div class="line"></div><b>Heavenly chips</b> can be spent on a variety of permanent transcendental upgrades.<div class="line"></div>Your <b>prestige level</b> also gives you a permanent <b>+1% CpS</b> per level.':
		'Questo è il primo potenziamento celestiale, che sblocca il sistema delle <b>scaglie celestiali</b>.<div class="line"></div>A ogni ascensione, i biscotti ottenuti nella vita precedente sono trasformati in <b>scaglie celestiali</b> e <b>prestigio</b>.<div class="line"></div>Puoi spendere le <b>scaglie celestiali</b> per acquistare diversi potenziamenti trascendentali permanenti.<div class="line"></div>Ogni <b>livello di prestigio</b> ti conferisce inoltre <b>+1% B/s</b>.',
	...
	'While the golden switch is on, you gain an additional <b>+%1% CpS</b> per golden cookie upgrade owned.':
		"Con l'interruttore dorato attivo, ottieni <b>+%1% B/s</b> aggiuntivi per ogni potenziamento biscotto dorato in tuo possesso.",
	'All upgrades are <b>%1% cheaper per %2</b>.':
		'Il costo di tutti i potenziamenti è <b>ridotto del %1% ogni %2</b>.',
	'Unlocks a new tier of upgrades that affect <b>2 buildings at the same time</b>.<br>Synergies appear once you have <b>%1</b> of both buildings.':
		'Sblocca una nuova classe di potenziamenti, che hanno effetto su <b>2 strutture in contemporanea</b>.<br>Le sinergie compaiono una volta costruite <b>%1</b> unità di entrambe le strutture.',
	'Golden cookies (and all other things that spawn, such as reindeer) have <b>%1% chance of being doubled</b>.':
		'I biscotti dorati (e gli altri oggetti generati, tra cui le renne) hanno il <b>%1% di probabilità di raddoppiarsi</b>.',
	...
	'Sugar lumps coalesce <b>a whole lot faster</b>.':
		'Le zollette di zucchero si formano <b>molto più rapidamente</b>.',
	'<b>+%1%</b> prestige level effect on CpS.':
		'Effetto dei livelli di prestigio sui B/s pari a <b>+%1%</b>.',
	'<b>+%1%</b> prestige level effect on CpS.<br><b>+%2%</b> golden cookie effect duration.<br><b>+%3%</b> golden cookie lifespan.':
		"Effetto dei livelli di prestigio sui B/s pari a <b>+%1%</b>.<br>Durata dell'effetto dei biscotti dorati <b>+%2%</b>.<br>Longevità dei biscotti dorati <b>+%3%</b>.",
	'Each unspent sugar lump (up to %1) gives <b>+%2% CpS</b>.<div class="warning">Note: this means that spending sugar lumps will decrease your CpS until they grow back.</div>':
		'Ogni zolletta di zucchero inutilizzata (fino a un limite di %1) fornisce <b>+%2% B/s</b>.<div class="warning">Nota: ciò significa che, una volta spese le zollette, i B/s sono ridotti finché non si formano nuovamente.</div>',
	'Once an ascension, you may use the "Sugar frenzy" switch to <b>triple your CpS</b> for 1 hour, at the cost of <b>1 sugar lump</b>.':
		'A ogni ascensione puoi utilizzare una singola volta la "Frenesia di zucchero" per <b>triplicare i B/s</b> per un\'ora al costo di <b>1 zolletta di zucchero</b>.',
	'Each grandma (up to %1) makes sugar lumps ripen <b>%2</b> sooner.':
		'Ogni nonna (fino a un limite di %1) riduce il tempo di maturazione delle zollette di <b>%2</b>.',
	'Activating this will <b>triple your CpS</b> for 1 hour, at the cost of <b>1 sugar lump</b>.':
		"Attivandolo potrai <b>triplicare i B/s</b> per un'ora al costo di <b>1 zolletta di zucchero</b>.",
	...
	'Garden plants grow every second.<br>Garden seeds are free to plant.<br>You can switch soils at any time.':
		'Le piante del giardino crescono ogni secondo.<br>I semi possono essere piantati gratuitamente.<br>Puoi cambiare terreno in qualsiasi momento.',
	...
	'Sugar lumps are <b>twice as likely</b> to be unusual.':
		'<b>Raddoppia la probabilità</b> di ottenere zollette di zucchero insolite.',
	'<b>+%1%</b> sugar lump growth.': 'Crescita delle zollette di zucchero <b>aumentata del %1%</b>.',
	'Sugar lumps ripen <b>%1</b> sooner.':
		'Il tempo di maturazione delle zollette di zucchero è ridotto di <b>%1</b>.',
	'Sugar lumps mature <b>%1</b> sooner.':
		'Il tempo di crescita delle zollette di zucchero è ridotto di <b>%1</b>.',
	'Bifurcated sugar lumps appear <b>%1% more often</b> and are <b>%2% more likely</b> to drop 2 lumps.':
		'<b>Aumenta del %1% la comparsa</b> di zollette di zucchero biforcute e <b>del %2% la probabilità</b> di ottenere 2 zollette da esse.',
	'Mouse over a wrinkler to see how many cookies are in its stomach.':
		'Posiziona il mouse su un divoratore per visualizzare il numero di biscotti che ha ingurgitato.',
	'Unlocks the <b>Buy all</b> feature, which lets you instantly purchase every upgrade in your store (starting from the cheapest one).<br>Also unlocks the <b>Vault</b>, a store section where you can place upgrades you do not wish to auto-buy.':
		'Sblocca la funzione <b>Acquista tutto</b>, che ti permette di acquistare immediatamente tutti i potenziamenti del negozio (a partire dal più economico).<br>Sblocca inoltre il <b>Deposito</b>, una sezione del negozio in cui inserire i potenziamenti che non desideri acquistare automaticamente.',
	'Mouse over an upgrade to see its tier.<br><small>Note: only some upgrades have tiers. Tiers are purely cosmetic and have no effect on gameplay.</small>':
		'Posiziona il mouse su un potenziamento per conoscerne la classe.<br><small>Nota: solo alcuni potenziamenti appartengono a una classe. Le classi sono puramente estetiche e non hanno alcun effetto sul gioco.</small>',
	'You now benefit from the boost provided by <b>heralds</b>.<br>Each herald gives you <b>+1% CpS</b>.<br>Look on the purple flag at the top to see how many heralds are active at any given time.':
		'Puoi ora usufruire del bonus offerto dagli <b>araldi</b>.<br>Ogni araldo ti garantisce <b>+1% B/s</b>.<br>Posizionati sulla bandiera viola nella parte superiore dello schermo per visualizzare il numero di araldi attivi in ogni momento.',
	'Seasonal random drops have a <b>1/5 chance</b> to carry over through ascensions.':
		"Hai <b>1 possibilità su 5</b> di conservare i ritrovamenti casuali stagionali dopo l'ascensione.",
	"Unlocks <b>extra price information</b>.<br>Each displayed cost now specifies how long it'll take you to afford it, and how much of your bank it represents.":
		'Sblocca <b>informazioni aggiuntive sul prezzo</b>.<br>Ora i costi visualizzati specificano il tempo necessario a coprirli e a quanto corrispondono rispetto a ciò che possiedi.',
	'Unlocks the <b>shimmering veil</b>, a switch that passively boosts your CpS by <b>%1%</b>.<br>You start with the veil turned on; however, it is very fragile, and clicking the big cookie or any golden cookie or reindeer will turn it off, requiring %2 of CpS to turn back on.':
		'Sblocca il <b>velo lucente</b>, che conferisce ai B/s un bonus passivo del <b>%1%</b>.<br>Inizi la partita con il velo attivo, ma è molto fragile; facendo clic sul biscotto gigante, sui biscotti dorati o sulle renne lo romperai e potrai attivarlo nuovamente spendendo %2 di B/s.',
	'Boosts your cookie production by <b>%1%</b> when active.<br>The veil is very fragile and will break if you click the big cookie or any golden cookies or reindeer.<br><br>Once broken, turning the veil back on costs %2 of unbuffed CpS.':
		'Se attivato, migliora la produzione di biscotti del <b>%1%</b>.<br>Il velo è molto fragile e verrà lacerato da ogni clic sul biscotto gigante, sui biscotti dorati o sulle renne.<br><br>Una volta lacerato, potrai riattivarlo al costo di %2 di B/s senza bonus.',
	...
	'The <b>shimmering veil</b> is more resistant, and has a <b>%1% chance</b> not to break. It also gives <b>+%2%</b> more CpS.':
		'Il <b>velo lucente</b> è più resistente e ha il <b>%1% di probabilità</b> di non lacerarsi. Garantisce inoltre <b>+%2%</b> B/s aggiuntivi.',
	'Active.': 'Attivo.',
	'The reinforced membrane protects the shimmering veil.':
		'La membrana rinforzata protegge il velo lucente.',
	...
	'Prior to purchasing the <b>%1</b> upgrade in a run, random drops are <b>%2 times more common</b>.':
		'Prima di acquistare il potenziamento <b>%1</b> durante una campagna, i ritrovamenti casuali sono <b>%2 volte più probabili</b>.',
	...
	"You don't know what you have until you've lost it.":
		'Non ti accorgi di ciò che possiedi finché non lo perdi.',
	...
	'The news ticker may occasionally have <b>fortunes</b>, which may be clicked for something good.':
		'A volte le ultime notizie includono delle <b>profezie</b>: prova a farvi clic sopra per ottenere qualcosa di utile.',
	'Through clever accounting, this actually makes kitten upgrades <b>%1% cheaper</b>.':
		"Grazie a un'accorta contabilità, il prezzo dei potenziamenti felini è <b>ridotto del %1%</b>.",
	'Unlocks the ability to <b>pet your dragon</b> by clicking on it once hatched.':
		"Sblocca la possibilità di <b>coccolare il tuo drago</b> con un clic quando l'uovo si schiude.",
	'Cost scales with CpS, but %1 times cheaper with a fully-trained dragon.':
		'Il costo varia in base ai B/s, ma è %1 volte più economico con un drago completamente addestrato.',
	'Golden cookies may trigger a <b>Dragon Harvest</b>.':
		'I biscotti dorati potrebbero attivare un <b>Raccolto del drago</b>.',
	'Golden cookies may trigger a <b>Dragonflight</b>.':
		'I biscotti dorati potrebbero attivare un <b>Volo di drago</b>.',
	'Dragon harvest and Dragonflight are <b>%1% stronger</b>.':
		'Raccolto del drago e Volo di drago sono <b>più potenti del %1%</b>.',
	'Kittens are <b>%1%</b> more effective.': 'I felini sono più potenti del <b>%1%</b>.',
	'Each kitten upgrade boosts %1 CpS by <b>%2%</b>.':
		'Ogni potenziamento felino migliora del <b>%2%</b> i B/s forniti da queste unità: %1.',
	'Each rank of milk boosts %1 CpS by <b>%2%</b>.':
		'Ogni grado di latte migliora del <b>%2%</b> i B/s forniti da queste unità: %1.',
	'Cursor levels boost clicks by <b>%1%</b> each (up to cursor level %2).':
		'Ogni livello del cursore migliora i clic del <b>%1%</b> (fino al livello %2 dei cursori).',
	'<b>%1</b> are now effective up to cursor level %2.':
		'<b>%1</b> sono efficaci fino al livello %2 dei cursori.',
	...
	'Golden and wrath cookie effect duration +%1%.':
		'+%1% durata effetto biscotto dorato e iracondo.',
	'Golden and wrath cookies appear %1% more.':
		'I biscotti dorati e iracondi si materializzano il %1% più spesso.',
	'Golden and wrath cookies appear %1% less.':
		'Biscotti dorati e iracondi si materializzano il %1% meno spesso.',
	...
	'Selling buildings triggers a buff boosted by how many buildings were sold.':
		'La vendita di strutture attiva un bonus incrementato dal numero di strutture vendute.',
	'Buff boosts clicks by +%1% for every building sold for %2 seconds.':
		'Il bonus incrementa i clic del +%1% per ogni struttura venduta per %2 secondi.',
	'CpS bonus fluctuating between %1 and %2 over time.':
		'BpS bonus che oscilla di volta in volta tra %1 e %2.',
	...
	'All golden cookies are wrath cookies with a greater chance of a negative effect.':
		'Tutti i biscotti dorati sono biscotti iracondi con probabilità maggiore di un effetto negativo.',
	'Wrinklers appear %1% faster and digest %2% more cookies.':
		'I divoratori si materializzano il %1% più velocemente e digeriscono il %2% in più di biscotti.',
	'Effect is only active when your total amount of buildings ends with 0.':
		"L'effetto è attivo solo se la quantità totale delle tue strutture termina con uno 0.",
	...
	'Make <b>%1</b> by only having clicked <b>%2 times</b>.':
		'Produci <b>%1</b> facendo clic <b>%2 volte</b>.',
	'Make <b>%1</b> with <b>no</b> cookie clicks.':
		'Produci <b>%1</b> <b>senza</b> fare clic sul biscotto.',
	'Get to <b>%1</b> baked with <b>no upgrades purchased</b>.':
		'Inforna <b>%1</b> <b>senza acquistare potenziamenti</b>.',
	...
	'Have <b>at least %1</b> of every building.':
		'Possiedi <b>almeno %1 unità</b> di ogni struttura.',
	'Have at least <b>1 of the most expensive object, 2 of the second-most expensive, 4 of the next</b> and so on (capped at %1).':
		"Possiedi almeno <b>1 unità dell'oggetto più costoso, 2 unità del secondo oggetto più costoso, 4 unità di quello successivo</b> e così via (fino a un massimo di %1).",
	'Have at least <b>10 of the most expensive object, 20 of the second-most expensive, 30 of the next</b> and so on.':
		"Possiedi almeno <b>10 unità dell'oggetto più costoso, 20 unità del secondo oggetto più costoso, 30 unità di quello successivo</b> e così via.",
	...
	'Appease the grandmatriarchs at least <b>once</b>.':
		'Placa le matriarche almeno <b>una volta</b>.',
	'Appease the grandmatriarchs at least <b>%1 times</b>.':
		'Placa le matriarche almeno <b>%1 volte</b>.',
	...
	'Unlock <b>100%</b> of your heavenly chips power.':
		'Sblocca il <b>100%</b> della potenza delle scaglie celestiali.',
	'You have <b>1 chance in %1</b> every second of earning this achievement.':
		'Ogni secondo hai <b>1 probabilità su %1</b> di ottenere questo obiettivo.',
	...
	'Unlock <b>every Halloween-themed cookie</b>.<div class="line"></div>Owning this achievement makes Halloween-themed cookies drop more frequently in future playthroughs.':
		'Sblocca <b>tutti i biscotti di Halloween</b>.<div class="line"></div>Questo obiettivo aumenta la frequenza dei biscotti di Halloween nelle campagne future.',
	...
	'Unlock <b>every Christmas-themed cookie</b>.<div class="line"></div>Owning this achievement makes Christmas-themed cookies drop more frequently in future playthroughs.':
		'Sblocca <b>tutti i biscotti di Natale</b>.<div class="line"></div>Questo obiettivo aumenta la frequenza dei biscotti di Natale nelle campagne future.',
	'Pop <b>1 reindeer</b>.': 'Scoppia <b>1 renna</b>.',
	'Pop <b>%1 reindeer</b>.': 'Scoppia <b>%1 renne</b>.',
	'Pop a reindeer <b>during an elder frenzy</b>.':
		'Scoppia una renna <b>durante una frenesia venerabile</b>.',
	'Unlock <b>every Valentine-themed cookie</b>.':
		'Sblocca <b>tutti i biscotti di San Valentino</b>.',
	'Click the tiny cookie.': 'Fai clic sul mini biscotto.',
	'This is for baking %1 and making it on the local news.':
		'Hai infornato %1 e hanno parlato di te al notiziario locale.',
	'Name yourself <b>Orteil</b>.<div class="warning">Note: usurpers incur a -%1% CpS penalty until they rename themselves something else.</div>':
		'Cambia il nome in <b>Orteil</b>.<div class="warning">Nota: gli usurpatori subiranno una penalità di -%1% B/s fino a quando non modificheranno nuovamente il nome.</div>',
	...
	'Unlock <b>all the eggs</b>.<div class="line"></div>Owning this achievement makes eggs drop more frequently in future playthroughs.':
		'Sblocca <b>tutte le uova</b>.<div class="line"></div>Questo obiettivo aumenta la frequenza delle uova nelle campagne future.',
	...
	'Own <b>%1</b> upgrades and <b>%2</b> buildings.':
		'Possiedi <b>%1</b> potenziamenti e <b>%2</b> strutture.',
	'Own <b>%1</b> heavenly upgrades.': 'Possiedi <b>%1</b> potenziamenti celestiali.',
	'Burst the near-extinct <b>shiny wrinkler</b>.':
		'Fai esplodere il quasi estinto <b>divoratore lucente</b>.',
	'Click a golden cookie <b>less than 1 second after it spawns</b>.':
		'Fai clic su un biscotto dorato <b>meno di 1 secondo dopo la sua comparsa</b>.',
	'Click a golden cookie <b>less than 1 second before it dies</b>.':
		'Fai clic su un biscotto dorato <b>meno di 1 secondo prima che scompaia</b>.',
	'Harvest <b>%1 coalescing sugar lumps</b>.':
		'Raccogli <b>%1 zollette di zucchero in crescita</b>.',
	"Successfully harvest a coalescing sugar lump before it's ripe.":
		'Raccogli con successo una zolletta di zucchero in crescita prima che maturi.',
	...
	'Harvest a <b>caramelized sugar lump</b>.':
		'Raccogli una <b>zolletta di zucchero caramellata</b>.',
	...
	'Have <b>%1</b> golden cookies simultaneously.':
		'Attiva <b>%1</b> biscotti dorati contemporaneamente.',
	'Manage a cookie legacy for <b>at least a year</b>.':
		'Gestisci una genesi di biscotti per <b>almeno un anno</b>.',
	...
	'Fill every tile of the biggest garden plot with plants.':
		'Riempi di piante ogni spazio disponibile nel lotto più grande del giardino.',
	...
	'Convert a complete seed log into sugar lumps by sacrificing your garden to the sugar hornets.<div class="line"></div>Owning this achievement makes seeds <b>%1% cheaper</b>, plants mature <b>%2% sooner</b>, and plant upgrades drop <b>%3% more</b>.':
		'Converti una selezione completa di semi in zollette di zucchero sacrificando il tuo giardino ai calabroni da zucchero.<div class="line"></div>Questo obiettivo <b>riduce del %1% il costo</b> dei semi, <b>riduce del %2% il tempo</b> di maturazione delle piante e <b>aumenta del %3%</b> i ritrovamenti dalle piante.',
	'Ascend with exactly <b>%1</b>.': 'Ascendi con esattamente <b>%1</b>.',
	'Have your <b>reinforced membrane</b> protect the <b>shimmering veil</b>.':
		'Proteggi il <b>velo lucente</b> con la <b>membrana rinforzata</b>.',
	'Own every <b>fortune upgrade</b>.<div class="line"></div>Owning this achievement makes fortunes appear <b>twice as often</b>; unlocked fortune upgrades also have a <b>%1% chance</b> to carry over after ascending.':
		'Possiedi tutti i <b>potenziamenti fortuna</b>.<div class="line"></div>Questo obiettivo <b>raddoppia la frequenza</b> delle profezie; i potenziamenti fortuna sbloccati hanno inoltre un <b>%1% di probabilità</b> di essere mantenuti dopo l\'ascensione.',
	...
	'Own at least <b>%1</b> of a stock market good.':
		'Possiedi almeno <b>%1</b> unità di una merce del mercato azionario.',
	'Own at least <b>%1</b> of every stock market good.':
		'Possiedi almeno <b>%1</b> unità di ogni merce del mercato azionario.',
	'Make <b>a day</b> of CpS ($%1) in 1 stock market sale.':
		"Guadagna l'equivalente di <b>un giorno</b> di B/s (%1 $) con 1 vendita nel mercato azionario.",
	'Spend <b>a day</b> of CpS ($%1) in 1 stock market purchase.':
		"Spendi l'equivalente di <b>un giorno</b> di B/s (%1 $) con 1 acquisto nel mercato azionario.",
	'Have your stock market profits surpass <b>a whole year</b> of CpS ($%1).':
		"Supera l'equivalente di <b>un intero anno</b> di B/s (%1 $) con i profitti del mercato azionario.",
	'Unlock the <b>highest-tier</b> stock market headquarters.':
		'Sblocca la <b>classe più alta</b> della sede del mercato azionario.',
	'Have your stock market profits surpass <b>$%1</b>.':
		'Supera <b>%1 $</b> con i profitti del mercato azionario.',
	...
	"Click one of Santa's helper grandmas during Christmas season.":
		"Fai clic sulle nonnine dell'aiutante di Babbo Natale durante la stagione natalizia.",
	Frenzy: 'Frenesia',
	...
	'All buildings are %1% cheaper for %2!':
		'Il costo di tutte le strutture è ridotto del %1% per %2!',
	'All buildings are %1% pricier for %2!':
		'Il costo di tutte le strutture è aumentato del %1% per %2!',
	'All upgrades are %1% cheaper for %2!':
		'Il costo di tutti i potenziamenti è ridotto del %1% per %2!',
	'All upgrades are %1% pricier for %2!':
		'Il costo di tutti i potenziamenti è aumentato del %1% per %2!',
	'Cookie production halted for %1,<br>but each click is worth %2 of CpS.':
		'Produzione di biscotti interrotta per %1,<br>ma ogni clic equivale a %2 dei B/s.',
	...
	'You find %1% more golden cookies for the next %2.':
		'Frequenza dei biscotti dorati aumentata del %1% per %2.',
	'Spells backfire %1 times less for %2.':
		'Probabilità di fallimento degli incantesimi ridotta di %1 volte per %2.',
	'Spells backfire %1 times more for %2.':
		'Probabilità di fallimento degli incantesimi aumentata di %1 volte per %2.',
	...
	"[Baker's wheat quote]A plentiful crop whose hardy grain is used to make flour for pastries.":
		'Ricca coltura dai chicchi resistenti, macinati per creare farina per dolci.',
	...
	'[Thumbcorn quote]A strangely-shaped variant of corn. The amount of strands that can sprout from one seed is usually in the single digits.':
		'Una varietà di granturco dalla forma particolare. Ogni seme produce generalmente un numero a cifra singola di germogli.',
	...
	"[Cronerice quote]Not only does this wrinkly bulb look nothing like rice, it's not even related to it either; its closest extant relative is the weeping willow.":
		'Questo bulbo raggrinzito non somiglia affatto al riso e non appartiene nemmeno alla stessa specie; il suo parente più stretto è il salice piangente.',
	...
	'[Gildmillet quote]An ancient staple crop, famed for its golden sheen. Was once used to bake birthday cakes for kings and queens of old.':
		'Importante coltivazione fin dai tempi antichi, rinomata per il suo luccichio dorato. Un tempo veniva utilizzata per preparare torte di compleanno per i re e le regine.',
	...
	'[Ordinary clover quote]<i>Trifolium repens</i>, a fairly mundane variety of clover with a tendency to produce four leaves. Such instances are considered lucky by some.':
		'<i>Trifolium repens</i>, una varietà di trifoglio piuttosto ordinaria che tende a produrre quattro foglie. Molti ritengono che questa circostanza sia segno di buona sorte.',
	...
	'[Golden clover quote]A variant of the ordinary clover that traded its chlorophyll for pure organic gold. Tragically short-lived, this herb is an evolutionary dead-end - but at least it looks pretty.':
		"Una varietà del trifoglio comune, che ha rinunciato alla clorofilla per del puro oro organico. Tragicamente poco longeva, quest'erba è un vicolo cieco nell'evoluzione, ma almeno è bella da vedere.",
	...
	'[Shimmerlily quote]These little flowers are easiest to find at dawn, as the sunlight refracting in dew drops draws attention to their pure-white petals.':
		"Questi piccoli fiori si trovano più facilmente all'alba, quando i raggi del sole si rifrangono sulle gocce di rugiada e attraggono l'attenzione sui loro candidi petali.",
	...
	'[Elderwort quote]A very old, long-forgotten subspecies of edelweiss that emits a strange, heady scent. There is some anecdotal evidence that these do not undergo molecular aging.':
		"Un'antica e dimenticata sottospecie di stella alpina che emana un odore inebriante. Secondo prove non confermate, questi fiori non subiscono alcun invecchiamento molecolare.",
	...
	'[Bakeberry quote]A favorite among cooks, this large berry has a crunchy brown exterior and a creamy red center. Excellent in pies or chicken stews.':
		'Ingrediente apprezzato dagli chef, questa grande bacca presenta un croccante esterno marrone e un cuore rosso e cremoso. Perfetta per crostate o stufati di pollo.',
	...
	'[Chocoroot quote]A tangly bramble coated in a sticky, sweet substance. Unknown genetic ancestry. Children often pick these from fields as-is as a snack.':
		'Groviglio di arbusti ricoperti da una sostanza dolce e appiccicosa. Ascendenza genetica sconosciuta. Spesso i bambini la raccolgono come spuntino.',
	...
	'[White chocoroot quote]A pale, even sweeter variant of the chocoroot. Often impedes travelers with its twisty branches.':
		'Una varietà chiara e ancora più dolce della cioccoradice. Spesso ostacola i viandanti con i suoi rami contorti.',
	...
	'[White mildew quote]A common rot that infests shady plots of earth. Grows in little creamy capsules. Smells sweet, but sadly wilts quickly.':
		'Comune muffa che infesta i terreni ombreggiati. Cresce in piccole capsule cremose. Ha un profumo dolce, ma purtroppo appassisce rapidamente.',
	...
	'[Brown mold quote]A common rot that infests shady plots of earth. Grows in odd reddish clumps. Smells bitter, but thankfully wilts quickly.':
		'Comune muffa che infesta i terreni ombreggiati. Cresce in strani ammassi rossastri. Ha un profumo amaro, ma per fortuna appassisce rapidamente.',
	...
	'[Meddleweed quote]The sign of a neglected farmland, this annoying weed spawns from unused dirt and may sometimes spread to other plants, killing them in the process.':
		'Segnale di incuria dei terreni agricoli, questa fastidiosa erbaccia germoglia dalla terra inutilizzata e a volte invade lo spazio di altre piante, uccidendole.',
	...
	"[Whiskerbloom quote]Squeezing the translucent pods makes them excrete a milky liquid, while producing a faint squeak akin to a cat's meow.":
		'Se spremuti, i baccelli traslucidi secernono un liquido latteo e producono un lieve stridio simile al miagolio di un gatto.',
	...
	'[Chimerose quote]Originating in the greener flanks of polar mountains, this beautiful flower with golden accents is fragrant enough to make any room feel a little bit more festive.':
		"Originaria dei verdi versanti dei monti polari, questo splendido fiore dai toni dorati ha un aroma tanto intenso da diffondere in ogni stanza un'aria di festa.",
	...
	'[Nursetulip quote]This flower grows an intricate root network that distributes nutrients throughout the surrounding soil. The reason for this seemingly altruistic behavior is still unknown.':
		"Questo fiore produce un'intricata rete di radici che distribuiscono sostanze nutritive al terreno circostante. Le ragioni di questo apparente comportamento altruista sono ancora sconosciute.",
	Drowsyfern: 'Felce sopente',
	'[Drowsyfern quote]Traditionally used to brew a tea that guarantees a good night of sleep.':
		'Tradizionalmente utilizzata per preparare un tè rilassante, che assicura una buona notte di riposo.',
	...
	'[Wardlichen quote]The metallic stench that emanates from this organism has been known to keep insects and slugs away.':
		'È risaputo che il fetore metallico emanato da questo organismo tiene a distanza insetti e lumache.',
	...
	'[Keenmoss quote]Fuzzy to the touch and of a vibrant green. In plant symbolism, keenmoss is associated with good luck for finding lost objects.':
		'Soffice al tatto e di un intenso colore verde. Nella simbologia botanica, il muschio sagace è un augurio di buona fortuna per ritrovare oggetti perduti.',
	...
	'[Queenbeet quote]A delicious taproot used to prepare high-grade white sugar. Entire countries once went to war over these.':
		'Gustoso fittone utilizzato per preparare zucchero bianco di alta qualità. Un tempo fu causa di guerre tra intere nazioni.',
	...
	'[Juicy queenbeet quote]A delicious taproot used to prepare high-grade white sugar. Entire countries once went to war over these.<br>It looks like this one has grown especially sweeter and juicier from growing in close proximity to other queenbeets.':
		'Gustoso fittone utilizzato per preparare zucchero bianco di alta qualità. Un tempo fu causa di guerre tra intere nazioni.<br>Sembra che crescere a stretto contatto con altre bietole regie abbia reso questo esemplare particolarmente dolce e succoso.',
	...
	'[Duketater quote]A rare, rich-tasting tuber fit for a whole meal, as long as its strict harvesting schedule is respected. Its starch has fascinating baking properties.':
		'Raro tubero dal gusto ricco. È tanto nutriente da bastare per un intero pasto, purché si rispetti il rigido calendario di raccolta. Il suo amido presenta interessanti proprietà per la pasticceria.',
	...
	'[Crumbspore quote]An archaic mold that spreads its spores to the surrounding dirt through simple pod explosion.':
		'Una muffa arcaica che sparge le spore sul terreno circostante con una semplice esplosione del baccello.',
	...
	'[Doughshroom quote]Jammed full of warm spores; some forest walkers often describe the smell as similar to passing by a bakery.':
		'Ripieno di tiepide spore; alcuni escursionisti descrivono un profumo simile a quello di una pasticceria.',
	...
	'[Glovemorel quote]Touching its waxy skin reveals that the interior is hollow and uncomfortably squishy.':
		'Toccando la sua pelle cerosa si rivela un interno cavo e sgradevolmente molliccio.',
	...
	'[Cheapcap quote]Small, tough, and good in omelettes. Some historians propose that the heads of dried cheapcaps were once used as currency in some bronze age societies.':
		"Piccolo, tenace e ottimo nelle frittate. Alcuni storici suggeriscono che le cappelle secche dei tirchiodini fossero utilizzate come valuta in alcune comunità dell'età del bronzo.",
	...
	"[Fool's bolete quote]Named for its ability to fool mushroom pickers. The fool's bolete is not actually poisonous, it's just extremely bland.":
		'Il nome rimanda alla sua capacità di ingannare i raccoglitori di funghi. Il porcino impostore non è velenoso, ha semplicemente un sapore insulso.',
	...
	"[Wrinklegill quote]This mushroom's odor resembles that of a well-done steak, and is said to whet the appetite - making one's stomach start gurgling within seconds.":
		"Questo fungo emana un aroma simile a quello di una bistecca ben cotta e si dice che stuzzichi l'appetito, causando un brontolio di stomaco in pochi secondi.",
	...
	'[Green rot quote]This short-lived mold is also known as "emerald pebbles", and is considered by some as a pseudo-gem that symbolizes good fortune.':
		'Questa muffa dalla vita breve è anche conosciuta come "ciottoli di smeraldo" e viene considerata una pseudo-gemma, simbolo di buona ventura.',
	...
	'[Shriekbulb quote]A nasty vegetable with a dreadful quirk : its flesh resonates with a high-pitched howl whenever it is hit at the right angle by sunlight, moonlight, or even a slight breeze.':
		'Disgustoso vegetale con un terribile difetto: la sua polpa emette un lamento acuto ogni volta che viene colpita alla giusta angolazione dai raggi del sole, dalla luce lunare o persino da una lieve brezza.',
	...
	'[Tidygrass quote]The molecules this grass emits are a natural weedkiller. Its stems grow following a predictable pattern, making it an interesting -if expensive- choice for a lawn grass.':
		"Le molecole emanate da quest'erba sono un diserbante naturale. I suoi steli crescono seguendo uno schema preciso, rendendola una scelta interessante (e costosa) per un giardino.",
	...
	'[Everdaisy quote]While promoted by some as a superfood owing to its association with longevity and intriguing geometry, this elusive flower is actually mildly toxic.':
		"Alcuni la ritengono un super alimento a causa della longevità e dell'affascinante geometria che la contraddistinguono, ma in realtà questo misterioso fiore è leggermente tossico.",
	...
	'[Ichorpuff quote]This puffball mushroom contains sugary spores, but it never seems to mature to bursting on its own. Surrounding plants under its influence have a very slow metabolism, reducing their effects but lengthening their lifespan.':
		'Questa vescia contiene spore di zucchero, ma non sembra mai raggiungere la maturità necessaria a rilasciarle. Influisce sulle piante circostanti rallentandone il metabolismo, riducendone gli effetti ma allungandone il ciclo vitale.',
	'Garden information': 'Informazioni sul giardino',
	'Your garden is frozen, providing no effects.':
		'Il tuo giardino è congelato e non produce alcun effetto.',
	...
	'%1 to harvest all mature plants of this type.':
		'%1 per raccogliere tutte le piante mature di questo tipo.',
	Freeze: 'Congela',
	'Cryogenically preserve your garden.<br>Plants no longer grow, spread or die; they provide no benefits.<br>Soil cannot be changed.<div class="line"></div>Using this will effectively pause your garden.':
		'Conserva criogenicamente il tuo giardino.<br>Le piante non crescono, non si diffondono e non muoiono più: non producono più alcun effetto.<br>Il terreno non può essere cambiato.<div class="line"></div>L\'uso di questa funzione metterà come in pausa il tuo giardino.',
	...
	'Do you REALLY want to sacrifice your garden to the sugar hornets?<br><small>You will be left with an empty plot and only the %1 seed unlocked.<br>In return, you will gain <b>%2 sugar lumps</b>.</small>':
		'Vuoi DAVVERO sacrificare il tuo giardino e lasciarlo in balìa dei calabroni zuccherini?<br><small>Rimarrai con un appezzamento vuoto e con il solo seme di %1 sbloccato.<br>In cambio otterrai <b>%2 zollette di zucchero</b>.</small>',
	...
	"You've sacrificed your garden to the sugar hornets, destroying your crops and your knowledge of seeds.<br>In the remains, you find <b>%1 sugar lumps</b>.":
		'Hai sacrificato il tuo giardino lasciandolo alle grinfie dei calabroni zuccherini che hanno distrutto tutto il tuo raccolto e la tua conoscenza in fatto di semi.<br>Tra i resti trovi <b>%1 zollette di zucchero</b>.',
	immortal: 'immortale',
	'predictable growth': 'crescita prevedibile',
	'surrounding plants (%1x%1) age %2% faster':
		'le piante circostanti (%1x%1) invecchiano il %2% più velocemente',
	'surrounding plants (%1x%1) age %2% slower':
		'le piante circostanti (%1x%1) invecchiano il %2% più lentamente',
	'surrounding plants (%1x%1) are %2% more efficient':
		'le piante circostanti (%1x%1) sono il %2% più efficienti',
	'surrounding plants (%1x%1) are %2% less efficient':
		'le piante circostanti (%1x%1) sono il %2% meno efficienti',
	'surrounding tiles (%1x%1) develop no weeds or fungus':
		'i riquadri circostanti (%1x%1) non sviluppano erbacce o funghi',
	'harvest when mature for +%1 of CpS (max. %2% of bank)':
		'raccoglile da mature per +%1 di BpS (max. %2% della banca)',
	...
	'explodes into up to %1 of CpS at the end of its lifecycle (max. %2% of bank)':
		'esplode in fino a %1 di BpS al termine del suo ciclo di vita (max. %2% della banca)',
	'cannot handle cold climates; %1% chance to die when frozen':
		'non sopporta i climi freddi: ha una probabilità del %1% di morire quando congelata',
	'the unfortunate result of some plant combinations':
		'lo sfortunato risultato di alcuni innesti di piante',
	...
	'You will be able to change your soil again in %1.':
		'Sarai in grado di cambiare di nuovo il terreno tra %1.',
	'Click to use this type of soil for your whole field.':
		'Fai clic per usare questo tipo di terreno per tutto il tuo campo.',
	Dirt: 'Terriccio',
	"Simple, regular old dirt that you'd find in nature.":
		'Banale terriccio che si trova normalmente in natura.',
	Fertilizer: 'Fertilizzante',
	'Soil with a healthy helping of fresh manure. Plants grow faster but are less efficient.':
		'Terreno con una sana dose di concime fresco. Le piante crescono più velocemente ma sono meno efficienti.',
	Clay: 'Argilla',
	'Rich soil with very good water retention. Plants grow slower but are more efficient.':
		"Terreno ricco con un'ottima ritenzione idrica. Le piante crescono più lentamente ma sono più efficienti.",
	Pebbles: 'Ciottoli',
	"Dry soil made of small rocks tightly packed together. Not very conducive to plant health, but whatever falls off your crops will be easy to retrieve.<br>Useful if you're one of those farmers who just want to find new seeds without having to tend their garden too much.":
		'Terreno secco composto da pietruzze compattate. Non particolarmente favorevole per un buon raccolto, ma rende facile raccogliere qualsiasi cosa cada dalla pianta.<br>Utile se sei uno di quegli agricoltori che vogliono solo trovare nuovi semi senza dover badare troppo al giardino.',
	...
	'Soil made of bits and pieces of bark and sawdust. Helpful for young sprouts to develop, not so much for mature plants.':
		'Terreno composto da frammenti di corteccia e segatura. Utile per lo sviluppo di germogli, non molto per quello di piante mature.',
	...
	'<b>%1% chance</b> of collecting seeds automatically when plants expire':
		'<b>probabilità del %1%</b> di raccogliere semi automaticamente quando la pianta appassisce',
	'plants spread and mutate <b>%1 times more</b>':
		'le piante si diffondono e mutano <b>%1 volte di più</b>',
	...
	'This tile of soil is empty.<br>Pick a seed and plant something!':
		'Questo riquadro di terreno è vuoto.<br>Scegli un seme e piantalo!',
	...
	'may reproduce, will drop seed when harvested':
		'può riprodursi, lascerà cadere semi quando raccolta',
	...
	'Click to refill your soil timer and trigger <b>1</b> plant growth tick with <b>x%1</b> spread and mutation rate for %2.':
		'Fai clic per ricaricare il timer del terreno e azionare <b>1</b> mossa della crescita delle piante con velocità di diffusione <b>x%1</b> e velocità di mutazione del %2.',
	...
	'Plot size: %1<br>(Upgrades with farm level)':
		'Dimensioni appezzamento: %1<br>(Potenziamenti in base al livello della fattoria)',
	'Garden plants age and mutate %1% faster.':
		'La piante del giardino invecchiano e mutano il %1% più velocemente.',
	'while plant is alive; scales with plant growth':
		'mentre la pianta è viva; si adatta alla crescita della pianta',
	Dungeon: 'Segrete',
	Grimoire: 'Grimorio',
	'This is your magic meter. Each spell costs magic to use.<div class="line"></div>Your maximum amount of magic varies depending on your amount of <b>Wizard towers</b>, and their level.<div class="line"></div>Magic refills over time. The lower your magic meter, the slower it refills.':
		'Questo è il tuo rilevatore di magia. Lanciare un incantesimo ti costerà della magia.<div class="line"></div>Il tuo quantitativo massimo di magia varia a seconda del numero di <b>Torri stregate</b> e al loro livello.<div class="line"></div>La magia si ricarica con trascorrere del tempo. Più basso è il valore dato dal tuo rilevatore di magia e più tempo impiegherà per ricaricarsi.',
	...
	'Click to refill <b>%1 units</b> of your magic meter for %2.':
		'Fai clic per ricaricare <b>%1 unità</b> del tuo rilevatore di magia per %2.',
	'Grimoire spells are %1% cheaper but fail %1% more.':
		'Gli incantesimi del Grimorio sono meno cari del %1% ma falliscono il %1% di più.',
	'Conjure Baked Goods': 'Invoca prodotti da forno',
	'Summon half an hour worth of your CpS, capped at %1% of your cookies owned.':
		"Evoca mezz'ora di BpS, limitata al %1% dei biscotti in tuo possesso.",
	'Trigger a %1-minute clot and lose %1 minutes of CpS.':
		'Aziona un blocco di %1 minuto e perdi %1 minuti di BpS.',
	...
	'Summon a random golden cookie. Each existing golden cookie makes this spell +%1% more likely to backfire.':
		'Evoca un biscotto dorato a caso. Ciascun biscotto dorato esistente aumenta del %1% le probabilità che questo incantesimo si ritorca contro di te.',
	...
	'All active buffs gain %1% more time (up to %2 more minutes).':
		'Tutti i bonus attivi vedono prolungato del %1% il loro tempo (fino a %2 minuti in più).',
	'All active buffs are shortened by %1% (up to %2 minutes shorter).':
		'Tutti i bonus attivi vedono ridotto del %1% il loro tempo (fino a %2 minuti in meno).',
	...
	'The spell picks a random building you could afford if you had twice your current cookies, and gives it to you for free. The building selected must be under %1, and cannot be your most-built one (unless it is your only one).':
		"Grazie a questo incantesimo puoi ottenere gratuitamente una struttura casuale che potresti permetterti solo se avessi il doppio dei biscotti attualmente a tua disposizione. La struttura selezionata deve essere sotto %1, e non può essere la più costruita tra le tue strutture (a meno che non sia l'unica).",
	...
	'Backfired, but no buildings to destroy!':
		"L'incantesimo ti si è ritorto contro, ma non ci sono strutture da distruggere!",
	...
	'One of your %1<br>disappears in a puff of smoke.':
		'Uno dei tuoi %1<br>è scomparso in una nuvola di fumo.',
	...
	'Upgrades are %1% more expensive for an hour.':
		"I potenziamenti sono più cari del %1% per un'ora.",
	...
	'Cast a random spell at half the magic cost, with twice the chance of backfiring.':
		'Lancia un incantesimo a meta prezzo in magia, con il doppio delle probabilità che si ritorca contro di te.',
	...
	'Instantly summon a wrinkler if conditions are fulfilled.':
		'Evoca istantaneamente un divoratore se le condizioni vengono rispettate.',
	...
	'Spells backfire %1 times less for the next %2 minutes.':
		'Gli incantesimi ti si ritorcono contro %1 volte meno per i prossimi %2 minuti.',
	'Spells backfire %1 times more for the next %2 minutes.':
		'Gli incantesimi ti si ritorcono contro %1 volte di più per i prossimi %2 minuti.',
	...
	'[GOD 1 QUOTE]An immortal life spent focusing on the inner self, away from the distractions of material wealth.':
		'Una vita immortale trascorsa a concentrarsi sul proprio sé interiore, lontano dalle cose materiali.',
	...
	'[GOD 2 QUOTE]This sleazy spirit revels in the lust for quick easy gain and contempt for the value of steady work.':
		'Questo spirito abbietto si crogiola nella brama di un guadagno facile e veloce e nel disprezzo per il valore di un lavoro stabile.',
	...
	'[GOD 3 QUOTE]The embodiment of natural disasters. An impenetrable motive drives the devastation caused by this spirit.':
		'La personificazione dei disastri naturali. Una motivazione impenetrabile spinge questo spirito a causare devastazioni.',
	...
	"[GOD 4 QUOTE]This spirit knows about everything you'll ever do, and enjoys dispensing a harsh judgment.":
		'Questo spirito conosce tutto quello che hai fatto e farai e gode nel dispensare giudizi severi.',
	...
	'[GOD 5 QUOTE]This is the spirit of merry getaways and regretful Monday mornings.':
		'Questo è lo spirito delle scappatelle più scanzonate e dei rimpianti che ne seguono.',
	...
	"[GOD 6 QUOTE]All things that be and ever will be were scripted long ago by this spirit's inscrutable tendrils.":
		'Tutto ciò che è stato e che sarà è stato già scritto tempo fa dagli imperscrutabili viticci di questo spirito.',
	...
	'[GOD 7 QUOTE]This spirit enjoys a good cheese after a day of hard work.':
		'A questo spirito non dispiace un bel pezzo di formaggio dopo una dura giornata di lavoro.',
	...
	'[GOD 8 QUOTE]While this spirit has many regrets, helping you rule the world through constant industrialization is not one of them.':
		'Sebbene questo spirito abbia molti rimpianti, aiutarti a dominare il mondo attraverso la costante industrializzazione non è uno di questi.',
	...
	'[GOD 9 QUOTE]A caring spirit said to contain itself, inwards infinitely.':
		'Uno spirito gentile che si dice contenga se stesso, dentro di sé infinitamente.',
	...
	'[GOD 10 QUOTE]This spirit enjoys poking foul beasts and watching them squirm, but has no love for its own family.':
		'Questo spirito si diverte a infilzare bestie ripugnanti e a guardarle contorcersi, ma non prova affetto per propria famiglia.',
	...
	'[GOD 11 QUOTE]You will find that life gets just a little bit sweeter if you can motivate this spirit with tidy numbers and properly-filled tax returns.':
		"Scoprirai che la vita diventa un po' più dolce se riesci a motivare questo spirito con numeri ordinati e dichiarazioni dei redditi adeguatamente compilate.",
	...
	'Drag a spirit onto this slot to assign it.':
		'Trascina uno spirito in questo slot per assegnarglielo.',
	'If a golden cookie is clicked, this spirit is unslotted and all worship swaps will be used up.':
		'Se fai clic su un biscotto dorato, questo spirito verrà rimosso dallo slot e tutti gli scambi devozionali verranno consumati.',
	...
	'The jade slot behaves as a ruby slot and the ruby slot behaves as a diamond slot.':
		'Lo slot giada si comporta come uno slot rubino e lo slot rubino si comporta come lo slot diamante.',
	...
	'You may increase your storage space by upgrading your offices and by buying more %1. You also get %2 extra storage space per %3 level (currently: <b>+%4</b>).':
		'Puoi aumentare lo spazio di immagazzinamento potenziando i tuoi uffici o acquistando altro %1. Inoltre, ottieni spazio di immagazzinamento extra pari al %2 per %3 livello (attualmente: <b>+%4</b>).',
	'The average worth of this stock and how high it can peak depends on the building it is tied to, along with the level of your %1.':
		'Il valore medio di questo titolo azionario e il picco che può raggiungere dipende dalla struttura a cui è legato, insieme al livello del tuo %1.',
	'%1 the hide button to toggle all other stocks.':
		'%1 sul pulsante nascondi per attivare/disattivare tutti gli altri titoli azionari.',
	...
	'You cannot buy and sell this stock in the same tick.':
		'Non puoi acquistare e vendere questo titolo azionario nella stessa mossa.',
	...
	'It is fully upgraded. Its lavish interiors, spanning across innumerable floors, are host to many a decadent party, owing to your nigh-unfathomable wealth.':
		'È stato totalmente potenziato. I suoi sontuosi interni, che si estendono su innumerevoli piani, ospitano molte feste faraoniche grazie alla tua quasi incalcolabile ricchezza.',
	...
	'+%1% base warehouse space for all goods':
		'+% 1% spazio di immagazzinamento base per tutte le merci',
	'Brokers:': 'Broker:',
	...
	'Buying goods normally incurs overhead costs of <b>%1% extra</b>. Each broker you hire reduces that cost by <b>%2%</b>.':
		"L'acquisto di beni normalmente comporta costi generali pari al <b>%1% extra</b>. Ciascun broker che assumi riduce quel costo del <b>%2%</b>.",
	'Current overhead costs thanks to your brokers: <b>+%1%</b>':
		'Costi generali attuali grazie ai tuoi broker: <b>+%1%</b>',
	"Buying a broker costs %1 of CpS (that's $%2).":
		"Il prezzo per l'acquisto di un broker è di %1 di BpS, cioè $%2.",
	"Maximum number of brokers you can own: %1 (the highest amount of grandmas you've owned this run, divided by 10, plus your grandma level)":
		'Numero massimo di broker che puoi possedere: %1 (la quantità più elevata di nonnine in tuo possesso per questa serie, divisa per 10, più il tuo livello nonnina)',
	'Brokers are Wall Street-class grandmas versed in the ways of finance. Stockbroker grandmas work hard and play hard, and will fight telephone in hand to get your clients the best possible deals - with a sizeable profit margin for you, of course.':
		'I broker sono come nonnine di classe Wall Street esperte nel settore finanziario. Le nonnine broker lavorano sodo e giocano duro. Combatteranno, telefono in mano, per far ottenere ai tuoi clienti le migliori offerte possibili con un considerevole margine di profitto per te, ovviamente.',
	...
	"Buy that vintage car you've always wanted. Just pay us back.":
		"Acquista quell'auto d'epoca che hai sempre desiderato. L'importante è ripagarci.",
	'a pawnshop loan': 'un prestito al banco dei pegni',
	"Bad credit? No problem. It's your money, and you need it now.":
		'Cattivo credito? Nessun problema. Si tratta di denaro tuo e ne hai bisogno ora.',
	'a retirement loan': 'un prestito pensionistico',
	"Finance your next house, boat, spouse, etc. You've earned it.":
		"Finanziaci l'acquisto della tua prossima casa, barca, matrimonio, ecc. Te li sei guadagnati.",
	'By taking this loan, you will get %1 CpS for the next %2.':
		'Accettando questo prestito, otterrai %1 BpS per i prossimi %2.',
	'However, you will get %1 CpS for the next %2 after that.':
		'Tuttavia, dopo di ciò otterrai %1 BpS per i prossimi %2.',
	'You must also pay an immediate downpayment of %1 (<b>%2%</b> of your current bank).':
		'Inoltre è necessario pagare un acconto immediato di %1 (<b>%2%</b> della tua banca attuale).',
	'Loan over': 'Prestito terminato',
	'Your loan has expired, and you must now repay the interest.':
		'Il tuo prestito è scaduto e ora devi pagare gli interessi.',
	...
	'Click to refill your opportunity timer (and give a quick burst to your economy) for %1.':
		'Fai clic per ricaricare il tuo timer delle opportunità (e dai una scossa di energia alle tue finanze) al prezzo di %1.',
	'Profits: %1. All prices are in $econds of your highest raw cookies per second.':
		'Profitti: %1. Tutti i prezzi sono in $econdi del tuo record di biscotti crudi al secondo.',
	...
	'[Upgrade name 97]Round british tea biscuits with heart motif':
		'Biscotti da tè rotondi con cuore',
	'[Upgrade name 98]Round chocolate british tea biscuits with heart motif':
		'Biscotti da tè rotondi al cioccolato con cuore',
	...
	'[Upgrade name 318]Some other super-tiny fundamental particle? Probably?':
		"Un'altra minuscola particella fondamentale? Forse?",
	...
	'[Upgrade name 400]Lavender chocolate butter biscuit':
		'Biscotti al burro e cioccolato alla lavanda',
	...
	'[Upgrade name 442]Kitten assistants to the regional manager':
		'Assistente felino al direttore regionale',
	...
	'[Upgrade name 477]Synthetic chocolate green honey butter biscuit':
		'Biscotti al burro e miele verde con cioccolato sintetico',
	'[Upgrade name 478]Royal raspberry chocolate butter biscuit':
		'Biscotti al burro e cioccolato reale al lampone',
	'[Upgrade name 479]Ultra-concentrated high-energy chocolate butter biscuit':
		'Biscotti al burro e cioccolato energetico ultraconcentrato',
	...
	'[Upgrade name 497]Pure pitch-black chocolate butter biscuit':
		'Biscotti al burro e puro cioccolato nero',
	...
	'[Upgrade name 553]A chocolate chip cookie but with the chips picked off for some reason':
		'Biscotto con scaglie di cioccolato, ma per qualche motivo hanno tolto le scaglie',
	...
	'[Upgrade name 718]Milkhelp&reg; lactose intolerance relief tablets':
		"Pastiglie NoLatte® per il sollievo dell'intolleranza al lattosio",
	...
	'[Upgrade name 804]Distinguished wallpaper assortment':
		'Raffinato assortimento di carta da parati',
	...
	'[Achievement name 196]Too many rabbits, not enough hats':
		'Troppi conigli, troppo pochi cappelli',
	...
	'[Achievement name 225]He who controls the cookies controls the universe':
		"Chi controlla i biscotti, controlla l'universo",
	...
	'[Achievement name 230]Brought to you by the letter <div style="display:inline-block;background:url(img/money.png);width:16px;height:16px;"></div>':
		'Comincia con la lettera <div style="display:inline-block;background:url(img/money.png);width:16px;height:16px;"></div>',
	...
	'[Achievement name 232]When this baby hits 36 quadrillion cookies per hour':
		'Quando questo aggeggio toccherà i 36 biliardi di biscotti oraribiscotto',
	...
	'[Achievement name 234]Cookiehertz : a really, really tasty hertz':
		'Biscohertz: un hertz molto, molto gustoso',
	...
	"[Achievement name 255]And now for my next trick, I'll need a volunteer from the audience":
		'Per il mio prossimo trucco, avrò bisogno di un volontario dal pubblico',
	...
	'[Achievement name 259]cookie clicker forever and forever a hundred years cookie clicker, all day long forever, forever a hundred times, over and over cookie clicker adventures dot com':
		"cookie clicker sempre e per sempre per cent'anni cookie clicker, per tutto il giorno per sempre, per cento giorni cookie clicker, per sempre per cento volte, ancora e ancora, le avventure di cookie clicker punto com",
	...
	"[Achievement name 275]Well the cookies start coming and they don't stop coming":
		'Gli anni passano, ma i biscotti restano',
	"[Achievement name 276]I don't know if you've noticed but all these icons are very slightly off-center":
		"Forse non l'hai notato, ma tutte queste icone sono leggermente decentrate",
	...
	"[Achievement name 278]If it's worth doing, it's worth overdoing":
		'Ciò che vale la pena di fare, vale la pena di esagerare',
	"[Achievement name 279]The dreams in which I'm baking are the best I've ever had":
		"E naufragar m'è dolce in questo impasto",
	...
	'[Achievement name 293]Click (starring Adam Sandler)':
		'Cambia la tua vita con un clic (con Adam Sandler)',
	...
	'[Achievement name 327]Grandma needs a new pair of shoes':
		'A nonna serve un bel paio di scarpe nuove',
	...
	'[Achievement name 349]What happens in the vortex stays in the vortex':
		'Ciò che accade nel vortice resta nel vortice',
	...
	"[Achievement name 357]Save your breath because that's all you've got left":
		'Risparmia il fiato, è tutto ciò che ti resta',
	...
	"[Achievement name 361]Don't get used to yourself, you're gonna have to change":
		'Non abituarti al vecchio te, dovrai cambiare',
	'[Achievement name 362]Objects in the mirror dimension are closer than they appear':
		'Gli oggetti nelle dimensioni specchio sono più vicini di quanto appaiano',
	...
	'[Achievement name 376]All the other kids with the pumped up clicks':
		'Stessa storia, stesso posto, stesso clic',
	...
	'[Achievement name 380]In the garden of Eden (baby)':
		"Nel giardino dell'Eden (cara, ogni giorno ti amo di più)",
	...
	'[Achievement name 398]With her finger and her thumb':
		'Oh, accidenti, le dita non me le sento più... io le dita non ce le ho!',
	...
	'[Achievement name 405]The meteor men beg to differ':
		'Il mago sarà in cima alle scale, nella stanza più remota della torre più alta',
	...
	'[Achievement name 407]We could all use a little change':
		'Abbiamo bevuto una pozione magica e ora... siamo sexy',
	'[Achievement name 408]Your brain gets smart but your head gets dumb':
		'Le cipolle hanno gli strati, gli universi hanno gli strati',
	...
	"[Achievement name 411]You'll never shine if you don't glow":
		"Sai cos'altro piace a tutti? I prismi",
	"[Achievement name 412]You'll never know if you don't go":
		'Oooh, ti aspettavi il principe azzurro, vero?',
	...
	'[Achievement name 421]For more information on this achievement, please refer to its title':
		'Per ulteriori informazioni su questo obiettivo, fare riferimento al titolo',
	"[Achievement name 422]I'm so meta, even this achievement":
		'Sono proprio meta, anche con questo obiettivo',
	...
	"[Achievement name 442]Dude what if we're all living in a simulation like what if we're all just code on a computer somewhere":
		'Immagina se stessimo vivendo in una simulazione, se fossimo solo codici su un computer',
	...
	"[Achievement name 449]You're #1 so why try harder":
		'Sei già il migliore, perché faticare ancora',
	...
	'[Achievement name 495]Mountain out of a molehill, but like in a good way':
		'Fare di un sassolino una montagna, ma in senso positivo',
	...
	'[Achievement name 515]Nobody exists on purpose, nobody belongs anywhere':
		'Nessuno esiste di proposito, nessuno appartiene a un posto',
	...
	'[Achievement name 544]A trademarked portmanteau of "imagination" and "engineering"':
		'Una parola composta registrata tra "immaginazione" e "ingegneria"',
	...
	"[Achievement name 558]Don't let the walls cave in on you":
		'Non lasciare che le pareti di crollino addosso',
	...
	'[Achievement name 586]What do you get for the baker who has everything':
		'Cosa regalare a un panettiere che ha tutto',
