AddLanguage('FR', 'french', {
	...
	grandmapocalypse: '/',
	'%1 cookie': ['%1 cookie', '%1 cookies'],
	'%1 sugar lump': ['%1 morceau de sucre', '%1 morceaux de sucre'],
	'%1 heavenly chip': ['%1 pépite céleste', '%1 pépites célestes'],
	'%1 golden cookie': ['%1 cookie doré', '%1 cookies dorés'],
	'%1 building': ['%1 construction', '%1 constructions'],
	'%1 upgrade': ['%1 amélioration', '%1 améliorations'],
	Yes: 'Oui',
	No: 'Non',
	...
	Esc: 'Échapp',
	Cookies: '/',
	'%1 day': ['%1 jour', '%1 jours'],
	'%1 hour': ['%1 heure', '%1 heures'],
	'%1 minute': ['%1 minute', '%1 minutes'],
	'%1 second': ['%1 seconde', '%1 secondes'],
	...
	'visual improvements; disabling may improve performance':
		'améliorations visuelles, désactiver peut améliorer les performances',
	Particles: 'Particules',
	Numbers: 'Nombres',
	'numbers that pop up when clicking the cookie':
		'nombres qui apparaissent en cliquant sur le cookie',
	'Milk [setting]': 'Lait',
	...
	'display boxes around upgrades and achievements in Stats':
		'affiche des boîtes autour des améliorations et des trophées dans les statistiques',
	'Alt font': 'Police alternative',
	'your cookies are displayed using a monospace font':
		'vos cookies sont affichés avec une police à chasse fixe',
	...
	'the game will ask you to confirm when you close the window':
		'le jeu demandera confirmation avant de fermer la fenêtre',
	Defocus: 'Arrière-plan',
	'the game will be less resource-intensive when out of focus':
		'le jeu exigera moins de ressources quand il sera en arrière-plan',
	...
	'the game will ask you to confirm before spending sugar lumps':
		"une confirmation sera demandée avant l'utilisation de morceaux de sucre",
	'Custom grandmas': 'Grand-mères personnalisées',
	'some grandmas will be named after Patreon supporters':
		'certaines grand-mères porteront le nom de mécènes de Patreon',
	...
	"on slower computers, the game will put itself in sleep mode when it's inactive and starts to lag out; offline CpS production kicks in during sleep mode":
		"sur les ordinateurs plus lents, le jeu passera en mode veille en cas d'inactivité et de ralentissement, la production CpS démarre en mode veille",
	'Music in background': 'Musique de fond',
	"music will keep playing even when the game window isn't focused":
		"la musique sera toujours jouée, même quand la fenêtre n'est pas au premier plan",
	'Cloud saving': 'Sauvegarder sur le Cloud',
	'allow use of Steam Cloud for save backups':
		"permet d'utiliser le Steam Cloud pour les sauvegardes",
	...
	'allows optimizations for screen readers; game will reload':
		"permet les optimisations pour lecteurs d'écrans ; le jeu rechargera",
	'Discord status': 'Statut Discord',
	'if Discord is on, show your game info as activity status':
		"si Discord est activé, affiche vos infos de jeu en tant que statut d'activité",
	Language: 'Langue',
	'Language: %1': 'Langue: %1',
	...
	'These are feats that are either unfair or difficult to attain. They do not give milk.':
		"Ces exploits sont difficiles à accomplir, voire injustes, et n'apportent pas de lait.",
	...
	'with %1 ascension': ['avec %1 ascension', 'avec %1 ascensions'],
	...
	'Milk is gained with each achievement. It can unlock unique upgrades over time.':
		'Tu gagnes du lait avec chaque trophée. Il peut débloquer des améliorations uniques avec le temps.',
	'Rank %1': 'Rang %1',
	...
	'Cookie Clicker is a javascript game by %1 and %2.':
		'Cookie Clicker est un jeu javascript par %1 et %2.',
	...
	"This version of Cookie Clicker is 100% free, forever. Want to support us so we can keep developing games? Here's some ways you can help:%1":
		'Cette version de Cookie Clicker est totalement gratuite, et le restera toujours. Tu veux nous aider à continuer à développer des jeux ? Voici comment tu peux nous aider : %1',
	"Note: if you find a new bug after an update and you're using a 3rd-party add-on, make sure it's not just your add-on causing it!":
		"Note : si tu découvres un bug après une mise à jour mais que tu utilises un module complémentaire tiers, assure-toi que ce n'est pas ce dernier qui en est la cause !",
	'Warning: clearing your browser cache or cookies <small>(what else?)</small> will result in your save being wiped. Export your save and back it up first!':
		'Attention : effacer le cache ou les cookies <small>(évidemment !)</small> de ton navigateur effacera ta sauvegarde. Exporte ta sauvegarde pour en faire une copie avant !',
	'Version history': 'Historique des versions',
	'Official website': 'Site Web officiel',
	'Note: links will open in your web browser.':
		"Note : les liens s'ouvriront dans votre navigateur Web.",
	'Note: older update notes are in English.':
		'Note : les anciennes notes de mise à jour sont en Anglais.',
	'This feature is not yet available in your language.':
		"Cette fonctionnalité n'est pas encore disponible dans votre langue.",
	...
	'Cookie Clicker is in sleep mode and generating offline cookies.':
		'Cookie Clicker est en mode veille et génère des cookies hors ligne.',
	...
	'(this happens when too many frames are skipped at once,<br>usually when the game has been running in the background for a while)<br>(you can turn this feature off in the settings menu)':
		'(ceci arrive lorsque trop de trames sont sautées à la fois,<br>généralement quand le jeu a tourné en arrière-plan pendant un moment)<br>(tu peux désactiver cette option dans le menu des paramètres)',
	...
	'Hello again! Just a reminder that you may want to back up your Cookie Clicker save every once in a while, just in case.<br>To do so, go to Options and hit "Export save" or "Save to file"!':
		"Rebonjour ! Juste pour te dire qu'il serait judicieux de copier ta sauvegarde Cookie Clicker de temps en temps, juste au cas où.<br>Pour le faire, va dans les Options et clique sur « Exporter sauvegarde » ou « Enregistrer fichier » !",
	'Save manually (the game autosaves every 60 seconds; shortcut: ctrl+S)':
		'Sauvegarde manuelle (le jeu effectue une sauvegarde automatique toutes les 60 secondes, raccourci clavier : Ctrl + s)',
	'You can use this to backup your save or to transfer it to another computer (shortcut for import: ctrl+O)':
		"Peut s'utiliser pour copier la sauvegarde ou la transférer vers un autre ordinateur (raccourci d'importation : Ctrl + o)",
	...
	'This is your save code.<br>Copy it and keep it somewhere safe!':
		"C'est ton code de sauvegarde.<br>Copie-le et garde-le à l'abri !",
	'Import save': 'Importer sauvegarde',
	'Please paste in the code that was given to you on save export.':
		"Merci de coller le code donné lors de l'exportation de sauvegarde.",
	...
	'Oops, looks like the import string is all wrong!':
		"Oups, on dirait qu'il y a un problème de chaîne n'importation !",
	'You are attempting to load a save from a future version (v. %1; you are using v. %2).':
		"Tu es en train d'essayer de charger une sauvegarde d'une version future (v. %1, alors que tu utilises v. %2).",
	"Sorry, you can't import saves from the classic version.":
		'Désolés, tu ne peux pas importer des sauvegardes de la version classique.',
	'Wipe save': 'Effacer sauvegarde',
	'Delete all your progress, including your achievements':
		'Efface toute ta progression, notamment tes trophées',
	'Do you REALLY want to wipe your save?<br><small>You will lose your progress, your achievements, and your heavenly chips!</small>':
		'Veux-tu VRAIMENT effacer ta sauvegarde ?<br><small>Tu perdras toute ta progression, tes trophées et tes pépites célestes !</small>',
	"Whoah now, are you really, <b><i>REALLY</i></b> sure you want to go through with this?<br><small>Don't say we didn't warn you!</small>":
		"Holà, mais est-ce que tu veux vraiment, <b><i>VRAIMENT</i></b> faire ça ?<br><small>Tu ne pourras pas dire qu'on ne t'avait pas prévenu !</small>",
	...
	'Only use mods from trusted sources. Some mods may require a game restart to take effect.':
		"N'utilise que les mods de sources fiables. Certains mods peuvent exiger de relancer le jeu pour prendre effet.",
	Enable: 'Activer',
	Disable: 'Désactiver',
	...
	'This tool allows you to upload new mods to the Steam Workshop.<br>You need to select a mod folder containing a properly-formatted %1 file.<br>See the included sample mods for examples.':
		'Cet outil vous permet de téléverser de nouveaux mods vers le Workshop Steam.<br>Vous devez sélectionner un dossier de mod contenant un fichier %1 correctement formaté.<br>Voir les échantillons de mods inclus pour des exemples.',
	...
	'These are the mods present in your save data. You may delete some of this data to make your save file smaller.':
		'Ce sont les mods présents dans tes données de sauvegarde. Tu peux en effacer une partie pour rendre ton fichier de sauvegarde plus petit.',
	'(loaded)': '(chargé)',
	'%1 char': ['%1 caractère', '%1 caractères'],
	'Check mod data': 'Vérifier les données de mod',
	'view and delete save data created by mods':
		'voir et effacer les données de sauvegarde issues des mods',
	...
	'You are currently playing Cookie Clicker on the <b>%1</b> protocol.<br>The <b>%2</b> version uses a different save slot than this one.<br>Click this lock to reload the page and switch to the <b>%2</b> version!':
		'Tu joues actuellement à Cookie Clicker sur le protocole <b>%1</b>.<br>La version <b>%2</b> utilise un emplacement de sauvegarde différent de celle-ci.<br>Clique sur ce verrou pour recharger la page et passer à la version <b>%2</b> !',
	'+%1 more notification.': ['+%1 notification de plus.', '+%1 notifications de plus.'],
	Christmas: 'Noël',
	...
	"Because you've baked a <b>billion cookies</b> in total, you are now attracting <b>sugar lumps</b>. They coalesce quietly near the top of your screen, under the Stats button.<br>You will be able to harvest them when they're ripe, after which you may spend them on all sorts of things!":
		"Comme tu as cuit un <b>milliard de cookies</b> au total, tu attires des <b>morceaux de sucre</b>. Ils se forment discrètement près du sommet de ton écran, sous le bouton Statistiques.<br>Tu pourras les récolter une fois qu'ils seront mûrs, et tu pourras ensuite les dépenser pour acheter toutes sortes de choses !",
	'A <b>sugar lump</b> is coalescing here, attracted by your accomplishments.':
		'Un <b>morceau de sucre</b> se forme ici, attiré par tes réussites.',
	'Your sugar lumps mature after <b>%1</b>,<br>ripen after <b>%2</b>,<br>and fall after <b>%3</b>.':
		"Tes morceaux de sucre s'affinent après <b>%1</b>,<br>mûrissent après <b>%2</b>,<br>et tombent après <b>%3</b>.",
	...
	"This sugar lump is mature and will be ripe in <b>%1</b>.<br>You may <b>click it to harvest it now</b>, but there is a <b>50% chance you won't get anything</b>.":
		'Ce morceau de sucre est affiné et sera mûr dans <b>%1</b>.<br>Tu peux <b>cliquer dessus pour le récolter maintenant</b>, mais il y a <b>50 % de chances de ne rien obtenir</b>.',
	'<b>This sugar lump is ripe! Click it to harvest it.</b><br>If you do nothing, it will auto-harvest in <b>%1</b>.':
		"<b>Ce morceau de sucre est mûr ! Clique dessus pour le récolter.</b><br>Si tu ne fais rien, il s'auto-récoltera dans <b>%1</b>.",
	'This sugar lump grew to be <b>bifurcated</b>; harvesting it has a 50% chance of yielding two lumps.':
		"Ce morceau de sucre s'est <b>dédoublé</b> en grandissant. Sa récolte offre 50 % de chances d'obtenir deux morceaux.",
	'This sugar lump grew to be <b>golden</b>; harvesting it will yield 2 to 7 lumps, your current cookies will be doubled (capped to a gain of 24 hours of your CpS), and you will find 10% more golden cookies for the next 24 hours.':
		"Ce morceau de sucre est devenu <b>doré</b> en grandissant. Sa récolte va permettre d'obtenir 2 à 7 morceaux, ton nombre de cookies actuel sera doublé (dans la limite d'un gain de 24 heures de tes CpS), et tu trouveras 10 % de cookies dorés supplémentaires pour les prochaines 24 heures.",
	'This sugar lump was affected by the elders and grew to be <b>meaty</b>; harvesting it will yield between 0 and 2 lumps.':
		'Ce morceau de sucre a été affecté par les anciennes, et est devenu <b>charnu</b>. Sa récolte apportera entre 0 et 2 morceaux.',
	'This sugar lump is <b>caramelized</b>, its stickiness binding it to unexpected things; harvesting it will yield between 1 and 3 lumps and will refill your sugar lump cooldowns.':
		"Ce morceau de sucre est <b>caramélisé</b>, ce qui le fait coller à tout et n'importe quoi. Sa récolte apportera entre 1 et 3 morceaux, et remplira tes barres d'attente de morceaux.",
	...
	'Your cookies have been doubled.<br>+10% golden cookies for the next 24 hours.':
		'Ton nombre de cookies a été doublé.<br>+10 % de cookies dorés pour les prochaines 24 heures.',
	...
	Heralds: 'Hérauts',
	'%1 herald': ['%1 héraut', '%1 hérauts'],
	"Heralds couldn't be loaded. There may be an issue with our servers, or you are playing the game locally.":
		'Impossible de charger les hérauts. Il y a peut-être un problème avec nos serveurs, ou tu joues au jeu en local.',
	'There are no heralds at the moment. Please consider <b>donating to our Patreon</b>!':
		"Il n'y a pas de hérauts pour l'instant. Merci d'envisager un <b>don sur notre Patreon</b> !",
	'selflessly inspiring a boost in production for everyone, resulting in %1.':
		'donnant généreusement une hausse de production pour tout le monde, générant %1.',
	'+%1% cookies per second': '+%1 % cookies par seconde',
	'You are in a <b>Born again</b> run, and are not currently benefiting from heralds.':
		'Tu es dans une partie <b>renaissance</b>, et ne bénéficies pas des hérauts pour le moment.',
	'You own the <b>Heralds</b> upgrade, and therefore benefit from the production boost.':
		"Tu possèdes l'amélioration <b>hérauts</b>, et bénéficies donc de la hausse de production.",
	'To benefit from the herald bonus, you need a special upgrade you do not yet own. You will permanently unlock it later in the game.':
		'Pour bénéficier du bonus des hérauts, il te faut une amélioration spéciale que tu ne possèdes pas encore. Tu pourras la débloquer définitivement plus tard dans la partie.',
	'<b>Heralds</b> are people who have donated to our highest Patreon tier, and are limited to 100.<br>Each herald gives everyone +1% CpS.<br>Heralds benefit everyone playing the game, regardless of whether you donated.':
		"Les <b>hérauts</b> sont ceux qui ont donné à hauteur de notre palier Patreon le plus élevé, et il ne peut y en avoir plus de 100.<br>Chaque héraut offre + 1 % CpS à tout le monde.<br>Les hérauts profitent à tous les joueurs, même à ceux qui n'ont pas fait de don.",
	'Every %1 current players on Steam generates <b>1 herald</b>, up to %2 heralds.<br>Each herald gives everyone +1% CpS.':
		'<b>1 Héraut</b> est généré tous les %1 joueurs actuels sur Steam, dans la limite de %2 hérauts.<br>Chaque héraut donne + 1 % CpS à tout le monde.',
	'+%1!': '+%1 !',
	...
	'Sweet!<br><small>Found 1 sugar lump!</small>':
		'Joli !<br><small>Trouvé 1 morceau de sucre !</small>',
	'Lucky!': 'Quelle chance !',
	'Ruin!': 'Raté !',
	...
	'Cookie chain broken.<br><small>You made %1.</small>':
		'Chaîne de cookies interrompue.<br><small>Tu as fait %1.</small>',
	'Cookie blab': [
	...
	'Lets you use two dragon auras simultaneously':
		"Te permet d'utiliser deux auras de dragon à la fois",
	...
	'Select an aura from those your dragon knows.':
		'Choisis une aura parmi celles que ton dragon connaît.',
	'<b>One tenth</b> of every other dragon aura, <b>combined</b>.':
		'<b>Un dixième</b> de toutes les autres auras de dragon <b>combinées</b>.',
	'Switching your aura is <b>free</b> because you own no buildings.':
		"Ton changement d'aura est <b>gratuit</b> parce que tu ne possèdes aucune construction.",
	'The cost of switching your aura is <b>%1</b>.<br>This will affect your CpS!':
		"Ton changement d'aura coûtera <b>%1</b>.<br>Tes CpS seront modifiés !",
	...
	'You feel like making cookies. But nobody wants to eat your cookies.':
		'Tu as envie de faire des cookies. Mais personne ne veut les manger.',
	'Your first batch goes to the trash. The neighborhood raccoon barely touches it.':
		'Ta première fournée finit à la poubelle. Le raton laveur du quartier ose à peine y toucher.',
	...
	'Your cookies are talked about for miles around.':
		'On parle de tes cookies à des kilomètres à la ronde.',
	...
	'Your cookies bring all the boys to the yard.':
		'Tes cookies attirent tous les garçons dans la cour.',
	...
	'Your cookies sell very well in distant countries.':
		'Tes cookies se vendent très bien dans des pays éloignés.',
	'People come from very far away to get a taste of your cookies.':
		'Des gens vienennt de très loin pour goûter tes cookies.',
	'Kings and queens from all over the world are enjoying your cookies.':
		'Des rois et reines du monde entier adorent tes cookies.',
	'There are now museums dedicated to your cookies.':
		'Il y a désormais des musées consacrés à tes cookies.',
	'A national day has been created in honor of your cookies.':
		"Une journée nationale a été établie en l'honneur de tes cookies.",
	'Your cookies have been named a part of the world wonders.':
		'Tes cookies ont été nommés parmi les merveilles du monde.',
	'History books now include a whole chapter about your cookies.':
		"Les livres d'histoire consacrent un chapitre entier à tes cookies.",
	'Your cookies have been placed under government surveillance.':
		'Tes cookies ont été placés sous surveillance gouvernementale.',
	...
	'Strange creatures from neighboring planets wish to try your cookies.':
		"D'étranges créatures de planètes voisines veulent goûter tes cookies.",
	'Elder gods from the whole cosmos have awoken to taste your cookies.':
		'Des dieux anciens du cosmos entier se sont éveillés pour goûter tes cookies.',
	'Beings from other dimensions lapse into existence just to get a taste of your cookies.':
		"Des êtres d'autres dimensions se matérialisent pour goûter à tes cookies.",
	...
	'The universe has now turned into cookie dough, to the molecular level.':
		"L'univers s'est maintenant transformé en pâte à cookie au niveau moléculaire.",
	'Your cookies are rewriting the fundamental laws of the universe.':
		"Tes cookies réécrivent les lois fondamentales de l'univers.",
	'A local news station runs a 10-minute segment about your cookies. Success!<br><small>(you win a cookie)</small>':
		'Une chaîne de télé locale a fait un reportage de 10 minutes sur tes cookies, quelle réussite !<br><small>(tu gagnes un cookie)</small>',
	...
	'You gain <b>one hour</b> of your CpS (capped at double your bank).':
		'Tu gagnes <b>une heure</b> de tes CpS (dans la limite du double de ta banque).',
	...
	'Your prestige level is currently <b>%1</b>.<br>(CpS +%2%)':
		'Ton niveau de prestige est actuellement de <b>%1</b>.<br>(CpS + %2 %)',
	'Ascending now would grant you no prestige.':
		"Une ascension maintenant ne t'apporterait aucun prestige.",
	'Ascending now would grant you<br><b>1 prestige level</b> (+1% CpS)<br>and <b>1 heavenly chip</b> to spend.':
		"Une ascension maintenant t'apporterait<br><b>1 niveau de prestige</b> (+1 % CpS)<br>et <b>1 pépite céleste</b> à dépenser.",
	'Ascending now would grant you<br><b>%1 prestige levels</b> (+%2% CpS)<br>and <b>%3 heavenly chips</b> to spend.':
		"Une ascension maintenant t'apporterait<br><b>%1 niveaux de prestige</b> (+%2 % CpS)<br>et <b>%3 pépites célestes</b> à dépenser.",
	'You need <b>%1 more cookies</b> for the next level.':
		'Il te faut <b>%1 cookies en plus</b> pour le prochain niveau.',
	'Do you REALLY want to ascend?<div class="line"></div>You will lose your progress and start over from scratch.<div class="line"></div>All your cookies will be converted into prestige and heavenly chips.':
		'Veux-tu VRAIMENT procéder à l\'ascension ?<div class="line"></div> Tu perdras ta progression et devras recommencer depuis le début.<div class="line"></div> Tous tes cookies seront transformés en prestige et en pépites célestes.',
	...
	'You will keep your achievements, building levels and sugar lumps.':
		'Tu conserveras tes trophées, niveaux de construction et morceaux de sucre.',
	...
	'%1 prestige level': ['%1 niveau de prestige', '%1 niveaux de prestige'],
	...
	"You are ascending.<br>Drag the screen around<br>or use arrow keys!<br>When you're ready,<br>click Reincarnate.":
		"Ton ascension est en cours.<br>Fais glisser l'écran<br>ou utilise les touches directionnelles !<br>Quand tu le voudras,<br>clique sur Réincarnation.",
	'Each prestige level grants you a permanent <b>+%1% CpS</b>.<br>The more levels you have, the more cookies they require.':
		"Chaque niveau de prestige t'offre <b>+%1 % CpS</b> de manière permanente.<br>Plus tu as de niveaux, plus ceux-ci exigent de cookies.",
	'Heavenly chips are used to buy heavenly upgrades.<br>You gain <b>1 chip</b> every time you gain a prestige level.':
		'Les pépites célestes servent à acheter des améliorations célestes.<br>Tu gagnes <b>1 pépite</b> à chaque niveau de prestige gagné.',
	"Click this once you've bought<br>everything you need!":
		'Clique ici une fois que tu auras acheté<br>tout ce dont tu as besoin !',
	'Are you ready to return to the mortal world?':
		'Es-tu prêt(e) à retourner dans le monde des mortels ?',
	...
	'Challenge modes apply special modifiers to your next ascension.<br>Click to change.':
		'Les modes défi appliquent des modificateurs spéciaux à ta prochaine ascension.<br>Clique pour changer.',
	...
	"It's <b>Valentine's season</b>!<br>Love's in the air and cookies are just that much sweeter!":
		"C'est le <b>saison de la Saint-Valentin</b> !<br>Il y a de l'amour dans l'air et les cookies sont encore plus savoureux !",
	'Business Day!': 'Jour des affaires !',
	"It's <b>Business season</b>!<br>Don't panic! Things are gonna be looking a little more corporate for a few days.":
		"C'est le <b>Jour des affaires</b> !<br>Pas de panique ! Les choses vont avoir l'air un peu plus professionnelles pour quelques jours.",
	'Halloween!': 'Halloween !',
	"It's <b>Halloween season</b>!<br>Everything is just a little bit spookier!":
		"C'est la <b>saison d'Halloween</b> !<br>Tout est un peu plus effrayant !",
	'Christmas time!': 'Noël !',
	"It's <b>Christmas season</b>!<br>Bring good cheer to all and you just may get cookies in your stockings!":
		"C'est la <b>saison de Noël</b> !<br>Répands la bonne humeur autour de toi et tu auras peut-être des cookies dans ton petit soulier !",
	'Easter!': 'Pâques !',
	"It's <b>Easter season</b>!<br>Keep an eye out and you just might click a rabbit or two!":
		"C'est la <b>saison de Pâques</b> !<br>Ouvre l'œil et tu pourras peut-être cliquer sur un lapin ou deux !",
	...
	'Upgrade is vaulted and will not be auto-purchased.':
		"L'amélioration est dans le coffre et ne sera pas achetée automatiquement.",
	...
	'Will <b>instantly purchase</b> every upgrade you can afford, starting from the cheapest one.<br>Upgrades in the <b>vault</b> will not be auto-purchased.<br>You may place an upgrade into the vault by <b>Shift-clicking</b> on it.':
		'<b>Achètera instantanément</b> toutes les améliorations que tu peux acheter, commençant par la moins chère.<br>Les améliorations dans le <b>coffre</b> ne seront pas achetées automatiquement.<br>Tu peux placer une amélioration dans le coffre en faisant un <b>Majuscule clic</b> dessus.',
	...
	'all combined, these boosts account for <b>%1</b> per second (<b>%2%</b> of total CpS)':
		'au total, ces améliorations amènent <b>%1</b> par seconde (<b>%2 %</b> des CpS totaux)',
	'owned: %1': 'possédés : %1',
	'free: %1!': 'gratuits : %1 !',
	...
	'Levelling up this building unlocks a minigame.':
		'Faire monter de niveau cette construction débloque un mini-jeu.',
	...
	'Names in white were submitted by our supporters on Patreon.':
		'Les noms en blanc sont proposés par nos mécènes sur Patreon.',
	'You can also press %1 to bulk-buy or sell %2 of a building at a time, or %3 for %4.':
		"Tu peux aussi appuyer sur %1 pour acheter en gros ou vendre %2 d'une construction à la fois, ou %3 pour %4.",
	Investment: 'Investissement',
	"You're not sure what this does, you just know it means profit.":
		'Tu ne sais pas ce que ça fait au juste, seulement que ça rapporte.',
	Cursor: 'Curseur',
	cursor: 'curseur',
	cursors: 'curseurs',
	'%1 cursor': ['%1 curseur', '%1 curseurs'],
	'[Cursor quote]Autoclicks once every 10 seconds.':
		'Clique automatiquement toutes les 10 secondes.',
	...
	'[Cursor business quote]Essential in flattening dough. The first step in cookie-making.':
		'Indispensable pour aplatir la pâte. La première étape de la fabrication de cookies.',
	Grandma: 'Grand-mère',
	grandma: 'grand-mère',
	grandmas: 'grand-mères',
	'%1 grandma': ['%1 grand-mère', '%1 grand-mères'],
	'[Grandma quote]A nice grandma to bake more cookies.':
		'Une gentille grand-mère pour cuire plus de cookies',
	'[Grandma business name]Oven': 'Four',
	'[Grandma business quote]A crucial element of baking cookies.':
		'Un élément indispensable pour cuire les cookies.',
	Farm: 'Ferme',
	farm: 'ferme',
	farms: 'fermes',
	'%1 farm': ['%1 ferme', '%1 fermes'],
	'[Farm quote]Grows cookie plants from cookie seeds.':
		'Fait pousser des plants de cookies à partir de graines de cookies.',
	'[Farm business name]Kitchen': 'Cuisine',
	'[Farm business quote]The more kitchens, the more cookies your employees can produce.':
		'Plus tu as de cuisines, plus tes employés peuvent produire de cookies.',
	Mine: '/',
	mine: '/',
	mines: '/',
	'%1 mine': ['%1 mine', '%1 mines'],
	'[Mine quote]Mines out cookie dough and chocolate chips.':
		'Mine de la pâte à cookies et des pépites de chocolat.',
	...
	'[Mine business quote]These give you the edge you need to outsell those pesky competitors.':
		"T'offre l'avantage qu'il te faut pour vendre plus que tes concurrents.",
	Factory: 'Usine',
	factory: 'usine',
	factories: 'usines',
	'%1 factory': ['%1 usine', '%1 usines'],
	'[Factory quote]Produces large quantities of cookies.':
		'Produit des grandes quantités de cookies.',
	...
	'[Factory business quote]Mass production is the future of baking. Seize the day, and synergize!':
		'La production en masse est le futur de la pâtisserie. Profite du jour présent et synergise !',
	Bank: 'Banque',
	bank: 'banque',
	banks: 'banques',
	'%1 bank': ['%1 banque', '%1 banques'],
	...
	"[Bank business quote]Business folks with a nose for profit, ready to finance your venture as long as there's money to be made.":
		"Des affairistes qui flairent les profits, prêts à financer ton entreprise tant qu'il y a de l'argent à faire.",
	Temple: '/',
	temple: '/',
	temples: '/',
	'%1 temple': ['%1 temple', '%1 temples'],
	...
	'[Temple business quote]Your social media page is going viral! Amassing likes is the key to a lasting online presence and juicy advertising deals.':
		"Ta page sur les réseaux sociaux devient virale ! Amasser des j'aime est la clé d'une présence en ligne constante pour obtenir des accords publicitaires juteux.",
	'Wizard tower': 'Tour de mage',
	'wizard tower': 'tour de mage',
	'wizard towers': 'tours de mage',
	'%1 wizard tower': ['%1 tour de mage', '%1 tours de mage'],
	'[Wizard tower quote]Summons cookies with magic spells.':
		'Invoque des cookies avec des sorts magiques.',
	...
	'[Wizard tower business quote]Cookie memes are all the rage! With just the right amount of social media astroturfing, your brand image will be all over the cyberspace.':
		'Les mèmes de cookies sont à la mode ! Avec la bonne dose de faux avis sur les réseaux sociaux, ta marque sera omniprésente dans le cyberespace !',
	Shipment: 'Cargaison',
	shipment: 'cargaison',
	shipments: 'cargaisons',
	'%1 shipment': ['%1 cargaison', '%1 cargaisons'],
	'[Shipment quote]Brings in fresh cookies from the cookie planet.':
		'Apporte des cookies frais de la planète des cookies.',
	...
	'[Shipment business quote]A gigantic cookie emporium - your very own retail chain.':
		'Un immense centre de vente de cookies... pour ta propre franchise de magasins.',
	'Alchemy lab': "Labo d'alchimie",
	'alchemy lab': "labo d'alchimie",
	'alchemy labs': "labos d'alchimie",
	'%1 alchemy lab': ["%1 labo d'alchimie", "%1 labos d'alchimie"],
	...
	"[Alchemy lab business quote]You're officially on the stock market, and everyone wants a piece!":
		'Tu es officiellement coté en bourse, et tout le monde veut sa part !',
	Portal: 'Portail',
	portal: 'portail',
	portals: 'portails',
	'%1 portal': ['%1 portail', '%1 portails'],
	...
	'[Portal business quote]Your cookies have their own sitcom! Hilarious baking hijinks set to the cheesiest laughtrack.':
		"Tes cookies ont leur propre feuilleton à base d'aventure culinaires hilarantes sur fond de rires en boîte !",
	'Time machine': 'Machine à voyager dans le temps',
	'time machine': 'machine à voyager dans le temps',
	'time machines': 'machines à voyager dans le temps',
	'%1 time machine': ['%1 machine à voyager dans le temps', '%1 machines à voyager dans le temps'],
	'[Time machine quote]Brings cookies from the past, before they were even eaten.':
		"Ramène des cookies du passé, avant même qu'ils soient mangés.",
	...
	'[Time machine business quote]Cookie theme parks, full of mascots and roller-coasters. Build one, build a hundred!':
		'Parc sur le thème des cookies, plein de mascottes et de montagnes russes. Construis-en un, construis-en cent !',
	'Antimatter condenser': "Condenseur d'antimatière",
	'antimatter condenser': "condenseur d'antimatière",
	'antimatter condensers': "condenseurs d'antimatière",
	'%1 antimatter condenser': ["%1 condenseur d'antimatière", "%1 condenseurs d'antimatière"],
	'[Antimatter condenser quote]Condenses the antimatter in the universe into cookies.':
		"Condense l'antimatière de l'univers pour en faire des cookies.",
	...
	'[Antimatter condenser business quote]A virtual currency, already replacing regular money in some small countries.':
		"Une monnaie virtuelle, qui remplace déjà l'argent liquide dans certains petits pays.",
	Prism: 'Prisme',
	prism: 'prisme',
	prisms: 'prismes',
	'%1 prism': ['%1 prisme', '%1 prismes'],
	...
	"[Prism business quote]You've made it to the top, and you can now buy entire nations to further your corporate greed. Godspeed.":
		"Tu es au sommet, maintenant, tu peux acheter des pays entiers pour satisfaire l'avidité de ton entreprise. Que rien ne t'arrête.",
	Chancemaker: 'Porte-bonheur',
	chancemaker: 'porte-bonheur',
	chancemakers: 'porte-bonheur',
	'%1 chancemaker': ['%1 porte-bonheur', '%1 porte-bonheur'],
	'[Chancemaker quote]Generates cookies out of thin air through sheer luck.':
		'Génère des cookies à partir du vide grâce à la pure chance.',
	...
	"[Chancemaker business quote]Actually, you know what's cool? A whole planet dedicated to producing, advertising, selling, and consuming your cookies.":
		'En fait, tu sais ce qui serait bien ? Une planète entière dédiée à la production, la publicité, la vente et la consommation de tes cookies.',
	'Fractal engine': 'Moteur fractal',
	'fractal engine': 'moteur fractal',
	'fractal engines': 'moteurs fractals',
	'%1 fractal engine': ['%1 moteur fractal', '%1 moteurs fractals'],
	'[Fractal engine quote]Turns cookies into even more cookies.':
		"Transforme des cookies en d'autres cookies.",
	...
	'[Fractal engine business quote]Only through political dominion can you truly alter this world to create a brighter, more cookie-friendly future.':
		'Seule la domination politique peut te permettre de modifier le monde pour faire advenir des lendemains qui chantent favorables aux cookies.',
	'Javascript console': 'Console javascript',
	'javascript console': 'console javascript',
	'javascript consoles': 'consoles javascript',
	'%1 javascript console': ['%1 console javascript', '%1 consoles javascript'],
	'[Javascript console quote]Creates cookies from the very code this game was written in.':
		'Crée des cookies à partir du langage même dans lequel ce jeu est écrit.',
	...
	'[Javascript console business quote]Taking many forms -religion, culture, philosophy- a doctrine may, when handled properly, cause a lasting impact on civilizations, reshaping minds and people and ensuring all future generations share a singular goal - the production, and acquisition, of more cookies.':
		"Quelle que soit la forme qu'elle prend, religion, culture, ou philosophie, une doctrine peut, utilisée à bon escient, avoir un impact durable sur les civilisations, formant les esprits et les gens pour s'assurer que les générations futures partagent un but unique... la production et l'acquisition de plus de cookies.",
	Idleverse: 'Veillevers',
	idleverse: 'veillevers',
	idleverses: 'veillevers',
	'%1 idleverse': ['%1 veillevers', '%1 veillevers'],
	"[Idleverse quote]There's been countless other idle universes running alongside our own. You've finally found a way to hijack their production and convert whatever they've been making into cookies!":
		"Il y a une infinité (dénombrable) d'univers en veille parallèles au tien. Tu as enfin trouvé le moyen de pirater leur production en convertissant tout ce qu'ils fabriquent en cookies !",
	...
	'[Idleverse business quote]Sometimes the best way to keep going up is sideways. Diversify your ventures through non-cookie investments.':
		'Parfois, le meilleur moyen de continuer à monter consiste à aller sur les côtés. Diversifie tes entreprises avec des investissements hors cookies.',
	...
	'[Cortex baker quote]These artificial brains the size of planets are capable of simply dreaming up cookies into existence. Time and space are inconsequential. Reality is arbitrary.':
		"Ces cerveaux artificiels de la taille d'une planète sont capables de simplement créer des cookies par la force de leur pensée. L'espace et le temps sont sans importance. La réalité est arbitraire.",
	...
	"[Cortex baker business quote]There's only so many ways you can bring in more profit. Or is there? Hire the most brilliant experts in the known universe and let them scrape their brains for you!":
		"Il n'y a qu'un nombre limité de manières de générer plus de profit. Non ? Recrutez les experts les plus brillants de l'univers connu et laissez-les se creuser les méninges pour vous !",
	CpS: '/',
	...
	'All cookie production <b>multiplied by %1</b>.':
		"L'ensemble de la production de cookies est <b>multiplié par %1</b>.",
	'+%1 CpS': '/',
	...
	'Unshackled! <b>+%1%</b> extra production.':
		'Débridé(e)s ! <b>+%1 %</b> de production supplémentaire.',
	'Tiered upgrades for <b>%1</b> provide an extra <b>+%2%</b> production.<br>Only works with unshackled upgrade tiers.':
		"Les améliorations à paliers de <b>%1</b> fournissent <b>+%2 %</b> de production supplémentaire.<br>Ne fonctionne qu'avec les paliers d'amélioration débridés.",
	'Unshackles all <b>%1-tier upgrades</b>, making them more powerful.<br>Only applies to unshackled buildings.':
		"Débride toutes les <b>améliorations à palier %1</b>, les rendant plus puissantes.<br>S'applique uniquement aux constructions débridées.",
	'The mouse and cursors are <b>twice</b> as efficient.':
		'La souris et les curseurs sont <b>deux fois</b> plus efficaces.',
	'The mouse and cursors gain <b>+%1</b> cookies for each non-cursor building owned.':
		'La souris et les curseurs gagnent <b>+%1</b> cookies pour chaque construction possédée hors curseurs.',
	'Grandmas gain <b>+%1% CpS</b> for each non-grandma building.':
		'Les grand-mères gagnent <b>+ %1 % CpS</b> pour chaque construction hors grand-mères.',
	'You gain <b>more CpS</b> the more milk you have.':
		'Tu gagnes <b>plus de CpS</b> plus tu as de lait.',
	'Milk is <b>%1% more powerful</b>.': 'Le lait est <b>%1 % plus puissant</b>.',
	'Cookie production multiplier <b>+%1%</b>.':
		'Multiplicateur de production de cookies <b>+%1 %</b>.',
	'Cookie production multiplier <b>+%1% permanently</b>.':
		'Multiplicateur de production de cookies <b>+%1 % permanents</b>.',
	"Cookie production multiplier <b>+%1% per Santa's levels.</b>":
		'Multiplicateur de production de cookies <b>+%1 % par niveau du Père Noël</b>.',
	'Cookie production multiplier <b>+%1%</b> for every year Cookie Clicker has existed (currently: <b>+%2%</b>).':
		"Multiplicateur de production de cookies <b>+%1 %</b> pour chaque année d'existence de Cookie Clicker (actuellement : <b>+%2 %</b>).",
	'Cookie production multiplier <b>+%1%</b> for every building type level %2 or higher.':
		'Multiplicateur de production de cookies <b>+%1 %</b> pour chaque type de construction de niveau %2 ou plus.',
	...
	'Grandma-operated science lab and leisure club.<br>Grandmas are <b>4 times</b> as efficient.<br><b>Regularly unlocks new upgrades</b>.':
		'Laboratoire scientifique et club de loisirs fonctionnant grâce aux grand-mères.<br>Les grand-mères sont <b>4 fois</b> plus efficaces.<br><b>Débloque régulièrement de nouvelles améliorations</b>.',
	'Each %1 gains <b>+%2 base CpS per %3</b>.':
		'Chaque %1 fait gagner <b>+%2 CpS de base par %3</b>.',
	'Note: the grandmothers are growing restless. Do not encourage them.':
		"Note : les grand-mères commencent à s'agiter. Ne les encourage pas.",
	'Note: proceeding any further in scientific research may have unexpected results. You have been warned.':
		"Note : poursuivre plus loin les recherches scientifiques pourrait produire des résultats inattendus. On t'aura prévenu.",
	...
	"<b>Warning:</b> purchasing this will have unexpected, and potentially undesirable results!<br><small>It's all downhill from here. You have been warned!</small><br><br>Purchase anyway?":
		"<b>Avertissement :</b> cet achat pourrait produire des résultats inattendus, et potentiellement négatifs !<br><small>Ça ne peut plus qu'empirer à partir de maintenant. On t'aura prévenu !</small><br><br>Acheter quand même ?",
	'Contains the wrath of the elders, at least for a while.':
		'Jugule la colère des anciennes, au moins pour un moment.',
	"Puts a permanent end to the elders' wrath, at the cost of %1% of your CpS.":
		'Met définitivement fin à la colère des anciennes, contre %1 % de tes CpS.',
	'You will get %1% of your CpS back, but the grandmatriarchs will return.':
		'Tu récupèreras %1 % de tes CpS, mais les grand-matriarches reviendront.',
	'Time remaining until pledge runs out:': "Temps restant avant la fin de l'engagement :",
	"You haven't pledged to the elders yet.":
		"Tu n'as pas encore formulé d'engagement auprès des anciennes.",
	...
	'Golden cookies appear <b>twice as often</b> and stay <b>twice as long</b>.':
		'Les cookies dorés apparaissent <b>deux fois plus souvent</b> et restent <b>deux fois plus longtemps</b>.',
	'Golden cookies appear <b>%1%</b> more often.':
		'Les cookies dorés apparaissent <b>%1 %</b> plus souvent.',
	'Golden cookies appear <b>%1%</b> more often during %2.':
		'Les cookies dorés apparaissent <b>%1 %</b> plus souvent pendant %2.',
	'Golden cookies appear <b>really often</b>.':
		'Les cookies dorés apparaissent <b>vraiment souvent</b>.',
	'Golden cookie effects last <b>twice as long</b>.':
		'Les effets des cookies dorés durent <b>deux fois plus longtemps</b>.',
	'Golden cookie effects last <b>%1%</b> longer.':
		'Les effets des cookies dorés durent <b>%1 %</b> plus longtemps.',
	'Golden cookies stay <b>%1%</b> longer.': 'Les cookies dorés restent <b>%1 %</b> plus longtemps.',
	'Golden cookies give <b>%1%</b> more cookies.':
		'Les cookies dorés donnent <b>%1 %</b> plus de cookies.',
	'Wrath cookies give <b>%1%</b> more cookies.':
		'Les cookies de colère donnent <b>%1 %</b> plus de cookies.',
	'<b>+%1% CpS</b> per golden cookie on-screen, multiplicative.':
		"<b>+%1 % CpS</b> par cookie doré à l'écran, multiplicatif.",
	'With no buffs and no golden cookies on screen, selling your most powerful building has <b>%1% chance to summon one</b>.':
		"En l'absence de buffs ou de cookies dorés à l'écran, vendre ta construction la plus puissante offre <b>%1 % de chances d'en invoquer un</b>.",
	'Confers various powers to your minigames while active.<br>See the bottom of each minigame for more details.':
		"Confère divers pouvoirs à tes mini-jeux lorsqu'il est actif.<br>Voir au bas de chaque mini-jeu pour plus de détails.",
	'Elder pledges last <b>twice</b> as long.':
		'Les engagements auprès des anciennes durent <b>deux fois</b> plus longtemps.',
	'Can toggle upgrades on and off at will in the stats menu.':
		'Peut activer ou non les améliorations à volonté dans le menu des statistiques.',
	'You keep producing cookies even while the game is closed.':
		'Tu continues à produire des cookies même quand le jeu est fermé.',
	'Unlocks <b>%1%</b> of the potential of your prestige level.':
		'Débloque <b>%1 %</b> du potentiel de ton niveau de prestige.',
	'Subsequent research will be <b>%1 times</b> as fast.':
		'Les recherches suivantes seront <b>%1 fois</b> plus rapides.',
	'Wrinklers appear <b>%1 times</b> as fast.':
		'Les rideux apparaissent <b>%1 fois</b> plus rapidement.',
	...
	'Wrinklers explode into <b>%1% more cookies</b>.':
		'Les rideux explosent pour donner <b>%1 % plus de cookies</b>.',
	...
	'Buildings sell back for <b>%1%</b> instead of %2%.':
		'Les constructions se revendent pour <b>%1 %</b> au lieu de %2 %.',
	'All buildings are <b>%1% cheaper</b>.':
		'Toutes les constructions sont <b>%1 %</b> moins chères.',
	...
	'All buildings and upgrades are <b>%1% cheaper</b>.':
		'Toutes les constructions et améliorations sont <b>%1 %</b> moins chères.',
	'%1 are <b>%2%</b> more efficient and <b>%3%</b> cheaper.':
		'%1 sont <b>%2 %</b> plus efficaces et coûtent <b>%3 %</b> en moins.',
	'Cookie upgrades are <b>%1 times cheaper</b>.':
		'Les améliorations de cookies sont <b>%1 fois</b> moins chères.',
	'Random drops are <b>%1% more common</b>.':
		'Les apparitions aléatoires sont <b>%1 %</b> plus fréquentes.',
	...
	'Allows you to <b>trigger seasonal events</b> at will, for a price.':
		'Permet de <b>déclencher des évènements saisonniers</b> à volonté contre paiement.',
	'Triggers <b>%1 season</b> for the next 24 hours.<br>Triggering another season will cancel this one.<br>Cost scales with unbuffed CpS and increases with every season switch.':
		'Déclenche la <b>saison %1</b> pour les prochaines 24 h.<br>Déclencher une autre saison annulera celle-ci.<br>Le coût est proportionnel aux CpS et augmente avec chaque changement de saison.',
	...
	"You haven't switched seasons this ascension yet.":
		"Tu n'as pas encore changé de saison au cours de cette ascension.",
	"You've switched seasons <b>once</b> this ascension.":
		'Tu as changé de saison <b>une fois</b> au cours de cette ascension.',
	"You've switched seasons <b>%1 times</b> this ascension.":
		'Tu as changé de saison <b>%1 fois</b> au cours de cette ascension.',
	'Cookie production <b>multiplied by 1,000</b>.':
		'Production de cookies <b>1 000 fois</b> plus grande.',
	'Other eggs appear <b>%1% more frequently</b>.':
		'Les autres œufs apparaissent <b>%1 % plus souvent</b>.',
	...
	'Christmas cookies drop <b>%1%</b> more often.':
		'Les cookies de Noël apparaissent <b>%1 %</b> plus souvent.',
	'Spooky cookies drop <b>%1%</b> more often.':
		'Les cookies effrayants apparaissent <b>%1 %</b> plus souvent.',
	'Heart cookies are <b>%1%</b> more powerful.':
		'Les cookies cœur sont <b>%1 %</b> plus puissants.',
	"You continually gain <b>more CpS the longer you've played</b> in the current ascension.":
		"Tu gagnes continuellement <b>davantage de CpS plus tu as joué longtemps</b> au cours de l'ascension actuelle.",
	...
	'Contains an assortment of rich butter cookies.':
		'Contient un assortiment de cookies riches en beurre.',
	'Contains an assortment of delicious pastries.':
		'Contient un assortiment de délicieuses pâtisseries.',
	...
	'Placing an upgrade in this slot will make its effects <b>permanent</b> across all playthroughs.':
		'Placer une amélioration à cet emplacement rendra ses effets <b>permanents</b> pour toutes les parties.',
	...
	'Here are all the upgrades you\'ve purchased last playthrough.<div class="line"></div>Pick one to permanently gain its effects!<div class="line"></div>You can reassign this slot anytime you ascend.':
		'Voici toutes les améliorations que tu as achetées au cours de la partie précédente.<div class="line"></div>Choisis-en une pour bénéficier de ses effets en permanence !<div class="line"></div>Tu peux modifier cet emplacement à chaque ascension.',
	'You now <b>keep making cookies while the game is closed</b>, at the rate of <b>%1%</b> of your regular CpS and up to <b>1 hour</b> after the game is closed.<br>(Beyond 1 hour, this is reduced by a further %2% - your rate goes down to <b>%3%</b> of your CpS.)':
		"Tu peux désormais <b>continuer à faire des cookies une fois que le jeu est fermé</b>, au rythme de <b>%1 %</b> de tes CpS moyens et jusqu'à <b>1 heure</b> après avoir quitté le jeu.<br>(Après 1 heure, ce taux est encore réduit de %2 % - et descend jusqu'à <b>%3 %</b> de tes CpS.)",
	'You gain another <b>+%1%</b> of your regular CpS while the game is closed.':
		'Tu gagnes encore <b>+%1 %</b> de tes CpS normaux quand le jeu est fermé.',
	'You gain another <b>+%1%</b> of your regular CpS while the game is closed, for a total of <b>%2%</b>.':
		'Tu gagnes encore <b>+%1 %</b> de tes CpS normaux quand le jeu est fermé, pour un total de <b>%2 %</b>.',
	...
	'Allows you to purchase a <b>crumbly egg</b> once you have earned 1 million cookies.':
		"Te permet d'acheter un <b>œuf croustillant</b> une fois que tu as gagné 1 million de cookies.",
	'Unlocks the <b>cookie dragon egg</b>.': "Débloque <b>l'œuf de dragon de cookie</b>.",
	'Synergy upgrades are <b>%1% cheaper</b>.':
		'Les améliorations de synergie sont <b>%1 % moins chères</b>.',
	'You retain optimal cookie production while the game is closed for <b>%1 more days</b>.':
		'Tu maintiens une production de cookies optimale quand le jeu est fermé pendant <b>%1 jours de plus</b>.',
	'You retain optimal cookie production while the game is closed for twice as long, for a total of <b>%1</b>.':
		'Tu maintiens une production de cookies optimale quand le jeu est fermé pendant deux fois plus longtemps, pour un total de <b>%1</b>.',
	'Unlocks the <b>golden switch</b>, which passively boosts your CpS by %1% but disables golden cookies.':
		'Débloque le <b>permutateur doré</b>, qui augmente passivement tes CpS de %1 % mais désactive les cookies dorés.',
	'Turning this on will give you a passive <b>+%1% CpS</b>, but prevents golden cookies from spawning.<br>Cost is equal to 1 hour of production.':
		"Activer ceci offre passivement <b>+ %1 % de CpS</b>, mais empêche les cookies dorés d'apparaître.<br>Le coût est égal à une heure de production.",
	'The switch is currently giving you a passive <b>+%1% CpS</b>; it also prevents golden cookies from spawning.<br>Turning it off will revert those effects.<br>Cost is equal to 1 hour of production.':
		"Le permutateur t'offre actuellement <b>+%1 % de CpS</b> de manière passive, mais empêche aussi les cookies dorés d'apparaître.<br>L'éteindre mettra fin à ces effets.<br>Le coût est égal à une heure de production.",
	'Unlocks the <b>milk selector</b>, letting you pick which milk is displayed under your cookie.<br>Comes with a variety of basic flavors.':
		'Débloque le <b>sélecteur de lait</b>, te laissant choisir quel lait est affiché sous ton cookie.<br>Est fourni avec divers parfums de base.',
	'Contains more exotic flavors for your milk selector.':
		'Contient de nouveaux parfums exotiques pour ton sélecteur de lait.',
	'Lets you pick what flavor of milk to display.':
		'Te permet de choisir quel parfum de lait afficher.',
	'Unlocks the <b>golden cookie sound selector</b>, which lets you pick whether golden cookies emit a sound when appearing or not.':
		'Débloque le <b>sélecteur de son de cookie doré</b>, qui te permet de choisir si les cookies dorés produisent un son en apparaissant ou non.',
	'Lets you change the sound golden cookies make when they spawn.':
		'Permet de changer le son que les cookies dorés produisent en apparaissant.',
	'No sound': 'Pas de son',
	Chime: 'Tintement',
	Fortune: '/',
	Cymbal: 'Cymbale',
	...
	'Unlocks the <b>jukebox</b>, which allows you to play through every sound file in the game.':
		'Débloque le  <b>juke-box</b>, qui te permet de lire chaque fichier son du jeu.',
	...
	"Unlocks the <b>background selector</b>, letting you select the game's background.<br>Comes with a variety of basic flavors.":
		"Débloque le <b>sélecteur d'arrière-plan</b>, qui te permet de choisir le fond d'écran du jeu.<br>Est fourni avec divers parfums de base.",
	...
	'While the golden switch is on, you gain an additional <b>+%1% CpS</b> per golden cookie upgrade owned.':
		'Quand le permutateur doré est allumé, tu gagnes <b>+%1  % de CpS</b> par amélioration de cookie doré possédée.',
	'All upgrades are <b>%1% cheaper per %2</b>.':
		'Toutes les améliorations sont <b>%1 % moins chères par %2</b>.',
	'Unlocks a new tier of upgrades that affect <b>2 buildings at the same time</b>.<br>Synergies appear once you have <b>%1</b> of both buildings.':
		"Débloque un nouveau palier d'améliorations affectant <b>2 constructions à la fois</b>.<br>Les synergies apparaissent une fois que tu possèdes <b>%1</b> des deux constructions.",
	'Golden cookies (and all other things that spawn, such as reindeer) have <b>%1% chance of being doubled</b>.':
		"Les cookies dorés (et tous les autres éléments qui apparaissent, comme les rennes) ont <b>%1 % de chances d'être doublés</b>.",
	'Cookie production <b>reduced to 0</b>.': 'Production de cookies <b>réduite à 0</b>.',
	'Sugar lumps coalesce <b>a whole lot faster</b>.':
		'Les morceaux de sucre se forment <b>beaucoup plus vite</b>.',
	'<b>+%1%</b> prestige level effect on CpS.':
		"<b>+%1 %</b> d'effet du niveau de prestige sur les CpS.",
	'<b>+%1%</b> prestige level effect on CpS.<br><b>+%2%</b> golden cookie effect duration.<br><b>+%3%</b> golden cookie lifespan.':
		"<b>+%1 %</b> d'effet du niveau de prestige sur les CpS.<br><b>+%2 %</b> de durée d'effet des cookies dorés.<br><b>+%3 %</b> de durée de vie des cookies dorés.",
	'Each unspent sugar lump (up to %1) gives <b>+%2% CpS</b>.<div class="warning">Note: this means that spending sugar lumps will decrease your CpS until they grow back.</div>':
		"Chaque morceau de sucre non dépensé (jusqu'à %1) donne <b>+%2 % de CpS</b>.<div class=\"warning\">Note : cela signifie que dépenser tes morceaux de sucre réduira tes CpS jusqu'à ce qu'ils se reforment.</div>",
	'Once an ascension, you may use the "Sugar frenzy" switch to <b>triple your CpS</b> for 1 hour, at the cost of <b>1 sugar lump</b>.':
		'Une fois par ascension, tu pourras utiliser le permutateur « frénésie sucrée » pour <b>tripler tes CpS</b> pendant une heure, ce qui te coûte <b>1 morceau de sucre</b>.',
	'Each grandma (up to %1) makes sugar lumps ripen <b>%2</b> sooner.':
		"Chaque grand-mère (jusqu'à %1) fait mûrir les morceaux de sucre <b>%2</b> plus vite.",
	'Activating this will <b>triple your CpS</b> for 1 hour, at the cost of <b>1 sugar lump</b>.':
		'Activer cette option <b>triple tes CpS</b> pendant 1 heure et te coûte <b>1 morceau de sucre</b>.',
	...
	'Garden plants grow every second.<br>Garden seeds are free to plant.<br>You can switch soils at any time.':
		"Les plantes du jardin poussent à chaque seconde.<br>Les graines du jardin ne coûtent rien à planter.<br>Tu peux changer de terre à n'importe quel moment.",
	...
	'Sugar lumps are <b>twice as likely</b> to be unusual.':
		"Les morceaux de sucre ont <b>deux fois plus de chances</b> d'être inhabituels.",
	...
	'Bifurcated sugar lumps appear <b>%1% more often</b> and are <b>%2% more likely</b> to drop 2 lumps.':
		'Les morceaux de sucre dédoublés apparaissent <b>%1 % plus souvent</b> et sont <b>%2 % plus susceptibles</b> de donner 2 morceaux.',
	'Mouse over a wrinkler to see how many cookies are in its stomach.':
		"Passe la souris sur un rideux pour voir combien de cookies il a dans l'estomac.",
	...
	'Mouse over an upgrade to see its tier.<br><small>Note: only some upgrades have tiers. Tiers are purely cosmetic and have no effect on gameplay.</small>':
		"Passe la souris sur une amélioration pour voir son palier.<br><small>Note : seules certaines améliorations comportent des paliers. Ceux-ci sont purement cosmétiques et n'influencent pas le jeu.</small>",
	'You now benefit from the boost provided by <b>heralds</b>.<br>Each herald gives you <b>+1% CpS</b>.<br>Look on the purple flag at the top to see how many heralds are active at any given time.':
		"Tu bénéficies désormais de l'augmentation fournie par les <b>hérauts</b>.<br>Chaque héraut te donne <b>+1 % CpS</b>.<br>Regarde le drapeau violet au sommet, pour voir combien de hérauts sont actifs à tout moment.",
	'Seasonal random drops have a <b>1/5 chance</b> to carry over through ascensions.':
		"Les apparitions aléatoires saisonnières ont <b>1 chance sur 5</b> d'être transmises d'une ascension à l'autre.",
	"Unlocks <b>extra price information</b>.<br>Each displayed cost now specifies how long it'll take you to afford it, and how much of your bank it represents.":
		"Débloque des <b>informations supplémentaires sur les coûts</b>.<br>Chaque coût affiché indique désormais combien de temps il te faudra pour te permettre l'achat, et quelle proportion de ta banque il représente.",
	'Unlocks the <b>shimmering veil</b>, a switch that passively boosts your CpS by <b>%1%</b>.<br>You start with the veil turned on; however, it is very fragile, and clicking the big cookie or any golden cookie or reindeer will turn it off, requiring %2 of CpS to turn back on.':
		"Débloque le <b>voile scintillant</b>, un permutateur qui augmente passivement tes CpS de <b>%1 %</b>.<br>Tu commences avec le voile activé, mais il est cependant très fragile, et en cliquant sur le gros cookie ou n'importe quel cookie doré ou renne, il sera désactivé et requiert %2 de CpS pour être réactivé.",
	'Boosts your cookie production by <b>%1%</b> when active.<br>The veil is very fragile and will break if you click the big cookie or any golden cookies or reindeer.<br><br>Once broken, turning the veil back on costs %2 of unbuffed CpS.':
		"Augmente ta production de cookies de <b>%1 %</b> lorsqu'il est actif.<br>Le voile est très fragile et se déchirera si tu cliques sur un gros cookie, un cookie doré ou un renne.<br><br>Une fois déchiré, réactiver le voile coûte %2 de tes CpS hors augmentations.",
	...
	'The <b>shimmering veil</b> is more resistant, and has a <b>%1% chance</b> not to break. It also gives <b>+%2%</b> more CpS.':
		'Le <b>voile scintillant</b> est plus résistant, offrant <b>%1 % de chances</b> de ne pas se déchirer. Il apporte également <b>+%2 %</b> de CpS en plus.',
	'Active.': 'Activé.',
	'The reinforced membrane protects the shimmering veil.':
		'La membrane renforcée protège le voile scintillant.',
	...
	'Prior to purchasing the <b>%1</b> upgrade in a run, random drops are <b>%2 times more common</b>.':
		"Avant d'acheter l'amélioration <b>%1</b> lors d'une partie, les apparitions aléatoires sont <b>%2 fois plus fréquentes</b>.",
	...
	'The news ticker may occasionally have <b>fortunes</b>, which may be clicked for something good.':
		"Le fil d'informations peut parfois présenter des <b>bonnes aventures</b>, sur lesquelles tu peux cliquer pour une bonne surprise.",
	'Through clever accounting, this actually makes kitten upgrades <b>%1% cheaper</b>.':
		'Grâce à des astuces comptables, ceci peut rendre les améliorations de chaton <b>%1 % moins chères</b>.',
	'Unlocks the ability to <b>pet your dragon</b> by clicking on it once hatched.':
		"Débloque la possibilité de <b>caresser ton dragon</b> en cliquant dessus une fois qu'il a éclos.",
	'Cost scales with CpS, but %1 times cheaper with a fully-trained dragon.':
		'Le coût est proportionnel aux CpS, mais est %1 fois moins cher avec un dragon complètement entraîné.',
	'Golden cookies may trigger a <b>Dragon Harvest</b>.':
		'Les cookies dorés peuvent déclencher une <b>récolte de dragon</b>.',
	'Golden cookies may trigger a <b>Dragonflight</b>.':
		'Les cookies dorés peuvent déclencher un <b>vol de dragon</b>.',
	'Dragon harvest and Dragonflight are <b>%1% stronger</b>.':
		'Les récoltes et vols de dragon sont <b>renforcés de %1 %</b>.',
	'Kittens are <b>%1%</b> more effective.': 'Les chatons sont <b>%1 %</b> plus efficaces.',
	'Each kitten upgrade boosts %1 CpS by <b>%2%</b>.':
		'Chaque amélioration de chaton augmente le CpS de %1 de <b>%2 %</b>.',
	'Each rank of milk boosts %1 CpS by <b>%2%</b>.':
		'Chaque rang de lait augmente le CpS de %1 de <b>%2 %</b>.',
	'Cursor levels boost clicks by <b>%1%</b> each (up to cursor level %2).':
		"Les niveaux de curseur augmentent les clics de <b>%1 %</b> chacun (jusqu'au niveau de curseur %2).",
	'<b>%1</b> are now effective up to cursor level %2.':
		"<b>%1</b> sont désormais efficaces jusqu'au niveau de curseur %2.",
	...
	'Golden and wrath cookie effect duration +%1%.':
		'+ %1 % de durée des cookies dorés et de colère.',
	'Golden and wrath cookies appear %1% more.':
		"%1 % d'apparitions de cookies dorés et de colère en plus.",
	'Golden and wrath cookies appear %1% less.':
		"%1 % d'apparitions de cookies dorés et de colère en moins.",
	...
	'Selling buildings triggers a buff boosted by how many buildings were sold.':
		'Vendre les constructions déclenche un buff boosté par le nombre de constructions vendues.',
	'Buff boosts clicks by +%1% for every building sold for %2 seconds.':
		'Le buff augmente les clics de + %1 % pour chaque construction vendue pendant %2 secondes.',
	'CpS bonus fluctuating between %1 and %2 over time.':
		'Le bonus de CpS fluctue entre %1 et %2 au fil du temps.',
	...
	'All golden cookies are wrath cookies with a greater chance of a negative effect.':
		"Tous les cookies dorés sont des cookies de colère avec une plus grande chance d'effet négatif.",
	'Wrinklers appear %1% faster and digest %2% more cookies.':
		'Les rideux apparaissent %1 % plus vite et digèrent %2 % de cookies en plus.',
	'Effect is only active when your total amount of buildings ends with 0.':
		"L'effet n'est activé que quand le nombre total de tes constructions se termine par 0.",
	...
	'Make <b>%1</b> by only having clicked <b>%2 times</b>.':
		"Fais <b>%1</b> en n'ayant cliqué que <b>%2 fois</b>.",
	'Make <b>%1</b> with <b>no</b> cookie clicks.':
		'Fais <b>%1</b> sans <b>aucun</b> clic sur un cookie.',
	'Get to <b>%1</b> baked with <b>no upgrades purchased</b>.':
		'Atteins <b>%1</b> cuits <b>sans améliorations achetées</b>.',
	...
	'Have <b>at least %1</b> of every building.':
		'Possède <b>au moins %1</b> exemplaires de chaque construction.',
	'Have at least <b>1 of the most expensive object, 2 of the second-most expensive, 4 of the next</b> and so on (capped at %1).':
		"Possède au moins <b>1 exemplaire de l'objet le plus cher, 2 du second plus cher, 4 du suivant</b> et ainsi de suite (limité à %1).",
	'Have at least <b>10 of the most expensive object, 20 of the second-most expensive, 30 of the next</b> and so on.':
		"Possède au moins <b>10 exemplaires de l'objet le plus cher, 20 du second plus cher, 30 du suivant</b> et ainsi de suite.",
	...
	'Appease the grandmatriarchs at least <b>once</b>.':
		'Apaise les grand-matriarches au moins <b>une fois</b>.',
	'Appease the grandmatriarchs at least <b>%1 times</b>.':
		'Apaise les grand-matriarches au moins <b>%1 fois</b>.',
	...
	'Unlock <b>100%</b> of your heavenly chips power.':
		'Débloque <b>100 %</b> de la puissance de tes pépites célestes.',
	'You have <b>1 chance in %1</b> every second of earning this achievement.':
		'Tu as <b>1 chance sur %1</b> de remporter ce trophée à chaque seconde.',
	...
	'Unlock <b>every Halloween-themed cookie</b>.<div class="line"></div>Owning this achievement makes Halloween-themed cookies drop more frequently in future playthroughs.':
		'Débloque <b>tous les cookies de thème d\'Halloween</b>.<div class="line"></div> Posséder ce trophée rend les apparitions de cookies de thème d\'Halloween plus fréquentes lors des parties suivantes.',
	...
	'Unlock <b>every Christmas-themed cookie</b>.<div class="line"></div>Owning this achievement makes Christmas-themed cookies drop more frequently in future playthroughs.':
		'Débloque <b>tous les cookies de thème de Noël</b>.<div class="line"></div> Posséder ce trophée rend les apparitions de cookies de thème de Noël plus fréquentes lors des parties suivantes.',
	'Pop <b>1 reindeer</b>.': 'Éclate <b>1 renne</b>.',
	'Pop <b>%1 reindeer</b>.': 'Éclate <b>%1 rennes</b>.',
	'Pop a reindeer <b>during an elder frenzy</b>.':
		'Éclate un renne <b>pendant une frénésie des anciennes</b>.',
	'Unlock <b>every Valentine-themed cookie</b>.':
		'Débloque <b>tous les cookies de thème Saint-Valentin</b>.',
	'Click the tiny cookie.': 'Clique sur le cookie minuscule.',
	'This is for baking %1 and making it on the local news.':
		'Pour avoir cuit %1 et ton apparition à la télévision locale.',
	'Name yourself <b>Orteil</b>.<div class="warning">Note: usurpers incur a -%1% CpS penalty until they rename themselves something else.</div>':
		'Appelle-toi <b>Orteil</b>.<div class="warning">Note : les usurpateurs se voient infliger une pénalité de -%1 % CpS jusqu\'à ce qu\'ils changent leur nom.</div>',
	...
	'Unlock <b>all the eggs</b>.<div class="line"></div>Owning this achievement makes eggs drop more frequently in future playthroughs.':
		'Débloque <b>tous les œufs</b>.<div class="line"></div> Posséder ce trophée rend les apparitions d\'œufs plus fréquentes lors des parties suivantes.',
	...
	'Own <b>%1</b> upgrades and <b>%2</b> buildings.':
		'Possède <b>%1</b> améliorations et <b>%2</b> constructions.',
	'Own <b>%1</b> heavenly upgrades.': 'Possède <b>%1</b> améliorations célestes. ',
	'Burst the near-extinct <b>shiny wrinkler</b>.':
		'Éclate le <b>rideux brillant</b> en voie de disparition.',
	'Click a golden cookie <b>less than 1 second after it spawns</b>.':
		"Clique sur un cookie doré <b>moins d'1 seconde après son apparition</b>.",
	'Click a golden cookie <b>less than 1 second before it dies</b>.':
		"Clique sur un cookie doré <b>moins d'1 seconde avant qu'il ne meure</b>.",
	'Harvest <b>%1 coalescing sugar lumps</b>.':
		'Récolte <b>%1 morceaux de sucre en cours de formation</b>.',
	"Successfully harvest a coalescing sugar lump before it's ripe.":
		"Réussis à récolter un morceau de sucre en cours de formation avant qu'il soit mûr.",
	...
	'Manage a cookie legacy for <b>at least a year</b>.':
		'Gère un héritage de cookies pendant <b>au moins un an</b>.',
	...
	'Fill every tile of the biggest garden plot with plants.':
		'Remplis chaque case de la plus grande parcelle du jardin avec des plantes.',
	...
	'Convert a complete seed log into sugar lumps by sacrificing your garden to the sugar hornets.<div class="line"></div>Owning this achievement makes seeds <b>%1% cheaper</b>, plants mature <b>%2% sooner</b>, and plant upgrades drop <b>%3% more</b>.':
		'Convertis tout un registre de graines en morceaux de sucre en sacrifiant ton jardin aux frelons sucriers.<div class="line"></div>Posséder ce trophée rend les graines <b>%1 % moins chères</b>, les plantes arrivent à maturation <b>%2 % plus tôt</b>, et les améliorations de plantes apparaissent <b>%3 % plus souvent</b>.',
	...
	'Have your <b>reinforced membrane</b> protect the <b>shimmering veil</b>.':
		'Utilise ta <b>membrane renforcée</b> pour protéger le <b>voile scintillant</b>.',
	'Own every <b>fortune upgrade</b>.<div class="line"></div>Owning this achievement makes fortunes appear <b>twice as often</b>; unlocked fortune upgrades also have a <b>%1% chance</b> to carry over after ascending.':
		'Possède chaque <b>amélioration de bonne aventure</b>.<div class="line"></div>Posséder ce trophée fait apparaître les bonnes aventures <b>deux fois plus souvent</b>, et les améliorations de bonne aventure débloquées ont aussi <b>%1 % de chances</b> d\'être conservées après une ascension.',
	...
	'Own at least <b>%1</b> of a stock market good.':
		"Possède au moins <b>%1</b> d'un bien sur le marché boursier.",
	'Own at least <b>%1</b> of every stock market good.':
		'Possède au moins <b>%1</b> de chaque bien sur le marché boursier.',
	'Make <b>a day</b> of CpS ($%1) in 1 stock market sale.':
		'Produis <b>une journée</b> de CpS (%1 $) en 1 vente sur le marché boursier.',
	'Spend <b>a day</b> of CpS ($%1) in 1 stock market purchase.':
		'Dépense <b>une journée</b> de CpS (%1 $) en un achat sur le marché boursier.',
	'Have your stock market profits surpass <b>a whole year</b> of CpS ($%1).':
		'Produis des bénéfices sur le marché boursiers dépassant <b>une année entière</b> de tes CpS (%1 $).',
	'Unlock the <b>highest-tier</b> stock market headquarters.':
		'Débloque le <b>plus haut palier</b> du quartier général de la bourse.',
	'Have your stock market profits surpass <b>$%1</b>.':
		'Produis des bénéfices boursiers dépassant <b>%1 $</b>.',
	...
	"Click one of Santa's helper grandmas during Christmas season.":
		'Clique sur une des grand-mères assistantes du Père Noël pendant la saison de Noël.',
	Frenzy: 'Frénésie',
	...
	'All buildings are %1% cheaper for %2!':
		'Toutes les constructions sont %1 % moins chères pendant %2 !',
	'All buildings are %1% pricier for %2!':
		'Toutes les constructions sont %1 % plus chères pendant %2 !',
	'All upgrades are %1% cheaper for %2!':
		'Toutes les améliorations sont %1 % moins chères pendant %2 !',
	'All upgrades are %1% pricier for %2!':
		'Toutes les améliorations sont %1 % plus chères pendant %2 !',
	'Cookie production halted for %1,<br>but each click is worth %2 of CpS.':
		'Production de cookies arrêtée pendant %1,<br>Mais chaque clic vaut %2 en CpS.',
	...
	'You find %1% more golden cookies for the next %2.':
		'Tu trouves %1 % plus de cookies dorés pendant %2.',
	'Spells backfire %1 times less for %2.':
		'Les sorts se retournent %1 fois moins contre toi pendant %2.',
	'Spells backfire %1 times more for %2.':
		'Les sorts se retournent %1 fois plus contre toi pendant %2.',
	...
	"[Baker's wheat quote]A plentiful crop whose hardy grain is used to make flour for pastries.":
		'Variété abondante dont les grains résistants servent à faire la farine pour les pâtisseries.',
	Thumbcorn: 'Maïspouce',
	'[Thumbcorn quote]A strangely-shaped variant of corn. The amount of strands that can sprout from one seed is usually in the single digits.':
		'Une variété de maïs à la forme étrange. Une graine ne peut généralement donner que moins de dix grains.',
	Cronerice: 'Mégèriz',
	"[Cronerice quote]Not only does this wrinkly bulb look nothing like rice, it's not even related to it either; its closest extant relative is the weeping willow.":
		"Non seulement ce bulbe ridé ne ressemble absolument pas à du riz, mais en plus, il n'est même pas de la même famille, son parent le plus proche étant le saule pleureur.",
	Gildmillet: 'Mildoré',
	'[Gildmillet quote]An ancient staple crop, famed for its golden sheen. Was once used to bake birthday cakes for kings and queens of old.':
		"Une plante ancienne, connue pour ses reflets dorés. Elle était autrefois utilisée pour confectionner les gâteaux d'anniversaire pour les rois et les reines d'antan.",
	...
	'[Ordinary clover quote]<i>Trifolium repens</i>, a fairly mundane variety of clover with a tendency to produce four leaves. Such instances are considered lucky by some.':
		'<i>Trifolium repens</i>, une variété de trèfle ordinaire, ayant tendance à produire quatre feuilles. Certains considèrent ces évènements chanceux.',
	...
	'[Golden clover quote]A variant of the ordinary clover that traded its chlorophyll for pure organic gold. Tragically short-lived, this herb is an evolutionary dead-end - but at least it looks pretty.':
		"Une variante du trèfle ordinaire ayant échangé sa clorophylle contre de l'or pur d'origine organique. Son espérance de vie est malheureusement très courte, et en fait une impasse évolutionnaire... mais au moins, il est joli.",
	...
	'[Shimmerlily quote]These little flowers are easiest to find at dawn, as the sunlight refracting in dew drops draws attention to their pure-white petals.':
		"Ces petites fleurs sont plus faciles à trouver à l'aube, quand la lumière du soleil réfractée attire l'attention sur leurs pétales d'un blanc pur.",
	...
	'[Elderwort quote]A very old, long-forgotten subspecies of edelweiss that emits a strange, heady scent. There is some anecdotal evidence that these do not undergo molecular aging.':
		"Une sous-espèce d'edelweiss oubliée depuis longtemps, qui émet un parfum étrange et entêtant. Il aurait été montré qu'elles ne subissent pas le vieillissement moléculaire.",
	...
	'[Bakeberry quote]A favorite among cooks, this large berry has a crunchy brown exterior and a creamy red center. Excellent in pies or chicken stews.':
		'Cette grosse baie est parmi les favorites des cuisiniers, avec sa peau brune croquante et son intérieur rouge crémeux. Excellente dans les tartes comme dans les bouillons de poulet.',
	...
	'[Chocoroot quote]A tangly bramble coated in a sticky, sweet substance. Unknown genetic ancestry. Children often pick these from fields as-is as a snack.':
		"Une ronce noueuse recouverte d'une substance douce et sirupeuse. Origine génétique inconnue. Les enfants en ramassent souvent dans les champs pour en grignoter.",
	...
	'[White chocoroot quote]A pale, even sweeter variant of the chocoroot. Often impedes travelers with its twisty branches.':
		'Une version plus claire et encore plus sucrée de la chocoracine, ses branches tordues gènent souvent les voyageurs.',
	...
	'[White mildew quote]A common rot that infests shady plots of earth. Grows in little creamy capsules. Smells sweet, but sadly wilts quickly.':
		"Un parasite courant infestant les parterres ombragés. Grandit sous forme de petites capsules crémeuses, à l'odeur douce, mais qui fane, hélas, rapidement.",
	...
	'[Brown mold quote]A common rot that infests shady plots of earth. Grows in odd reddish clumps. Smells bitter, but thankfully wilts quickly.':
		"Un parasite courant touchant les parterres ombragés. Donne d'étranges tas rouges, à l'odeur amère, mais fane, heureusement, vite.",
	...
	'[Meddleweed quote]The sign of a neglected farmland, this annoying weed spawns from unused dirt and may sometimes spread to other plants, killing them in the process.':
		"Signe de terres fermières négligées, cette mauvaise herbe pousse sur les sols inutilisés et peut parfois s'étendre aux autres plantes, ce qui tue ces dernières.",
	...
	"[Whiskerbloom quote]Squeezing the translucent pods makes them excrete a milky liquid, while producing a faint squeak akin to a cat's meow.":
		'Presser leurs gousses laiteuses leur fait secréter un liquide laiteux, tout en produisant un couinement semblable à un miaulement.',
	Chimerose: 'Tinterose',
	'[Chimerose quote]Originating in the greener flanks of polar mountains, this beautiful flower with golden accents is fragrant enough to make any room feel a little bit more festive.':
		"Venue des flancs fertiles des montagnes polaires, cette jolie fleur aux reflets dorés émet un parfum capable de rendre n'importe quelle pièce un peu plus festive.",
	...
	'[Nursetulip quote]This flower grows an intricate root network that distributes nutrients throughout the surrounding soil. The reason for this seemingly altruistic behavior is still unknown.':
		'Cette fleur produit un système de racines complexe distribuant les nutriments dans tout le soil voisin. Les raisons de ce comportement altruiste restent inconnues.',
	Drowsyfern: 'Ronflegère',
	'[Drowsyfern quote]Traditionally used to brew a tea that guarantees a good night of sleep.':
		'Sert habituellement à confectionner une tisane garantissant une bonnes nuits.',
	...
	'[Wardlichen quote]The metallic stench that emanates from this organism has been known to keep insects and slugs away.':
		'La puanteur métallique émanant de cet organisme est connu pour repousser les insectes et les limaces.',
	...
	'[Keenmoss quote]Fuzzy to the touch and of a vibrant green. In plant symbolism, keenmoss is associated with good luck for finding lost objects.':
		"Douce au toucher et d'un vert éclatant. Dans le langage des plantes, la poussemousse est associée à la chance de retrouver les objets perdus.",
	...
	'[Queenbeet quote]A delicious taproot used to prepare high-grade white sugar. Entire countries once went to war over these.':
		'Tubercule délicieux servant à préparer le sucre blanc hautement concentré. Des pays entiers ont fait des guerres pour se les disputer.',
	...
	'[Juicy queenbeet quote]A delicious taproot used to prepare high-grade white sugar. Entire countries once went to war over these.<br>It looks like this one has grown especially sweeter and juicier from growing in close proximity to other queenbeets.':
		"Tubercule délicieux servant à préparer le sucre blanc hautement concentré. Des pays entiers ont fait des guerres pour se les disputer.<br>Il semblerait que la proximité d'autres bettereines ait rendues celles-ci encore plus douces et juteuses.",
	...
	'[Duketater quote]A rare, rich-tasting tuber fit for a whole meal, as long as its strict harvesting schedule is respected. Its starch has fascinating baking properties.':
		'Un tubercule au goût riche pouvant offrir un repas entier satisfaisant, tant que son calendrier de récolte strict est respecté. Son amidon offre des propriétés de pâtisserie fascinantes.',
	...
	'[Crumbspore quote]An archaic mold that spreads its spores to the surrounding dirt through simple pod explosion.':
		'Moisissure archaïque répandant ses spores sur le sol alentour par explosion de ses capsules.',
	...
	'[Doughshroom quote]Jammed full of warm spores; some forest walkers often describe the smell as similar to passing by a bakery.':
		"Pleins de spores tièdes. Certains ramasseurs en comparent l'odeur à celle émise par une pâtisserie.",
	...
	'[Glovemorel quote]Touching its waxy skin reveals that the interior is hollow and uncomfortably squishy.':
		'Toucher leur peau cireuse laisse voir combien leur intérieur est creux et inconfortablement gluant.',
	Cheapcap: 'Capacher',
	'[Cheapcap quote]Small, tough, and good in omelettes. Some historians propose that the heads of dried cheapcaps were once used as currency in some bronze age societies.':
		"Petits, coriaces et bons dans les omelettes. Certains historiens pensent que les corolles séchées des capachers servaient autrefois de monnaie dans certaines sociétés de l'âge de bronze.",
	...
	"[Fool's bolete quote]Named for its ability to fool mushroom pickers. The fool's bolete is not actually poisonous, it's just extremely bland.":
		"Nommé pour sa capacité à tromper les ramasseurs de champignons. Le bolet sleula n'est pas vraiment vénéneux, juste très fade.",
	...
	"[Wrinklegill quote]This mushroom's odor resembles that of a well-done steak, and is said to whet the appetite - making one's stomach start gurgling within seconds.":
		"L'odeur de ce champignon rappelle celle d'un steak bien cuit, et est réputée ouvrir l'appétit au point de faire gargouiller les estomacs en quelques secondes.",
	'Green rot': 'Vertiture',
	'[Green rot quote]This short-lived mold is also known as "emerald pebbles", and is considered by some as a pseudo-gem that symbolizes good fortune.':
		"Cette moisissure éphémère est également appelée « graviers d'émeraude », et considérée par certains comme une pierre semi-précieuse symbolisant la chance.",
	...
	'[Shriekbulb quote]A nasty vegetable with a dreadful quirk : its flesh resonates with a high-pitched howl whenever it is hit at the right angle by sunlight, moonlight, or even a slight breeze.':
		"Ce légume peu appétissant a une particularité effrayante : sa chair résonne en un hululement perçant dès qu'il est frappé par la lumière du soleil, celle de la lune, ou même une petite brise selon un angle particulier.",
	Tidygrass: 'Proprerbe',
	'[Tidygrass quote]The molecules this grass emits are a natural weedkiller. Its stems grow following a predictable pattern, making it an interesting -if expensive- choice for a lawn grass.':
		'Les molécules émises par cette herbe tuent naturellement les mauvaises. Ses brins poussent selon un motif prévisible, ce qui en fait un bon choix de gazon, malgré son prix élevé.',
	...
	'[Everdaisy quote]While promoted by some as a superfood owing to its association with longevity and intriguing geometry, this elusive flower is actually mildly toxic.':
		'Même si certains la vantent comme si elle était une panacée en raison de son association à la longévité et de son étrange géométrie, cette fleur rare est en fait modérément toxique.',
	...
	'[Ichorpuff quote]This puffball mushroom contains sugary spores, but it never seems to mature to bursting on its own. Surrounding plants under its influence have a very slow metabolism, reducing their effects but lengthening their lifespan.':
		"Ce genre de champignon vesse-de-loup contient des spores sucrées, mais ne semble jamais maturer au point d'éclater de lui-même. Il influence les plantes des alentours en ralentissant énormément leur métabolisme, réduisant leurs effets, mais prolongeant leur durée de vie.",
	...
	"-You can cross-breed plants by planting them close to each other; new plants will grow in the empty tiles next to them.<br>-Unlock new seeds by harvesting mature plants.<br>-When you ascend, your garden plants are reset, but you keep all the seeds you've unlocked.<br>-Your garden has no effect and does not grow while the game is closed.":
		"-Tu peux croiser les types de plantes en les plantant les unes près des autres, de nouvelles plantes pousseront sur les cases vides à côté.<br>-Débloque de nouvelles graines en récoltant les plantes à maturation.<br>-Quand tu effectues une ascension, les plantes de ton jardin sont réinitialisées, mais tu gardes toutes les graines que tu as débloquées.<br>-Ton jardin n'a aucun effet et ne pousse pas quand le jeu est fermé.",
	'Harvest all': 'Tout récolter',
	'Instantly harvest all plants in your garden.':
		'Récolter instantanément toutes les plantes de ton jardin.',
	'%1 to harvest only mature, mortal plants.':
		'%1 pour ne récolter que les plantes à maturité et mortelles.',
	'%1 to harvest all mature plants of this type.':
		'%1 pour récolter toutes les plantes à maturité de ce type.',
	Freeze: 'Geler',
	'Cryogenically preserve your garden.<br>Plants no longer grow, spread or die; they provide no benefits.<br>Soil cannot be changed.<div class="line"></div>Using this will effectively pause your garden.':
		'Préserve ton jardin avec la cryogénie.<br>Les plantes ne poussent, se propagent et ne meurent plus, elles ne fournissent pas d\'avantages.<br>La terre ne peut pas être changée.<div class="line"></div>Cette option mettra ton jardin en pause.',
	...
	'A swarm of sugar hornets comes down on your garden, <span class="red">destroying every plant as well as every seed you\'ve unlocked</span> - leaving only a %1 seed.<br>In exchange, they will grant you <span class="green">%2</span>.<br>This action is only available with a complete seed log.':
		'Un essaim de frelons sucriers fond sur ton jardin, <span class="red">détruisant toutes les plantes et toutes les graines que tu as débloquées</span> - ne laissant qu\'une graine de %1.<br>En échange, ils te donnent <span class="green">%2</span>.<br>Cette action n\'est disponible qu\'avec un registre de graines complet.',
	'Do you REALLY want to sacrifice your garden to the sugar hornets?<br><small>You will be left with an empty plot and only the %1 seed unlocked.<br>In return, you will gain <b>%2 sugar lumps</b>.</small>':
		'Est-ce que tu veux VRAIMENT sacrifier ton jardin aux frelons sucriers ?<br><small>Il ne te restera plus que la graine de %1 débloquée.<br>En revanche, tu gagneras <b>%2 morceaux de sucre</b>.</small>',
	'Sacrifice!': 'Sacrifice !',
	"You've sacrificed your garden to the sugar hornets, destroying your crops and your knowledge of seeds.<br>In the remains, you find <b>%1 sugar lumps</b>.":
		'Tu as sacrifié ton jardin aux frelons sucriers, qui ont détruit tes récoltes et ta connaissance des graines.<br>Parmi les décombres, tu trouves <b>%1 morceaux de sucre</b>.',
	immortal: 'immortelle',
	'predictable growth': 'croissance prévisible',
	'surrounding plants (%1x%1) age %2% faster':
		'les plantes aux alentours (%1 x %1) vieillissent %2 % plus vite',
	'surrounding plants (%1x%1) age %2% slower':
		'les plantes aux alentours (%1 x %1) vieillissent %2 % plus lentement',
	'surrounding plants (%1x%1) are %2% more efficient':
		'les plantes aux alentours (%1 x %1) sont %2 % plus efficaces',
	'surrounding plants (%1x%1) are %2% less efficient':
		'les plantes aux alentours (%1 x %1) sont %2 % moins efficaces',
	'surrounding tiles (%1x%1) develop no weeds or fungus':
		'les mauvaises herbes et champignons ne se développent pas sur les cases aux alentours (%1 x %1)',
	'harvest when mature for +%1 of CpS (max. %2% of bank)':
		'à récolter une fois à maturité pour + %1 de CpS (max. %2 % de la banque)',
	...
	'may sometimes drop spores when uprooted':
		"peut parfois faire apparaître des spores lors d'un déracinement",
	'explodes into up to %1 of CpS at the end of its lifecycle (max. %2% of bank)':
		"explose pour donner jusqu'à %1 de CpS à la fin de son cycle de vie (max. %2 % de la banque)",
	'cannot handle cold climates; %1% chance to die when frozen':
		"ne supporte pas les climats froids, %1 % de chances de mourir lors d'un gel",
	'the unfortunate result of some plant combinations':
		'le résultat malencontreux de certaines combinaisons de plantes',
	...
	'You will be able to change your soil again in %1.':
		'Tu pourras changer à nouveau de terre dans %1.',
	'Click to use this type of soil for your whole field.':
		'Clique pour utiliser ce type de terre pour tout ton champ.',
	Dirt: 'Terre',
	"Simple, regular old dirt that you'd find in nature.":
		'Simple terre ordinaire, trouvable dans la nature.',
	Fertilizer: 'Engrais',
	'Soil with a healthy helping of fresh manure. Plants grow faster but are less efficient.':
		'Terre comprenant une bonne dose de fumier. Les plantes poussent plus vite, mais sont moins efficaces.',
	Clay: 'Argile',
	'Rich soil with very good water retention. Plants grow slower but are more efficient.':
		"Terre riche retenant bien l'eau. Les plantes poussent moins vite mais sont plus efficaces.",
	Pebbles: 'Graviers',
	"Dry soil made of small rocks tightly packed together. Not very conducive to plant health, but whatever falls off your crops will be easy to retrieve.<br>Useful if you're one of those farmers who just want to find new seeds without having to tend their garden too much.":
		"Terre sèche faite de petits caiiloux agglomérés. Pas très bonne pour la santé de vos récoltes, mais tout ce qui en tombera sera facile à ramasser.<br>Utile pour les fermiers qui veulent juste trouver les nouvelles graines sans avoir à trop s'occuper de leur jardin.",
	...
	'Soil made of bits and pieces of bark and sawdust. Helpful for young sprouts to develop, not so much for mature plants.':
		"Terre faite de bouts d'écorces et de sciure. Utile pour la germination de jeunes pousses, mais pas autant pour les plantes à maturité.",
	...
	'<b>%1% chance</b> of collecting seeds automatically when plants expire':
		"<b>%1 % de chances</b> de récupérer des graines automatiquement lors de l'expiration des plantes",
	'plants spread and mutate <b>%1 times more</b>':
		'les plantes se propagent et mutent <b>%1 fois plus souvent</b>',
	...
	'This tile of soil is empty.<br>Pick a seed and plant something!':
		'Cette case de terre est vide.<br>Choisis une graine et plante quelque chose !',
	...
	'may reproduce, will drop seed when harvested':
		'peut se reproduire, donnera des graines après la récolte',
	...
	'Click to refill your soil timer and trigger <b>1</b> plant growth tick with <b>x%1</b> spread and mutation rate for %2.':
		'Clique pour remplir ta jauge de terre et déclencher <b>1</b> une période de croissance des plantes avec <b>x %1</b> taux de propagation et de mutation pour %2.',
	...
	'Plot size: %1<br>(Upgrades with farm level)':
		"Taille de parterre : %1<br>(S'améliore avec le niveau de ferme)",
	'Garden plants age and mutate %1% faster.':
		'Les plantes du jardin vieillissent et mutent %1 % plus vite.',
	'while plant is alive; scales with plant growth':
		'pendant que la plante est vivante ; proportionnel à la croissance de la plante',
	Dungeon: 'Donjon',
	Grimoire: '/',
	'This is your magic meter. Each spell costs magic to use.<div class="line"></div>Your maximum amount of magic varies depending on your amount of <b>Wizard towers</b>, and their level.<div class="line"></div>Magic refills over time. The lower your magic meter, the slower it refills.':
		'C\'est ta jauge de magie. Chaque sort coûte de la magie.<div class="line"></div>Ta quantité de magie maximale dépend de ton nombre de <b>tours de mage</b>, et de leur niveau.<div class="line"></div>La jauge se remplit au fil du temps. Plus son niveau est bas, plus elle se remplit lentement.',
	...
	'Click to refill <b>%1 units</b> of your magic meter for %2.':
		'Clique pour remplir <b>%1 unités</b> de ta jauge de magie pour %2.',
	'Grimoire spells are %1% cheaper but fail %1% more.':
		'Les sorts de grimoire coûtent %1 % moins cher mais échouent %1 % plus souvent.',
	'Conjure Baked Goods': 'Invoquer des pâtisseries',
	'Summon half an hour worth of your CpS, capped at %1% of your cookies owned.':
		'Invoque une demi-heure des tes CpS, dans la limite de %1 % de tes cookies possédés.',
	'Trigger a %1-minute clot and lose %1 minutes of CpS.':
		'Déclenche un grumeau de %1 minutes et perds %1 minutes de CpS.',
	...
	'Summon a random golden cookie. Each existing golden cookie makes this spell +%1% more likely to backfire.':
		'Invoque un cookie doré aléatoire. Chaque cookie doré existant ajoute + %1 % de chances que le sort tourne mal.',
	...
	'All active buffs gain %1% more time (up to %2 more minutes).':
		"Tous les buffs actifs durent %1 % plus longtemps (jusqu'à %2 minutes en plus).",
	'All active buffs are shortened by %1% (up to %2 minutes shorter).':
		"Tous les buffs actifs durent %1 % moins longtemps (jusqu'à %2 minutes en moins).",
	...
	'The spell picks a random building you could afford if you had twice your current cookies, and gives it to you for free. The building selected must be under %1, and cannot be your most-built one (unless it is your only one).':
		"Le sort choisit une construction aléatoire que tu pourrais te payer avec le double de tes cookies actuels, et te l'offre gratuitement. La construction sélectionnée doit être sous %1, et ne peut pas être celle que tu as le plus construite (sauf si c'est ta seule).",
	...
	'One of your %1<br>disappears in a puff of smoke.':
		'Un(e) de tes %1<br>disparaît dans une nuage de fumée.',
	"Haggler's Charm": 'Charme du marchandeur',
	'Upgrades are %1% cheaper for 1 minute.':
		'Les améliorations coûtent %1 % moins cher pour 1 minute.',
	'Upgrades are %1% more expensive for an hour.':
		'Les améliorations coûtent %1 % plus cher pour 1 heure.',
	...
	'Buildings are %1% cheaper for 1 minute.':
		'Les constructions coûtent %1 % moins cher pour 1 minute.',
	'Buildings are %1% more expensive for an hour.':
		'Les constructions coûtent %1 % plus cher pour 1 heure.',
	...
	'Cast a random spell at half the magic cost, with twice the chance of backfiring.':
		'Lance un sort aléatoire pour la moitié de son coût en magie, avec deux fois plus de chances de mal tourner.',
	...
	'Instantly summon a wrinkler if conditions are fulfilled.':
		'Invoque instantanément un rideux si les conditions sont remplies.',
	...
	'Spells backfire %1 times less for the next %2 minutes.':
		'Les sorts tournent mal %1 fois moins souvent pour les %2 prochaines minutes.',
	'Spells backfire %1 times more for the next %2 minutes.':
		'Les sorts tournent mal %1 fois plus souvent pour les %2 prochaines minutes.',
	...
	'[GOD 1 QUOTE]An immortal life spent focusing on the inner self, away from the distractions of material wealth.':
		'Une vie éternelle centrée sur le soi intérieur, loin des distractions des richesses matérielles.',
	...
	'[GOD 2 QUOTE]This sleazy spirit revels in the lust for quick easy gain and contempt for the value of steady work.':
		'Cet esprit sordide se délecte du désir pour les gains faciles, méprisant la valeur du travail régulier.',
	...
	'[GOD 3 QUOTE]The embodiment of natural disasters. An impenetrable motive drives the devastation caused by this spirit.':
		"L'incarnation des catastrophes naturelles. La motivation des destructions causées par cet esprit reste impénétrable.",
	...
	"[GOD 4 QUOTE]This spirit knows about everything you'll ever do, and enjoys dispensing a harsh judgment.":
		'Cet esprit sait tout ce que tu vas faire, et aime juger sévèrement.',
	...
	'[GOD 5 QUOTE]This is the spirit of merry getaways and regretful Monday mornings.':
		"C'est l'esprit des escapades joyeuses, et des lundi matin pleins de regrets.",
	...
	"[GOD 6 QUOTE]All things that be and ever will be were scripted long ago by this spirit's inscrutable tendrils.":
		'Toutes les choses présentes et futures ont été écrites il y a bien longtemps par les tentacules insondables de cet esprit.',
	...
	'[GOD 7 QUOTE]This spirit enjoys a good cheese after a day of hard work.':
		'Cet esprit apprécie un bon fromage après une journée de dur labeur.',
	...
	'[GOD 8 QUOTE]While this spirit has many regrets, helping you rule the world through constant industrialization is not one of them.':
		"Même si cet esprit a maint regrets, vous aider à dominer le monde grâce à une industrialisation constante n'en fait pas partie.",
	...
	'[GOD 9 QUOTE]A caring spirit said to contain itself, inwards infinitely.':
		"Un esprit bienveillant dont on dit qu'il se contiendrait lui-même, à l'infini.",
	...
	'[GOD 10 QUOTE]This spirit enjoys poking foul beasts and watching them squirm, but has no love for its own family.':
		"Cet esprit aime tourmenter les bêtes immondes et les regarder se tortiller, mais n'a pas d'amour pour les siens.",
	...
	'[GOD 11 QUOTE]You will find that life gets just a little bit sweeter if you can motivate this spirit with tidy numbers and properly-filled tax returns.':
		"Vous vous rendrez compte que la vie est un petit peu plus agréable si vous arrivez à motiver cet esprit avec des chiffres ronds et des déclarations d'impôts bien remplies.",
	...
	'Drag a spirit onto this slot to assign it.':
		"Faites glisser un esprit vers cet emplacement pour l'y assigner.",
	'If a golden cookie is clicked, this spirit is unslotted and all worship swaps will be used up.':
		"Si un cookie doré est cliqué, cet esprit est retiré de son emplacement, et tous les échanges d'adoration seront utilisés.",
	'Each time you slot a spirit, you use up one worship swap.<div class="line"></div>If you have 2 swaps left, the next one will refill after %1.<br>If you have 1 swap left, the next one will refill after %2.<br>If you have 0 swaps left, you will get one after %3.<div class="line"></div>Unslotting a spirit costs no swaps.':
		"À chaque fois que tu mets un esprit dans un emplacement, tu utilises un échange d'adoration.<div class=\"line\"></div>S'il te reste 2 échanges, le prochain sera rechargé après %1.<br>S'il ne te reste plus qu'1 échange, le prochain sera rechargé après %2.<br>S'il ne te reste plus d'échange, tu en obtiendras un après %3.<div class=\"line\"></div>Retirer un esprit d'un emplacement ne coûte aucun échange.",
	'Click to refill all your worship swaps for %1.':
		"Clique pour recharger tous tes échanges d'adoration pour %1.",
	...
	'The jade slot behaves as a ruby slot and the ruby slot behaves as a diamond slot.':
		"L'emplacement jade se comporte comme un emplacement rubis et l'emplacement rubis comme un emplacement diamant.",
	...
	'You may increase your storage space by upgrading your offices and by buying more %1. You also get %2 extra storage space per %3 level (currently: <b>+%4</b>).':
		'Tu peux augmenter ton espace de stockage en améliorant tes bureaux et en achetant plus de %1. Tu gagnes aussi %2 espaces de stockage tous les %3 niveaux (actuellement : <b>+ %4</b>).',
	'The average worth of this stock and how high it can peak depends on the building it is tied to, along with the level of your %1.':
		"La valeur moyenne de cette action et jusqu'où elle peut monter dépend de la construction à laquelle elle est liée, ainsi que de ton niveau de %1.",
	'%1 the hide button to toggle all other stocks.':
		'%1 le bouton cacher pour activer ou non toutes les autres actions.',
	'stock:': 'action :',
	...
	'You cannot buy and sell this stock in the same tick.':
		'Tu ne peux pas acheter et revendre cette action au cours de la même période.',
	...
	'It is fully upgraded. Its lavish interiors, spanning across innumerable floors, are host to many a decadent party, owing to your nigh-unfathomable wealth.':
		"Il est pleinement amélioré. Son intérieur luxueux, s'étendant sur d'innombrables étages, est le décor de moult fêtes décadentes, grâce à ta richesse quasiment incalculable.",
	...
	'+%1% base warehouse space for all goods':
		"+ %1 % d'espace d'entrepôt de base pour toutes marchandises",
	'Brokers:': 'Courtiers :',
	...
	'Buying goods normally incurs overhead costs of <b>%1% extra</b>. Each broker you hire reduces that cost by <b>%2%</b>.':
		'Acheter des marchandises entraîne généralement des frais de <b>%1 % supplémentaires</b>. Chaque courtier que tu engages réduit ces frais de <b>%2 %</b>.',
	'Current overhead costs thanks to your brokers: <b>+%1%</b>':
		'Frais actuels grâce à tes courtiers : <b>+ %1 %</b>',
	"Buying a broker costs %1 of CpS (that's $%2).":
		'Acheter un courtier coûte %1 de CpS (donc %2 $).',
	"Maximum number of brokers you can own: %1 (the highest amount of grandmas you've owned this run, divided by 10, plus your grandma level)":
		'Nombre maximal de courtiers que tu peux posséder : %1 (le plus grand nombre de grand-mères que tu as possédées au cours de cette partie, divisé par 10, plus ton niveau de grand-mère)',
	'Brokers are Wall Street-class grandmas versed in the ways of finance. Stockbroker grandmas work hard and play hard, and will fight telephone in hand to get your clients the best possible deals - with a sizeable profit margin for you, of course.':
		'Les courtiers sont des grand-mères aux connaissances en finance dignes de Wall Street. Ces grand-mères courtiers travaillent dur, jouent encore plus dur, et combattront, téléphone en main, pour décrocher les meilleures affaires pour tes clients (avec une bonne marge pour tes poches, bien entendu).',
	...
	"Buy that vintage car you've always wanted. Just pay us back.":
		"Achète cette voiture de collection que tu as toujours voulue. Mais n'oublie pas de nous rembourser.",
	'a pawnshop loan': 'un prêt de boutique de prêteur sur gages',
	"Bad credit? No problem. It's your money, and you need it now.":
		"Mauvaise note de crédit ? Pas de problème, c'est ton argent, et tu en as besoin tout de suite.",
	'a retirement loan': 'un prêt de retraite',
	"Finance your next house, boat, spouse, etc. You've earned it.":
		'Finance ton prochain manoir, bateau, mariage, etc. Tu le mérites.',
	'By taking this loan, you will get %1 CpS for the next %2.':
		'En contractant ce prêt, tu obtiendras %1 CpS pour les prochaines %2.',
	'However, you will get %1 CpS for the next %2 after that.':
		'Mais tu obtiendras %1 CpS pour les prochaines %2 après ça.',
	'You must also pay an immediate downpayment of %1 (<b>%2%</b> of your current bank).':
		'Tu dois également payer un apport immédiat de %1 (<b>%2 %</b> de ta banque actuelle).',
	'Loan over': 'Prêt fini',
	'Your loan has expired, and you must now repay the interest.':
		'Ton prêt a pris fin, et tu dois maintenant payer les intérêts.',
	...
	'Click to refill your opportunity timer (and give a quick burst to your economy) for %1.':
		"Clique pour remplir ta jauge d'opportunité (et donner un coup de fouet temporaire à ton économie) pour %1.",
	'Profits: %1. All prices are in $econds of your highest raw cookies per second.':
		'Profits : %1. Tous les prix sont dans les $econdes de ton plus haut niveau brut de cookies par secondes.',
	...
	'[Upgrade name 41]White chocolate macadamia nut cookies':
		'Cookies noix de macadamia chocolat blanc',
	...
	'[Upgrade name 96]Round chocolate british tea biscuits':
		'Biscuits ronds au chocolat pour le thé britannique',
	'[Upgrade name 97]Round british tea biscuits with heart motif':
		'Biscuits ronds à cœur pour le thé britannique',
	'[Upgrade name 98]Round chocolate british tea biscuits with heart motif':
		'Biscuits ronds à cœur au chocolat pour le thé britannique',
	...
	'[Upgrade name 318]Some other super-tiny fundamental particle? Probably?':
		"Un genre d'autre particule fondamentale super-minuscule ? Probablement ?",
	...
	'[Upgrade name 400]Lavender chocolate butter biscuit':
		'Biscuit au beurre au chocolat et à la lavande',
	...
	'[Upgrade name 442]Kitten assistants to the regional manager':
		'Assistants de directeurs régionaux chatons',
	...
	'[Upgrade name 477]Synthetic chocolate green honey butter biscuit':
		'Biscuit au beurre, chocolat de synthèse et miel vert',
	'[Upgrade name 478]Royal raspberry chocolate butter biscuit':
		'Biscuit au beurre, chocolat et framboise royale',
	'[Upgrade name 479]Ultra-concentrated high-energy chocolate butter biscuit':
		'Biscuit au beurre et chocolat à énergie ultra-concentrée',
	...
	'[Upgrade name 497]Pure pitch-black chocolate butter biscuit':
		'Biscuit au beurre et chocolat purement noir comme la nuit',
	...
	'[Upgrade name 527]One particularly good-humored cow':
		'La vache particulièrement de bonne humeur',
	...
	'[Upgrade name 553]A chocolate chip cookie but with the chips picked off for some reason':
		'Un cookie aux pépites de chocolat, mais dont les pépites ont mystérieusement disparu',
	...
	'[Upgrade name 718]Milkhelp&reg; lactose intolerance relief tablets':
		"Comprimés de soulagement de l'intolérance au lactose Milkhelp®",
	...
	'[Achievement name 149]The old never bothered me anyway':
		"Les vieilles choses ne m'ont jamais dérangé",
	...
	'[Achievement name 196]Too many rabbits, not enough hats':
		'Trop de lapins, pas assez de chapeaux',
	...
	'[Achievement name 225]He who controls the cookies controls the universe':
		"Celui qui contrôle les cookies contrôle l'univers",
	...
	"[Achievement name 228]We're gonna need a bigger bakery":
		'Il va falloir une plus grande pâtisserie',
	...
	'[Achievement name 230]Brought to you by the letter <div style="display:inline-block;background:url(img/money.png);width:16px;height:16px;"></div>':
		'Livré par la poste <div style="display:inline-block;background:url(img/money.png);width:16px;height:16px;"></div>',
	...
	"[Achievement name 255]And now for my next trick, I'll need a volunteer from the audience":
		"Et pour mon prochain tour, j'ai besoin d'un volontaire parmi le public",
	...
	'[Achievement name 259]cookie clicker forever and forever a hundred years cookie clicker, all day long forever, forever a hundred times, over and over cookie clicker adventures dot com':
		'cookie clicker, pour toujours et à jamais, cent ans de cookie clicker, toute la journée éternellement, pour cent éternités, encore et encore cookie clicker adventures point com.',
	'[Achievement name 260]Scientists baffled everywhere':
		'Les scientifiques du monde entier perplexes',
	...
	'[Achievement name 301]Neither snow nor rain nor heat nor gloom of night':
		'Ni la neige, ni la pluie, ni la chaleur, ni la noirceur de la nuit',
	...
	"[Achievement name 347]That's just peanuts to space":
		"Dans l'espace, personne ne t'entendra grignoter",
	...
	'[Achievement name 349]What happens in the vortex stays in the vortex':
		'Ce qui arrive dans le vortex reste dans le vortex',
	...
	'[Achievement name 353]Maybe a chance in hell, actually':
		"Peut-être qu'on a une chance en enfer, finalement",
	...
	"[Achievement name 357]Save your breath because that's all you've got left":
		"Ne gâche pas ta salive, c'est tout ce qu'il te reste",
	...
	"[Achievement name 361]Don't get used to yourself, you're gonna have to change":
		"Ne t'habitue pas à toi-même, tu vas devoir changer",
	'[Achievement name 362]Objects in the mirror dimension are closer than they appear':
		"Les objets de la dimension miroir sont plus proches qu'ils n'en ont l'air",
	...
	'[Achievement name 376]All the other kids with the pumped up clicks':
		'Et tous les autres gamins et leurs clics malins',
	...
	'[Achievement name 397]When the cookies ascend just right':
		'Quand les cookies effectuent une ascension sans accroc',
	...
	'[Achievement name 408]Your brain gets smart but your head gets dumb':
		'Quand ton esprit devient pointu mais ta tête lourde',
	...
	"[Achievement name 412]You'll never know if you don't go":
		"Tu n'arriveras jamais si tu ne pars pas",
	...
	'[Achievement name 421]For more information on this achievement, please refer to its title':
		"Pour plus d'informations sur ce trophée, merci de lire son titre",
	"[Achievement name 422]I'm so meta, even this achievement":
		'Je suis tellement meta, même ce trophée',
	...
	"[Achievement name 429]I think it's safe to say you've got it made":
		"Je pense qu'on peut dire qu'on est en place",
	...
	"[Achievement name 442]Dude what if we're all living in a simulation like what if we're all just code on a computer somewhere":
		"Mec, et si on vivait tous genre dans une simulation, si on n'était que des programmes sur un ordinateur quelque part",
	...
	'[Achievement name 467]What did we even eat before these':
		"Mais que'est-ce qu'on mangeait avant ça",
	...
	'[Achievement name 495]Mountain out of a molehill, but like in a good way':
		"Une montagne d'un taupinière, mais dans le bon sens",
	...
	'[Achievement name 506]Flip a cookie. Chips, I win. Crust, you lose.':
		'Jette un cookie. Pépites, je gagne, croûte, tu perds.',
	...
	"[Achievement name 509]They'll never know what hit 'em":
		'Ils ne sauront jamais ce qui leur est tombé dessus',
	...
	'[Achievement name 515]Nobody exists on purpose, nobody belongs anywhere':
		"Personne n'a choisi d'exister, et personne n'appartient à un endroit",
	...
	'[Achievement name 521]Reject reality, substitute your own':
		'Rejette la réalité, remplace-la par la tienne',
	...
	'[Achievement name 531]Keep going until I say stop':
		"Continue jusqu'à ce que je te dise de t'arrêter",
	...
	'[Achievement name 544]A trademarked portmanteau of "imagination" and "engineering"':
		'Un mot-valise à marque déposée combinant « imagination » et « ingénierie »',
	...
	'[Achievement name 548]Though fools seldom differ':
		"Bien que les idiots soient rarement d'un avis différent",
	...
	"[Achievement name 558]Don't let the walls cave in on you":
		'Ne laisse pas les murs se refermer sur toi',
	...
	'[Achievement name 573]By will alone I set my mind in motion':
		'Par ma seule volonté mon esprit se met en branle',
	...
	'[Achievement name 586]What do you get for the baker who has everything':
		"Qu'offrir au pâtissier qui a tout",
