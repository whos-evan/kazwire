...
M.launch = function () {
	...
	M.init = function (div) {
		...
		M.gods = {
			asceticism: {
				...
				descAfter:
					'<span class="red">If a golden cookie is clicked, this spirit is unslotted and all worship swaps will be used up.</span>',
				quote:
					'An immortal life spent focusing on the inner self, away from the distractions of material wealth.'
			},
			decadence: {
				name: 'Vomitrax, Spirit of Decadence',
				icon: [22, 18],
				desc1:
					'<span class="green">Golden and wrath cookie effect duration +7%,</span> <span class="red">but buildings grant -7% CpS.</span>',
				desc2:
					'<span class="green">Golden and wrath cookie effect duration +5%,</span> <span class="red">but buildings grant -5% CpS.</span>',
				desc3:
					'<span class="green">Golden and wrath cookie effect duration +2%,</span> <span class="red">but buildings grant -2% CpS.</span>',
				quote:
					'This sleazy spirit revels in the lust for quick easy gain and contempt for the value of steady work.'
			},
			ruin: {
				name: 'Godzamok, Spirit of Ruin',
				icon: [23, 18],
				descBefore:
					'<span class="green">Selling buildings triggers a buff boosted by how many buildings were sold.</span>',
				desc1:
					'<span class="green">Buff boosts clicks by +1% for every building sold for 10 seconds.</span>',
				desc2:
					'<span class="green">Buff boosts clicks by +0.5% for every building sold for 10 seconds.</span>',
				desc3:
					'<span class="green">Buff boosts clicks by +0.25% for every building sold for 10 seconds.</span>',
				quote:
					'The embodiment of natural disasters. An impenetrable motive drives the devastation caused by this spirit.'
			},
			ages: {
				...
				activeDescFunc: function () {
					...
					var mult = 1;
					if (godLvl == 1)
						mult *= 0.15 * Math.sin((Date.now() / 1000 / (60 * 60 * 3)) * Math.PI * 2);
					else if (godLvl == 2)
						mult *= 0.15 * Math.sin((Date.now() / 1000 / (60 * 60 * 12)) * Math.PI * 2);
					else if (godLvl == 3)
						mult *= 0.15 * Math.sin((Date.now() / 1000 / (60 * 60 * 24)) * Math.PI * 2);
					return (
						'Current bonus : ' + (mult < 0 ? '-' : '+') + Beautify(Math.abs(mult) * 100, 2) + '%.'
					);
				},
				descBefore:
					'CpS bonus fluctuating between <span class="green">+15%</span> and <span class="red">-15%</span> over time.',
				desc1: 'Effect cycles over 3 hours.',
				desc2: 'Effect cycles over 12 hours.',
				desc3: 'Effect cycles over 24 hours.',
				quote:
					"This spirit knows about everything you'll ever do, and enjoys dispensing a harsh judgement."
			},
			seasons: {
				...
				desc1:
					'<span class="green">Large boost.</span> <span class="red">Switching seasons is 100% pricier.</span>',
				desc2:
					'<span class="green">Medium boost.</span> <span class="red">Switching seasons is 50% pricier.</span>',
				desc3:
					'<span class="green">Small boost.</span> <span class="red">Switching seasons is 25% pricier.</span>',
			...
			creation: {
				...
				icon: [26, 18],
				desc1:
					'<span class="green">Buildings are 7% cheaper,</span> <span class="red">but heavenly chips have 30% less effect.</span>',
				desc2:
					'<span class="green">Buildings are 5% cheaper,</span> <span class="red">but heavenly chips have 20% less effect.</span>',
				desc3:
					'<span class="green">Buildings are 2% cheaper,</span> <span class="red">but heavenly chips have 10% less effect.</span>',
				quote:
					"All things that be and ever will be were scripted long ago by this spirit's inscrutable tendrils."
			},
			labor: {
				name: 'Muridal, Spirit of Labor',
				icon: [27, 18],
				desc1:
					'<span class="green">Clicks are 15% more powerful,</span> <span class="red">but buildings produce 3% less.</span>',
				desc2:
					'<span class="green">Clicks are 10% more powerful,</span> <span class="red">but buildings produce 2% less.</span>',
				desc3:
					'<span class="green">Clicks are 5% more powerful,</span> <span class="red">but buildings produce 1% less.</span>',
			...
			industry: {
				...
				icon: [28, 18],
				desc1:
					'<span class="green">Buildings produce 10% more cookies,</span> <span class="red">but golden and wrath cookies appear 10% less.</span>',
				desc2:
					'<span class="green">Buildings produce 6% more cookies,</span> <span class="red">but golden and wrath cookies appear 6% less.</span>',
				desc3:
					'<span class="green">Buildings produce 3% more cookies,</span> <span class="red">but golden and wrath cookies appear 3% less.</span>',
				quote:
					'While this spirit has many regrets, helping you rule the world through constant industrialization is not one of them.'
			},
			mother: {
				name: 'Mokalsium, Mother Spirit',
				icon: [29, 18],
				desc1:
					'<span class="green">Milk is 10% more powerful,</span> <span class="red">but golden and wrath cookies appear 15% less.</span>',
				desc2:
					'<span class="green">Milk is 5% more powerful,</span> <span class="red">but golden and wrath cookies appear 10% less.</span>',
				desc3:
					'<span class="green">Milk is 3% more powerful,</span> <span class="red">but golden and wrath cookies appear 5% less.</span>',
			...
			scorn: {
				...
				icon: [21, 19],
				descBefore:
					'<span class="red">All golden cookies are wrath cookies with a greater chance of a negative effect.</span>',
				desc1:
					'<span class="green">Wrinklers appear 150% faster and digest 15% more cookies.</span>',
				desc2:
					'<span class="green">Wrinklers appear 100% faster and digest 10% more cookies.</span>',
				desc3: '<span class="green">Wrinklers appear 50% faster and digest 5% more cookies.</span>',
				quote:
					'This spirit enjoys poking foul beasts and watching them squirm, but has no love for its own family.'
			},
			order: {
				...
				activeDescFunc: function () {
					if (Game.BuildingsOwned % 10 == 0)
						return 'Buildings owned : ' + Beautify(Game.BuildingsOwned) + '.<br>Effect is active.';
					else
						return (
							'Buildings owned : ' + Beautify(Game.BuildingsOwned) + '.<br>Effect is inactive.'
						);
				},
				...
				descAfter:
					'<span class="red">Effect is only active when your total amount of buildings ends with 0.</span>',
				quote:
					'You will find that life gets just a little bit sweeter if you can motivate this spirit with tidy numbers and properly-filled tax returns.'
			}
		};
		M.godsById = [];
		var n = 0;
		...
		M.godTooltip = function (id) {
			return function () {
				...
				var str =
					...
					(me.desc1
						? '<div class="templeEffect templeEffect1"><div class="usesIcon shadowFilter templeGem templeGem1"></div>' +
						  me.desc1 +
						  '</div>'
						: '') +
					(me.desc2
						? '<div class="templeEffect templeEffect2"><div class="usesIcon shadowFilter templeGem templeGem2"></div>' +
						  me.desc2 +
						  '</div>'
						: '') +
					(me.desc3
						? '<div class="templeEffect templeEffect3"><div class="usesIcon shadowFilter templeGem templeGem3"></div>' +
						  me.desc3 +
						  '</div>'
						: '') +
		...
		M.slotTooltip = function (id) {
			return function () {
				...
				var str =
					'<div style="padding:8px 4px;min-width:350px;">' +
					(M.slot[id] != -1
						? '<div class="name templeEffect" style="margin-bottom:12px;"><div class="usesIcon shadowFilter templeGem templeGem' +
						  (parseInt(id) + 1) +
						  '"></div>' +
						  M.slotNames[id] +
						  ' slot</div>' +
						  ...
						  '<div class="line"></div><div class="description"><div style="margin:6px 0px;font-weight:bold;">Effects :</div>' +
						  (me.activeDescFunc
								? '<div class="templeEffect templeEffectOn" style="padding:8px 4px;text-align:center;">' +
								  me.activeDescFunc() +
								  '</div>'
								: '') +
						  (me.descBefore ? '<div class="templeEffect">' + me.descBefore + '</div>' : '') +
						  (me.desc1
								? '<div class="templeEffect templeEffect1' +
								  (me.slot == 0 ? ' templeEffectOn' : '') +
								  '"><div class="usesIcon shadowFilter templeGem templeGem1"></div>' +
								  me.desc1 +
								  '</div>'
								: '') +
						  (me.desc2
								? '<div class="templeEffect templeEffect2' +
								  (me.slot == 1 ? ' templeEffectOn' : '') +
								  '"><div class="usesIcon shadowFilter templeGem templeGem2"></div>' +
								  me.desc2 +
								  '</div>'
								: '') +
						  (me.desc3
								? '<div class="templeEffect templeEffect3' +
								  (me.slot == 2 ? ' templeEffectOn' : '') +
								  '"><div class="usesIcon shadowFilter templeGem templeGem3"></div>' +
								  me.desc3 +
								  '</div>'
								: '') +
						  (me.descAfter ? '<div class="templeEffect">' + me.descAfter + '</div>' : '') +
						  (me.quote ? '<q>' + me.quote + '</q>' : '') +
						  '</div>'
						: '<div class="name templeEffect"><div class="usesIcon shadowFilter templeGem templeGem' +
						  (parseInt(id) + 1) +
						  '"></div>' +
						  M.slotNames[id] +
						  ' slot (empty)</div><div class="line"></div><div class="description">' +
						  (M.slotHovered == id && M.dragging
								? 'Release to assign <b>' + M.dragging.name + '</b> to this slot.'
		...
		M.dropGod = function () {
			...
			if (M.slotHovered != -1 && (M.swaps == 0 || M.dragging.slot == M.slotHovered)) {
				...
				if (M.dragging.slot != -1) l('templeSlot' + M.dragging.slot).appendChild(div);
					...
					l('templeGodPlaceholder' + M.dragging.id).parentNode.insertBefore(
						div,
						l('templeGodPlaceholder' + M.dragging.id)
					);
		...
		for (var i in M.slot) {
			var me = M.slot[i];
			str +=
				'<div class="ready templeGod templeGod' +
				(i % 4) +
				' templeSlot titleFont" id="templeSlot' +
				i +
				'" ' +
				Game.getDynamicTooltip(
					'Game.ObjectsById[' + M.parent.id + '].minigame.slotTooltip(' + i + ')',
					'this'
				) +
				'><div class="usesIcon shadowFilter templeGem templeGem' +
				(parseInt(i) + 1) +
				'"></div></div>';
		}
		str += '</div>';
		str +=
			'<div id="templeInfo"><div ' +
			Game.getDynamicTooltip(
				'Game.ObjectsById[' + M.parent.id + '].minigame.refillTooltip',
				'this'
			) +
			' id="templeLumpRefill" class="usesIcon shadowFilter lumpRefill" style="left:-6px;top:-10px;background-position:' +
			-29 * 48 +
			'px ' +
			-14 * 48 +
			'px;"></div><div id="templeSwaps" ' +
			Game.getTooltip(
				'<div style="padding:8px;width:350px;font-size:11px;text-align:center;">Each time you slot a spirit, you use up one worship swap.<div class="line"></div>If you have 2 swaps left, the next one will refill after 1 hour.<br>If you have 1 swap left, the next one will refill after 4 hours.<br>If you have 0 swaps left, you will get one after 16 hours.<div class="line"></div>Unslotting a spirit costs no swaps.</div>'
			) +
			'>-</div></div>';
		...
		for (var i in M.gods) {
			...
			str +=
				'<div class="ready templeGod templeGod' +
				(me.id % 4) +
				' titleFont" id="templeGod' +
				me.id +
				'" ' +
				Game.getDynamicTooltip(
					'Game.ObjectsById[' + M.parent.id + '].minigame.godTooltip(' + me.id + ')',
					'this'
				) +
				'><div class="usesIcon shadowFilter templeIcon" style="background-position:' +
				-icon[0] * 48 +
				'px ' +
				-icon[1] * 48 +
				'px;"></div><div class="templeSlotDrag" id="templeGodDrag' +
				me.id +
				'"></div></div>';
		...
		M.refillTooltip = function () {
			return (
				'<div style="padding:8px;width:300px;font-size:11px;text-align:center;">Click to refill all your worship swaps for <span class="price lump">1 sugar lump</span>.' +
				(Game.canRefillLump()
	...
	M.draw = function () {
		...
		var t2 = M.swapT + t - Date.now();
		M.swapsL.innerHTML =
			'Worship swaps : <span class="titleFont" style="color:' +
			(M.swaps > 0 ? '#fff' : '#c00') +
			';">' +
			M.swaps +
			'/' +
