							...
							var i = function (e) {
											...
											if ('require' !== r && 'advanced' !== r && 'mediaSource' !== r) {
												...
												void 0 !== i.exact && 'number' != typeof i.exact
													...
													: ['min', 'max'].forEach(function (e) {
															void 0 !== i[e] &&
																((t.mandatory = t.mandatory || {}), (t.mandatory[o(e, r)] = i[e]));
													  });
											}
										}),
								...
								o = function (e, o) {
									...
									if (e && 'object' === n(e.video)) {
										...
										c = c && ((void 0 === c ? 'undefined' : n(c)) === 'object' ? c : { ideal: c });
										var p = t.version < 66;
										if (
											c &&
											('user' === c.exact ||
											...
											if (
												...
												return r.mediaDevices.enumerateDevices().then(function (t) {
													...
													return (
														!r && t.length && d.includes('back') && (r = t[t.length - 1]),
														r &&
						...
						if (
							...
							(e.RTCIceCandidate = function (e) {
								if (
									...
									var r,
										n = Object.assign(new t(e), s.default.parseCandidate(e.candidate));
									return (
										(n.toJSON = function () {
											return {
							...
							if (e.RTCPeerConnection && e.RTCPeerConnection.prototype) {
								...
								r &&
									...
									(e.RTCPeerConnection.prototype.setLocalDescription = function () {
										var e = this,
											t = arguments[0] || {};
										if ((void 0 === t ? 'undefined' : i(t)) !== 'object' || (t.type && t.sdp))
											return r.apply(this, arguments);
							...
							if ((void 0 === e ? 'undefined' : n(e)) === 'object' && e.RTCRtpSender) {
								...
								t &&
									(e.RTCRtpSender.prototype.getParameters = function () {
										var e = t.apply(this, arguments);
										return (
											'encodings' in e || (e.encodings = [].concat(this.sendEncodings || [{}])), e
										);
									});
							}
						}),
			...
			11: [
				function (e, t, r) {
					...
					(r.extractVersion = a),
						...
						(r.log = function () {
							('undefined' == typeof window ? 'undefined' : n(window)) === 'object' &&
								!i &&
				...
				function (e, t, r) {
					...
					(i.generateIdentifier = function () {
						...
						(i.parseFmtp = function (e) {
							for (
								var t = {}, r = void 0, n = e.substr(e.indexOf(' ') + 1).split(';'), i = 0;
								i < n.length;
								i++
							)
						...
						(i.writeCryptoLine = function (e) {
							return (
								...
								e.cryptoSuite +
								' ' +
								('object' === n(e.keyParams) ? i.writeCryptoKeyParams(e.keyParams) : e.keyParams) +
						...
						(i.getIceParameters = function (e, t) {
							...
							return r && n ? { usernameFragment: r.substr(12), password: n.substr(10) } : null;
						}),
							...
							p.length > 0 && p[0].length > 1 && p[0][0] === s && (c = p[0][1]),
								r.codecs.forEach(function (e) {
									if ('RTX' === e.name.toUpperCase() && e.parameters.apt) {
										var r = { ssrc: s, codecPayloadType: parseInt(e.parameters.apt, 10) };
										s && c && (r.rtx = { ssrc: c }),
											t.push(r),
											n &&
						...
						(i.parseMsid = function (e) {
							...
							if (n.length > 0) return { stream: (t = n[0].value.split(' '))[0], track: t[1] };
						}),
						(i.parseSctpDescription = function (e) {
							...
							if (o.length > 0)
								return { port: parseInt(o[0].substr(12), 10), protocol: t.fmt, maxMessageSize: n };
							var a = i.matchPrefix(e, 'a=sctpmap:');
							if (a.length > 0) {
								var s = a[0].substr(10).split(' ');
								return { port: parseInt(s[0], 10), protocol: s[1], maxMessageSize: n };
							}
						}),
