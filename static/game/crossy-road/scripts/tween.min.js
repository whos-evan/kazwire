		...
		(this.to = function (n, t) {
			...
			(this.start = function (n) {
				...
				for (var t in u) {
					...
					void 0 !== r[t] &&
						((i[t] = r[t]), i[t] instanceof Array == !1 && (i[t] *= 1), (e[t] = i[t] || 0));
				}
				return this;
			}),
			(this.stop = function () {
				...
				for (c in u)
					if (void 0 !== i[c]) {
						...
						O instanceof Array
							...
							: ('string' == typeof O &&
									(O =
										'+' === O.charAt(0) || '-' === O.charAt(0) ? W + parseFloat(O) : parseFloat(O)),
							  'number' == typeof O && (r[c] = W + (O - W) * N));
					}
				if ((null !== I && I.call(r, N), 1 === T)) {
					if (a > 0) {
						isFinite(a) && a--;
						for (c in e) {
							if (('string' == typeof u[c] && (e[c] = e[c] + parseFloat(u[c])), f)) {
								var m = e[c];
								(e[c] = u[c]), (u[c] = m);
							}
							i[c] = e[c];
					...
					null !== M && M.call(r, r);
					for (var g = 0, y = d.length; g < y; g++) d[g].start(l + o);
					return !1;
				}
				return !0;
			});
	...
	(TWEEN.Interpolation = {
		Linear: function (n, t) {
			...
			return t < 0
				...
				: t > 1
				? e(n[r], n[r - 1], r - i)
				: e(n[u], n[u + 1 > r ? r : u + 1], i - u);
		},
		Bezier: function (n, t) {
			for (
				var r = 0, i = n.length - 1, u = Math.pow, e = TWEEN.Interpolation.Utils.Bernstein, o = 0;
				o <= i;
				o++
			)
				r += u(1 - t, i - o) * u(t, o) * n[o] * e(i, o);
			return r;
		},
		CatmullRom: function (n, t) {
			...
			return n[0] === n[r]
				? (t < 0 && (u = Math.floor((i = r * (1 + t)))),
				  e(n[(u - 1 + r) % r], n[u], n[(u + 1) % r], n[(u + 2) % r], i - u))
				: t < 0
				? n[0] - (e(n[0], n[0], n[1], n[1], -i) - n[0])
				: t > 1
				? n[r] - (e(n[r], n[r], n[r - 1], n[r - 1], i - r) - n[r])
				: e(n[u ? u - 1 : 0], n[u], n[r < u + 1 ? r : u + 1], n[r < u + 2 ? r : u + 2], i - u);
		},
		Utils: {
			...
			CatmullRom: function (n, t, r, i, u) {
				var e = 0.5 * (r - n),
					...
					a = u * u,
					f = u * a;
				return (2 * t - 2 * r + e + o) * f + (-3 * t + 3 * r - 2 * e - o) * a + e * u + t;
			}
		}
	}),
	(function (n) {
