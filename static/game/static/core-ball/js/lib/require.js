	...
	function ha(b) {
		...
		$.prototype = {
			...
			defineDep: function (a, e) {
				this.depMatched[a] ||
					((this.depMatched[a] = !0), (this.depCount -= 1), (this.depExports[a] = e));
			},
			fetch: function () {
				if (!this.fetched) {
					this.fetched = !0;
								...
								: ((d = t(this, function (a) {
								  ...
								  (d.fromText = t(this, function (f, c) {
										...
										try {
											...
											return w(
												C('fromtexteval', 'fromText eval for ' + b + ' failed: ' + j, j, [b])
											);
										}
										k && (O = !0);
										this.depMaps.push(J);
		...
		i = {
			...
			onScriptLoad: function (a) {
				if ('load' === a.type || ka.test((a.currentTarget || a.srcElement).readyState))
					(P = null), (a = L(a)), i.completeLoad(a.id);
			},
		...
		h.load = function (b, c, d) {
			...
			if (z)
				return (
					...
					g.attachEvent &&
					!(g.attachEvent.toString && 0 > g.attachEvent.toString().indexOf('[native code')) &&
					!Z
