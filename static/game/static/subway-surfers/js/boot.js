!(function (t) {
	...
	(__webpack_require__.m = t),
		...
		__webpack_require__((__webpack_require__.s = 486));
})({
	486: function (e, n, t) {
		function pathJoin() {
		...
		function loadJson(e, n, t) {
			...
			a.addEventListener('load', function () {
				...
				a.open('GET', e + '?v=1gefx1jwdk0gj12hb'),
				a.send();
		}
		...
		function loadFont(e, n) {
			...
			(t.rel = 'stylesheet'),
				(t.type = 'text/css'),
				(t.href = e + '?v=1gefx1jwdk0gj12hb'),
				(t.media = 'all'),
				document.head.appendChild(t);
			var a = document.createElement('div');
			(a.className = 'fontcache'),
				(a.style = 'font-family: "' + n + '";'),
				(a.textContent = '.'),
		...
		function initApp(e) {
			var n, t, a;
			(n = e.meta),
				(t = pathJoin(n.path, n.splash)),
				((a = document.querySelector('#og-game-holder')).style.backgroundColor = n.color),
				(a.style.backgroundImage = 'url("' + t + '?v=1gefx1jwdk0gj12hb"")'),
				loadFont('assets/font/lilita-one.css', 'Lilita One'),
				loadFont('assets/font/titan-one.css', 'Titan One'),
				window.sharedAppData.config.leaderboards && loadScript('js/leaderboard.js'),
				window.sharedAppData.config.vconsole &&
					loadScript('https://cdnjs.cloudflare.com/ajax/libs/vConsole/3.3.0/vconsole.min.js'),
				loadScript('js/inflate.min.js'),
				loadScript('js/vendor.js'),
					...
					o = (function () {
						...
						for (var t in e) {
							...
							void 0 !== r &&
								...
								(n[o] = 'string' == typeof r && r.match(/^[-.0-9]+$/) ? parseFloat(r) : r));
						}
						return n;
					})();
