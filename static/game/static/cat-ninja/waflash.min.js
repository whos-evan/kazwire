var Module = (() => {
	...
	return function (r) {
		...
		((r = void 0 !== (r = r || {}) ? r : {}).ready = new Promise(function (e, r) {
			...
			r.expectedDataFileDownloads || (r.expectedDataFileDownloads = 0),
			...
			(function () {
				if (!r.ENVIRONMENT_IS_PTHREAD) {
					!(function (e) {
						...
						var t = 'waflash.data';
						'function' != typeof r.locateFilePackage ||
							r.locateFile ||
							((r.locateFile = r.locateFilePackage),
							p(
						...
						function l() {
							...
							n.prototype = {
								...
								finish: function (e) {
									r.FS_createDataFile(this.name, null, e, !0, !0, !0),
										r.removeRunDependency('fp ' + this.name),
										(this.requests[this.name] = null);
								}
							};
							for (var o = e.files, a = 0; a < o.length; ++a)
								new n(o[a].start, o[a].end, o[a].audio || 0).open('GET', o[a].filename);
							function i(o) {
								...
								for (var i = e.files, u = 0; u < i.length; ++u)
									n.prototype.requests[i[u].filename].onload();
								r.removeRunDependency('datafile_waflash.data');
							}
							r.addRunDependency('datafile_waflash.data'),
								r.preloadResults || (r.preloadResults = {}),
								(r.preloadResults['waflash.data'] = { fromCache: !1 }),
								f ? (i(f), (f = null)) : (c = i);
						}
						f ||
							((a = n),
							...
							(s = new XMLHttpRequest()).open('GET', a, !0),
							...
							(s.onprogress = function (e) {
								...
								if ((e.total && (n = e.total), e.loaded)) {
									s.addedTotal
										? (r.dataFileDownloads[t].loaded = e.loaded)
										: ((s.addedTotal = !0),
										  r.dataFileDownloads || (r.dataFileDownloads = {}),
										  (r.dataFileDownloads[t] = { loaded: e.loaded, total: n }));
									var o = 0,
										u = 0,
										c = 0;
									...
									(o = Math.ceil((o * r.expectedDataFileDownloads) / c)),
										r.setStatus && r.setStatus('Downloading data... (' + u + '/' + o + ')');
							...
							s.send(null)),
							r.calledRun ? l() : (r.preRun || (r.preRun = []), r.preRun.push(l));
					})({
						files: [
							{ filename: '/desktop.ini', start: 0, end: 46 },
							{ filename: '/NanumSquareRoundOTFR.otf', start: 46, end: 465950 }
						],
			...
			switch (('*' === t.charAt(t.length - 1) && (t = 'i32'), t)) {
				...
				case 'i64':
					(ue = [
						...
						+Math.abs(ie) >= 1
							? ie > 0
								? (0 | Math.min(+Math.floor(ie / 4294967296), 4294967295)) >>> 0
								: ~~+Math.ceil((ie - +(~~ie >>> 0)) / 4294967296) >>> 0
							: 0)
					]),
						(P[e >> 2] = ue[0]),
						(P[(e + 4) >> 2] = ue[1]);
		...
		function G(e) {
			(A = e),
				...
				(r.HEAP16 = _ = new Int16Array(e)),
				(r.HEAP32 = P = new Int32Array(e)),
				(r.HEAPU8 = B = new Uint8Array(e)),
				(r.HEAPU16 = D = new Uint16Array(e)),
				(r.HEAPU32 = F = new Uint32Array(e)),
				(r.HEAPF32 = T = new Float32Array(e)),
				(r.HEAPF64 = I = new Float64Array(e));
		}
		r.INITIAL_MEMORY;
		var Q,
			H = [],
		...
		function te(e) {
			if (
				(Z--,
				r.monitorRunDependencies && r.monitorRunDependencies(Z),
				0 == Z && (null !== J && (clearInterval(J), (J = null)), ee))
			) {
				var t = ee;
				(ee = null), t();
			}
		...
		var fe = {
			...
			994451: function () {
				r.canvas.addEventListener('keydown', (e) => {
					(r.keyboardModifierState = r.keyboardModifierState || {}),
						(r.keyboardModifierState.NumLock = e.getModifierState('NumLock')),
						(r.keyboardModifierState.CapLock = e.getModifierState('CapLock'));
				}),
			...
			995194: function () {
				...
				if (e) {
					...
					if (e.startsWith('http://') || e.startsWith('https://')) r = e;
						...
						let t = window.location.pathname.substr(
							0,
			...
			996363: function () {
				...
				e && r.canvas.parentNode.removeChild(e),
					(r.canvas.wafActiveInputText = null),
					r.canvas.focus();
			},
			996536: function (e, t) {
				const n = r.canvas.wafActiveInputText;
				n &&
					((n.wafSelectionChangedByEngine = !0),
					(n.wafSelectionStart = n.selectionStart = e),
					(n.wafSelectionEnd = n.selectionEnd = t));
			},
			996729: function (e) {
				...
				if (t) {
					...
					t.value != r &&
						((t.value = r),
						(t.wafSelectionStart = t.selectionStart = r.length),
			...
			997055: function () {
				return ({ high: 3, medium: 2, low: 1 }[r.options.quality] || 3) - 1;
			},
			997145: function () {
				return ({ high: 3, medium: 2, low: 1 }[r.options.quality] || 3) - 1;
			},
			...
			997327: function (e) {
				...
				return (
					null === o && (o = 'i'),
					(r = Yr(o)),
					(t = 1 == 'i8' ? it(r.length) : et(r.length)),
					r.subarray || r.slice || (r = new Uint8Array(r)),
					B.set(r, t),
					t
				);
			},
			...
			997913: function (e) {
				...
				return (
					...
					t.audioContext ||
						...
						t.audioContext && le(t.audioContext)),
			...
			998474: function (e, t, n, o) {
				var a = r.SDL2,
					i = function (r) {
						void 0 !== a.capture.silenceTimer &&
							(clearTimeout(a.capture.silenceTimer), (a.capture.silenceTimer = void 0)),
							(a.capture.mediaStreamNode = a.audioContext.createMediaStreamSource(r)),
							(a.capture.scriptProcessorNode = a.audioContext.createScriptProcessor(t, e, 1)),
							(a.capture.scriptProcessorNode.onaudioprocess = function (e) {
								void 0 !== a &&
									void 0 !== a.capture &&
									(e.outputBuffer.getChannelData(0).fill(0),
									(a.capture.currentCaptureBuffer = e.inputBuffer),
									ge('vi', n, [o]));
							}),
							a.capture.mediaStreamNode.connect(a.capture.scriptProcessorNode),
							a.capture.scriptProcessorNode.connect(a.audioContext.destination),
							(a.capture.stream = r);
					},
					u = function (e) {};
				(a.capture.silenceBuffer = a.audioContext.createBuffer(e, t, a.audioContext.sampleRate)),
					a.capture.silenceBuffer.getChannelData(0).fill(0);
				(a.capture.silenceTimer = setTimeout(function () {
					(a.capture.currentCaptureBuffer = a.capture.silenceBuffer), ge('vi', n, [o]);
				}, (t / a.audioContext.sampleRate) * 1e3)),
					void 0 !== navigator.mediaDevices && void 0 !== navigator.mediaDevices.getUserMedia
						? navigator.mediaDevices.getUserMedia({ audio: !0, video: !1 }).then(i).catch(u)
						: void 0 !== navigator.webkitGetUserMedia &&
						  navigator.webkitGetUserMedia({ audio: !0, video: !1 }, i, u);
			},
			1000126: function (e, t, n, o) {
				var a = r.SDL2;
				(a.audio.scriptProcessorNode = a.audioContext.createScriptProcessor(t, 0, e)),
					(a.audio.scriptProcessorNode.onaudioprocess = function (e) {
						void 0 !== a &&
							void 0 !== a.audio &&
							((a.audio.currentOutputBuffer = e.outputBuffer), ge('vi', n, [o]));
					}),
					a.audio.scriptProcessorNode.connect(a.audioContext.destination);
			},
			1000536: function (e, t) {
				for (
					var n = r.SDL2, o = n.capture.currentCaptureBuffer.numberOfChannels, a = 0;
					a < o;
					++a
				) {
					...
					if (1 == o) for (var u = 0; u < t; ++u) w(e + 4 * u, i[u], 'float');
					else for (u = 0; u < t; ++u) w(e + 4 * (u * o + a), i[u], 'float');
				}
			},
			...
			1001621: function (e) {
				...
				if (e) {
					if (
						(void 0 !== t.capture.silenceTimer && clearTimeout(t.capture.silenceTimer),
						void 0 !== t.capture.stream)
					) {
						for (var n = t.capture.stream.getAudioTracks(), o = 0; o < n.length; o++)
							t.capture.stream.removeTrack(n[o]);
						t.capture.stream = void 0;
					}
					void 0 !== t.capture.scriptProcessorNode &&
						((t.capture.scriptProcessorNode.onaudioprocess = function (e) {}),
						t.capture.scriptProcessorNode.disconnect(),
						(t.capture.scriptProcessorNode = void 0)),
						void 0 !== t.capture.mediaStreamNode &&
							(t.capture.mediaStreamNode.disconnect(), (t.capture.mediaStreamNode = void 0)),
						void 0 !== t.capture.silenceBuffer && (t.capture.silenceBuffer = void 0),
						(t.capture = void 0);
				} else
					null != t.audio.scriptProcessorNode &&
						(t.audio.scriptProcessorNode.disconnect(), (t.audio.scriptProcessorNode = void 0)),
						(t.audio = void 0);
			...
			1002793: function (e, t, n) {
				...
				r.SDL2 || (r.SDL2 = {});
				var u = r.SDL2;
				u.ctxCanvas !== r.canvas &&
					((u.ctx = r.createContext(r.canvas, !1, !0)), (u.ctxCanvas = r.canvas)),
					(u.w === o && u.h === a && u.imageCtx === u.ctx) ||
						((u.image = u.ctx.createImageData(o, a)), (u.w = o), (u.h = a), (u.imageCtx = u.ctx));
				var s,
					c = u.image.data,
					f = i >> 2,
					l = 0;
		...
		function le(e, r) {
			r || (r = [document, document.getElementById('canvas')]),
				['keydown', 'mousedown', 'touchstart'].forEach(function (t) {
					r.forEach(function (r) {
						r &&
							(function (e, r, t) {
								e.addEventListener(r, t, { once: !0 });
							})(r, t, function () {
		...
		var xe = {
			...
			Ee = {
				...
				register: function (e, r) {
					(Ee.ttys[e] = { input: [], output: [], ops: r }), Le.registerDevice(e, Ee.stream_ops);
				},
				stream_ops: {
					open: function (e) {
		...
		var Ce = {
			...
			createNode: function (e, r, t, n) {
				...
				Ce.ops_table ||
					(Ce.ops_table = {
						dir: {
							...
							stream: { llseek: Ce.stream_ops.llseek }
						},
						file: {
				...
				return (
					Le.isDir(o.mode)
						? ((o.node_ops = Ce.ops_table.dir.node),
						  (o.stream_ops = Ce.ops_table.dir.stream),
						  (o.contents = {}))
						: Le.isFile(o.mode)
						? ((o.node_ops = Ce.ops_table.file.node),
						  (o.stream_ops = Ce.ops_table.file.stream),
						  (o.usedBytes = 0),
						  (o.contents = null))
						: Le.isLink(o.mode)
						? ((o.node_ops = Ce.ops_table.link.node), (o.stream_ops = Ce.ops_table.link.stream))
						: Le.isChrdev(o.mode) &&
						  ((o.node_ops = Ce.ops_table.chrdev.node),
						  (o.stream_ops = Ce.ops_table.chrdev.stream)),
			...
			node_ops: {
				getattr: function (e) {
					var r = {};
					return (
						(r.dev = Le.isChrdev(e.mode) ? e.id : 1),
						(r.ino = e.id),
						(r.mode = e.mode),
						(r.nlink = 1),
						(r.uid = 0),
				...
				rename: function (e, r, t) {
					if (Le.isDir(e.mode)) {
						...
						if (n) for (var o in n.contents) throw new Le.ErrnoError(55);
					}
			...
			stream_ops: {
				...
				write: function (e, r, t, n, o, a) {
					...
					if ((Ce.expandFileStorage(i, o + n), i.contents.subarray && r.subarray))
				...
				llseek: function (e, r, t) {
					...
					if (
						(1 === t
							? (n += e.position)
							: 2 === t && Le.isFile(e.node.mode) && (n += e.node.usedBytes),
						n < 0)
					)
						throw new Le.ErrnoError(28);
					return n;
				},
				...
				mmap: function (e, r, t, n, o, a) {
					...
					if (2 & a || s.buffer !== A) {
						if (
							((n > 0 || n + t < s.length) &&
								(s = s.subarray ? s.subarray(n, n + t) : Array.prototype.slice.call(s, n, n + t)),
							(u = !0),
							!(i = ke(t)))
						)
							throw new Le.ErrnoError(48);
						L.set(s, i);
			...
			Ae = {
				...
				getDB: (e, r) => {
					...
					(t.onupgradeneeded = (e) => {
						...
						(r = t.objectStoreNames.contains(Ae.DB_STORE_NAME)
							? n.objectStore(Ae.DB_STORE_NAME)
							: t.createObjectStore(Ae.DB_STORE_NAME)).indexNames.contains('timestamp') ||
				...
				getLocalSet: (e, r) => {
					...
					for (var a = Le.readdir(e.mountpoint).filter(n).map(o(e.mountpoint)); a.length; ) {
						...
						Le.isDir(i.mode) && a.push.apply(a, Le.readdir(u).filter(n).map(o(u))),
							(t[u] = { timestamp: i.mtime });
					}
					...
					Ae.getDB(e.mountpoint, (e, n) => {
						...
						try {
							...
							(o.onerror = (e) => {
								...
								(o.objectStore(Ae.DB_STORE_NAME).index('timestamp').openKeyCursor().onsuccess = (
									e
								) => {
				...
				loadLocalEntry: (e, r) => {
					...
					return Le.isDir(t.mode)
						? r(null, { timestamp: t.mtime, mode: t.mode })
						: Le.isFile(t.mode)
						? ((n.contents = Ce.getFileDataAsTypedArray(n)),
				...
				storeLocalEntry: (e, r, t) => {
					try {
						if (Le.isDir(r.mode)) Le.mkdirTree(e, r.mode);
							...
							Le.writeFile(e, r.contents, { canOwn: !0 });
						}
			...
			Le = {
				...
				lookupPath: (e, r = {}) => {
					...
					for (
						...
						if (s && r.parent) break;
						if (
							((a = Le.lookupNode(a, o[u])),
							(i = we.join2(i, o[u])),
							Le.isMountpoint(a) && (!s || (s && r.follow_mount)) && (a = a.mounted.root),
							!s || r.follow)
						)
							for (var c = 0; Le.isLink(a.mode); ) {
								var f = Le.readlink(i);
								if (
									((i = xe.resolve(we.dirname(i), f)),
									(a = Le.lookupPath(i, { recurse_count: r.recurse_count }).node),
									c++ > 40)
								)
									throw new Le.ErrnoError(32);
							}
					}
				...
				mayOpen: (e, r) =>
					e
						? Le.isLink(e.mode)
							? 32
							: Le.isDir(e.mode) && ('r' !== Le.flagsToPermissionString(r) || 512 & r)
							? 31
							: Le.nodePermissions(e, Le.flagsToPermissionString(r))
						: 44,
				MAX_OPEN_FDS: 4096,
				nextfd: (e = 0, r = Le.MAX_OPEN_FDS) => {
					for (var t = e; t <= r; t++) if (!Le.streams[t]) return t;
					throw new Le.ErrnoError(33);
				},
				getStream: (e) => Le.streams[e],
				createStream: (e, r, t) => {
					Le.FSStream ||
						((Le.FSStream = function () {}),
						(Le.FSStream.prototype = {
							object: {
								get: function () {
									return this.node;
								},
				...
				mount: (e, r, t) => {
					...
					if (!o && !a) {
						var i = Le.lookupPath(t, { follow_mount: !1 });
						if (((t = i.path), (n = i.node), Le.isMountpoint(n))) throw new Le.ErrnoError(10);
						if (!Le.isDir(n.mode)) throw new Le.ErrnoError(54);
					}
					var u = { type: e, opts: r, mountpoint: t, mounts: [] },
						s = e.mount(u);
					return (
						(s.mount = u),
						(u.root = s),
						o ? (Le.root = s) : n && ((n.mounted = u), n.mount && n.mount.mounts.push(u)),
						s
					);
				},
				unmount: (e) => {
					var r = Le.lookupPath(e, { follow_mount: !1 });
				...
				create: (e, r) => (
					(r = void 0 !== r ? r : 438), (r &= 4095), (r |= 32768), Le.mknod(e, r, 0)
				),
				mkdir: (e, r) => (
					(r = void 0 !== r ? r : 511), (r &= 1023), (r |= 16384), Le.mknod(e, r, 0)
				),
				mkdirTree: (e, r) => {
				...
				symlink: (e, r) => {
					...
					var t = Le.lookupPath(r, { parent: !0 }).node;
				...
				rename: (e, r) => {
					var t,
						...
						u = we.basename(r);
					if (
						((t = Le.lookupPath(e, { parent: !0 }).node),
						(n = Le.lookupPath(r, { parent: !0 }).node),
						!t || !n)
					)
						throw new Le.ErrnoError(44);
				...
				rmdir: (e) => {
					var r = Le.lookupPath(e, { parent: !0 }).node,
						t = we.basename(e),
						n = Le.lookupNode(r, t),
				...
				readdir: (e) => {
					var r = Le.lookupPath(e, { follow: !0 }).node;
				...
				stat: (e, r) => {
					var t = Le.lookupPath(e, { follow: !r }).node;
					if (!t) throw new Le.ErrnoError(44);
				...
				chmod: (e, r, t) => {
					var n;
					'string' == typeof e ? (n = Le.lookupPath(e, { follow: !t }).node) : (n = e);
				...
				chown: (e, r, t, n) => {
					var o;
					'string' == typeof e ? (o = Le.lookupPath(e, { follow: !n }).node) : (o = e);
				...
				truncate: (e, r) => {
					...
					var t;
					'string' == typeof e ? (t = Le.lookupPath(e, { follow: !0 }).node) : (t = e);
				...
				open: (e, t, n, o, a) => {
					...
					if (
						((n = void 0 === n ? 438 : n),
						(n =
							64 & (t = 'string' == typeof t ? Le.modeStringToFlags(t) : t)
								? (4095 & n) | 32768
								: 0),
						'object' == typeof e)
					)
						...
						e = we.normalize(e);
						try {
							i = Le.lookupPath(e, { follow: !(131072 & t) }).node;
						} catch (e) {}
					}
					var u = !1;
					if (64 & t)
					...
					if ((Le.isChrdev(i.mode) && (t &= -513), 65536 & t && !Le.isDir(i.mode)))
						throw new Le.ErrnoError(54);
					if (!u) {
					...
					return (
						...
						!r.logReadFiles ||
							1 & t ||
							(Le.readFiles || (Le.readFiles = {}), e in Le.readFiles || (Le.readFiles[e] = 1)),
						c
					);
				},
				close: (e) => {
				...
				readFile: (e, r = {}) => {
					...
					return (
						Le.read(n, a, 0, o, 0),
						'utf8' === r.encoding ? (t = M(a, 0)) : 'binary' === r.encoding && (t = a),
						Le.close(n),
						t
					);
				},
				...
				cwd: () => Le.currentPath,
				chdir: (e) => {
					var r = Le.lookupPath(e, { follow: !0 });
				...
				createDefaultDevices: () => {
					Le.mkdir('/dev'),
						Le.registerDevice(Le.makedev(1, 3), { read: () => 0, write: (e, r, t, n, o) => n }),
						Le.mkdev('/dev/null', Le.makedev(1, 3)),
						Ee.register(Le.makedev(5, 0), Ee.default_tty_ops),
						Ee.register(Le.makedev(6, 0), Ee.default_tty1_ops),
						Le.mkdev('/dev/tty', Le.makedev(5, 0)),
						Le.mkdev('/dev/tty1', Le.makedev(6, 0));
					var e = (function () {
					...
					Le.createDevice('/dev', 'random', e),
						Le.createDevice('/dev', 'urandom', e),
						Le.mkdir('/dev/shm'),
						Le.mkdir('/dev/shm/tmp');
				},
				...
				createStandardStreams: () => {
					r.stdin
						? Le.createDevice('/dev', 'stdin', r.stdin)
						: Le.symlink('/dev/tty', '/dev/stdin'),
						r.stdout
							? Le.createDevice('/dev', 'stdout', null, r.stdout)
							: Le.symlink('/dev/tty', '/dev/stdout'),
						r.stderr
							? Le.createDevice('/dev', 'stderr', null, r.stderr)
							: Le.symlink('/dev/tty1', '/dev/stderr');
					Le.open('/dev/stdin', 0), Le.open('/dev/stdout', 1), Le.open('/dev/stderr', 1);
				},
				ensureErrnoError: () => {
					Le.ErrnoError ||
						((Le.ErrnoError = function (e, r) {
							(this.node = r),
						...
						(Le.ErrnoError.prototype = new Error()),
						(Le.ErrnoError.prototype.constructor = Le.ErrnoError),
						[44].forEach((e) => {
							(Le.genericErrors[e] = new Le.ErrnoError(e)),
								(Le.genericErrors[e].stack = '<generic error, no stack>');
						}));
				},
				staticInit: () => {
					Le.ensureErrnoError(),
						...
						(Le.filesystems = { MEMFS: Ce, IDBFS: Ae });
				},
				init: (e, t, n) => {
					(Le.init.initialized = !0),
						Le.ensureErrnoError(),
						(r.stdin = e || r.stdin),
						(r.stdout = t || r.stdout),
						(r.stderr = n || r.stderr),
				...
				analyzePath: (e, r) => {
					try {
						e = (n = Le.lookupPath(e, { follow: !r })).path;
					} catch (e) {}
					var t = {
						isRoot: !1,
						exists: !1,
					...
					try {
						...
						(t.parentExists = !0),
							...
							(t.name = we.basename(e)),
							(n = Le.lookupPath(e, { follow: !r })),
							(t.exists = !0),
							(t.path = n.path),
							(t.object = n.node),
							(t.name = n.node.name),
						...
						'string' == typeof t
							? (function (e, r, t, n) {
									...
									a(
										e,
										function (t) {
											k(t, 'Loading data file "' + e + '" failed (no arrayBuffer).'),
												r(new Uint8Array(t)),
												o && te();
										},
										function (r) {
					...
					(o.onupgradeneeded = t),
						(o.onsuccess = () => {
							...
							e.forEach((e) => {
								var r = i.get(e);
								(r.onsuccess = () => {
									Le.analyzePath(e).exists && Le.unlink(e),
										Le.createDataFile(we.dirname(e), we.basename(e), r.result, !0, !0, !0),
										++u + s == c && f();
								}),
									(r.onerror = () => {
										s++, u + s == c && f();
			...
			Be = {
				...
				doStat: function (e, r, t) {
					...
					return (
						...
						(P[(t + 48) >> 2] = 4096),
						(P[(t + 52) >> 2] = n.blocks),
						(P[(t + 56) >> 2] = (n.atime.getTime() / 1e3) | 0),
						(P[(t + 60) >> 2] = 0),
						(P[(t + 64) >> 2] = (n.mtime.getTime() / 1e3) | 0),
						(P[(t + 68) >> 2] = 0),
						(P[(t + 72) >> 2] = (n.ctime.getTime() / 1e3) | 0),
						(P[(t + 76) >> 2] = 0),
						(ue = [
							n.ino >>> 0,
							((ie = n.ino),
				...
				doMkdir: function (e, r) {
					return (
						'/' === (e = we.normalize(e))[e.length - 1] && (e = e.substr(0, e.length - 1)),
						Le.mkdir(e, r, 0),
						0
					);
				},
		...
		function _e(e, r) {
			if (((Ie.mainLoop.timingMode = e), (Ie.mainLoop.timingValue = r), !Ie.mainLoop.func))
				return 1;
			if ((Ie.mainLoop.running || (Ie.mainLoop.running = !0), 0 == e))
		...
		function Pe(e, r, t, n, o) {
			...
			function i() {
				return (
					!(a < Ie.mainLoop.currentlyRunningMainloop) ||
					((function () {
						if (!$())
							try {
								De(x);
			...
			if (
				((Ie.mainLoop.running = !1),
				(Ie.mainLoop.runner = function () {
					if (!E)
						if (Ie.mainLoop.queue.length > 0) {
							...
							if ((t.func(t.arg), Ie.mainLoop.remainingBlockers)) {
								...
								t.counted
									? (Ie.mainLoop.remainingBlockers = o)
									: ((o += 0.5), (Ie.mainLoop.remainingBlockers = (8 * n + o) / 9));
							}
							if (
								(m('main loop blocker "' + t.name + '" took ' + (Date.now() - r) + ' ms'),
								Ie.mainLoop.updateStatus(),
								!i())
							)
								return;
							...
							i() &&
								((Ie.mainLoop.currentFrameNumber = (Ie.mainLoop.currentFrameNumber + 1) | 0),
								1 == Ie.mainLoop.timingMode &&
								Ie.mainLoop.timingValue > 1 &&
								Ie.mainLoop.currentFrameNumber % Ie.mainLoop.timingValue != 0
									? Ie.mainLoop.scheduler()
									: (0 == Ie.mainLoop.timingMode && (Ie.mainLoop.tickStartTime = Se()),
									  Oe.newRenderingFrameStarted(),
									  Ie.mainLoop.runIter(e),
									  i() &&
											('object' == typeof SDL &&
												SDL.audio &&
				...
				o || (r && r > 0 ? _e(0, 1e3 / r) : _e(1, 1), Ie.mainLoop.scheduler()),
				t)
			)
				throw 'unwind';
		}
		...
		var Ie = {
				mainLoop: {
					...
					resume: function () {
						...
						var e = Ie.mainLoop.timingMode,
							...
							t = Ie.mainLoop.func;
						(Ie.mainLoop.func = null),
							Pe(t, 0, !1, Ie.mainLoop.arg, !0),
							_e(e, r),
							Ie.mainLoop.scheduler();
					},
					...
					runIter: function (e) {
						if (!E) {
							if (r.preMainLoop) if (!1 === r.preMainLoop()) return;
				...
				init: function () {
					if ((r.preloadPlugins || (r.preloadPlugins = []), !Ie.initted)) {
						...
						try {
							...
							(Ie.hasBlobConstructor = !1),
								m('warning: no blob constructor, cannot create blobs with mimetypes');
						}
						(Ie.BlobBuilder =
							'undefined' != typeof MozBlobBuilder
								...
								? WebKitBlobBuilder
								: Ie.hasBlobConstructor
								? null
								: m('warning: no BlobBuilder')),
							(Ie.URLObject =
						...
						var e = {
							...
							handle: function (e, t, n, o) {
								var a = null;
								if (Ie.hasBlobConstructor)
									try {
										(a = new Blob([e], { type: Ie.getMimetype(t) })).size !== e.length &&
											(a = new Blob([new Uint8Array(e).buffer], { type: Ie.getMimetype(t) }));
									} catch (e) {
										v(
								...
								(s.onload = () => {
									...
									(o.width = s.width),
										...
										(r.preloadedImages[t] = o),
										Ie.URLObject.revokeObjectURL(u),
										n && n(e);
								}),
									(s.onerror = (e) => {
						...
						var t = {
							...
							handle: function (e, t, n, o) {
								...
								try {
									var s = new Blob([e], { type: Ie.getMimetype(t) });
								} catch (e) {
									return u();
								}
				...
				createContext: function (e, t, n, o) {
					...
					return a
						? (n &&
								...
								(r.ctx = a),
								t && Oe.makeContextCurrent(i),
								(r.useWebGL = t),
								Ie.moduleContextCreatedCallbacks.forEach(function (e) {
									e();
								}),
								Ie.init()),
						  a)
				...
				requestFullscreen: function (e, t) {
					(Ie.lockPointer = e),
						(Ie.resizeCanvas = t),
						void 0 === Ie.lockPointer && (Ie.lockPointer = !0),
						void 0 === Ie.resizeCanvas && (Ie.resizeCanvas = !1);
					var n = r.canvas;
					function o() {
						Ie.isFullscreen = !1;
						var e = n.parentNode;
						(document.fullscreenElement ||
							...
							? ((n.exitFullscreen = Ie.exitFullscreen),
							  Ie.lockPointer && n.requestPointerLock(),
							  (Ie.isFullscreen = !0),
							  Ie.resizeCanvas ? Ie.setFullscreenCanvasSize() : Ie.updateCanvasDimensions(n))
							: (e.parentNode.insertBefore(n, e),
							  e.parentNode.removeChild(e),
							  Ie.resizeCanvas ? Ie.setWindowedCanvasSize() : Ie.updateCanvasDimensions(n)),
							r.onFullScreen && r.onFullScreen(Ie.isFullscreen),
							r.onFullscreen && r.onFullscreen(Ie.isFullscreen);
					}
					Ie.fullscreenHandlersInstalled ||
						((Ie.fullscreenHandlersInstalled = !0),
				...
				fakeRequestAnimationFrame: function (e) {
					...
					else for (; r + 2 >= Ie.nextRAF; ) Ie.nextRAF += 1e3 / 60;
					var t = Math.max(Ie.nextRAF - r, 0);
					setTimeout(e, t);
				},
				requestAnimationFrame: function (e) {
					'function' != typeof requestAnimationFrame
						? (0, Ie.fakeRequestAnimationFrame)(e)
				...
				calculateMouseEvent: function (e) {
					if (Ie.pointerLock)
						'mousemove' != e.type && 'mozMovementX' in e
							? (Ie.mouseMovementX = Ie.mouseMovementY = 0)
							: ((Ie.mouseMovementX = Ie.getMovementX(e)),
							  (Ie.mouseMovementY = Ie.getMovementY(e))),
							'undefined' != typeof SDL
								? ((Ie.mouseX = SDL.mouseX + Ie.mouseMovementX),
								  (Ie.mouseY = SDL.mouseY + Ie.mouseMovementY))
								: ((Ie.mouseX += Ie.mouseMovementX), (Ie.mouseY += Ie.mouseMovementY));
					else {
						...
						if ('touchstart' === e.type || 'touchend' === e.type || 'touchmove' === e.type) {
							...
							var s = u.pageX - (a + t.left),
								c = u.pageY - (i + t.top),
								f = { x: (s *= n / t.width), y: (c *= o / t.height) };
							if ('touchstart' === e.type)
								(Ie.lastTouches[u.identifier] = f), (Ie.touches[u.identifier] = f);
						...
						(d *= n / t.width),
							(m *= o / t.height),
							(Ie.mouseMovementX = d - Ie.mouseX),
							(Ie.mouseMovementY = m - Ie.mouseY),
							(Ie.mouseX = d),
							(Ie.mouseY = m);
					}
				},
				...
				updateCanvasDimensions: function (e, t, n) {
					...
					if (
						(r.forcedAspectRatio &&
							r.forcedAspectRatio > 0 &&
							(o / a < r.forcedAspectRatio
								? (o = Math.round(a * r.forcedAspectRatio))
								: (a = Math.round(o / r.forcedAspectRatio))),
						(document.fullscreenElement ||
							document.mozFullScreenElement ||
							document.msFullscreenElement ||
							document.webkitFullscreenElement ||
			...
			Re = {
				...
				scheduleSourceAudio: function (e, r) {
					if (
						(1 !== Ie.mainLoop.timingMode || 'visible' == document.visibilityState) &&
						4114 === e.state
					) {
						for (
							var t = Re.updateSourceTime(e),
								n = e.bufStartTime,
								o = e.bufOffset,
								a = e.bufsProcessed,
								i = 0;
							i < e.audioQueue.length;
							i++
						) {
							(n = (f = e.audioQueue[i])._startTime + f._duration),
								(o = 0),
								(a += f._skipCount + 1);
						}
						...
						for (var u = t + r, s = 0; n < u; ) {
							...
							if (0 === c.length) {
								...
								var f;
								((f = e.context.audioCtx.createBufferSource()).buffer = c.audioBuf),
									(f.playbackRate.value = e.playbackRate),
									(c.audioBuf._loopStart || c.audioBuf._loopEnd) &&
										((f.loopStart = c.audioBuf._loopStart), (f.loopEnd = c.audioBuf._loopEnd));
								var l = 0;
								4136 === e.type && e.looping
									? ((l = Number.POSITIVE_INFINITY),
									  (f.loop = !0),
									  c.audioBuf._loopStart && (f.loopStart = c.audioBuf._loopStart),
									  c.audioBuf._loopEnd && (f.loopEnd = c.audioBuf._loopEnd))
									: (l = (c.audioBuf.duration - o) / e.playbackRate),
									(f._startOffset = o),
									(f._duration = l),
									(f._skipCount = s),
									(s = 0),
									f.connect(e.gain),
									void 0 !== f.start
										? ((n = Math.max(n, e.context.audioCtx.currentTime)), f.start(n, o))
										: void 0 !== f.noteOn &&
										  ((n = Math.max(n, e.context.audioCtx.currentTime)), f.noteOn(n)),
									(f._startTime = n),
									e.audioQueue.push(f),
									(n += l);
							}
				...
				updateSourceTime: function (e) {
					...
					isFinite(e.bufStartTime) ||
						((e.bufStartTime = r - e.bufOffset / e.playbackRate), (e.bufOffset = 0));
					...
					if (e.bufsProcessed >= e.bufQueue.length && !e.looping) Re.setSourceState(e, 4116);
						...
						if (0 === (c = e.bufQueue[0]).length) e.bufOffset = 0;
							...
							i <= a && (i = c.audioBuf.duration),
								(e.bufOffset = o < i ? o : a + ((o - a) % (i - a)));
						}
				...
				setSourceState: function (e, r) {
					4114 === r
						? ((4114 !== e.state && 4116 != e.state) || ((e.bufsProcessed = 0), (e.bufOffset = 0)),
						  Re.stopSourceAudio(e),
						  (e.state = 4114),
						  (e.bufStartTime = Number.NEGATIVE_INFINITY),
						  Re.scheduleSourceAudio(e))
						: 4115 === r
						? 4114 === e.state && (Re.updateSourceTime(e), Re.stopSourceAudio(e), (e.state = 4115))
						: 4116 === r
						? 4113 !== e.state &&
						  ((e.state = 4116),
						  (e.bufsProcessed = e.bufQueue.length),
					...
					if (4144 !== e.type) {
						...
						if (1 === e.spatialize || (2 === e.spatialize && 1 === r.channels)) {
							...
							(e.panner = e.context.audioCtx.createPanner()),
								Re.updateSourceGlobal(e),
								Re.updateSourceSpace(e),
				...
				updateSourceGlobal: function (e) {
					...
					if (r)
						switch (
							...
							e.context.sourceDistanceModel ? e.distanceModel : e.context.distanceModel)
						) {
							case 0:
				...
				updateListenerSpace: function (e) {
					...
					e.sources))
						Re.updateSourceSpace(e.sources[t]);
				},
					...
					if (e.panner) {
						...
						if (e.relative) {
							...
							var w = (g *= y = b(v, g, h)) * p - (h *= y) * m,
								...
								C = i,
								S = u;
							(a = k * (w *= y = b(w, x, E)) + C * (v = m * (E *= y) - p * (x *= y)) + S * d),
								(i = k * x + C * (g = p * w - d * E) + S * m),
								(u = k * E + C * (h = d * x - m * w) + S * p),
								(t = (k = t) * w + (C = n) * v + (S = o) * d),
								(n = k * x + C * g + S * m),
								(o = k * E + C * h + S * p),
								(t += c),
						...
						r.positionX
							? (t != r.positionX.value && (r.positionX.value = t),
							  n != r.positionY.value && (r.positionY.value = n),
							  o != r.positionZ.value && (r.positionZ.value = o))
							: r.setPosition(t, n, o),
							r.orientationX
								? (a != r.orientationX.value && (r.orientationX.value = a),
								  i != r.orientationY.value && (r.orientationY.value = i),
								  u != r.orientationZ.value && (r.orientationZ.value = u))
								: r.setOrientation(a, i, u);
					...
					if (4114 === e.state) {
						...
						(r =
							4136 === e.type && e.looping
								...
								: (t.buffer.duration - t._startOffset) / e.playbackRate),
							(t._duration = r),
				...
				sourceTell: function (e) {
					Re.updateSourceTime(e);
					for (var r = 0, t = 0; t < e.bufsProcessed; t++)
						e.bufQueue[t].audioBuf && (r += e.bufQueue[t].audioBuf.duration);
					return (r += e.bufOffset);
				},
				sourceSeek: function (e, r) {
					var t = 4114 == e.state;
					if ((t && Re.setSourceState(e, 4113), null !== e.bufQueue[e.bufsProcessed].audioBuf)) {
						for (e.bufsProcessed = 0; r > e.bufQueue[e.bufsProcessed].audioBuf.duration; )
							(r -= e.bufQueue[e.bufsProcessed].audiobuf.duration), e.bufsProcessed++;
						e.bufOffset = r;
					}
							...
							switch (r) {
								case 4100:
									...
									(n.position[0] = t[0]),
										(n.position[1] = t[1]),
										(n.position[2] = t[2]),
										Re.updateListenerSpace(Re.currentCtx);
									break;
								case 4102:
									if (!Number.isFinite(t[0]) || !Number.isFinite(t[1]) || !Number.isFinite(t[2]))
										return void (Re.currentCtx.err = 40963);
							...
							if (null !== n)
								switch (t) {
									case 8196:
										...
										break;
									case 8213:
										if (n[0] < 0 || n[0] > o.length || n[1] < 0 || n[1] > o.Length || n[0] >= n[1])
											return void (Re.currentCtx.err = 40963);
										if (o.refCount > 0) return void (Re.currentCtx.err = 40964);
										o.audioBuf &&
											((o.audioBuf._loopStart = n[0] / o.frequency),
											(o.audioBuf._loopEnd = n[1] / o.frequency));
										break;
									default:
										return void (Re.currentCtx.err = 40962);
								}
				...
				getSourceParam: function (e, r, t) {
					...
					switch (t) {
						...
						case 4118:
							return (1 === n.bufQueue.length && 0 === n.bufQueue[0].id) || n.looping
								? 0
								: n.bufsProcessed;
						case 4128:
						...
						case 4134:
							...
							return (
								(o = Re.sourceTell(n)) > 0 &&
									(o *= n.bufQueue[0].frequency * n.bufQueue[0].bytesPerSample),
								o
							);
						case 4135:
							return n.type;
						case 4628:
							return n.spatialize;
						case 8201:
							for (var a = 0, i = 0, u = 0; u < n.bufQueue.length; u++)
								(a += n.bufQueue[u].length),
									0 !== n.bufQueue[u].id &&
										(i = n.bufQueue[u].bytesPerSample * n.bufQueue[u].channels);
							return a * i;
						case 8202:
								...
								switch (t) {
									...
									case 4103:
										if (1 === n) {
											if (
												((o.looping = !0),
												Re.updateSourceTime(o),
												4136 === o.type && o.audioQueue.length > 0)
											)
												((a = o.audioQueue[0]).loop = !0), (a._duration = Number.POSITIVE_INFINITY);
										} else {
											if (0 !== n) return void (Re.currentCtx.err = 40963);
											o.looping = !1;
											var a,
												i = Re.updateSourceTime(o);
											4136 === o.type &&
												o.audioQueue.length > 0 &&
												(((a = o.audioQueue[0]).loop = !1),
												(a._duration = o.bufQueue[0].audioBuf.duration / o.playbackRate),
												(a._startTime = i - o.bufOffset / o.playbackRate));
										}
										break;
									case 4105:
										if (4114 === o.state || 4115 === o.state)
											return void (Re.currentCtx.err = 40964);
										if (0 === n) {
											for (var u = 0; u < o.bufQueue.length; u++) o.bufQueue[u].refCount--;
											(o.bufQueue.length = 1),
												(o.bufQueue[0] = Re.buffers[0]),
												(o.bufsProcessed = 0),
												(o.type = 4144);
										} else {
									...
									case 4106:
										...
										break;
									case 4109:
										if (!Number.isFinite(n) || n < 0 || n > Math.min(o.maxGain, 1))
											return void (Re.currentCtx.err = 40963);
										o.minGain = n;
										break;
									case 4110:
										if (!Number.isFinite(n) || n < Math.max(0, o.minGain) || n > 1)
											return void (Re.currentCtx.err = 40963);
										o.maxGain = n;
										break;
									case 4128:
									...
									case 53248:
										switch (n) {
											...
											case 53254:
												(o.distanceModel = n),
													Re.currentCtx.sourceDistanceModel &&
														Re.updateContextGlobal(Re.currentCtx);
												break;
											default:
												return void (Re.currentCtx.err = 40963);
										}
		...
		var Ne = {
			...
			chooseConfig: function (e, r, t, n, o) {
				...
				return (t && n) || o
					? (o && (P[o >> 2] = 1), t && n > 0 && (P[t >> 2] = 62002), Ne.setErrorCode(12288), 1)
					: (Ne.setErrorCode(12300), 0);
			}
		};
		var Oe = {
			counter: 1,
			...
			generateTempBuffers: function (e, r) {
				...
				for (var n = 0; n <= t; ++n) {
					(r.tempIndexBuffers[n] = null),
						(r.tempVertexBufferCounters1[n] = r.tempVertexBufferCounters2[n] = 0);
				...
				if (e) {
					(r.tempQuadIndexBuffer = qr.createBuffer()),
						r.GLctx.bindBuffer(34963, r.tempQuadIndexBuffer);
					for (
						var s = Oe.MAX_TEMP_BUFFER_SIZE >> 1, c = new Uint16Array(s), f = ((n = 0), 0);
						!((c[n++] = f),
						n >= s ||
							((c[n++] = f + 1), n >= s) ||
							((c[n++] = f + 2), n >= s) ||
			...
			getTempVertexBuffer: function (e) {
				...
				Oe.currentContext.tempVertexBufferCounters1[r] =
					(Oe.currentContext.tempVertexBufferCounters1[r] + 1) &
					(Oe.numTempVertexBuffersPerSize - 1);
				var o = t[n];
				if (o) return o;
				var a = qr.getParameter(34964);
				return (
					(t[n] = qr.createBuffer()),
					qr.bindBuffer(34962, t[n]),
					qr.bufferData(34962, 1 << r, 35048),
					qr.bindBuffer(34962, a),
					t[n]
				);
			},
			getTempIndexBuffer: function (e) {
				...
				return (
					(Oe.currentContext.tempIndexBuffers[r] = qr.createBuffer()),
					qr.bindBuffer(34963, Oe.currentContext.tempIndexBuffers[r]),
					qr.bufferData(34963, 1 << r, 35048),
					qr.bindBuffer(34963, n),
					Oe.currentContext.tempIndexBuffers[r]
				);
			},
			newRenderingFrameStarted: function () {
				if (Oe.currentContext) {
					var e = Oe.currentContext.tempVertexBuffers1;
					(Oe.currentContext.tempVertexBuffers1 = Oe.currentContext.tempVertexBuffers2),
						(Oe.currentContext.tempVertexBuffers2 = e),
						(e = Oe.currentContext.tempVertexBufferCounters1),
						(Oe.currentContext.tempVertexBufferCounters1 =
							Oe.currentContext.tempVertexBufferCounters2),
						(Oe.currentContext.tempVertexBufferCounters2 = e);
					for (var r = Oe.log2ceilLookup(Oe.MAX_TEMP_BUFFER_SIZE), t = 0; t <= r; ++t)
						Oe.currentContext.tempVertexBufferCounters1[t] = 0;
				}
			},
			...
			preDrawHandleClientVertexAttribBindings: function (e) {
				...
				for (var r = 0; r < Oe.currentContext.maxVertexAttribs; ++r) {
					...
					if (t.clientside && t.enabled) {
						...
						qr.bindBuffer(34962, o),
							qr.bufferSubData(34962, 0, B.subarray(t.ptr, t.ptr + n)),
							t.vertexAttribPointerAdaptor.call(qr, r, t.size, t.type, t.normalized, t.stride, 0);
					}
				}
			},
			...
			registerContext: function (e, r) {
				var t = Oe.getNewId(Oe.contexts),
					n = { handle: t, attributes: r, version: r.majorVersion, GLctx: e };
				e.canvas && (e.canvas.GLctxObject = n),
					(Oe.contexts[t] = n),
					(void 0 === r.enableExtensionsByDefault || r.enableExtensionsByDefault) &&
						Oe.initExtensions(n),
			...
			makeContextCurrent: function (e) {
				return (
					(Oe.currentContext = Oe.contexts[e]),
					(r.ctx = qr = Oe.currentContext && Oe.currentContext.GLctx),
					!(e && !qr)
				);
			},
			...
			deleteContext: function (e) {
				Oe.currentContext === Oe.contexts[e] && (Oe.currentContext = null),
					'object' == typeof ze && ze.removeAllHandlersOnTarget(Oe.contexts[e].GLctx.canvas),
					Oe.contexts[e] &&
						Oe.contexts[e].GLctx.canvas &&
						(Oe.contexts[e].GLctx.canvas.GLctxObject = void 0),
					(Oe.contexts[e] = null);
			},
			initExtensions: function (e) {
				if ((e || (e = Oe.currentContext), !e.initExtensionsDone)) {
					...
					!(function (e) {
						...
						((r = t).dibvbi = r.getExtension('WEBGL_draw_instanced_base_vertex_base_instance')),
						(function (e) {
							e.mdibvbi = e.getExtension('WEBGL_multi_draw_instanced_base_vertex_base_instance');
						})(t),
						e.version >= 2 &&
							(t.disjointTimerQueryExt = t.getExtension('EXT_disjoint_timer_query_webgl2')),
		...
		var ze = {
				...
				registerRemoveEventListeners: function () {
					ze.removeEventListenersRegistered ||
						(W.push(ze.removeAllEventListeners), (ze.removeEventListenersRegistered = !0));
				},
				deferredCalls: [],
				deferCall: function (e, r, t) {
					...
					ze.deferredCalls.push({ targetFunction: e, precedence: r, argsList: t }),
						ze.deferredCalls.sort(function (e, r) {
							return e.precedence < r.precedence;
						});
				},
				removeDeferredCalls: function (e) {
					for (var r = 0; r < ze.deferredCalls.length; ++r)
						ze.deferredCalls[r].targetFunction == e && (ze.deferredCalls.splice(r, 1), --r);
				},
				...
				removeAllHandlersOnTarget: function (e, r) {
					for (var t = 0; t < ze.eventHandlers.length; ++t)
						ze.eventHandlers[t].target != e ||
							(r && r != ze.eventHandlers[t].eventTypeString) ||
							ze._removeHandler(t--);
				},
				_removeHandler: function (e) {
					var r = ze.eventHandlers[e];
					r.target.removeEventListener(r.eventTypeString, r.eventListenerFunc, r.useCapture),
						ze.eventHandlers.splice(e, 1);
				},
				registerOrRemoveHandler: function (e) {
					var r = function (r) {
						++ze.inEventHandler,
							(ze.currentEventHandler = e),
							ze.runDeferredCalls(),
							e.handlerFunc(r),
							ze.runDeferredCalls(),
							--ze.inEventHandler;
					...
					if (e.callbackfunc)
						(e.eventListenerFunc = r),
							...
							ze.eventHandlers.push(e),
							ze.registerRemoveEventListeners();
					else
						for (var t = 0; t < ze.eventHandlers.length; ++t)
							ze.eventHandlers[t].target == e.target &&
								ze.eventHandlers[t].eventTypeString == e.eventTypeString &&
								ze._removeHandler(t--);
				},
			...
			var t = (function (e) {
					...
					function w() {
						document.fullscreenElement ||
							...
							document.removeEventListener('webkitfullscreenchange', w),
							We(e, t, n),
							(e.style.width = o),
							(e.style.height = a),
							...
							(e.style.paddingTop = f),
							(e.style.paddingBottom = l),
							...
							(e.style.imageRendering = y),
							e.GLctxObject && e.GLctxObject.GLctx.viewport(0, 0, t, n),
							je.canvasResizedCallback &&
								ve(je.canvasResizedCallback)(37, 0, je.canvasResizedCallbackUserData));
					}
					return (
		...
		function Ze(e, r) {
			if (((0 == r.scaleMode && 0 == r.canvasResolutionScaleMode) || $e(e, r), e.requestFullscreen))
				e.requestFullscreen();
			else {
			...
			return (
				...
				r.canvasResizedCallback &&
					ve(r.canvasResizedCallback)(37, 0, r.canvasResizedCallbackUserData),
				0
			);
		}
		function Je(e) {
			if (e.requestPointerLock) e.requestPointerLock();
				...
				if (!e.msRequestPointerLock)
					return document.body.requestPointerLock || document.body.msRequestPointerLock ? -3 : -1;
		...
		function er(e) {
			...
			U(o, e + 8, 128),
				U(a, e + 136, 128),
				(P[(e + 264) >> 2] = n ? n.clientWidth : 0),
				(P[(e + 268) >> 2] = n ? n.clientHeight : 0),
				(P[(e + 272) >> 2] = screen.width),
				(P[(e + 276) >> 2] = screen.height),
				t && (ze.previousFullscreenElement = r);
		}
		function rr(e, r) {
			I[e >> 3] = r.timestamp;
			for (var t = 0; t < r.axes.length; ++t) I[(e + 8 * t + 16) >> 3] = r.axes[t];
			for (t = 0; t < r.buttons.length; ++t)
				'object' == typeof r.buttons[t]
					? (I[(e + 8 * t + 528) >> 3] = r.buttons[t].value)
					: (I[(e + 8 * t + 528) >> 3] = r.buttons[t]);
			for (t = 0; t < r.buttons.length; ++t)
				'object' == typeof r.buttons[t]
					? (P[(e + 4 * t + 1040) >> 2] = r.buttons[t].pressed)
					: (P[(e + 4 * t + 1040) >> 2] = 1 == r.buttons[t]);
			(P[(e + 1296) >> 2] = r.connected),
				(P[(e + 1300) >> 2] = r.index),
				(P[(e + 8) >> 2] = r.axes.length),
				(P[(e + 12) >> 2] = r.buttons.length),
				U(r.id, e + 1304, 64),
				U(r.mapping, e + 1368, 64);
		}
		function tr() {
			return 2147483648;
		}
		...
		function ar(e, r, t, n) {
			...
			if (!qr.currentElementArrayBufferBinding) {
				...
				(o = Oe.getTempIndexBuffer(a)),
					qr.bindBuffer(34963, o),
					qr.bufferSubData(34963, 0, B.subarray(n, n + a)),
					(n = 0);
			}
			Oe.preDrawHandleClientVertexAttribBindings(r),
				qr.drawElements(e, r, t, n),
				Oe.postDrawHandleClientVertexAttribBindings(r),
				qr.currentElementArrayBufferBinding || qr.bindBuffer(34963, null);
		}
		function ir(e, r, t, n) {
			for (var o = 0; o < e; o++) {
				var a = qr[t](),
		...
		function pr(e) {
			...
			if (!n)
				for (
					e.uniformLocsById = n = {}, e.uniformArrayNamesById = {}, r = 0;
					r < qr.getProgramParameter(e, 35718);
					++r
				) {
					...
					for (e.uniformIdCounter += u, o[c] = [u, f], t = 0; t < u; ++t)
						(n[f] = t), (e.uniformArrayNamesById[f++] = c);
				}
		}
		function vr(e) {
				...
				return (
					'number' == typeof t &&
						(r.uniformLocsById[e] = t =
							qr.getUniformLocation(r, r.uniformArrayNamesById[e] + (t > 0 ? '[' + t + ']' : ''))),
					t
				);
			}
			Oe.recordError(1282);
		...
		function hr(e, r, t, n) {
			if (t) {
				Oe.currentContext.clientBuffers[e].enabled &&
					p('glGetVertexAttrib*v on client-side array: not supported, bad data returned');
		...
		function Sr(e) {
			...
			for (var o in e) {
				...
				n || (t += ', '),
					(n = !1),
					(t += 'number' == typeof a || 'string' == typeof a ? a : '(' + typeof a + ')');
			}
			t += ')';
				...
				(r +=
					...
					(function (e) {
						var r = be(),
							...
							o = r.indexOf('\n', Math.max(t, n)) + 1;
						(r = r.slice(o)),
							32 & e && v('EM_LOG_DEMANGLE is deprecated; ignoring'),
							8 & e &&
								...
								(e |= 16));
						var a = null;
						if (128 & e) for (a = Sr(arguments); a[1].includes('_emscripten_'); ) a = Sr(a[0]);
						var i = r.split('\n');
						r = '';
						...
						for (var f in i) {
							...
							var b = !1;
							if (8 & e) {
								var y = emscripten_source_map.originalPositionFor({ line: p, column: g });
								(b = y && y.source) &&
									(64 & e &&
										(y.source = y.source.substring(
											y.source.replace(/\\/g, '/').lastIndexOf('/') + 1
										)),
									(r += '    at ' + d + ' (' + y.source + ':' + y.line + ':' + y.column + ')\n'));
							}
							(16 & e || !b) &&
								(64 & e && (m = m.substring(m.replace(/\\/g, '/').lastIndexOf('/') + 1)),
								(r += (b ? '     = ' + d : '    at ' + d) + ' (' + m + ':' + p + ':' + g + ')\n')),
								128 & e &&
									a[0] &&
									(a[1] == d &&
										a[2].length > 0 &&
										((r = r.replace(/\s+$/, '')), (r += ' with values: ' + a[1] + a[2] + '\n')),
									(a = Sr(a[0])));
						}
						return r.replace(/\s+$/, '');
					})(e))),
		...
		function Rr(e, r, t, n, o, a, i) {
			...
			var u = {
				...
				callbackfunc: n,
				handlerFunc: function (t) {
					for (var a, i = {}, u = t.touches, s = 0; s < u.length; ++s)
						((a = u[s]).isChanged = a.onTarget = 0), (i[a.identifier] = a);
					for (s = 0; s < t.changedTouches.length; ++s)
						((a = t.changedTouches[s]).isChanged = 1), (i[a.identifier] = a);
					for (s = 0; s < t.targetTouches.length; ++s)
						i[t.targetTouches[s].identifier].onTarget = 1;
					var c = ze.touchEvent;
					I[c >> 3] = t.timeStamp;
					var f = c >> 2;
					(P[f + 3] = t.ctrlKey),
					...
					for (var s in i)
						if (
							...
							(P[f + 7] = a.isChanged),
							(P[f + 8] = a.onTarget),
							(P[f + 9] = a.clientX - l.left),
							(P[f + 10] = a.clientY - l.top),
							(f += 13),
							++d > 31)
						)
							break;
		...
		function Mr(e, r, t, n, o, a, i) {
			...
			var u = {
				...
				handlerFunc: function (e) {
					...
					(t = u),
						(a = ['hidden', 'visible', 'prerender', 'unloaded'].indexOf(document.visibilityState)),
						(P[t >> 2] = document.hidden),
						(P[(t + 4) >> 2] = a),
						ve(n)(o, u, r) && i.preventDefault();
				},
				useCapture: t
			};
			ze.registerOrRemoveHandler(u);
		...
		var Nr = {
			...
			staticInit: function () {
				Nr.openDatabase(
					...
					('undefined' != typeof ENVIRONMENT_IS_FETCH_WORKER && ENVIRONMENT_IS_FETCH_WORKER) ||
						re();
			}
		};
		function Or(e, r, t, n, o) {
			...
			if (a) {
				...
				(k.onload = (n) => {
					...
					Nr.setu64(e + 24, 0),
						o && Nr.setu64(e + 32, o),
						(D[(e + 40) >> 1] = k.readyState),
						(D[(e + 42) >> 1] = k.status),
						k.statusText && U(k.statusText, e + 44, 64),
						k.status >= 200 && k.status < 300 ? r && r(e, k, n) : t && t(e, k, n);
				}),
					(k.onerror = (r) => {
						I(b);
						var n = k.status;
						Nr.setu64(e + 24, 0),
							Nr.setu64(e + 32, k.response ? k.response.byteLength : 0),
							(D[(e + 40) >> 1] = k.readyState),
							(D[(e + 42) >> 1] = n),
							t && t(e, k, r);
					}),
					...
					(k.onprogress = (r) => {
						var t = b && y && k.response ? k.response.byteLength : 0,
							o = 0;
						b && y && ((o = et(t)), B.set(new Uint8Array(k.response), o)),
							(F[(e + 12) >> 2] = o),
							Nr.setu64(e + 16, t),
							Nr.setu64(e + 24, r.loaded - t),
							Nr.setu64(e + 32, r.total),
							(D[(e + 40) >> 1] = k.readyState),
							k.readyState >= 3 && 0 === k.status && r.loaded > 0 && (k.status = 200),
							(D[(e + 42) >> 1] = k.status),
							k.statusText && U(k.statusText, e + 44, 64),
							n && n(e, k, r),
							o && Jr(o);
					...
					(k.onreadystatechange = (r) => {
						(D[(e + 40) >> 1] = k.readyState),
							k.readyState >= 2 && (D[(e + 42) >> 1] = k.status),
							o && o(e, k, r);
					});
				try {
					k.send(T);
			...
			function I(r) {
				var t = 0,
					n = 0;
				r &&
					((n = k.response ? k.response.byteLength : 0),
					(t = et(n)),
					B.set(new Uint8Array(k.response), t)),
					(F[(e + 12) >> 2] = t),
					Nr.setu64(e + 16, n);
			}
		}
		...
		Object.defineProperties(Gr.prototype, {
			...
			(Le.FSNode = Gr),
			Le.staticInit(),
			(r.FS_createPath = Le.createPath),
			(r.FS_createDataFile = Le.createDataFile),
			(r.FS_createPreloadedFile = Le.createPreloadedFile),
			(r.FS_createLazyFile = Le.createLazyFile),
			(r.FS_createDevice = Le.createDevice),
			(r.FS_unlink = Le.unlink),
			(r.requestFullscreen = function (e, r) {
		...
		var Kr,
			$r = {
				...
				kc: function (e, r, t, n) {
					try {
						...
						var o = 256 & n,
							a = 4096 & n;
						return (
							(n &= -4353), (r = Be.calculateAt(e, r, a)), Be.doStat(o ? Le.lstat : Le.stat, r, t)
						);
					} catch (e) {
						if (void 0 === Le || !(e instanceof Le.ErrnoError)) throw e;
						return -e.errno;
				...
				qc: function (e, r) {
					...
					(P[r >> 2] = t.getUTCSeconds()),
						(P[(r + 4) >> 2] = t.getUTCMinutes()),
						(P[(r + 8) >> 2] = t.getUTCHours()),
						(P[(r + 12) >> 2] = t.getUTCDate()),
						(P[(r + 16) >> 2] = t.getUTCMonth()),
						(P[(r + 20) >> 2] = t.getUTCFullYear() - 1900),
						(P[(r + 24) >> 2] = t.getUTCDay());
				...
				rc: function (e, r) {
					var t = new Date(1e3 * P[e >> 2]);
					(P[r >> 2] = t.getSeconds()),
						(P[(r + 4) >> 2] = t.getMinutes()),
						(P[(r + 8) >> 2] = t.getHours()),
						(P[(r + 12) >> 2] = t.getDate()),
						(P[(r + 16) >> 2] = t.getMonth()),
						(P[(r + 20) >> 2] = t.getFullYear() - 1900),
						(P[(r + 24) >> 2] = t.getDay());
								...
								try {
									switch (r) {
										case 4352:
											if (n > 0)
												for (
													var u = (i = Re.currentCtx.audioCtx.createBuffer(1, n, o)).getChannelData(
															0
														),
														s = 0;
													s < n;
										...
										case 4353:
											if (n > 0) {
												u = (i = Re.currentCtx.audioCtx.createBuffer(1, n >> 1, o)).getChannelData(
													0
												);
												t >>= 1;
										...
										case 4354:
											if (n > 0) {
												u = (i = Re.currentCtx.audioCtx.createBuffer(2, n >> 1, o)).getChannelData(
													0
												);
												var c = i.getChannelData(1);
												for (s = 0; s < n >> 1; ++s)
													(u[s] = 0.0078125 * B[t++] - 1), (c[s] = 0.0078125 * B[t++] - 1);
											}
											(a.bytesPerSample = 1), (a.channels = 2), (a.length = n >> 1);
											break;
										case 4355:
											if (n > 0) {
												(u = (i = Re.currentCtx.audioCtx.createBuffer(2, n >> 2, o)).getChannelData(
													0
												)),
													(c = i.getChannelData(1));
												t >>= 1;
												for (s = 0; s < n >> 2; ++s)
													(u[s] = 30517578125e-15 * _[t++]), (c[s] = 30517578125e-15 * _[t++]);
											}
											(a.bytesPerSample = 2), (a.channels = 2), (a.length = n >> 2);
											break;
										case 65552:
											if (n > 0) {
												u = (i = Re.currentCtx.audioCtx.createBuffer(1, n >> 2, o)).getChannelData(
													0
												);
												t >>= 2;
										...
										case 65553:
											if (n > 0) {
												(u = (i = Re.currentCtx.audioCtx.createBuffer(2, n >> 3, o)).getChannelData(
													0
												)),
													(c = i.getChannelData(1));
												t >>= 2;
				...
				_b: function (e, r) {
					if (Re.currentCtx) {
						...
						for (t = 0; t < e; ++t) {
							var n;
							0 !== (n = P[(r + 4 * t) >> 2]) &&
								(Re.deviceRefCounts[Re.buffers[n].deviceId]--,
								delete Re.buffers[n],
								Re.freeIds.push(n));
						}
					}
				...
				$b: function (e, r) {
					if (Re.currentCtx) {
						...
						for (t = 0; t < e; ++t) {
							n = P[(r + 4 * t) >> 2];
							Re.setSourceState(Re.currentCtx.sources[n], 4116),
								Me(n, 4105, 0),
								delete Re.currentCtx.sources[n],
								Re.freeIds.push(n);
						}
					}
				},
					...
					switch (r) {
						...
						case 4102:
							(Re.paramArray[0] = t),
								(Re.paramArray[1] = n),
								(Re.paramArray[2] = o),
								Re.setSourceParam('alSource3i', e, r, Re.paramArray);
							break;
						default:
						...
						if (n)
							if (4136 !== n.type) {
								if (0 !== r) {
									...
									for (a = 0; a < r; ++a) {
										...
										0 === o.id ||
											(u.frequency === o.frequency &&
												u.bytesPerSample === o.bytesPerSample &&
												u.channels === o.channels) ||
											(Re.currentCtx.err = 40964);
									}
									1 === n.bufQueue.length && 0 === n.bufQueue[0].id && (n.bufQueue.length = 0),
										(n.type = 4137);
									for (a = 0; a < r; ++a) {
										var u;
										i = P[(t + 4 * a) >> 2];
									...
									n.looping && Re.cancelPendingSourceAudio(n),
										Re.initSourcePanner(n),
										Re.scheduleSourceAudio(n);
								}
				...
				Vb: function (e, r, t) {
					if (Re.currentCtx) {
						var n = Re.currentCtx.sources[e];
						if (n) {
							if (r > (1 === n.bufQueue.length && 0 === n.bufQueue[0].id ? 0 : n.bufsProcessed))
								Re.currentCtx.err = 40963;
							else if (0 !== r) {
								for (var o = 0; o < r; o++) {
									var a = n.bufQueue.shift();
									a.refCount--, (P[(t + 4 * o) >> 2] = a.id), n.bufsProcessed--;
								}
								0 === n.bufQueue.length && n.bufQueue.push(Re.buffers[0]),
									Re.initSourcePanner(n),
									Re.scheduleSourceAudio(n);
							}
						} else Re.currentCtx.err = 40961;
				...
				ac: Me,
				Xb: function (e) {
					return !(e in Re.deviceRefCounts) || Re.deviceRefCounts[e] > 0
						? 0
						: (delete Re.deviceRefCounts[e], Re.freeIds.push(e), 1);
				},
				vc: function (e, r) {
					...
					var t = null,
						...
						o = null;
					if ((r >>= 2))
						for (var a = 0, i = 0; (a = P[r++]), n.push(a), 0 !== a; )
							switch (((i = P[r++]), n.push(i), a)) {
								case 4103:
									t || (t = {}), (t.sampleRate = i);
									break;
								case 4112:
				...
				Zb: function (e) {
					var r = Re.contexts[e];
					Re.currentCtx !== r
						? (Re.contexts[e].interval && clearInterval(Re.contexts[e].interval),
						  Re.deviceRefCounts[r.deviceId]--,
						  delete Re.contexts[e],
						  Re.freeIds.push(e))
						: (Re.alcErr = 40962);
				},
				cb: function (e, r, t, n) {
					if (0 !== t && n)
						switch (r) {
							...
							case 4099:
								if (!(e in Re.deviceRefCounts)) return void (Re.alcErr = 40961);
								if (!Re.currentCtx) return void (Re.alcErr = 40962);
								for (var o = 0; o < Re.currentCtx.attrs.length; o++)
									P[(n + 4 * o) >> 2] = Re.currentCtx.attrs[o];
								break;
							case 4103:
								if (!(e in Re.deviceRefCounts)) return void (Re.alcErr = 40961);
								if (!Re.currentCtx) return void (Re.alcErr = 40962);
				...
				Th: function (e, t, n, o) {
					...
					return a < 2 || a > 3
						? (Ne.setErrorCode(12293), 0)
						: ((Ne.contextAttributes.majorVersion = a - 1),
						  (Ne.contextAttributes.minorVersion = 0),
						  (Ne.context = Oe.createContext(r.canvas, Ne.contextAttributes)),
						  0 != Ne.context
								? (Ne.setErrorCode(12288),
								  Oe.makeContextCurrent(Ne.context),
								  (r.useWebGL = !0),
								  Ie.moduleContextCreatedCallbacks.forEach(function (e) {
										e();
								  }),
								  Oe.makeContextCurrent(null),
								  62004)
								: (Ne.setErrorCode(12297), 0));
				},
				Vh: function (e, r, t, n) {
					return 62e3 != e
						? (Ne.setErrorCode(12296), 0)
						: 62002 != r
						? (Ne.setErrorCode(12293), 0)
						: (Ne.setErrorCode(12288), 62006);
				},
				Uh: function (e, r) {
					return 62e3 != e
						? (Ne.setErrorCode(12296), 0)
						: 62004 != r
						? (Ne.setErrorCode(12294), 0)
						: (Oe.deleteContext(Ne.context),
						  Ne.setErrorCode(12288),
						  Ne.currentContext == r && (Ne.currentContext = 0),
						  1);
				},
				Wh: function (e, r) {
					return 62e3 != e
						? (Ne.setErrorCode(12296), 0)
						: 62006 != r
						? (Ne.setErrorCode(12301), 1)
						: (Ne.currentReadSurface == r && (Ne.currentReadSurface = 0),
						  Ne.currentDrawSurface == r && (Ne.currentDrawSurface = 0),
						  Ne.setErrorCode(12288),
						  1);
				},
				ei: function (e, r, t, n) {
				...
				bi: function (e, r, t) {
					return 62e3 == e
						? (r && (P[r >> 2] = 1),
						  t && (P[t >> 2] = 4),
						  (Ne.defaultDisplayInitialized = !0),
						  Ne.setErrorCode(12288),
						  1)
						: (Ne.setErrorCode(12296), 0);
				},
				Xh: function (e, r, t, n) {
					return 62e3 != e
						...
						? (Ne.setErrorCode(12301), 0)
						: (Oe.makeContextCurrent(n ? Ne.context : null),
						  (Ne.currentContext = n),
						  (Ne.currentDrawSurface = r),
						  (Ne.currentReadSurface = t),
						  Ne.setErrorCode(12288),
						  1);
				},
				Rh: function (e, r) {
				...
				Zh: function (e, r) {
					return 62e3 != e
						? (Ne.setErrorCode(12296), 0)
						: (0 == r ? _e(0, 0) : _e(1, r), Ne.setErrorCode(12288), 1);
				},
				ci: function (e) {
					return 62e3 != e
						? (Ne.setErrorCode(12296), 0)
						: ((Ne.currentContext = 0),
						  (Ne.currentReadSurface = 0),
						  (Ne.currentDrawSurface = 0),
						  (Ne.defaultDisplayInitialized = !1),
						  Ne.setErrorCode(12288),
						  1);
				},
				$h: function () {
				...
				vb: function (e, r) {
					return e < 0 || e >= ze.lastGamepadState.length
						? -5
						: ze.lastGamepadState[e]
						? (rr(r, ze.lastGamepadState[e]), 0)
						: -7;
				},
				hc: tr,
				Ga: Se,
				...
				mh: function (e, r) {
					34962 == e
						? (qr.currentArrayBufferBinding = r)
						: 34963 == e && (qr.currentElementArrayBufferBinding = r),
						35051 == e
							? (qr.currentPixelPackBufferBinding = r)
							: 35052 == e && (qr.currentPixelUnpackBufferBinding = r),
						qr.bindBuffer(e, Oe.buffers[r]);
				},
				Td: function (e, r, t) {
				...
				dh: function (e, r, t, n) {
					Oe.currentContext.version >= 2
						? t
							? qr.bufferData(e, B, n, t, r)
							: qr.bufferData(e, r, n)
						: qr.bufferData(e, t ? B.subarray(t, t + r) : r, n);
				},
				ch: function (e, r, t, n) {
					Oe.currentContext.version >= 2
						? qr.bufferSubData(e, r, B, n, t)
						: qr.bufferSubData(e, r, B.subarray(n, n + t));
				},
				bh: function (e) {
				...
				Wg: function (e, r, t, n, o, a, i, u) {
					Oe.currentContext.version >= 2
						? qr.currentPixelUnpackBufferBinding
							? qr.compressedTexImage2D(e, r, t, n, o, a, i, u)
							: qr.compressedTexImage2D(e, r, t, n, o, a, B, u, i)
						: qr.compressedTexImage2D(e, r, t, n, o, a, u ? B.subarray(u, u + i) : null);
				},
				te: function (e, r, t, n, o, a, i, u, s) {
					qr.currentPixelUnpackBufferBinding
						? qr.compressedTexImage3D(e, r, t, n, o, a, i, u, s)
						: qr.compressedTexImage3D(e, r, t, n, o, a, i, B, s, u);
				},
				Ug: function (e, r, t, n, o, a, i, u, s) {
					Oe.currentContext.version >= 2
						? qr.currentPixelUnpackBufferBinding
							? qr.compressedTexSubImage2D(e, r, t, n, o, a, i, u, s)
							: qr.compressedTexSubImage2D(e, r, t, n, o, a, i, B, s, u)
						: qr.compressedTexSubImage2D(e, r, t, n, o, a, i, s ? B.subarray(s, s + u) : null);
				},
				se: function (e, r, t, n, o, a, i, u, s, c, f) {
					qr.currentPixelUnpackBufferBinding
						? qr.compressedTexSubImage3D(e, r, t, n, o, a, i, u, s, c, f)
						: qr.compressedTexSubImage3D(e, r, t, n, o, a, i, u, s, B, f, c);
				},
				ud: function (e, r, t, n, o) {
				...
				Og: function (e, r) {
					for (var t = 0; t < e; t++) {
						...
						o &&
							...
							(o.name = 0),
							(Oe.buffers[n] = null),
							n == qr.currentArrayBufferBinding && (qr.currentArrayBufferBinding = 0),
							n == qr.currentElementArrayBufferBinding && (qr.currentElementArrayBufferBinding = 0),
							n == qr.currentPixelPackBufferBinding && (qr.currentPixelPackBufferBinding = 0),
							n == qr.currentPixelUnpackBufferBinding && (qr.currentPixelUnpackBufferBinding = 0));
					}
				},
				Ng: function (e, r) {
					for (var t = 0; t < e; ++t) {
				...
				Cg: function (e, r, t) {
					Oe.preDrawHandleClientVertexAttribBindings(r + t),
						qr.drawArrays(e, r, t),
						Oe.postDrawHandleClientVertexAttribBindings();
				},
				nd: function (e, r, t, n) {
				...
				qd: function (e, r, t, n) {
					if (n)
						if (((e = Oe.programs[e]), 35393 != t)) {
							...
							if (null !== o)
								if (35395 == t) for (var a = 0; a < o.length; a++) P[(n + 4 * a) >> 2] = o[a];
								else P[n >> 2] = o;
						} else {
				...
				fg: function (e, r, t, n) {
					...
					(o instanceof WebGLRenderbuffer || o instanceof WebGLTexture) && (o = 0 | o.name),
						(P[n >> 2] = o);
				},
				dd: function (e, r, t) {
					fr(e, r, t, 1);
				...
				Cc: function (e, r, t, n, o) {
					if (n < 0) Oe.recordError(1281);
						...
						if (null !== a) for (var i = 0; i < a.length && i < n; ++i) P[(o + 4 * i) >> 2] = a[i];
					} else Oe.recordError(1281);
				},
					...
					if (t)
						if (e >= Oe.counter) Oe.recordError(1281);
							...
							if (!e.maxUniformLength)
								for (var o = 0; o < qr.getProgramParameter(e, 35718); ++o)
									e.maxUniformLength = Math.max(
										e.maxUniformLength,
										qr.getActiveUniform(e, o).name.length + 1
									);
							P[t >> 2] = e.maxUniformLength;
						} else if (35722 == r) {
							if (!e.maxAttributeLength)
								for (o = 0; o < qr.getProgramParameter(e, 35721); ++o)
									e.maxAttributeLength = Math.max(
										e.maxAttributeLength,
										qr.getActiveAttrib(e, o).name.length + 1
									);
							P[t >> 2] = e.maxAttributeLength;
						} else if (35381 == r) {
							if (!e.maxUniformBlockNameLength)
								for (o = 0; o < qr.getProgramParameter(e, 35382); ++o)
									e.maxUniformBlockNameLength = Math.max(
										e.maxUniformBlockNameLength,
										qr.getActiveUniformBlockName(e, o).length + 1
									);
					...
					if (t) {
						...
						sr(
							...
							'boolean' ==
								typeof (n =
									Oe.currentContext.version < 2
										? qr.disjointTimerQueryExt.getQueryObjectEXT(o, r)
										: qr.getQueryParameter(o, r))
								? n
									? 1
									: 0
								: n
					...
					switch (e) {
						case 7939:
							...
							return (
								...
								(t = Oe.stringiCache[e] = n),
								r < 0 || r >= t.length ? (Oe.recordError(1281), 0) : t[r]
							);
						default:
				...
				Pf: function (e, r, t) {
					t
						? (Oe.currentContext.clientBuffers[e].enabled &&
						  ...
						  (P[t >> 2] = qr.getVertexAttribOffset(e, r)))
						: Oe.recordError(1281);
				},
				Rf: function (e, r, t) {
					hr(e, r, t, 2);
				...
				ef: function (e, r, t) {
					if (Oe.currentContext.version >= 2) qr.uniform1fv(vr(e), T, t >> 2, r);
						...
						if (r <= 288) for (var n = xr[r - 1], o = 0; o < r; ++o) n[o] = T[(t + 4 * o) >> 2];
				...
				cf: function (e, r, t) {
					if (Oe.currentContext.version >= 2) qr.uniform1iv(vr(e), P, t >> 2, r);
						...
						if (r <= 288) for (var n = Er[r - 1], o = 0; o < r; ++o) n[o] = P[(t + 4 * o) >> 2];
				...
				af: function (e, r, t) {
					if (Oe.currentContext.version >= 2) qr.uniform2fv(vr(e), T, t >> 2, 2 * r);
						...
						if (r <= 144)
							for (var n = xr[2 * r - 1], o = 0; o < 2 * r; o += 2)
								(n[o] = T[(t + 4 * o) >> 2]), (n[o + 1] = T[(t + (4 * o + 4)) >> 2]);
				...
				_e: function (e, r, t) {
					if (Oe.currentContext.version >= 2) qr.uniform2iv(vr(e), P, t >> 2, 2 * r);
						...
						if (r <= 144)
							for (var n = Er[2 * r - 1], o = 0; o < 2 * r; o += 2)
								(n[o] = P[(t + 4 * o) >> 2]), (n[o + 1] = P[(t + (4 * o + 4)) >> 2]);
				...
				Ye: function (e, r, t) {
					if (Oe.currentContext.version >= 2) qr.uniform3fv(vr(e), T, t >> 2, 3 * r);
						...
						if (r <= 96)
							for (var n = xr[3 * r - 1], o = 0; o < 3 * r; o += 3)
								(n[o] = T[(t + 4 * o) >> 2]),
									(n[o + 1] = T[(t + (4 * o + 4)) >> 2]),
									(n[o + 2] = T[(t + (4 * o + 8)) >> 2]);
				...
				We: function (e, r, t) {
					if (Oe.currentContext.version >= 2) qr.uniform3iv(vr(e), P, t >> 2, 3 * r);
						...
						if (r <= 96)
							for (var n = Er[3 * r - 1], o = 0; o < 3 * r; o += 3)
								(n[o] = P[(t + 4 * o) >> 2]),
									(n[o + 1] = P[(t + (4 * o + 4)) >> 2]),
									(n[o + 2] = P[(t + (4 * o + 8)) >> 2]);
				...
				Se: function (e, r, t) {
					if (Oe.currentContext.version >= 2) qr.uniform4iv(vr(e), P, t >> 2, 4 * r);
						...
						if (r <= 72)
							for (var n = Er[4 * r - 1], o = 0; o < 4 * r; o += 4)
								(n[o] = P[(t + 4 * o) >> 2]),
									(n[o + 1] = P[(t + (4 * o + 4)) >> 2]),
									(n[o + 2] = P[(t + (4 * o + 8)) >> 2]),
									(n[o + 3] = P[(t + (4 * o + 12)) >> 2]);
				...
				Re: function (e, r, t, n) {
					if (Oe.currentContext.version >= 2) qr.uniformMatrix2fv(vr(e), !!t, T, n >> 2, 4 * r);
						...
						if (r <= 72)
							for (var o = xr[4 * r - 1], a = 0; a < 4 * r; a += 4)
								(o[a] = T[(n + 4 * a) >> 2]),
									(o[a + 1] = T[(n + (4 * a + 4)) >> 2]),
									(o[a + 2] = T[(n + (4 * a + 8)) >> 2]),
									(o[a + 3] = T[(n + (4 * a + 12)) >> 2]);
				...
				Qe: function (e, r, t, n) {
					if (Oe.currentContext.version >= 2) qr.uniformMatrix3fv(vr(e), !!t, T, n >> 2, 9 * r);
						...
						if (r <= 32)
							for (var o = xr[9 * r - 1], a = 0; a < 9 * r; a += 9)
								(o[a] = T[(n + 4 * a) >> 2]),
									(o[a + 1] = T[(n + (4 * a + 4)) >> 2]),
									(o[a + 2] = T[(n + (4 * a + 8)) >> 2]),
									(o[a + 3] = T[(n + (4 * a + 12)) >> 2]),
				...
				Ee: function (e, r, t, n, o, a) {
					...
					if (!qr.currentArrayBufferBinding)
						return (
							(i.size = r),
							(i.type = t),
							(i.normalized = n),
								...
								for (var a, i, u, s, c = []; ; ) {
									...
									if (((i = L[(t + 1) >> 0]), 37 == a)) {
										...
										if (42 == i) (g = o('i32')), t++, (i = L[(t + 1) >> 0]);
											...
											for (; i >= 48 && i <= 57; )
												(g = 10 * g + (i - 48)), t++, (i = L[(t + 1) >> 0]);
										var h,
											b = !1,
											y = -1;
										if (46 == i) {
											if (((y = 0), (b = !0), t++, 42 == (i = L[(t + 1) >> 0])))
												(y = o('i32')), t++;
											else
												for (;;) {
													var w = L[(t + 1) >> 0];
										...
										switch ((h && t++, (i = L[(t + 1) >> 0]), String.fromCharCode(i))) {
											...
											case 'p':
												...
												(u = o('i' + 8 * (h = h || 4))),
													8 == h &&
														(u =
															117 == i ? (u[0] >>> 0) + 4294967296 * (u[1] >>> 0) : nr(u[0], u[1])),
													h <= 4 && (u = (x ? kr : Cr)(u & (Math.pow(256, h) - 1), 8 * h));
												var E = Math.abs(u),
													k = '';
												if (100 == i || 105 == i) A = kr(u, 8 * h).toString(10);
													...
													if (((k = m && 0 != u ? '0x' : ''), u < 0)) {
														...
														for (var C = [], S = 0; S < A.length; S++)
															C.push((15 - parseInt(A[S], 16)).toString(16));
														for (A = C.join(''); A.length < 2 * h; ) A = 'f' + A;
													} else A = E.toString(16);
													88 == i && ((k = k.toUpperCase()), (A = A.toUpperCase()));
												} else
													112 == i &&
														(0 === E ? (A = '(nil)') : ((k = '0x'), (A = E.toString(16))));
												if (b) for (; A.length < y; ) A = '0' + A;
												for (
													u >= 0 && (l ? (k = '+' + k) : v && (k = ' ' + k)),
														'-' == A.charAt(0) && ((k = '-' + k), (A = A.substr(1)));
													k.length + A.length < g;
											...
											case 'G':
												...
												if (((u = o('double')), isNaN(u))) (A = 'nan'), (p = !1);
													...
													if (103 == i || 71 == i) {
														...
														y > F && F >= -4
															? ((i = (103 == i ? 'f' : 'F').charCodeAt(0)), (y -= F + 1))
															: ((i = (103 == i ? 'e' : 'E').charCodeAt(0)), y--),
															(D = Math.min(y, 20));
													}
													101 == i || 69 == i
														? ((A = u.toExponential(D)),
														  /[eE][-+]\d$/.test(A) && (A = A.slice(0, -1) + '0' + A.slice(-1)))
														: (102 != i && 70 != i) ||
														  ((A = u.toFixed(D)),
														  0 === u &&
																((s = u) < 0 || (0 === s && 1 / s == -1 / 0)) &&
													...
													if (_ && !m)
														for (
															...
															T[0].length > 1 &&
															T[0].includes('.') &&
															('0' == T[0].slice(-1) || '.' == T[0].slice(-1));

														)
															T[0] = T[0].slice(0, -1);
													else
														for (m && -1 == A.indexOf('.') && (T[0] += '.'); y > D++; ) T[0] += '0';
													(A = T[0] + (T.length > 1 ? 'e' + T[1] : '')),
														69 == i && (A = A.toUpperCase()),
														u >= 0 && (l ? (A = '+' + A) : v && (A = ' ' + A));
												} else (A = (u < 0 ? '-' : '') + 'inf'), (p = !1);
												for (; A.length < g; )
													d
											...
											case 's':
												...
												if ((b && (M = Math.min(M, y)), !d)) for (; M < g--; ) c.push(32);
												if (R) for (S = 0; S < M; S++) c.push(B[R++ >> 0]);
												else c = c.concat(Yr('(null)'.substr(0, M), !0));
												if (d) for (; M < g--; ) c.push(32);
												break;
											case 'c':
				...
				Mb: function (e, r, t) {
					return (function (e, r) {
						return ze.fullscreenEnabled()
							? (e = Ge(e))
								? e.requestFullscreen || e.webkitRequestFullscreen
									? ze.canPerformEventHandlerRequests()
										? Ze(e, r)
										: r.deferUntilInEventHandler
										? (ze.deferCall(Ze, 1, [e, r]), 1)
										: -2
									: -3
								: -4
							: -1;
				...
				gc: function (e) {
					...
					for (var a = 1; a <= 4; a *= 2) {
						...
						if (
							...
							Lr(Math.min(o, ((r = Math.max(e, i)) % (t = 65536) > 0 && (r += t - (r % t)), r))))
						)
							return !0;
					}
					return !1;
				...
				wb: function () {
					return (ze.lastGamepadState = navigator.getGamepads
				...
				oh: function (e) {
					if (((r.gid = N(e)), window.dataLayer))
						...
						(e.async = 1),
							(e.src = '//www.googletagmanager.com/gtag/js?id=' + r.gid),
							void e,
					...
					r.ga('config', r.gid, { send_page_view: !1 });
				},
				na: Xe,
				Ia: function (e, r, t) {
				...
				Ea: function (e, r, t, n, o) {
					return ze.fullscreenEnabled()
						? (e = Ge(e))
							? (_r(e, r, t, n, 19, 'fullscreenchange'),
							  _r(e, r, t, n, 19, 'webkitfullscreenchange'),
							  0)
							: -4
						: -1;
				},
				ub: function (e, r, t, n) {
					return navigator.getGamepads || navigator.webkitGetGamepads
						? (Dr(2, e, r, t, 26, 'gamepadconnected'), 0)
						: -1;
				},
				tb: function (e, r, t, n) {
					return navigator.getGamepads || navigator.webkitGetGamepads
						? (Dr(2, e, r, t, 27, 'gamepaddisconnected'), 0)
						: -1;
				},
				...
				mb: function (e, r, t, n, o) {
					return document &&
						...
						? (e = Ge(e))
							? (Ir(e, r, t, n, 20, 'pointerlockchange'),
							  Ir(e, r, t, n, 20, 'mozpointerlockchange'),
							  Ir(e, r, t, n, 20, 'webkitpointerlockchange'),
							  Ir(e, r, t, n, 20, 'mspointerlockchange'),
							  0)
							: -4
						: -1;
				},
								...
								handlerFunc: function (t) {
									...
									if (a.target == e) {
										...
										if (i) {
											var u = ze.uiEvent;
											(P[u >> 2] = a.detail),
												(P[(u + 4) >> 2] = i.clientWidth),
												(P[(u + 8) >> 2] = i.clientHeight),
												(P[(u + 12) >> 2] = innerWidth),
												(P[(u + 16) >> 2] = innerHeight),
												(P[(u + 20) >> 2] = outerWidth),
												(P[(u + 24) >> 2] = outerHeight),
												(P[(u + 28) >> 2] = pageXOffset),
												(P[(u + 32) >> 2] = pageYOffset),
												ve(n)(o, u, r) && a.preventDefault();
										}
									}
								},
								useCapture: t
								...
								var u = {
									...
									handlerFunc: function (t) {
										...
										Fr(i, a, e),
											...
											(I[(i + 80) >> 3] = a.deltaY),
											(I[(i + 88) >> 3] = a.deltaZ),
											(P[(i + 96) >> 2] = a.deltaMode),
											ve(n)(o, i, r) && a.preventDefault();
									},
									useCapture: t
								};
								ze.registerOrRemoveHandler(u);
				...
				Mf: function (e, t) {
					function n(e) {
						...
						return 'string' == r
							? `<string>${(function (e) {
									const r = { '&': '&amp;', '<': '&lt', '>': '&gt', '"': '&quot', "'": '&apos' },
										t = new RegExp(Object.keys(r).join('|'), 'g');
									return e.replace(t, (e) => r[e]);
							  })(e)}</string>`
							: 'undefined' == r
							? '<undefined/>'
							: 'number' == r
							...
							: e instanceof Array
							? (function (e) {
									for (var r = '<array>', t = 0; t < e.length; t++)
										r += `<property id="${t}">${n(e[t])}</property>`;
									return r + '</array>';
							  })(e)
							: 'object' == r
							? (function (e) {
					...
					let i =
						a &&
						a.hal &&
						'function' == typeof a.hal.external_transformExternalInterfaceCall &&
						a.hal.external_transformExternalInterfaceCall(o, t);
					if (i) {
						i = n(i);
						const e = z(i) + 1,
							r = et(e);
				...
				qf: function (e, t, n) {
					if (t && n > 0) {
						...
						a && a.length > 0
							? localStorage.setItem(o, JSON.stringify(Array.from(a)))
				...
				ld: function (e, t, n, o, a, i, u, s, c) {
					...
					(f.value = N(e)),
						...
						(f.style.left = '50%'),
						(f.style.width = '32px'),
						(f.wafSelectionStart = f.wafSelectionEnd = f.value ? f.value.length : 0);
					let l = !1,
						d = !1;
					const m = (e, r) => {
						ve(u)(c, 0, e, r);
					...
					window.requestAnimationFrame(function () {
						...
						f.addEventListener('input', function (e) {
							if ('insertCompositionText' != e.inputType || e.isComposing) {
								if (
									...
									m(f.wafSelectionStart, f.wafSelectionEnd + 1);
								else if ('deleteContentBackward' == e.inputType) {
									if (f.wafSelectionStart <= 0) return;
									m(f.wafSelectionStart - 1, f.wafSelectionEnd),
										(f.wafSelectionEnd = --f.wafSelectionStart);
								} else {
									const r = e.data || '';
									let t = f.wafSelectionStart,
										n = f.wafSelectionEnd;
									e.isComposing
										? (l ? ((f.wafSelectionEnd = ++f.wafSelectionStart), (l = !1)) : (t -= 1),
										  r || (f.wafSelectionEnd = --f.wafSelectionStart))
										: (f.wafSelectionEnd = ++f.wafSelectionStart),
										((e, r, t) => {
											const n = z(e) + 1,
												o = et(n);
						...
						f.addEventListener('keydown', (e) => {
							...
							const t = e.key,
								...
								a =
									...
									'/Home/End/ArrowUp/ArrowDown/ArrowLeft/ArrowRight/'.indexOf('/' + t + '/') >= 0;
						...
						f.addEventListener('compositionstart', (e) => {
							l = !0;
						}),
						f.addEventListener('compositionupdate', (e) => {}),
						f.addEventListener('compositionend', (e) => {}),
						!r.canvas.inputTextFocusHandler &&
							((r.canvas.inputTextFocusHandler = (e) => {
								r.canvas.wafActiveInputText &&
									window.requestAnimationFrame(function () {
										r.canvas.wafActiveInputText.focus();
									});
							}),
							r.canvas.addEventListener('focus', r.canvas.inputTextFocusHandler)),
						r.canvas.parentNode.appendChild(f),
						(r.canvas.wafActiveInputText = f);
				},
				oi: function () {
					'function' == typeof r.hideStatus && r.hideStatus();
				},
				Yb: function (e, t, n) {
					r.canvas.setAttribute('waf-content-width', e),
						r.canvas.setAttribute('waf-content-height', t),
						r.canvas.setAttribute('waf-content-fps', n),
						r.canvas.style.setProperty('--waf-content-width', e + 'px'),
						r.canvas.style.setProperty('--waf-content-height', t + 'px');
				},
				Wa: function (e) {
				...
				ad: function (e, t) {
					const n = N(e),
						...
						i =
							a &&
							a.hal &&
							'function' == typeof a.hal.url_transformNavigateUrl &&
							a.hal.url_transformNavigateUrl(n, o);
				...
				Rc: function (e) {
					const t = N(e),
						...
						o = n
							? n.hal &&
							  'function' == typeof n.hal.url_transformRequestUrl &&
							  n.hal.url_transformRequestUrl(t)
							: t;
					if (o) {
						const e = z(o) + 1,
							r = et(e);
			...
			Zr =
				((function () {
					...
					'function' != typeof fetch
						? a(o)
						: fetch(oe, { credentials: 'same-origin' }).then(function (r) {
		...
		(r.ccall = S),
			...
			(r.addRunDependency = re),
			(r.removeRunDependency = te),
			(r.FS_createPath = Le.createPath),
			(r.FS_createDataFile = Le.createDataFile),
			(r.FS_createPreloadedFile = Le.createPreloadedFile),
			(r.FS_createLazyFile = Le.createLazyFile),
		...
		function st(e) {
			function n() {
				Kr ||
					...
					E ||
						(!0,
						r.noFSInit || Le.init.initialized || Le.init(),
						(Le.ignorePermissions = !1),
						Ee.init(),
						de(V),
						de(X),
						t(r),
