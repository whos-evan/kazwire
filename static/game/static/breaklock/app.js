!(function (t) {
	...
	function (t, e, n) {
		...
		var i = {
			create: function (t) {
				...
				if (
					((e =
						-1 === i.SVG_ELEMENTS.indexOf(t)
							? document.createElement(t)
							: document.createElementNS(i.SVG_NAMESPACE, t)),
					n.constructor === String)
				)
					e.setAttribute('class', n);
				else for (var r in n) e.setAttribute(r, n[r]);
				if (a instanceof Array) for (var o = 0; o < a.length; o++) e.appendChild(a[o]);
			...
			icon: function (t) {
				var e = i.create('use');
				return (
					e.setAttributeNS(i.XLINK_NAMESPACE, 'href', '#icon-' + t),
					i.create('svg', { class: 'icon' }, [e])
				);
			},
			clear: function (t) {
	...
	function (t, e, n) {
		...
		var i = {
			GAME: {
				...
				TYPE: { PRACTICE: 1, CHALLENGE: 2, COUNTDOWN: 3 },
				ACTIONS: { CONTINUE: 1, NEW_GAME: 2, BACK_HOME: 3 }
			},
			SOCIAL: {
				PLATFORMS: {
					FB: {
					...
					TWITTER: {
						...
						URL: function (t, e, n) {
							return (
								'http://twitter.com/' +
								(t ? 'share?' : 'intent/tweet?') +
								(e ? 'text=' + encodeURI(e) + '&' : '') +
								(t ? 'url=' + encodeURI(t) + '&' : '') +
								(n ? 'hashtags=' + encodeURI(n.join(',')) : '')
							);
						}
					}
				},
			...
			COLORS: { BRIGHT: '#ffffff', DARK: '#14171b', SUCCESS: '#116699', ERROR: '#ff0000' },
			PATTERN: { HEX_COLOR_START: '66', HEX_COLOR_END: 'FF' }
		};
		e.default = i;
	},
	function (t, e, n) {
						...
						},
						{
							...
							value: function (t) {
								...
								if (
									...
									n >> 0 === n &&
									(e % 3) - (n % 3) == (n % 3) - (t % 3) &&
									Math.floor(e / 3) - Math.floor(n / 3) == Math.floor(n / 3) - Math.floor(t / 3)
								) {
									var i = this.addDot(n);
	...
	function (t, e, n) {
					...
					a(t, [
						...
						},
						{
							...
							value: function (t) {
								...
								for (var a = 1; a < t.suite.length; a++)
									i.push(
										o.default.create('line', {
								...
								return (
									...
									this.addGroup({ 'stroke-width': e, 'stroke-linecap': 'round' }, i)
								);
							}
						},
						{
						...
						},
						{
							...
							value: function (t, e, n) {
								...
								this.el.setAttribute(
									'viewBox',
									'0 0 ' + this.SVG_WIDTH + ' ' + (this.SVG_WIDTH + this.SVG_COMB_EXP)
								);
								for (var h = [], d = 0; d < i; d++)
									h.push(
										o.default.create('circle', {
		...
		(s.prototype.SVG_NAMESPACE = 'http://www.w3.org/2000/svg'),
			(s.prototype.SVG_WIDTH = 100),
			(s.prototype.SVG_COMB_EXP = 20),
			(s.prototype.SVG_MARGIN = 15),
			(s.prototype.GRID_GUTTER = 35),
			(s.prototype.DOT_BORDER = 2),
			(s.prototype.DOT_MAGNET = 6),
			(e.default = s);
	},
	function (t, e, n) {
		'use strict';
		...
		function a(t) {
			for (var e = c.length - 1; e >= 0; e--) if (c[e].el === t) return c.splice(e, 1)[0];
		}
		function r(t) {
		...
		function o(t) {
			if (((t.counter -= 1), t.counter <= 0))
				return (t.el.textContent = t.originalText), void a(t.el);
	...
	function (t, e, n) {
		...
		var C = (function () {
			function t(e) {
				a(this, t),
					(this.statusBar = new s.default(this.abort.bind(this))),
					(this.history = new l.default()),
					(this.lock = new h.default(this.newAttempt.bind(this))),
					(this.summary = new f.default(this.action.bind(this))),
					(this.pattern = null),
					(this.type = null),
					(this.isEnded = !1),
					(this.onEnd = e),
				...
				r(t, [
					{
						...
						value: function () {
							return (
								(this.el = T.default.create('div', 'game-layout view', [
									T.default.create('div', 'view-bloc game-layout-dashboard', [
										this.statusBar.el,
										T.default.create('div', 'history-wrap', [this.history.el])
									]),
									T.default.create('div', 'view-bloc game-layout-lock', [this.lock.el]),
									this.summary.el
								])),
								this.el
							);
					...
					},
					{
						...
						value: function (t, e) {
							switch (
								((this.type = t),
								(this.difficulty = e),
								this.lock.setDotLength(e),
								(this.pattern = new v.default(e)),
								this.pattern.fillRandomly(),
								this.history.clear('Connect ' + e + ' dots'),
								(this.count = 0),
								(this.isEnded = !1),
								t)
							) {
					...
					},
					{
						...
						value: function (t) {
							...
							if ((this.count++, this.isEnded)) this.statusBar.incrementCounter();
								...
								this.type === b.default.GAME.TYPE.COUNTDOWN && this.statusBar.stopCountdown(),
									(this.isEnded = n),
									this.summary.setContent(!0, this.count);
							else
								switch (this.type) {
									case b.default.GAME.TYPE.PRACTICE:
										...
										break;
									case b.default.GAME.TYPE.CHALLENGE:
										0 === this.statusBar.decrementCounter() &&
											((this.isEnded = !0), this.summary.setContent(!1, this.count));
								}
						...
						value: function (t) {
							t
								? ((this.isEnded = !0),
								  ...
								  this.summary.setContent(!1, this.count))
								: this.onEnd();
						}
					},
					{
						...
						value: function (t, e) {
							...
							n.addDots(1),
								n.addPattern(
									...
									14,
									w.default.greydient(
										b.default.PATTERN.HEX_COLOR_START,
										b.default.PATTERN.HEX_COLOR_END,
										t.dotLength - 3
									)
								),
								e && m.default.prototype.addCombinaison.apply(n, e);
							var i = n.getSVG();
				...
				r(t, [
					{
						...
						value: function () {
							...
							(this.title = t),
								(this.typeHelpEl = v.default.create('p', {}, 'Future info about the challenge')),
								(this.btnStarlEl = v.default.create('button', 'action-btn', 'START_')),
								(0, m.default)(t, 'BreakLock');
							var n = new s.default(
								'INSTRUCTIONS',
							...
							return (
								n.init(),
								(this.difficultyOption = new l.default([
									{ value: f.default.GAME.DIFFICULTY.EASY, label: 'Easy', default: !0 },
									{ value: f.default.GAME.DIFFICULTY.MEDIUM, label: 'Medium' },
									{ value: f.default.GAME.DIFFICULTY.HARD, label: 'Hard' }
								])),
								...
								(this.el = v.default.create('div', 'menu-layout view', [
									v.default.create('div', 'view-bloc menu-layout-instructions', [t, e, n.el]),
									v.default.create('div', 'view-bloc menu-layout-form', [
					...
					{
						key: 'triggerEasterEgg',
						value: function () {
							localStorage.getItem('isDeepBlack')
				...
				r(t, [
					{
						key: 'setupTemplate',
						value: function () {
							(this.counterEl = l.default.create('span', 'countdown-counter')),
								(this.barEl = l.default.create('span', 'countdown-content'));
					...
					},
					{
						...
						value: function () {
							(this.remaining = this.remaining > 0 ? this.remaining : 0),
								...
								(this.counterEl.textContent = (0, s.default)(this.remaining, 3)),
								(this.barEl.style.width = (this.remaining / this.duration) * 100 + '%'),
								0 == this.remaining && (this.stop(), this.endCallback && this.endCallback());
						}
					}
				]),
				t
				...
				a(t, [
					{
						...
						value: function () {
							...
							return (
								(this.buttonEl = o.default.create('button', 'extender-button', this.title)),
								(this.contentEl = o.default.create('div', 'extender-content', t)),
								(this.el = o.default.create('div', 'extender small-only', [
									this.buttonEl,
									this.contentEl
								])),
								this.render(),
				...
				a(t, [
					{
						...
						value: function () {
							return (
								(this.containerEl = o.default.create('div', 'history-container', '')),
								(this.el = o.default.create('div', 'history', [this.containerEl])),
								this.el
							);
						}
					},
					{
						...
						value: function (t) {
							this.lastPattern
								? this.containerEl.insertBefore(t, this.lastPattern)
					...
					},
					{
						...
						value: function () {
							...
							(this.el.scrollLeft = (Math.max(t / 4, 4), 0)),
					...
					},
					{
						...
						value: function (t) {
							(this.lastPattern = null),
								...
								(this.containerEl = o.default.create('div', {
				...
				r(t, [
					{
						...
						value: function () {
							var t = new l.default();
							return (
								t.addBackgroundLayer(),
								(this.el = t.getSVG()),
								this.el.setAttribute('class', 'lock'),
								(this.patternEl = t.addGroup({
									'stroke-width': '2',
									stroke: f.default.COLORS.BRIGHT,
									'stroke-linecap': 'round'
								})),
								(this.bigDotsEl = t.addDots(9, { class: 'lock-flashdots' })),
								t.addDots(2),
								this.el
							);
						}
						...
						value: function (t) {
							...
							var e = t.currentTarget.getBoundingClientRect(),
								n = Math.max(
									0,
									Math.min(
										l.default.prototype.SVG_WIDTH,
										Math.round((l.default.prototype.SVG_WIDTH / e.width) * (t.pageX - e.left))
									)
								),
								i = Math.max(
									0,
									Math.min(
										l.default.prototype.SVG_WIDTH,
										Math.round((l.default.prototype.SVG_WIDTH / e.height) * (t.pageY - e.top))
									)
								);
							...
							var e = t.currentTarget.getBoundingClientRect(),
								n = Math.max(
									...
									Math.min(
										l.default.prototype.SVG_WIDTH,
										Math.round(
											(l.default.prototype.SVG_WIDTH / e.width) *
												(t.targetTouches[0].pageX - e.left)
										)
									)
								),
								i = Math.max(
									...
									Math.min(
										l.default.prototype.SVG_WIDTH,
										Math.round(
											(l.default.prototype.SVG_WIDTH / e.height) *
												(t.targetTouches[0].pageY - e.top)
										)
									)
								);
							this.updatePoint(n, i);
						...
						value: function (t, e) {
							if (!this.isPendingReset) {
								for (var n = void 0, i = void 0, a = 0; a < 3; a++) {
									var r =
											l.default.prototype.GRID_GUTTER * a +
											l.default.prototype.SVG_MARGIN -
											l.default.prototype.DOT_MAGNET,
										o =
											l.default.prototype.GRID_GUTTER * a +
											l.default.prototype.SVG_MARGIN +
											l.default.prototype.DOT_MAGNET;
							...
							if (!this.pattern.gotDot(t)) {
								...
								navigator.vibrate && navigator.vibrate(20),
									n.forEach(function (t, i) {
										var a =
												l.default.prototype.GRID_GUTTER * (t % 3) + l.default.prototype.SVG_MARGIN,
											r =
												l.default.prototype.GRID_GUTTER * Math.floor(t / 3) +
												l.default.prototype.SVG_MARGIN;
										if (
											(e.closeLine(a, r),
											e.bigDotsEl.childNodes[t].classList.add('active'),
											i + 1 === n.length && e.pattern.isComplete())
										)
											return e.checkPattern();
										e.startLine(a, r);
									});
							}
						}
					},
					{
						...
						value: function () {
							...
							for (var e = this.patternEl.childNodes.length - 1; e >= 0; e--)
								this.patternEl.childNodes[e].remove();
					...
					},
					{
						...
						value: function () {
							...
							return (
								...
								this.patternEl.setAttribute(
									'stroke',
									t ? f.default.COLORS.SUCCESS : f.default.COLORS.ERROR
								),
								t
							);
						}
					},
					{
						key: 'startLine',
						value: function (t, e) {
							(this.currentLine = h.default.create('line', { x1: t, y1: e })),
					...
					},
					{
						...
						value: function (t, e) {
							this.currentLine &&
								(this.currentLine.setAttribute('x2', t), this.currentLine.setAttribute('y2', e));
						}
					},
					{
						key: 'closeLine',
			...
			return (
				a(t, [
						...
						value: function (t) {
							...
							t.forEach(function (t, i) {
								var a = o.default.create(
									'span',
									{ class: 'selectbox-item', rel: t.value },
									t.label
								);
								return (
					...
					},
					{
						key: 'selectFromTag',
						value: function (t) {
							this.selectedTag && this.selectedTag.classList.remove('active'),
								(this.selectedTag = t),
								this.selectedTag.classList.add('active'),
								(this.selectedValue = window.parseInt(t.getAttribute('rel'), 10));
						}
					},
					{
						key: 'getValue',
				...
				a(t, [
					{
						...
						value: function () {
							return (
								(this.btnLeft = o.default.create(
									'span',
									'selectbox-item active selector-left',
									'<'
								)),
								(this.btnRight = o.default.create(
									'span',
									'selectbox-item active selector-right',
									'>'
								)),
								(this.labelEl = o.default.create('span', 'selectbox-item selector-label')),
								(this.el = o.default.create('div', 'selector selectbox', [
									this.btnLeft,
									this.btnRight,
									this.labelEl
								])),
					...
					},
					{
						...
						value: function (t) {
							this.choices = t;
							for (var e = this.choices.length - 1; e >= 0; e--)
								this.selectionIndex = this.choices[e].default ? e : this.selectionIndex;
					...
					},
					{
						...
						value: function () {
							this.selectionIndex =
								(this.selectionIndex + this.choices.length) % this.choices.length;
							var t = this.choices[this.selectionIndex];
							return (
								(this.labelEl.textContent = t.label),
								this.selectCallback && this.selectCallback(this.choices[this.selectionIndex]),
								this.selectionIndex
							);
						}
					},
					{
						...
						value: function (t) {
							return (
								t.preventDefault(), t.stopPropagation(), this.selectionIndex++, this.updateLabel()
							);
						}
					},
					{
				...
				r(t, [
					{
						...
						value: function () {
							return (
								(this.cancelBtnEl = h.default.create('button', 'status-bar-cancel', 'ABORT')),
								(this.counterEl = h.default.create('span', 'status-bar-info')),
								(this.countdown = new s.default()),
								(this.countdownEl = this.countdown.el),
								this.countdownEl.setAttribute('class', 'status-bar-info'),
								(this.el = h.default.create('div', 'status-bar', [
									this.cancelBtnEl,
									this.counterEl,
									this.countdownEl
								])),
					...
					},
					{
						...
						value: function () {
							return (
								(this.counterEl.textContent = (0, l.default)(this.counterVal, 3)), this.counterVal
							);
						}
					},
					{
					...
					},
					{
						...
						value: function (t) {
							...
							(this.counterEl.style.display = 'none'),
								...
								this.countdown.setTimer(t, function () {
									e.cancelCallback(1);
								}),
			...
			return (
				r(t, [
						...
						value: function () {
							...
							for (var t in l.default.GAME.ACTIONS) {
								var e = f.default.create(
									'button',
									{ class: 'summary-action-button', rel: l.default.GAME.ACTIONS[t] },
							...
							var a = f.default.create('div', 'summary-feedback bloc', [
								f.default.create('p', {}, [
									f.default.create('span', {}, 'Tweet me your feedback at '),
									f.default.create(
										'a',
										{ href: l.default.SOCIAL.PLATFORMS.TWITTER.URL('', '@mxwllt', ['breaklock']) },
										'@mxwllt'
									)
								])
							]);
							return (
								(this.titleEl = f.default.create('h1', 'summary-title highlight')),
								(this.detailsEl = f.default.create('p', 'summary-details')),
								(this.revealEl = f.default.create(
									'p',
									'summary-reveal',
									'Continue to see the solution.'
								)),
								(this.actionsEl = f.default.create(
									'div',
									'summary-actions bloc',
									this.actionButtons
								)),
								(this.socialEl = f.default.create('div', 'summary-share bloc', this.socialButtons)),
								(this.el = f.default.create('div', 'summary view', [
									f.default.create('div', 'view-bloc', [
										this.titleEl,
										this.detailsEl,
										this.revealEl
									]),
									f.default.create('div', 'view-bloc', [this.actionsEl, this.socialEl, a])
								])),
								this.el
							);
						}
					...
					},
					{
						...
						value: function (t, e) {
							this.titleEl.classList.remove('fail'),
								...
								this.titleEl.classList.add(t ? 'success' : 'fail'),
								(0, v.default)(this.titleEl, t ? 'Success!' : 'Fail!'),
								(this.detailsEl.textContent = (0, s.default)(t, e)),
								this.revealEl.classList[t ? 'add' : 'remove']('hide'),
					...
					},
					{
						key: 'toggle',
						value: function (t) {
							(t = void 0 != t ? t : !this.el.classList.contains('active')),
								this.el.classList[t ? 'add' : 'remove']('active');
						}
					},
					{
						key: 'triggerAction',
					...
					},
					{
						...
						value: function () {
							this.socialButtons.forEach(function (t) {
								...
								t.setAttribute(
									'href',
									n.URL(l.default.URL, l.default.SOCIAL.MESSAGE, l.default.SOCIAL.TAGS)
								);
							});
						}
					}
		...
		function i(t, e) {
			...
			return (
				t
					...
					: ((n = "Sorry, you didn't make it this time. "), (i = r)),
				n + i[Math.floor(i.length * Math.random())]
			);
		}
		Object.defineProperty(e, '__esModule', { value: !0 });
		var a = [
	...
	function (t, e, n) {
		...
		var i = {
			greydient: function (t, e) {
				...
				(t = 'string' == typeof t ? parseInt(t, 16) : t),
					(e = 'string' == typeof e ? parseInt(e, 16) : e),
