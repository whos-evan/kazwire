!(function (t) {
		...
		t.exports = function (t, n) {
			...
			if ((e = p ? i : g ? i[f] || s(f, {}) : (i[f] || {}).prototype))
				for (u in n) {
					if (
						((A = n[u]),
						(l = t.noTargetGet ? (m = r(e, u)) && m.value : e[u]),
						!c(p ? u : f + (g ? '.' : '#') + u, t.forced) && void 0 !== l)
					) {
			...
			!(function (e, a) {
				if (e) {
					...
					(s.noConflict = function () {
							...
							function d(n, e, i, r, d) {
								if (o) s.computeStackTrace.augmentStackTraceWithInitialElement(o, e, i, n), c();
									...
									(A.func = s.computeStackTrace.guessFunctionName(A.url, A.line)),
										...
										a({ name: l, message: m, mode: 'onerror', stack: [A] }, !0, null);
								}
						...
						(s.computeStackTrace = (function () {
								...
								if (!A(e && e.document)) {
									for (
										var n,
											...
											s,
											c = [e.location.href],
											u = e.document.getElementsByTagName('script'),
											l = '' + t,
											m = 0;
										m < u.length;
										++m
									...
									if (
										...
										(n = o(r[3]).replace(/;$/, ';?')),
											(i = new RegExp(
												'function' + p + '\\s*\\(\\s*' + g + '\\s*\\)\\s*{\\s*' + n + '\\s*}'
											));
									} else i = new RegExp(o(l).replace(/\s+/g, '\\s+'));
									if ((s = d(i, c))) return s;
									if (
										(r = /^function on([\w$]+)\s*\(event\)\s*\{\s*(\S[\s\S]*\S)\s*\}\s*$/.exec(l))
									) {
										var h = r[1];
										if (
											((n = a(r[2])),
											(s = d(
												(i = new RegExp('on' + h + '=[\\\'"]\\s*' + n + '\\s*[\\\'"]', 'i')),
												c[0]
											)))
										)
											return s;
							...
							function m(t) {
								...
								for (
									...
									if ((e = a.exec(m[g]))) {
										...
										e[3] && e[3].indexOf(' > eval') > -1 && (n = u.exec(e[3]))
											? ((e[3] = n[1]), (e[4] = n[2]), (e[5] = null))
											: 0 !== g || e[5] || A(t.columnNumber) || (f[0].column = t.columnNumber + 1),
											(o = {
												url: e[3],
												func: e[1] || '?',
												args: e[2] ? e[2].split(',') : [],
									...
									!o.func && o.line && (o.func = i(o.url, o.line)),
										(o.context = o.line ? r(o.url, o.line) : null),
										f.push(o);
								}
								return f.length
									? (f[0] &&
											...
											!f[0].column &&
											p &&
											(f[0].column = c(p[1], f[0].url, f[0].line)),
									  { mode: 'stack', name: t.name, message: t.message, stack: f })
									: null;
							}
								...
								if (a.url && a.line) {
									...
									if (
										...
										if (!t.stack[0].line && t.stack[0].func === a.func)
											return (t.stack[0].line = a.line), (t.stack[0].context = a.context), !1;
									}
							...
							function p(t, n) {
								for (
									...
									if (m !== g && m !== s.report) {
										if (
											((r = { url: null, func: '?', args: [], line: null, column: null }),
											m.name ? (r.func = m.name) : (e = a.exec(m.toString())) && (r.func = e[1]),
											void 0 === r.func)
										)
											try {
										...
										(s = (function (t) {
											...
											if (n) {
												for (
													...
													if (
														((e = o.exec(s[c]))
															? (u = { url: e[2], line: +e[1], column: null, func: e[3], args: [] })
															: (e = a.exec(s[c])) &&
															  (u = {
																	url: e[6],
																	line: +e[1],
														...
														if ((!u.func && u.line && (u.func = i(u.url, u.line)), u.line))
															try {
												...
												return d.length
													? { mode: 'stacktrace', name: t.name, message: t.message, stack: d }
													: null;
											}
										})(t))
									)
									...
									if (
										(s = (function (t) {
											...
											for (var h = 2; h < o.length; h += 2) {
												var w = null;
												if ((s = c.exec(o[h])))
													w = { url: s[2], func: s[3], args: [], line: +s[1], column: null };
											...
											return m.length
												? { mode: 'multiline', name: t.name, message: o[0], stack: m }
												: null;
										})(t))
									)
										return s;
							...
							return (
								(g.augmentStackTraceWithInitialElement = f),
								(g.computeStackTraceFromStackProp = m),
								(g.guessFunctionName = i),
								(g.gatherContext = r),
								(g.ofCaller = function (t) {
									t = 1 + (null == t ? 0 : +t);
									try {
										throw new Error();
									} catch (n) {
							...
							var t = function (t) {
								...
								e[t] = function () {
									var t = c.call(arguments),
										e = t[0];
									return (
										'function' == typeof e && (t[0] = s.wrap(e)),
										n.apply ? n.apply(this, t) : n(t[0], t[1])
									);
								};
							};
						...
						(r = []),
						void 0 === (o = 'function' == typeof (i = s) ? i.apply(n, r) : i) || (t.exports = o);
				}
	...
	function (t, n, e) {
		...
		(t.exports = function (t, n, e, s) {
			var d = !!s && !!s.unsafe,
				...
				A = !!s && !!s.noTargetGet;
			'function' == typeof e &&
				('string' != typeof n || o(e, 'name') || r(e, 'name', n),
				(u(e).source = l.join('string' == typeof n ? n : ''))),
				t !== i
					? (d ? !A && t[n] && (c = !0) : delete t[n], c ? (t[n] = e) : r(t, n, e))
					: c
					? (t[n] = e)
					: a(n, e);
		...
		(s[l] = !0),
			(t.exports =
				...
				function (t, n) {
					...
					return (
						null !== t
							? ((A.prototype = r(t)), (e = new A()), (A.prototype = null), (e[l] = t))
							: (e = f()),
						void 0 === n ? e : o(e, n)
					);
				});
		...
		t.exports = function (t, n, e, u, m, w, y) {
			...
			if (
				(I &&
					...
					f !== Object.prototype &&
						v.next &&
						(l || o(v) === f || (a ? a(v, f) : 'function' != typeof v[g] && d(v, g, h)),
						s(v, E, !0, !0),
						l && (A[E] = h))),
				'values' == m &&
					z &&
	...
	function (t, n, e) {
		...
		var i,
			...
			A = !1;
		[].keys &&
			('next' in (o = [].keys()) ? (r = a(a(o))) !== Object.prototype && (i = r) : (A = !0)),
			null == i && (i = {}),
			u ||
				d(i, l) ||
				s(i, l, function () {
			...
			(t.exports = { IteratorPrototype: i, BUGGY_SAFARI_ITERATORS: A });
	},
	function (t, n, e) {
		var i = e(10);
	...
	function (t, n, e) {
		...
		(f && p) ||
			...
			'process' == d(g)
				...
				: h && !A
				? ((o = (r = new h()).port2), (r.port1.onmessage = S), (i = c(o.postMessage, o, 1)))
				: !a.addEventListener ||
				...
				: ((i = E), a.addEventListener('message', S, !1))),
						...
						c = a(function () {
							...
							s(t, function (t) {
								...
								o.push(void 0),
									...
									e.call(n, t).then(
										function (t) {
											s || ((s = !0), (o[r] = { status: 'fulfilled', value: t }), --d || i(o));
										},
										function (t) {
											s || ((s = !0), (o[r] = { status: 'rejected', reason: t }), --d || i(o));
										}
									);
							}),
								--d || i(o);
	...
	function (t) {
		t.exports = JSON.parse('{"a":"https://example.com/prebid/prebid4.12.0.js"}');
	},
	,
	function (t, n, e) {
		e(70);
		...
		var i = e(20),
			...
			a = function (t) {
				return function (n, e, a) {
					...
					} else for (; c > u; u++) if ((t || u in d) && d[u] === e) return t || u || 0;
					return !t && -1;
				};
			};
			...
			r(function () {
				...
				? function (t, n) {
						for (var e = d(t), r = arguments.length, u = 1, l = a.f, A = s.f; r > u; )
							for (
								var m, f = c(arguments[u++]), p = l ? o(f).concat(l(f)) : o(f), g = p.length, h = 0;
								g > h;

							)
								(m = p[h++]), (i && !A.call(f, m)) || (e[m] = f[m]);
						return e;
				  }
				: u;
	},
	...
	function (t, n, e) {
		...
		o(
			...
			function () {
				...
				return r >= e.length
					? { value: void 0, done: !0 }
					: ((t = i(e, r)), (n.index += t.length), { value: t, done: !1 });
			}
		);
	},
	function (t, n, e) {
				...
				return function (n, e) {
					...
					return d < 0 || d >= c
						? t
							? ''
							: void 0
						: (o = s.charCodeAt(d)) < 55296 ||
						  o > 56319 ||
						  d + 1 === c ||
						  (a = s.charCodeAt(d + 1)) < 56320 ||
						  a > 57343
						? t
							? s.charAt(d)
							: o
	...
	function (t, n, e) {
		...
		t.exports = function (t, n, e) {
			var c = n + ' Iterator';
			return (t.prototype = r(i, { next: o(1, e) })), a(t, c, !1, !0), (s[c] = d), t;
		};
	},
	function (t, n, e) {
		var i = e(2);
	...
	function (t, n, e) {
		...
		(t.exports = s(
			...
			'Array',
			function (t, n) {
				d(this, { type: 'Array Iterator', target: i(t), index: 0, kind: n });
			},
			function () {
				var t = c(this),
					n = t.target,
	...
	function (t, n, e) {
		...
		var i,
				...
				if (!n.notified) {
					...
					x(function () {
						for (var r = n.value, o = 1 == n.state, a = 0; i.length > a; ) {
							...
							try {
								l
									? (o || (2 === n.rejection && nt(t, n), (n.rejection = 1)),
									  !0 === l ? (s = r) : (f && f.enter(), (s = l(r)), f && (f.exit(), (c = !0))),
									  s === u.promise
			...
			Y = function (t, n, e) {
				var i, r;
				W
					? (((i = N.createEvent('Event')).promise = n),
					  (i.reason = e),
					  i.initEvent(t, !1, !0),
					  c.dispatchEvent(i))
					...
					(r = c['on' + t])
						? r(i)
						: 'unhandledrejection' === t && z('Unhandled promise rejection', e);
			},
			$ = function (t, n) {
				E.call(c, function () {
					var e,
			...
			((i = function (t) {
				...
				then: function (t, n) {
					...
					return (
						...
						(i.domain = H ? F.domain : void 0),
						(e.parent = !0),
						e.reactions.push(i),
						0 != e.state && J(this, e, !1),
						i.promise
					);
				},
				catch: function (t) {
	...
	function (t, n, e) {
		...
		var i = e(5),
			...
			p = function (t, n) {
				...
				return (
					u(t, i.push, i),
					r ? m(e, { errors: i, type: 'AggregateError' }) : (e.errors = i),
			...
			function y() {
				return (
					...
					(this._initBody = function (t) {
						if (((this._bodyInit = t), t))
							if ('string' == typeof t) this._bodyText = t;
								...
								if (!o || (!ArrayBuffer.prototype.isPrototypeOf(t) && !d(t)))
					...
					(this.text = function () {
						...
						if (i) return i;
						if (this._bodyBlob)
							return (t = this._bodyBlob), (n = new FileReader()), (e = g(n)), n.readAsText(t), e;
						if (this._bodyArrayBuffer)
							return Promise.resolve(
								(function (t) {
									for (var n = new Uint8Array(t), e = new Array(n.length), i = 0; i < n.length; i++)
				...
				(function (t) {
					...
					if ('Element' in t) {
						var n = t.Element.prototype,
							...
							s = function (t) {
								for (
									var n = i.call(t.getAttribute('class') || ''),
										e = n ? n.split(/\s+/) : [],
										r = 0,
										o = e.length;
									r < o;
	...
	function (t, n, e) {
		...
		var s,
			...
			A = {
				...
				ads: {
					...
					busy: 'pokiAdsBusy',
					position: { preroll: 'PP', midroll: 'PM', rewarded: 'PR', display: 'DP' },
					video: {
				...
				return (
					...
					(t.removeEventListener = function (t, n) {
						if (Object.prototype.hasOwnProperty.call(this.listeners, t)) {
							var e = this.listeners[t].indexOf(n);
							-1 !== e && this.listeners[t].splice(e, 1);
						}
					}),
					...
					(t.dispatchEvent = function (t, n) {
						void 0 === n && (n = {}),
							!this.debug ||
								(window.process && window.process.env && 'test' === window.process.env.NODE_ENV) ||
								console.info(t, n);
						for (var e = Object.keys(this.listeners), i = 0; i < e.length; i++) {
							var r = e[i];
							if (t === r)
								for (var o = this.listeners[r], a = 0; a < o.length; a++)
									o[a](m(m({}, this.dataAnnotations), n));
						}
					}),
			...
			y = (function () {
				...
				return (
					...
					(t.track = function (t, n) {
						if ((void 0 === n && (n = {}), -1 === w.indexOf(t)))
							throw new TypeError("Invalid 'event', must be one of " + w.join(', '));
					...
					(t.setupDefaultEvents = function () {
						var n,
							e =
								(((n = {})[A.ready] = A.tracking.sdk.status.initialized),
								(n[A.adblocked] = A.tracking.sdk.status.failed),
								(n[A.ads.busy] = A.tracking.ads.status.busy),
								(n[A.ads.completed] = A.tracking.ads.status.completed),
								(n[A.ads.error] = A.tracking.ads.status.error),
								(n[A.ads.displayError] = A.tracking.ads.status.displayError),
								(n[A.ads.impression] = A.tracking.ads.status.impression),
								(n[A.ads.limit] = A.tracking.ads.status.limit),
								(n[A.ads.ready] = A.tracking.ads.status.ready),
								(n[A.ads.requested] = A.tracking.ads.status.requested),
								(n[A.ads.prebidRequested] = A.tracking.ads.status.prebidRequested),
								(n[A.ads.skipped] = A.tracking.ads.status.skipped),
								(n[A.ads.started] = A.tracking.ads.status.started),
								(n[A.ads.video.clicked] = A.tracking.ads.video.clicked),
								(n[A.ads.video.error] = A.tracking.ads.video.error),
								(n[A.ads.video.loaderError] = A.tracking.ads.video.loaderError),
								(n[A.ads.video.buffering] = A.tracking.ads.status.buffering),
								(n[A.tracking.screen.gameplayStart] = A.tracking.screen.gameplayStart),
								(n[A.tracking.screen.gameplayStop] = A.tracking.screen.gameplayStop),
								(n[A.tracking.screen.loadingProgress] = A.tracking.screen.loadingProgress),
								(n[A.tracking.screen.commercialBreak] = A.tracking.screen.commercialBreak),
								(n[A.tracking.screen.rewardedBreak] = A.tracking.screen.rewardedBreak),
								(n[A.tracking.screen.happyTime] = A.tracking.screen.happyTime),
								(n[A.tracking.screen.sendHighscore] = A.tracking.screen.sendHighscore),
								(n[A.tracking.screen.getLeaderboard] = A.tracking.screen.getLeaderboard),
								n);
			...
			b = (function () {
				function t(t) {
					void 0 === t && (t = {}),
						...
						f.addEventListener(A.ads.requested, this.startTimeBetweenAdsTimer.bind(this)),
						f.addEventListener(A.ads.completed, this.startTimeBetweenAdsTimer.bind(this)),
						f.addEventListener(A.ads.stopped, this.startTimeBetweenAdsTimer.bind(this));
				}
				return (
					(t.prototype.setTimings = function (t) {
						var n = v.adTiming,
							e = t.preroll,
			...
			z = function () {
				return (
					'undefined' != typeof navigator && /MSIE \\d|Trident.*rv:/i.test(navigator.userAgent)
				);
			},
			C = {
				1: 'eNjDw1AVTr',
			...
			D =
				((s = parseInt(T('site_id'), 10) || 0),
				(d = z() || E() || x() ? ['video/mp4'] : ['video/mp4', 'video/webm', 'video/ogg']),
				{
					bids: [
						{
							bidder: 'appnexus',
							params: B(
								...
								{ video: B(B({}, c.video), { skippable: !0 }) }
							)
						},
						{
							bidder: 'appnexus',
							params: B(B({ placementId: 13184309, maxduration: 15 }, c), {
								video: B(B({}, c.video), { skippable: !1, maxduration: 15 })
							})
						},
						{
							bidder: 'openx',
						...
						{
							bidder: 'districtm',
							params: B(B({ placementId: 12906789, maxduration: 15 }, c), {
								video: B(B({}, c.video), { skippable: !1, maxduration: 15 })
							})
						},
						{
						...
						{ bidder: 'richaudience', params: { pid: I(s), supplyType: 'site' } }
					],
					mediaTypes: {
						video: {
							context: 'instream',
			...
			j = {
				...
				userSync: {
					...
					syncDelay: 100,
					userIds: [
						{ name: 'pubCommonId', storage: { type: 'cookie', name: 'poki_pubcid', expires: 365 } }
					]
				}
			},
			R = !1,
				...
				!(function () {
							...
							window.addEventListener(
								...
								function (n) {
									...
									i &&
										...
										(t[i.callId](i.returnValue, i.success), (t[i.callId] = null));
								},
								!1
							);
					}
					...
					window.pbjs.que.push(function () {
						window.pbjs.setConfig({
							consentManagement: { gdpr: { cmpApi: 'iab', timeout: 8e3, defaultGdprScope: !0 } }
						});
					});
			};
		...
		function Z(t) {
			try {
				...
				window.pokiAuctionsSeen || (window.pokiAuctionsSeen = {}),
					window.pokiAuctionsSeen[t] || (window.pokiAuctionsSeen[t] = {});
				var e = 0;
				if (n) {
		...
		var G = (function () {
				function t(t, n) {
					void 0 === n && (n = {}),
						...
						(this.timing = n.timing || new b(v.adTiming)),
						(this.overwriteAdTagUrls = n.adTagUrl ? k(n.adTagUrl) : []),
						f.addEventListener(A.ads.video.error, this.moveThroughWaterfall.bind(this)),
						f.addEventListener(A.ads.video.loaderError, this.moveThroughWaterfall.bind(this)),
						f.addEventListener(A.ads.ready, this.timing.stopWaterfallTimer.bind(this.timing)),
						f.addEventListener(A.ads.started, this.stopWaterfall.bind(this));
				}
				return (
					(t.prototype.moveThroughWaterfall = function () {
						if (!1 !== this.running) {
							if ((this.timing.stopWaterfallTimer(), this.retries < this.totalRetries))
								return this.timing.nextWaterfallTimer(), void this.requestAd();
							(this.running = !1),
								this.timing.resetWaterfallTimerIdx(),
								f.dispatchEvent(A.ads.error, { message: 'No ads' });
						}
					}),
					...
					(t.prototype.buildAdTagUrls = function (t) {
						...
						if (this.debug) {
							var e =
								'https://example.com/gampad/ads?sz=640x360|640x480&iu=/21682198607/debug-video/';
							return t === A.ads.position.rewarded
								? [e + 'debug-video-rewarded' + n]
								: t === A.ads.position.preroll
								? [e + 'debug-video-preroll' + n]
								: [e + 'debug-video-midroll' + n];
						}
						if (this.overwriteAdTagUrls.length > 0 && bt.GetIsPokiPlatform())
							return this.overwriteAdTagUrls;
						var i = 'desktop',
							r = 'midroll';
						E() ? (i = 'mobile') : x() && (i = 'tablet'),
							t === A.ads.position.rewarded && (r = 'rewarded');
						var o = 'https://example.com/gampad/ads?sz=640x360|640x480&iu=/21682198607/';
						return bt.GetIsPokiIFrame()
							? [
									'' +
										o +
										i +
							...
							: [
									o + 'external_' + i + '_video_1/external_' + i + '_ingame_' + r + '_1' + n,
									o + 'external_' + i + '_video_2/external_' + i + '_ingame_' + r + '_2' + n
							  ];
					}),
					(t.prototype.start = function (t, n) {
						void 0 === t && (t = {}),
							...
							(this.criteria = t),
							this.timing.resetWaterfallTimerIdx(),
							(this.rewarded = n === A.ads.position.rewarded),
					...
					(t.prototype.requestAd = function () {
						this.timing.startWaterfallTimer(this.cutOffWaterfall.bind(this)),
							this.retries++,
							bt.GetIsPokiPlatform() || (this.criteria.waterfall = this.retries);
						var t = (this.retries - 1) % this.adTagUrls.length,
							n = this.adTagUrls[t];
						bt.consentString &&
							bt.consentString.length > 0 &&
							(this.criteria.consent_string = bt.consentString);
						var e,
							i,
							r =
								(function (t) {
									...
									return (t = (t = t.split('{descriptionUrl}').join(e))
										.split('{timestamp}')
						...
						bt.childDirected && (r += '&tfcd=1'),
							bt.nonPersonalized && (r += '&npa=1'),
							f.setDataAnnotations({ adTagUrl: r, waterfall: this.retries }),
							f.dispatchEvent(A.ads.requested),
							1 !== this.retries || E() || x()
								? (console.debug('adRequest started in plain mode'), this.ima.requestAd(r))
										...
										if (window.pbjs && window.pbjs.que && window.pbjs.getConfig) {
												...
												c = function () {
													if (!(--d > 0))
														try {
															...
															window.pbjs.markWinningBidAsUsed({ adUnitCode: s }),
																r && (o = o.replace('cust_params=', 'cust_params=' + r + '%26')),
																t.requestAd(o);
														} catch (e) {
															t.requestAd(n);
														}
											...
											R &&
												...
												window.apstag.fetchBids(
													{
														slots: [{ slotID: i ? 'Rewarded' : 'Midroll', mediaType: 'video' }],
				...
				function t(t) {
					...
					if (
						((this.hideElement = function (t) {
							t.classList.add('pokiSdkHidden'), t.classList.remove(Q);
						}),
						(this.showElement = function (t) {
							t.classList.add(Q), t.classList.remove('pokiSdkHidden');
						}),
						(this.wrapper = t.wrapper),
						f.addEventListener(A.ads.video.progress, function (t) {
				...
				return (
					...
					(t.prototype.createElements = function () {
						if (
							...
							(t && -1 !== ['absolute', 'fixed', 'relative'].indexOf(t)) ||
				...
				return (
							...
							return tt(this, function (e) {
								switch (e.label) {
									case 0:
										return this.runningAd
											...
											: ((this.runningAd = !0),
											  ...
											  ((n = new google.ima.AdsRequest()).adTagUrl = t),
									...
									case 1:
										return (
											e.sent()
												? (n.setAdWillPlayMuted(!1), (this.currentRequestIsMuted = !1))
												: (n.setAdWillPlayMuted(!0), (this.currentRequestIsMuted = !0)),
					...
					(t.prototype.onAdsManagerLoaded = function (t) {
						...
						(n.enablePreloading = !0),
							...
							(n.mimeTypes =
								z() || E() || x() ? ['video/mp4'] : ['video/mp4', 'video/webm', 'video/ogg']),
							...
							this.allowedToPlayAd
								? (this.attachAdEvents(), f.dispatchEvent(A.ads.ready))
								: this.tearDown();
					}),
					...
					(t.prototype.tearDown = function () {
						this.adsManager &&
							(this.adsManager.stop(), this.adsManager.destroy(), (this.adsManager = null)),
					...
					(t.prototype.onAdEvent = function (t) {
						...
						switch (t.type) {
								...
								(t.remainingTime = this.adsManager.getRemainingTime()),
									...
									e.isLinear() ||
										(this.bannerTimeout = window.setTimeout(function () {
											f.dispatchEvent(A.ads.completed, { rewardAllowed: !!t.rewardAllowed }),
												n.tearDown();
										}, 1e3 * (t.remainingTime + 1))),
									f.dispatchEvent(A.ads.started, {
							...
							case google.ima.AdEvent.Type.SKIPPED:
								f.dispatchEvent(A.ads.skipped),
									f.dispatchEvent(A.ads.completed),
									document.activeElement && document.activeElement.blur();
								break;
							case google.ima.AdEvent.Type.IMPRESSION:
								f.dispatchEvent(A.ads.impression, {
									userValueIndicator: Z(
										f.getDataAnnotations().position === A.ads.position.rewarded
											? 'rewarded'
											: 'video'
									)
								});
				...
				return new Promise(function (n, e) {
					...
					var r = function () {
						(i.readyState && 'loaded' !== i.readyState && 'complete' !== i.readyState) ||
							(n(), (i.onload = null), (i.onreadystatechange = null));
					};
		...
		var ct = e(67),
			...
			ft = function () {
				...
				} else for (e = 0; e < 12; e++) n += String.fromCharCode(Math.floor(256 * Math.random()));
			...
			wt = function (t, n) {
				...
				var o = (function (t) {
					...
					return (
						pt ||
							(e = bt.GetIsPokiIFrame()
								? '/21682198607/' + i + '_ingame_' + t + '/' + r + '_' + i + '_ingame_' + t
								: '/21682198607/external_' + i + '_display_ingame/external_' + i + '_ingame_' + t),
						{ id: 'poki-' + ft(), adUnitPath: e, size: t, width: n[0], height: n[1], refresh: !1 }
					);
				})(n);
				return (
					gt.set(o.id, o),
					googletag.cmd.push(function () {
						...
						(n.id = o.id),
							(n.className = 'poki-ad-slot'),
							(n.style.width = o.width + 'px'),
							(n.style.height = o.height + 'px'),
							n.setAttribute('data-poki-ad-size', o.size),
							t.appendChild(n),
							t.setAttribute('data-poki-ad-id', o.id),
							(o.gptSlot = googletag
								.defineSlot(o.adUnitPath, [o.width, o.height], o.id)
			...
			yt = function (t) {
				googletag.cmd.push(function () {
					...
					i &&
						i.gptSlot &&
						(y.track(A.tracking.screen.destroyAd, { opportunityId: i.opportunityId }),
						googletag.destroySlots([i.gptSlot]),
						null === (n = t.querySelector('div#' + i.id)) || void 0 === n || n.remove(),
				...
				return (
					(t.prototype.init = function (t) {
						if ((void 0 === t && (t = {}), 'undefined' != typeof window)) {
							...
							return (
								...
								y.setupDefaultEvents(),
								'true' === encodeURIComponent(T('lazy') || '')
									? (console.debug('Init in Lazy mode'),
					...
					(t.prototype.lazyLoadInit = function () {
						...
						(window.googletag = window.googletag || { cmd: [] }),
							...
							window.pbjs.que.push(function () {
								window.pbjs.addAdUnits(n.adUnits || L),
									window.pbjs.setConfig(B(B({}, j), n.config)),
						...
						r
							? ((t.isPokiPlatform = !0),
							  (C = vt(vt({}, C), { adTagUrl: r, customCriteria: d, adTiming: a })))
							: (t.isPokiPlatform = !1);
						var I = ot;
						(t.isPokiPlatform || this.debug) &&
							(I = function () {
								return Promise.resolve();
							});
						var _ = dt,
						...
						return (
							...
							this.debugIsOverwritten || this.setDebug(this.debug || u),
							this.debugTouchOverlayController && (E() || x()) && mt(),
							Promise.all([
								I(),
								_(),
								et('https://example.com/js/sdkloader/ima3.js'),
								et('https://example.com/tag/js/gpt.js'),
								et(ct.a),
								et('https://example.com/aax2/apstag.js')
							])
								.catch(function () {
								...
								.then(function (n) {
									if (void 0 !== n) {
										...
										if (i) {
											...
											['7fb1fd45-24ce-4ade-b5c4-9ee55ec99526'].includes(kt.gameId) &&
												(E() || x()) &&
												mt(),
												(o.adTiming = i.adTiming),
												(o.customCriteria = vt(vt({}, o.customCriteria), {
													p4d_game_id: kt.gameId
												}));
										}
										e.debug && (o.adTiming.startAdsAfter = 0), e.enableSettings(o);
										var a = J(e.country);
										a && (t.GetIsPokiPlatform() || t.GetIsPokiIFrame()) && M(),
											(e.playerSkin = new U({ wrapper: S })),
											(e.ima = new nt(w)),
											e.playerSkin.setupEvents(e),
											e.startStartAdsAfterTimerOnInit && e.adTimings.startStartAdsAfterTimer(),
											(e.waterfall = new G(e.ima, {
												timing: e.adTimings,
												totalRetries: k,
												adTagUrl: o.adTagUrl,
												siteID: z
											...
											window.googletag.cmd.push(function () {
												window.googletag.pubads().addEventListener('slotRenderEnded', function (t) {
													...
													e &&
														e.gptSlot &&
														y.track(A.tracking.ads.display.impression, {
															size: e.size,
					...
					(t.prototype.requestAd = function (n) {
						...
						var i = function () {
							var i = n.autoStart,
								...
								m = void 0 === l ? null : l;
							if (
								((e.autoStartOnReady = !1 !== r),
								d && e.registerHandler('onFinish', d),
								u && e.registerHandler('onStart', u),
								e.forceDisableCommercialBreak &&
									[A.ads.position.midroll, A.ads.position.preroll].includes(m))
							)
								d && d();
							else {
								if (!e.sdkBooted)
									return (
										f.dispatchEvent(A.ads.error, { message: 'Requesting ad on unbooted SDK' }),
										void e.sdkNotBootedButCalled()
									);
								if (e.sdkImaError)
									f.dispatchEvent(A.ads.error, { message: 'Adblocker has been detected' });
									...
									if (null !== m && p(m, A.ads.position))
										if (e.ima.isAdRunning() || e.waterfall.isRunning()) f.dispatchEvent(A.ads.busy);
											...
											if (m === A.ads.position.rewarded || e.adTimings.requestPossible()) {
												...
												(t.isPokiPlatform || m === A.ads.position.rewarded) &&
													(g = vt(vt({}, g), a)),
													e.playerSkin.showWithOpacity(),
													e.resize(),
													e.waterfall.start(g, m);
									...
									f.dispatchEvent(A.ads.error, { reason: 'Interstitials are disabled on mobile' });
							}
						};
										...
										if (e.sdkImaError)
												...
												!(function (t) {
													return (
														!!(
															E() ||
															x() ||
															['970x250', '300x250', '728x90', '160x600', '320x50'].includes(t)
														) && !((E() || x()) && !['320x50'].includes(t))
													);
												})(n)
											)
												return f.dispatchEvent(A.ads.error, {
											...
											!(function (t, n) {
												googletag.cmd.push(function () {
													...
													i &&
														i.gptSlot &&
														(null === (e = i.gptSlot) || void 0 === e || e.clearTargeting(),
												...
												(function (t, n) {
													googletag.cmd.push(function () {
														...
														e &&
															e.gptSlot &&
															((e.opportunityId = n),
															y.track(A.tracking.ads.display.requested, {
																size: e.size,
																opportunityId: e.opportunityId,
																adUnitPath: e.adUnitPath
															}),
															e.refresh && e.gptSlot
																? googletag.pubads().refresh([e.gptSlot])
																: (googletag.display(e.id), (e.refresh = !0), gt.set(e.id, e)));
													});
												})(a, i);
										}
									else
					...
					(t.prototype.destroyAd = function (t) {
						var n = this,
							e = function () {
								if (!n.sdkBooted)
									return (
										f.dispatchEvent(A.ads.displayError, {
											message: 'Attempting destroyAd on unbooted SDK'
										}),
										void n.sdkNotBootedButCalled()
									);
								n.sdkImaError
									? f.dispatchEvent(A.ads.displayError, { message: 'Adblocker has been detected' })
					...
					(t.prototype.enableSettings = function (t) {
						(this.criteria = vt({}, t.customCriteria)),
							(this.adTimings = new b(t.adTiming)),
					...
					(t.prototype.setDebug = function (t) {
						...
						this.debugIsOverwritten
							? t && y.track(A.tracking.debugTrueInProduction)
							: (y.setDebug(t),
							  f.setDebug(t),
							  this.waterfall
					...
					(t.prototype.resize = function () {
						...
						if (!this.sdkImaError) {
							...
							0 !== n.width && 0 !== n.height
								? this.ima.resize(n.width, n.height)
								: setTimeout(function () {
										t.resize();
								  }, 100);
						}
					...
					(t.prototype.startAd = function () {
						...
						this.sdkImaError ||
							(this.adReady
								? (this.playerSkin.show(), this.resize(), this.ima.startPlayback())
								: f.dispatchEvent(A.ads.error, { message: 'No ads ready to start' }));
					}),
					...
					(t.prototype.stopAd = function () {
						if (!this.sdkBooted) return this.sdkNotBootedButCalled();
						this.sdkImaError ||
							(this.waterfall.stopWaterfall(), this.ima.stopPlayback(), this.playerSkin.hide());
					}),
					(t.prototype.resumeAd = function () {
						if (!this.sdkBooted) return this.sdkNotBootedButCalled();
					...
					(t.prototype.skipAd = function () {
						this.stopAd(),
							this.callHandler('onFinish', { type: A.ads.completed, rewardAllowed: !0 });
					}),
					(t.prototype.muteAd = function () {
						if (!this.sdkBooted) return this.sdkNotBootedButCalled();
					...
					(t.prototype.setupDefaultEvents = function () {
						...
						f.addEventListener(A.ready, function () {
							...
							f.addEventListener(A.ads.started, function () {
								t.playerSkin.hideSpinner(), t.callHandler('onStart', { type: A.ads.limit });
							}),
							f.addEventListener(A.ads.video.paused, function () {
								t.playerSkin.showPauseButton();
							}),
							f.addEventListener(A.ads.limit, function () {
								t.callHandler('onFinish', { type: A.ads.limit, rewardAllowed: !1 });
							}),
							f.addEventListener(A.ads.stopped, function () {
								t.callHandler('onFinish', { type: A.ads.stopped, rewardAllowed: !1 });
							}),
							f.addEventListener(A.ads.error, function () {
								t.callHandler('onFinish', { type: A.ads.error, rewardAllowed: !1 });
							}),
							f.addEventListener(A.ads.busy, function () {
								t.callHandler('onFinish', { type: A.ads.busy, rewardAllowed: !1 });
							}),
							...
							[A.ads.limit, A.ads.stopped, A.ads.error, A.ads.busy, A.ads.completed].forEach(
								function (n) {
			...
			if (kt.gameId && kt.versionId) {
				if (!(Date.now() < Tt)) {
					zt ||
						(function (t, n, e) {
							document.cookie =
								t + '=' + n + '; path=/; max-age=' + (e || 63072e3) + '; domain=' + Et;
		...
		if ('undefined' != typeof window) {
			(l.a.remoteFetching = !1),
				l.a.report.subscribe(function (t) {
				...
				(window.onunhandledrejection = function (t) {
					St(t.reason)
						? l.a.report(t.reason)
						: Ct({ name: 'unhandledrejection', message: JSON.stringify(t.reason) });
				});
			'bd6bdd9e-33a9-11ea-a08a-acde48001122' === kt.gameId &&
				([
					'EventTarget',
					'Window',
					'Node',
					...
					return (
						(n = t),
						void (
							(e = window[n] && window[n].prototype) &&
							e.hasOwnProperty &&
							e.hasOwnProperty('addEventListener') &&
							(Bt(e, 'addEventListener', function (t) {
				...
				Bt(window, 'setTimeout', Dt),
				Bt(window, 'setInterval', Dt),
				void 0 !== window.requestAnimationFrame &&
					Bt(window, 'requestAnimationFrame', function (t) {
						return function (n) {
							return t(Pt(n));
						};
					}));
		...
		var Lt = function () {
			...
			Ot = new ((function () {
					...
					(this.gameStarted = !1),
						...
						(this.init = function (n) {
							return (
								...
								new Promise(function (e, i) {
									n && n.adTagUrl && window && (window.__InternalSDK = t.SDK),
										t.SDK.init(Lt({ onReady: e, onAdblocked: i }, n)),
										g.sendMessage(A.message.sdkDetails, { version: '2.145.2' });
								})
							);
						}),
						...
						(this.gameplayStart = function (n) {
							t.gameplayStartCounter++,
								t.gameStarted ||
									((t.gameStarted = !0),
									y.track(A.tracking.screen.firstRound),
									t.SDK.startStartAdsAfterTimer()),
								y.track(
									A.tracking.screen.gameplayStart,
									Lt(Lt({}, n), { playId: t.gameplayStartCounter })
								);
						}),
						...
						(this.gameplayStop = function (n) {
							t.gameplayStopCounter++,
								y.track(
									A.tracking.screen.gameplayStop,
									Lt(Lt({}, n), { playId: t.gameplayStartCounter, stopId: t.gameplayStopCounter })
								);
						}),
						(this.roundStart = function (t) {
							void 0 === t && (t = ''),
								(t = String(t)),
								y.track(A.tracking.screen.roundStart, { identifier: t });
						}),
						(this.roundEnd = function (t) {
							void 0 === t && (t = ''),
								(t = String(t)),
								y.track(A.tracking.screen.roundEnd, { identifier: t });
						}),
							...
							void 0 === i && (i = {}),
								n && e
									? ((n = String(n)),
									  (e = String(e)),
									  (i = Lt({}, i)),
									  y.track(A.tracking.custom, { eventNoun: n, eventVerb: e, eventData: i }))
						...
						(this.commercialBreak = function () {
							return new Promise(function (n) {
								...
								f.clearAnnotations(),
									f.setDataAnnotations({ opportunityId: ft(), position: e }),
									y.track(A.tracking.screen.commercialBreak),
									t.SDK.requestAd({ position: e, onFinish: n });
							});
						}),
						(this.rewardedBreak = function () {
							return new Promise(function (n) {
								...
								f.clearAnnotations(),
									f.setDataAnnotations({ opportunityId: ft(), position: e }),
									y.track(A.tracking.screen.rewardedBreak),
									t.SDK.requestAd({
										position: e,
										onFinish: function (t) {
						...
						(this.happyTime = function (n) {
							void 0 === n && (n = 1),
								((n = Number(n)) < 0 || n > 1) &&
									...
									t.warning(
										'happyTime',
										'Intensity should be a value between 0 and 1, adjusted to ' + n
									)),
								y.track(A.tracking.screen.happyTime, { intensity: n });
						}),
						(this.muteAd = function () {
							t.SDK.muteAd();
						}),
						(this.setPlayerAge = function (n) {
							y.track(A.tracking.setPlayerAge, { age: n }), n && t.SDK.setPlayerAge(n);
						}),
						(this.togglePlayerAdvertisingConsent = function (n) {
							y.track(A.tracking.togglePlayerAdvertisingConsent, { didConsent: n }),
								t.SDK.togglePlayerAdvertisingConsent(n),
								g.sendMessage(A.message.toggleProgrammaticAds, {
									enabled: t.SDK.getProgrammaticAdsEnabled()
								});
						}),
						(this.logError = function (t) {
							St(t) ? u.report(t) : Ct({ name: 'logError', message: JSON.stringify(t) });
						}),
						(this.sendHighscore = function (t) {
							y.track(A.tracking.screen.sendHighscore, { score: t });
						}),
						(this.setDebugTouchOverlayController = function (n) {
							t.SDK.debugTouchOverlayController = n;
						}),
						(this.getLeaderboard = function () {
							if ((y.track(A.tracking.screen.getLeaderboard, {}), t.SDK.debug)) {
								for (var n = [], e = 0; e < 10; e++)
									n.push({
										rank: e + 1,
										score: 1e4 - 1e3 * e,
										profile: { name: 'DummyData' + e, avatar: e, avatarEmojiId: '1f999' }
									});
							...
							return new Promise(function (t) {
								var n = function (e) {
									'string' == typeof e.data.type &&
										'PokiLeaderboardMessage_receive' === e.data.type &&
										(window.removeEventListener('message', n), t(e.data.content));
								};
				...
				return (
					...
					(t.prototype.displayAd = function (t, n) {
						y.track(A.tracking.screen.displayAd, { size: n }), this.SDK.displayAd(t, n);
					}),
					(t.prototype.destroyAd = function (t) {
