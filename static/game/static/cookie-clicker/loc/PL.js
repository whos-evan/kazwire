AddLanguage('PL', 'polish', {
	...
	grandmapocalypse: '/',
	'%1 cookie': ['%1 ciastko', '%1 ciastka'],
	'%1 sugar lump': ['%1 grudka cukru', '%1 grudki cukru'],
	'%1 heavenly chip': ['%1 niebiański żeton', '%1 niebiańskie żetony'],
	'%1 golden cookie': ['%1 złote ciastko', '%1 złote ciastka'],
	'%1 building': ['%1 budynek', '%1 budynki'],
	'%1 upgrade': ['%1 ulepszenie', '%1 ulepszenia'],
	Yes: 'Tak',
	No: 'Nie',
	...
	Cookies: 'Ciastka',
	'%1 day': ['%1 dzień', '%1 dni'],
	'%1 hour': ['%1 godzina', '%1 godziny'],
	'%1 minute': ['%1 minuta', '%1 minuty'],
	'%1 second': ['%1 sekunda', '%1 sekund'],
	...
	'visual improvements; disabling may improve performance':
		'ulepszenia graficzne. Wyłączenie ich może poprawić płynność gry',
	Particles: 'Cząsteczki',
	Numbers: 'Liczby',
	'numbers that pop up when clicking the cookie':
		'liczby, które pojawiają się, gdy klikasz ciastka',
	'Milk [setting]': 'Mleko',
	...
	'display boxes around upgrades and achievements in Stats':
		'wyświetla ikony wokół ulepszeń oraz osiągnięć w statystykach',
	'Alt font': 'Alternatywna czcionka',
	'your cookies are displayed using a monospace font':
		'wyświetla ciastka za pomocą czcionki monospace',
	...
	'the game will ask you to confirm when you close the window':
		'gra poprosi cię o potwierdzenie, jeśli postanowisz zamknąć okno',
	Defocus: 'Obniż priorytet',
	'the game will be less resource-intensive when out of focus':
		'gra stanie się mniej zasobożerna, jeśli obniżysz jej priorytet',
	...
	'the game will ask you to confirm before spending sugar lumps':
		'gra poprosi cię o potwierdzenie, jeśli postanowisz wydać grudki cukru',
	'Custom grandmas': 'Spersonalizowane babcie',
	'some grandmas will be named after Patreon supporters':
		'niektóre babcie otrzymają imiona naszych darczyńców z Patreona',
	...
	"on slower computers, the game will put itself in sleep mode when it's inactive and starts to lag out; offline CpS production kicks in during sleep mode":
		'na słabszych komputerach gra automatycznie wejdzie w tryb uśpienia, jeśli będzie nieaktywna lub zacznie spowalniać. W tym trybie rozpoczyna się offline’owa produkcja CnS',
	'Music in background': 'Muzyka w tle',
	"music will keep playing even when the game window isn't focused":
		'muzyka będzie odtwarzana, nawet jeśli okno gry będzie zminimalizowane',
	...
	'allows optimizations for screen readers; game will reload':
		'optymalizacja pod kątem czytników ekranowych; gra zostanie załadowana na nowo',
	'Discord status': 'Status na Discordzie',
	'if Discord is on, show your game info as activity status':
		'wyświetli twoje informacje o grze w polu statusu, jeśli masz włączonego Discorda',
	Language: 'Język',
	'Language: %1': 'Język: %1',
	'Change language': 'Zmień język',
	'note: this will save and reload your game':
		'uwaga: twoja gra zostanie zapisana i załadowana ponownie',
	...
	'These are feats that are either unfair or difficult to attain. They do not give milk.':
		'Wyczyny, które są nieuczciwe lub trudne do wykonania. Nie dają ci mleka.',
	...
	'with %1 ascension': ['z %1 wzniesieniem', 'z %1 wzniesieniami'],
	...
	'at %1% of its potential <b>(+%2% CpS)</b>':
		'na %1% swojego potencjału <b>(+%2% wartości CnS)</b>',
	...
	'Milk is gained with each achievement. It can unlock unique upgrades over time.':
		'Każde osiągnięcie wynagradza cię mlekiem. Dzięki niemu możesz z biegiem gry odblokowywać wyjątkowe ulepszenia.',
	'Rank %1': 'Poziom %1',
	...
	'Cookie Clicker is a javascript game by %1 and %2.':
		'Cookie Clicker jest grą w javascript, stworzoną przez %1 i %2.',
	'Music by %1.': 'Muzyka: %1.',
	...
	"This version of Cookie Clicker is 100% free, forever. Want to support us so we can keep developing games? Here's some ways you can help:%1":
		'Ta wersja gry Cookie Clicker jest w 100% na zawsze darmowa. Chcesz jednak nas wspierać, abyśmy mogli dalej tworzyć gry? Oto jak nam możesz pomóc:%1',
	"Note: if you find a new bug after an update and you're using a 3rd-party add-on, make sure it's not just your add-on causing it!":
		'Pamiętaj: jeśli po aktualizacji gry zauważysz jakiś nowy błąd, a używasz dodatków osób trzecich, upewnij się najpierw, że to nie one go powodują!',
	'Warning: clearing your browser cache or cookies <small>(what else?)</small> will result in your save being wiped. Export your save and back it up first!':
		'Uwaga: wyczyszczenie pamięci podręcznej lub ciasteczek <small>(a jakże?)</small> sprawi, że twoje postępy w grze zostaną utracone. Zawsze najpierw eksportuj swój stan gry i dokonuj jego kopii zapasowej!',
	'Version history': 'Historia wersji',
	'Official website': 'Strona oficjalna',
	'Note: links will open in your web browser.':
		'Uwaga: odnośnik zostanie otworzony w przeglądarce internetowej.',
	'Note: older update notes are in English.':
		'Uwaga: starsze opisy aktualizacji są w języku angielskim.',
	'This feature is not yet available in your language.':
		'Ta opcja nie jest jeszcze dostępna w Twoim języku.',
	...
	'Cookie Clicker is in sleep mode and generating offline cookies.':
		'Cookie Clicker działa w trybie uśpienia, ale nadal generuje ciastka offline.',
	...
	'(this happens when too many frames are skipped at once,<br>usually when the game has been running in the background for a while)<br>(you can turn this feature off in the settings menu)':
		'(tak się dzieje, gdy za wiele klatek pomija się na raz,<br>co na ogół ma miejsce, jeśli gra działa od dłuższego czasu w tle)<br>(możesz wyłączyć tę funkcję w menu ustawień)',
	...
	'Hello again! Just a reminder that you may want to back up your Cookie Clicker save every once in a while, just in case.<br>To do so, go to Options and hit "Export save" or "Save to file"!':
		'Witaj ponownie! Tylko przypominamy, że od czasu do czasu dobrze jest zrobić kopię zapasową postępów w grze Cookie Clicker. Tak na wszelki wypadek.<br>Aby tego dokonać, wejdź do Opcji, a następnie wciśnij „Eksportuj stan gry” lub „Zapisz do pliku”.',
	'Save manually (the game autosaves every 60 seconds; shortcut: ctrl+S)':
		'Zapisuj ręcznie (gra zapisuje automatycznie twoje postępy co 60 sekund. Skrót: Ctrl+S)',
	'You can use this to backup your save or to transfer it to another computer (shortcut for import: ctrl+O)':
		'Dzięki tej funkcji możesz zarówno stworzyć kopię zapasową swoich postępów w grze, jak również przenieść ją na inny komputer (skrót do importowania: Crtl+O)',
	'Save to file': 'Zapisz do pliku',
	'Load from file': 'Wczytaj z pliku',
	'Use this to keep backups on your computer':
		'Dzięki tej funkcji możesz zapisywać na swoim komputerze kopie zapasowe postępów w grze',
	'Export save': 'Eksportuj stan gry',
	'This is your save code.<br>Copy it and keep it somewhere safe!':
		'To kod z twoimi postępami w grze.<br>Przekopiuj go i trzymaj w bezpiecznym miejscu!',
	'Import save': 'Importuj stan gry',
	'Please paste in the code that was given to you on save export.':
		'Proszę wkleić kod, który otrzymałeś podczas eksportowania swoich postępów w grze.',
	...
	'Oops, looks like the import string is all wrong!':
		'Ojej, wygląda na to, że ciąg znaków w importowanym pliku jest niepoprawny!',
	'You are attempting to load a save from a future version (v. %1; you are using v. %2).':
		'Próbujesz wczytać stan gry z nowszej wersji (v. %1, a ty używasz v. %2).',
	"Sorry, you can't import saves from the classic version.":
		'Przepraszamy, ale nie można importować postępów w grze z wersji klasycznej.',
	'Wipe save': 'Usuń postępy w grze',
	'Delete all your progress, including your achievements':
		'Usuwa wszystkie twoje postępy w grze, włącznie z osiągnięciami',
	'Do you REALLY want to wipe your save?<br><small>You will lose your progress, your achievements, and your heavenly chips!</small>':
		'NA PEWNO chcesz usunąć wszystkie postępy?<br><small>Stracisz wszystkie postępy, osiągnięcia oraz niebiańskie żetony!</small>',
	"Whoah now, are you really, <b><i>REALLY</i></b> sure you want to go through with this?<br><small>Don't say we didn't warn you!</small>":
		'Ale teraz już poważnie, czy ty faktycznie, <b><i>NAPRAWDĘ</i></b> chcesz tego dokonać?<br><small>Tylko nie mów, że cię nie ostrzegaliśmy!</small>',
	...
	'Only use mods from trusted sources. Some mods may require a game restart to take effect.':
		'Używaj modów tylko z zaufanych źródeł. Niektóre mody wymagają zrestartowania gry.',
	Enable: 'Włącz',
	Disable: 'Wyłącz',
	...
	'This tool allows you to upload new mods to the Steam Workshop.<br>You need to select a mod folder containing a properly-formatted %1 file.<br>See the included sample mods for examples.':
		'To narzędzie pozwala na przesyłanie nowych modów do Warsztatu Steam.<br>Musisz wybrać katalog moda zawierający odpowiednio sformatowany plik %1.<br>Aby uzyskać więcej informacji, zajrzyj do załączonych przykładowych modów.',
	'Mod data': 'Dane modów',
	...
	'These are the mods present in your save data. You may delete some of this data to make your save file smaller.':
		'Mody obecne w twoim pliku zapisu postępów w grze. Możesz usunąć część tych danych, aby zmniejszyć plik.',
	'(loaded)': '(wczytano)',
	'%1 char': ['%1 znak', '%1 znaki'],
	...
	'You are currently playing Cookie Clicker on the <b>%1</b> protocol.<br>The <b>%2</b> version uses a different save slot than this one.<br>Click this lock to reload the page and switch to the <b>%2</b> version!':
		'Aktualnie grasz w Cookie Clicker na protokole <b>%1</b> .<br>Wersja <b>%2</b> korzysta z innego miejsca zapisu postępów w grze niż twoja.<br>Kliknij tę kłódkę, aby przeładować stronę i przełączyć się na wersję <b>%2</b>!',
	'+%1 more notification.': ['+%1 dodatkowe powiadomienie', '+%1 dodatkowych powiadomień'],
	...
	"Because you've baked a <b>billion cookies</b> in total, you are now attracting <b>sugar lumps</b>. They coalesce quietly near the top of your screen, under the Stats button.<br>You will be able to harvest them when they're ripe, after which you may spend them on all sorts of things!":
		'Ponieważ upiekłeś łącznie <b>miliard ciastek</b>, to teraz zaczynasz przyciągać <b>grudki cukru</b>. Zbierają się one spokojnie nieopodal górnej krawędzi ekranu, pod przyciskami Statystyk.<br>Gdy będą dojrzałe, będziesz mógł je zebrać, a następnie wydać na całą masę różnych rzeczy!',
	'A <b>sugar lump</b> is coalescing here, attracted by your accomplishments.':
		'Tutaj pojawia się <b>grudka cukru</b>. Zwabiły ją twoje osiągnięcia.',
	'Your sugar lumps mature after <b>%1</b>,<br>ripen after <b>%2</b>,<br>and fall after <b>%3</b>.':
		'Twoje grudki cukru dorosną za <b>%1</b>,<br>dojrzeją za <b>%2</b>,<br>oraz spadną za <b>%3</b>.',
	...
	"This sugar lump is mature and will be ripe in <b>%1</b>.<br>You may <b>click it to harvest it now</b>, but there is a <b>50% chance you won't get anything</b>.":
		'Ta grudka cukru już dorosła, ale potrzebuje <b>%1</b> żeby dojrzeć.<br>Możesz <b>kliknąć grudkę cukru już teraz, aby ją zebrać</b>, ale jest <b>50% ryzyka, że ci się nie powiedzie</b>.',
	'<b>This sugar lump is ripe! Click it to harvest it.</b><br>If you do nothing, it will auto-harvest in <b>%1</b>.':
		'<b>Ta grudka cukru jest już dojrzała! Kliknij ją, aby ją zebrać.</b><br>Jeśli nie zrobisz nic, grudka zostanie zebrana samoczynnie za <b>%1</b>.',
	'This sugar lump grew to be <b>bifurcated</b>; harvesting it has a 50% chance of yielding two lumps.':
		'Ta grudka cukru <b>zduplikowała się</b>. Dzięki temu masz 50% szansy na to, że zbierzesz dwie grudki zamiast jednej.',
	'This sugar lump grew to be <b>golden</b>; harvesting it will yield 2 to 7 lumps, your current cookies will be doubled (capped to a gain of 24 hours of your CpS), and you will find 10% more golden cookies for the next 24 hours.':
		'Ta grudka cukru pokryła się <b>złotem</b>. Zebranie jej sprawi, że otrzymasz 2 do 7 grudek, twój zapas ciastek podwoi się (ograniczony do poziomu będącego wypadkową 24 godzin i twojej wartości CnS), a także przez kolejne 24 godziny będziesz znajdował o 10% więcej złotych ciastek.',
	'This sugar lump was affected by the elders and grew to be <b>meaty</b>; harvesting it will yield between 0 and 2 lumps.':
		'Przy tej grudce cukru majstrowała starszyzna, skutkiem czego stała się <b>mięsista</b>. Zebranie jej dostarczy ci od 0 do 2 grudek. ',
	'This sugar lump is <b>caramelized</b>, its stickiness binding it to unexpected things; harvesting it will yield between 1 and 3 lumps and will refill your sugar lump cooldowns.':
		'Ta grudka cukru <b>skarmelizowała się</b>, na skutek czego cała masa różnych rzeczy poprzyklejała się do niej. Zebranie jej dostarczy ci od 1 do 3 grudek oraz odnowi twoje czasy oczekiwania na grudki cukru.',
	...
	'Your cookies have been doubled.<br>+10% golden cookies for the next 24 hours.':
		'Masz dwa razy więcej ciastek.<br>+10% złotych ciastek przez następne 24 godziny.',
	...
	Heralds: 'Heroldzi',
	'%1 herald': ['%1 herold', '%1 heroldzi'],
	"Heralds couldn't be loaded. There may be an issue with our servers, or you are playing the game locally.":
		'Nie można załadować heroldów. Może to być spowodowane błędem na serwerze albo przez to, że grasz lokalnie.',
	'There are no heralds at the moment. Please consider <b>donating to our Patreon</b>!':
		'Na tę chwile nie ma żadnych heroldów. Rozważ jednak, czy nie zechciałbyś <b>dokonać wpłaty na naszym Patreonie</b>!',
	'selflessly inspiring a boost in production for everyone, resulting in %1.':
		'bezinteresownie wywołując u każdego wzrost produktywności, dzięki czemu otrzymujesz %1.',
	'+%1% cookies per second': '+%1% ciastek na sekundę',
	'You are in a <b>Born again</b> run, and are not currently benefiting from heralds.':
		'Jesteś <b>Urodzony na nowo</b>, ale nie korzystasz z heroldów.',
	'You own the <b>Heralds</b> upgrade, and therefore benefit from the production boost.':
		'Dysponujesz ulepszeniem <b>Heroldzi</b>, dzięki któremu twoja produktywność wzrasta.',
	'To benefit from the herald bonus, you need a special upgrade you do not yet own. You will permanently unlock it later in the game.':
		'Aby skorzystać z bonusu dawanego przez heroldów, musisz mieć specjalne ulepszenie, którym jeszcze nie dysponujesz. Odblokujesz je na stałe na późniejszych etapach w grze.',
	'<b>Heralds</b> are people who have donated to our highest Patreon tier, and are limited to 100.<br>Each herald gives everyone +1% CpS.<br>Heralds benefit everyone playing the game, regardless of whether you donated.':
		'<b>Heroldzi</b> to ludzie, którzy wpłacili najwyższe kwoty na naszego Patreona i jest ich nie więcej niż 100.<br>Każdy herold daje każdemu +1% wartości CnS.<br>Z obecności heroldów korzystają wszyscy gracze, niezależnie od tego, czy sami również wpłacili.',
	'Every %1 current players on Steam generates <b>1 herald</b>, up to %2 heralds.<br>Each herald gives everyone +1% CpS.':
		'Każde %1 aktywnych graczy na Steamie generuje <b>1 herolda</b>, maksymalnie %2.<br>Każdy herold daje każdemu +1% CnS.',
	'+%1!': '/',
	...
	'Sweet!<br><small>Found 1 sugar lump!</small>':
		'Słodko!<br><small>Znaleziono 1 grudkę cukru!</small>',
	'Lucky!': 'Szczęściarz!',
	'Ruin!': 'Tragedia!',
	...
	'Cookie chain broken.<br><small>You made %1.</small>':
		'Ciastkowy łańcuch przełamany.<br><small>Zarabiasz %1.</small>',
	'Cookie blab': [
	...
	'Lets you use two dragon auras simultaneously':
		'Pozwala na równoczesne korzystanie z dwóch smoczych aur',
	...
	'Select an aura from those your dragon knows.':
		'Wybierz aurę spośród tych, które twój smok już zna.',
	'<b>One tenth</b> of every other dragon aura, <b>combined</b>.':
		'<b>Jedna dziesiąta</b> z każdej drugiej aury smoka, <b>razem</b>.',
	'Switching your aura is <b>free</b> because you own no buildings.':
		'Przechodzenie pomiędzy aurami jest <b>darmowe</b>, ponieważ nie masz żadnych budynków.',
	'The cost of switching your aura is <b>%1</b>.<br>This will affect your CpS!':
		'Koszt związany ze zmianą aury to <b>%1</b>.<br>Wpłynie to również na twoją wartość CnS!',
	...
	'You feel like making cookies. But nobody wants to eat your cookies.':
		'Masz ochotę upiec trochę ciastek, ale nikt nie chce ich jeść.',
	'Your first batch goes to the trash. The neighborhood raccoon barely touches it.':
		'Pierwsza partia idzie do śmietnika. Nawet szop pracz z pobliskiego kontenera patrzy na nie zdegustowany.',
	'Your family accepts to try some of your cookies.':
		'Twoja rodzina zgadza się spróbować twoich ciastek.',
	'Your cookies are popular in the neighborhood.':
		'Twoje ciastka zyskują na popularności w okolicy.',
	'People are starting to talk about your cookies.':
		'Ludzie zaczynają rozmawiać o twoich ciastkach.',
	'Your cookies are talked about for miles around.':
		'Ludzie w promieniu wielu kilometrów mówią o twoich ciastkach.',
	...
	'Your cookies bring all the boys to the yard.':
		'Wszyscy chłopcy grzecznie przychodzą do ciebie po ciastka.',
	'Your cookies now have their own website!':
		'Twoje ciastka mają już swoją własną stronę internetową!',
	...
	'Your cookies sell very well in distant countries.':
		'Twoje ciastka sprzedają się bardzo dobrze nawet w odległych krajach.',
	'People come from very far away to get a taste of your cookies.':
		'Ludzie przybywają z bardzo daleka, aby choćby spróbować twoich ciastek.',
	'Kings and queens from all over the world are enjoying your cookies.':
		'Królowie i królowe z całego świata zajadają się twoimi ciastkami.',
	...
	'A national day has been created in honor of your cookies.':
		'Ogłoszono święto narodowe, aby uczcić twoje ciastka.',
	'Your cookies have been named a part of the world wonders.':
		'Twoje ciastka wpisano na listę cudów świata.',
	'History books now include a whole chapter about your cookies.':
		'Podręczniki do historii zawierają cały rozdział poświęcony twoim ciastkom.',
	'Your cookies have been placed under government surveillance.':
		'Twoje ciastka są pod stałym nadzorem rządu.',
	...
	'Strange creatures from neighboring planets wish to try your cookies.':
		'Dziwne stworzenia z pobliskich planet pragną spróbować twoich ciastek.',
	'Elder gods from the whole cosmos have awoken to taste your cookies.':
		'Starożytni bogowie z całego kosmosu przebudzili się, aby skosztować twoich ciastek.',
	'Beings from other dimensions lapse into existence just to get a taste of your cookies.':
		'Stworzenia z innych wymiarów rodzą się tylko po to, aby posmakować twoich ciastek.',
	...
	'The universe has now turned into cookie dough, to the molecular level.':
		'Wszechświat właśnie przeobraził się w ciasto na poziomie cząsteczkowym.',
	'Your cookies are rewriting the fundamental laws of the universe.':
		'Twoje ciastka przepisują fundamentalne prawa rządzące wszechświatem.',
	'A local news station runs a 10-minute segment about your cookies. Success!<br><small>(you win a cookie)</small>':
		'Lokalna radiostacja poświęca 10-minutową audycję na omówienie twoich ciastek! Sukces!<br><small>(wygrywasz ciastko)</small>',
	...
	'You gain <b>one hour</b> of your CpS (capped at double your bank).':
		'Otrzymujesz <b>jedną godzinę</b> twojej wartości CnS (do podwójnego poziomu twojego obecnego salda).',
	"You've unlocked a new upgrade.": 'Odblokowujesz nowe ulepszenie.',
	'Wish granted. Golden cookie spawned.':
		'Życzenie się spełniło i oto przed tobą pojawia się złote ciastko.',
	'help me!': 'pomocy!',
	Ascend: 'Wznoszenie',
	"You've been on this run for <b>%1</b>.": 'Grasz już od <b>%1</b>.',
	'Your prestige level is currently <b>%1</b>.<br>(CpS +%2%)':
		'Twój aktualny poziom prestiżu wynosi <b>%1</b>.<br>(CnS +%2%)',
	...
	'Ascending now would grant you<br><b>1 prestige level</b> (+1% CpS)<br>and <b>1 heavenly chip</b> to spend.':
		'Wzniesienie się teraz sprawi, że zyskasz<br><b>1 poziom prestiżu</b> (+1% CnS)<br>oraz <b>1 niebiański żeton</b> do wydania.',
	'Ascending now would grant you<br><b>%1 prestige levels</b> (+%2% CpS)<br>and <b>%3 heavenly chips</b> to spend.':
		'Wzniesienie się teraz sprawi, że zyskasz<br><b>%1 poziomy prestiżu</b> (+%2% CnS)<br>oraz <b>%3 niebiańskich żetonów</b> do wydania.',
	'You need <b>%1 more cookies</b> for the next level.':
		'Potrzebujesz <b>%1 więcej ciastek</b>, aby zdobyć kolejny poziom.',
	'Do you REALLY want to ascend?<div class="line"></div>You will lose your progress and start over from scratch.<div class="line"></div>All your cookies will be converted into prestige and heavenly chips.':
		'NAPRAWDĘ chcesz się teraz wnieść?<div class="line"></div>Stracisz wszystkie postępy i będziesz musiał zaczynać od zera.<div class="line"></div>Wszystkie twoje ciastka zostaną zamienione na niebiańskie żetony.',
	...
	'You will keep your achievements, building levels and sugar lumps.':
		'Zachowasz swoje osiągnięcia, poziomy budynków oraz grudki cukru.',
	...
	'%1 prestige level': ['%1 poziom prestiżu', '%1 poziomy prestiżu'],
	...
	"You are ascending.<br>Drag the screen around<br>or use arrow keys!<br>When you're ready,<br>click Reincarnate.":
		'Wznosisz się.<br>Przeciągaj ekran<br>albo skorzystaj ze strzałek<br>Gdy będziesz gotowy,<br>kliknij Reinkarnacja.',
	'Each prestige level grants you a permanent <b>+%1% CpS</b>.<br>The more levels you have, the more cookies they require.':
		'Każdy poziom prestiżu daje ci stałe <b>+%1% wartości CnS</b>.<br>Im wyższy masz poziom, tym więcej potrzebujesz ciastek.',
	'Heavenly chips are used to buy heavenly upgrades.<br>You gain <b>1 chip</b> every time you gain a prestige level.':
		'Niebiańskich żetonów używa się do zakupu niebiańskich ulepszeń.<br>Otrzymujesz <b>1 żeton</b> za każdy poziom prestiżu.',
	"Click this once you've bought<br>everything you need!":
		'Kliknij tu, gdy kupisz już<br>wszystko, czego ci trzeba!',
	'Are you ready to return to the mortal world?':
		'Jesteś gotowy na powrót do świata śmiertelników?',
	...
	'Challenge modes apply special modifiers to your next ascension.<br>Click to change.':
		'Tryb wyzwań pozwala na dobranie specjalnych modyfikatorów do kolejnego wzniesienia.<br>Kliknij, aby zmienić.',
	...
	"It's <b>Valentine's season</b>!<br>Love's in the air and cookies are just that much sweeter!":
		'To <b>czas na walentynki</b>!<br>Miłość wisi w powietrzu a ciastka są jeszcze słodsze!',
	'Business Day!': 'Zwykły dzień roboczy!',
	"It's <b>Business season</b>!<br>Don't panic! Things are gonna be looking a little more corporate for a few days.":
		'To <b>czas na pracę</b>!<br>Spokojnie! Przez parę następnych dni rzeczy będą nieco bardziej skomplikowane.',
	'Halloween!': '/',
	"It's <b>Halloween season</b>!<br>Everything is just a little bit spookier!":
		'To <b>czas na Halloween</b>!<br>Wszystko stało się nieco straszniejsze!',
	...
	"It's <b>Christmas season</b>!<br>Bring good cheer to all and you just may get cookies in your stockings!":
		'To <b>czas Świąt Bożego Narodzenia</b>!<br>Spraw, żeby wszyscy mieli dobry humor, a może dostaniesz parę ciastek do skarpety!',
	'Easter!': 'Wielkanoc!',
	"It's <b>Easter season</b>!<br>Keep an eye out and you just might click a rabbit or two!":
		'To <b>czas Wielkanocy</b>!<br>Miej się na baczności, a może zdołasz kliknąć jakiego królika albo dwa.',
	...
	'Upgrade is vaulted and will not be auto-purchased.':
		'Ulepszenie znajduje się w banku i nie zostanie zakupione automatyczne.',
	...
	'Will <b>instantly purchase</b> every upgrade you can afford, starting from the cheapest one.<br>Upgrades in the <b>vault</b> will not be auto-purchased.<br>You may place an upgrade into the vault by <b>Shift-clicking</b> on it.':
		'Będziesz <b>natychmiast kupował</b> wszystkie ulepszenia, na które cię stać, począwszy od najtańszego.<br>Ulepszenia ze <b>skarbca</b> nie będą kupowane automatycznie.<br>Możesz umieścić każde ulepszenie w skarbcu, jeśli <b>klikniesz je z wciśniętym Shiftem</b>.',
	...
	'all combined, these boosts account for <b>%1</b> per second (<b>%2%</b> of total CpS)':
		'sumarycznie, te wzmocnienia dają ci <b>%1</b> na sekundę (<b>%2%</b> z całej wartości CnS.',
	'owned: %1': 'posiadasz: %1',
	'free: %1!': 'wolne: %1!',
	...
	'Levelling up this building unlocks a minigame.':
		'Podniesienie poziomu tego budynku odblokowuje minigierkę.',
	...
	'Names in white were submitted by our supporters on Patreon.':
		'Imiona zapisane białą czcionką zostały przesłane przez naszych darczyńców na Patreonie.',
	'You can also press %1 to bulk-buy or sell %2 of a building at a time, or %3 for %4.':
		'Możesz także wcisnąć %1, aby hurtowo kupować lub sprzedawać %2 budynki na raz, albo %3 za %4.',
	Investment: 'Inwestycja',
	"You're not sure what this does, you just know it means profit.":
		'Jeśli nie wiesz, po co to jest, to wiedz, że przynosi to zysk.',
	Cursor: 'Kursor',
	cursor: 'kursor',
	cursors: 'kursory',
	'%1 cursor': ['%1 kursor', '%1 kursory'],
	...
	'[Cursor business quote]Essential in flattening dough. The first step in cookie-making.':
		'Niezbędny przy spłaszczeniu ciasta. Pierwszy krok w produkcji ciastek.',
	Grandma: 'Babcia',
	grandma: 'babcia',
	grandmas: 'babcie',
	'%1 grandma': ['%1 babcia', '%1 babcie'],
	...
	'[Grandma business quote]A crucial element of baking cookies.':
		'Niezbędny element w produkcji ciastek.',
	Farm: 'Hodowla',
	farm: 'hodowla',
	farms: 'hodowle',
	'%1 farm': ['%1 hodowla', '%1 hodowle'],
	'[Farm quote]Grows cookie plants from cookie seeds.':
		'To tutaj z ciastkowych ziaren wyrastają dorodne, ciastkowe rośliny.',
	'[Farm business name]Kitchen': 'Kuchnia',
	'[Farm business quote]The more kitchens, the more cookies your employees can produce.':
		'Im więcej masz kuchni, tym więcej ciastek mogą upiec twoi pracownicy.',
	Mine: 'Kopalnia',
	mine: 'kopalnia',
	mines: 'kopalnie',
	'%1 mine': ['%1 kopalnia', '%1 kopalnie'],
	'[Mine quote]Mines out cookie dough and chocolate chips.':
		'Tutaj wydobywa się surowe ciasto oraz płatki czekoladowe.',
	...
	'[Mine business quote]These give you the edge you need to outsell those pesky competitors.':
		'To dzięki nim uzyskujesz przewagę nad tą niecną konkurencją.',
	Factory: 'Fabryka',
	factory: 'fabryka',
	factories: 'fabryki',
	'%1 factory': ['%1 fabryka', '%1 fabryki'],
	...
	'[Factory business quote]Mass production is the future of baking. Seize the day, and synergize!':
		'Masowa produkcja jest przyszłością w branży ciastkowej. Chwytaj dzień i synergizuj się!',
	Bank: '/',
	bank: '/',
	banks: 'banki',
	'%1 bank': ['%1 bank', '%1 banki'],
	...
	"[Bank business quote]Business folks with a nose for profit, ready to finance your venture as long as there's money to be made.":
		'Człowiek ze smykałką do interesów, który z chęcią wesprze twoją firmę, jeśli tylko zauważy w niej potencjał do wzbogacenia się.',
	Temple: 'Świątynia',
	temple: 'świątynie',
	temples: 'świątynie',
	'%1 temple': ['%1 świątynia', '%1 świątynie'],
	'[Temple quote]Full of precious, ancient chocolate.':
		'Obfitują w drogocenną, starożytną czekoladę.',
	...
	'[Temple business quote]Your social media page is going viral! Amassing likes is the key to a lasting online presence and juicy advertising deals.':
		'Twoja stronka na portalu społecznościowym jest rozchwytywana! Zbieranie polubień jest kluczem do trwałej obecności w sieci i soczystych ofert reklamowych.',
	'Wizard tower': 'Wieża czarodzieja',
	'wizard tower': 'wieża czarodzieja',
	'wizard towers': 'wieże czarodzieja',
	'%1 wizard tower': ['%1 wieża czarodzieja', '%1 wieże czarodzieja'],
	'[Wizard tower quote]Summons cookies with magic spells.':
		'Przyzywa ciastka za pomocą magicznych zaklęć.',
	...
	'[Wizard tower business quote]Cookie memes are all the rage! With just the right amount of social media astroturfing, your brand image will be all over the cyberspace.':
		'Ogarnia nas prawdziwe szaleństwo ciastkowych memów! Dzięki odpowiedniej ilości astroturfingu w mediach społecznościowych, wizerunek twojej marki w mig rozprzestrzeni się w całej cyberprzestrzeni.',
	Shipment: 'Dostawa',
	shipment: 'dostawa',
	shipments: 'dostawy',
	'%1 shipment': ['%1 dostawa', '%1 dostawy'],
	'[Shipment quote]Brings in fresh cookies from the cookie planet.':
		'Transportuje świeże ciastka z ciastkowej planety.',
	...
	'[Shipment business quote]A gigantic cookie emporium - your very own retail chain.':
		'Gigantyczna składnica ciastek — twoja własna sieć sklepów.',
	'Alchemy lab': 'Laboratorium alchemiczne',
	'alchemy lab': 'laboratorium alchemiczne',
	'alchemy labs': 'laboratoria alchemiczne',
	'%1 alchemy lab': ['%1 laboratorium alchemiczne', '%1 laboratoria alchemiczne'],
	...
	"[Alchemy lab business quote]You're officially on the stock market, and everyone wants a piece!":
		'Oficjalnie jesteś już na giełdzie i każdy chce tutaj zarobić!',
	Portal: 'Brama',
	portal: '/',
	portals: 'portale',
	'%1 portal': ['%1 portal', '%1 portale'],
	...
	'[Portal business quote]Your cookies have their own sitcom! Hilarious baking hijinks set to the cheesiest laughtrack.':
		'Twoje ciastka mają swój własny serial! Przezabawne perypetie cukiernicze podkręcone do niedorzecznie przaśnego poziomu.',
	'Time machine': 'Wehikuł czasu',
	'time machine': 'wehikuł czasu',
	'time machines': 'wehikuły czasu',
	'%1 time machine': ['%1 wehikuł czasu', '%1 wehikuły czasu'],
	'[Time machine quote]Brings cookies from the past, before they were even eaten.':
		'Przywołuje ciastka z przeszłości, zanim zdążą zostać zjedzone.',
	...
	'[Time machine business quote]Cookie theme parks, full of mascots and roller-coasters. Build one, build a hundred!':
		'Ciastkowy park zabaw, pełen maskotek i kolejek górskich. Postaw jeden, a zapragniesz ich setki!',
	'Antimatter condenser': 'Kondensator antymaterii',
	'antimatter condenser': 'kondensator antymaterii',
	'antimatter condensers': 'kondensatory antymaterii',
	'%1 antimatter condenser': ['%1 kondensator antymaterii', '%1 kondensatory antymaterii'],
	'[Antimatter condenser quote]Condenses the antimatter in the universe into cookies.':
		'Kondensuje antymaterię wszechświata do postaci ciastek.',
	...
	'[Antimatter condenser business quote]A virtual currency, already replacing regular money in some small countries.':
		'Wirtualna waluta, która już wypiera tradycyjne środki płatnicze w niektórych mniejszych krajach.',
	Prism: 'Pryzma',
	prism: 'pryzma',
	prisms: 'pryzmy',
	'%1 prism': ['%1 pryzma', '%1 pryzmy'],
	...
	"[Prism business quote]You've made it to the top, and you can now buy entire nations to further your corporate greed. Godspeed.":
		'Dotarłeś na sam szczyt. Oto miejsce, z którego możesz kupować całe narody, aby zaspokajać swój korporacyjny apetyt. Powodzenia.',
	Chancemaker: 'Koło fortuny',
	chancemaker: 'koło fortuny',
	chancemakers: 'koła fortuny',
	'%1 chancemaker': ['%1 koło fortuny', '%1 koła fortuny'],
	'[Chancemaker quote]Generates cookies out of thin air through sheer luck.':
		'Tworzy ciastka z powietrza z domieszką czystego szczęścia.',
	...
	"[Chancemaker business quote]Actually, you know what's cool? A whole planet dedicated to producing, advertising, selling, and consuming your cookies.":
		'Wiesz, co w tym fajnego? Cała planeta dedykowana jedynie produkcji, reklamie, sprzedaży i konsumowaniu twoich ciastek.',
	'Fractal engine': 'Silnik fraktalny',
	'fractal engine': 'silnik fraktalny',
	'fractal engines': 'silniki fraktalne',
	'%1 fractal engine': ['%1 silnik fraktalny', '%1 silniki fraktalne'],
	'[Fractal engine quote]Turns cookies into even more cookies.':
		'Zamienia ciastka w jeszcze więcej ciastek.',
	...
	'[Fractal engine business quote]Only through political dominion can you truly alter this world to create a brighter, more cookie-friendly future.':
		'Tylko polityczna dominacja sprawi, że będziesz mógł naprawdę przemienić ten świat w radosną krainę, mlekiem i ciastkami płynącą.',
	'Javascript console': 'Konsola javascript',
	'javascript console': 'konsola javascript',
	'javascript consoles': 'konsole javascript',
	'%1 javascript console': ['%1 konsola javascript', '%1 konsole javascript'],
	'[Javascript console quote]Creates cookies from the very code this game was written in.':
		'Tworzy ciastka za pomocą tego samego kodu, którego użyliśmy do napisania tej gry.',
	...
	'[Javascript console business quote]Taking many forms -religion, culture, philosophy- a doctrine may, when handled properly, cause a lasting impact on civilizations, reshaping minds and people and ensuring all future generations share a singular goal - the production, and acquisition, of more cookies.':
		'Przybrawszy jedną z wielu form — religii, kultury, filozofii — doktryna może, jeśli się za nią odpowiednio zabrać, wywrzeć trwały ślad na cywilizacjach, kształtując umysły ludzkie oraz sprawiając, by wszystkie przyszłe pokolenia dążyły do wspólnego celu: produkcji i pozyskiwania jak największej ilości ciastek.',
	Idleverse: 'Próżnoświat',
	idleverse: 'próżnoświat',
	idleverses: 'próżnoświaty',
	'%1 idleverse': ['%1 próżnoświat', '%1 próżnoświaty'],
	"[Idleverse quote]There's been countless other idle universes running alongside our own. You've finally found a way to hijack their production and convert whatever they've been making into cookies!":
		'Istnieje nieskończenie wiele bezczynnych światów. Na szczęście w końcu poznałeś sposób, jak przejąć ich produkcję i zmusić ich do produkcji ciastek!',
	...
	'[Idleverse business quote]Sometimes the best way to keep going up is sideways. Diversify your ventures through non-cookie investments.':
		'Czasem najlepszym sposobem, aby iść w górę, to przeć na boki. Dywersyfikuj swój przychód za pomocą różnych nieciastkowych inwestycji.',
	'Cortex baker': 'Rdzeniowy piekarz',
	'cortex baker': 'rdzeniowy piekarz',
	'cortex bakers': 'rdzeniowi piekarze',
	'%1 cortex baker': ['%1 rdzeniowy piekarz', '%1 rdzeniowi piekarze'],
	'[Cortex baker quote]These artificial brains the size of planets are capable of simply dreaming up cookies into existence. Time and space are inconsequential. Reality is arbitrary.':
		'Te sztuczne mózgi rozmiarów planety zdolne są do materializowania ciastek zaledwie siłą umysłu. Czas i odległość nie grają roli a rzeczywistość jest kwestią umowną.',
	...
	"[Cortex baker business quote]There's only so many ways you can bring in more profit. Or is there? Hire the most brilliant experts in the known universe and let them scrape their brains for you!":
		'Sposobów na jeszcze szybsze zarabianie jest ograniczona ilość. Ale czy na pewno? Zatrudnij najznakomitszych ekspertów z całego poznanego świata i każ im dumać tylko dla ciebie!',
	CpS: 'CnS',
	...
	'All cookie production <b>multiplied by %1</b>.':
		'Cała produkcja ciastek <b>pomnożona przez %1</b>.',
	'+%1 CpS': '+%1 CnS',
	...
	'Tiered upgrades for <b>%1</b> provide an extra <b>+%2%</b> production.<br>Only works with unshackled upgrade tiers.':
		'Rzędowe ulepszenia dla <b>%1</b> zapewniają dodatkowe <b>+%2%</b> do produkcji.<br>Działa tylko na odblokowanych rzędach ulepszeń.',
	'Unshackles all <b>%1-tier upgrades</b>, making them more powerful.<br>Only applies to unshackled buildings.':
		'Odblokowuje wszystkie <b>ulepszenia %1-rzędu</b>, wzmacniając je jeszcze bardziej.<br>Działa tylko na odblokowanych budynkach.',
	'The mouse and cursors are <b>twice</b> as efficient.':
		'Mysz i kursor są <b>dwukrotnie</b> wydajniejsze.',
	'The mouse and cursors gain <b>+%1</b> cookies for each non-cursor building owned.':
		'Mysz i kursor dają <b>+%1</b> ciastek za każdy posiadany budynek nie będący kursorem.',
	'Grandmas gain <b>+%1% CpS</b> for each non-grandma building.':
		'Babcie dają <b>+%1% CnS</b> za każdy budynek nie będący babcią.',
	'You gain <b>more CpS</b> the more milk you have.':
		'Otrzymujesz <b>więcej CnS</b>, jeśli masz więcej mleka.',
	...
	'Cookie production multiplier <b>+%1% permanently</b>.':
		'Mnożnik produkcji ciastek <b>+%1% na zawsze</b>.',
	"Cookie production multiplier <b>+%1% per Santa's levels.</b>":
		'Mnożnik produkcji ciastek <b>+%1% na poziom św. Mikołaja.</b>',
	'Cookie production multiplier <b>+%1%</b> for every year Cookie Clicker has existed (currently: <b>+%2%</b>).':
		'Mnożnik produkcji ciastek <b>+%1%</b> za każdy rok, w którym działa Cookie Clicker (aktualnie: <b>+%2%</b>).',
	'Cookie production multiplier <b>+%1%</b> for every building type level %2 or higher.':
		'Mnożnik produkcji ciastek <b>+%1%</b> za każdy rodzaj budynku na poziomie %2 lub wyższym.',
	...
	'Grandma-operated science lab and leisure club.<br>Grandmas are <b>4 times</b> as efficient.<br><b>Regularly unlocks new upgrades</b>.':
		'Prowadzone przez babcie laboratorium naukowe wraz z klubem seniora.<br>Babcie są <b>4 razy</b> skuteczniejsze.<br><b>Regularnie odblokowuje nowe ulepszenia</b>.',
	'Each %1 gains <b>+%2 base CpS per %3</b>.':
		'Każde %1 daje <b>+%2 bazowej wartości CnS na %3</b>.',
	'Note: the grandmothers are growing restless. Do not encourage them.':
		'Uwaga: Babcie się niecierpliwią. Nie zachęcaj ich.',
	'Note: proceeding any further in scientific research may have unexpected results. You have been warned.':
		'Uwaga: Kontynuowanie badań naukowych może mieć nieprzewidziane skutki. Ostrzegamy.',
	...
	"<b>Warning:</b> purchasing this will have unexpected, and potentially undesirable results!<br><small>It's all downhill from here. You have been warned!</small><br><br>Purchase anyway?":
		'<b>Ostrzeżenie:</b> zakupienie tego będzie miało nieprzewidziane i potencjalnie niepożądane skutki!<br><small>Jesteś już na równi pochyłej. Ostrzegaliśmy cię!</small><br><br>Na pewno chcesz to kupić?',
	'Contains the wrath of the elders, at least for a while.':
		'Powstrzymuje gniew starszyzny, a przynajmniej na chwilę.',
	"Puts a permanent end to the elders' wrath, at the cost of %1% of your CpS.":
		'Na stałe powstrzymuje gniew starszyzny, ale za cenę %1% twojej wartości CnS.',
	'You will get %1% of your CpS back, but the grandmatriarchs will return.':
		'Otrzymasz z powrotem %1% swojej wartości CnS, ale arcymatrony powrócą.',
	...
	'Golden cookies appear <b>twice as often</b> and stay <b>twice as long</b>.':
		'Złote ciastka pojawiają się <b>dwa razy częściej</b> oraz pozostają <b>dwa razy dłużej</b>.',
	'Golden cookies appear <b>%1%</b> more often.':
		'Złote ciastka pojawiają się <b>%1%</b> częściej.',
	'Golden cookies appear <b>%1%</b> more often during %2.':
		'Złote ciastka pojawiają się <b>%1%</b> częściej, jeśli jest %2.',
	'Golden cookies appear <b>really often</b>.':
		'Złote ciastka pojawiają się <b>naprawdę często</b>.',
	'Golden cookie effects last <b>twice as long</b>.':
		'Skutki działania złotych ciastek utrzymują się <b>dwa razy dłużej</b>.',
	'Golden cookie effects last <b>%1%</b> longer.':
		'Skutki działania złotych ciastek utrzymują się <b>%1%</b> dłużej.',
	...
	'<b>+%1% CpS</b> per golden cookie on-screen, multiplicative.':
		'<b>+%1% do CnS</b> za każde złote ciastko na ekranie. Wartości mnożą się.',
	'With no buffs and no golden cookies on screen, selling your most powerful building has <b>%1% chance to summon one</b>.':
		'Jeśli nie masz wzmocnień i złotych ciastek na ekranie, sprzedanie najpotężniejszego budynku ma <b>%1% szansy na wezwanie jednego z nich</b>.',
	'Confers various powers to your minigames while active.<br>See the bottom of each minigame for more details.':
		'Po włączeniu przekazuje ci różne moce podczas zabawy w minigierkach.<br>Więcej informacji znajdziesz na dole każdej minigierki.',
	'Elder pledges last <b>twice</b> as long.':
		'Obietnice starszyzny trwają <b>dwukrotnie</b> dłużej.',
	'Can toggle upgrades on and off at will in the stats menu.':
		'Możesz dowoli włączać i wyłączać ulepszenia w menu statystyk.',
	'You keep producing cookies even while the game is closed.':
		'Ciastka będą tworzone nadal po zamknięciu gry.',
	'Unlocks <b>%1%</b> of the potential of your prestige level.':
		'Odblokowuje <b>%1%</b> potencjału zgodnego z twoim poziomem prestiżu.',
	'Subsequent research will be <b>%1 times</b> as fast.':
		'Następne badania odbywać się będą <b>%1 razy</b> szybciej.',
	'Wrinklers appear <b>%1 times</b> as fast.':
		'Zmarszczkacze pojawiają się <b>%1 razy</b> szybciej.',
	...
	'Wrinklers explode into <b>%1% more cookies</b>.':
		'Po eksplozji zmarszczkacze dają ci <b>%1% więcej ciastek</b>.',
	...
	'Cost scales with how many eggs you own.':
		'Koszt skaluje się zgodnie z ilością posiadanych jajek.',
	...
	'Buildings sell back for <b>%1%</b> instead of %2%.':
		'Budynki można odsprzedawać za <b>%1%</b>, a nie za %2%.',
	...
	'All buildings and upgrades are <b>%1% cheaper</b>.':
		'Wszystkie budynki i ulepszenia są <b>%1% tańsze</b>.',
	'%1 are <b>%2%</b> more efficient and <b>%3%</b> cheaper.':
		'%1 są <b>%2%</b> wydajniejsze oraz <b>%3%</b> tańsze.',
	...
	'Allows you to <b>trigger seasonal events</b> at will, for a price.':
		'Za konkretną opłatą pozwala na dowolną <b>aktywację sezonowych wydarzeń</b>.',
	'Triggers <b>%1 season</b> for the next 24 hours.<br>Triggering another season will cancel this one.<br>Cost scales with unbuffed CpS and increases with every season switch.':
		'Aktywuje <b>%1 sezon</b> na kolejne 24 godziny.<br>Aktywowanie kolejnego sezonu anuluje bieżący sezon.<br>Koszt skaluje się zgodnie z niewzmocnioną wartością CnS oraz zwiększa się z każdą zmianą sezonu.',
	...
	"You haven't switched seasons this ascension yet.":
		'Nie zmieniłeś jeszcze sezonu podczas tego wzniesienia.',
	"You've switched seasons <b>once</b> this ascension.":
		'Podczas bieżącego wzniesienia zmieniłeś sezon <b>raz</b>. ',
	"You've switched seasons <b>%1 times</b> this ascension.":
		'Podczas bieżącego wzniesienia zmieniłeś sezon <b>%1 razy</b>.',
	...
	'Christmas cookies drop <b>%1%</b> more often.':
		'Świąteczne ciastka wypadają <b>%1%</b> częściej.',
	...
	"You continually gain <b>more CpS the longer you've played</b> in the current ascension.":
		'Ciągle otrzymujesz <b>coraz więcej CnS, im dłużej grasz</b> w danym wzniesieniu.',
	...
	'Contains an assortment of rich butter cookies.':
		'Zawiera całą masę eleganckich, maślanych ciasteczek.',
	...
	'Placing an upgrade in this slot will make its effects <b>permanent</b> across all playthroughs.':
		'Umieszczenie ulepszenia w tym miejscu spowoduje, że jego efekty będą <b>utrzymywać się</b> we wszystkich rozgrywkach.',
	...
	'Here are all the upgrades you\'ve purchased last playthrough.<div class="line"></div>Pick one to permanently gain its effects!<div class="line"></div>You can reassign this slot anytime you ascend.':
		'Oto wszystkie ulepszenia, które zakupiłeś w trakcie ostatniej rozgrywki. <div class="line"></div>Wybierz jedno, aby cieszyć się na stałe jego efektami! <div class="line"></div>Możesz w to miejsce umieścić inne ulepszenie przy każdym wzniesieniu.',
	'You now <b>keep making cookies while the game is closed</b>, at the rate of <b>%1%</b> of your regular CpS and up to <b>1 hour</b> after the game is closed.<br>(Beyond 1 hour, this is reduced by a further %2% - your rate goes down to <b>%3%</b> of your CpS.)':
		'Nadal będziesz <b>piekł ciastka, choć gra jest wyłączona</b>. Prędkość wyniesie <b>%1%</b> twojej podstawowej wartości CnS, aż do <b>1 godziny</b> po wyjściu z gry.<br>(Godzinę później, prędkość pieczenia ciastek spada do %2% — wynosi teraz <b>%3%</b> twojej wartości CnS.)',
	'You gain another <b>+%1%</b> of your regular CpS while the game is closed.':
		'Zyskujesz dodatkowe <b>+%1%</b> swojej podstawowej wartości CnS, gdy gra jest wyłączona.',
	'You gain another <b>+%1%</b> of your regular CpS while the game is closed, for a total of <b>%2%</b>.':
		'Zyskujesz dodatkowe <b>+%1%</b> swojej podstawowej wartości CnS, gdy gra jest wyłączona, aż do maksymalnie <b>%2%</b>.',
	'You start with <b>%1</b>.': 'Zaczynasz od <b>%1</b>.',
	'Allows you to purchase a <b>crumbly egg</b> once you have earned 1 million cookies.':
		'Umożliwia zakup <b>kruchego jajka</b>, gdy tylko zarobisz 1 milion ciastek.',
	...
	'You retain optimal cookie production while the game is closed for <b>%1 more days</b>.':
		'Zachowujesz optymalną prędkość produkcji ciastek po wyjściu z gry przez <b>%1 więcej dni</b>.',
	'You retain optimal cookie production while the game is closed for twice as long, for a total of <b>%1</b>.':
		'Zachowujesz optymalną prędkość produkcji ciastek po wyjściu z gry dwa razy dłużej, aż do <b>%1</b>.',
	'Unlocks the <b>golden switch</b>, which passively boosts your CpS by %1% but disables golden cookies.':
		'Odblokowuje <b>złoty przełącznik</b>, który pasywnie zwiększa twoją wartość CnS o %1%, ale dezaktywuje złote ciastka.',
	'Turning this on will give you a passive <b>+%1% CpS</b>, but prevents golden cookies from spawning.<br>Cost is equal to 1 hour of production.':
		'Włączenie tego sprawi, że otrzymasz pasywnie <b>+%1% do wartości CnS</b>, ale całkowicie wyeliminuje złote ciastka.<br>Koszt równy jest 1 godzinie produkcji.',
	'The switch is currently giving you a passive <b>+%1% CpS</b>; it also prevents golden cookies from spawning.<br>Turning it off will revert those effects.<br>Cost is equal to 1 hour of production.':
		'Przełącznik aktualnie daje ci pasywnie <b>+%1% do wartości CnS</b>, ale także zapobiega przed pojawianiem się złotych ciastek.<br>Wyłączenie tego sprawi, że efekty zostaną anulowane.<br>Koszt równy jest 1 godzinie produkcji.',
	'Unlocks the <b>milk selector</b>, letting you pick which milk is displayed under your cookie.<br>Comes with a variety of basic flavors.':
		'Odblokowuje <b>wybierak mleka</b>, dzięki któremu możesz wybierać rodzaj mleka, które pojawi się pod twoim ciastkiem.<br>Jest dostępne w różnych podstawowych smakach.',
	'Contains more exotic flavors for your milk selector.':
		'Zawiera bardziej egzotyczne smaki mleka.',
	...
	'Unlocks the <b>golden cookie sound selector</b>, which lets you pick whether golden cookies emit a sound when appearing or not.':
		'Odblokowuje <b>wybierak dźwięku złotych ciastek</b>, dzięki któremu możesz wybrać, czy złote ciastka mają wydawać dźwięk, gdy się pojawiają.',
	'Lets you change the sound golden cookies make when they spawn.':
		'Pozwala ci zmienić dźwięk wydawany przez pojawiające się złote ciastka.',
	...
	'Unlocks the <b>jukebox</b>, which allows you to play through every sound file in the game.':
		'Odblokowuje <b>szafę grającą</b>, która pozwala na odtwarzanie wszystkich plików dźwiękowych znajdujących się w grze.',
	...
	"Unlocks the <b>background selector</b>, letting you select the game's background.<br>Comes with a variety of basic flavors.":
		'Odblokowuje <b>wybierak tła</b>, dzięki któremu możesz wybrać tło gry.<br>Jest dostępne w różnych podstawowych smakach.',
	...
	'This is the first heavenly upgrade; it unlocks the <b>Heavenly chips</b> system.<div class="line"></div>Each time you ascend, the cookies you made in your past life are turned into <b>heavenly chips</b> and <b>prestige</b>.<div class="line"></div><b>Heavenly chips</b> can be spent on a variety of permanent transcendental upgrades.<div class="line"></div>Your <b>prestige level</b> also gives you a permanent <b>+1% CpS</b> per level.':
		'Oto pierwsze niebiańskie ulepszenie. Odblokowuje ono system <b>Niebiańskich żetonów</b>.<div class="line"></div>Przy każdym kolejnym wzniesieniu wszystkie zgromadzone przez ciebie w poprzednim życiu ciastka są przemieniane na <b>niebiańskie żetony</b> oraz <b>prestiż</b>.<div class="line"></div><b>Niebiańskie żetony</b> można wydawać na wiele różnych, stałych ulepszeń niebiańskich.<div class="line"></div>Twój <b>poziom prestiżu</b> także daje ci stałą wartość <b>+1% CnS</b> na poziom.',
	'You can attract <b>%1 more wrinklers</b>.':
		'Przyciągasz <b>%1 jeszcze więcej zmarszczkaczy</b>.',
	'While the golden switch is on, you gain an additional <b>+%1% CpS</b> per golden cookie upgrade owned.':
		'Gdy złoty przełącznik jest włączony, otrzymujesz dodatkowe <b>+%1% CnS</b> na każde posiadane ulepszenie złotego ciastka.',
	'All upgrades are <b>%1% cheaper per %2</b>.':
		'Wszystkie ulepszenia są <b>%1% tańsze przez %2</b>.',
	'Unlocks a new tier of upgrades that affect <b>2 buildings at the same time</b>.<br>Synergies appear once you have <b>%1</b> of both buildings.':
		'Odblokowuje nowy poziom ulepszeń, które wpływają na <b>2 budynki jednocześnie</b>.<br>Pojawiają się synergie, gdy tylko posiądziesz <b>%1</b> z obu budynków.',
	'Golden cookies (and all other things that spawn, such as reindeer) have <b>%1% chance of being doubled</b>.':
		'Złote ciastka (oraz wszystkie inne pojawiające się rzeczy, jak renifery) mają <b>%1% szansy na pojawienie się w ilości dwóch</b>.',
	'Cookie production <b>reduced to 0</b>.': 'Produkcja ciastek <b>zredukowana do 0</b>.',
	'Sugar lumps coalesce <b>a whole lot faster</b>.':
		'Grudki cukru krzepną <b>zdecydowanie szybciej</b>.',
	'<b>+%1%</b> prestige level effect on CpS.':
		'<b>+%1%</b> do efektu działania poziomu prestiżu na wartość CnS.',
	'<b>+%1%</b> prestige level effect on CpS.<br><b>+%2%</b> golden cookie effect duration.<br><b>+%3%</b> golden cookie lifespan.':
		'<b>+%1%</b> do efektu działania poziomu prestiżu na wartość CnS.<br><b>+%2%</b> do czasu działania złotych ciastek.<br><b>+%3%</b> do czasu życia złotych ciastek.',
	'Each unspent sugar lump (up to %1) gives <b>+%2% CpS</b>.<div class="warning">Note: this means that spending sugar lumps will decrease your CpS until they grow back.</div>':
		'Każda niewykorzystana grudka cukru (aż do %1) daje ci <b>+%2% wartości CnS</b>.<div class="warning">Uwaga: oznacza to, że wydawanie grudek cukru będzie pomniejszało twoją wartość CnS, aż do momentu, gdy grudki odrosną.</div>',
	'Once an ascension, you may use the "Sugar frenzy" switch to <b>triple your CpS</b> for 1 hour, at the cost of <b>1 sugar lump</b>.':
		'Podczas wzniesienia możesz użyć przełącznika „Cukrowego szału”, aby <b>potroić twoją wartość CnS</b> przez 1 godzinę, kosztem <b>1 grudki cukru</b>.',
	'Each grandma (up to %1) makes sugar lumps ripen <b>%2</b> sooner.':
		'Każda babcia (aż do %1) sprawia, że grudki cukru dojrzewają <b>%2</b> szybciej.',
	'Activating this will <b>triple your CpS</b> for 1 hour, at the cost of <b>1 sugar lump</b>.':
		'Aktywowanie tego <b>potroi twoją wartość CnS</b> przez 1 godzinę, kosztem <b>1 grudki cukru</b>.',
	...
	'Garden plants grow every second.<br>Garden seeds are free to plant.<br>You can switch soils at any time.':
		'Rośliny w ogrodzie rosną co sekundę.<br>Można za darmo siać w ogrodzie.<br>Możesz w dowolnym momencie zmieniać glebę.',
	...
	'Sugar lumps are <b>twice as likely</b> to be unusual.':
		'Szansa, że grudki cukru będą nadzwyczajne, wzrasta <b>dwukrotnie</b>.',
	...
	'Bifurcated sugar lumps appear <b>%1% more often</b> and are <b>%2% more likely</b> to drop 2 lumps.':
		'Rozwidlone grudki cukru pojawiają się <b>%1% częściej</b> oraz dają <b>%2% większą szansę</b> na pozostawienie 2 grudek.',
	'Mouse over a wrinkler to see how many cookies are in its stomach.':
		'Najedź myszą na zmarszczkacza, aby przekonać się, ile ciastek ma w brzuchu.',
	'Unlocks the <b>Buy all</b> feature, which lets you instantly purchase every upgrade in your store (starting from the cheapest one).<br>Also unlocks the <b>Vault</b>, a store section where you can place upgrades you do not wish to auto-buy.':
		'Odblokowuje opcję <b>Kup wszystko</b>, która pozwala na natychmiastowy zakup każdego ulepszenia dostępnego w twoim sklepie (rozpoczynając od najtańszego).<br>Odblokowuje też <b>Skarbiec</b> — miejsce w sklepie, w którym możesz umieścić ulepszenia, aby nie zostały zakupione automatycznie.',
	'Mouse over an upgrade to see its tier.<br><small>Note: only some upgrades have tiers. Tiers are purely cosmetic and have no effect on gameplay.</small>':
		'Najedź myszą na ulepszenie, aby zobaczyć jego poziom.<br><small>Uwaga: Nie wszystkie ulepszenia mają poziomy. Poziomy są czymś czysto kosmetycznym i nie wpływają na rozgrywkę.</small>',
	'You now benefit from the boost provided by <b>heralds</b>.<br>Each herald gives you <b>+1% CpS</b>.<br>Look on the purple flag at the top to see how many heralds are active at any given time.':
		'Możesz stać się beneficjentem wzmocnień oferowanych przez <b>heraldów</b>.<br>Każdy herald daje <b>+1% wartości CnS</b>.<br>Spójrz na fioletową flagę na szczycie, aby przekonać się, ilu heraldów jest aktywnych w danym momencie.',
	'Seasonal random drops have a <b>1/5 chance</b> to carry over through ascensions.':
		'Jest <b>1/5 szansy</b>, że sezonowe losowe znajdźki przejdą do kolejnego wzniesienia.',
	"Unlocks <b>extra price information</b>.<br>Each displayed cost now specifies how long it'll take you to afford it, and how much of your bank it represents.":
		'Odblokowuje <b>dodatkowe informacje o cenach</b>.<br>Pod każdą ceną widnieje informacja, jak długo będziesz na daną rzecz zbierać oraz jaką część twojego banku ona reprezentuje.',
	...
	'Boosts your cookie production by <b>%1%</b> when active.<br>The veil is very fragile and will break if you click the big cookie or any golden cookies or reindeer.<br><br>Once broken, turning the veil back on costs %2 of unbuffed CpS.':
		'Jeśli jest włączona, zwiększa produkcję ciastek o <b>%1%</b>.<br>Zasłona jest bardzo słaba i ulegnie przełamaniu, jeśli klikniesz jakiekolwiek duże lub złote ciastko, albo choćby renifera.<br><br>Jeśli to nastąpi, przywrócenie zasłony będzie kosztowało %2 wartości twoich niezwiększonych CnS.',
	'Has a <b>%1%</b> chance to not break.':
		'Istnieje <b>%1%</b> szansy, że nie ulegnie przełamaniu.',
	'The <b>shimmering veil</b> is more resistant, and has a <b>%1% chance</b> not to break. It also gives <b>+%2%</b> more CpS.':
		'<b>Błyszcząca zasłona</b> jest odporniejsza, dzięki czemu istnieje <b>%1% szansy</b>, że nie ulegnie przełamaniu. Ponadto zasłona zwiększa twoją wartość CnS o <b>+%2%</b>.',
	'Active.': 'Aktywna.',
	'The reinforced membrane protects the shimmering veil.':
		'Błyszczącą zasłonę chroni też wzmocniona membrana.',
	...
	'Prior to purchasing the <b>%1</b> upgrade in a run, random drops are <b>%2 times more common</b>.':
		'Przed zakupem ulepszenia <b>%1</b> w danej rozgrywce, częstotliwość pojawiania się losowych znajdziek wzrasta <b>%2 razy</b>.',
	...
	"You don't know what you have until you've lost it.":
		'Człowiek nie szanuje tego, co ma, dopóki tego nie utraci.',
	...
	'The news ticker may occasionally have <b>fortunes</b>, which may be clicked for something good.':
		'Na pasku wiadomości od czasu do czasu pojawiać się będą ikony <b>wróżby</b>, które można kliknąć, aby otrzymać coś dobrego.',
	'Through clever accounting, this actually makes kitten upgrades <b>%1% cheaper</b>.':
		'Kreatywna księgowość sprawia, że kocie ulepszania stają się <b>%1% tańsze</b>.',
	'Unlocks the ability to <b>pet your dragon</b> by clicking on it once hatched.':
		'Odblokowuje możliwość <b>głaskania swojego smoka</b>. Aby tego dokonać, kliknij go, gdy już się wykluje.',
	'Cost scales with CpS, but %1 times cheaper with a fully-trained dragon.':
		'Koszt skaluje się wraz z poziomem twojej wartości CnS, ale z w pełni wyszkolonym smokiem jest mniejszy o %1.',
	'Golden cookies may trigger a <b>Dragon Harvest</b>.':
		'Złote ciastka mogą wywołać <b>Smocze żniwa</b>.',
	'Golden cookies may trigger a <b>Dragonflight</b>.':
		'Złote ciastka mogą wywołać <b>Lot smoka</b>.',
	'Dragon harvest and Dragonflight are <b>%1% stronger</b>.':
		'Smocze żniwa oraz Lot smoka są <b>%1% silniejsze</b>.',
	'Kittens are <b>%1%</b> more effective.': 'Kocięta są <b>%1%</b> wydajniejsze.',
	'Each kitten upgrade boosts %1 CpS by <b>%2%</b>.':
		'Każde kocie ulepszenie zwiększa CnS obiektu "%1" o <b>%2%</b>.',
	'Each rank of milk boosts %1 CpS by <b>%2%</b>.':
		'Każdy poziom mleka zwiększa %1 twoich CnS o <b>%2%</b>.',
	'Cursor levels boost clicks by <b>%1%</b> each (up to cursor level %2).':
		'Każdy poziom kursora zwiększa kliknięcia o <b>%1%</b> (aż do poziomu %2).',
	'<b>%1</b> are now effective up to cursor level %2.':
		'<b>%1</b> są skuteczne do poziomu kursora %2.',
	...
	'Golden and wrath cookie effect duration +%1%.':
		'Czas trwania efektu złotych i gniewnych ciastek +%1%.',
	'Golden and wrath cookies appear %1% more.':
		'Złote i gniewne ciastka pojawiają się %1% częściej.',
	'Golden and wrath cookies appear %1% less.':
		'Złote i gniewne ciastka pojawiają się %1% rzadziej.',
	'Buildings grant -%1% CpS.': 'Budynki przyznają -%1% CnS.',
	'Selling buildings triggers a buff boosted by how many buildings were sold.':
		'Sprzedaż budynków powoduje doładowanie zależne od liczby sprzedanych budynków.',
	'Buff boosts clicks by +%1% for every building sold for %2 seconds.':
		'Doładowanie przyspiesza kliknięcia o +%1% za każdy sprzedany budynek przez %2 sek.',
	...
	'All golden cookies are wrath cookies with a greater chance of a negative effect.':
		'Wszystkie złote ciastka są gniewnymi ciastkami o zwiększonym ryzyku negatywnych efektów.',
	'Wrinklers appear %1% faster and digest %2% more cookies.':
		'Zmarszczkacze pojawiają się %1% szybciej i pożerają %2% więcej ciastek.',
	'Effect is only active when your total amount of buildings ends with 0.':
		'Efekt jest aktywny, tylko jeśli ilość Twoich budynków kończy się na 0.',
	...
	'Make <b>%1</b> by only having clicked <b>%2 times</b>.':
		'Zdobądź <b>%1</b>, wykonując jedynie <b>%2 kliknięcia</b>.',
	'Make <b>%1</b> with <b>no</b> cookie clicks.':
		'Zdobądź <b>%1</b>, nie kliknąwszy <b>żadnego</b> ciastka.',
	'Get to <b>%1</b> baked with <b>no upgrades purchased</b>.':
		'Dotrzyj do <b>%1</b>, piekąc <b>bez kupowania żadnych ulepszeń</b>.',
	...
	'Have <b>at least %1</b> of every building.':
		'Posiadaj każdy budynek w ilości <b>co najmniej %1</b> .',
	'Have at least <b>1 of the most expensive object, 2 of the second-most expensive, 4 of the next</b> and so on (capped at %1).':
		'Posiadaj co najmniej <b>1 najdroższy budynek, 2 budynki drugie pod względem ceny, 4 kolejne</b> i tak dalej (limit na %1).',
	'Have at least <b>10 of the most expensive object, 20 of the second-most expensive, 30 of the next</b> and so on.':
		'Posiadaj co najmniej <b>10 najdroższych obiektów, 20 obiektów drugich pod względem ceny, 30 kolejnych</b> i tak dalej.',
	...
	'Appease the grandmatriarchs at least <b>once</b>.':
		'Uspokój arcymatronę przynajmniej <b>raz</b>.',
	'Appease the grandmatriarchs at least <b>%1 times</b>.':
		'Uspokój arcymatronę przynajmniej <b>%1 razy</b>.',
	...
	'Unlock <b>100%</b> of your heavenly chips power.':
		'Odblokuj <b>100%</b> mocy swoich niebiańskich żetonów.',
	'You have <b>1 chance in %1</b> every second of earning this achievement.':
		'Każdej sekundy masz <b>1 szansę na %1</b> na zdobycie tego osiągnięcia.',
	...
	'Unlock <b>every Halloween-themed cookie</b>.<div class="line"></div>Owning this achievement makes Halloween-themed cookies drop more frequently in future playthroughs.':
		'Odblokuj <b>wszystkie ciasta z motywem Halloween</b>.<div class="line"></div>Zdobycie tego osiągnięcia sprawi, że w przyszłych rozgrywkach ciastka z motywem Halloween będą pojawiać się częściej.',
	...
	'Unlock <b>every Christmas-themed cookie</b>.<div class="line"></div>Owning this achievement makes Christmas-themed cookies drop more frequently in future playthroughs.':
		'Odblokuj <b>wszystkie ciasta z motywem Bożego Narodzenia</b>.<div class="line"></div>Zdobycie tego osiągnięcia sprawi, że w przyszłych rozgrywkach ciastka z motywem Bożego Narodzenia będą pojawiać się częściej.',
	...
	'Pop a reindeer <b>during an elder frenzy</b>.':
		'Rozgnieć renifera <b>podczas szału starszyzny</b>.',
	'Unlock <b>every Valentine-themed cookie</b>.':
		'Odblokuj <b>wszystkie ciastka z motywem walentynkowym</b>.',
	'Click the tiny cookie.': 'Kliknij malutkie ciastko.',
	'This is for baking %1 and making it on the local news.':
		'To za upieczenie %1 oraz pójście z tym do lokalnych mediów.',
	'Name yourself <b>Orteil</b>.<div class="warning">Note: usurpers incur a -%1% CpS penalty until they rename themselves something else.</div>':
		'Nazwij się <b>Orteil</b>.<div class="warning">Uwaga: uzurpatorzy otrzymują karę -%1% do wartości CnS aż do momentu, gdy się przemianują na coś innego.</div>',
	...
	'Unlock <b>all the eggs</b>.<div class="line"></div>Owning this achievement makes eggs drop more frequently in future playthroughs.':
		'Odblokuj <b>wszystkie jajka</b>.<div class="line"></div>Zdobycie tego osiągnięcia sprawi, że w przyszłych rozgrywkach jajka będą pojawiały się częściej.',
	...
	'Own <b>%1</b> upgrades and <b>%2</b> buildings.':
		'Posiadaj <b>%1</b> ulepszeń oraz <b>%2</b> budynków.',
	'Own <b>%1</b> heavenly upgrades.': 'Posiadaj <b>%1</b> niebiańskich ulepszeń.',
	'Burst the near-extinct <b>shiny wrinkler</b>.':
		'Rozgnieć niemal już wymarłego <b>błyszczącego zmarszczkacza</b>.',
	'Click a golden cookie <b>less than 1 second after it spawns</b>.':
		'Kliknij złote ciastko <b>w mniej niż sekundę po jego pojawieniu się</b>.',
	'Click a golden cookie <b>less than 1 second before it dies</b>.':
		'Kliknij złote ciastko <b>w mniej niż sekundę przed jego śmiercią</b>.',
	...
	"Successfully harvest a coalescing sugar lump before it's ripe.":
		'Zbierz krzepnącą grudkę cukru, zanim ta dojrzeje.',
	...
	'Convert a complete seed log into sugar lumps by sacrificing your garden to the sugar hornets.<div class="line"></div>Owning this achievement makes seeds <b>%1% cheaper</b>, plants mature <b>%2% sooner</b>, and plant upgrades drop <b>%3% more</b>.':
		'Przekształć swój dziennik nasion na grudki cukru, oddając swój ogród cukrowym szerszeniom. <div class="line"></div>Posiadanie tego osiągnięcia sprawia, że nasiona są <b>%1% tańsze</b>, rośliny dojrzewają <b>%2% szybciej</b> a ulepszenia roślin wypadają <b>%3% częściej</b>.',
	'Ascend with exactly <b>%1</b>.': 'Wznieś się z dokładnie <b>%1</b>.',
	'Have your <b>reinforced membrane</b> protect the <b>shimmering veil</b>.':
		'Spraw, żeby <b>wzmocniona membrana</b> ochroniła twoją <b>błyszczącą zasłonę</b>.',
	'Own every <b>fortune upgrade</b>.<div class="line"></div>Owning this achievement makes fortunes appear <b>twice as often</b>; unlocked fortune upgrades also have a <b>%1% chance</b> to carry over after ascending.':
		'Posiadaj wszystkie <b>ulepszenia szczęścia</b>. <div class="line"></div>Posiadanie tego osiągnięcia sprawia, że szczęście pojawia się <b>dwa razy częściej</b> Istnieje też <b>%1% szansy</b>, że odblokowane ulepszenia szczęścia przejdą razem z tobą po wzniesieniu.',
	'Make your first stock market profit.': 'Zyskaj po raz pierwszy na giełdzie.',
	'Own at least <b>%1</b> of a stock market good.':
		'Posiadaj co najmniej <b>%1</b> danego dobra na giełdzie.',
	'Own at least <b>%1</b> of every stock market good.':
		'Posiadaj co najmniej <b>%1</b> wszystkich dóbr na giełdzie.',
	'Make <b>a day</b> of CpS ($%1) in 1 stock market sale.':
		'Zarób CnS ($%1) o wartości <b>1 dnia</b> podczas 1 transakcji sprzedaży na giełdzie.',
	'Spend <b>a day</b> of CpS ($%1) in 1 stock market purchase.':
		'Wydaj CnS ($%1) o wartości <b>1 dnia</b> podczas 1 transakcji kupna na giełdzie.',
	'Have your stock market profits surpass <b>a whole year</b> of CpS ($%1).':
		'Spraw, żeby twoje zyski na giełdzie przekroczyły CnS ($%1) o wartości <b>całego roku</b>.',
	'Unlock the <b>highest-tier</b> stock market headquarters.':
		'Odblokuj <b>najwyższy poziom</b> kwatery głównej giełdy ciastek wartościowych.',
	'Have your stock market profits surpass <b>$%1</b>.':
		'Spraw, żeby twoje zyski na giełdzie przekroczyły <b>$%1</b>.',
	...
	"Click one of Santa's helper grandmas during Christmas season.":
		'Kliknij jedną z mikołajowych babć-pomocnic w trakcie okresu świątecznego.',
	Frenzy: 'Szał',
	...
	'Cookie production halted for %1,<br>but each click is worth %2 of CpS.':
		'Produkcja ciastek zatrzymana przez %1,<br>ale każde kliknięcie jest warte %2 twoich CnS.',
	...
	'You find %1% more golden cookies for the next %2.':
		'Odnajdujesz %1% więcej ciastek przez następne %2.',
	'Spells backfire %1 times less for %2.':
		'Czary odwracają się przeciwko tobie %1 razy rzadziej przez %2.',
	'Spells backfire %1 times more for %2.':
		'Czary odwracają się przeciwko tobie %1 razy częściej przez %2.',
	...
	"[Baker's wheat quote]A plentiful crop whose hardy grain is used to make flour for pastries.":
		'Urodzajne zboże, którego twarde ziarno wykorzystywane jest do produkcji mąki pod przyszłe wypieki.',
	...
	'[Thumbcorn quote]A strangely-shaped variant of corn. The amount of strands that can sprout from one seed is usually in the single digits.':
		'Odmiana kukurydzy o dziwnym kształcie. Liczba pędów, które mogą wyrosnąć z jednego nasiona, jest zwykle jednocyfrowa. ',
	Cronerice: 'Smutnoryż',
	"[Cronerice quote]Not only does this wrinkly bulb look nothing like rice, it's not even related to it either; its closest extant relative is the weeping willow.":
		'Nie dość, że ta pomarszczona cebulka nie jest podobna do ryżu, to nawet nie jest z nim spokrewniona. Jej najbliższą daleką kuzynką jest wierzba płacząca.',
	...
	'[Gildmillet quote]An ancient staple crop, famed for its golden sheen. Was once used to bake birthday cakes for kings and queens of old.':
		'Starożytna odmiana jadalnego zboża, hodowana ze względu na swój złoty kolor. Używano jej niegdyś do pieczenia urodzinowych tortów dla królów i królowych.',
	...
	'[Ordinary clover quote]<i>Trifolium repens</i>, a fairly mundane variety of clover with a tendency to produce four leaves. Such instances are considered lucky by some.':
		'<i>Koniczyna biała</i>, będąca całkowicie przeciętną odmianą koniczyny. Co ciekawe, zdarza jej się czasem wypuścić cztery liście, co w niektórych środowiskach uważa się za symbol szczęścia.',
	...
	'[Golden clover quote]A variant of the ordinary clover that traded its chlorophyll for pure organic gold. Tragically short-lived, this herb is an evolutionary dead-end - but at least it looks pretty.':
		'Odmiana koniczyny pospolitej, która zamieniła swój chlorofil na czyste, organiczne złoto. Nie dość, że jej długość życia jest niedorzecznie mała, to jeszcze jest przykładem ewolucyjnego ślepego zaułka. No, ale przynajmniej jest przepiękna.',
	...
	'[Shimmerlily quote]These little flowers are easiest to find at dawn, as the sunlight refracting in dew drops draws attention to their pure-white petals.':
		'Najłatwiej dostrzec te małe kwiatuszki o świcie, gdy światło słoneczne załamujące się w kroplach rosy, podkreślając piękno jej śnieżnobiałych płatków. ',
	Elderwort: 'Starotka',
	'[Elderwort quote]A very old, long-forgotten subspecies of edelweiss that emits a strange, heady scent. There is some anecdotal evidence that these do not undergo molecular aging.':
		'Leciwy, od dawien dawna zapomniany podgatunek szarotki, który wydaje dziwny, mocny zapach. Istnieją pewne anegdotyczne dowody na to, że nie ulegają one starzeniu na poziomie molekularnym. ',
	...
	'[Bakeberry quote]A favorite among cooks, this large berry has a crunchy brown exterior and a creamy red center. Excellent in pies or chicken stews.':
		'Absolutny faworyt niejednego kucharza. Ta sporej wielkości jagoda ma chrupiącą, brązową skórkę oraz kremowy, czerwony środek. Nadaje się idealnie do ciast oraz gulaszu.',
	Chocoroot: 'Czekorzeń',
	'[Chocoroot quote]A tangly bramble coated in a sticky, sweet substance. Unknown genetic ancestry. Children often pick these from fields as-is as a snack.':
		'Poplątana jeżyna pokryta klejącą, słodką substancją. Dziedzictwo generyczne nieznane. Dzieci często wyrywają je z ziemi i jedzą z marszu na surowo.',
	...
	'[White chocoroot quote]A pale, even sweeter variant of the chocoroot. Often impedes travelers with its twisty branches.':
		'Blady, ale jeszcze słodszy gatunek czekoburaka. Znane są przypadki, że jego pokręcone gałęzie skutecznie zatrzymywały przechodniów.',
	...
	'[White mildew quote]A common rot that infests shady plots of earth. Grows in little creamy capsules. Smells sweet, but sadly wilts quickly.':
		'Typowa zgnilizna porastająca mroczne skrawki ziemi. Mnoży się pod postacią małych, kremowych kapsułek. Zapach ma słodki, ale niestety szybko usycha.',
	...
	'[Brown mold quote]A common rot that infests shady plots of earth. Grows in odd reddish clumps. Smells bitter, but thankfully wilts quickly.':
		'Typowa zgnilizna porastająca mroczne skrawki ziemi. Mnoży się pod postacią dziwnych, czerwonych grudek. Zapach ma gorzki, ale na szczęcie szybko usycha.',
	...
	'[Meddleweed quote]The sign of a neglected farmland, this annoying weed spawns from unused dirt and may sometimes spread to other plants, killing them in the process.':
		'Oto najlepszy przykład zaniedbanego ogrodu. Ten irytujący chwast nasiewa się od nieużywanej ziemi i zdarza się, że przechodzi na inne rośliny, zabijając je przy tym.',
	...
	"[Whiskerbloom quote]Squeezing the translucent pods makes them excrete a milky liquid, while producing a faint squeak akin to a cat's meow.":
		'Ściskanie przezroczystych strąków tej rośliny sprawia, że z kiciorostu poczyna wypływać mleczny płyn. Co więcej, usłyszeć też przy tym można delikatny pisk, podobny do miałczenia kota.',
	Chimerose: 'Chimeróża',
	'[Chimerose quote]Originating in the greener flanks of polar mountains, this beautiful flower with golden accents is fragrant enough to make any room feel a little bit more festive.':
		'Roślina pierwotnie pochodzi z zieleńszych zboczy gór polarnych. Jej piękny kwiat ze złotymi zdobieniami jest tak aromatyczny, że z powodzeniem może nadać blasku każdemu domowi.',
	...
	'[Nursetulip quote]This flower grows an intricate root network that distributes nutrients throughout the surrounding soil. The reason for this seemingly altruistic behavior is still unknown.':
		'Ten kwiat wytwarza skomplikowaną sieć korzeniową, która dostarcza wartości odżywczych roślinom na pobliskich polach. Nadal nie znamy powodów tego pozornie altruistycznego zachowania.',
	Drowsyfern: 'Drzemkopaprotka',
	'[Drowsyfern quote]Traditionally used to brew a tea that guarantees a good night of sleep.':
		'Tradycyjnie parzona pod postacią herbatki, która poprawia jakość snu.',
	...
	'[Wardlichen quote]The metallic stench that emanates from this organism has been known to keep insects and slugs away.':
		'Metaliczny odór tego organizmu sprawia, że wszelakie insekty i ślimaki trzymają się od niego z daleka.',
	Keenmoss: 'Ostromech',
	'[Keenmoss quote]Fuzzy to the touch and of a vibrant green. In plant symbolism, keenmoss is associated with good luck for finding lost objects.':
		'Roślina o żywym, zielonym kolorze, nieco kudłata w dotyku. W symbolice roślin można przeczytać, że ostromech utożsamia się ze szczęściem oraz odnajdywaniem zagubionych przedmiotów.',
	...
	'[Queenbeet quote]A delicious taproot used to prepare high-grade white sugar. Entire countries once went to war over these.':
		'Pyszna roślina, używana przeważnie do produkcji wysokiej jakości cukru. W dawnych czasach całe narody szły na wojnę, aby ją zdobyć.',
	...
	'[Juicy queenbeet quote]A delicious taproot used to prepare high-grade white sugar. Entire countries once went to war over these.<br>It looks like this one has grown especially sweeter and juicier from growing in close proximity to other queenbeets.':
		'Pyszna roślina, używana przeważnie do produkcji wysokiej jakości cukru. W dawnych czasach całe narody szły na wojnę, aby ją zdobyć.<br>Wygląda na to, że ta roślina jest jeszcze słodsza i bardziej soczysta, a to dzięki zasadzeniu w niewielkiej odległości od pozostałych buraków królewskich.',
	Duketater: 'Diuktator',
	'[Duketater quote]A rare, rich-tasting tuber fit for a whole meal, as long as its strict harvesting schedule is respected. Its starch has fascinating baking properties.':
		'Rzadka bulwa o bogatym smaku, która idealnie nadaje się na pełnowartościowy obiad pod warunkiem przestrzegania bardzo restrykcyjnego harmonogramu zbioru. Jej skrobia ma fascynujące właściwości piekarnicze.',
	...
	'[Crumbspore quote]An archaic mold that spreads its spores to the surrounding dirt through simple pod explosion.':
		'Archaiczna pleść, która rozmnaża się dzięki zarodnikom wystrzeliwanym na pobliskie pola za pomocą zwykłej eksplozji strąków.',
	...
	'[Doughshroom quote]Jammed full of warm spores; some forest walkers often describe the smell as similar to passing by a bakery.':
		'Wypełniony aż po kapelusz ciepłymi zarodnikami. Niektórzy bywalcy lasów określają jego zapach jako kojarzący się z piekarnią.',
	...
	'[Glovemorel quote]Touching its waxy skin reveals that the interior is hollow and uncomfortably squishy.':
		'Po dotknięciu woskowej skóry tego grzyba wnet odkrywamy jego wnętrze, które jest puste i nieprzyjemnie gąbczaste.',
	...
	'[Cheapcap quote]Small, tough, and good in omelettes. Some historians propose that the heads of dried cheapcaps were once used as currency in some bronze age societies.':
		'Mały, twardy, ale dobry do omletów. Niektórzy historycy przypominają, że wysuszone kapelusze taników zwyczajnych były w epoce brązu używane przez niektóre plemiona jako środek płatniczy.',
	...
	"[Fool's bolete quote]Named for its ability to fool mushroom pickers. The fool's bolete is not actually poisonous, it's just extremely bland.":
		'Nazwa odnosi się do jego wyglądu, który bardzo łatwo pomylić z innymi grzybami. Borowik zmylony w zasadzie nie jest trujący, ale zwyczajnie jego smak jest nijaki.',
	...
	"[Wrinklegill quote]This mushroom's odor resembles that of a well-done steak, and is said to whet the appetite - making one's stomach start gurgling within seconds.":
		'Woń tego grzyba przypomina zapach bardzo mocno wysmażonego steka. Podobno ma też właściwości wzmagające apetyt, gdyż w przeciągu paru sekund od konsumpcji każdemu zaczyna bulgotać w brzuchu.',
	...
	'[Green rot quote]This short-lived mold is also known as "emerald pebbles", and is considered by some as a pseudo-gem that symbolizes good fortune.':
		'Ta nietrwała pleśń znana jest też pod nazwą „szmaragdowych klejnotów”. Niektórzy jednak uznają ją za pseudoklejnot, choć zgadzają się, że symbolizuje szczęście.',
	...
	'[Shriekbulb quote]A nasty vegetable with a dreadful quirk : its flesh resonates with a high-pitched howl whenever it is hit at the right angle by sunlight, moonlight, or even a slight breeze.':
		'Nieprzyjemne warzywo z równie okropną przypadłością: za każdym razem, gdy światło słoneczne lub księżycowe — a nawet lekka bryza — muśnie go pod odpowiednim kątem, piskocebulka wydaje z siebie ogłuszający pisk.',
	...
	'[Tidygrass quote]The molecules this grass emits are a natural weedkiller. Its stems grow following a predictable pattern, making it an interesting -if expensive- choice for a lawn grass.':
		'Cząsteczki produkowane przez tę roślinę są naturalnym środkiem chwastobójczym. Jej łodygi rosną zgodnie z przewidywalnym wzorem, co czyni ją interesującym — choć nietanim — wyborem na przydomowy trawnik.',
	...
	'[Everdaisy quote]While promoted by some as a superfood owing to its association with longevity and intriguing geometry, this elusive flower is actually mildly toxic.':
		'Choć niektóre źródła wynoszą tę roślinę do statusu superpokarmu, dzięki jej długowieczności oraz intrygującej geometrii, to w rzeczywistości zdrowokrotka jest dość trująca.',
	...
	'[Ichorpuff quote]This puffball mushroom contains sugary spores, but it never seems to mature to bursting on its own. Surrounding plants under its influence have a very slow metabolism, reducing their effects but lengthening their lifespan.':
		'Choć grzyb ten zawiera zarodniki cukrowe, to nigdy nie dojrzewa na tyle, aby wybuchnąć i uwolnić je spod kapelusza. Będące pod jej wpływem pobliskie rośliny mają zdecydowanie obniżony metabolizm, co zmniejsza ich produktywność, ale wydłuża życie.',
	'Garden information': 'Informacje o ogrodzie',
	'Your garden is frozen, providing no effects.':
		'Twój ogród jest zamrożony i nie zapewnia żadnych efektów.',
	...
	"-You can cross-breed plants by planting them close to each other; new plants will grow in the empty tiles next to them.<br>-Unlock new seeds by harvesting mature plants.<br>-When you ascend, your garden plants are reset, but you keep all the seeds you've unlocked.<br>-Your garden has no effect and does not grow while the game is closed.":
		'-Możesz krzyżować rośliny, sadząc je blisko siebie. Nowe rośliny wyrosną na pustych polach obok nich.<br>- Odblokowuj nowe nasiona, zbierając dojrzałe rośliny.<br>-Po wzniesieniu się rośliny ogrodowe resetują się, ale zatrzymujesz wszystkie odblokowane nasiona.<br>-Twój ogród nie przynosi efektów i nie rozrasta się, kiedy gra jest zamknięta.',
	'Harvest all': 'Zbierz wszystko',
	'Instantly harvest all plants in your garden.':
		'Natychmiast zbierz wszystkie rośliny ze swojego ogrodu.',
	...
	'%1 to harvest all mature plants of this type.':
		'%1, by zebrać wszystkie dojrzałe rośliny tego typu.',
	Freeze: 'Zamroź',
	'Cryogenically preserve your garden.<br>Plants no longer grow, spread or die; they provide no benefits.<br>Soil cannot be changed.<div class="line"></div>Using this will effectively pause your garden.':
		'Kriogenicznie konserwuje Twój ogród.<br>Rośliny przestają rosnąć, mnożyć się i obumierać. Nie przynoszą korzyści.<br>Gleba nie może zostać zmieniona.<div class="line"></div>Użycie tej opcji oznacza całkowite wstrzymanie Twojego ogrodu.',
	...
	'A swarm of sugar hornets comes down on your garden, <span class="red">destroying every plant as well as every seed you\'ve unlocked</span> - leaving only a %1 seed.<br>In exchange, they will grant you <span class="green">%2</span>.<br>This action is only available with a complete seed log.':
		'Rój szerszeni cukrowych atakuje Twój ogród, <span class="red">niszcząc wszystkie rośliny oraz wszystkie odblokowane nasiona</span>. Jedyne nasiono, jakie ocaleje, to %1.<br>W zamian otrzymasz od nich <span class="green">%2</span>.<br>Ta opcja jest aktywna, tylko jeśli spis nasion jest kompletny.',
	'Do you REALLY want to sacrifice your garden to the sugar hornets?<br><small>You will be left with an empty plot and only the %1 seed unlocked.<br>In return, you will gain <b>%2 sugar lumps</b>.</small>':
		'NA PEWNO chcesz poświęcić swój ogród szerszeniom cukrowym?<br><small>Zostaniesz z pustą działką i jednym odblokowanym nasionem: %1.<br>W zamian otrzymasz <b>grudki cukru x%2</b>.</small>',
	...
	"You've sacrificed your garden to the sugar hornets, destroying your crops and your knowledge of seeds.<br>In the remains, you find <b>%1 sugar lumps</b>.":
		'Poświęciłeś ogród szerszeniom cukrowym, niszcząc uprawy i pozbywając się wiedzy o nasionach.<br>W zgliszczach znajdujesz <b>grudki cukru x%1</b>.',
	immortal: 'nieśmiertelny',
	'predictable growth': 'przewidywany wzrost',
	'surrounding plants (%1x%1) age %2% faster':
		'sąsiednie rośliny (%1x%1) starzeją się %2% szybciej',
	...
	'surrounding plants (%1x%1) are %2% more efficient':
		'sąsiednie rośliny (%1x%1) są wydajniejsze o %2%',
	'surrounding plants (%1x%1) are %2% less efficient':
		'sąsiednie rośliny (%1x%1) są %2% mniej wydajne',
	'surrounding tiles (%1x%1) develop no weeds or fungus':
		'na sąsiednich polach (%1x%1) nie wyrastają chwasty ani grzyb',
	'harvest when mature for +%1 of CpS (max. %2% of bank)':
		'zbierz dojrzałe za +%1 CnS (maks. %2% banku)',
	...
	'explodes into up to %1 of CpS at the end of its lifecycle (max. %2% of bank)':
		'kończy cykl życia, eksplodując na %1 CnS (maks. %2% banku)',
	'cannot handle cold climates; %1% chance to die when frozen':
		'nie znosi zimnego klimatu; %1% ryzyka obumarcia po zamrożeniu',
	'the unfortunate result of some plant combinations':
		'niefortunny rezultat kombinacji niektórych roślin',
	...
	'Click to use this type of soil for your whole field.':
		'Kliknij, by użyć tej gleby na całym polu.',
	Dirt: 'Piach',
	"Simple, regular old dirt that you'd find in nature.":
		'Najzwyczajniejszy piach, jaki można znaleźć w naturze.',
	Fertilizer: 'Nawóz',
	'Soil with a healthy helping of fresh manure. Plants grow faster but are less efficient.':
		'Gleba z porządną dawką świeżego nawozu. Rośliny rosną szybciej, ale są mniej wydajne.',
	Clay: 'Glina',
	'Rich soil with very good water retention. Plants grow slower but are more efficient.':
		'Bogata gleba z bardzo dobrą retencją wody. Rośliny rosną wolniej, ale są wydajniejsze.',
	Pebbles: 'Żwir',
	"Dry soil made of small rocks tightly packed together. Not very conducive to plant health, but whatever falls off your crops will be easy to retrieve.<br>Useful if you're one of those farmers who just want to find new seeds without having to tend their garden too much.":
		'Sucha gleba z drobnych, mocno zbitych kamyczków. Nie sprzyja zdrowiu roślin, ale ułatwia zbieranie owoców, które z nich spadają.<br>Przydatna dla farmerów, którym zależy wyłącznie na nowych nasionach, bez zbytniego pielenia ogrodu.',
	...
	'Soil made of bits and pieces of bark and sawdust. Helpful for young sprouts to develop, not so much for mature plants.':
		'Gleba ze zlepków kory i wiór. Przydatna przy młodych pędach, mniej w przypadku dojrzałych roślin.',
	...
	'<b>%1% chance</b> of collecting seeds automatically when plants expire':
		'<b>%1% szansy</b> na automatycznie zebranie nasion po zwiędnięciu rośliny',
	'plants spread and mutate <b>%1 times more</b>':
		'rośliny rozrastają się i mutują <b>%1x częściej</b>',
	...
	'This tile of soil is empty.<br>Pick a seed and plant something!':
		'To pole gleby jest puste.<br>Wybierz nasiono i posadź coś!',
	...
	'may reproduce, will drop seed when harvested':
		'może się rozmnażać, wypuszcza nasiona po zebraniu',
	...
	'Click to refill your soil timer and trigger <b>1</b> plant growth tick with <b>x%1</b> spread and mutation rate for %2.':
		'Kliknij, by zresetować pomiar czasu gleby i wywołać<b>1</b> skok rozwoju rośliny z częstotliwością rozrastania się i mutacji <b>x%1</b> za %2.',
	...
	'Plot size: %1<br>(Upgrades with farm level)':
		'Rozmiar działki: %1<br>(Zwiększa się wraz z poziomem farmy)',
	...
	'while plant is alive; scales with plant growth':
		'w trakcie życia rośliny; wzrasta wraz ze wzrostem rośliny',
	Dungeon: 'Loch',
	Grimoire: 'Grymuar',
	'This is your magic meter. Each spell costs magic to use.<div class="line"></div>Your maximum amount of magic varies depending on your amount of <b>Wizard towers</b>, and their level.<div class="line"></div>Magic refills over time. The lower your magic meter, the slower it refills.':
		'To Twój miernik magii. Każde zaklęcie zużywa magię.<div class="line"></div>Twój maksymalny poziom magii jest uzależniony od ilości posiadanych <b>wież Czarnoksiężnika</b>oraz ich poziomu.<div class="line"></div>Magia odnawia się z czasem. Im niższy jest wskaźnik magii, tym wolniej się uzupełnia.',
	...
	'Click to refill <b>%1 units</b> of your magic meter for %2.':
		'Kliknij, by odnowić <b>%1 jednost.</b> miernika magii za %2.',
	'Grimoire spells are %1% cheaper but fail %1% more.':
		'Zaklęcia grymuaru są %1% tańsze, ale %1% częściej zawodzą.',
	'Conjure Baked Goods': 'Przyzwij Wypieki',
	'Summon half an hour worth of your CpS, capped at %1% of your cookies owned.':
		'Przyzwij pół godziny wartości CnS o górnej granicy %1% posiadanych ciastek.',
	'Trigger a %1-minute clot and lose %1 minutes of CpS.':
		'Wywołaj %1-minutowy zakrzep, tracąc %1 min. CnS.',
	...
	'Summon a random golden cookie. Each existing golden cookie makes this spell +%1% more likely to backfire.':
		'Przyzwij losowe złote ciastko. Każde istniejące złote ciastko zwiększa ryzyko pomyłki o %1%.',
	...
	'All active buffs gain %1% more time (up to %2 more minutes).':
		'Wszystkie aktywne usprawnienia dostają %1% więcej czasu (do %2 min.).',
	'All active buffs are shortened by %1% (up to %2 minutes shorter).':
		'Wszystkie aktywne usprawnienia są skrócone o %1% (do % min.).',
	...
	'The spell picks a random building you could afford if you had twice your current cookies, and gives it to you for free. The building selected must be under %1, and cannot be your most-built one (unless it is your only one).':
		'Zaklęcie wybiera losowy budynek, na który byłoby Cię stać, mając dwa razy więcej ciastek, i daje Ci go za darmo. Wybrany budynek musi kosztować mniej niż %1 i nie może być tym, który budujesz najczęściej (chyba że masz tylko jeden).',
	...
	'Backfired, but no buildings to destroy!':
		'Doszło do pomyłki, lecz nie ma budynków do zniszczenia!',
	...
	'Cast a random spell at half the magic cost, with twice the chance of backfiring.':
		'Rzuć losowe zaklęcie za połowę ceny z dwa razy większym ryzykiem pomyłki.',
	...
	'Instantly summon a wrinkler if conditions are fulfilled.':
		'Natychmiast przyzywa zmarszczkacza, jeśli warunki są spełnione.',
	...
	'Spells backfire %1 times less for the next %2 minutes.':
		'Pomylone zaklęcia występują %1x rzadziej przez %2 min.',
	'Spells backfire %1 times more for the next %2 minutes.':
		'Pomylone zaklęcia występują %1x częściej przez %2 min.',
	...
	'[GOD 1 QUOTE]An immortal life spent focusing on the inner self, away from the distractions of material wealth.':
		'Nieśmiertelna istota skupiona na życiu wewnętrznym, z dala od pokus materialnego bogactwa.',
	...
	'[GOD 2 QUOTE]This sleazy spirit revels in the lust for quick easy gain and contempt for the value of steady work.':
		'Ten nikczemny duch pragnie szybkiego zysku i gardzi ciężką pracą.',
	...
	'[GOD 3 QUOTE]The embodiment of natural disasters. An impenetrable motive drives the devastation caused by this spirit.':
		'Ucieleśnienie katastrof naturalnych. Nieznana siła motywuje tego siejącego zniszczenie ducha.',
	...
	"[GOD 4 QUOTE]This spirit knows about everything you'll ever do, and enjoys dispensing a harsh judgment.":
		'Ten duch wie o wszystkim, co kiedykolwiek uczynisz, i z przyjemnością wydaje surowe osądy.',
	...
	'[GOD 5 QUOTE]This is the spirit of merry getaways and regretful Monday mornings.':
		'Oto duch radosnego zapomnienia i bolesnych poniedziałków.',
	...
	"[GOD 6 QUOTE]All things that be and ever will be were scripted long ago by this spirit's inscrutable tendrils.":
		'Wszystko, co jest i kiedykolwiek będzie, zostało zapisane dawno temu przez enigmatyczne kończyny tego ducha.',
	...
	'[GOD 7 QUOTE]This spirit enjoys a good cheese after a day of hard work.':
		'Ten duch uwielbia dobry ser po dniu ciężkiej roboty.',
	...
	'[GOD 8 QUOTE]While this spirit has many regrets, helping you rule the world through constant industrialization is not one of them.':
		'Choć ten duch ma powody do smutku, wspieranie Cię w podboju świata poprzez nieustanną industrializację nie jest jednym z nich.',
	...
	'[GOD 9 QUOTE]A caring spirit said to contain itself, inwards infinitely.':
		'Opiekuńczy duch, rzekomo o sercu bez dna.',
	...
	'[GOD 10 QUOTE]This spirit enjoys poking foul beasts and watching them squirm, but has no love for its own family.':
		'Ten duch lubi prowokować bestie, obserwując ich cierpienia, i nie przepada za własną rodziną.',
	...
	'[GOD 11 QUOTE]You will find that life gets just a little bit sweeter if you can motivate this spirit with tidy numbers and properly-filled tax returns.':
		'Odkryjesz, że życie staje się łatwiejsze, kiedy motywujesz tego ducha uporządkowanymi liczbami i starannymi formularzami podatkowymi.',
	...
	'If a golden cookie is clicked, this spirit is unslotted and all worship swaps will be used up.':
		'Po kliknięciu złotego ciastka duch zostaje usunięty z gniazda, a wszystkie wymiany bóstwa zostają zużyte.',
	...
	'The jade slot behaves as a ruby slot and the ruby slot behaves as a diamond slot.':
		'Miejsce jadeitowe zachowuje się tak jak miejsce rubinowe, a miejsce rubinowe - tak jak miejsce diamentowe.',
	'Stock Market': 'Giełda',
	...
	'You may increase your storage space by upgrading your offices and by buying more %1. You also get %2 extra storage space per %3 level (currently: <b>+%4</b>).':
		'Możesz zwiększyć przestrzeń magazynową, ulepszając biura i kupując %1. Możesz też zdobyć %2 przestrzeni magazynowej na %3 poziom (obecnie: <b>+%4</b>).',
	'The average worth of this stock and how high it can peak depends on the building it is tied to, along with the level of your %1.':
		"Średnia i maksymalna wartość tej akcji jest zależna od budynku, z którym jest związana, oraz poziomem '%1'.",
	'%1 the hide button to toggle all other stocks.':
		'%1 przycisk ukrywania, by przełączyć wszystkie pozostałe akcje.',
	'stock:': 'akcje:',
	...
	'You cannot buy and sell this stock in the same tick.':
		'Nie możesz kupować i sprzedawać akcji w trakcie jednego etapu.',
	...
	'It is fully upgraded. Its lavish interiors, spanning across innumerable floors, are host to many a decadent party, owing to your nigh-unfathomable wealth.':
		'Jest maksymalnie ulepszone. Liczy sobie wiele pięter i było miejscem wielu dekadenckich imprez. Wszystko dzięki Twojemu niewyobrażalnemu bogactwu.',
	...
	'+%1% base warehouse space for all goods':
		'+%1% bazowej przestrzeni magazynowej na wszystkie dobra',
	'Brokers:': 'Maklerzy:',
	...
	'Buying goods normally incurs overhead costs of <b>%1% extra</b>. Each broker you hire reduces that cost by <b>%2%</b>.':
		'Kupowanie towarów zazwyczaj zwiększa koszty stałe o <b>%1%</b>. Każdy zatrudniony makler zmniejsza te koszty o <b>%2%</b>.',
	'Current overhead costs thanks to your brokers: <b>+%1%</b>':
		'Obecne koszty stałe dzięki Twoim maklerom: <b>+%1%</b>',
	...
	"Maximum number of brokers you can own: %1 (the highest amount of grandmas you've owned this run, divided by 10, plus your grandma level)":
		'Maksymalna możliwa ilość posiadanych maklerów: %1 (najwyższa liczba posiadanych babci w trakcie tej rozgrywki podzielona przez 10, plus Twój poziom babci)',
	'Brokers are Wall Street-class grandmas versed in the ways of finance. Stockbroker grandmas work hard and play hard, and will fight telephone in hand to get your clients the best possible deals - with a sizeable profit margin for you, of course.':
		'Maklerzy to babcie rodem z Wall Street obcykane z finansami. Babcie-maklerki ciężko pracują i zaciekle walczą z telefonem w dłoni, by zapewnić Twoim klientom jak najlepsze warunki - przy uwzględnieniu sporej działki dla Ciebie, oczywiście.',
	...
	'Click to refill your opportunity timer (and give a quick burst to your economy) for %1.':
		'Kliknij, by zresetować czasomierz okazji (i zasilić gospodarkę) za %1.',
	'Profits: %1. All prices are in $econds of your highest raw cookies per second.':
		'Zysk: %1. Wszystkie ceny są $ekundy od Twojej najwyższej wartości ciastek na sekundę.',
	...
	'[Upgrade name 41]White chocolate macadamia nut cookies':
		'Ciastka z białą czekoladą i orzechami makadamia',
	...
	'[Upgrade name 96]Round chocolate british tea biscuits':
		'Okrągłe czekoladowe herbatniki brytyjskie',
	'[Upgrade name 97]Round british tea biscuits with heart motif':
		'Okrągłe herbatniki brytyjskie z motywem serca',
	'[Upgrade name 98]Round chocolate british tea biscuits with heart motif':
		'Okrągłe czekoladowe herbatniki brytyjskie z motywem serca',
	...
	'[Upgrade name 318]Some other super-tiny fundamental particle? Probably?':
		'Jakaś inna maluteńka cząstka podstawowa? Może?',
	...
	'[Upgrade name 361]Golden cookie sound selector':
		'Wybierak dźwięku ostrzegawczego złotych ciastek',
	...
	'[Upgrade name 442]Kitten assistants to the regional manager':
		'Koci asystenci kierowników regionalnych',
	...
	'[Upgrade name 477]Synthetic chocolate green honey butter biscuit':
		'Ciastko maślane z syntetyczną czekoladą i zielonym miodem',
	'[Upgrade name 478]Royal raspberry chocolate butter biscuit':
		'Ciastko maślane z królewską czekoladą malinową',
	'[Upgrade name 479]Ultra-concentrated high-energy chocolate butter biscuit':
		'Ciastko maślane z dużą zawartością czekolady wysokoenergetycznej',
	...
	'[Upgrade name 497]Pure pitch-black chocolate butter biscuit':
		'Ciastko maślane z czekoladą ciemną jak smoła',
	...
	'[Upgrade name 553]A chocolate chip cookie but with the chips picked off for some reason':
		'Ciastko oskubane z czekoladowych płatków, nie wiedzieć czemu',
	...
	'[Achievement name 225]He who controls the cookies controls the universe':
		'Kto kontroluje ciastka ten kontroluje wszechświat',
	...
	'[Achievement name 230]Brought to you by the letter <div style="display:inline-block;background:url(img/money.png);width:16px;height:16px;"></div>':
		'Jest list do ciebie <div style="display:inline-block;background:url(img/money.png);width:16px;height:16px;"></div>',
	...
	'[Achievement name 232]When this baby hits 36 quadrillion cookies per hour':
		'Ten moment, gdy dziecina wyciska 36 kwadrylionów ciastek na sekundę',
	'[Achievement name 233]Fast and delicious': 'Szybcy i smaczni',
	'[Achievement name 234]Cookiehertz : a really, really tasty hertz':
		'Taniec z ciastkami: tylko najbardziej utalentowane ciastka',
	'[Achievement name 235]Woops, you solved world hunger':
		'Ups, chyba rozwiązałeś problem głodu na świecie',
	...
	"[Achievement name 255]And now for my next trick, I'll need a volunteer from the audience":
		'A do następnej sztuczki poproszę kogoś z widowni',
	...
	'[Achievement name 259]cookie clicker forever and forever a hundred years cookie clicker, all day long forever, forever a hundred times, over and over cookie clicker adventures dot com':
		'cookie clicker teraz i zawsze i na wieki wieków przez sto lat klikania całe dnie i całe ranki i tak sto razy napiszesz na tablicy od lewa do prawa przygody w cookie clicker kropka com',
	...
	'[Achievement name 301]Neither snow nor rain nor heat nor gloom of night':
		'Ani śnieg, ani deszcz, ani upał, ani mrok nocy',
	...
	'[Achievement name 349]What happens in the vortex stays in the vortex':
		'Co się wydarzyło w wirze, zostaje w wirze',
	...
	"[Achievement name 357]Save your breath because that's all you've got left":
		'Nie przemęczaj się, bo i tak nie masz już nic',
	...
	"[Achievement name 361]Don't get used to yourself, you're gonna have to change":
		'Nie przyzwyczajaj się do siebie, bo i tak się zmienisz',
	'[Achievement name 362]Objects in the mirror dimension are closer than they appear':
		'Obiekty w lustrzanym wymiarze są bliżej, niż ci się wydaje',
	...
	'[Achievement name 376]All the other kids with the pumped up clicks':
		'Uczciwością i klikaniem ludzie się bogacą',
	...
	"[Achievement name 404]My world's on fire, how about yours":
		'Mój świat płonie, a co tam u ciebie?',
	...
	'[Achievement name 408]Your brain gets smart but your head gets dumb':
		'Twój mózg staje się mądrzejszy, ale głowa — coraz głupsza',
	...
	"[Achievement name 411]You'll never shine if you don't glow":
		'Nigdy nie zabłyśniesz, jeśli nie zapłoniesz światłem',
	"[Achievement name 412]You'll never know if you don't go":
		'Nigdy się nie dowiesz, jeśli nie tam nie pójdziesz',
	...
	'[Achievement name 421]For more information on this achievement, please refer to its title':
		'Aby uzyskać więcej informacji na temat tego osiągnięcia, proszę przeczytać jego nazwę',
	"[Achievement name 422]I'm so meta, even this achievement":
		'Nawet to osiągnięcie jest wybitnie meta',
	...
	"[Achievement name 429]I think it's safe to say you've got it made":
		'Chyba można powiedzieć, że ci się powiodło',
	...
	"[Achievement name 442]Dude what if we're all living in a simulation like what if we're all just code on a computer somewhere":
		'Stary, a co, jeśli wszyscy żyjemy w jakiejś symulacji albo jesteśmy tylko kodem gdzieś na czyimś komputerze',
	...
	'[Achievement name 495]Mountain out of a molehill, but like in a good way':
		'Z igły widły, ale tak pozytywnie',
	...
	'[Achievement name 506]Flip a cookie. Chips, I win. Crust, you lose.':
		'Rzuć ciastkiem. Polewa — wygrywam. Spód — ty przegrywasz.',
	...
	'[Achievement name 515]Nobody exists on purpose, nobody belongs anywhere':
		'Nikt nie ma celu, bo to nie jest nasze miejsce ',
	...
	'[Achievement name 521]Reject reality, substitute your own':
		'Odrzuć rzeczywistość i wymyśl swoją',
	...
	'[Achievement name 544]A trademarked portmanteau of "imagination" and "engineering"':
		'Zastrzeżony znak towarowy dla „wyobraźnia” i „inżynieria”',
	...
	"[Achievement name 558]Don't let the walls cave in on you":
		'Nie pozwól ścianom zwalić się na ciebie',
	...
	'[Achievement name 566]But the future refused to change':
		'Ale przyszłość nie chciała się zmienić',
	...
	'[Achievement name 586]What do you get for the baker who has everything':
		'Co podarować piekarzowi który ma już wszystko',
