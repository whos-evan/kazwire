AddLanguage('CS', 'czech', {
	...
	grandmapocalypse: '/',
	'%1 cookie': ['%1 keks', '%1 keksy'],
	'%1 sugar lump': ['%1 cukrová hrudka', '%1 cukrové hrudky'],
	'%1 heavenly chip': ['%1 nebeský střípek', '%1 nebeské střípky'],
	'%1 golden cookie': ['%1 zlatý keks', '%1 zlaté keksy'],
	'%1 building': ['%1 budova', '%1 budovy'],
	'%1 upgrade': ['%1 vylepšení', '%1 vylepšení'],
	Yes: 'Ano',
	No: 'Ne',
	...
	Cookies: 'Keksy',
	'%1 day': ['%1 den', '%1 dní'],
	'%1 hour': ['%1 hodina', '%1 hodin'],
	'%1 minute': ['%1 minuta', '%1 minut'],
	...
	'visual improvements; disabling may improve performance':
		'vylepšení vzhledu; vypnutí může vést ke zlepšení výkonu',
	Particles: 'Částice',
	Numbers: 'Čísla',
	...
	'display boxes around upgrades and achievements in Stats':
		'zobrazovat v Atributech boxy kolem vylepšení a úspěchy',
	'Alt font': 'Alt písmo',
	'your cookies are displayed using a monospace font':
		'vaše keksy se zobrazují pomocí monoprostorového písma',
	...
	'the game will ask you to confirm when you close the window':
		'když zavíráte okno, hra vás požádá o potvrzení',
	Defocus: 'Nesoustředěnost',
	'the game will be less resource-intensive when out of focus':
		'hra bude méně intenzivní ohledně zdrojů, když není v popředí',
	...
	'the game will ask you to confirm before spending sugar lumps':
		'před utracením cukrových hrudek vás hra požádá o potvrzení',
	'Custom grandmas': 'Vlastní babičky',
	'some grandmas will be named after Patreon supporters':
		'některé babičky budou pojmenovány po podporovatelích na Patreonu',
	...
	"on slower computers, the game will put itself in sleep mode when it's inactive and starts to lag out; offline CpS production kicks in during sleep mode":
		'na pomalejších počítačích se hra v případě neaktivity sama přepne do režimu spánku a zpomalí se; během režimu spánku naskočí offline produkce K/s',
	'Music in background': 'Hudba na pozadí',
	"music will keep playing even when the game window isn't focused":
		'hudba bude hrát, i když není okno s hrou zaostřené',
	'Cloud saving': 'Ukládání do cloudu',
	'allow use of Steam Cloud for save backups':
		'povolit používání služby Steam Cloud k zálohování uložených souborů',
	...
	'allows optimizations for screen readers; game will reload':
		'umožňuje optimalizaci pro čtečky obrazovky, hra se restartuje',
	'Discord status': 'Stav služby Discord',
	'if Discord is on, show your game info as activity status':
		'pokud je služba Discord zapnutá, zobrazí se informace o hře, například stav aktivity',
	Language: 'Jazyk',
	'Language: %1': 'Jazyk: %1',
	...
	'These are feats that are either unfair or difficult to attain. They do not give milk.':
		'Toto jsou úspěchy, které jsou buď nefér, nebo se obtížně získávají. Není za ně mléko.',
	...
	'with %1 ascension': ['při %1 postupu', 'při %1 postupech'],
	...
	'Milk is gained with each achievement. It can unlock unique upgrades over time.':
		'Mléko získáváte při každém úspěchu.',
	'Rank %1': 'Hodnost %1',
	...
	'Cookie Clicker is a javascript game by %1 and %2.':
		'Cookie Clicker je hra na bázi javascriptu od %1 a %2.',
	'Music by %1.': 'Hudba: %1.',
	...
	"This version of Cookie Clicker is 100% free, forever. Want to support us so we can keep developing games? Here's some ways you can help:%1":
		'Tato verze Cookie Clicker je 100% bezplatná, a to navždy. Chcete nás podpořit, abychom mohli ve vývoji her pokračovat? Zde je pár způsobů, jak můžete pomoci:%1',
	"Note: if you find a new bug after an update and you're using a 3rd-party add-on, make sure it's not just your add-on causing it!":
		'Poznámka: Pokud po aktualizaci objevíte novou chybu a využíváte nějaký doplněk třetí strany, ujistěte se, že chybu nezpůsobuje jenom ten!',
	...
	'Note: older update notes are in English.':
		'Poznámka: starší poznámky o aktualizacích jsou v angličtině.',
	'This feature is not yet available in your language.':
		'Tato funkce zatím není dostupná ve tvém jazyce.',
	...
	'Cookie Clicker is in sleep mode and generating offline cookies.':
		'Cookie Clicker je v režimu spánku a generuje offline keksy.',
	...
	'(this happens when too many frames are skipped at once,<br>usually when the game has been running in the background for a while)<br>(you can turn this feature off in the settings menu)':
		'(toto se děje v případě, že je přeskočeno příliš mnoho snímků najednou,<br>obvykle tehdy, pokud hra už nějakou dobu běží na pozadí)<br>(tuto funkci můžete vypnout v nabídce nastavení)',
	...
	'Hello again! Just a reminder that you may want to back up your Cookie Clicker save every once in a while, just in case.<br>To do so, go to Options and hit "Export save" or "Save to file"!':
		'Opět zdravíme! Jen připomínáme, že by možné bylo dobré si jednou za čas svou uloženou pozici v Cookie Clicker zálohovat, čistě pro případ.<br>Abyste tak učinili, přejděte do Možností a klikněte na "Exportovat uložení" nebo "Uložit do souboru"!',
	'Save manually (the game autosaves every 60 seconds; shortcut: ctrl+S)':
		'Uložit ručně (hra se automaticky ukládá každých 60 sekund; zkratka: ctrl+S)',
	'You can use this to backup your save or to transfer it to another computer (shortcut for import: ctrl+O)':
		'Tímto můžete zálohovat svou uloženou pozici nebo ji převést do jiného počítače (zkratka pro import: ctrl+O)',
	...
	'This is your save code.<br>Copy it and keep it somewhere safe!':
		'Toto je kód vašeho uložení.<br>Zkopírujte si ho a uchovávejte někde v bezpečí!',
	'Import save': 'Importovat uložení',
	'Please paste in the code that was given to you on save export.':
		'Prosím vložte kód, který jste dostali při exportování uložené pozice.',
	...
	'Oops, looks like the import string is all wrong!':
		'Jejda, zdá se, že řetězec importu je úplně špatně!',
	'You are attempting to load a save from a future version (v. %1; you are using v. %2).':
		'Pokoušíte se načíst uložení z budoucí verze (v. %1; vy používáte v. %2).',
	"Sorry, you can't import saves from the classic version.":
		'Je nám líto, nelze importovat uložení z klasické verze.',
	'Wipe save': 'Vymazat uložení',
	'Delete all your progress, including your achievements':
		'Smazat veškerý postup včetně vašich úspěchů',
	'Do you REALLY want to wipe your save?<br><small>You will lose your progress, your achievements, and your heavenly chips!</small>':
		'OPRAVDU si přejete vymazat své uložení?<br><small>Přijdete o svůj postup, své úspěchy i své nebeské střípky!</small>',
	"Whoah now, are you really, <b><i>REALLY</i></b> sure you want to go through with this?<br><small>Don't say we didn't warn you!</small>":
		'Počkat, to jste si opravdu, <b><i>REALLY</i></b> jistí, že v tomto chcete pokračovat?<br><small>Neříkejte, že jsme vás nevarovali!</small>',
	...
	'Only use mods from trusted sources. Some mods may require a game restart to take effect.':
		'Používej jen mody z ověřených zdrojů. Některé mody začnou fungovat až po restartu hry.',
	Enable: 'Povolit',
	Disable: 'Zakázat',
	...
	'This tool allows you to upload new mods to the Steam Workshop.<br>You need to select a mod folder containing a properly-formatted %1 file.<br>See the included sample mods for examples.':
		'<br>Tento nástroj umožňuje nahrávat nové modifikace do služby Steam Workshop.<br>Je třeba vybrat složku modifikací se souborem %1 ve správném formátu.<br>Podívejte se na přiložené příklady modifikací.',
	'Mod data': 'Data modů',
	...
	'These are the mods present in your save data. You may delete some of this data to make your save file smaller.':
		'Toto jsou mody přítomné v datech vašeho uložení. Možná by bylo dobré některá z těchto dat smazat, aby byla vaše uložená pozice menší.',
	'(loaded)': '(načteno)',
	'%1 char': ['%s znak', '%s znaky'],
	'Check mod data': 'Zkontrolovat data modů',
	'view and delete save data created by mods':
		'zobrazit a odstranit data uložené pozice vytvořená mody',
	...
	'You are currently playing Cookie Clicker on the <b>%1</b> protocol.<br>The <b>%2</b> version uses a different save slot than this one.<br>Click this lock to reload the page and switch to the <b>%2</b> version!':
		'Momentálně hrajete Cookie Clicker na protokolu <b>%1</b>.<br>Verze <b>%2</b> využívá k ukládání jinou pozici než tato.<br>Kliknutím na tento zámek obnovíte stránku a přepnete na verzi <b>%2</b>!',
	'+%1 more notification.': ['+%1 další upozornění.', '+%1 další upozornění.'],
	Christmas: 'Vánoce',
	...
	"Because you've baked a <b>billion cookies</b> in total, you are now attracting <b>sugar lumps</b>. They coalesce quietly near the top of your screen, under the Stats button.<br>You will be able to harvest them when they're ripe, after which you may spend them on all sorts of things!":
		'Protože jste upekli celkem <b>miliardu sušenek</b>, nyní přitahujete <b>cukrové hrudky</b>. Ty se nenápadně hromadí v horní části vaší obrazovky pod tlačítkem Atributy.<br>Až budou zralé, budete je moci sklidit a pak si za ně pořizovat všemožné věci!',
	'A <b>sugar lump</b> is coalescing here, attracted by your accomplishments.':
		'Tady se hromadí <b>cukrová hrudka</b>, kterou přilákaly vaše úspěchy.',
	'Your sugar lumps mature after <b>%1</b>,<br>ripen after <b>%2</b>,<br>and fall after <b>%3</b>.':
		'Vaše cukrové hrudky dorůstají po <b>%1</b>,<br>zralé po <b>%2</b>,<br>a padají po <b>%3</b>.',
	...
	'This sugar lump has been exposed to time travel shenanigans and will take an excruciating <b>%1</b> to reach maturity.':
		'Tuto cukrovou hrudku potkaly trampoty spojené s cestováním časem a plného vzrůstu se dočká až za útrpných <b>%1</b>.',
	'This sugar lump is still growing and will take <b>%1</b> to reach maturity.':
		'Tato cukrová hrudka dosud roste a plného vzrůstu se dočká za <b>%1</b>.',
	"This sugar lump is mature and will be ripe in <b>%1</b>.<br>You may <b>click it to harvest it now</b>, but there is a <b>50% chance you won't get anything</b>.":
		'Tato cukrová hrudka už vyrostla a zralá bude za <b>%1</b>.<br>Můžete <b>kliknout a sklidit ji ihned</b>, ale je tu <b>50% šance, že nedostanete nic</b>.',
	'<b>This sugar lump is ripe! Click it to harvest it.</b><br>If you do nothing, it will auto-harvest in <b>%1</b>.':
		'<b>Tato cukrová hrudka je zralá! Skliďte ji kliknutím.</b><br>Pokud si jí nebudete všímat, za <b>%1</b> se sklidí sama.',
	'This sugar lump grew to be <b>bifurcated</b>; harvesting it has a 50% chance of yielding two lumps.':
		'Tato cukrová hrudka vyrostla <b>rozdvojená</b>; při její sklizni je 50% šance, že z ní budete mít dvě hrudky.',
	'This sugar lump grew to be <b>golden</b>; harvesting it will yield 2 to 7 lumps, your current cookies will be doubled (capped to a gain of 24 hours of your CpS), and you will find 10% more golden cookies for the next 24 hours.':
		'Tato cukrová hrudka vyrostla <b>zlatá</b>; její sklizní získáte 2 až 7 hrudek, vaše současné keksy se zdvojnásobí (až po limit ve výši zisku za 24 hodin K/s) a během následujících hodin budete nacházet o 10% více zlatých keksů.',
	'This sugar lump was affected by the elders and grew to be <b>meaty</b>; harvesting it will yield between 0 and 2 lumps.':
		'Tato cukrová hrudka byla ovlivněna prastarými, takže vyrostla jako <b>meaty</b>; z její sklizně dostanete 0 až 2 hrudky.',
	'This sugar lump is <b>caramelized</b>, its stickiness binding it to unexpected things; harvesting it will yield between 1 and 3 lumps and will refill your sugar lump cooldowns.':
		'Tato cukrová hrudka <b>caramelized</b>, díky své lepivosti se chytá na nepředvídané věci; z její sklizně dostanete 1 až 3 hrudky a odpočty vašich cukrových hrudek se vrátí na plnou hodnotu.',
	'You harvested <b>%1</b> while you were away.':
		'Během své nepřítomnosti jste sklidili <b>%1</b>.',
	...
	'Your cookies have been doubled.<br>+10% golden cookies for the next 24 hours.':
		'Vaše keksy se zdvojnásobily.<br>+10% zlatých keksů na následujících 24 hodin.',
	...
	'To benefit from the herald bonus, you need a special upgrade you do not yet own. You will permanently unlock it later in the game.':
		'Abyste měli výhody z bonusu v podobě poslů, potřebujete zvláštní vylepšení, které zatím nevlastníte. Trvale si jej odemknete později během hry.',
	'<b>Heralds</b> are people who have donated to our highest Patreon tier, and are limited to 100.<br>Each herald gives everyone +1% CpS.<br>Heralds benefit everyone playing the game, regardless of whether you donated.':
		'<b>Heralds</b> jsou lidé, kteří přispěli na nejvyšší stupeň našeho Patreonu, a jejich počet je omezen na 100.<br>Každý posel všem přidává +1% K/s.<br>Poslové přinášejí výhody všem hráčům této hry nehledě na to, kolik jste přispěli.',
	'Every %1 current players on Steam generates <b>1 herald</b>, up to %2 heralds.<br>Each herald gives everyone +1% CpS.':
		'Každý aktuální hráč %1 na Steamu generuje <b>1 herald</b> až %2 heraldy.<br>Každý herald každému poskytne +1% K/s.',
	'+%1!': '/',
	...
	'Cookie chain broken.<br><small>You made %1.</small>':
		'Keksový řetězec se rozbil.<br><small>You made %1.</small>',
	'Cookie blab': [
	...
	'Select an aura from those your dragon knows.':
		'Vyberte si nějakou auru z těch, které váš drak umí.',
	'<b>One tenth</b> of every other dragon aura, <b>combined</b>.':
		'<b>One tenth</b> z každé druhé dračí aury, <b>combined</b>.',
	'Switching your aura is <b>free</b> because you own no buildings.':
		'Přepnutí aury je <b>free</b>, protože nevlastníte žádné budovy.',
	'The cost of switching your aura is <b>%1</b>.<br>This will affect your CpS!':
		'Cena za přepnutí aury je <b>%1</b>.<br>Toto bude mít vliv na vaše K/s!',
	...
	'You feel like making cookies. But nobody wants to eat your cookies.':
		'Máte chuť vyrábět keksy. Nikdo však vaše keksy nechce jíst.',
	'Your first batch goes to the trash. The neighborhood raccoon barely touches it.':
		'Vaše první várka letí do koše. Místní mýval se jí skoro ani nedotkl.',
	'Your family accepts to try some of your cookies.':
		'Vaše rodina souhlasí, že pár vašich keksů ochutná.',
	...
	'Your cookies are talked about for miles around.':
		'Lidé si o vašich keksech povídají na kilometry daleko.',
	...
	'Your cookies sell very well in distant countries.':
		'Vaše keksy se velmi dobře prodávají v dalekých zemích.',
	'People come from very far away to get a taste of your cookies.':
		'Lidé přicházejí z velké dálky, aby ochutnali vaše keksy.',
	'Kings and queens from all over the world are enjoying your cookies.':
		'Králové a královny z celého světa si pochutnávají na vašich keksech.',
	...
	'A national day has been created in honor of your cookies.':
		'Na počest vašich keksů byl vyhlášen národní svátek.',
	'Your cookies have been named a part of the world wonders.':
		'Vaše keksy byly prohlášeny za jeden ze světových divů.',
	'History books now include a whole chapter about your cookies.':
		'Učebnice historie nyní obsahují celou kapitolu věnovanou vašim keksům.',
	'Your cookies have been placed under government surveillance.':
		'Vaše keksy byly umístěny pod vládní ostrahu.',
	...
	'Strange creatures from neighboring planets wish to try your cookies.':
		'Podivná stvoření ze sousedních planet si přejí ochutnat vaše keksy.',
	'Elder gods from the whole cosmos have awoken to taste your cookies.':
		'Prastaří bohové celého kosmu se probouzejí, aby ochutnali vaše sušenky.',
	'Beings from other dimensions lapse into existence just to get a taste of your cookies.':
		'Přicházejí stvoření z jiných dimenzí, jen aby ochutnali vaše keksy.',
	...
	'The universe has now turned into cookie dough, to the molecular level.':
		'Vesmír se nyní na molekulární úrovni změnil v sušenkové těsto.',
	'Your cookies are rewriting the fundamental laws of the universe.':
		'Vaše keksy přepisují základní zákonitosti vesmíru.',
	'A local news station runs a 10-minute segment about your cookies. Success!<br><small>(you win a cookie)</small>':
		'Místní televizní stanice odvysílala 10minutový segment o vašich keksech. Úspěch!<br><small>(you win a cookie)</small>',
	...
	'You gain <b>one hour</b> of your CpS (capped at double your bank).':
		'Získáváte <b>one hour</b> vašeho K/s (limit je dvojnásobek vašeho banku).',
	...
	'Your prestige level is currently <b>%1</b>.<br>(CpS +%2%)':
		'Momentální úroveň vaší prestiže je <b>%1</b>.<br>(K/s +%2%)',
	'Ascending now would grant you no prestige.':
		'Pokud se povznesete nyní, nepřidá vám to žádnou prestiž.',
	'Ascending now would grant you<br><b>1 prestige level</b> (+1% CpS)<br>and <b>1 heavenly chip</b> to spend.':
		'Pokud se povznesete nyní, získáte<br><b>1 prestige level</b> (+1% K/s)<br>a <b>1 heavenly chip</b> k utracení.',
	'Ascending now would grant you<br><b>%1 prestige levels</b> (+%2% CpS)<br>and <b>%3 heavenly chips</b> to spend.':
		'Pokud se povznesete nyní, získáte<br><b>%1 prestige levels</b> (+%2% K/s)<br>a <b>%3 heavenly chips</b> k utracení.',
	'You need <b>%1 more cookies</b> for the next level.':
		'Na další úroveň potřebujete <b>%1 more cookies</b>.',
	'Do you REALLY want to ascend?<div class="line"></div>You will lose your progress and start over from scratch.<div class="line"></div>All your cookies will be converted into prestige and heavenly chips.':
		'OPRAVDU si přejete se povznést? <div class="line"></div>Přijdete o veškerý dosavadní postup a budete začínat od nuly.<div class="line"></div>Všechny vaše keksy budou převedeny na prestiž a nebeské střípky.',
	'You will keep your achievements.': 'Své úspěchy si ponecháte.',
	'You will keep your achievements, building levels and sugar lumps.':
		'Ponecháte si své úspěchy, úrovně budov a cukrové hrudky.',
	...
	'%1 prestige level': ['%1 úroveň prestiže', '%1 úrovně prestiže'],
	...
	"You are ascending.<br>Drag the screen around<br>or use arrow keys!<br>When you're ready,<br>click Reincarnate.":
		'Právě se povznášíte.<br>Potáhněte obrazovku do stran<br>nebo použijte klávesy šipek!<br>Až budete připraveni,<br>klikněte na Reinkarnovat.',
	'Each prestige level grants you a permanent <b>+%1% CpS</b>.<br>The more levels you have, the more cookies they require.':
		'Z každé úrovně prestiže dostanete permanentní <b>+%1% CpS</b>.<br>Čím více máte úrovní, tím více je na ně potřeba keksů.',
	'Heavenly chips are used to buy heavenly upgrades.<br>You gain <b>1 chip</b> every time you gain a prestige level.':
		'Za nebeské střípky si lze kupovat nebeská vylepšení.<br><b>1 chip</b> získáte pokaždé, když získáte úroveň prestiže.',
	"Click this once you've bought<br>everything you need!":
		'Klikněte sem, až budete mít koupeno<br>vše potřebné!',
	...
	'Challenge modes apply special modifiers to your next ascension.<br>Click to change.':
		'Módy výzvy přidávají k vašemu příštímu povznesení speciální modifikátory.<br>Klikněte pro změnu.',
	...
	'This run will behave as if you\'d just started the game from scratch. Prestige levels and heavenly upgrades will have no effect, as will sugar lumps and building levels. Perma-upgrades and minigames will be unavailable.<div class="line"></div>Some achievements are only available in this mode.':
		'Tento běh se bude chovat stejně, jako byste právě začali hru od nuly. Úrovně prestiže a nebeská vylepšení nebudou mít žádný efekt a cukrové hrudky a úrovně budov také ne. Perma-vylepšení a minihry budou nedostupné.<div class="line"></div>Některá vylepšení jsou dostupná pouze v tomto módu.',
	'Your bingo center/research facility is conducting experiments.':
		'Ve vašem bingo centru/výzkumném ústavu se provádějí experimenty.',
	...
	"It's <b>Valentine's season</b>!<br>Love's in the air and cookies are just that much sweeter!":
		"Je <b>Valentine's season</b>!<br>Láska je všude a keksy jsou o to sladší!",
	'Business Day!': 'Den obchodů!',
	"It's <b>Business season</b>!<br>Don't panic! Things are gonna be looking a little more corporate for a few days.":
		'Je <b>Business season</b>!<br>Žádnou paniku! Na pár dní bude vše vypadat o trochu více korporátně.',
	'Halloween!': '/',
	"It's <b>Halloween season</b>!<br>Everything is just a little bit spookier!":
		'Je <b>Halloween season</b>!<br>Všechno je o trochu strašidelnější!',
	...
	"It's <b>Christmas season</b>!<br>Bring good cheer to all and you just may get cookies in your stockings!":
		'Je <b>Christmas season</b>!<br>Buďte na všechny milí a možná se vám v punčoše objeví keksy!',
	'Easter!': 'Velikonoce!',
	"It's <b>Easter season</b>!<br>Keep an eye out and you just might click a rabbit or two!":
		'Je <b>Easter season</b>!<br>Mějte oči na stopkách a možná odklikete jednoho nebo dva králíky!',
	...
	'Upgrade is vaulted and will not be auto-purchased.':
		'Vylepšení je v trezoru a nebude automaticky zakoupeno.',
	...
	'Will <b>instantly purchase</b> every upgrade you can afford, starting from the cheapest one.<br>Upgrades in the <b>vault</b> will not be auto-purchased.<br>You may place an upgrade into the vault by <b>Shift-clicking</b> on it.':
		'<b>instantly purchase</b> každé vylepšení, na které máte, počínaje tím nejlevnějším.<br>Vylepšení v <b>vault</b> nebudou zakoupena<br>Vylepšení můžete vložit do trezoru <b>Shift-clicking</b> na něj.',
	...
	'all combined, these boosts account for <b>%1</b> per second (<b>%2%</b> of total CpS)':
		'všechna tato posílení dohromady přinášejí <b>%1</b> za sekundu (<b>%2%</b> z celkových K/s)',
	'owned: %1': 'vlastněno: %1',
	'free: %1!': 'volných: %1!',
	...
	'Names in white were submitted by our supporters on Patreon.':
		'Jména psaná bíle byla navržena našimi podporovateli na Patreonu.',
	'You can also press %1 to bulk-buy or sell %2 of a building at a time, or %3 for %4.':
		'Můžete také stisknout %1 pro hromadný nákup nebo prodat %2 budov najednou, případně %3 za %4.',
	Investment: 'Investice',
	"You're not sure what this does, you just know it means profit.":
		'Nevíte jistě, co to dělá, víte jenom, že to znamená zisk.',
	Cursor: 'Kurzor',
	cursor: 'kurzor',
	cursors: 'kurzory',
	'%1 cursor': ['%1 kurzor', '%1 kurzory'],
	...
	'[Cursor business quote]Essential in flattening dough. The first step in cookie-making.':
		'Nezbytný pro válení těsta. První krok výroby keksu.',
	Grandma: 'Babička',
	grandma: 'babička',
	grandmas: 'babičky',
	'%1 grandma': ['%1 babička', '%1 babiček'],
	...
	'[Mine business quote]These give you the edge you need to outsell those pesky competitors.':
		'Díky nim získáváte prodejní výhodu nad těmi otravnými konkurenty.',
	Factory: 'Továrna',
	factory: 'továrna',
	factories: 'továrny',
	'%1 factory': ['%1 továrna', '%1 továren'],
	...
	'[Factory business quote]Mass production is the future of baking. Seize the day, and synergize!':
		'Masová produkce je budoucností pečení. Využijte den naplno a synergizujte!',
	Bank: 'Banka',
	bank: 'banka',
	banks: 'banky',
	'%1 bank': ['%1 banka', '%1 bank'],
	...
	"[Bank business quote]Business folks with a nose for profit, ready to finance your venture as long as there's money to be made.":
		'Obchodníci, kteří dokážou vycítit zisk. Jsou připraveni financovat vaše podnikání, dokud je co vydělávat.',
	Temple: 'Chrám',
	temple: 'chrám',
	temples: 'chrámy',
	'%1 temple': ['%1 chrám', '%1 chrámů'],
	...
	'[Temple business quote]Your social media page is going viral! Amassing likes is the key to a lasting online presence and juicy advertising deals.':
		'Vaše sociální sítě se stávají virálními! Shromažďování lajků je klíčem k dlouhotrvajícímu online působení a šťavnatým reklamním kampaním.',
	'Wizard tower': 'Čarodějná věž',
	'wizard tower': 'Čarodějná věž',
	'wizard towers': 'čarodějné věže',
	'%1 wizard tower': ['%1 čarodějná věž', '%1 čarodějných věží'],
	...
	'[Wizard tower business quote]Cookie memes are all the rage! With just the right amount of social media astroturfing, your brand image will be all over the cyberspace.':
		'Keksové meme jsou hit! Stačí správná míra taktizování na sociálních sítí a logo vaší značky bude po celém kyberprostoru.',
	Shipment: 'Dodávka',
	shipment: 'dodávka',
	shipments: 'dodávky',
	'%1 shipment': ['%1 dodávka', '%1 dodávek'],
	'[Shipment quote]Brings in fresh cookies from the cookie planet.':
		'Přiváží čerstvé keksy z keksové planety.',
	...
	'[Shipment business quote]A gigantic cookie emporium - your very own retail chain.':
		'Gigantické keksové tržiště - váš vlastní obchodní řetězec.',
	'Alchemy lab': 'Alchymistická laboratoř',
	'alchemy lab': 'Alchymistická laboratoř',
	'alchemy labs': 'alchymistické laboratoře',
	'%1 alchemy lab': ['%1 alchymistická laboratoř', '%1 alchymistických laboratoří'],
	...
	"[Alchemy lab business quote]You're officially on the stock market, and everyone wants a piece!":
		'Jste oficiálně na akciové burze a všichni chtějí svůj díl!',
	Portal: 'Portál',
	portal: 'portál',
	portals: 'portály',
	'%1 portal': ['%1 portál', '%1 portály'],
	...
	'[Portal business quote]Your cookies have their own sitcom! Hilarious baking hijinks set to the cheesiest laughtrack.':
		'Vaše keksy mají vlastní sitcom! Vtipné příhody z pečení vás rozesmějí stejně spolehlivě, jako když se řekne "sýr".',
	'Time machine': 'Stroj času',
	'time machine': 'stroj času',
	'time machines': 'stroje času',
	'%1 time machine': ['%1 stroj času', '%1 strojů času'],
	...
	'[Time machine business quote]Cookie theme parks, full of mascots and roller-coasters. Build one, build a hundred!':
		'Keksový zábavní park plný maskotů a horských drah. Postavte jeden nebo klidně sto!',
	'Antimatter condenser': 'Antihmotový kondenzátor',
	'antimatter condenser': 'antihmotový kondenzátor',
	'antimatter condensers': 'Antihmotové kondenzátory',
	'%1 antimatter condenser': ['%1 antihmotový kondenzátor', '%1 antihmotové kondenzátory'],
	'[Antimatter condenser quote]Condenses the antimatter in the universe into cookies.':
		'Kondenzuje antihmotu ve vesmíru na keksy.',
	...
	'[Antimatter condenser business quote]A virtual currency, already replacing regular money in some small countries.':
		'Virtuální měna, která v některých menších zemích už teď nahrazuje běžné peníze.',
	Prism: 'Prizma',
	prism: 'prizma',
	prisms: 'prizmata',
	'%1 prism': ['%1 prizma', '%1 prizmat'],
	...
	"[Prism business quote]You've made it to the top, and you can now buy entire nations to further your corporate greed. Godspeed.":
		'Dostali jste se na vrchol a nyní můžete rozvíjet svůj korporátní mamon skupováním celých národů. Ať se daří.',
	Chancemaker: 'Šancovač',
	chancemaker: 'šancovač',
	chancemakers: 'šancovače',
	'%1 chancemaker': ['%1 šancovač', '%1 šancovačů'],
	'[Chancemaker quote]Generates cookies out of thin air through sheer luck.':
		'Generuje keksy jen tak z ničeho, čistě na bázi štěstí.',
	...
	"[Chancemaker business quote]Actually, you know what's cool? A whole planet dedicated to producing, advertising, selling, and consuming your cookies.":
		'A víte, co je vůbec super? Celá planeta zasvěcená výrobě, propagaci, prodeji a konzumaci vašich keksů.',
	'Fractal engine': 'Fraktální motor',
	'fractal engine': 'fraktální motor',
	'fractal engines': 'fraktální motory',
	'%1 fractal engine': ['%1 fraktální motor', '%1 fraktální motory'],
	'[Fractal engine quote]Turns cookies into even more cookies.':
		'Přeměňuje keksy na ještě více keksů.',
	...
	'[Fractal engine business quote]Only through political dominion can you truly alter this world to create a brighter, more cookie-friendly future.':
		'Pouze skrze politickou nadvládu můžete skutečně přetvořit svět v příjemnější, keksům přívětivé místo.',
	'Javascript console': 'Konzole javascript',
	'javascript console': 'konzole javascript',
	'javascript consoles': 'Konzole javascript',
	'%1 javascript console': ['%1 konzole javascript', '%1 konzole javascript'],
	'[Javascript console quote]Creates cookies from the very code this game was written in.':
		'Vytváří keksy přímo z kódu, ve kterém je psána tato hra.',
	...
	'[Javascript console business quote]Taking many forms -religion, culture, philosophy- a doctrine may, when handled properly, cause a lasting impact on civilizations, reshaping minds and people and ensuring all future generations share a singular goal - the production, and acquisition, of more cookies.':
		'Doktrína má mnoho podob - náboženské, kulturní, filozofické - a když se s ní zachází správně, může mít trvalý dopad na celé civilizace. Přetvoří myšlení i lidi a zaručí, že budou veškeré budoucí generace sdílet společný cíl - aby produkovali a získávali více keksů.',
	Idleverse: 'Nečinný vesmír',
	idleverse: 'nečinný vesmír',
	idleverses: 'nečinné vesmíry',
	'%1 idleverse': ['%1 nečinný vesmír', '%1 nečinné vesmíry'],
	"[Idleverse quote]There's been countless other idle universes running alongside our own. You've finally found a way to hijack their production and convert whatever they've been making into cookies!":
		'Vedle našeho vesmíru existuje i několik dalších, nečinných vesmírů. Konečně jste objevili způsob, jak se nabourat do jejich produkce a cokoliv, co vyrábějí, přeměnit na keksy!',
	...
	'[Idleverse business quote]Sometimes the best way to keep going up is sideways. Diversify your ventures through non-cookie investments.':
		'Někdy je nejlepší postupovat do stran. Zpestřete své podnikání mimokeksovými investicemi.',
	'Cortex baker': 'Kortexový pekař',
	'cortex baker': 'kortexový pekař',
	'cortex bakers': 'kortexoví pekaři',
	'%1 cortex baker': ['%1 kortexový pekař', '%1 kortexových pekařů'],
	'[Cortex baker quote]These artificial brains the size of planets are capable of simply dreaming up cookies into existence. Time and space are inconsequential. Reality is arbitrary.':
		'Tyto umělé mozky o velikosti planety jsou schopné zhmotnit sny o keksech. Čas a prostor jsou nepodstatné. Realita je svévolná.',
	...
	"[Cortex baker business quote]There's only so many ways you can bring in more profit. Or is there? Hire the most brilliant experts in the known universe and let them scrape their brains for you!":
		'Existuje jen omezený počet způsobů, jak dosáhnout vyššího zisku. Nebo ne? Najměte si ty nejgeniálnější experty v celém známém vesmíru a nechte je, ať si pro vás namáhají mozky!',
	CpS: 'K/s',
	...
	'All cookie production <b>multiplied by %1</b>.':
		'Veškerá produkce keksů <b>multiplied by %1</b>.',
	'+%1 CpS': '+%1 K/s',
	...
	'Tiered upgrades for <b>%1</b> provide an extra <b>+%2%</b> production.<br>Only works with unshackled upgrade tiers.':
		'Odstupňovaná vylepšení (pro: <b>%1</b>) poskytují <b>+%2 %</b> k produkci.<br>Funguje pouze s nespoutanými stupni vylepšení.',
	'Unshackles all <b>%1-tier upgrades</b>, making them more powerful.<br>Only applies to unshackled buildings.':
		'Učiní všechna <b>vylepšení %1. úrovně</b> nespoutanými, a tím zvýší jejich efektivitu.<br>Pouze platí pro budovy bez okovů.',
	'The mouse and cursors are <b>twice</b> as efficient.':
		'Myš a kurzory jsou <b>twice</b> efektivnější.',
	'The mouse and cursors gain <b>+%1</b> cookies for each non-cursor building owned.':
		'Myš a kurzory získávají <b>+%1</b> keksů za každou nekurzorovou budovu, kterou vlastníte.',
	'Grandmas gain <b>+%1% CpS</b> for each non-grandma building.':
		'Babičky získávají <b>+%1% CpS</b> za každou nebabičkovskou budovu.',
	'You gain <b>more CpS</b> the more milk you have.':
		'Získáváte tím více <b>more CpS</b>, čím více máte mléka.',
	...
	'Cookie production multiplier <b>+%1% permanently</b>.':
		'Násobič produkce keksů <b>+%1% permanently</b>.',
	"Cookie production multiplier <b>+%1% per Santa's levels.</b>":
		"Násobič produkce keksů <b>+%1% per Santa's levels.</b>",
	'Cookie production multiplier <b>+%1%</b> for every year Cookie Clicker has existed (currently: <b>+%2%</b>).':
		'Násobič produkce keksů <b>+%1%</b> za každý rok existence Cookie Clicker (currently: <b>+%2%</b>).',
	'Cookie production multiplier <b>+%1%</b> for every building type level %2 or higher.':
		'Násobič produkce keksů <b>+%1%</b> za každou budovu úrovně %2 nebo vyšší.',
	...
	'Grandma-operated science lab and leisure club.<br>Grandmas are <b>4 times</b> as efficient.<br><b>Regularly unlocks new upgrades</b>.':
		'Babičkami ovládaná vědecká laboratoř a volnočasový klub.<br>Babičky jsou <b>4 times</b> efektivnější.<br><b>Regularly unlocks new upgrades</b>.',
	...
	'Note: the grandmothers are growing restless. Do not encourage them.':
		'Poznámka: babičky začínají být neklidné. Nepovzbuzujte je.',
	'Note: proceeding any further in scientific research may have unexpected results. You have been warned.':
		'Poznámka: další postup ve vědeckém výzkumu může mít nečekané následky. Byli jste varováni.',
	...
	"<b>Warning:</b> purchasing this will have unexpected, and potentially undesirable results!<br><small>It's all downhill from here. You have been warned!</small><br><br>Purchase anyway?":
		"<b>Warning:</b> tato koupě bude mít nečekané a potenciálně nežádoucí následky!<br><small>It's all downhill from here. You have been warned!</small><br><br>Stejně koupit?",
	'Contains the wrath of the elders, at least for a while.':
		'Obsahuje hněv prastarých, minimálně na chvíli.',
	"Puts a permanent end to the elders' wrath, at the cost of %1% of your CpS.":
		'Trvale ukončí hněv prastarých za cenu %1% z vašeho K/s.',
	'You will get %1% of your CpS back, but the grandmatriarchs will return.':
		'Získáte nazpět %1% ze svého K/s, ale pramatky se vrátí.',
	...
	'Golden cookies appear <b>twice as often</b> and stay <b>twice as long</b>.':
		'Zlaté keksy se objevují <b>twice as often</b> a zůstávají <b>twice as long</b>.',
	...
	'Golden cookies appear <b>%1%</b> more often during %2.':
		'Zlaté keksy se objevují <b>%1%</b> častěji během %2.',
	...
	'Golden cookie effects last <b>twice as long</b>.':
		'Efekty zlatých keksů trvají <b>twice as long</b>.',
	...
	'<b>+%1% CpS</b> per golden cookie on-screen, multiplicative.':
		'<b>+%1% CpS</b> za zlatý keks na obrazovce, lze násobit.',
	'With no buffs and no golden cookies on screen, selling your most powerful building has <b>%1% chance to summon one</b>.':
		'Nemáte-li žádná posílení a žádné zlaté keksy na obrazovce, prodej vaší nejsilnější budovy má <b>%1% chance to summon one</b>.',
	'Confers various powers to your minigames while active.<br>See the bottom of each minigame for more details.':
		'Po dobu své aktivity propůjčuje vašim minihrám různé síly.<br>Podrobnosti najdete u jednotlivých her dole.',
	...
	'Can toggle upgrades on and off at will in the stats menu.':
		' V nabídce atributů lze zapnout a vypnout vylepšení.',
	'You keep producing cookies even while the game is closed.':
		'Keksy se produkují i v případě, že je hra zavřená.',
	'Unlocks <b>%1%</b> of the potential of your prestige level.':
		'Odemkne <b>%1%</b> potenciálu úrovně vaší prestiže.',
	'Subsequent research will be <b>%1 times</b> as fast.':
		'Následný výzkum bude <b>%1 times</b> rychlejší.',
	...
	'Wrinklers explode into <b>%1% more cookies</b>.':
		'Vrubouni vybuchnou do <b>%1% more cookies</b>.',
	...
	'Buildings sell back for <b>%1%</b> instead of %2%.':
		'Zpětný prodej budov je za <b>%1%</b> namísto %2%.',
	...
	'All buildings and upgrades are <b>%1% cheaper</b>.':
		'Všechny budovy a vylepšení jsou <b>%1% cheaper</b>.',
	'%1 are <b>%2%</b> more efficient and <b>%3%</b> cheaper.':
		'%1 jsou <b>%2%</b> efektivnější a <b>%3%</b> levnější.',
	...
	'Allows you to <b>trigger seasonal events</b> at will, for a price.':
		'Umožňuje vám za určitou cenu <b>trigger seasonal events</b>, kdy chcete. ',
	'Triggers <b>%1 season</b> for the next 24 hours.<br>Triggering another season will cancel this one.<br>Cost scales with unbuffed CpS and increases with every season switch.':
		'Spustí <b>%1 season</b> na následujících 24 hodin.<br>Spuštění dalšího období zruší současné období.<br>Výše nákladů se odvíjí podle K/s bez posílení a zvyšuje se s každým přepnutím období.',
	...
	"You continually gain <b>more CpS the longer you've played</b> in the current ascension.":
		"V současném postupu neustále získáváte <b>more CpS the longer you've played</b> v současném povznesení.",
	...
	'Placing an upgrade in this slot will make its effects <b>permanent</b> across all playthroughs.':
		'Vložení vylepšení na tuto pozici učiní jeho efekt <b>permanent</b> pro všechny hry.',
	...
	'Here are all the upgrades you\'ve purchased last playthrough.<div class="line"></div>Pick one to permanently gain its effects!<div class="line"></div>You can reassign this slot anytime you ascend.':
		'Zde jsou veškerá vylepšení, která jste zakoupili za poslední hru.<div class="line"></div>Vyberte si jedno, jehož efekty získáte trvale!<div class="line"></div>Tuto pozici můžete nahradit kdykoliv, když se povznesete.',
	'You now <b>keep making cookies while the game is closed</b>, at the rate of <b>%1%</b> of your regular CpS and up to <b>1 hour</b> after the game is closed.<br>(Beyond 1 hour, this is reduced by a further %2% - your rate goes down to <b>%3%</b> of your CpS.)':
		'Nyní <b>keep making cookies while the game is closed</b>, a to rychlostí <b>%1%</b> z vašich běžných K/s a až <b>1 hour</b> poté, co je hra zavřena.<br>(Po 1 hodině se toto snižuje o dalších %2% - vaše rychlost klesá na <b>%3%</b> vašich K/s.) ',
	'You gain another <b>+%1%</b> of your regular CpS while the game is closed.':
		'Získáváte dalších <b>+%1%</b> z vašich běžných K/s, když je hra zavřená. ',
	'You gain another <b>+%1%</b> of your regular CpS while the game is closed, for a total of <b>%2%</b>.':
		'Získáváte dalších <b>+%1%</b> z vašich běžných K/s, když je hra zavřená, a to celkově <b>%2%</b>.',
	'You start with <b>%1</b>.': 'Začínáte s <b>%1</b>.',
	'Allows you to purchase a <b>crumbly egg</b> once you have earned 1 million cookies.':
		'Umožňuje vám zakoupit si <b>crumbly egg</b>, jakmile dosáhnete 1 milionu sušenek.',
	...
	'You retain optimal cookie production while the game is closed for <b>%1 more days</b>.':
		'Po zavření hry si udržíte optimální produkci keksů po <b>%1 more days</b>.',
	'You retain optimal cookie production while the game is closed for twice as long, for a total of <b>%1</b>.':
		'Po zavření hry si udržíte optimální produkci keksů na dvakrát tak dlouho, a to celkově <b>%1</b>.',
	'Unlocks the <b>golden switch</b>, which passively boosts your CpS by %1% but disables golden cookies.':
		'Odemyká <b>golden switch</b>, který pasivně posílí vaše K/s o %1%, ale deaktivuje zlaté keksy.',
	'Turning this on will give you a passive <b>+%1% CpS</b>, but prevents golden cookies from spawning.<br>Cost is equal to 1 hour of production.':
		'Zapnutím této volby získáte pasivní <b>+%1% CpS</b>, ale nebudou se objevovat zlaté keksy.<br>Náklady se rovnají 1 hodině produkce.',
	'The switch is currently giving you a passive <b>+%1% CpS</b>; it also prevents golden cookies from spawning.<br>Turning it off will revert those effects.<br>Cost is equal to 1 hour of production.':
		'Tento spínač vám momentálně dává pasivních <b>+%1% CpS</b>; zároveň se nebudou objevovat zlaté keksy.<br>Vypnutím této volby tyto efekty zrušíte.<br>Náklady se rovnají 1 hodině produkce.',
	'Unlocks the <b>milk selector</b>, letting you pick which milk is displayed under your cookie.<br>Comes with a variety of basic flavors.':
		'Odemyká <b>milk selector</b>, který vám umožní vybrat si, jaké mléko se zobrazí pod vaším keksem.<br>Přichází v celé škále základních příchutí.',
	'Contains more exotic flavors for your milk selector.':
		'Obsahuje exotičtější příchutě pro váš přepínač mléka.',
	'Lets you pick what flavor of milk to display.':
		'Umožňuje vybrat, jaká příchuť mléka se zobrazí.',
	'Unlocks the <b>golden cookie sound selector</b>, which lets you pick whether golden cookies emit a sound when appearing or not.':
		'Odemyká <b>golden cookie sound selector</b>, která vám umožňuje zvolit si, zda zlaté keksy při svém objevení vydají zvuk nebo ne.',
	'Lets you change the sound golden cookies make when they spawn.':
		'Umožňuje změnit zvuk, který vydává zlatá sušenka tehdy, když se objeví.',
	'No sound': 'Žádný zvuk',
	Chime: 'Rozeznít',
	Fortune: 'Štěstí',
	Cymbal: 'Činel',
	...
	'Unlocks the <b>jukebox</b>, which allows you to play through every sound file in the game.':
		'Odemkne <b>jukebox</b>, který umožňuje přehrávat všechny zvukové soubory ve hře.',
	...
	"Unlocks the <b>background selector</b>, letting you select the game's background.<br>Comes with a variety of basic flavors.":
		'Odemkne se <b>background selector</b>, který vám umožní vybrat pozadí hry.<br>Přichází v celé škále základních příchutí.',
	...
	'This is the first heavenly upgrade; it unlocks the <b>Heavenly chips</b> system.<div class="line"></div>Each time you ascend, the cookies you made in your past life are turned into <b>heavenly chips</b> and <b>prestige</b>.<div class="line"></div><b>Heavenly chips</b> can be spent on a variety of permanent transcendental upgrades.<div class="line"></div>Your <b>prestige level</b> also gives you a permanent <b>+1% CpS</b> per level.':
		'Toto je první nebeská aktualizace; tato aktualizace odemyká systém <b>Heavenly chips</b>. <div class="line"></div>Po každém vzestupu se sušenky, které jste vytvořili ve svém minulém životě, změní na <b>heavenly chips</b> a <b>prestige</b>. <div class="line"></div><b>Heavenly chips</b> můžete utrácet za celou řadu permanentních transcendentálních aktualizací. <div class="line"></div>Vaše <b>prestige level</b> vám také poskytne permanentní <b>+1% CpS</b> v příslušné úrovni (CpS - počet sušenek za sekundu).',
	...
	'While the golden switch is on, you gain an additional <b>+%1% CpS</b> per golden cookie upgrade owned.':
		'Pokud je zapnutý zlatý přepínač, získáte další <b>+%1% CpS</b> za vaši vlastní aktualizaci se zlatou sušenkou.',
	'All upgrades are <b>%1% cheaper per %2</b>.':
		'Všechny aktualizace jsou o <b>%1% cheaper per %2</b>.',
	'Unlocks a new tier of upgrades that affect <b>2 buildings at the same time</b>.<br>Synergies appear once you have <b>%1</b> of both buildings.':
		'Odemkne se nová úroveň aktualizací, která bude mít vliv na <b>2 buildings at the same time</b>.<br>Jakmile budete mít v obou stavbách <b>%1</b>, dojde k synergii.',
	'Golden cookies (and all other things that spawn, such as reindeer) have <b>%1% chance of being doubled</b>.':
		'Zlaté sušenky (a všechny ostatní věci, které se zde objevují, například sobi) mají <b>%1% chance of being doubled</b>.',
	'Cookie production <b>reduced to 0</b>.': 'Produkce sušenek <b>snížena na 0</b>.',
	'Sugar lumps coalesce <b>a whole lot faster</b>.':
		'Kostky cukru se spojují <b>a whole lot faster</b>.',
	'<b>+%1%</b> prestige level effect on CpS.':
		'Účinek <b>+%1%</b> úrovně prestiže na CpS (počet sušenek za sekundu).',
	'<b>+%1%</b> prestige level effect on CpS.<br><b>+%2%</b> golden cookie effect duration.<br><b>+%3%</b> golden cookie lifespan.':
		'Účinek <b>+%1%</b> úrovně prestiže na CpS (počet sušenek za sekundu).<br><b>+%2%</b> doba trvání účinku zlaté sušenky.<br><b>+%3%</b> životnost zlaté sušenky.',
	'Each unspent sugar lump (up to %1) gives <b>+%2% CpS</b>.<div class="warning">Note: this means that spending sugar lumps will decrease your CpS until they grow back.</div>':
		'Každá nevyčerpaná kostka cukru (až do %1) dává <b>+%2% CpS</b>.<div class="warning">Note: this means that spending sugar lumps will decrease your CpS until they grow back.</div>',
	'Once an ascension, you may use the "Sugar frenzy" switch to <b>triple your CpS</b> for 1 hour, at the cost of <b>1 sugar lump</b>.':
		'Po vzestupu můžete pomocí přepínače "Sugar Frenzy" přepnout na <b>triple your CpS</b> na dobu 1 hodiny; cena <b>1 sugar lump</b>.',
	'Each grandma (up to %1) makes sugar lumps ripen <b>%2</b> sooner.':
		'S každou babičkou (až do %1) dozrávají kostky cukru o <b>%2</b> dříve.',
	'Activating this will <b>triple your CpS</b> for 1 hour, at the cost of <b>1 sugar lump</b>.':
		'Aktivací této funkce <b>triple your CpS</b> na dobu 1 hodiny, za cenu <b>1 sugar lump</b>.',
	...
	'Garden plants grow every second.<br>Garden seeds are free to plant.<br>You can switch soils at any time.':
		'Zahradní rostliny vyrůstají každou sekundu.<br>Semena na zahradě můžete sázet zdarma.<br>Můžete kdykoli přepínat mezi různými půdami.',
	...
	'Sugar lumps are <b>twice as likely</b> to be unusual.':
		'Kostky cukru jsou velmi neobvyklé <b>twice as likely</b>.',
	...
	'Bifurcated sugar lumps appear <b>%1% more often</b> and are <b>%2% more likely</b> to drop 2 lumps.':
		'Rozdvojené kostky cukru se objevují <b>%1% more often</b> a existuje u nich větší pravděpodobnost <b>%2% more likely</b> uvolnění 2 kostek.',
	'Mouse over a wrinkler to see how many cookies are in its stomach.':
		'Najeďte myší na wrinkler a zjistěte, kolik má v žaludku sušenek.',
	'Unlocks the <b>Buy all</b> feature, which lets you instantly purchase every upgrade in your store (starting from the cheapest one).<br>Also unlocks the <b>Vault</b>, a store section where you can place upgrades you do not wish to auto-buy.':
		'Odemkne se funkce <b>Buy all</b>, která vám umožní okamžitě kupovat jednotlivé aktualizace ve vašem obchodě (od nejlevnější).<br>Odemkne se také <b>Vault</b>, sekce obchodu, kde můžete ukládat aktualizace, které si nepřejete automaticky nakupovat.',
	'Mouse over an upgrade to see its tier.<br><small>Note: only some upgrades have tiers. Tiers are purely cosmetic and have no effect on gameplay.</small>':
		'Umístěte kurzor nad aktualizaci a podívejte se na její úroveň.<br><small>Note: only some upgrades have tiers. Tiers are purely cosmetic and have no effect on gameplay.</small>',
	'You now benefit from the boost provided by <b>heralds</b>.<br>Each herald gives you <b>+1% CpS</b>.<br>Look on the purple flag at the top to see how many heralds are active at any given time.':
		'Nyní můžete využít podporu poskytovanou prostřednictvím <b>heralds</b>.<br>Každý posel vám dává <b>+1% CpS</b>.<br>Podívejte se nahoru na fialovou vlajku a zjistěte, kolik poslů je v daném okamžiku aktivních.',
	'Seasonal random drops have a <b>1/5 chance</b> to carry over through ascensions.':
		'Sezónní náhodné poklesy mají <b>1/5 chance</b> na přenesení prostřednictvím vzestupu.',
	"Unlocks <b>extra price information</b>.<br>Each displayed cost now specifies how long it'll take you to afford it, and how much of your bank it represents.":
		'Odemyká <b>extra price information</b>.<br>Každá zobrazená cena nyní určuje, jak dlouho vám bude trvat, než si ji budete moci dovolit, a jakou hodnotu z vaší banky bude představovat.',
	'Unlocks the <b>shimmering veil</b>, a switch that passively boosts your CpS by <b>%1%</b>.<br>You start with the veil turned on; however, it is very fragile, and clicking the big cookie or any golden cookie or reindeer will turn it off, requiring %2 of CpS to turn back on.':
		'Odemyká <b>shimmering veil</b>, přepínač, který pasivně zvýší vaši hodnotu CpS o <b>%1%</b>.<br>Začínáte se zapnutým závojem; závoj je však velmi křehký a pouhým kliknutím velkou sušenku nebo na jakoukoli zlatou sušenku nebo na soba tento závoj vypnete, což vyžaduje opětovné zapnutí %2 CpS.',
	'Boosts your cookie production by <b>%1%</b> when active.<br>The veil is very fragile and will break if you click the big cookie or any golden cookies or reindeer.<br><br>Once broken, turning the veil back on costs %2 of unbuffed CpS.':
		'Pokud je závoj aktivní, zvyšuje se produkce sušenek o <b>%1%</b>.<br>Závoj je velmi křehký a rozbije se, když kliknete na velkou sušenku, na jakoukoli zlatou sušenku nebo na soba.<br><br>Jakmile se rozbije, pak opětovné zapnutí závoje stojí %2 nevypuštěné CpS.',
	...
	'The <b>shimmering veil</b> is more resistant, and has a <b>%1% chance</b> not to break. It also gives <b>+%2%</b> more CpS.':
		'<b>shimmering veil</b> je odolnější a má šanci <b>%1% chance</b>, že se nerozbije. Poskytuje také o <b>+%2%</b> více CpS.',
	'Active.': 'Aktivní.',
	'The reinforced membrane protects the shimmering veil.':
		'Zesílená membrána chrání třpytivý závoj.',
	...
	'Prior to purchasing the <b>%1</b> upgrade in a run, random drops are <b>%2 times more common</b>.':
		'Před zakoupením aktualizace <b>%1</b> v rámci běhu jsou náhodné poklesy <b>%2 times more common</b>.',
	...
	'The news ticker may occasionally have <b>fortunes</b>, which may be clicked for something good.':
		'Ve zprávách mohou být příležitostně <b>fortunes</b>, na které můžete kliknout a získat něco dobrého.',
	'Through clever accounting, this actually makes kitten upgrades <b>%1% cheaper</b>.':
		'Díky chytrému účtu mohou být aktualizace koťat o <b>%1% cheaper</b>.',
	'Unlocks the ability to <b>pet your dragon</b> by clicking on it once hatched.':
		'Odemkne se možnost <b>pet your dragon</b> kliknutím na vylíhnutého draka.',
	'Cost scales with CpS, but %1 times cheaper with a fully-trained dragon.':
		'Cenová škála s CpS, ale %1krát levnější s plně vyškoleným drakem.',
	'Golden cookies may trigger a <b>Dragon Harvest</b>.':
		'Zlaté sušenky mohou spustit <b>Dragon Harvest</b>.',
	'Golden cookies may trigger a <b>Dragonflight</b>.':
		'Zlaté sušenky mohou spustit <b>Dragonflight</b>.',
	'Dragon harvest and Dragonflight are <b>%1% stronger</b>.':
		'Dračí sklizeň a Dračí let jsou o <b>%1% stronger</b>.',
	'Kittens are <b>%1%</b> more effective.': 'Koťata jsou o <b>%1%</b> efektivnější.',
	'Each kitten upgrade boosts %1 CpS by <b>%2%</b>.':
		'Každá aktualizace kotěte zvyšuje %1 CpS o <b>%2%</b>.',
	'Each rank of milk boosts %1 CpS by <b>%2%</b>.':
		'Každé pořadí mléka zvyšuje %1 CpS o <b>%2%</b>.',
	'Cursor levels boost clicks by <b>%1%</b> each (up to cursor level %2).':
		'Úrovně kurzoru zvyšují počet kliknutí o <b>%1%</b> (až na úroveň kurzoru %2).',
	'<b>%1</b> are now effective up to cursor level %2.':
		'<b>%1</b> jsou nyní účinné až do úrovně kurzoru %2.',
	...
	'Golden and wrath cookie effect duration +%1%.':
		'Doba trvání účinku zlatého a červeného keksu +%1%.',
	...
	'Selling buildings triggers a buff boosted by how many buildings were sold.':
		'Prodej budov spustí buff zesílený podle toho, kolik budov se prodalo.',
	'Buff boosts clicks by +%1% for every building sold for %2 seconds.':
		'Buff zesílí kliknutí o +%1% za každou prodanou budovu o %2 vteřin.',
	'CpS bonus fluctuating between %1 and %2 over time.':
		'Bonus K/s se průběžně pohybuje mezi %1 a %2.',
	...
	'All golden cookies are wrath cookies with a greater chance of a negative effect.':
		'Všechny zlaté keksy jsou červené keksy s větší šancí negativního účinku.',
	'Wrinklers appear %1% faster and digest %2% more cookies.':
		'Vrubouny se objeví %1% rychleji a spolykají %2% víc keksů.',
	'Effect is only active when your total amount of buildings ends with 0.':
		'Účinek je aktivní jen když počet tvých budov končí na 0.',
	...
	'Make <b>%1</b> by only having clicked <b>%2 times</b>.':
		'Vytvořte <b>%1</b> pouhým kliknutím <b>%2 times</b>.',
	'Make <b>%1</b> with <b>no</b> cookie clicks.':
		'Vytvořte <b>%1</b> kliknutím na <b>no</b> sušenky.',
	'Get to <b>%1</b> baked with <b>no upgrades purchased</b>.':
		'Přejděte na <b>%1</b> upečené s <b>no upgrades purchased</b>.',
	...
	'Have at least <b>1 of the most expensive object, 2 of the second-most expensive, 4 of the next</b> and so on (capped at %1).':
		'Získejte alespoň <b>1 of the most expensive object, 2 of the second-most expensive, 4 of the next</b> a tak dále (omezeno na %1).',
	'Have at least <b>10 of the most expensive object, 20 of the second-most expensive, 30 of the next</b> and so on.':
		'Získejte alespoň <b>10 of the most expensive object, 20 of the second-most expensive, 30 of the next</b> a tak dále.',
	...
	'Appease the grandmatriarchs at least <b>once</b>.':
		'Alespoň <b>once</b> archimatrony uklidněte.',
	'Appease the grandmatriarchs at least <b>%1 times</b>.':
		'Alespoň <b>%1 times</b> archimatrony uklidněte.',
	...
	'Unlock <b>100%</b> of your heavenly chips power.':
		'Odemkněte <b>100%</b> své síly nebeských čipů.',
	'You have <b>1 chance in %1</b> every second of earning this achievement.':
		'Každou sekundu máte šanci <b>1 chance in %1</b> dosáhnout této úrovně.',
	...
	'Unlock <b>every Halloween-themed cookie</b>.<div class="line"></div>Owning this achievement makes Halloween-themed cookies drop more frequently in future playthroughs.':
		'Odemkněte <b>every Halloween-themed cookie</b>.<div class="line"></div>Dosažením této úrovně způsobíte, že sušenky s tématem Halloween budou v budoucích přehrávkách padat častěji.',
	...
	'Unlock <b>every Christmas-themed cookie</b>.<div class="line"></div>Owning this achievement makes Christmas-themed cookies drop more frequently in future playthroughs.':
		'Odemkněte <b>every Christmas-themed cookie</b>.<div class="line"></div>Dosažením této úrovně způsobíte, že sušenky s tématem Vánoce budou v budoucích přehrávkách padat častěji.',
	...
	'This is for baking %1 and making it on the local news.':
		'Toto se týká pečení %1 a zveřejnění v místních zprávách.',
	'Name yourself <b>Orteil</b>.<div class="warning">Note: usurpers incur a -%1% CpS penalty until they rename themselves something else.</div>':
		'Pojmenujte si <b>Orteil</b>.<div class="warning">Note: usurpers incur a -%1% CpS penalty until they rename themselves something else.</div>',
	...
	'Unlock <b>all the eggs</b>.<div class="line"></div>Owning this achievement makes eggs drop more frequently in future playthroughs.':
		'Odemkněte <b>all the eggs</b>.<div class="line"></div>Dosažením této úrovně způsobíte, že vajíčka budou v budoucích přehrávkách padat častěji.',
	...
	"Successfully harvest a coalescing sugar lump before it's ripe.":
		'Úspěšná sklizeň spojující se kostky cukru před jejím dozráním.',
	...
	'Manage a cookie legacy for <b>at least a year</b>.':
		'Vytvořte historii sušenek za dobu <b>at least a year</b>.',
	...
	'Fill every tile of the biggest garden plot with plants.':
		'Zaplňte jednotlivé dlaždice největšího zahradního pozemku rostlinami.',
	...
	'Convert a complete seed log into sugar lumps by sacrificing your garden to the sugar hornets.<div class="line"></div>Owning this achievement makes seeds <b>%1% cheaper</b>, plants mature <b>%2% sooner</b>, and plant upgrades drop <b>%3% more</b>.':
		'Převeďte kompletní protokol semen do formy kostek cukru tím, že obětujete svoji zahradu pro cukrové sršně.<div class="line"></div>Díky tomuto postupu budou semena <b>%1% cheaper</b>, rostliny budou dozrávat <b>%2% sooner</b> a dojde také k poklesu aktualizací rostlin <b>%3% more</b>.',
	...
	'Have your <b>reinforced membrane</b> protect the <b>shimmering veil</b>.':
		'Vaše <b>reinforced membrane</b> musí chránit <b>shimmering veil</b>.',
	'Own every <b>fortune upgrade</b>.<div class="line"></div>Owning this achievement makes fortunes appear <b>twice as often</b>; unlocked fortune upgrades also have a <b>%1% chance</b> to carry over after ascending.':
		'Získejte každou aktualizaci <b>fortune upgrade</b>.<div class="line"></div>Díky tomu se budou šťastné sušenky objevovat <b>twice as often</b>; odemčené aktualizace šťastných sušenek také představují <b>%1% chance</b> pro přenesení po vzestupu.',
	...
	'Own at least <b>%1</b> of every stock market good.':
		'Získejte alespoň <b>%1</b> na každém akciovém trhu.',
	'Make <b>a day</b> of CpS ($%1) in 1 stock market sale.':
		'Zajistěte <b>a day</b> CpS ($%1) v 1 akciovém prodeji.',
	'Spend <b>a day</b> of CpS ($%1) in 1 stock market purchase.':
		'Utraťte <b>a day</b> CpS ($%1) v 1 akciovém nákupu.',
	'Have your stock market profits surpass <b>a whole year</b> of CpS ($%1).':
		'Nechte své zisky na akciovém trhu překonat hodnotu <b>a whole year</b> CpS ($%1).',
	'Unlock the <b>highest-tier</b> stock market headquarters.':
		'Odemkněte <b>highest-tier</b> ústředí akciových trhů s nejvyšší úrovní.',
	'Have your stock market profits surpass <b>$%1</b>.':
		'Nechte své zisky na akciovém trhu překonat hodnotu <b>$%1</b>.',
	...
	"Click one of Santa's helper grandmas during Christmas season.":
		'Klikněte během vánočního období na jednu ze Santových babiček pomocnic.',
	Frenzy: '/',
	...
	'Cookie production halted for %1,<br>but each click is worth %2 of CpS.':
		'Produkce sušenek byla zastavena u %1,<br>ale každé kliknutí má hodnotu %2 CpS.',
	...
	'You find %1% more golden cookies for the next %2.':
		'Můžete najít o %1% více zlatých sušenek v dalším %2.',
	...
	"[Baker's wheat quote]A plentiful crop whose hardy grain is used to make flour for pastries.":
		'Bohatá plodina, jejíž odolné zrno se používá k výrobě mouky pro pečivo.',
	...
	'[Thumbcorn quote]A strangely-shaped variant of corn. The amount of strands that can sprout from one seed is usually in the single digits.':
		'Zvláštní varianta kukuřice. Počty pramenů, které mohou klíčit z jednoho semene, se obvykle počítají v jednotkách.',
	...
	"[Cronerice quote]Not only does this wrinkly bulb look nothing like rice, it's not even related to it either; its closest extant relative is the weeping willow.":
		'Tato vrásčitá struktura vůbec nevypadá jako rýže, ani s ní jakkoli nesouvisí; nejbližší existující příbuznou je smuteční vrba.',
	...
	'[Gildmillet quote]An ancient staple crop, famed for its golden sheen. Was once used to bake birthday cakes for kings and queens of old.':
		'Starodávná základní plodina známá svým zlatým leskem. Kdysi se používala k pečení narozeninových dortů pro krále a královny.',
	...
	'[Ordinary clover quote]<i>Trifolium repens</i>, a fairly mundane variety of clover with a tendency to produce four leaves. Such instances are considered lucky by some.':
		'<i>Trifolium repens</i>, poměrně obyčejná odrůda jetele s tendencí vytváření čtyř listů. Někteří lidé považují takové případy za šťastné.',
	...
	'[Golden clover quote]A variant of the ordinary clover that traded its chlorophyll for pure organic gold. Tragically short-lived, this herb is an evolutionary dead-end - but at least it looks pretty.':
		'Varianta obyčejného jetele, který však vyměnil svůj chlorofyl za čisté organické zlato. Díky tragicky krátké životnosti představuje tato bylina vývojovou slepou uličku - ale aspoň vypadá hezky.',
	...
	'[Shimmerlily quote]These little flowers are easiest to find at dawn, as the sunlight refracting in dew drops draws attention to their pure-white petals.':
		'Tyto malé květy uvidíte nejlépe za úsvitu, protože sluneční světlo lámající se v kapkách rosy upozorňuje na jejich čistě bílé okvětní lístky.',
	...
	'[Elderwort quote]A very old, long-forgotten subspecies of edelweiss that emits a strange, heady scent. There is some anecdotal evidence that these do not undergo molecular aging.':
		'Velmi starý, dávno zapomenutý poddruh protěže vydávající podivnou a opojnou vůni. Existují určité neoficiální důkazy, že tyto látky neprocházejí molekulárním stárnutím.',
	...
	'[Bakeberry quote]A favorite among cooks, this large berry has a crunchy brown exterior and a creamy red center. Excellent in pies or chicken stews.':
		'Tato velká plodina je oblíbená mezi kuchaři, má křupavý hnědý exteriér a krémově červený střed. Je vynikající v koláčích nebo v kuřecím masu.',
	...
	'[Chocoroot quote]A tangly bramble coated in a sticky, sweet substance. Unknown genetic ancestry. Children often pick these from fields as-is as a snack.':
		'Zapletený keř pokrytý lepkavou sladkou látkou. Neznámý genetický původ. Děti často tento keř obírají na polích a dávají si jeho plody na svačinu.',
	...
	'[White chocoroot quote]A pale, even sweeter variant of the chocoroot. Often impedes travelers with its twisty branches.':
		'Bledá a ještě sladší varianta čokoládového kořene. Cestovatelům často ztěžují přístup jeho zkroucené větve.',
	...
	'[White mildew quote]A common rot that infests shady plots of earth. Grows in little creamy capsules. Smells sweet, but sadly wilts quickly.':
		'Běžná hniloba, která zamořuje pozemky ve stínu. Roste v malých krémových tobolkách. Má sladkou vůni, ale velmi rychle vadne.',
	...
	'[Brown mold quote]A common rot that infests shady plots of earth. Grows in odd reddish clumps. Smells bitter, but thankfully wilts quickly.':
		'Běžná hniloba, která zamořuje pozemky ve stínu. Roste v nevzhledných načervenalých shlucích. Má hořkou vůni a velmi rychle vadne.',
	...
	'[Meddleweed quote]The sign of a neglected farmland, this annoying weed spawns from unused dirt and may sometimes spread to other plants, killing them in the process.':
		'Známka zanedbané zemědělské půdy; tento nepříjemný plevel se objevuje na nepoužívaných nečistotách a někdy se může rozšířit do dalších rostlin, které v tomto procesu zabije.',
	...
	"[Whiskerbloom quote]Squeezing the translucent pods makes them excrete a milky liquid, while producing a faint squeak akin to a cat's meow.":
		'Mačkáním průsvitných lusků způsobíte vylučování mléčné tekutiny a současně dojde k slabému pískotu podobnému kočičímu mňoukání.',
	Chimerose: 'Chimeróza',
	'[Chimerose quote]Originating in the greener flanks of polar mountains, this beautiful flower with golden accents is fragrant enough to make any room feel a little bit more festive.':
		'Tato krásná květina pochází ze zelených úbočí polárních hor; má dostatečnou vůni na to, aby vytvořila v místnosti slavnostní atmosféru.',
	...
	'[Nursetulip quote]This flower grows an intricate root network that distributes nutrients throughout the surrounding soil. The reason for this seemingly altruistic behavior is still unknown.':
		'Tato květina má složitou kořenovou síť, která distribuuje živiny po okolní půdě. Důvod tohoto zdánlivě altruistického chování není dosud znám.',
	Drowsyfern: '/',
	'[Drowsyfern quote]Traditionally used to brew a tea that guarantees a good night of sleep.':
		'Tradičně se používá k vaření čaje, který je zárukou dobrého spánku.',
	Wardlichen: '/',
	'[Wardlichen quote]The metallic stench that emanates from this organism has been known to keep insects and slugs away.':
		'Je známo, že kovový zápach vycházející z tohoto organismu odpuzuje hmyz a slimáky.',
	Keenmoss: '/',
	'[Keenmoss quote]Fuzzy to the touch and of a vibrant green. In plant symbolism, keenmoss is associated with good luck for finding lost objects.':
		'Měkký na dotek a zářivě zelený. V rostlinné symbolice je keenmoss spojován se štěstím při hledání ztracených předmětů.',
	...
	'[Queenbeet quote]A delicious taproot used to prepare high-grade white sugar. Entire countries once went to war over these.':
		'Lahodný hlavní kořen používaný k přípravě kvalitního bílého cukru. Kdysi s ním chodívaly do války celé země.',
	...
	'[Juicy queenbeet quote]A delicious taproot used to prepare high-grade white sugar. Entire countries once went to war over these.<br>It looks like this one has grown especially sweeter and juicier from growing in close proximity to other queenbeets.':
		'Lahodný hlavní kořen používaný k přípravě kvalitního bílého cukru. Kdysi s ním chodívaly do války celé země.<br>Vypadá to, že tato je obzvláště sladká a šťavnatější, protože vyrostla v těsné blízkosti ostatních královských řep.',
	Duketater: '/',
	'[Duketater quote]A rare, rich-tasting tuber fit for a whole meal, as long as its strict harvesting schedule is respected. Its starch has fascinating baking properties.':
		'Vzácná hlíza s bohatou chutí vhodná pro plné pokrmy, pokud je respektován její přísný harmonogram sklizně. Její škrob má fascinující vlastnosti při pečení.',
	...
	'[Crumbspore quote]An archaic mold that spreads its spores to the surrounding dirt through simple pod explosion.':
		'Archaická forma, která rozšiřuje své spory na okolní špínu jednoduchou explozí tobolky.',
	Doughshroom: '/',
	'[Doughshroom quote]Jammed full of warm spores; some forest walkers often describe the smell as similar to passing by a bakery.':
		'Blokace teplými spóry; někteří návštěvníci lesů často popisují vůni jako vůni kolem pekárny.',
	Glovemorel: '/',
	'[Glovemorel quote]Touching its waxy skin reveals that the interior is hollow and uncomfortably squishy.':
		'Pocit voskové kůže na dotek odhaluje, že interiér je dutý a nepříjemně měkký.',
	...
	'[Cheapcap quote]Small, tough, and good in omelettes. Some historians propose that the heads of dried cheapcaps were once used as currency in some bronze age societies.':
		'Malá, odolná a dobrá v omeletách. Někteří historici tvrdí, že hlavy sušených čepic byly kdysi používány jako měna v některých společnostech doby bronzové.',
	...
	"[Fool's bolete quote]Named for its ability to fool mushroom pickers. The fool's bolete is not actually poisonous, it's just extremely bland.":
		'Pojmenován pro svou schopnost oklamat houbaře. Kozák pro blázny není ve skutečnosti jedovatý, je prostě extrémně nevýrazný.',
	Wrinklegill: '/',
	"[Wrinklegill quote]This mushroom's odor resembles that of a well-done steak, and is said to whet the appetite - making one's stomach start gurgling within seconds.":
		'Vůně této houby připomíná dobře upečený steak a říká se, že povzbuzuje chuť k jídlu - během několika sekund začne žaludek bublat.',
	...
	'[Green rot quote]This short-lived mold is also known as "emerald pebbles", and is considered by some as a pseudo-gem that symbolizes good fortune.':
		'Tyto hniloby, které mají velmi krátkou životnost, jsou známy také jako "smaragdové oblázky" a někteří ji považují za pseudo-klenot, který symbolizuje štěstí.',
	Shriekbulb: '/',
	'[Shriekbulb quote]A nasty vegetable with a dreadful quirk : its flesh resonates with a high-pitched howl whenever it is hit at the right angle by sunlight, moonlight, or even a slight breeze.':
		'Ošklivá zelenina se strašlivou manýrou: její dužina rezonuje s vysokým pronikavým zvukem, kdykoli je zasažena ve správném úhlu slunečním světlem, měsíčním světlem nebo dokonce mírným vánkem.',
	Tidygrass: '/',
	'[Tidygrass quote]The molecules this grass emits are a natural weedkiller. Its stems grow following a predictable pattern, making it an interesting -if expensive- choice for a lawn grass.':
		'Molekuly, které tato tráva emituje, jsou přirozeným prostředkem proti plevelu. Její stonky rostou podle předvídatelného vzoru; díky tomu je zajímavá pro trávníky - pokud není drahá.',
	Everdaisy: '/',
	'[Everdaisy quote]While promoted by some as a superfood owing to its association with longevity and intriguing geometry, this elusive flower is actually mildly toxic.':
		'I když ji někteří propagují jako super-potravinu díky dlouhověkosti a zajímavé geometrii, je tato prchavá květina ve skutečnosti mírně toxická.',
	Ichorpuff: '/',
	'[Ichorpuff quote]This puffball mushroom contains sugary spores, but it never seems to mature to bursting on its own. Surrounding plants under its influence have a very slow metabolism, reducing their effects but lengthening their lifespan.':
		'Tato houba pýchavka obsahuje sladké výtrusy, ale zdá se, že nikdy nedozrává sama k prasknutí. Pod jejím vlivem mají okolní rostliny velmi pomalý metabolismus, což snižuje jejich účinky, ale prodlužuje jejich životnost.',
	'Garden information': 'Informace o zahradě',
	'Your garden is frozen, providing no effects.':
		'Tvoje zahrada je zmrzlá, neposkytuje žádné účinky.',
	...
	'Cryogenically preserve your garden.<br>Plants no longer grow, spread or die; they provide no benefits.<br>Soil cannot be changed.<div class="line"></div>Using this will effectively pause your garden.':
		'Chraň svou zahradu pomocí mrazu.<br>Rostliny nerostou, nešíří se ani nehynou; nepřináší žádné výhody.<br>Zeminu nelze změnit.<div class="line"></div>Tímto zastavíš činnost zahrady.',
	...
	'A swarm of sugar hornets comes down on your garden, <span class="red">destroying every plant as well as every seed you\'ve unlocked</span> - leaving only a %1 seed.<br>In exchange, they will grant you <span class="green">%2</span>.<br>This action is only available with a complete seed log.':
		'Do tvé zahrady vletí roj cukrových vos, <span class="red">které zničí všechny rostliny i odemknutá semínka</span> – zbývá ti jenom semínko %1.<br>Na výměnu ti dají <span class="green">%2</span>.<br>Tato akce je dostupná pouze pro kompletní záznam semínek.',
	'Do you REALLY want to sacrifice your garden to the sugar hornets?<br><small>You will be left with an empty plot and only the %1 seed unlocked.<br>In return, you will gain <b>%2 sugar lumps</b>.</small>':
		'Opravdu chceš svou zahradu obětovat cukrovým vosám?<br><small>Zbyde ti jen prázdné místo a odemknuté semínko %1.<br>Výměnou získáš <b>%2 hrudek cukru</b>.</small>',
	'Sacrifice!': 'Obětovat!',
	"You've sacrificed your garden to the sugar hornets, destroying your crops and your knowledge of seeds.<br>In the remains, you find <b>%1 sugar lumps</b>.":
		'Obětoval/a jsi zahradu cukrovým vosám, tvoje rostliny i znalosti o semínkách jsou pryč.<br>V ruinách zahrady najdeš <b>%1 hrudek cukru</b>.',
	immortal: 'nesmrtelné',
	...
	'surrounding plants (%1x%1) are %2% less efficient':
		'okolní rostliny (%1x%1) jsou %2% méně účinné',
	'surrounding tiles (%1x%1) develop no weeds or fungus':
		'v okolních místech (%1x%1) neroste plevel a houby',
	'harvest when mature for +%1 of CpS (max. %2% of bank)':
		'skliď dorostlé za +%1 z K/s (max. %2% celku)',
	...
	'explodes into up to %1 of CpS at the end of its lifecycle (max. %2% of bank)':
		'na konci životního cyklu exploduje až do %1 K/s (max. %2% celku)',
	'cannot handle cold climates; %1% chance to die when frozen':
		'neprospívá jí chladné klima; %1% při zmrazení hrozí riziko uhynutí',
	'the unfortunate result of some plant combinations':
		'nešťastný důsledek nevhodné kombinace některých rostlin',
	...
	'Click to use this type of soil for your whole field.':
		'Klikni pro použití této zeminy na celém poli.',
	Dirt: 'Hlína',
	...
	'Soil with a healthy helping of fresh manure. Plants grow faster but are less efficient.':
		'Zemina se zdravou dávkou čerstvého hnoje. Rostliny rostou rychleji, ale jsou méně účinné.',
	Clay: 'Jíl',
	'Rich soil with very good water retention. Plants grow slower but are more efficient.':
		'Vydatná zemina, která dobře zadržuje vodu. Rostliny rostou pomaleji, ale jsou účinnější.',
	Pebbles: 'Oblázky',
	"Dry soil made of small rocks tightly packed together. Not very conducive to plant health, but whatever falls off your crops will be easy to retrieve.<br>Useful if you're one of those farmers who just want to find new seeds without having to tend their garden too much.":
		'Suchá zemina z drobných kamínků. Rostlinám moc neprospívá, ale snadno na ní všechno najdeš.<br>Ideální pro zahradníky, kteří chtějí mít všechna semínka bez toho, aby se o zahradu nějak zvlášť starali.',
	'Wood chips': 'Hobliny',
	'Soil made of bits and pieces of bark and sawdust. Helpful for young sprouts to develop, not so much for mature plants.':
		'Zemina z kousků dřevěné kůry a hoblin. Hodí se pro mladé rostlinky, pro starší ale ne.',
	...
	'<b>%1% chance</b> of collecting seeds automatically when plants expire':
		'<b>%1% šance</b> posbírání semínek automaticky, když rostlina uhyne',
	'plants spread and mutate <b>%1 times more</b>':
		'rostliny se rozrůstají a mutují <b>%1 krát více</b>',
	...
	'This tile of soil is empty.<br>Pick a seed and plant something!':
		'Toto místo s půdou je prázdné.<br>Vyber semínko a zasaď ho!',
	...
	'Click to refill your soil timer and trigger <b>1</b> plant growth tick with <b>x%1</b> spread and mutation rate for %2.':
		'Klikni pro doplnění časovače zeminy a spuštění <b>1</b> tiknutí pro růst rostlin s <b>x%1</b>  rychlostí rozšíření a mutace za %2.',
	...
	'Plot size: %1<br>(Upgrades with farm level)':
		'Velikost pozemku: %1<br>(Vylepšuje se spolu s úrovní farmy)',
	...
	'while plant is alive; scales with plant growth':
		'dokud je rostlina živá, škáluje se s růstem rostliny',
	Dungeon: 'Sklep',
	Grimoire: '/',
	'This is your magic meter. Each spell costs magic to use.<div class="line"></div>Your maximum amount of magic varies depending on your amount of <b>Wizard towers</b>, and their level.<div class="line"></div>Magic refills over time. The lower your magic meter, the slower it refills.':
		'Tohle je tvůj měřič magie. Za použití každého kouzla musíš zaplatit.<div class="line"></div>Maximální množství kouzel se odvíjí od počtu tvých <b>Čarodějných věží</b> a jejich úrovně.<div class="line"></div>Kouzla se postupně doplňují. Čím nižší je tvůj měřič magie, tím pomaleji se doplňuje.',
	...
	'Click to refill <b>%1 units</b> of your magic meter for %2.':
		'Klikni pro doplnění <b>%1 jednotek</b> tvého měřiče magie za %2.',
	'Grimoire spells are %1% cheaper but fail %1% more.':
		'Grimoárová kouzla jsou o %1 % levnější, ale o %1 % častěji selhávají.',
	'Conjure Baked Goods': 'Vyvolat Pečivo',
	'Summon half an hour worth of your CpS, capped at %1% of your cookies owned.':
		'Vyvolat půl hodiny tvého K/s s limitem %1% keksů, které už máš.',
	'Trigger a %1-minute clot and lose %1 minutes of CpS.':
		'Spusť %1-minutové zdržení a ztrať %1 minut K/s.',
	...
	'Summon a random golden cookie. Each existing golden cookie makes this spell +%1% more likely to backfire.':
		'Vyvolat náhodný zlatý keks. S každým existujícím zlatým keksem je +%1% vyšší pravděpodobnost, že kouzlo selže.',
	...
	'All active buffs gain %1% more time (up to %2 more minutes).':
		'Všechny aktivní buffy získají %1% více času (až %2 minut navíc).',
	'All active buffs are shortened by %1% (up to %2 minutes shorter).':
		'Všechny aktivní buffy se krátí o %1% (až o %2 minut kratší).',
	...
	'The spell picks a random building you could afford if you had twice your current cookies, and gives it to you for free. The building selected must be under %1, and cannot be your most-built one (unless it is your only one).':
		'Kouzlo náhodně vybere budovu, kterou by sis mohl/a dovolit, kdybys měl/a dvojnásobek keksů než teď, a dá ti ji zadarmo. Zvolená budova musí stát míň než %1 a nesmí to být tvá nejstavěnější (s výjimkou toho, že je tvá jediná).',
	...
	'Cast a random spell at half the magic cost, with twice the chance of backfiring.':
		'Použij náhodné kouzlo za půlku magické ceny s dvojnásobným rizikem selhání.',
	...
	'Instantly summon a wrinkler if conditions are fulfilled.':
		'Při splnění podmínek okamžitě vyvolá vrubouna.',
	...
	'Spells backfire %1 times less for the next %2 minutes.':
		'Kouzla v příštích %2 minutách selžou %1 krát méně často.',
	'Spells backfire %1 times more for the next %2 minutes.':
		'Kouzla v příštích %2 minutách selžou %1 krát častěji.',
	...
	'[GOD 1 QUOTE]An immortal life spent focusing on the inner self, away from the distractions of material wealth.':
		'Věčný život strávený zaměřením na duchovní záležitosti, daleko od rozptýlení materiálního bohatství.',
	...
	'[GOD 2 QUOTE]This sleazy spirit revels in the lust for quick easy gain and contempt for the value of steady work.':
		'Z tohohle slizouna odkapává touha po rychlém, snadném zisku a nenávist k poctivé práci.',
	...
	'[GOD 3 QUOTE]The embodiment of natural disasters. An impenetrable motive drives the devastation caused by this spirit.':
		'Ztělesnění přírodních katastrof. Ničení způsobená tímto duchem mají neproniknutelný motiv.',
	...
	"[GOD 4 QUOTE]This spirit knows about everything you'll ever do, and enjoys dispensing a harsh judgment.":
		'Tento duch ví o všem co děláš a budeš dělat a libuje si v ostré kritice.',
	...
	'[GOD 5 QUOTE]This is the spirit of merry getaways and regretful Monday mornings.':
		'Duch bujarých večírků a ranního bolehlavu.',
	...
	"[GOD 6 QUOTE]All things that be and ever will be were scripted long ago by this spirit's inscrutable tendrils.":
		'Vše přítomné i budoucí bylo dávno napsáno nevyzpytatelnými úponky tohoto ducha.',
	...
	'[GOD 7 QUOTE]This spirit enjoys a good cheese after a day of hard work.':
		'Tento duch si po celodenní dřině rád dopřává dobrý sýr.',
	...
	'[GOD 8 QUOTE]While this spirit has many regrets, helping you rule the world through constant industrialization is not one of them.':
		'Lituje spousty věcí, ale rozhodně ne toho, že ti pomáhá vládnout světu prostřednictvím neutuchající industrializace.',
	...
	'[GOD 9 QUOTE]A caring spirit said to contain itself, inwards infinitely.':
		'O tomto laskavém duchovi se říká, že ho zajímá hlavně duchovní život.',
	...
	'[GOD 10 QUOTE]This spirit enjoys poking foul beasts and watching them squirm, but has no love for its own family.':
		'Tento duch rád popichuje ohavná stvoření a pozoruje, jak se kroutí, ale nemá rád vlastní rodinu.',
	...
	'[GOD 11 QUOTE]You will find that life gets just a little bit sweeter if you can motivate this spirit with tidy numbers and properly-filled tax returns.':
		'Zjistíš, že je život o něco sladší, když se ti podaří namotivovat tohohle ducha s pečlivě srovnaným účetnictvím a správně vyplněnými papíry na finančák.',
	...
	'If a golden cookie is clicked, this spirit is unslotted and all worship swaps will be used up.':
		'Když klikneš na zlatý keks, tento duch už nebude patřit ke slotu a všechny výměny za uctívání budou využité.',
	'Each time you slot a spirit, you use up one worship swap.<div class="line"></div>If you have 2 swaps left, the next one will refill after %1.<br>If you have 1 swap left, the next one will refill after %2.<br>If you have 0 swaps left, you will get one after %3.<div class="line"></div>Unslotting a spirit costs no swaps.':
		'Při každém přidělení ducha ke slotu použiješ jednu výměnu za uctívání.<div class="line"></div>Pokud ti zbývají dvě výměny, další se doplní za %1.<br>Pokud máš jednu výměnu, další se doplní za %2.<br>Pokud nemáš žádné výměny, jednu dostaneš za %3.<div class="line"></div>Oddělení ducha od slotu nic nestojí.',
	'Click to refill all your worship swaps for %1.':
		'Klikni pro doplnění všech svých výměn za uctívání za %1.',
	...
	'The jade slot behaves as a ruby slot and the ruby slot behaves as a diamond slot.':
		'Nefritový slot se chová jako rubínový slot a rubínový slot se chová jako diamantový slot.',
	'Stock Market': 'Burza',
	...
	'You may increase your storage space by upgrading your offices and by buying more %1. You also get %2 extra storage space per %3 level (currently: <b>+%4</b>).':
		'Skladovací prostory můžeš zvětšit vylepšením kanceláří a nákupem dalších %1. Za každou úroveň %3 (aktuálně: <b>+%4</b>) získáš %2 skladovacího místa navíc.',
	'The average worth of this stock and how high it can peak depends on the building it is tied to, along with the level of your %1.':
		'Průměrná hodnota těchto akcií a její navýšení záleží na tom, ke které patří budově, a také na úrovni %1.',
	'%1 the hide button to toggle all other stocks.':
		'%1 tlačítko pro skrytí pro prohlížení všech ostatních akcií.',
	'stock:': 'akcie:',
	...
	'You cannot buy and sell this stock in the same tick.':
		'Nemůžeš tyto akcie koupit a zároveň prodat.',
	...
	'It is fully upgraded. Its lavish interiors, spanning across innumerable floors, are host to many a decadent party, owing to your nigh-unfathomable wealth.':
		'Je kompletně vylepšená. Tyto honosné interiéry, které se rozprostírají na nesčetných patrech, jsou dějištěm mnoha dekadentních večírků, které si užíváš díky svému pohádkovému bohatství.',
	...
	'Buying goods normally incurs overhead costs of <b>%1% extra</b>. Each broker you hire reduces that cost by <b>%2%</b>.':
		'Nákup zboží s sebou obvykle nese o<b>%1% vyšší režijní náklady.</b>. S každým najatým brokerem tyto náklady snížíš o <b>%2%</b>.',
	'Current overhead costs thanks to your brokers: <b>+%1%</b>':
		'Aktuální režijní náklady díky brokerům: <b>+%1%</b>',
	...
	"Maximum number of brokers you can own: %1 (the highest amount of grandmas you've owned this run, divided by 10, plus your grandma level)":
		'Maximální počet brokerů, které můžeš najmout: %1 (nejvyšší počet babiček, které jsi měl/a v tomhle kole, děleno 10, plus tvoje úroveň babiček)',
	'Brokers are Wall Street-class grandmas versed in the ways of finance. Stockbroker grandmas work hard and play hard, and will fight telephone in hand to get your clients the best possible deals - with a sizeable profit margin for you, of course.':
		'Brokeři jsou něco jako babičky, jen s finančními znalostmi z Wall Street. Tyhle výkonné babičky hodně pracují a hodně si hrají a klidně se přetrhnou, aby pro klienty vyřvali co nejlepší podmínky – s pěkným ziskem pro tebe, samozřejmě.',
	...
	'Click to refill your opportunity timer (and give a quick burst to your economy) for %1.':
		'Klikni pro doplnění časovače příležitostí (a rychle nakopni svou ekonomiku) za %1.',
	'Profits: %1. All prices are in $econds of your highest raw cookies per second.':
		'Zisky: %1. Všechny ceny jsou v $ekundách tvé nejvyšší hodnoty syrových keksů za sekundu.',
	...
	'[Upgrade name 41]White chocolate macadamia nut cookies':
		'Sušenky s makadamovými ořechy a s bílou čokoládou',
	...
	'[Upgrade name 96]Round chocolate british tea biscuits':
		'Kulaté čokoládové britské čajové sušenky',
	'[Upgrade name 97]Round british tea biscuits with heart motif':
		'Kulaté britské čajové sušenky s motivem srdce',
	'[Upgrade name 98]Round chocolate british tea biscuits with heart motif':
		'Kulaté čokoládové britské čajové sušenky s motivem srdce',
	...
	'[Upgrade name 318]Some other super-tiny fundamental particle? Probably?':
		'Nějaká další velmi malá základní částice? Pravděpodobně?',
	...
	'[Upgrade name 397]Distilled essence of redoubled luck':
		'Destilovaná esence zdvojnásobeného štěstí',
	...
	'[Upgrade name 400]Lavender chocolate butter biscuit':
		'Sušenka z levandulového čokoládového másla',
	...
	'[Upgrade name 442]Kitten assistants to the regional manager':
		'Kočičí asistenti regionálního manažera',
	...
	'[Upgrade name 477]Synthetic chocolate green honey butter biscuit':
		'Syntetická čokoládová sušenka ze zeleného medového másla',
	'[Upgrade name 478]Royal raspberry chocolate butter biscuit':
		'Královská malinová čokoládová sušenka s máslem',
	'[Upgrade name 479]Ultra-concentrated high-energy chocolate butter biscuit':
		'Vysoce koncentrovaná a vysokoenergetická čokoládová máslová sušenka',
	...
	'[Upgrade name 497]Pure pitch-black chocolate butter biscuit':
		'Čistá čokoládová máslová sušenka, úhlově černá',
	...
	'[Upgrade name 553]A chocolate chip cookie but with the chips picked off for some reason':
		'Čokoládové čipové sušenky; čipy byly z nějakého důvodu vybrány',
	...
	'[Upgrade name 718]Milkhelp&reg; lactose intolerance relief tablets':
		'Tablety pro úlevu od intolerance vůči laktóze Milkhelp®',
	...
	'[Achievement name 225]He who controls the cookies controls the universe':
		'Ten, kdo ovládá sušenky, ovládá vesmír',
	...
	'[Achievement name 230]Brought to you by the letter <div style="display:inline-block;background:url(img/money.png);width:16px;height:16px;"></div>':
		'Napsáno v dopisu <div style="display:inline-block;background:url(img/money.png);width:16px;height:16px;"></div>',
	...
	"[Achievement name 255]And now for my next trick, I'll need a volunteer from the audience":
		'A teď budu pro svůj další trik potřebovat dobrovolníka z publika',
	...
	'[Achievement name 259]cookie clicker forever and forever a hundred years cookie clicker, all day long forever, forever a hundred times, over and over cookie clicker adventures dot com':
		'cookie clicker pořád a navždy, sto let cookie clicker, celý den a navždy, stokrát, znovu a znovu cookie clicker dobrodružství, tečka com',
	...
	"[Achievement name 275]Well the cookies start coming and they don't stop coming":
		'Sušenky začnou vycházet a jejich přísun nebude nikdy končit',
	"[Achievement name 276]I don't know if you've noticed but all these icons are very slightly off-center":
		'Nevím, jestli jste si všimli, ale všechny tyto ikony jsou mírně mimo střed',
	...
	"[Achievement name 278]If it's worth doing, it's worth overdoing":
		'Pokud to stojí za to udělat, stojí za to i přehánět',
	"[Achievement name 279]The dreams in which I'm baking are the best I've ever had":
		'Sny, ve kterých peču, jsou nejlepší, jaké jsem kdy měl',
	...
	'[Achievement name 301]Neither snow nor rain nor heat nor gloom of night':
		'Ani sníh, ani déšť, ani horko, ani ponurá tma',
	...
	'[Achievement name 349]What happens in the vortex stays in the vortex':
		'Co se stane ve víru, zůstane ve víru',
	...
	"[Achievement name 357]Save your breath because that's all you've got left":
		'Šetřete si svůj dech, protože to je vše, co vám zbylo',
	...
	"[Achievement name 361]Don't get used to yourself, you're gonna have to change":
		'Nezvykněte si na sebe, budete se muset změnit',
	'[Achievement name 362]Objects in the mirror dimension are closer than they appear':
		'Objekty v zrcadlové dimenzi jsou blíže, než se zdají být',
	...
	'[Achievement name 376]All the other kids with the pumped up clicks':
		'Všechny ostatní děti s napumpovanými kliknutími',
	...
	'[Achievement name 407]We could all use a little change':
		'Všichni bychom mohli využít malou změnu',
	'[Achievement name 408]Your brain gets smart but your head gets dumb':
		'Váš mozek je chytrý, ale vaše hlava je němá',
	...
	"[Achievement name 411]You'll never shine if you don't glow":
		'Nikdy nebudete zářit, pokud nebudete svítit',
	"[Achievement name 412]You'll never know if you don't go":
		'Nikdy nebudete vědět, pokud nevyjdete ven',
	...
	'[Achievement name 421]For more information on this achievement, please refer to its title':
		'Další informace o tomto úspěchu naleznete v tomto titulu',
	"[Achievement name 422]I'm so meta, even this achievement":
		'Jsem tak meta, dokonce i na této úrovni',
	...
	"[Achievement name 429]I think it's safe to say you've got it made":
		'Myslím, že lze s jistotou říci, že jste to zvládli',
	...
	"[Achievement name 442]Dude what if we're all living in a simulation like what if we're all just code on a computer somewhere":
		'Kamaráde, co když všichni žijeme v simulaci, jako kdybychom všichni jen někde kódovali v počítači',
	...
	'[Achievement name 495]Mountain out of a molehill, but like in a good way':
		'Hora z krtince, ale v dobrém slova smyslu',
	...
	'[Achievement name 506]Flip a cookie. Chips, I win. Crust, you lose.':
		'Otočte sušenku. Žetony, vyhrávám. Kůra - prohraješ.',
	...
	'[Achievement name 515]Nobody exists on purpose, nobody belongs anywhere':
		'Nikdo neexistuje záměrně, nikdo nikam nepatří',
	...
	'[Achievement name 521]Reject reality, substitute your own':
		'Odmítněte realitu, žijte svou vlastní',
	...
	'[Achievement name 544]A trademarked portmanteau of "imagination" and "engineering"':
		'Patentované spojení "fantazie" a "inženýrství"',
	...
	'[Achievement name 573]By will alone I set my mind in motion':
		'K rozpohybování mysli mi stačila vůle',
	...
	'[Achievement name 586]What do you get for the baker who has everything':
		'Co dostanete za pekaře v plné palbě',
