AddLanguage('ES', 'spanish', {
	...
	grandmapocalypse: '/',
	'%1 cookie': ['%1 galleta', '%1 galletas'],
	'%1 sugar lump': ['%1 terrón de azúcar', '%1 terrones de azúcar'],
	'%1 heavenly chip': ['%1 pepita celestial', '%1 pepitas celestiales'],
	'%1 golden cookie': ['%1 galleta dorada', '%1 galletas doradas'],
	'%1 building': ['%1 edificio', '%1 edificios'],
	'%1 upgrade': ['%1 mejora', '%1 mejoras'],
	Yes: 'Sí',
	No: '/',
	...
	Cookies: 'Galletas',
	'%1 day': ['%1 día', '%1 días'],
	'%1 hour': ['%1 hora', '%1 horas'],
	'%1 minute': ['%1 minuto', '%1 minutos'],
	...
	'visual improvements; disabling may improve performance':
		'mejoras visuales, desactivarlos puede mejorar el rendimiento',
	...
	'display boxes around upgrades and achievements in Stats':
		'muestra cajas alrededor de mejoras y logros en las estadísticas',
	'Alt font': 'Fuente alternativa',
	'your cookies are displayed using a monospace font':
		'tus galletas se muestran con fuente monoespaciado',
	...
	'the game will ask you to confirm when you close the window':
		'el juego te pedirá confirmación al cerrar la ventana',
	Defocus: 'Desenfoque',
	'the game will be less resource-intensive when out of focus':
		'el juego usará menos recursos cuando esté desenfocado',
	...
	'the game will ask you to confirm before spending sugar lumps':
		'el juego te pedirá confirmación antes de gastar terrones de azúcar',
	'Custom grandmas': 'Abuelas personalizadas',
	'some grandmas will be named after Patreon supporters':
		'algunas abuelas llevarán el nombre de colaboradores de Patreon',
	...
	"on slower computers, the game will put itself in sleep mode when it's inactive and starts to lag out; offline CpS production kicks in during sleep mode":
		'en los ordenadores más lentos, el juego entrará en modo suspensión cuando esté inactivo y empiece a colgarse; la producción de g/s arranca durante el modo suspensión',
	'Music in background': 'Música de fondo',
	"music will keep playing even when the game window isn't focused":
		'la música seguirá sonando aunque estés en una ventana diferente a la del juego',
	'Cloud saving': 'Guardar en la nube',
	'allow use of Steam Cloud for save backups':
		'Permite el uso de Steam Cloud para guardar copias de seguridad.',
	...
	'allows optimizations for screen readers; game will reload':
		'Permite optimizaciones para lectores de pantalla; el juego se volverá a cargar.',
	'Discord status': 'Estado de Discord',
	'if Discord is on, show your game info as activity status':
		'Si Discord está activado, muestra la información de tu juego como estado de actividad.',
	Language: 'Idioma',
	'Language: %1': 'Idioma: %1',
	...
	'These are feats that are either unfair or difficult to attain. They do not give milk.':
		'características injustas o difíciles de conseguir. No dan leche.',
	...
	'with %1 ascension': ['con %1 ascensión', 'con %1 ascensiones'],
	...
	'Milk is gained with each achievement. It can unlock unique upgrades over time.':
		'La leche se consigue con cada logro. Puede desbloquear mejoras únicas con el tiempo.',
	'Rank %1': 'Nivel %1',
	...
	'Cookie Clicker is a javascript game by %1 and %2.':
		'Cookie Clicker es un juego de javascript de %1 y %2.',
	...
	"This version of Cookie Clicker is 100% free, forever. Want to support us so we can keep developing games? Here's some ways you can help:%1":
		'Esta versión de Cookie Clicker es 100 % gratis, para siempre. ¿Quieres apoyarnos para que podamos seguir desarrollando juegos? Te decimos cómo lo puedes hacer: %1',
	"Note: if you find a new bug after an update and you're using a 3rd-party add-on, make sure it's not just your add-on causing it!":
		'Nota: si encuentras un fallo nuevo después de una actualización y estás usando una extensión de terceros, ¡asegúrate de que no lo esté causando la extensión!',
	'Warning: clearing your browser cache or cookies <small>(what else?)</small> will result in your save being wiped. Export your save and back it up first!':
		'Aviso: borrar la caché o las cookies <small>(cómo no)</small> del buscador puede eliminar tus datos guardados. ¡Expórtalos y guarda una copia primero!',
	...
	'Note: older update notes are in English.':
		'Nota: las notas de actualización más antiguas están en inglés.',
	'This feature is not yet available in your language.':
		'Esta función aún no está disponible en tu idioma.',
	...
	'Cookie Clicker is in sleep mode and generating offline cookies.':
		'Cookie Clicker está en modo suspensión y generando galletas sin conexión.',
	...
	'(this happens when too many frames are skipped at once,<br>usually when the game has been running in the background for a while)<br>(you can turn this feature off in the settings menu)':
		'(esto ocurre cuando se saltan demasiados fotogramas a la vez,<br>normalmente cuando el juego lleva tiempo funcionando en segundo plano)<br>(puedes deshabilitar esta función en los ajustes del menú)',
	...
	'Hello again! Just a reminder that you may want to back up your Cookie Clicker save every once in a while, just in case.<br>To do so, go to Options and hit "Export save" or "Save to file"!':
		'¡Hola de nuevo! Esto es un recordatorio para que guardes tus datos de Cookie Clicker de vez en cuando, por si las moscas.<br>Para hacerlo, entra en Opciones y haz clic en "Exportar datos guardados" o "Guardar en archivo".',
	'Save manually (the game autosaves every 60 seconds; shortcut: ctrl+S)':
		'Guárdalo manualmente (el juego se guarda automáticamente cada 60 segundos; atajo ctrl+S)',
	'You can use this to backup your save or to transfer it to another computer (shortcut for import: ctrl+O)':
		'Puedes usar esto para hacer una copia de tus datos guardados o para transferirlos a otro ordenador (atajo para importar: ctrl+O)',
	'Save to file': 'Guardar en archivo',
	'Load from file': 'Cargar desde archivo',
	'Use this to keep backups on your computer':
		'Usa esto para guardar copias de seguridad en tu ordenador',
	'Export save': 'Exportar datos guardados',
	'This is your save code.<br>Copy it and keep it somewhere safe!':
		'Este es el código de tus datos guardados.<br>¡Cópialo y guárdalo a buen recaudo!',
	'Import save': 'Importar datos guardados',
	'Please paste in the code that was given to you on save export.':
		'Pega el código que te dimos al exportar datos guardados.',
	...
	'Oops, looks like the import string is all wrong!':
		'¡Vaya! Parece que el archivo de importación no es válido.',
	'You are attempting to load a save from a future version (v. %1; you are using v. %2).':
		'Estás intentando cargar datos guardados de una versión más avanzada (v. %1; estás usando la v. %2).',
	"Sorry, you can't import saves from the classic version.":
		'Lo siento, no puedes importar datos guardados de la versión clásica.',
	'Wipe save': 'Borrar datos guardados',
	'Delete all your progress, including your achievements':
		'Borrar todos los progresos, incluidos tus logros.',
	'Do you REALLY want to wipe your save?<br><small>You will lose your progress, your achievements, and your heavenly chips!</small>':
		'¿SEGURO que quieres borrar tus datos guardados?<br><small>¡Perderás todos tus progresos, tus logros y tus pepitas celestiales!</small>',
	"Whoah now, are you really, <b><i>REALLY</i></b> sure you want to go through with this?<br><small>Don't say we didn't warn you!</small>":
		'Guau… ¿<b><i>SEGURO</i></b> que quieres hacerlo?<br><small>¡No dirás que no te lo advertimos!</small>',
	...
	'Only use mods from trusted sources. Some mods may require a game restart to take effect.':
		'Usa solo modificaciones de fuentes fiables. Puede que para que algunas tengan efecto haya que reiniciar el juego.',
	Enable: 'Activar',
	Disable: 'Desactivar',
	...
	'This tool allows you to upload new mods to the Steam Workshop.<br>You need to select a mod folder containing a properly-formatted %1 file.<br>See the included sample mods for examples.':
		'Esta herramienta te permite cargar nuevos mods en Steam Workshop.<br>Debes seleccionar una carpeta de mods que contenga un archivo %1 con el formato correcto.<br>Consulta los mods de muestra incluidos para tener ejemplos.',
	...
	'These are the mods present in your save data. You may delete some of this data to make your save file smaller.':
		'Estas son las modificaciones de tus datos guardados. Puedes eliminar algunos datos para reducir el archivo de datos guardados.',
	'(loaded)': '(cargados)',
	'%1 char': ['%1 caracter', '%1 caracteres'],
	'Check mod data': 'Comprobar datos modificados',
	'view and delete save data created by mods':
		'ver y eliminar datos guardados creados con modificaciones',
	...
	'You are currently playing Cookie Clicker on the <b>%1</b> protocol.<br>The <b>%2</b> version uses a different save slot than this one.<br>Click this lock to reload the page and switch to the <b>%2</b> version!':
		'Estás jugando a Cookie Clicker con el protocolo <b>%1</b>.<br>La versión <b>%2</b> utiliza un espacio de guardado diferente a esta.<br>¡Haz clic en este candado para actualizar la página y cambiar a la versión <b>%2</b>!',
	'+%1 more notification.': ['+%1 notificación más.', '+%1 notificaciones más.'],
	Christmas: 'Navidad',
	...
	"Because you've baked a <b>billion cookies</b> in total, you are now attracting <b>sugar lumps</b>. They coalesce quietly near the top of your screen, under the Stats button.<br>You will be able to harvest them when they're ripe, after which you may spend them on all sorts of things!":
		'Como has horneado <b>mil millones de galletas</b> en total, ahora atraes <b>terrones de azúcar</b>. Se fusionan en la parte superior de tu pantalla, debajo del botón Estadísticas.<br>¡Podrás cosecharlos cuando hayan madurado, y después podrás usarlos para conseguir un montón de cosas!',
	'A <b>sugar lump</b> is coalescing here, attracted by your accomplishments.':
		'Se está fusionando un <b>terrón de azúcar</b>, atraído por tus logros.',
	'Your sugar lumps mature after <b>%1</b>,<br>ripen after <b>%2</b>,<br>and fall after <b>%3</b>.':
		'Tus terrones de azúcar maduran al cabo de <b>%1</b>,<br>están listos para la cosecha al cabo de <b>%2</b>,<br>y caen al cabo de <b>%3</b>.',
	'&bull; Sugar lumps can be harvested when mature, though if left alone beyond that point they will start ripening (increasing the chance of harvesting them) and will eventually fall and be auto-harvested after some time.<br>&bull; Sugar lumps are delicious and may be used as currency for all sorts of things.<br>&bull; Once a sugar lump is harvested, another one will start growing in its place.<br>&bull; Note that sugar lumps keep growing when the game is closed.':
		'• Puedes cosechar terrones de azúcar cuando estén maduros, aunque si los dejas más tiempo, estarán listos (lo que aumentará las opciones de cosecha) y acabarán cayendo y autocosechándose al cabo de un tiempo.<br>• Los terrones de azúcar son deliciosos y se pueden usar para comprar un montón de cosas.<br>• Una vez cosechado un terrón de azúcar, otro empezará a crecer en su lugar.<br>• Recuerda que los terrones de azúcar siguen creciendo aunque cierres el juego.',
	'This sugar lump has been exposed to time travel shenanigans and will take an excruciating <b>%1</b> to reach maturity.':
		'Este terrón de azúcar ha estado expuesto a viajes en el tiempo y tardará <b>%1</b> en madurar.',
	'This sugar lump is still growing and will take <b>%1</b> to reach maturity.':
		'Este terrón de azúcar sigue creciendo y tardará <b>%1</b> en madurar.',
	"This sugar lump is mature and will be ripe in <b>%1</b>.<br>You may <b>click it to harvest it now</b>, but there is a <b>50% chance you won't get anything</b>.":
		'Este terrón de azúcar está maduro y estará listo para la cosecha en <b>%1</b>.<br>Puedes <b>hacer clic para cosecharlo ahora</b>, pero hay un <b>50% de probabilidades de que no consigas nada</b>.',
	'<b>This sugar lump is ripe! Click it to harvest it.</b><br>If you do nothing, it will auto-harvest in <b>%1</b>.':
		'<b>¡Este terrón de azúcar está listo para la cosecha! Haz clic para cosecharlo.</b><br>Si no haces nada, se autocosechará en <b>%1</b>.',
	'This sugar lump grew to be <b>bifurcated</b>; harvesting it has a 50% chance of yielding two lumps.':
		'Este terrón de azúcar ha salido <b>bifurcado</b>; si lo cosechas, tienes un 50 % de probabilidades de obtener dos terrones.',
	'This sugar lump grew to be <b>golden</b>; harvesting it will yield 2 to 7 lumps, your current cookies will be doubled (capped to a gain of 24 hours of your CpS), and you will find 10% more golden cookies for the next 24 hours.':
		'Este terrón de azúcar ha salido <b>dorado</b>; si lo cosechas, obtendrás de 2 a 7 terrones, tus galletas actuales se duplicarán (con un límite de 24 horas de g/s) y encontrarás un 10 % más de galletas doradas en las próximas 24 horas.',
	'This sugar lump was affected by the elders and grew to be <b>meaty</b>; harvesting it will yield between 0 and 2 lumps.':
		'Este terrón de azúcar se vio afectado por las ancianas y salió <b>carnoso</b>; si lo cosechas, obtendrás entre 0 y 2 terrones.',
	'This sugar lump is <b>caramelized</b>, its stickiness binding it to unexpected things; harvesting it will yield between 1 and 3 lumps and will refill your sugar lump cooldowns.':
		'Este terrón de azúcar está <b>caramelizado</b>, su pegajosidad lo une a cosas inesperadas; si lo cosechas, obtendrás entre 1 y 3 terrones y rellenará el tiempo de recarga de tus terrones.',
	...
	'Your cookies have been doubled.<br>+10% golden cookies for the next 24 hours.':
		'Se han duplicado tus galletas.<br>+10 % de galletas doradas en las próximas 24 horas.',
	...
	Heralds: 'Heraldos',
	'%1 herald': ['%1 heraldo', '%1 heraldos'],
	"Heralds couldn't be loaded. There may be an issue with our servers, or you are playing the game locally.":
		'No se han podido cargar los heraldos. Puede ser un error de nuestros servidores o que estás jugando sin conexión.',
	'There are no heralds at the moment. Please consider <b>donating to our Patreon</b>!':
		'Ahora mismo no hay heraldos. ¡Piensa en <b>donar a través de Patreon</b>',
	'selflessly inspiring a boost in production for everyone, resulting in %1.':
		'y logra un generoso aumento del %1 en la producción para todos!',
	...
	'You are in a <b>Born again</b> run, and are not currently benefiting from heralds.':
		'Estás jugando a <b>Renacido</b> y no puedes beneficiarte de heraldos.',
	'You own the <b>Heralds</b> upgrade, and therefore benefit from the production boost.':
		'Tienes la mejora de <b>Heraldos</b>, así que puedes beneficiarte del aumento de producción.',
	'To benefit from the herald bonus, you need a special upgrade you do not yet own. You will permanently unlock it later in the game.':
		'Para beneficiarte de la bonificación Heraldo, necesitas una mejora especial que aún no tienes. La desbloquearás más tarde en el juego de manera permanente.',
	'<b>Heralds</b> are people who have donated to our highest Patreon tier, and are limited to 100.<br>Each herald gives everyone +1% CpS.<br>Heralds benefit everyone playing the game, regardless of whether you donated.':
		'Los <b>Heraldos</b> son personas que han donado en el nivel superior de Patreon y están limitados a 100.<br>Cada heraldo concede a todo el mundo +1% g/s.<br>Los heraldos benefician a todos los jugadores, independientemente de que hayas hecho o no una donación.',
	'Every %1 current players on Steam generates <b>1 herald</b>, up to %2 heralds.<br>Each herald gives everyone +1% CpS.':
		'Se genera <b>1 mensajero</b> (hasta %2) por cada %1 jugadores actuales en Steam.<br>Cada mensajero da a todo el mundo +1% g/s.',
	'+%1!': '¡+%1!',
	...
	'Sweet!<br><small>Found 1 sugar lump!</small>':
		'¡Genial!<br><small>¡Has encontrado 1 terrón de azúcar!</small>',
	'Lucky!': '¡Qué suerte!',
	'Ruin!': '¡Porras!',
	...
	'Cookie chain broken.<br><small>You made %1.</small>':
		'Cadena de galletas interrumpida.<br><small>Has conseguido %1.</small>',
	'Cookie blab': [
	...
	'Lets you use two dragon auras simultaneously':
		'Te permite usar dos auras de dragón simultáneamente',
	...
	'<b>One tenth</b> of every other dragon aura, <b>combined</b>.':
		'<b>Un décimo</b> de aura de todos los demás dragones, <b>combinados</b>.',
	'Switching your aura is <b>free</b> because you own no buildings.':
		'Cambiar tu aura es <b>gratis</b> porque no tienes ningún edificio.',
	'The cost of switching your aura is <b>%1</b>.<br>This will affect your CpS!':
		'Cambiar tu aura te costará <b>%1</b>.<br>¡Esto afectará a tus g/s!',
	...
	'You feel like making cookies. But nobody wants to eat your cookies.':
		'Te apetece hacer galletas, pero a nadie le apetece comérselas.',
	'Your first batch goes to the trash. The neighborhood raccoon barely touches it.':
		'Tu primera remesa acaba en la basura. El mapache del vecino casi ni las toca.',
	'Your family accepts to try some of your cookies.':
		'Tu familia accede a probar algunas de tus galletas.',
	...
	'Your cookies are talked about for miles around.':
		'Se habla de tus galletas a varios kilómetros a la redonda.',
	'Your cookies are renowned in the whole town!':
		'¡Tus galletas se hacen famosas en toda la ciudad!',
	...
	'Your cookies sell very well in distant countries.':
		'Tus galletas se venden muy bien en países lejanos.',
	'People come from very far away to get a taste of your cookies.':
		'La gente viene de muy lejos para probar tus galletas.',
	'Kings and queens from all over the world are enjoying your cookies.':
		'Miembros de la realeza de todo el mundo disfrutan con tus galletas.',
	...
	'A national day has been created in honor of your cookies.':
		'Se ha creado un día de fiesta nacional en honor a tus galletas.',
	'Your cookies have been named a part of the world wonders.':
		'Tus galletas entran a formar parte de las maravillas de mundo.',
	'History books now include a whole chapter about your cookies.':
		'Los libros de historia incluyen ahora un capítulo sobre tus galletas.',
	'Your cookies have been placed under government surveillance.':
		'El gobierno vigila tus galletas.',
	...
	'Strange creatures from neighboring planets wish to try your cookies.':
		'Seres extraños de planetas vecinos quieren probar tus galletas.',
	'Elder gods from the whole cosmos have awoken to taste your cookies.':
		'Dioses antiguos de todo el cosmos se han despertado para probar tus galletas.',
	'Beings from other dimensions lapse into existence just to get a taste of your cookies.':
		'Aparecen seres de otras dimensiones solo para probar tus galletas.',
	...
	'The universe has now turned into cookie dough, to the molecular level.':
		'El universo se ha transformado en masa de galleta a nivel molecular.',
	'Your cookies are rewriting the fundamental laws of the universe.':
		'Tus galletas están reescribiendo las leyes fundamentales del universo.',
	'A local news station runs a 10-minute segment about your cookies. Success!<br><small>(you win a cookie)</small>':
		'Una cadena local de noticias emite una sección de 10 minutos sobre tus galletas. ¡Todo un éxito!<br><small>(ganas una galleta)</small>',
	...
	'You gain <b>one hour</b> of your CpS (capped at double your bank).':
		'Obtienes <b>una hora</b> de tus g/s (con un límite del doble de tu banca).',
	...
	'Your prestige level is currently <b>%1</b>.<br>(CpS +%2%)':
		'Tu nivel de prestigio es ahora <b>%1</b>.<br>(g/s +%2%)',
	...
	'Ascending now would grant you<br><b>1 prestige level</b> (+1% CpS)<br>and <b>1 heavenly chip</b> to spend.':
		'Ascender ahora te otorgará<br><b>1 nivel de prestigio</b> (+1% g/s)<br>y <b>1 pepita celestial</b> para gastar.',
	'Ascending now would grant you<br><b>%1 prestige levels</b> (+%2% CpS)<br>and <b>%3 heavenly chips</b> to spend.':
		'Ascender ahora te otorgará<br><b>%1 niveles de prestigio</b> (+%2% g/s)<br>y <b>%3 pepitas celestiales</b> para gastar.',
	'You need <b>%1 more cookies</b> for the next level.':
		'Necesitas <b>%1 más galletas</b> para el siguiente nivel.',
	'Do you REALLY want to ascend?<div class="line"></div>You will lose your progress and start over from scratch.<div class="line"></div>All your cookies will be converted into prestige and heavenly chips.':
		'¿SEGURO que quieres ascender?<div class="line"></div>Perderás tus progresos y empezarás de cero.<div class="line"></div>Todas tus galletas se convertirán en prestigio y pepitas celestiales.',
	...
	'You will keep your achievements, building levels and sugar lumps.':
		'Conservarás todos tus logros, niveles de edificios y terrones de azúcar.',
	...
	'%1 prestige level': ['%1 nivel de prestigio', '%1 niveles de prestigio'],
	...
	"You are ascending.<br>Drag the screen around<br>or use arrow keys!<br>When you're ready,<br>click Reincarnate.":
		'Estás ascendiendo.<br>¡Arrastra la pantalla<br>o usa las flechas!<br>Cuando quieras,<br>haz clic en Reencarnarse.',
	'Each prestige level grants you a permanent <b>+%1% CpS</b>.<br>The more levels you have, the more cookies they require.':
		'Cada nivel de prestigio te otorga un <b>+%1% de g/s</b> permanente.<br>Cuantos más niveles tengas, más galletas requieren.',
	'Heavenly chips are used to buy heavenly upgrades.<br>You gain <b>1 chip</b> every time you gain a prestige level.':
		'Las pepitas celestiales se usan para comprar mejoras celestiales.<br>Obtienes <b>1 pepita</b> cada vez que ganas un nivel de prestigio.',
	"Click this once you've bought<br>everything you need!":
		'¡Haz clic aquí cuando hayas comprado<br>todo lo que necesitas!',
	...
	'Challenge modes apply special modifiers to your next ascension.<br>Click to change.':
		'Los modos desafío aplican modificadores especiales a tu próxima ascensión.<br>Haz clic para cambiar.',
	...
	'This run will behave as if you\'d just started the game from scratch. Prestige levels and heavenly upgrades will have no effect, as will sugar lumps and building levels. Perma-upgrades and minigames will be unavailable.<div class="line"></div>Some achievements are only available in this mode.':
		'En esta partida, jugarás como si acabaras de empezar el juego desde cero. Los niveles de prestigio y las mejoras celestiales no tendrán efecto, igual que los terrones de azúcar y los niveles de edificios. Las mejoras permanentes y los minijuegos no estarán disponibles.<div class="line"></div>Algunos logros solo están disponibles en este modo.',
	'Your bingo center/research facility is conducting experiments.':
		'Tu bingo/centro de investigación está realizando experimentos.',
	...
	"It's <b>Valentine's season</b>!<br>Love's in the air and cookies are just that much sweeter!":
		'¡Es <b>San Valentín</b>!<br>¡El amor está en el aire y las galletas saben mucho más dulces!',
	...
	"It's <b>Business season</b>!<br>Don't panic! Things are gonna be looking a little more corporate for a few days.":
		'¡<b>A emprender toca</b>!<br>¡Tranquilidad! Vas a vivir unos días un poco más corporativos.',
	'Halloween!': '¡Halloween!',
	"It's <b>Halloween season</b>!<br>Everything is just a little bit spookier!":
		'¡Es <b>Halloween</b>!<br>¡Todo tiene un punto más aterrador!',
	...
	"It's <b>Christmas season</b>!<br>Bring good cheer to all and you just may get cookies in your stockings!":
		'¡Es <b>Navidad</b>!<br>¡Haz feliz a la gente y tus calcetines acabarán llenos de galletas!',
	'Easter!': '¡Pascua!',
	"It's <b>Easter season</b>!<br>Keep an eye out and you just might click a rabbit or two!":
		'¡Estamos en <b>Pascua</b>!<br>¡No te despistes y puede que hagas clic en algún que otro conejo!',
	...
	'Upgrade is vaulted and will not be auto-purchased.':
		'La mejora está guardada en la cámara y no se comprará automáticamente.',
	...
	'Will <b>instantly purchase</b> every upgrade you can afford, starting from the cheapest one.<br>Upgrades in the <b>vault</b> will not be auto-purchased.<br>You may place an upgrade into the vault by <b>Shift-clicking</b> on it.':
		'Sirve para <b>comprar al instante</b> todas las mejoras que te puedas permitir, partiendo de la más barata.<br>Las mejoras en la <b>cámara</b> no se comprarán automáticamente.<br>Puedes guardar una mejora en la cámara pulsando <b>Mayús-clic</b> sobre ella.',
	...
	'all combined, these boosts account for <b>%1</b> per second (<b>%2%</b> of total CpS)':
		'combinados, estos aumentos suponen <b>%1</b> por segundo (<b>%2%</b> de g/s en total)',
	'owned: %1': 'tienes: %1',
	'free: %1!': '¡Gratis: %1!',
	'Level %1 %2': 'Nivel %1 %2',
	...
	'Levelling up this building unlocks a minigame.':
		'Subir este edificio de nivel desbloquea un minijuego.',
	...
	'Names in white were submitted by our supporters on Patreon.':
		'Los nombres en blanco los pusieron nuestros colaboradores de Patreon.',
	'You can also press %1 to bulk-buy or sell %2 of a building at a time, or %3 for %4.':
		'También puedes pulsar %1 para comprar al por mayor o vender %2 de un edificio de cada vez, o %3 por %4.',
	Investment: 'Inversión',
	"You're not sure what this does, you just know it means profit.":
		'No sabes muy bien qué es, solo sabes que implica beneficios.',
	Cursor: '/',
	cursor: '/',
	cursors: 'cursores',
	'%1 cursor': ['%1 cursor', '%1 cursores'],
	...
	'[Cursor business quote]Essential in flattening dough. The first step in cookie-making.':
		'Esencial para estirar la masa. El primer paso en la elaboración de galletas.',
	Grandma: 'Abuela',
	grandma: 'abuela',
	grandmas: 'abuelas',
	'%1 grandma': ['%1 abuela', '%1 abuelas'],
	'[Grandma quote]A nice grandma to bake more cookies.':
		'Una abuela afable para hornear más galletas.',
	'[Grandma business name]Oven': 'Horno',
	'[Grandma business quote]A crucial element of baking cookies.':
		'Un instrumento crucial para elaborar galletas.',
	Farm: 'Granja',
	farm: 'granja',
	farms: 'granjas',
	'%1 farm': ['%1 granja', '%1 granjas'],
	'[Farm quote]Grows cookie plants from cookie seeds.':
		'Cultivo de plantas de galleta a partir de semillas de galleta.',
	'[Farm business name]Kitchen': 'Cocina',
	'[Farm business quote]The more kitchens, the more cookies your employees can produce.':
		'Cuantas más cocinas, más galletas producirán tus empleadas.',
	Mine: 'Mina',
	mine: 'mina',
	mines: 'minas',
	'%1 mine': ['%1 mina', '%1 minas'],
	'[Mine quote]Mines out cookie dough and chocolate chips.':
		'Extracción de masa de galleta y pepitas de chocolate.',
	...
	'[Mine business quote]These give you the edge you need to outsell those pesky competitors.':
		'Te da la ventaja que necesitas para vender más que la molesta competencia.',
	Factory: 'Fábrica',
	factory: 'fábrica',
	factories: 'fábricas',
	'%1 factory': ['%1 fábrica', '%1 fábricas'],
	...
	'[Factory business quote]Mass production is the future of baking. Seize the day, and synergize!':
		'La producción masiva es el futuro de la pastelería. ¡Aprovecha el día y la sinergia!',
	Bank: 'Banca',
	bank: 'banca',
	banks: 'bancas',
	'%1 bank': ['%1 banca', '%1 bancas'],
	...
	"[Bank business quote]Business folks with a nose for profit, ready to finance your venture as long as there's money to be made.":
		'Negociantes con ojo para los beneficios, dispuestos a financiar tu empresa siempre que puedan sacar tajada.',
	Temple: 'Templo',
	temple: 'templo',
	temples: 'templos',
	'%1 temple': ['%1 templo', '%1 templos'],
	...
	'[Temple business quote]Your social media page is going viral! Amassing likes is the key to a lasting online presence and juicy advertising deals.':
		'¡Tu página web se hace viral! Acumular "me gusta" es la clave de una presencia online duradera y contratos jugosos de publicidad.',
	'Wizard tower': 'Torre mágica',
	'wizard tower': 'torre mágica',
	'wizard towers': 'torres mágicas',
	'%1 wizard tower': ['%1 torre mágica', '%1 torres mágicas'],
	'[Wizard tower quote]Summons cookies with magic spells.':
		'Invoca galletas con hechizos de magia.',
	...
	'[Wizard tower business quote]Cookie memes are all the rage! With just the right amount of social media astroturfing, your brand image will be all over the cyberspace.':
		'¡Los memes de galletas lo están rompiendo! Con una buena promoción en redes sociales, tu imagen de marca conquistará el ciberespacio.',
	Shipment: 'Envío',
	shipment: 'envío',
	shipments: 'envíos',
	'%1 shipment': ['%1 envío', '%1 envíos'],
	'[Shipment quote]Brings in fresh cookies from the cookie planet.':
		'Hace llegar galletas frescas desde el planeta galleta.',
	...
	'[Shipment business quote]A gigantic cookie emporium - your very own retail chain.':
		'Un emporio gigante de galletas… tu propia cadena de venta al por menor.',
	'Alchemy lab': 'Laboratorio de alquimia',
	'alchemy lab': 'laboratorio de alquimia',
	'alchemy labs': 'laboratorios de alquimia',
	'%1 alchemy lab': ['%1 laboratorio de alquimia', '%1 laboratorios de alquimia'],
	...
	"[Alchemy lab business quote]You're officially on the stock market, and everyone wants a piece!":
		'¡Ya estás oficialmente en bolsa, y todo el mundo quiere una participación!',
	Portal: '/',
	portal: '/',
	portals: 'portales',
	'%1 portal': ['%1 portal', '%1 portales'],
	...
	'[Portal business quote]Your cookies have their own sitcom! Hilarious baking hijinks set to the cheesiest laughtrack.':
		'¡Tus galletas tienen su propia telecomedia! Tronchantes travesuras de cocina con las risas enlatadas más horteras posibles.',
	'Time machine': 'Máquina del tiempo',
	'time machine': 'máquina del tiempo',
	'time machines': 'máquinas del tiempo',
	'%1 time machine': ['%1 máquina del tiempo', '%1 máquinas del tiempo'],
	'[Time machine quote]Brings cookies from the past, before they were even eaten.':
		'Trae galletas del pasado, antes incluso de que se comieran.',
	...
	'[Time machine business quote]Cookie theme parks, full of mascots and roller-coasters. Build one, build a hundred!':
		'Parques temáticos de galleta, llenos de mascotas y montañas rusas. ¡Construye uno, construye cien!',
	'Antimatter condenser': 'Condensador de antimateria',
	'antimatter condenser': 'condensador de antimateria',
	'antimatter condensers': 'condensadores de antimateria',
	'%1 antimatter condenser': ['%1 condensador de antimateria', '%1 condensadores de antimateria'],
	'[Antimatter condenser quote]Condenses the antimatter in the universe into cookies.':
		'Condensa la antimateria del universo en galletas.',
	...
	'[Antimatter condenser business quote]A virtual currency, already replacing regular money in some small countries.':
		'Una moneda virtual que, en algunos países pequeños, ya sustituye al dinero.',
	Prism: 'Prisma',
	prism: 'prisma',
	prisms: 'prismas',
	'%1 prism': ['%1 prisma', '%1 prismas'],
	...
	"[Prism business quote]You've made it to the top, and you can now buy entire nations to further your corporate greed. Godspeed.":
		'Has llegado a lo más alto, y ahora puedes comprar países enteros para llevar más allá tu codicia empresarial. Buena suerte.',
	Chancemaker: 'Probabilizador',
	chancemaker: 'probabilizador',
	chancemakers: 'probabilizadores',
	'%1 chancemaker': ['%1 probabilizador', '%1 probabilizadores'],
	'[Chancemaker quote]Generates cookies out of thin air through sheer luck.':
		'Genera galletas del aire por chiripa.',
	...
	"[Chancemaker business quote]Actually, you know what's cool? A whole planet dedicated to producing, advertising, selling, and consuming your cookies.":
		'¿Sabes lo que mola? Un planeta entero dedicado a producir, promocionar, vender y consumir tus galletas.',
	'Fractal engine': 'Motor fractal',
	'fractal engine': 'motor fractal',
	'fractal engines': 'motores fractales',
	'%1 fractal engine': ['%1 motor fractal', '%1 motores fractales'],
	'[Fractal engine quote]Turns cookies into even more cookies.':
		'Convierte las galletas en más galletas.',
	...
	'[Fractal engine business quote]Only through political dominion can you truly alter this world to create a brighter, more cookie-friendly future.':
		'Solo a través del dominio político podrás alterar el mundo para crear un futuro más brillante y favorable a las galletas.',
	'Javascript console': 'consola Javascript',
	'javascript console': 'consola javascript',
	'javascript consoles': 'consolas javascript',
	'%1 javascript console': ['%1 consola javascript', '%1 consolas javascript'],
	'[Javascript console quote]Creates cookies from the very code this game was written in.':
		'Crea galletas a partir del código de programación del juego.',
	...
	"[Idleverse quote]There's been countless other idle universes running alongside our own. You've finally found a way to hijack their production and convert whatever they've been making into cookies!":
		'Ha habido infinitos universos paralelos al nuestro. ¡Por fin has encontrado la manera de secuestrar su producción y convertir en galletas todo lo que ellos fabricaban!',
	...
	'[Idleverse business quote]Sometimes the best way to keep going up is sideways. Diversify your ventures through non-cookie investments.':
		'A veces, la mejor manera de avanzar es de lado. Diversifica tus empresas con inversiones ajenas a las galletas.',
	'Cortex baker': 'Panadero cerebral',
	'cortex baker': 'panadero cerebral',
	'cortex bakers': 'panaderos cerebrales',
	'%1 cortex baker': ['%1 panadero cerebral', '%1 panaderos cerebrales'],
	'[Cortex baker quote]These artificial brains the size of planets are capable of simply dreaming up cookies into existence. Time and space are inconsequential. Reality is arbitrary.':
		'Estos cerebros artificiales del tamaño de un planeta son capaces de soñar con galletas. El tiempo y el espacio son intrascendentes. La realidad es arbitraria.',
	...
	"[Cortex baker business quote]There's only so many ways you can bring in more profit. Or is there? Hire the most brilliant experts in the known universe and let them scrape their brains for you!":
		'Hay muchas formas de generar más ganancias. ¿O no? ¡Contrata a los expertos más brillantes del universo conocido y deja que se estrujen los sesos por ti!',
	CpS: 'g/s',
	...
	'All cookie production <b>multiplied by %1</b>.':
		'Toda la producción de galletas <b>multiplicada por %1</b>.',
	'+%1 CpS': '+%1 g/s',
	...
	'Tiered upgrades for <b>%1</b> provide an extra <b>+%2%</b> production.<br>Only works with unshackled upgrade tiers.':
		'Las mejoras por niveles de <b>%1</b> proporcionan una producción adicional de <b>+%2%</b>.<br>Solo funciona con niveles de mejora sin restricciones.',
	'Unshackles all <b>%1-tier upgrades</b>, making them more powerful.<br>Only applies to unshackled buildings.':
		'Desata todas las <b>mejoras de nivel %1</b> y las hace más poderosas.<br>Solo se aplica a edificios no encadenados.',
	'The mouse and cursors are <b>twice</b> as efficient.':
		'El ratón y los cursores son <b>el doble</b> de eficaces.',
	'The mouse and cursors gain <b>+%1</b> cookies for each non-cursor building owned.':
		'El ratón y los cursores ganan <b>+%1</b> galletas por cada edificio de tu propiedad no conseguido con cursor.',
	'Grandmas gain <b>+%1% CpS</b> for each non-grandma building.':
		'Las abuelas obtienen un <b>+%1% de g/s</b> por cada edificio no conseguido con abuelas.',
	'You gain <b>more CpS</b> the more milk you have.':
		'Obtienes <b>más g/s</b> cuanta más leche tengas.',
	'Milk is <b>%1% more powerful</b>.': 'La leche es un <b>%1% más potente</b>.',
	'Cookie production multiplier <b>+%1%</b>.':
		'Multiplicador de producción de galletas del <b>+%1%</b>.',
	'Cookie production multiplier <b>+%1% permanently</b>.':
		'Multiplicador de producción de galletas del <b>+%1% permanente</b>.',
	"Cookie production multiplier <b>+%1% per Santa's levels.</b>":
		'Multiplicador de producción de galletas del <b>+%1% por los niveles de Papá Noel.</b>',
	'Cookie production multiplier <b>+%1%</b> for every year Cookie Clicker has existed (currently: <b>+%2%</b>).':
		'Multiplicador de producción de galletas del <b>+%1%</b> por cada año de existencia de Cookie Clicker (ahora mismo: <b>+%2%</b>).',
	'Cookie production multiplier <b>+%1%</b> for every building type level %2 or higher.':
		'Multiplicador de producción de galletas del <b>+%1%</b> por cada tipo de edificio de nivel %2 o superior.',
	...
	'Grandma-operated science lab and leisure club.<br>Grandmas are <b>4 times</b> as efficient.<br><b>Regularly unlocks new upgrades</b>.':
		'Laboratorio científico y club social gestionado por abuelas.<br>Las abuelas son <b>4 veces</b> más eficaces.<br><b>La regularidad desbloquea nuevas mejoras</b>.',
	...
	'Note: the grandmothers are growing restless. Do not encourage them.':
		'Nota: las abuelas están inquietas. No las animes.',
	'Note: proceeding any further in scientific research may have unexpected results. You have been warned.':
		'Nota: seguir adelante con la investigación científica puede tener resultados inesperados. Quedas advertido.',
	...
	"<b>Warning:</b> purchasing this will have unexpected, and potentially undesirable results!<br><small>It's all downhill from here. You have been warned!</small><br><br>Purchase anyway?":
		'<b>Aviso:</b> ¡comprar esto tendrá consecuencias inesperadas y potencialmente perjudiciales!<br><small>A partir de aquí, solo puede ir a peor. ¡Quedas advertido!</small><br><br>¿Comprar de todos modos?',
	'Contains the wrath of the elders, at least for a while.':
		'Contiene la ira de las ancianas, al menos por un tiempo.',
	"Puts a permanent end to the elders' wrath, at the cost of %1% of your CpS.":
		'Pone fin a la ira de las ancianas de forma permanente, a costa del %1% de tus g/s. ',
	'You will get %1% of your CpS back, but the grandmatriarchs will return.':
		'Recuperarás el %1% de tus g/s, pero las abumatriarcas volverán.',
	...
	'Golden cookies appear <b>twice as often</b> and stay <b>twice as long</b>.':
		'Las galletas doradas aparecen <b>el doble de a menudo</b> y duran <b>el doble de tiempo</b>.',
	'Golden cookies appear <b>%1%</b> more often.':
		'Las galletas doradas aparecen un <b>%1%</b> más a menudo.',
	'Golden cookies appear <b>%1%</b> more often during %2.':
		'Las galletas doradas aparecen un <b>%1%</b> más a menudo durante %2.',
	'Golden cookies appear <b>really often</b>.':
		'Las galletas doradas aparecen <b>muy a menudo</b>.',
	'Golden cookie effects last <b>twice as long</b>.':
		'El efecto de las galletas doradas dura <b>el doble</b>.',
	'Golden cookie effects last <b>%1%</b> longer.':
		'El efecto de las galletas doradas dura un <b>%1%</b> más.',
	'Golden cookies stay <b>%1%</b> longer.': 'Las galletas doradas duran un <b>%1%</b> más.',
	'Golden cookies give <b>%1%</b> more cookies.':
		'Las galletas doradas dan un <b>%1%</b> más de galletas.',
	'Wrath cookies give <b>%1%</b> more cookies.':
		'Las galletas de ira dan un <b>%1%</b> más de galletas.',
	'<b>+%1% CpS</b> per golden cookie on-screen, multiplicative.':
		'<b>+%1% de g/s</b> por galleta dorada en pantalla, multiplicativo.',
	'With no buffs and no golden cookies on screen, selling your most powerful building has <b>%1% chance to summon one</b>.':
		'Sin potenciadores ni galletas doradas en pantalla, vender tu edificio más poderoso tiene un <b>%1% de probabilidad de invocar uno</b>.',
	'Confers various powers to your minigames while active.<br>See the bottom of each minigame for more details.':
		'Confiere varios poderes a tus minijuegos mientras está activo.<br>Consulta la parte inferior de cada minijuego para obtener más detalles.',
	...
	'Can toggle upgrades on and off at will in the stats menu.':
		'En el menú estadísticas, puedes activar y desactivar mejoras cuando quieras.',
	'You keep producing cookies even while the game is closed.':
		'Sigue produciendo galletas incluso con el juego cerrado.',
	'Unlocks <b>%1%</b> of the potential of your prestige level.':
		'Desbloquea un <b>%1%</b> del potencial de tu nivel de prestigio.',
	'Subsequent research will be <b>%1 times</b> as fast.':
		'La siguiente investigación será <b>%1 veces</b> más rápida.',
	'Wrinklers appear <b>%1 times</b> as fast.':
		'Los devoradores aparecen <b>%1 veces</b> más rápido.',
	...
	'Wrinklers explode into <b>%1% more cookies</b>.':
		'Los devoradores explotan en un <b>%1% más de galletas</b>.',
	...
	'Reindeer appear <b>twice as frequently</b>.':
		'Los renos aparecen con el <b>doble</b> de frecuencia.',
	...
	'Buildings sell back for <b>%1%</b> instead of %2%.':
		'Los edificios se venden por el <b>%1%</b> en vez del %2%.',
	...
	'All buildings and upgrades are <b>%1% cheaper</b>.':
		'Todos los edificios y mejoras son un <b>%1% más baratos</b>.',
	'%1 are <b>%2%</b> more efficient and <b>%3%</b> cheaper.':
		'%1 son un <b>%2%</b> más eficaces y un <b>%3%</b> más baratos.',
	'Cookie upgrades are <b>%1 times cheaper</b>.':
		'Las mejoras de galletas son <b>%1 veces más baratas</b>.',
	...
	'Allows you to <b>trigger seasonal events</b> at will, for a price.':
		'Te permite <b>activar eventos de temporada</b> cuando quieras, por un precio.',
	'Triggers <b>%1 season</b> for the next 24 hours.<br>Triggering another season will cancel this one.<br>Cost scales with unbuffed CpS and increases with every season switch.':
		'Activa <b>la temporada de %1</b> durante las próximas 24 horas.<br>Activar otra temporada cancelará esta.<br>El coste aumenta con las g/s no potenciadas y aumenta con cada cambio de temporada.',
	...
	"You haven't switched seasons this ascension yet.":
		'En esta ascensión aún no has cambiado de temporada.',
	"You've switched seasons <b>once</b> this ascension.":
		'En esta ascensión, has cambiado de temporada <b>una vez</b>.',
	"You've switched seasons <b>%1 times</b> this ascension.":
		'En esta ascensión, has cambiado de temporada <b>%1 veces</b>.',
	'Cookie production <b>multiplied by 1,000</b>.':
		'La producción de galletas <b>se multiplica por 1000</b>.',
	'Other eggs appear <b>%1% more frequently</b>.':
		'Otros huevos aparecen con un <b>%1% más de frecuencia</b>.',
	...
	'Christmas cookies drop <b>%1%</b> more often.':
		'Las galletas navideñas aparecen con un <b>%1%</b> más de frecuencia.',
	'Spooky cookies drop <b>%1%</b> more often.':
		'Las galletas espeluznantes aparecen con un <b>%1%</b> más de frecuencia.',
	'Heart cookies are <b>%1%</b> more powerful.':
		'Las galletas de corazón son un <b>%1%</b> más poderosas.',
	"You continually gain <b>more CpS the longer you've played</b> in the current ascension.":
		'Obtienes de continuo <b>más g/s cuanto más hayas jugado</b> en esta ascensión.',
	...
	'Contains an assortment of rich butter cookies.':
		'Contiene un surtido de galletas de mantequilla.',
	...
	'Placing an upgrade in this slot will make its effects <b>permanent</b> across all playthroughs.':
		'Colocar una mejora en este espacio hará sus efectos <b>permanentes</b> en todas las partidas.',
	...
	'Here are all the upgrades you\'ve purchased last playthrough.<div class="line"></div>Pick one to permanently gain its effects!<div class="line"></div>You can reassign this slot anytime you ascend.':
		'Aquí están todas las mejoras que has comprado en la última partida.<div class="line"></div> Elige una para hacer permanentes sus efectos<div class="line"></div>Puedes reasignar este espacio siempre que asciendas.',
	'You now <b>keep making cookies while the game is closed</b>, at the rate of <b>%1%</b> of your regular CpS and up to <b>1 hour</b> after the game is closed.<br>(Beyond 1 hour, this is reduced by a further %2% - your rate goes down to <b>%3%</b> of your CpS.)':
		'Ahora, <b>sigues elaborando galletas con el juego cerrado</b> a un ritmo del <b>%1%</b> de tus g/s habituales y hasta <b>1 hora</b> después de cerrar el juego.<br>(A partir de 1 hora, el ritmo se reduce un %2% más. Tu ritmo baja al <b>%3%</b> de tus g/s.)',
	'You gain another <b>+%1%</b> of your regular CpS while the game is closed.':
		'Obtienes otro <b>+%1%</b> de tus g/s habituales con el juego cerrado.',
	'You gain another <b>+%1%</b> of your regular CpS while the game is closed, for a total of <b>%2%</b>.':
		'Obtienes otro <b>+%1%</b> de tus g/s habituales con el juego cerrado, un <b>%2%</b> en total.',
	'You start with <b>%1</b>.': 'Empiezas con <b>%1</b>.',
	'Allows you to purchase a <b>crumbly egg</b> once you have earned 1 million cookies.':
		'Te permite comprar un <b>huevo desmenuzado</b> una vez hayas conseguido 1 millón de galletas.',
	'Unlocks the <b>cookie dragon egg</b>.': 'Desbloquea el <b>huevo de dragón de galleta</b>.',
	'Synergy upgrades are <b>%1% cheaper</b>.':
		'Las mejoras de sinergia son un <b>%1% más baratas</b>.',
	'You retain optimal cookie production while the game is closed for <b>%1 more days</b>.':
		'Mantienes la producción óptima de galletas con el juego cerrado durante <b>%1 días más</b>.',
	'You retain optimal cookie production while the game is closed for twice as long, for a total of <b>%1</b>.':
		'Mantienes la producción óptima de galletas con el juego cerrado el doble de tiempo, por un total de <b>%1</b>.',
	'Unlocks the <b>golden switch</b>, which passively boosts your CpS by %1% but disables golden cookies.':
		'Desbloquea el <b>interruptor dorado</b>, que aumenta de forma pasiva tus g/s en un %1%, pero desactiva las galletas doradas.',
	'Turning this on will give you a passive <b>+%1% CpS</b>, but prevents golden cookies from spawning.<br>Cost is equal to 1 hour of production.':
		'Activar esto te dará un <b>+%1% de g/s</b> de forma pasiva, pero evita que aparezcan galletas doradas.<br>El coste es igual a 1 hora de producción.',
	'The switch is currently giving you a passive <b>+%1% CpS</b>; it also prevents golden cookies from spawning.<br>Turning it off will revert those effects.<br>Cost is equal to 1 hour of production.':
		'El interruptor te está dando un <b>+%1% de g/s</b> de forma pasiva; también evita que aparezcan galletas doradas.<br>Desactivarlo revertirá dichos efectos.<br>El coste es igual a 1 hora de producción.',
	'Unlocks the <b>milk selector</b>, letting you pick which milk is displayed under your cookie.<br>Comes with a variety of basic flavors.':
		'Desbloquea el <b>selector de leche</b>, que te permite elegir la leche mostrada bajo tu galleta.<br>Las hay de varios sabores básicos.',
	'Contains more exotic flavors for your milk selector.':
		'Contiene más sabores exóticos para tu selector de leche.',
	...
	'Unlocks the <b>golden cookie sound selector</b>, which lets you pick whether golden cookies emit a sound when appearing or not.':
		'Desbloquea el <b>selector de sonido de galleta dorada</b>, que te permite elegir si las galletas doradas emiten un sonido cuando aparecen o no.',
	'Lets you change the sound golden cookies make when they spawn.':
		'Te permite cambiar el sonido que hacen las galletas doradas al aparecer.',
	'No sound': 'Sin sonido',
	Chime: 'Campanilla',
	Fortune: 'Fortuna',
	Cymbal: 'Platillo',
	...
	'Unlocks the <b>jukebox</b>, which allows you to play through every sound file in the game.':
		'Desbloquea la <b>máquina de discos</b>, que te permite reproducir todos los archivos de sonido del juego.',
	...
	"Unlocks the <b>background selector</b>, letting you select the game's background.<br>Comes with a variety of basic flavors.":
		'Desbloquea el <b>selector de fondo</b>, lo que te permite seleccionar el fondo del juego.<br>Las hay de varios sabores básicos.',
	...
	'While the golden switch is on, you gain an additional <b>+%1% CpS</b> per golden cookie upgrade owned.':
		'Mientras el interruptor dorado esté activado, obtienes +1% de g/s adicional por cada mejora de galleta dorada que tengas.',
	'All upgrades are <b>%1% cheaper per %2</b>.':
		'Todas las mejoras son <b>%1% más baratas por %2</b>.',
	'Unlocks a new tier of upgrades that affect <b>2 buildings at the same time</b>.<br>Synergies appear once you have <b>%1</b> of both buildings.':
		'Desbloquea un nuevo nivel de mejoras que afecta a <b>2 edificios a la vez</b>.<br>Aparecen sinergias una vez que tengas <b>%1</b> de ambos edificios.',
	'Golden cookies (and all other things that spawn, such as reindeer) have <b>%1% chance of being doubled</b>.':
		'Las galletas doradas (y todas las demás cosas que aparecen, como los renos) tienen un <b>%1% de probabilidad de duplicarse</b>.',
	...
	'Sugar lumps coalesce <b>a whole lot faster</b>.':
		'Los terrones de azúcar se fusionan <b>mucho más rápido</b>.',
	'<b>+%1%</b> prestige level effect on CpS.':
		'<b>+%1%</b> de efecto de nivel de prestigio en g/s.',
	'<b>+%1%</b> prestige level effect on CpS.<br><b>+%2%</b> golden cookie effect duration.<br><b>+%3%</b> golden cookie lifespan.':
		'<b>+%1%</b> de efecto de nivel de prestigio en g/s.<br><b>+%2%</b> de duración del efecto de la galleta dorada.<br><b>+%3%</b> de vida de la galleta dorada.',
	'Each unspent sugar lump (up to %1) gives <b>+%2% CpS</b>.<div class="warning">Note: this means that spending sugar lumps will decrease your CpS until they grow back.</div>':
		'Cada terrón de azúcar no gastado (hasta %1) da <b>+%2% g/s</b>.<div class="warning">Nota: esto significa que gastar terrones de azúcar disminuirá tus g/s hasta que vuelvan a crecer.</div>',
	'Once an ascension, you may use the "Sugar frenzy" switch to <b>triple your CpS</b> for 1 hour, at the cost of <b>1 sugar lump</b>.':
		'Una vez que asciendas, puedes usar el interruptor “Frenesí de azúcar” para <b>triplicar tus g/s</b> durante 1 hora a costa de <b>1 terrón de azúcar</b>.',
	'Each grandma (up to %1) makes sugar lumps ripen <b>%2</b> sooner.':
		'Cada abuela (hasta %1) hace que los terrones de azúcar maduren un <b>%2</b> antes.',
	'Activating this will <b>triple your CpS</b> for 1 hour, at the cost of <b>1 sugar lump</b>.':
		'Activar esto <b>triplicará tus g/s</b> durante 1 hora a costa de <b>1 terrón de azúcar</b>.',
	...
	'Garden plants grow every second.<br>Garden seeds are free to plant.<br>You can switch soils at any time.':
		'Las plantas de jardín crecen cada segundo.<br>Las semillas de jardín se pueden plantar gratis.<br>Puedes cambiar de suelo en cualquier momento.',
	...
	'Sugar lumps are <b>twice as likely</b> to be unusual.':
		'Los terrones de azúcar tienen <b>el doble de probabilidad</b> de ser inusuales.',
	'<b>+%1%</b> sugar lump growth.': '<b>+%1%</b> de crecimiento de terrones de azúcar.',
	'Sugar lumps ripen <b>%1</b> sooner.':
		'Los terrones de azúcar están listos para la cosecha un <b>%1</b> antes.',
	'Sugar lumps mature <b>%1</b> sooner.':
		'Los terrones de azúcar se ponen maduros un <b>%1</b> antes.',
	'Bifurcated sugar lumps appear <b>%1% more often</b> and are <b>%2% more likely</b> to drop 2 lumps.':
		'Los terrones de azúcar bifurcados aparecen un <b>%1% más a menudo</b> y tienen un <b>%2% más de probabilidad</b> de soltar 2 terrones.',
	'Mouse over a wrinkler to see how many cookies are in its stomach.':
		'Pasa el ratón sobre un devorador para ver cuántas galletas tiene en el estómago.',
	'Unlocks the <b>Buy all</b> feature, which lets you instantly purchase every upgrade in your store (starting from the cheapest one).<br>Also unlocks the <b>Vault</b>, a store section where you can place upgrades you do not wish to auto-buy.':
		'Desbloquea la función <b>Comprar todo</b>, que te permite comprar al instante cada mejora en tu tienda (comenzando por la más barata).<br>También desbloquea la <b>Cámara</b>, una sección de la tienda donde puedes colocar mejoras que no quieras comprar automáticamente.',
	'Mouse over an upgrade to see its tier.<br><small>Note: only some upgrades have tiers. Tiers are purely cosmetic and have no effect on gameplay.</small>':
		'Pasa el ratón sobre una mejora para ver su categoría.<br><small>Nota: solo algunas mejoras tienen categorías. Las categorías son puramente estéticas y no tienen ningún efecto en el juego.</small>',
	'You now benefit from the boost provided by <b>heralds</b>.<br>Each herald gives you <b>+1% CpS</b>.<br>Look on the purple flag at the top to see how many heralds are active at any given time.':
		'Ahora te beneficias del aumento proporcionado por los <b>heraldos</b>.<br>Cada heraldo te da <b>+1% g/s</b>.<br>Mira la bandera violeta en la parte superior para ver cuántos heraldos están activos en un momento dado.',
	'Seasonal random drops have a <b>1/5 chance</b> to carry over through ascensions.':
		'Los botines al azar de temporada tienen <b>1/5 de probabilidad</b> de transferirse después de ascender.',
	"Unlocks <b>extra price information</b>.<br>Each displayed cost now specifies how long it'll take you to afford it, and how much of your bank it represents.":
		'Desbloquea <b>información adicional sobre precios</b>.<br>Cada coste que se muestra ahora especifica cuánto tiempo tardarás en pagarlo y cuánto representa de tu banca.',
	'Unlocks the <b>shimmering veil</b>, a switch that passively boosts your CpS by <b>%1%</b>.<br>You start with the veil turned on; however, it is very fragile, and clicking the big cookie or any golden cookie or reindeer will turn it off, requiring %2 of CpS to turn back on.':
		'Desbloquea el <b>velo brillante</b>, un interruptor que aumenta de forma pasiva tus g/s un <b>%1%</b>.<br>Empiezas con el velo activado; sin embargo, es muy frágil y al hacer clic en la galleta grande o en cualquier galleta dorada o reno se desactivará, lo que requerirá %2 g/s para reactivarlo.',
	'Boosts your cookie production by <b>%1%</b> when active.<br>The veil is very fragile and will break if you click the big cookie or any golden cookies or reindeer.<br><br>Once broken, turning the veil back on costs %2 of unbuffed CpS.':
		'Aumenta tu producción de galletas un <b>%1%</b> cuando está activo.<br>El velo es muy frágil y se romperá si haces clic en la galleta grande o en cualquier galleta dorada o reno.<br><br>Una vez roto, volver a activar el velo cuesta %2 g/s no potenciadas.',
	...
	'The <b>shimmering veil</b> is more resistant, and has a <b>%1% chance</b> not to break. It also gives <b>+%2%</b> more CpS.':
		'El <b>velo brillante</b> es más resistente y tiene un <b>%1% de probabilidad</b> de no romperse. También da <b>+%2%</b> más g/s.',
	'Active.': 'Activo.',
	'The reinforced membrane protects the shimmering veil.':
		'La membrana reforzada protege el velo brillante.',
	...
	'Prior to purchasing the <b>%1</b> upgrade in a run, random drops are <b>%2 times more common</b>.':
		'Antes de comprar la mejora <b>%1</b> en una partida, los botines son <b>%2 veces más frecuentes</b>.',
	...
	'The news ticker may occasionally have <b>fortunes</b>, which may be clicked for something good.':
		'Ocasionalmente, el transmisor de noticias puede tener <b>fortunas</b>, en las que puedes hacer clic para obtener algo bueno.',
	'Through clever accounting, this actually makes kitten upgrades <b>%1% cheaper</b>.':
		'A través de una contabilidad inteligente, esto hace que las mejoras de gatitos sean un <b>%1% más baratas</b>.',
	'Unlocks the ability to <b>pet your dragon</b> by clicking on it once hatched.':
		'Desbloquea la habilidad de <b>acariciar a tu dragón</b> haciendo clic en él una vez que nace.',
	'Cost scales with CpS, but %1 times cheaper with a fully-trained dragon.':
		'El coste aumenta con tus g/s, pero es %1 veces más barato con un dragón completamente entrenado.',
	'Golden cookies may trigger a <b>Dragon Harvest</b>.':
		'Las galletas doradas pueden activar una <b>Cosecha de dragón</b>.',
	'Golden cookies may trigger a <b>Dragonflight</b>.':
		'Las galletas doradas pueden activar un <b>Vuelo de dragón</b>.',
	'Dragon harvest and Dragonflight are <b>%1% stronger</b>.':
		'Cosecha de dragón y Vuelo de dragón son un <b>%1% más fuertes</b>.',
	'Kittens are <b>%1%</b> more effective.': 'Los gatitos son un <b>%1%</b> más efectivos.',
	'Each kitten upgrade boosts %1 CpS by <b>%2%</b>.':
		'Cada mejora de gatito aumenta %1 g/s en un <b>%2%</b>.',
	'Each rank of milk boosts %1 CpS by <b>%2%</b>.':
		'Cada rango de leche aumenta %1 g/s en un <b>%2%</b>.',
	'Cursor levels boost clicks by <b>%1%</b> each (up to cursor level %2).':
		'Los niveles del cursor aumentan los clics un <b>%1%</b> cada uno (hasta el nivel del cursor %2).',
	'<b>%1</b> are now effective up to cursor level %2.':
		'<b>%1</b> ahora son efectivos hasta el nivel del cursor %2.',
	...
	'Golden and wrath cookie effect duration +%1%.':
		'+%1 % de duración de galleta dorada y de la ira.',
	'Golden and wrath cookies appear %1% more.':
		'Las galletas doradas y de la ira aparecen un %1 % más.',
	'Golden and wrath cookies appear %1% less.':
		'Las galletas doradas y de la ira aparecen un %1 % menos.',
	...
	'Selling buildings triggers a buff boosted by how many buildings were sold.':
		'Vender edificios activa una bonificación que aumenta según los edificios vendidos.',
	'Buff boosts clicks by +%1% for every building sold for %2 seconds.':
		'La bonificación aumenta los clics un +%1 % para cada edificio vendido durante %2 segundos.',
	'CpS bonus fluctuating between %1 and %2 over time.':
		'La bonificación de g/s fluctúa entre %1 y %2 con el tiempo.',
	...
	'All golden cookies are wrath cookies with a greater chance of a negative effect.':
		'Todas las galletas doradas son galletas de la ira con una mayor probabilidad de tener un efecto negativo.',
	'Wrinklers appear %1% faster and digest %2% more cookies.':
		'Los devoradores aparecen un %1 % más rápido y comen un %2 % más de galletas.',
	'Effect is only active when your total amount of buildings ends with 0.':
		'El efecto solo está activo cuando el número total de edificios acaba con 0.',
	...
	'Make <b>%1</b> by only having clicked <b>%2 times</b>.':
		'Haz <b>%1</b> tras solo haber hecho clic <b>%2 veces</b>.',
	'Make <b>%1</b> with <b>no</b> cookie clicks.':
		'Haz <b>%1</b> <b>sin</b> hacer clic en galletas.',
	'Get to <b>%1</b> baked with <b>no upgrades purchased</b>.':
		'Consigue hornear <b>%1</b> <b>sin comprar mejoras</b>.',
	...
	'Have at least <b>1 of the most expensive object, 2 of the second-most expensive, 4 of the next</b> and so on (capped at %1).':
		'Ten al menos <b>1 del objeto más caro, 2 del segundo más caro, 4 del siguiente</b> y así sucesivamente (con un límite de %1).',
	'Have at least <b>10 of the most expensive object, 20 of the second-most expensive, 30 of the next</b> and so on.':
		'Ten al menos <b>10 del objeto más caro, 20 del segundo más caro, 30 del siguiente</b> y así sucesivamente.',
	...
	'Appease the grandmatriarchs at least <b>once</b>.':
		'Apacigua a las abumatriarcas al menos <b>una vez</b>.',
	'Appease the grandmatriarchs at least <b>%1 times</b>.':
		'Apacigua a las abumatriarcas al menos <b>%1 veces</b>.',
	...
	'Unlock <b>100%</b> of your heavenly chips power.':
		'Desbloquea el <b>100%</b> del poder de tus fichas celestiales.',
	'You have <b>1 chance in %1</b> every second of earning this achievement.':
		'Tienes <b>1 probabilidad entre %1</b> por cada segundo de obtener este logro.',
	...
	'Unlock <b>every Halloween-themed cookie</b>.<div class="line"></div>Owning this achievement makes Halloween-themed cookies drop more frequently in future playthroughs.':
		'Desbloquea <b>todas las galletas con temática de Halloween</b>. <div class="line"></div>Tener este logro hace que las galletas con temática de Halloween caigan con más frecuencia en futuras partidas.',
	...
	'Unlock <b>every Christmas-themed cookie</b>.<div class="line"></div>Owning this achievement makes Christmas-themed cookies drop more frequently in future playthroughs.':
		'Desbloquea <b>todas las galletas con temática navideña</b>. <div class="line"></div>Tener este logro hace que las galletas con temática navideña caigan con más frecuencia en futuras partidas.',
	'Pop <b>1 reindeer</b>.': 'Explota <b>1 reno</b>.',
	'Pop <b>%1 reindeer</b>.': 'Explota <b>%1 renos</b>.',
	'Pop a reindeer <b>during an elder frenzy</b>.':
		'Explota un reno <b>durante un frenesí de ancianas</b>.',
	'Unlock <b>every Valentine-themed cookie</b>.':
		'Desbloquea <b>todas las galletas con temática de San Valentín</b>.',
	'Click the tiny cookie.': 'Haz clic en la galleta diminuta.',
	'This is for baking %1 and making it on the local news.':
		'Esto es por hornear %1 y publicarlo en las noticias locales.',
	'Name yourself <b>Orteil</b>.<div class="warning">Note: usurpers incur a -%1% CpS penalty until they rename themselves something else.</div>':
		'Ponte de nombre <b>Orteil</b>. <div class="warning"> Nota: los usurpadores incurrirán en una penalización de -%1% g/s hasta que cambien su nombre.</div>',
	...
	'Unlock <b>all the eggs</b>.<div class="line"></div>Owning this achievement makes eggs drop more frequently in future playthroughs.':
		'Desbloquea <b>todos los huevos</b>. <div class="line"></div>Tener este logro hace que los huevos caigan con más frecuencia en futuras partidas.',
	...
	'Click on the news ticker <b>%1 times</b>.':
		'Haz clic en el transmisor de noticias <b>%1 veces</b>.',
	...
	'Burst the near-extinct <b>shiny wrinkler</b>.':
		'Explota al casi extinto <b>devorador brillante</b>.',
	'Click a golden cookie <b>less than 1 second after it spawns</b>.':
		'Haz clic en una galleta dorada <b>menos de 1 segundo después de que aparezca</b>.',
	'Click a golden cookie <b>less than 1 second before it dies</b>.':
		'Haz clic en una galleta dorada <b>menos de 1 segundo antes de que desaparezca</b>.',
	...
	"Successfully harvest a coalescing sugar lump before it's ripe.":
		'Cosecha con éxito un terrón de azúcar fusionado antes de que esté maduro.',
	...
	'Have <b>%1</b> golden cookies simultaneously.':
		'Ten <b>%1</b> galletas doradas simultáneamente.',
	'Manage a cookie legacy for <b>at least a year</b>.':
		'Administra un legado de galletas durante <b>al menos un año</b>.',
	...
	'Fill every tile of the biggest garden plot with plants.':
		'Llena cada casilla del jardín más grande con plantas.',
	...
	'Convert a complete seed log into sugar lumps by sacrificing your garden to the sugar hornets.<div class="line"></div>Owning this achievement makes seeds <b>%1% cheaper</b>, plants mature <b>%2% sooner</b>, and plant upgrades drop <b>%3% more</b>.':
		'Convierte un tronco de semillas completo en terrones de azúcar sacrificando tu jardín a los avispones de azúcar.<div class="line"></div>Tener este logro hace que las semillas sean un <b>%1% más baratas</b>, las plantas maduren un <b>%2% ​​antes</b> y las mejoras de plantas caigan un <b>%3% más</b>.',
	...
	'Have your <b>reinforced membrane</b> protect the <b>shimmering veil</b>.':
		'Haz que tu <b>membrana reforzada</b> proteja el <b>velo brillante</b>.',
	'Own every <b>fortune upgrade</b>.<div class="line"></div>Owning this achievement makes fortunes appear <b>twice as often</b>; unlocked fortune upgrades also have a <b>%1% chance</b> to carry over after ascending.':
		'Ten cada <b>mejora de fortuna</b>.<div class="line"></div>Tener este logro hace que las fortunas aparezcan <b>el doble de veces</b>; las mejoras de fortuna desbloqueadas también tienen un <b>%1% de probabilidad</b> de transferirse después de ascender.',
	'Make your first stock market profit.': 'Obtén tu primera ganancia en la bolsa.',
	'Own at least <b>%1</b> of a stock market good.':
		'Ten al menos <b>%1</b> de un bien de la bolsa.',
	'Own at least <b>%1</b> of every stock market good.':
		'Ten al menos <b>%1</b> de cada bien de la bolsa.',
	'Make <b>a day</b> of CpS ($%1) in 1 stock market sale.':
		'Obtén <b>un día</b> de g/s ($%1) en 1 venta en la bolsa.',
	'Spend <b>a day</b> of CpS ($%1) in 1 stock market purchase.':
		'Gasta <b>un día</b> de g/s ($%1) en 1 compra en la bolsa.',
	'Have your stock market profits surpass <b>a whole year</b> of CpS ($%1).':
		'Haz que tus ganancias en la bolsa superen <b>todo un año</b> de g/s ($%1).',
	'Unlock the <b>highest-tier</b> stock market headquarters.':
		'Desbloquea la sede de la bolsa de <b>categoría más alta</b>.',
	'Have your stock market profits surpass <b>$%1</b>.':
		'Haz que tus ganancias en la bolsa superen <b>$%1</b>.',
	...
	"Click one of Santa's helper grandmas during Christmas season.":
		'Haz clic en una de las abuelas ayudantes de Papá Noel durante la temporada navideña.',
	Frenzy: 'Frenesí',
	...
	'All buildings are %1% cheaper for %2!':
		'¡Todos los edificios son un %1% más baratos durante %2!',
	...
	'Cookie production halted for %1,<br>but each click is worth %2 of CpS.':
		'La producción de galletas se detuvo durante %1,<br>pero cada clic vale %2 g/s.',
	...
	'You find %1% more golden cookies for the next %2.':
		'Encontrarás un %1% más de galletas doradas durante los próximos %2.',
	...
	"[Baker's wheat quote]A plentiful crop whose hardy grain is used to make flour for pastries.":
		'Una cosecha abundante cuyo grano resistente se utiliza para elaborar harina para repostería.',
	...
	'[Thumbcorn quote]A strangely-shaped variant of corn. The amount of strands that can sprout from one seed is usually in the single digits.':
		'Una variante de maíz con una forma extraña. La cantidad de hebras que pueden brotar de una semilla suele ser de un solo dígito.',
	...
	"[Cronerice quote]Not only does this wrinkly bulb look nothing like rice, it's not even related to it either; its closest extant relative is the weeping willow.":
		'Este bulbo arrugado no solo no se parece en nada al arroz, sino que ni siquiera está relacionado con él; su pariente más cercano es el sauce llorón.',
	...
	'[Gildmillet quote]An ancient staple crop, famed for its golden sheen. Was once used to bake birthday cakes for kings and queens of old.':
		'Un antiguo cultivo básico, famoso por su brillo dorado. Antaño, se utilizaba para hacer pasteles de cumpleaños para reyes y reinas.',
	...
	'[Ordinary clover quote]<i>Trifolium repens</i>, a fairly mundane variety of clover with a tendency to produce four leaves. Such instances are considered lucky by some.':
		'<i>Trifolium repens</i>, una variedad de trébol bastante mundana con tendencia a producir cuatro hojas. Algunos consideran que estos dan suerte.',
	...
	'[Golden clover quote]A variant of the ordinary clover that traded its chlorophyll for pure organic gold. Tragically short-lived, this herb is an evolutionary dead-end - but at least it looks pretty.':
		'Una variante del trébol ordinario que ha cambiado su clorofila por oro orgánico puro. Con una vida trágicamente, esta hierba es un callejón sin salida evolutivo, pero al menos es bonita.',
	...
	'[Shimmerlily quote]These little flowers are easiest to find at dawn, as the sunlight refracting in dew drops draws attention to their pure-white petals.':
		'Estas pequeñas flores son más fáciles de encontrar al amanecer, ya que la luz del sol que se refleja en las gotas de rocío destaca sobre sus pétalos de color blanco puro.',
	Elderwort: 'Sauco',
	'[Elderwort quote]A very old, long-forgotten subspecies of edelweiss that emits a strange, heady scent. There is some anecdotal evidence that these do not undergo molecular aging.':
		'Una subespecie de edelweiss muy antigua y olvidada hace mucho tiempo que desprende un aroma extraño y embriagador. Existe alguna prueba anecdótica de que no sufren envejecimiento molecular.',
	...
	'[Bakeberry quote]A favorite among cooks, this large berry has a crunchy brown exterior and a creamy red center. Excellent in pies or chicken stews.':
		'Una de las favoritas entre los cocineros, esta gran baya tiene un exterior marrón crujiente y un centro rojo cremoso. Es excelente en tartas o guisos de pollo.',
	...
	'[Chocoroot quote]A tangly bramble coated in a sticky, sweet substance. Unknown genetic ancestry. Children often pick these from fields as-is as a snack.':
		'Una zarza espesa cubierta de una sustancia dulce y pegajosa. Se desconoce su ascendencia genética. Los niños a menudo las recogen del campo como si fueran caramelos.',
	...
	'[White chocoroot quote]A pale, even sweeter variant of the chocoroot. Often impedes travelers with its twisty branches.':
		'Una variante pálida y aún más dulce de la chocorraíz. A menudo obstaculiza a los viajeros con sus ramas sinuosas.',
	...
	'[White mildew quote]A common rot that infests shady plots of earth. Grows in little creamy capsules. Smells sweet, but sadly wilts quickly.':
		'Una podredumbre común que infesta los terrenos sombríos. Crece en pequeñas cápsulas cremosas. Tiene un olor dulce, pero por desgracia se marchita rápidamente.',
	...
	'[Brown mold quote]A common rot that infests shady plots of earth. Grows in odd reddish clumps. Smells bitter, but thankfully wilts quickly.':
		'Una podredumbre común que infesta los terrenos sombríos. Crece en extraños grupos rojizos. Tiene un olor amargo, pero por suerte se marchita rápidamente.',
	...
	'[Meddleweed quote]The sign of a neglected farmland, this annoying weed spawns from unused dirt and may sometimes spread to other plants, killing them in the process.':
		'El signo de una tierra de cultivo descuidada, esta molesta maleza crece debido a la suciedad y a veces puede extenderse a otras plantas, matándolas en el proceso.',
	...
	"[Whiskerbloom quote]Squeezing the translucent pods makes them excrete a milky liquid, while producing a faint squeak akin to a cat's meow.":
		'Al apretar las vainas translúcidas excretan un líquido lechoso, mientras producen un leve chirrido similar al maullido de un gato.',
	Chimerose: 'Quimerosa',
	'[Chimerose quote]Originating in the greener flanks of polar mountains, this beautiful flower with golden accents is fragrant enough to make any room feel a little bit more festive.':
		'Originaria de los flancos más verdes de las montañas polares, esta hermosa flor con toques dorados es lo bastante fragante como para hacer que cualquier habitación sea un poco más festiva.',
	Nursetulip: 'Curipán',
	'[Nursetulip quote]This flower grows an intricate root network that distributes nutrients throughout the surrounding soil. The reason for this seemingly altruistic behavior is still unknown.':
		'Esta flor desarrolla una intrincada red de raíces que distribuye nutrientes por todo el suelo circundante. La razón de este comportamiento aparentemente altruista aún se desconoce.',
	Drowsyfern: 'Helecho somnoliento',
	'[Drowsyfern quote]Traditionally used to brew a tea that guarantees a good night of sleep.':
		'Se utiliza tradicionalmente para preparar un té que garantiza una buena noche de descanso.',
	...
	'[Wardlichen quote]The metallic stench that emanates from this organism has been known to keep insects and slugs away.':
		'Se sabe que el hedor metálico que emana de este organismo mantiene alejados a los insectos y las babosas.',
	Keenmoss: 'Musgo fino',
	'[Keenmoss quote]Fuzzy to the touch and of a vibrant green. In plant symbolism, keenmoss is associated with good luck for finding lost objects.':
		'Suave al tacto y de un verde vibrante. En el simbolismo de las plantas, el musgo fino se asocia a la buena suerte para encontrar objetos perdidos.',
	Queenbeet: 'Remolacha',
	'[Queenbeet quote]A delicious taproot used to prepare high-grade white sugar. Entire countries once went to war over these.':
		'Una deliciosa raíz que se utiliza para preparar azúcar blanca de alta calidad. Hasta países enteros han ido a la guerra por ellas.',
	...
	'[Juicy queenbeet quote]A delicious taproot used to prepare high-grade white sugar. Entire countries once went to war over these.<br>It looks like this one has grown especially sweeter and juicier from growing in close proximity to other queenbeets.':
		'Una deliciosa raíz que se utiliza para preparar azúcar blanca de alta calidad. Hasta países enteros han ido a la guerra por ellas.<br>Parece que esta se ha vuelto especialmente más dulce y jugosa al crecer cerca de otras remolachas.',
	...
	'[Duketater quote]A rare, rich-tasting tuber fit for a whole meal, as long as its strict harvesting schedule is respected. Its starch has fascinating baking properties.':
		'Un tubérculo raro y de rico sabor que vale para una comida completa, siempre que se respete su estricto programa de recogida. Su almidón tiene fascinantes propiedades para la repostería.',
	...
	'[Crumbspore quote]An archaic mold that spreads its spores to the surrounding dirt through simple pod explosion.':
		'Un moho arcaico que esparce sus esporas a la tierra circundante a través de la simple explosión de una vaina.',
	...
	'[Doughshroom quote]Jammed full of warm spores; some forest walkers often describe the smell as similar to passing by a bakery.':
		'Está repleto de esporas calientes; algunos caminantes del bosque a menudo describen su olor similar al de una confitería.',
	...
	'[Glovemorel quote]Touching its waxy skin reveals that the interior is hollow and uncomfortably squishy.':
		'Al tocar su piel cerosa se descubre que el interior es hueco e incómodamente blando.',
	Cheapcap: 'Baraseta',
	'[Cheapcap quote]Small, tough, and good in omelettes. Some historians propose that the heads of dried cheapcaps were once used as currency in some bronze age societies.':
		'Pequeña, dura y buena para hacer tortillas. Algunos historiadores opinan que las cabezas de las barasetas se utilizaron una vez como moneda en algunas sociedades de la Edad de Bronce.',
	...
	"[Fool's bolete quote]Named for its ability to fool mushroom pickers. The fool's bolete is not actually poisonous, it's just extremely bland.":
		'Llamado así por su capacidad para engañar a los recolectores de setas. El boletus engañoso no es en realidad venenoso, tan solo es muy soso.',
	...
	"[Wrinklegill quote]This mushroom's odor resembles that of a well-done steak, and is said to whet the appetite - making one's stomach start gurgling within seconds.":
		'El olor de este champiñón se parece al de un bistec bien hecho y se dice que abre el apetito, lo que hace que el estómago comience a rugir en segundos.',
	...
	'[Green rot quote]This short-lived mold is also known as "emerald pebbles", and is considered by some as a pseudo-gem that symbolizes good fortune.':
		'Este moho de corta vida también se conoce como “guijarro de esmeralda”, y algunos lo consideran una pseudogema que simboliza la buena suerte.',
	...
	'[Shriekbulb quote]A nasty vegetable with a dreadful quirk : its flesh resonates with a high-pitched howl whenever it is hit at the right angle by sunlight, moonlight, or even a slight breeze.':
		'Una verdura asquerosa con una peculiaridad espantosa: su carne resuena con un aullido agudo cada vez que la luz del sol, la luna o incluso una ligera brisa cae sobre él en el ángulo correcto.',
	...
	'[Tidygrass quote]The molecules this grass emits are a natural weedkiller. Its stems grow following a predictable pattern, making it an interesting -if expensive- choice for a lawn grass.':
		'Las moléculas que emite esta hierba son un herbicida natural. Sus tallos crecen siguiendo un patrón predecible, lo que la convierte en una opción interesante, aunque cara, como césped.',
	...
	'[Everdaisy quote]While promoted by some as a superfood owing to its association with longevity and intriguing geometry, this elusive flower is actually mildly toxic.':
		'Si bien algunos la promocionan como un superalimento debido a su relación con la longevidad y la geometría intrigante, esta elusiva flor es en realidad ligeramente tóxica.',
	...
	'[Ichorpuff quote]This puffball mushroom contains sugary spores, but it never seems to mature to bursting on its own. Surrounding plants under its influence have a very slow metabolism, reducing their effects but lengthening their lifespan.':
		'Este champiñón abombado contiene esporas azucaradas, pero nunca parece madurar hasta estallar por sí solo. Las plantas circundantes bajo su influencia tienen un metabolismo muy lento, lo que reduce sus efectos, pero alargan su vida útil.',
	...
	"-You can cross-breed plants by planting them close to each other; new plants will grow in the empty tiles next to them.<br>-Unlock new seeds by harvesting mature plants.<br>-When you ascend, your garden plants are reset, but you keep all the seeds you've unlocked.<br>-Your garden has no effect and does not grow while the game is closed.":
		'-Puedes cruzar plantas plantándolas cerca; las nuevas plantas crecerán en los hoyos vacíos que están junto a ellas.<br>Cuando asciendes, las plantas de tu jardín se reinician, pero conservas las semillas desbloqueadas.<br>-Tu jardín no tiene efecto y no crece cuando el juego está cerrado.',
	'Harvest all': 'Cosechar todas',
	'Instantly harvest all plants in your garden.':
		'Cosecha instantáneamente todas las plantas de tu jardín.',
	...
	'%1 to harvest all mature plants of this type.':
		'%1 para cosechar todas las plantas maduras de este tipo.',
	Freeze: 'Congelar',
	'Cryogenically preserve your garden.<br>Plants no longer grow, spread or die; they provide no benefits.<br>Soil cannot be changed.<div class="line"></div>Using this will effectively pause your garden.':
		'Criogeniza tu jardín para preservarlo.<br>Las plantas ya no crecen ni se esparcen o mueren; no dan ningún beneficio.<br>La tierra no puede cambiarse.<div class="line"></div>Es una manera eficaz de pausar tu jardín.',
	...
	'A swarm of sugar hornets comes down on your garden, <span class="red">destroying every plant as well as every seed you\'ve unlocked</span> - leaving only a %1 seed.<br>In exchange, they will grant you <span class="green">%2</span>.<br>This action is only available with a complete seed log.':
		'Un enjambre de avispones del azúcar desciende sobre tu jardín, <span class="red">destruyendo todas las plantas y las semillas desbloqueadas</span> y dejando solo una semilla de %1.<br>A cambio, otorga <span class="green">%2</span>.<br>Esta acción solo está disponible para los registros de semillas completos.',
	'Do you REALLY want to sacrifice your garden to the sugar hornets?<br><small>You will be left with an empty plot and only the %1 seed unlocked.<br>In return, you will gain <b>%2 sugar lumps</b>.</small>':
		'¿SEGURO que quieres sacrificar tu jardín a los avispones del azúcar?<br><small>La parcela se quedará vacía y solo quedará desbloqueada la semilla de %1.<br>A cambio ganarás<b>%2 terrones de azúcar</b>.</small>',
	...
	"You've sacrificed your garden to the sugar hornets, destroying your crops and your knowledge of seeds.<br>In the remains, you find <b>%1 sugar lumps</b>.":
		'Has sacrificado tu jardín a los avispones del azúcar, que han destruido tus cultivos y tus conocimientos sobre semillas.<br>En los restos encuentras <b>%1 terrones de azúcar</b>.',
	immortal: 'inmortal',
	'predictable growth': 'crecimiento predecible',
	'surrounding plants (%1x%1) age %2% faster':
		'las plantas alrededor (%1x%1) envejecen un %2 % más rápido',
	'surrounding plants (%1x%1) age %2% slower':
		'las plantas alrededor (%1x%1) envejecen un %2 % más despacio',
	'surrounding plants (%1x%1) are %2% more efficient':
		'las plantas alrededor (%1x%1) son un %2 % más eficientes',
	'surrounding plants (%1x%1) are %2% less efficient':
		'las plantas alrededor (%1x%1) son un %2 % menos eficientes',
	'surrounding tiles (%1x%1) develop no weeds or fungus':
		'en los hoyos alrededor (%1x%1) no hay malas hierbas ni hongos',
	'harvest when mature for +%1 of CpS (max. %2% of bank)':
		'cosechar cuando maduren por +%1 g/s (máx. %2 % del banco)',
	...
	'explodes into up to %1 of CpS at the end of its lifecycle (max. %2% of bank)':
		'explota en hasta %1 g/s al final de su ciclo de vida (máx. %2 % del banco)',
	'cannot handle cold climates; %1% chance to die when frozen':
		'no soporta los climas fríos; %1 % de probabilidades de morir al congelarse',
	'the unfortunate result of some plant combinations':
		'el desafortunado resultado de algunas combinaciones de plantas',
	...
	'Click to use this type of soil for your whole field.':
		'Haz clic para usar este tipo de tierra en todo el terreno.',
	Dirt: 'Barro',
	"Simple, regular old dirt that you'd find in nature.":
		'El barro normal de toda la vida que se encuentra en la naturaleza.',
	Fertilizer: 'Fertilizador',
	'Soil with a healthy helping of fresh manure. Plants grow faster but are less efficient.':
		'Tierra con una buena cantidad de abono fresco. Las plantas crecen más rápido, pero son menos eficientes.',
	Clay: 'Arcilla',
	'Rich soil with very good water retention. Plants grow slower but are more efficient.':
		'Tierra fértil que retiene bien el agua. Las plantas crecen más despacio, pero son más eficientes.',
	Pebbles: 'Guijarros',
	"Dry soil made of small rocks tightly packed together. Not very conducive to plant health, but whatever falls off your crops will be easy to retrieve.<br>Useful if you're one of those farmers who just want to find new seeds without having to tend their garden too much.":
		'Tierra seca compuesta por pequeñas piedras comprimidas. No es muy buena para la salud de las plantas, pero será fácil recuperar todo lo que se caiga de los cultivos.<br>Útil si eres como esos granjeros a los que les gusta encontrar semillas nuevas sin tener que cuidar mucho el jardín.',
	'Wood chips': 'Astillas',
	'Soil made of bits and pieces of bark and sawdust. Helpful for young sprouts to develop, not so much for mature plants.':
		'Tierra compuesta por trozos de corteza y virutas. Favorece el crecimiento de los pequeños brotes, no tanto el de las plantas maduras.',
	...
	'<b>%1% chance</b> of collecting seeds automatically when plants expire':
		'<b>%1 % de probabilidades</b> de recoger semillas automáticamente cuando la planta muera',
	'plants spread and mutate <b>%1 times more</b>':
		'las plantas se propagan y mutan <b>%1 veces más</b>',
	...
	'This tile of soil is empty.<br>Pick a seed and plant something!':
		'Este hoyo de tierra está vacío.<br>Escoge una semilla y planta algo.',
	...
	'may reproduce, will drop seed when harvested':
		'puede reproducirse, caerán semillas al cosecharla',
	...
	'Click to refill your soil timer and trigger <b>1</b> plant growth tick with <b>x%1</b> spread and mutation rate for %2.':
		'Haz clic para recargar el temporizador de tierra y activar <b>1</b> tic de crecimiento con un <b>x%1</b> de velocidad de propagación y mutación durante %2.',
	...
	'Plot size: %1<br>(Upgrades with farm level)':
		'Tamaño de la parcela: %1<br>(Mejora con el nivel de la granja)',
	'Garden plants age and mutate %1% faster.':
		'Las plantas de jardín envejecen y mutan un %1% más rápido.',
	'while plant is alive; scales with plant growth':
		'Mientras la planta está viva; progresa con el crecimiento de la planta.',
	Dungeon: 'Calabozo',
	Grimoire: 'Grimorio',
	'This is your magic meter. Each spell costs magic to use.<div class="line"></div>Your maximum amount of magic varies depending on your amount of <b>Wizard towers</b>, and their level.<div class="line"></div>Magic refills over time. The lower your magic meter, the slower it refills.':
		'Este es tu contador mágico. Cada hechizo cuesta magia.<div class="line"></div>La cantidad máxima de magia depende de la cantidad de <b>torres de hechicero</b> que tengas y de su nivel.<div class="line"></div>La magia se recarga con el tiempo. Cuanto más bajo esté tu contador mágico, más despacio se recargará.',
	...
	'Click to refill <b>%1 units</b> of your magic meter for %2.':
		'Haz clic para recargar <b>%1 unidades</b> del contador mágico durante %2.',
	'Grimoire spells are %1% cheaper but fail %1% more.':
		'Los hechizos de grimorio son un %1% más baratos, pero fallan un %1% más.',
	'Conjure Baked Goods': 'Conjurar alimentos horneados',
	'Summon half an hour worth of your CpS, capped at %1% of your cookies owned.':
		'Invoca media hora de g/s, limitado a un %1 % de las galletas que tienes.',
	'Trigger a %1-minute clot and lose %1 minutes of CpS.':
		'Activa un grumo de %1 minutos y pierde %1 minutos de g/s.',
	...
	'Summon a random golden cookie. Each existing golden cookie makes this spell +%1% more likely to backfire.':
		'Invoca una galleta dorada aleatoria. Cada galleta aleatoria existente hace que este hechizo tenga un +%1 % de probabilidades de estallar.',
	...
	'All active buffs gain %1% more time (up to %2 more minutes).':
		'Todas las bonificaciones activas ganan un %1 % más de tiempo (hasta %2 minutos más).',
	'All active buffs are shortened by %1% (up to %2 minutes shorter).':
		'Todas las bonificaciones activas se acortan un %1 % (hasta %2 minutos menos).',
	...
	'The spell picks a random building you could afford if you had twice your current cookies, and gives it to you for free. The building selected must be under %1, and cannot be your most-built one (unless it is your only one).':
		'El hechizo escoge un edificio aleatorio que te podrías permitir si tuvieses el doble de galletas y te lo da gratis. El edificio seleccionado debe ser menor a %1 y no puede ser el más construido (a menos que sea el único).',
	...
	'Upgrades are %1% more expensive for an hour.':
		'Las mejoras son un %1 % más caras durante 1 hora.',
	...
	'Buildings are %1% cheaper for 1 minute.':
		'Los edificios son un %1 % más baratos durante 1 minuto.',
	'Buildings are %1% more expensive for an hour.':
		'Los edificios son un %1 % más caros durante 1 minuto.',
	...
	'Cast a random spell at half the magic cost, with twice the chance of backfiring.':
		'Lanza un hechizo a costa de la mitad de la magia con el doble de probabilidad de fracasar.',
	...
	'Instantly summon a wrinkler if conditions are fulfilled.':
		'Invoca instantáneamente un devorador si se dan las condiciones apropiadas.',
	...
	'Spells backfire %1 times less for the next %2 minutes.':
		'Conjura %1 veces menos explosiones durante los próximos %2 minutos.',
	'Spells backfire %1 times more for the next %2 minutes.':
		'Conjura %1 veces más explosiones durante los próximos %2 minutos.',
	...
	'[GOD 1 QUOTE]An immortal life spent focusing on the inner self, away from the distractions of material wealth.':
		'Una vida inmortal dedicada al yo interior, lejos de las distracciones materiales.',
	...
	'[GOD 2 QUOTE]This sleazy spirit revels in the lust for quick easy gain and contempt for the value of steady work.':
		'A este sórdido espíritu le divierte la codicia por el lucro fácil y desprecia el valor del trabajo estable.',
	...
	'[GOD 3 QUOTE]The embodiment of natural disasters. An impenetrable motive drives the devastation caused by this spirit.':
		'La encarnación de los desastres naturales. Las motivaciones de la devastación causada por este espíritu son impenetrables.',
	...
	"[GOD 4 QUOTE]This spirit knows about everything you'll ever do, and enjoys dispensing a harsh judgment.":
		'Este espíritu sabe todo lo que harás en tu vida y disfruta juzgándote severamente.',
	...
	'[GOD 5 QUOTE]This is the spirit of merry getaways and regretful Monday mornings.':
		'Este es el espíritu de las salidas alegres y las mañanas pesarosas de los lunes.',
	...
	"[GOD 6 QUOTE]All things that be and ever will be were scripted long ago by this spirit's inscrutable tendrils.":
		'Todas las cosas que han sucedido y sucederán fueron escritas mucho tiempo atrás por sus inescrutables tentáculos.',
	...
	'[GOD 7 QUOTE]This spirit enjoys a good cheese after a day of hard work.':
		'A este espíritu le gusta disfrutar de un buen queso después de un duro día de trabajo.',
	...
	'[GOD 8 QUOTE]While this spirit has many regrets, helping you rule the world through constant industrialization is not one of them.':
		'Aunque este espíritu se arrepiente de muchas cosas, ayudarte a gobernar el mundo a través de una incesante industrialización no es una de ellas.',
	...
	'[GOD 9 QUOTE]A caring spirit said to contain itself, inwards infinitely.':
		'Un espíritu bondadoso que se contiene a sí mismo dentro infinitamente.',
	...
	'[GOD 10 QUOTE]This spirit enjoys poking foul beasts and watching them squirm, but has no love for its own family.':
		'Este espíritu disfruta metiéndose con bestias fétidas y viéndolas retorcerse, pero no siente ningún amor por su propia familia.',
	...
	'[GOD 11 QUOTE]You will find that life gets just a little bit sweeter if you can motivate this spirit with tidy numbers and properly-filled tax returns.':
		'Descubrirás que la vida se vuelve un poco más amable si puedes motivar a este espíritu con números ordenados y declaraciones de impuestos debidamente cumplimentadas.',
	...
	'Drag a spirit onto this slot to assign it.':
		'Arrastra un espíritu a esta ranura para asignarlo.',
	'If a golden cookie is clicked, this spirit is unslotted and all worship swaps will be used up.':
		'Si haces clic en una galleta dorada, el espíritu se liberará y se consumirán todos los cambios de devoción.',
	...
	'The jade slot behaves as a ruby slot and the ruby slot behaves as a diamond slot.':
		'La ranura de jade se comporta como una ranura de rubí y la ranura de rubí se comporta como una ranura de diamante.',
	...
	'You may increase your storage space by upgrading your offices and by buying more %1. You also get %2 extra storage space per %3 level (currently: <b>+%4</b>).':
		'Puedes aumentar tu espacio de almacenamiento mejorando tus oficinas y comprando más %1. También recibes 2% de espacio extra por nivel de %3 (ahora: <b>+%4</b>).',
	'The average worth of this stock and how high it can peak depends on the building it is tied to, along with the level of your %1.':
		'El valor medio de esta acción y lo alto que puede subir dependiendo del edificio al que está asociada y del nivel de tu %1.',
	'%1 the hide button to toggle all other stocks.':
		'%1 el botón para ocultar para cambiar el resto de acciones.',
	'stock:': 'acción:',
	...
	'You cannot buy and sell this stock in the same tick.':
		'No puedes comprar ni vender esta acción en el mismo tic.',
	...
	'It is fully upgraded. Its lavish interiors, spanning across innumerable floors, are host to many a decadent party, owing to your nigh-unfathomable wealth.':
		'Está completamente actualizada. Su lujoso interior, que se extiende a lo largo de innumerables pisos, alberga muchas fiestas suntuosas, debido a tu riqueza casi inconmensurable.',
	...
	'+%1% base warehouse space for all goods':
		'+%1% espacio(s) básico(s) en el almacén para todos los productos',
	'Brokers:': 'Brókers:',
	...
	'Buying goods normally incurs overhead costs of <b>%1% extra</b>. Each broker you hire reduces that cost by <b>%2%</b>.':
		'Comprar productos suele tener un coste general de un <b>%1 % extra</b>. Cada bróker que contrates reducirá ese coste un <b>%2 %</b>.',
	'Current overhead costs thanks to your brokers: <b>+%1%</b>':
		'Costes actuales gracias a tus brókers: <b>+%1 %</b>',
	"Buying a broker costs %1 of CpS (that's $%2).":
		'Comprar un bróker tiene un coste de %1 g/s (eso es $%2).',
	"Maximum number of brokers you can own: %1 (the highest amount of grandmas you've owned this run, divided by 10, plus your grandma level)":
		'Número máximo de brókers que puedes tener: %1 (la mayor cantidad de abuelas que has tenido en esta partida dividida entre 10 sumada al nivel de tu abuela)',
	'Brokers are Wall Street-class grandmas versed in the ways of finance. Stockbroker grandmas work hard and play hard, and will fight telephone in hand to get your clients the best possible deals - with a sizeable profit margin for you, of course.':
		'Los brókeres son abuelas versadas en finanzas dignas de Wall Street. Las abuelas corredoras de bolsa trabajan duro y no se andan con chiquitas, lucharán teléfono en mano por conseguir a tus clientes las mejores ofertas, con un buen margen de beneficio para ti, claro.',
	...
	'Click to refill your opportunity timer (and give a quick burst to your economy) for %1.':
		'Haz clic para recargar tu temporizador de oportunidades (y dale un empujón rápido a tu economía) durante %1.',
	'Profits: %1. All prices are in $econds of your highest raw cookies per second.':
		'Beneficios: %1. Todos los precios están en segundos de tu tasa más alta de galletas crudas por segundo.',
	...
	'[Upgrade name 41]White chocolate macadamia nut cookies':
		'Galletas de nuez de macadamia y chocolate blanco',
	...
	'[Upgrade name 96]Round chocolate british tea biscuits':
		'Galletas de té británicas de chocolate redondas',
	'[Upgrade name 97]Round british tea biscuits with heart motif':
		'Galletas de té británicas redondas con un corazón',
	'[Upgrade name 98]Round chocolate british tea biscuits with heart motif':
		'Galletas de té británicas redondas de chocolate con un corazón',
	...
	'[Upgrade name 233]Scissor-resistant credit cards':
		'Tarjetas de crédito resistentes a las tijeras',
	...
	'[Upgrade name 318]Some other super-tiny fundamental particle? Probably?':
		'¿Alguna otra partícula fundamental superdiminuta?  ¿Probablemente?',
	...
	'[Upgrade name 442]Kitten assistants to the regional manager':
		'Asistentes gatitos del director regional',
	...
	'[Upgrade name 477]Synthetic chocolate green honey butter biscuit':
		'Galleta danesa de miel verde y chocolate sintético',
	'[Upgrade name 478]Royal raspberry chocolate butter biscuit':
		'Galleta danesa de chocolate y frambuesa real',
	'[Upgrade name 479]Ultra-concentrated high-energy chocolate butter biscuit':
		'Galleta danesa de chocolate de alta energía ultraconcentrada',
	...
	'[Upgrade name 497]Pure pitch-black chocolate butter biscuit':
		'Galleta danesa de chocolate negro 100% puro',
	...
	'[Upgrade name 553]A chocolate chip cookie but with the chips picked off for some reason':
		'Una galleta con pepitas de chocolate, pero con las pepitas arrancadas por alguna razón',
	...
	'[Upgrade name 718]Milkhelp&reg; lactose intolerance relief tablets':
		'Pastillas para la intolerancia a la lactosa Milkhelp®',
	...
	'[Achievement name 70]Cheated cookies taste awful':
		'Las galletas haciendo trampas saben horribles',
	...
	'[Achievement name 196]Too many rabbits, not enough hats':
		'Demasiados conejos, no hay suficientes sombreros',
	...
	'[Achievement name 225]He who controls the cookies controls the universe':
		'El que controla las galletas controla el universo',
	...
	"[Achievement name 228]We're gonna need a bigger bakery":
		'Vamos a necesitar una confitería más grande',
	...
	'[Achievement name 230]Brought to you by the letter <div style="display:inline-block;background:url(img/money.png);width:16px;height:16px;"></div>':
		'Hoy toca esta letra <div style="display:inline-block;background:url(img/money.png);width:16px;height:16px;"></div>',
	...
	"[Achievement name 255]And now for my next trick, I'll need a volunteer from the audience":
		'Y ahora, para mi próximo truco, necesitaré un voluntario del público.',
	...
	'[Achievement name 259]cookie clicker forever and forever a hundred years cookie clicker, all day long forever, forever a hundred times, over and over cookie clicker adventures dot com':
		'cookie clicker para siempre cien años de cookie clicker, todo el día para siempre, para siempre cien veces, una y otra vez, aventuras cookie clicker punto com',
	'[Achievement name 260]Scientists baffled everywhere':
		'Científicos desconcertados por todas partes',
	...
	"[Achievement name 275]Well the cookies start coming and they don't stop coming":
		'Bueno, las galletas no dejan de llegar',
	"[Achievement name 276]I don't know if you've noticed but all these icons are very slightly off-center":
		'No sé si te habrás dado cuenta, pero todos estos iconos están ligeramente descentrados',
	'[Achievement name 277]The proof of the cookie is in the baking':
		'La prueba de una buena galleta está en la cocción',
	...
	"[Achievement name 279]The dreams in which I'm baking are the best I've ever had":
		'Los sueños en los que estoy horneando son los mejores que he tenido',
	...
	'[Achievement name 301]Neither snow nor rain nor heat nor gloom of night':
		'Ni nieve ni lluvia ni calor ni penumbra de la noche',
	...
	'[Achievement name 349]What happens in the vortex stays in the vortex':
		'Lo que pasa en el vórtice se queda en el vórtice',
	...
	'[Achievement name 353]Maybe a chance in hell, actually':
		'Tal vez una oportunidad en el infierno, más bien',
	...
	"[Achievement name 357]Save your breath because that's all you've got left":
		'Ahorra tu aliento porque es lo único que te queda',
	...
	"[Achievement name 361]Don't get used to yourself, you're gonna have to change":
		'No te acostumbres, vas a tener que cambiar',
	...
	'[Achievement name 376]All the other kids with the pumped up clicks':
		'Todos los otros niños con sus clics',
	...
	'[Achievement name 421]For more information on this achievement, please refer to its title':
		'Para obtener más información sobre este logro, consulta su título',
	...
	"[Achievement name 429]I think it's safe to say you've got it made":
		'Creo que es seguro decir que lo has logrado',
	...
	"[Achievement name 442]Dude what if we're all living in a simulation like what if we're all just code on a computer somewhere":
		'Tío, ¿y si todos viviéramos en una simulación, como si solo fuéramos código en un ordenador en algún lugar?',
	...
	"[Achievement name 450]Haven't even begun to peak":
		'Ni siquiera ha comenzado a alcanzar su apogeo',
	...
	'[Achievement name 495]Mountain out of a molehill, but like in a good way':
		'Una montaña de un grano de arena, pero en el buen sentido',
	...
	'[Achievement name 506]Flip a cookie. Chips, I win. Crust, you lose.':
		'Lanza una galleta al aire. Si sale pepitas, yo gano. Si sale corteza, tú pierdes.',
	...
	'[Achievement name 515]Nobody exists on purpose, nobody belongs anywhere':
		'Nadie existe a propósito, nadie pertenece a ningún lado',
	...
	'[Achievement name 521]Reject reality, substitute your own':
		'Rechaza la realidad, sustituye la tuya',
	...
	'[Achievement name 544]A trademarked portmanteau of "imagination" and "engineering"':
		'Un acrónimo registrado de "imaginación" e "ingeniería"',
	...
	'[Achievement name 586]What do you get for the baker who has everything':
		'¿Qué tienes para el panadero que lo tiene todo?',
