AddLanguage('RU', 'russian', {
	...
	'%1 cookie': ['%1 печенье', 'печенья: %1'],
	'%1 sugar lump': ['%1 кусочек сахара', 'кусочков сахара: %1'],
	'%1 heavenly chip': ['%1 небесная крошка', 'небесных крошек: %1'],
	'%1 golden cookie': ['%1 золотое печенье', 'золотого печенья: %1'],
	'%1 building': ['%1 строение', 'строений: %1'],
	'%1 upgrade': ['%1 улучшение', 'улучшений: %1'],
	Yes: 'Да',
	No: 'Нет',
	...
	'visual improvements; disabling may improve performance':
		'визуальные улучшения; отключение может повысить производительность',
	Particles: 'Частицы',
	Numbers: 'Числа',
	'numbers that pop up when clicking the cookie':
		'числа, которые появляются при нажатии на печенье',
	'Milk [setting]': 'Молоко',
	...
	'display boxes around upgrades and achievements in Stats':
		'отображать рамки вокруг улучшений и достижений в статистике',
	'Alt font': 'Альтернативный шрифт',
	'your cookies are displayed using a monospace font':
		'печенье отображается с моноширинным шрифтом',
	...
	'the game will ask you to confirm when you close the window':
		'при закрытии окна игры отображается запрос подтверждения',
	Defocus: 'Расфокусировать',
	'the game will be less resource-intensive when out of focus':
		'игра будет менее ресурсоемкой, если изображение будет нечетким',
	...
	'the game will ask you to confirm before spending sugar lumps':
		'прежде чем тратить кусочки сахара, игра отобразит запрос подтверждения',
	'Custom grandmas': 'Пользовательские бабули',
	'some grandmas will be named after Patreon supporters':
		'некоторые бабули будут названы в честь спонсоров на Patreon',
	...
	"on slower computers, the game will put itself in sleep mode when it's inactive and starts to lag out; offline CpS production kicks in during sleep mode":
		'на более медленных компьютерах игра переходит в спящий режим, когда она неактивна, и начинает притормаживать; при этом запускается производство печ/с в автономном режиме',
	'Music in background': 'Фоновая музыка',
	"music will keep playing even when the game window isn't focused":
		'Музыка будет играть, даже если окно с игрой неактивно',
	'Cloud saving': 'Сохранение в облако',
	'allow use of Steam Cloud for save backups':
		'позволяет использовать Steam Cloud для сохранения резервных копий',
	...
	'allows optimizations for screen readers; game will reload':
		'позволяет оптимизировать средства для чтения с экрана; игра будет перезапущена',
	'Discord status': 'Статус в Discord',
	'if Discord is on, show your game info as activity status':
		'Если Discord включен, покажите сведения о своей игре в качестве статуса активности',
	Language: 'Язык',
	'Language: %1': 'Язык: %1',
	'Change language': 'Сменить язык',
	'note: this will save and reload your game':
		'Внимание: при этом игра сохранится и перезагрузится.',
	...
	'These are feats that are either unfair or difficult to attain. They do not give milk.':
		'Это цели, которые либо неправильны, либо труднодостижимы. Они не приносят молока.',
	...
	'with %1 ascension': ['за %1 восхождение', 'за %1 восхождений'],
	...
	'Milk is gained with each achievement. It can unlock unique upgrades over time.':
		'Молоко дается за каждое достижение. Со временем оно может разблокировать уникальные улучшения.',
	'Rank %1': 'Ранг %1',
	...
	'Cookie Clicker is a javascript game by %1 and %2.':
		'Cookie Clicker — это игра, написанная на JavaScript %1 и %2.',
	...
	"This version of Cookie Clicker is 100% free, forever. Want to support us so we can keep developing games? Here's some ways you can help:%1":
		'Эта версия Cookie Clicker абсолютно бесплатна — навсегда. Хотите поддержать нас, чтобы мы могли продолжать разработку игр? Вот несколько способов, как вы можете нам помочь:%1',
	"Note: if you find a new bug after an update and you're using a 3rd-party add-on, make sure it's not just your add-on causing it!":
		'Примечание. Если вы обнаружили новую ошибку после обновления и используете стороннее дополнение, сначала убедитесь, что причина не в этом дополнении!',
	'Warning: clearing your browser cache or cookies <small>(what else?)</small> will result in your save being wiped. Export your save and back it up first!':
		'Предупреждение! Очистка кэша браузера или файлов cookie <small>(чего же еще?)</small> приведет к удалению сохраненных данных. Сначала экспортируйте свои сохраненные данные и сделайте резервную копию!',
	...
	'Note: older update notes are in English.':
		'Внимание: описания прошлых обновлений на английском.',
	'This feature is not yet available in your language.':
		'Данная функция пока недоступна на вашем языке.',
	...
	'Cookie Clicker is in sleep mode and generating offline cookies.':
		'Cookie Clicker находится в спящем режиме и производит печенье оффлайн.',
	...
	'(this happens when too many frames are skipped at once,<br>usually when the game has been running in the background for a while)<br>(you can turn this feature off in the settings menu)':
		'(это происходит, когда сразу пропускается слишком много кадров.<br>Обычно такое бывает, когда игра какое-то время работала в фоновом режиме.)<br>(Эту функцию можно отключить в меню настроек.)',
	'Are you sure you want to close Cookie Clicker?':
		'Вы действительно хотите закрыть Cookie Clicker?',
	...
	'Hello again! Just a reminder that you may want to back up your Cookie Clicker save every once in a while, just in case.<br>To do so, go to Options and hit "Export save" or "Save to file"!':
		'Привет еще раз! Напоминаем, что вы можете иногда делать резервную копию сохраненных данных Cookie Clicker — на всякий случай.<br>Для этого перейдите в меню параметров и нажмите «Экспорт сохраненных данных» или «Сохранить в файл»!',
	'Save manually (the game autosaves every 60 seconds; shortcut: ctrl+S)':
		'Сохранять вручную (игра автоматически сохраняется каждые 60 секунд; сочетание клавиш: Ctrl+S)',
	'You can use this to backup your save or to transfer it to another computer (shortcut for import: ctrl+O)':
		'Эта функция используется для резервного копирования сохраненных данных или для их переноса на другой компьютер (сочетание клавиш для импорта: Ctrl+O)',
	'Save to file': 'Сохранить в файл',
	'Load from file': 'Загрузить из файла',
	'Use this to keep backups on your computer':
		'Эта функция используется для хранения резервных копий на компьютере',
	'Export save': 'Экспорт сохраненных данных',
	'This is your save code.<br>Copy it and keep it somewhere safe!':
		'Это ваш код сохранения.<br>Скопируйте его и храните в надежном месте!',
	'Import save': 'Импорт сохраненных данных',
	'Please paste in the code that was given to you on save export.':
		'Введите код, полученный при экспорте сохраненных данных.',
	...
	'Oops, looks like the import string is all wrong!':
		'Ой! Похоже, указана неправильна строка импорта!',
	'You are attempting to load a save from a future version (v. %1; you are using v. %2).':
		'Вы пытаетесь загрузить сохраненные данные из более новой версии (версия %1; а вы используете версию % 2).',
	"Sorry, you can't import saves from the classic version.":
		'К сожалению, невозможно импортировать сохраненные данные из классической версии.',
	'Wipe save': 'Удалить сохраненные данные',
	'Delete all your progress, including your achievements':
		'Вы удалите весь свой прогресс, включая достижения',
	'Do you REALLY want to wipe your save?<br><small>You will lose your progress, your achievements, and your heavenly chips!</small>':
		'Вы ДЕЙСТВИТЕЛЬНО хотите удалить сохраненные данные?<br><small>Вы потеряете свой прогресс, достижения и небесные крошки!</small>',
	"Whoah now, are you really, <b><i>REALLY</i></b> sure you want to go through with this?<br><small>Don't say we didn't warn you!</small>":
		'Эй! Вы действительно, <b><i>ДЕЙСТВИТЕЛЬНО</i></b> уверены, что хотите сделать это?<br><small>Потом не говорите, что мы вас не предупреждали!</small>',
	...
	'Only use mods from trusted sources. Some mods may require a game restart to take effect.':
		'Устанавливайте моды лишь из проверенных источников. Для корректной работы некоторых модов нужно перезапустить игру.',
	Enable: 'Включить',
	Disable: 'Отключить',
	...
	'This tool allows you to upload new mods to the Steam Workshop.<br>You need to select a mod folder containing a properly-formatted %1 file.<br>See the included sample mods for examples.':
		'Инструмент позволяет загружать новые моды в Steam Workshop.<br>Выберите папку модов с %1-файлом подходящего формата.<br>Смотрите включенные примеры модов.',
	...
	'These are the mods present in your save data. You may delete some of this data to make your save file smaller.':
		'Это моды, имеющиеся в ваших сохраненных данных. Можно удалить часть этих данных, чтобы уменьшить размер сохраненного файла.',
	'(loaded)': '(загружено)',
	'%1 char': ['%1 символ', 'символов: %1'],
	'Check mod data': 'Проверить данные мода',
	'view and delete save data created by mods':
		'просмотреть и удалить сохраненные данные, созданные модами',
	...
	'You are currently playing Cookie Clicker on the <b>%1</b> protocol.<br>The <b>%2</b> version uses a different save slot than this one.<br>Click this lock to reload the page and switch to the <b>%2</b> version!':
		'В настоящее время Cookie Clicker используется по протоколу <b>%1</b>.<br>Версия <b>%2</b> использует другой слот сохранений.<br>Щелкните этот замок, чтобы перезагрузить страницу и установить версию <b>%2</b>!',
	'+%1 more notification.': ['еще +%1 уведомление.', 'еще уведомлений: +%1.'],
	Christmas: 'Рождество',
	...
	"Because you've baked a <b>billion cookies</b> in total, you are now attracting <b>sugar lumps</b>. They coalesce quietly near the top of your screen, under the Stats button.<br>You will be able to harvest them when they're ripe, after which you may spend them on all sorts of things!":
		'Поскольку вы испекли в общей сложности <b>миллиард печенек</b>, вы получаете <b>кусочки сахара</b>. Они незаметно растут в верхней части экрана под кнопкой статистики.<br>Когда они созреют, их можно собрать, а затем потратить на что угодно!',
	'A <b>sugar lump</b> is coalescing here, attracted by your accomplishments.':
		'Здесь зреет <b>кусочек сахара</b>, полученный за ваши достижения.',
	'Your sugar lumps mature after <b>%1</b>,<br>ripen after <b>%2</b>,<br>and fall after <b>%3</b>.':
		'Кусочки сахара растут <b>%1</b>,<br>созревают <b>%2</b>,<br>а через <b>%3</b> они падают.',
	...
	"This sugar lump is mature and will be ripe in <b>%1</b>.<br>You may <b>click it to harvest it now</b>, but there is a <b>50% chance you won't get anything</b>.":
		'Этот кусочек сахара уже вырос и созреет через <b>%1</b>.<br>Можно <b>щелкнуть кусочек, чтобы собрать его сейчас</b>, но есть вероятность <b>50%, что вы ничего не получите</b>.',
	'<b>This sugar lump is ripe! Click it to harvest it.</b><br>If you do nothing, it will auto-harvest in <b>%1</b>.':
		'<b>Этот кусочек сахара созрел! Щелкните по нему, чтобы собрать.</b><br>Если ничего не делать, то через <b>%1</b> он будет собран автоматически.',
	'This sugar lump grew to be <b>bifurcated</b>; harvesting it has a 50% chance of yielding two lumps.':
		'Этот кусочек сахара вырос <b>двойным</b>; при сборе существует вероятность 50%, что вы получите два кусочка.',
	'This sugar lump grew to be <b>golden</b>; harvesting it will yield 2 to 7 lumps, your current cookies will be doubled (capped to a gain of 24 hours of your CpS), and you will find 10% more golden cookies for the next 24 hours.':
		'Этот кусочек сахара вырос <b>золотым</b>; при сборе вы получите от 2 до 7 кусочков, текущее количество печенья будет удвоено (печ/с вырастет на 24 часа), и вы найдете на 10% больше золотых печенек в течение следующих 24 часов.',
	'This sugar lump was affected by the elders and grew to be <b>meaty</b>; harvesting it will yield between 0 and 2 lumps.':
		'Этот кусочек сахара подвергся влиянию старушек и стал <b>мясным</b>; при сборе вы получите от 0 до 2 кусочков.',
	'This sugar lump is <b>caramelized</b>, its stickiness binding it to unexpected things; harvesting it will yield between 1 and 3 lumps and will refill your sugar lump cooldowns.':
		'Этот кусочек сахара <b>карамельный</b>, он может прилипать к неожиданным вещам; при сборе вы получите от 1 до 3 кусочков, кроме того будут сброшены кулдауны для сахарков.',
	...
	'Your cookies have been doubled.<br>+10% golden cookies for the next 24 hours.':
		'Количество печенья удвоено.<br>На 10% больше золотых печенек в течение следующих 24 часов.',
	...
	Heralds: 'Вестники',
	'%1 herald': ['%1 вестник', 'вестников: %1'],
	"Heralds couldn't be loaded. There may be an issue with our servers, or you are playing the game locally.":
		'Невозможно загрузить вестников. Возможно, проблема связана с нашими серверами, или вы играете без подключения к Интернету.',
	'There are no heralds at the moment. Please consider <b>donating to our Patreon</b>!':
		'В данный момент вестников нет. Вы можете <b>оказать нам финансовую поддержку на Patreon</b>!',
	'selflessly inspiring a boost in production for everyone, resulting in %1.':
		'самозабвенно вдохновляя всех на ускорение, они повышают производительность на %1.',
	'+%1% cookies per second': '+%1% печенья в секунду',
	'You are in a <b>Born again</b> run, and are not currently benefiting from heralds.':
		'Вы участвуете в испытании <b>Новое рождение</b> и в настоящее время вестники для вас недоступны.',
	'You own the <b>Heralds</b> upgrade, and therefore benefit from the production boost.':
		'У вас есть улучшение <b>Вестник </b>, поэтому ваша производительность увеличится.',
	'To benefit from the herald bonus, you need a special upgrade you do not yet own. You will permanently unlock it later in the game.':
		'Чтобы воспользоваться бонусом вестника, вам нужно специальное улучшение, которого у вас еще нет. Вы навсегда разблокируете его позже в игре.',
	'<b>Heralds</b> are people who have donated to our highest Patreon tier, and are limited to 100.<br>Each herald gives everyone +1% CpS.<br>Heralds benefit everyone playing the game, regardless of whether you donated.':
		'<b>Вестники</b> — это люди, которые сделали пожертвования на Patreon на самом высоком уровне. Их количество ограничено 100 человек.<br>Каждый вестник дает каждому игроку +1% к печ/с.<br>Вестники дают преимущество всем игрокам, независимо от того, сделали ли они пожертвование.',
	'Every %1 current players on Steam generates <b>1 herald</b>, up to %2 heralds.<br>Each herald gives everyone +1% CpS.':
		'Каждый %1-й из текущих игроков в Steam производит <b>1 вестника</b>, но не более %2.<br>Каждый вестник дает всем +1% ПвС.',
	'+%1!': '/',
	...
	'Sweet!<br><small>Found 1 sugar lump!</small>':
		'Сладко!<br><small>Найден 1 кусочек сахара!</small>',
	'Lucky!': 'Повезло!',
	'Ruin!': 'Разорение!',
	...
	'Cookie chain broken.<br><small>You made %1.</small>':
		'Цепочка печенья оборвалась.<br><small>Вы испекли %1.</small>',
	'Cookie blab': [
	...
	'Lets you use two dragon auras simultaneously':
		'Позволяет использовать две ауры дракона одновременно',
	...
	'<b>One tenth</b> of every other dragon aura, <b>combined</b>.':
		'<b>Одна десятая</b> от каждой другой ауры дракона, <b>комбинированный</b>.',
	'Switching your aura is <b>free</b> because you own no buildings.':
		'Переключение ауры <b>бесплатно</b>, потому что у вас нет строений.',
	'The cost of switching your aura is <b>%1</b>.<br>This will affect your CpS!':
		'Переключение ауры стоит: <b>%1</b>.<br>Это повлияет на печ/с.',
	...
	'Your first batch goes to the trash. The neighborhood raccoon barely touches it.':
		'Ваша первая партия отправляется на помойку. Ее попробуют только местные еноты.',
	'Your family accepts to try some of your cookies.':
		'Ваша семья соглашается попробовать ваше печенье.',
	'Your cookies are popular in the neighborhood.':
		'Ваше печенье становится популярным в вашем районе.',
	...
	'Your cookies are talked about for miles around.':
		'О вашем печенье известно на несколько миль вокруг.',
	...
	'Your cookies bring all the boys to the yard.':
		'Ваше печенье расхватывают все мальчишки во дворе.',
	...
	'Strange creatures from neighboring planets wish to try your cookies.':
		'Неизвестные существа с соседних планет хотят попробовать ваше печенье.',
	'Elder gods from the whole cosmos have awoken to taste your cookies.':
		'Древние боги со всего космоса пробудились, чтобы отведать ваше печенье.',
	'Beings from other dimensions lapse into existence just to get a taste of your cookies.':
		'Существа из других измерений появляются только для того, чтобы отведать ваше печенье.',
	...
	'The universe has now turned into cookie dough, to the molecular level.':
		'Вселенная превратилась в тесто для печенья на молекулярном уровне.',
	'Your cookies are rewriting the fundamental laws of the universe.':
		'Ваши печеньки переписали фундаментальные законы Вселенной.',
	'A local news station runs a 10-minute segment about your cookies. Success!<br><small>(you win a cookie)</small>':
		'Местный новостной канал запустил в эфир 10-минутный сюжет о вашем печенье. Это успех!<br><small>(вы выиграли печеньку)</small>',
	...
	'You gain <b>one hour</b> of your CpS (capped at double your bank).':
		'Вы увеличиваете скорость печ/с на <b>один час</b> (удвоенный банк).',
	...
	'Your prestige level is currently <b>%1</b>.<br>(CpS +%2%)':
		'В настоящее время ваш уровень престижа составляет <b>%1</b>.<br>(+%2% печ/с)',
	'Ascending now would grant you no prestige.':
		'Если начать восхождение сейчас, вы не получите престижа.',
	'Ascending now would grant you<br><b>1 prestige level</b> (+1% CpS)<br>and <b>1 heavenly chip</b> to spend.':
		'Если начать восхождение сейчас, вы получите<br><b>1 уровень престижа</b> (+1% печ/с)<br>и <b>1 небесную крошка</b>, которую можно потратить.',
	...
	'You need <b>%1 more cookies</b> for the next level.':
		'Для перехода на следующий уровень вам нужно еще <b>%1 печенья</b>.',
	'Do you REALLY want to ascend?<div class="line"></div>You will lose your progress and start over from scratch.<div class="line"></div>All your cookies will be converted into prestige and heavenly chips.':
		'Вы ДЕЙСТВИТЕЛЬНО хотите совершить восхождение?<div class="line"></div>Вы потеряете свой прогресс и начнете все заново.<div class="line"></div>Все ваше печенье будет переведено в престиж и небесные крошки.',
	...
	'You will keep your achievements, building levels and sugar lumps.':
		'Вы сохраните свои достижения, уровни строений и кусочки сахара.',
	...
	'%1 prestige level': ['Уровень престижа: %1', 'Уровни престижа: %1'],
	...
	"You are ascending.<br>Drag the screen around<br>or use arrow keys!<br>When you're ready,<br>click Reincarnate.":
		'Вы совершаете восхождение.<br>Перетащите экран<br>или используйте клавиши со стрелками!<br>Когда будете готовы,<br>нажмите «Перевоплотиться».',
	'Each prestige level grants you a permanent <b>+%1% CpS</b>.<br>The more levels you have, the more cookies they require.':
		'Каждый уровень престижа дает вам постоянное увеличение <b>печ/с на %1%</b>.<br>Чем больше у вас уровней, тем больше нужно печенья.',
	'Heavenly chips are used to buy heavenly upgrades.<br>You gain <b>1 chip</b> every time you gain a prestige level.':
		'небесные крошки используются для покупки небесных улучшений.<br>При каждом повышении уровня престижа вы получаете <b>1 крошка</b>.',
	"Click this once you've bought<br>everything you need!":
		'Нажмите здесь, когда купите<br>все необходимое!',
	...
	'Challenge modes apply special modifiers to your next ascension.<br>Click to change.':
		'В режимах испытаний к вашему следующему восхождению применяются специальные модификаторы.<br>Щелкните, чтобы изменить.',
	...
	'This run will behave as if you\'d just started the game from scratch. Prestige levels and heavenly upgrades will have no effect, as will sugar lumps and building levels. Perma-upgrades and minigames will be unavailable.<div class="line"></div>Some achievements are only available in this mode.':
		'В этом режиме все будет так, как будто вы только что начали игру с нуля. Уровни престижа и небесные улучшения не будут действовать, как и кусочки сахара, и уровни строений. Постоянные улучшения и мини-игры будут недоступны.<div class="line"></div>Некоторые достижения доступны только в этом режиме.',
	'Your bingo center/research facility is conducting experiments.':
		'Ваш бинго-центр / исследовательская лаборатория проводит эксперименты.',
	...
	"It's <b>Valentine's season</b>!<br>Love's in the air and cookies are just that much sweeter!":
		'Наступает <b>сезон Святого Валентина</b>!<br>В воздухе витает любовь, и печенье стало намного слаще!',
	'Business Day!': 'Бизнес-день!',
	"It's <b>Business season</b>!<br>Don't panic! Things are gonna be looking a little more corporate for a few days.":
		'Наступает <b>сезон бизнес-дней</b>!<br>Без паники! В ближайшие несколько дней будет больше корпоративных дел.',
	'Halloween!': 'Хэллоуин!',
	"It's <b>Halloween season</b>!<br>Everything is just a little bit spookier!":
		'Наступает <b>сезон Хэллоуина</b>!<br>Все становится немного страшнее!',
	...
	"It's <b>Christmas season</b>!<br>Bring good cheer to all and you just may get cookies in your stockings!":
		'Наступает <b>сезон Рождества</b>!<br>Говорите всем хорошие пожелания и вы найдете печенье в праздничных носках!',
	'Easter!': 'Пасха!',
	"It's <b>Easter season</b>!<br>Keep an eye out and you just might click a rabbit or two!":
		'Наступает <b>сезон Пасхи</b>!<br>Смотрите в оба и сможете кликнуть по парочке кроликов!',
	...
	'Upgrade is vaulted and will not be auto-purchased.':
		'Улучшение помещается в хранилище и не приобретается автоматически.',
	...
	'Will <b>instantly purchase</b> every upgrade you can afford, starting from the cheapest one.<br>Upgrades in the <b>vault</b> will not be auto-purchased.<br>You may place an upgrade into the vault by <b>Shift-clicking</b> on it.':
		'Позволяет <b>мгновенно покупать</b> все доступные улучшения, начиная с самого дешевого.<br>Улучшения, помещенные в <b>хранилище</b>, не приобретаются автоматически.<br>Чтобы поместить улучшение в хранилище, <b>щелкните его, удерживая клавишу Shift</b>.',
	...
	'all combined, these boosts account for <b>%1</b> per second (<b>%2%</b> of total CpS)':
		'все вместе увеличивает на <b>%1</b> в секунду (<b>%2%</b> от общего значения печ/с)',
	...
	'Levelling up this building unlocks a minigame.':
		'Повышение уровня этого строения открывает мини-игру.',
	...
	'Names in white were submitted by our supporters on Patreon.':
		'Имена, выделенные белым цветом, предоставлены нашими спонсорами на Patreon.',
	'You can also press %1 to bulk-buy or sell %2 of a building at a time, or %3 for %4.':
		'Или нажмите %1, чтобы купить или продать %2 строений за раз, или %3 для %4.',
	Investment: 'Инвестиции',
	"You're not sure what this does, you just know it means profit.":
		'Вы точно не знаете, как это работает, вы просто знаете, что это приносит прибыль.',
	Cursor: 'Курсор',
	cursor: 'курсор',
	cursors: 'курсоры',
	'%1 cursor': ['%1 курсор', 'курсоров: %1'],
	...
	'[Cursor business quote]Essential in flattening dough. The first step in cookie-making.':
		'Необходима для раскатывания теста. Первый шаг в приготовлении печенья.',
	Grandma: 'Бабуля',
	grandma: 'бабуля',
	grandmas: 'бабули',
	'%1 grandma': ['%1 бабуля', 'бабуль: %1'],
	...
	'[Grandma business quote]A crucial element of baking cookies.':
		'Важнейший элемент для выпечки печенья.',
	Farm: 'Ферма',
	farm: 'ферма',
	farms: 'фермы',
	'%1 farm': ['%1 ферма', 'ферм: %1'],
	'[Farm quote]Grows cookie plants from cookie seeds.':
		'Выращивает печеньковые растения из печеньковых семян.',
	'[Farm business name]Kitchen': 'Кухня',
	'[Farm business quote]The more kitchens, the more cookies your employees can produce.':
		'Чем больше кухонь, тем больше печенья могут производить ваши сотрудники.',
	Mine: 'Шахта',
	mine: 'шахта',
	mines: 'шахты',
	'%1 mine': ['%1 шахта', 'Шахт: %1'],
	'[Mine quote]Mines out cookie dough and chocolate chips.':
		'Добывает тесто для печенья и шоколадную крошку.',
	...
	'[Mine business quote]These give you the edge you need to outsell those pesky competitors.':
		'Дает вам необходимое преимущество, чтобы обойти этих надоедливых конкурентов.',
	Factory: 'Фабрика',
	factory: 'фабрика',
	factories: 'фабрики',
	'%1 factory': ['%1 фабрика', 'Фабрик: %1'],
	...
	'[Factory business quote]Mass production is the future of baking. Seize the day, and synergize!':
		'Массовое производство — это будущее выпечки. Используйте день максимально продуктивно!',
	Bank: 'Банк',
	bank: 'банк',
	banks: 'банки',
	'%1 bank': ['%1 банк', 'Банков: %1'],
	...
	"[Bank business quote]Business folks with a nose for profit, ready to finance your venture as long as there's money to be made.":
		'Деловые люди, жаждущие прибыли и готовые финансировать ваше предприятие, пока есть деньги.',
	Temple: 'Храм',
	temple: 'храм',
	temples: 'храмы',
	'%1 temple': ['%1 храм', 'Храмов: %1'],
	...
	'[Temple business quote]Your social media page is going viral! Amassing likes is the key to a lasting online presence and juicy advertising deals.':
		'Ваша страница в социальных сетях стремительно набирает популярность! Накопление лайков — ключ к длительному присутствию в Интернете и выгодным рекламным сделкам.',
	'Wizard tower': 'Башня мага',
	'wizard tower': 'башня мага',
	'wizard towers': 'башни магов',
	'%1 wizard tower': ['%1 башня мага', 'Башен магов: %1'],
	'[Wizard tower quote]Summons cookies with magic spells.':
		'Призывает печенье с помощью магических заклинаний.',
	...
	'[Wizard tower business quote]Cookie memes are all the rage! With just the right amount of social media astroturfing, your brand image will be all over the cyberspace.':
		'Мемы с печеньем всегда популярны! С правильным количеством астротурфинга в социальных сетях ваш бренд заполнит все киберпространство.',
	Shipment: 'Доставка',
	shipment: 'доставка',
	shipments: 'доставки',
	'%1 shipment': ['%1 доставка', 'доставок: %1'],
	'[Shipment quote]Brings in fresh cookies from the cookie planet.':
		'Доставляет свежее печенье с планеты печенья.',
	...
	'[Shipment business quote]A gigantic cookie emporium - your very own retail chain.':
		'Гигантский магазин печенья — ваша собственная розничная сеть.',
	'Alchemy lab': 'Алхимическая лаборатория',
	'alchemy lab': 'алхимическая лаборатория',
	'alchemy labs': 'алхимические лаборатории',
	'%1 alchemy lab': ['%1 алхимическая лаборатория', 'Алхимических лабораторий: %1'],
	...
	"[Alchemy lab business quote]You're officially on the stock market, and everyone wants a piece!":
		'Вы официально вышли на фондовую биржу, и все хотят свою долю!',
	Portal: 'Портал',
	portal: 'портал',
	portals: 'порталы',
	'%1 portal': ['%1 портал', 'порталов: %1'],
	...
	'[Portal business quote]Your cookies have their own sitcom! Hilarious baking hijinks set to the cheesiest laughtrack.':
		'Теперь у вашего печенья есть собственный ситком! Смешные шутки о выпечке под дурацкий смех.',
	'Time machine': 'Машина времени',
	'time machine': 'машина времени',
	'time machines': 'машины времени',
	'%1 time machine': ['%1 машина времени', 'машин времени: %1'],
	'[Time machine quote]Brings cookies from the past, before they were even eaten.':
		'Доставляет печенье из прошлого — еще до того, как его съели.',
	...
	'[Time machine business quote]Cookie theme parks, full of mascots and roller-coasters. Build one, build a hundred!':
		'Тематические парки отдыха, полные разных персонажей и аттракционов. Постройте один, постройте сотню!',
	'Antimatter condenser': 'Конденсатор антиматерии',
	'antimatter condenser': 'конденсатор антиматерии',
	'antimatter condensers': 'конденсаторы антиматерии',
	'%1 antimatter condenser': ['%1 конденсатор антиматерии', 'конденсаторов антиматерии: %1'],
	'[Antimatter condenser quote]Condenses the antimatter in the universe into cookies.':
		'Конденсирует антиматерию Вселенной в печенье.',
	...
	'[Antimatter condenser business quote]A virtual currency, already replacing regular money in some small countries.':
		'Виртуальная валюта, которая уже заменила обычные деньги в некоторых небольших странах.',
	Prism: 'Призма',
	prism: 'призма',
	prisms: 'призмы',
	'%1 prism': ['%1 призма', 'призм: %1'],
	...
	"[Prism business quote]You've made it to the top, and you can now buy entire nations to further your corporate greed. Godspeed.":
		'Вы достигли вершины, и теперь вы можете покупать целые страны, чтобы утолить свою корпоративную жадность. Удачи.',
	Chancemaker: 'Шансмейкер',
	chancemaker: 'шансмейкер',
	chancemakers: 'шансмейкеры',
	'%1 chancemaker': ['%1 шансмейкер', 'шансмейкеров: %1'],
	'[Chancemaker quote]Generates cookies out of thin air through sheer luck.':
		'Создает печенье из воздуха благодаря чистой удаче.',
	...
	"[Chancemaker business quote]Actually, you know what's cool? A whole planet dedicated to producing, advertising, selling, and consuming your cookies.":
		'Знаете, что по-настоящему круто? Целая планета посвящена производству, рекламе, продаже и потреблению вашего печенья.',
	'Fractal engine': 'Фрактальный двигатель',
	'fractal engine': 'фрактальный двигатель',
	'fractal engines': 'фрактальные двигатели',
	'%1 fractal engine': ['%1 фрактальный двигатель', 'фрактальных двигателей: %1'],
	...
	'[Fractal engine business quote]Only through political dominion can you truly alter this world to create a brighter, more cookie-friendly future.':
		'Только с помощью политической власти вы сможете по-настоящему изменить этот мир, чтобы создать более светлое будущее, в котором будет еще больше печенья.',
	'Javascript console': 'Консоль Javascript',
	'javascript console': 'консоль Javascript',
	'javascript consoles': 'консоли Javascript',
	'%1 javascript console': ['%1 консоль Javascript', 'Консолей Javascript: %1'],
	'[Javascript console quote]Creates cookies from the very code this game was written in.':
		'Создает печенье из того самого кода, на котором написана эта игра.',
	...
	'[Javascript console business quote]Taking many forms -religion, culture, philosophy- a doctrine may, when handled properly, cause a lasting impact on civilizations, reshaping minds and people and ensuring all future generations share a singular goal - the production, and acquisition, of more cookies.':
		'Доктрина может принимать множество форм — религия, культура, философия. При правильном использовании она может оказать долгосрочное влияние на цивилизации, изменить психологию и самих людей, а также сделать так, чтобы все будущие поколения стремились к одной единственной цели — увеличение производства и потребления печенья.',
	Idleverse: 'Пустая вселенная',
	idleverse: 'пустая вселенная',
	idleverses: 'пустые вселенные',
	'%1 idleverse': ['%1 пустая вселенная', 'пустых вселенных: %1'],
	"[Idleverse quote]There's been countless other idle universes running alongside our own. You've finally found a way to hijack their production and convert whatever they've been making into cookies!":
		'Кроме нашей существует еще бессчетное множество пустых вселенных. Вы наконец-то нашли способ украсть их продукцию и превратить все, что они сделали, в печенье!',
	...
	'[Idleverse business quote]Sometimes the best way to keep going up is sideways. Diversify your ventures through non-cookie investments.':
		'Иногда лучший способ продолжить развитие — это движение вбок. Диверсифицируйте свои предприятия за счет инвестиций без использования печенья.',
	'Cortex baker': 'Корковый пекарь',
	'cortex baker': 'корковый пекарь',
	'cortex bakers': 'корковые пекари',
	'%1 cortex baker': ['%1 корковый пекарь', 'корковые пекари (%1)'],
	'[Cortex baker quote]These artificial brains the size of planets are capable of simply dreaming up cookies into existence. Time and space are inconsequential. Reality is arbitrary.':
		'Этот искусственный мозг размером с планету способен воплощать мечты о печенье. Пространство и время не имеют значения. Реальность произвольна.',
	...
	"[Cortex baker business quote]There's only so many ways you can bring in more profit. Or is there? Hire the most brilliant experts in the known universe and let them scrape their brains for you!":
		'Существует не так много способов для увеличения прибыли. Но они все же есть? Наймите самых компетентных экспертов, и пусть они ломают головы за вас!',
	CpS: 'ПвС',
	...
	'All cookie production <b>multiplied by %1</b>.':
		'Скорость производства печенья <b>умножается на %1</b>.',
	'+%1 CpS': '+%1 печ/с',
	...
	'Tiered upgrades for <b>%1</b> provide an extra <b>+%2%</b> production.<br>Only works with unshackled upgrade tiers.':
		'<b>%1</b> — уровневые улучшения дают дополнительные <b>+%2%</b> к производству.<br>Действует только с уровнями освобожденных улучшений.',
	'Unshackles all <b>%1-tier upgrades</b>, making them more powerful.<br>Only applies to unshackled buildings.':
		'Освобождает все <b>улучшения %1 уровня</b>, усиливая их.<br>Применимо только к освобожденным зданиям.',
	'The mouse and cursors are <b>twice</b> as efficient.':
		'Мышь и курсоры становятся <b>в два раза</b> эффективнее.',
	'The mouse and cursors gain <b>+%1</b> cookies for each non-cursor building owned.':
		'Мышь и курсоры получают <b>+%1</b> печенек за каждое строение, не являющееся курсором.',
	'Grandmas gain <b>+%1% CpS</b> for each non-grandma building.':
		'Бабули получают <b>+%1% печ/с</b> за каждое строение, не являющееся бабулей.',
	'You gain <b>more CpS</b> the more milk you have.':
		'Чем больше у вас молока, тем <b>больше печ/с</b>.',
	...
	'Cookie production multiplier <b>+%1% permanently</b>.':
		'Ускоряет производство печенья на <b>+%1%</b> бессрочно.',
	"Cookie production multiplier <b>+%1% per Santa's levels.</b>":
		'Ускоряет производство печенья на <b>+%1% на уровнях Санты.</b>',
	'Cookie production multiplier <b>+%1%</b> for every year Cookie Clicker has existed (currently: <b>+%2%</b>).':
		'Ускоряет производство печенья на <b>+%1%</b> за каждый год существования Cookie Clicker (сейчас: <b>+%2%</b>).',
	'Cookie production multiplier <b>+%1%</b> for every building type level %2 or higher.':
		'Ускоряет производство печенья на <b>+%1%</b> для каждого типа строения уровня %2 или выше.',
	...
	'Grandma-operated science lab and leisure club.<br>Grandmas are <b>4 times</b> as efficient.<br><b>Regularly unlocks new upgrades</b>.':
		'Бабулина научная лаборатория и клуб досуга.<br>Бабули в <b>4 раза</b> эффективнее.<br><b>Регулярно открывает новые улучшения</b>.',
	'Each %1 gains <b>+%2 base CpS per %3</b>.':
		'Каждый %1 получает <b>+%2 к базовому печ/с за %3</b>.',
	'Note: the grandmothers are growing restless. Do not encourage them.':
		'Примечание. Бабули становятся беспокойными. Не трогайте их.',
	'Note: proceeding any further in scientific research may have unexpected results. You have been warned.':
		'Примечание. Продолжение научных исследований может привести к неожиданным результатам. Мы вас предупредили.',
	...
	"<b>Warning:</b> purchasing this will have unexpected, and potentially undesirable results!<br><small>It's all downhill from here. You have been warned!</small><br><br>Purchase anyway?":
		'<b>Предупреждение.</b> Эта покупка приведет к неожиданным и потенциально нежелательным результатам!<br><small>После этого пойдет по наклонной. Мы вас предупредили!</small><br><br>Все равно купить?',
	'Contains the wrath of the elders, at least for a while.':
		'Сдерживает гнев старушек, по крайней мере, на время.',
	"Puts a permanent end to the elders' wrath, at the cost of %1% of your CpS.":
		'Позволяет навсегда положить конец гневу старушек за %1% печ/с.',
	'You will get %1% of your CpS back, but the grandmatriarchs will return.':
		'Вы получите обратно %1% печ/с, но бабульматриархи вернутся.',
	...
	'Golden cookies appear <b>twice as often</b> and stay <b>twice as long</b>.':
		'Золотые печеньки появляются в <b>два раза чаще</b> и не исчезают в <b>два раза дольше</b>.',
	...
	'Golden cookies appear <b>%1%</b> more often during %2.':
		'Золотые печеньки появляются на <b>%1%</b> чаще в течение %2.',
	...
	'Golden cookie effects last <b>twice as long</b>.':
		'Эффект золотого печенья действует <b>вдвое дольше</b>.',
	'Golden cookie effects last <b>%1%</b> longer.':
		'Эффект золотого печенья действует на <b>%1%</b> дольше.',
	'Golden cookies stay <b>%1%</b> longer.': 'Золотые печеньки не исчезают на <b>%1%</b> дольше.',
	'Golden cookies give <b>%1%</b> more cookies.':
		'Золотые печеньки дают на <b>%1%</b> печенья больше.',
	'Wrath cookies give <b>%1%</b> more cookies.':
		'Яростные печеньки дают на <b>%1%</b> печенья больше.',
	'<b>+%1% CpS</b> per golden cookie on-screen, multiplicative.':
		'<b>+%1% печ/с</b> за каждое золотое печенье на экране, многократно.',
	'With no buffs and no golden cookies on screen, selling your most powerful building has <b>%1% chance to summon one</b>.':
		'Если на экране нет баффов и золотых печенек, продажа самого мощного строения с вероятностью <b>%1% может вызвать его</b>.',
	'Confers various powers to your minigames while active.<br>See the bottom of each minigame for more details.':
		'Наделяет различными способностями в минииграх.<br>С подробностями можно ознакомиться внизу каждой миниигры.',
	...
	'Can toggle upgrades on and off at will in the stats menu.':
		'Может включать и отключать улучшения в меню статистики.',
	'You keep producing cookies even while the game is closed.':
		'Вы продолжаете производить печенье, даже когда игра закрыта.',
	'Unlocks <b>%1%</b> of the potential of your prestige level.':
		'Разблокирует <b>%1%</b> потенциала вашего уровня престижа.',
	'Subsequent research will be <b>%1 times</b> as fast.':
		'Следующее исследование будет в <b>%1 раз</b> быстрее.',
	...
	'Wrinklers explode into <b>%1% more cookies</b>.':
		'Морщинники взрываются и возвращают на <b>%1% больше печенья</b>.',
	...
	'Buildings sell back for <b>%1%</b> instead of %2%.':
		'Строения продаются за <b>%1%</b> вместо %2%.',
	...
	'All buildings and upgrades are <b>%1% cheaper</b>.':
		'Все строения и улучшения на <b>%1% дешевле</b>.',
	'%1 are <b>%2%</b> more efficient and <b>%3%</b> cheaper.':
		'%1 на <b>%2%</b> эффективнее и на <b>%3%</b> дешевле.',
	...
	'Allows you to <b>trigger seasonal events</b> at will, for a price.':
		'За определенную плату <b>включает сезонные события</b>, когда вы захотите.',
	'Triggers <b>%1 season</b> for the next 24 hours.<br>Triggering another season will cancel this one.<br>Cost scales with unbuffed CpS and increases with every season switch.':
		'Включает <b>%1 сезон</b> на следующие 24 часа.<br>Включение другого сезона отменяет текущий сезон.<br>Цена зависит от печ/с без баффа и увеличивается с каждым сезоном.',
	...
	"You haven't switched seasons this ascension yet.":
		'Вы еще не переключали сезоны на этом восхождении.',
	"You've switched seasons <b>once</b> this ascension.":
		'Вы переключали сезоны <b>один раз</b> во время восхождения.',
	"You've switched seasons <b>%1 times</b> this ascension.":
		'Вы переключали сезоны <b>%1 раз</b> во время восхождения.',
	'Cookie production <b>multiplied by 1,000</b>.':
		'Производство печенья <b>умножается на 1000</b>.',
	...
	'Christmas cookies drop <b>%1%</b> more often.':
		'Рождественское печенье выпадает на <b>%1%</b> чаще.',
	...
	"You continually gain <b>more CpS the longer you've played</b> in the current ascension.":
		'Чем <b>дольше вы играете, тем больше печ/с</b> в текущем восхождении.',
	...
	'Placing an upgrade in this slot will make its effects <b>permanent</b> across all playthroughs.':
		'Установка улучшения в этот слот сделает его эффекты <b>постоянными</b> во всех прохождениях.',
	...
	'Here are all the upgrades you\'ve purchased last playthrough.<div class="line"></div>Pick one to permanently gain its effects!<div class="line"></div>You can reassign this slot anytime you ascend.':
		'Вот все улучшения, которые вы приобрели в последнем прохождении.<div class="line"></div>Выберите одно, чтобы сделать его эффекты постоянными!<div class="line"></div>Вы можете переназначить этот слот в любое время, когда совершите восхождение.',
	'You now <b>keep making cookies while the game is closed</b>, at the rate of <b>%1%</b> of your regular CpS and up to <b>1 hour</b> after the game is closed.<br>(Beyond 1 hour, this is reduced by a further %2% - your rate goes down to <b>%3%</b> of your CpS.)':
		'Теперь вы будете <b>продолжать выпекать печенье, даже когда игра закрыта</b>, со скоростью <b>%1%</b> от обычного значения печ/с в течение <b>1 часа</b> после закрытия игры.<br>(По истечении 1 часа скорость уменьшится на %2% — это <b>%3%</b> от обычного печ/с.)',
	'You gain another <b>+%1%</b> of your regular CpS while the game is closed.':
		'Когда игра закрыта, вы получаете еще <b>+%1%</b> к обычному печ/с.',
	'You gain another <b>+%1%</b> of your regular CpS while the game is closed, for a total of <b>%2%</b>.':
		'Когда игра закрыта, вы получаете еще <b>+%1%</b> к обычному печ/с, всего: <b>%2%</b>.',
	'You start with <b>%1</b>.': 'Вы начинаете с <b>%1</b>.',
	'Allows you to purchase a <b>crumbly egg</b> once you have earned 1 million cookies.':
		'Позволяет приобрести <b>крошащееся яйцо</b>, когда вы заработаете 1 миллион печенек.',
	...
	'You retain optimal cookie production while the game is closed for <b>%1 more days</b>.':
		'Вы сохраняете оптимальное производство печенья, пока игра закрыта, еще на <b>%1 дн</b>.',
	'You retain optimal cookie production while the game is closed for twice as long, for a total of <b>%1</b>.':
		'Вы сохраняете оптимальное производство печенья, пока игра закрыта, вдвое дольше, всего на <b>%1</b>.',
	'Unlocks the <b>golden switch</b>, which passively boosts your CpS by %1% but disables golden cookies.':
		'Разблокирует <b>золотой переключатель</b>, который пассивно повышает печ/с на %1%, но отключает золотые печеньки.',
	'Turning this on will give you a passive <b>+%1% CpS</b>, but prevents golden cookies from spawning.<br>Cost is equal to 1 hour of production.':
		'При включении этого параметра вы получаете пассивное увеличение <b>печ/с на %1%</b>, но он не дает появляться золотым печенькам.<br>Цена равна 1 часу производства.',
	'The switch is currently giving you a passive <b>+%1% CpS</b>; it also prevents golden cookies from spawning.<br>Turning it off will revert those effects.<br>Cost is equal to 1 hour of production.':
		'В настоящее время этот переключатель дает пассивное увеличение <b>печ/с на %1%</b>, но он тоже не дает появляться золотым печенькам.<br>Отключение приведет к отмене этих эффектов.<br>Цена равна 1 часу производства.',
	'Unlocks the <b>milk selector</b>, letting you pick which milk is displayed under your cookie.<br>Comes with a variety of basic flavors.':
		'Разблокирует <b>переключатель молока</b>, позволяющий выбирать молоко, которое будет отображаться под печеньем.<br>Содержит множество основных вкусов.',
	'Contains more exotic flavors for your milk selector.':
		'Содержит более экзотические вкусы молока.',
	...
	'Unlocks the <b>golden cookie sound selector</b>, which lets you pick whether golden cookies emit a sound when appearing or not.':
		'Разблокирует <b>переключатель звука золотого печенья</b>, который определяет, издавать ли звуки при появлении золотого печенья или нет.',
	'Lets you change the sound golden cookies make when they spawn.':
		'Позволяет изменить звук, издаваемый при появлении золотого печенья.',
	'No sound': 'Без звука',
	Chime: 'Перезвон',
	Fortune: 'Богатство',
	Cymbal: 'Тарелка',
	...
	'Unlocks the <b>jukebox</b>, which allows you to play through every sound file in the game.':
		'Открывает <b>музыкальный автомат</b>, которые позволяет проигрывать любой звуковой файл в игре.',
	...
	"Unlocks the <b>background selector</b>, letting you select the game's background.<br>Comes with a variety of basic flavors.":
		'Разблокирует <b>переключатель фона</b>, позволяющий выбрать фон игры.<br>Содержит множество основных вкусов.',
	...
	'Unlocks a new tier of upgrades that affect <b>2 buildings at the same time</b>.<br>Synergies appear once you have <b>%1</b> of both buildings.':
		'Разблокирует новый уровень улучшений, которые влияют <b>сразу на 2 строения</b>.<br>Синергия появляется, когда у вас есть <b>%1</b> экземпляров обоих строений.',
	'Golden cookies (and all other things that spawn, such as reindeer) have <b>%1% chance of being doubled</b>.':
		'Золотые печеньки (и все остальное, что появляется, например олень) могут <b>быть удвоены с вероятностью %1%</b>.',
	'Cookie production <b>reduced to 0</b>.': 'Производство печенья <b>снижается до 0</b>.',
	'Sugar lumps coalesce <b>a whole lot faster</b>.':
		'Кусочки сахара растут <b>намного быстрее</b>.',
	...
	'<b>+%1%</b> prestige level effect on CpS.<br><b>+%2%</b> golden cookie effect duration.<br><b>+%3%</b> golden cookie lifespan.':
		'<b>+%1%</b> к влиянию уровня престижа на печ/с.<br><b>+%2%</b> к длительности эффекта золотого печенья.<br><b>+%3%</b> ко времени отображения золотого печенья.',
	'Each unspent sugar lump (up to %1) gives <b>+%2% CpS</b>.<div class="warning">Note: this means that spending sugar lumps will decrease your CpS until they grow back.</div>':
		'Каждый неизрасходованный кусочек сахара (до %1) дает <b>+%2% к печ/с</b>.<div class="warning">Примечание. Это означает, что расходование кусочков сахара снижает печ/с до тех пор, пока они не вырастут снова.</div>',
	'Once an ascension, you may use the "Sugar frenzy" switch to <b>triple your CpS</b> for 1 hour, at the cost of <b>1 sugar lump</b>.':
		'После восхождения вы можете использовать переключатель «Сахарное безумие», чтобы <b>утроить печ/с</b> на 1 час за <b>1 кусочек сахара</b>.',
	'Each grandma (up to %1) makes sugar lumps ripen <b>%2</b> sooner.':
		'Каждая бабуля (до %1) заставляет сахарные кусочки созревать на <b>%2</b> раньше.',
	'Activating this will <b>triple your CpS</b> for 1 hour, at the cost of <b>1 sugar lump</b>.':
		'Активация <b>утраивает печ/с</b> на 1 час за <b>1 кусочек сахара</b>.',
	...
	'Garden plants grow every second.<br>Garden seeds are free to plant.<br>You can switch soils at any time.':
		'Садовые растения растут каждую секунду.<br>Семена можно сеять бесплатно.<br>Грунт можно поменять в любой момент.',
	...
	'Sugar lumps are <b>twice as likely</b> to be unusual.':
		'Необычные кусочки сахара попадаются <b>вдвое чаще</b>.',
	...
	'Bifurcated sugar lumps appear <b>%1% more often</b> and are <b>%2% more likely</b> to drop 2 lumps.':
		'Двойные кусочки сахара появляются на <b>%1% чаще</b> и с <b>вероятностью % 2%</b> выпадает 2 кусочка.',
	'Mouse over a wrinkler to see how many cookies are in its stomach.':
		'Наведите курсор на морщинника, чтобы увидеть, сколько печенья у него в желудке.',
	'Unlocks the <b>Buy all</b> feature, which lets you instantly purchase every upgrade in your store (starting from the cheapest one).<br>Also unlocks the <b>Vault</b>, a store section where you can place upgrades you do not wish to auto-buy.':
		'Разблокирует функцию <b>Купить все</b>, которая позволяет мгновенно приобретать все улучшения в магазине (начиная с самого дешевого).<br>Также разблокирует <b>Хранилище</b> — раздел магазина, где можно разместить улучшения, которые не хотите покупать автоматически.',
	'Mouse over an upgrade to see its tier.<br><small>Note: only some upgrades have tiers. Tiers are purely cosmetic and have no effect on gameplay.</small>':
		'Наведите курсор мыши на улучшение, чтобы увидеть его уровень.<br><small>Примечание. Улучшения доступны только на некоторых уровнях. Уровни являются формальными и не влияют на процесс игры.</small>',
	'You now benefit from the boost provided by <b>heralds</b>.<br>Each herald gives you <b>+1% CpS</b>.<br>Look on the purple flag at the top to see how many heralds are active at any given time.':
		'Теперь вы получите бонус от <b>вестников</b>.<br>Каждый вестник дает вам <b>+1% к печ/с</b>.<br>Посмотрите на фиолетовый флаг сверху, чтобы узнать количество активных вестников.',
	'Seasonal random drops have a <b>1/5 chance</b> to carry over through ascensions.':
		'Выпадение случайного сезона переносится в следующее восхождение с <b>вероятностью 1/5</b>.',
	"Unlocks <b>extra price information</b>.<br>Each displayed cost now specifies how long it'll take you to afford it, and how much of your bank it represents.":
		'Открывает <b>дополнительную информацию о цене</b>.<br>Теперь для каждой цены указывается, сколько нужно времени, чтобы себе это позволить, и какую часть вашего банка она составляет.',
	'Unlocks the <b>shimmering veil</b>, a switch that passively boosts your CpS by <b>%1%</b>.<br>You start with the veil turned on; however, it is very fragile, and clicking the big cookie or any golden cookie or reindeer will turn it off, requiring %2 of CpS to turn back on.':
		'Разблокирует переключатель <b>мерцающей вуали</b>, который пассивно повышает печ/с на <b>%1%</b>.<br>Вуаль очень хрупкая: щелчок по большому печенью, любому золотому печенью или оленю отключает ее, и для ее включения потребуется %2 печ/с.',
	'Boosts your cookie production by <b>%1%</b> when active.<br>The veil is very fragile and will break if you click the big cookie or any golden cookies or reindeer.<br><br>Once broken, turning the veil back on costs %2 of unbuffed CpS.':
		'Увеличивает производство печенья на <b>%1%</b> в активном состоянии.<br>Вуаль очень хрупкая: она разрушается, если щелкнуть на большое печенье, золотое печенье или оленя.<br><br>После этого возвращение вуали стоит %2 печ/с без баффа.',
	...
	'The <b>shimmering veil</b> is more resistant, and has a <b>%1% chance</b> not to break. It also gives <b>+%2%</b> more CpS.':
		'<b>Мерцающая вуаль</b> более устойчивая и имеет шанс не разрушиться: <b>%1%</b>. Она также дает <b>+%2%</b> к печ/с.',
	'Active.': 'Активно.',
	'The reinforced membrane protects the shimmering veil.':
		'Усиленная мембрана защищает мерцающую вуаль.',
	...
	'Prior to purchasing the <b>%1</b> upgrade in a run, random drops are <b>%2 times more common</b>.':
		'До покупки улучшения <b>%1</b> в испытании случайные выпадения выпадают происходят в <b>%2 раз чаще</b>.',
	...
	"You don't know what you have until you've lost it.":
		'Вы не осознаете, что у вас есть, пока не потеряете это.',
	...
	'The news ticker may occasionally have <b>fortunes</b>, which may be clicked for something good.':
		'В ленте новостей иногда могут появляться <b>предсказания</b>. Щелкните на него, чтобы получить что-нибудь хорошее.',
	'Through clever accounting, this actually makes kitten upgrades <b>%1% cheaper</b>.':
		'Благодаря умному учету улучшения котят становятся <b>на %1% дешевле</b>.',
	'Unlocks the ability to <b>pet your dragon</b> by clicking on it once hatched.':
		'Разблокирует возможность <b>погладить дракона</b>, если щелкнуть по нему после того, как он вылупился.',
	'Cost scales with CpS, but %1 times cheaper with a fully-trained dragon.':
		'Цена зависит от печ/с, но с обученным драконом она будет в %1 раз ниже.',
	'Golden cookies may trigger a <b>Dragon Harvest</b>.':
		'Золотые печеньки могут запускать <b>Сбор драконьего урожая</b>.',
	'Golden cookies may trigger a <b>Dragonflight</b>.':
		'Золотые печеньки могут запускать <b>Полет дракона</b>.',
	'Dragon harvest and Dragonflight are <b>%1% stronger</b>.':
		'Сбор драконьего урожая и Полет дракона на <b>%1% мощнее</b>.',
	'Kittens are <b>%1%</b> more effective.': 'Котята на <b>%1%</b> эффективнее.',
	'Each kitten upgrade boosts %1 CpS by <b>%2%</b>.':
		'Каждое улучшение для котят повышает печ/с %1 на <b>%2%</b>.',
	'Each rank of milk boosts %1 CpS by <b>%2%</b>.':
		'Каждый ранг молока повышает печ/с %1 на <b>%2%</b>.',
	'Cursor levels boost clicks by <b>%1%</b> each (up to cursor level %2).':
		'Уровни курсора увеличивают количество кликов на <b>%1%</b> каждый (до %2 уровня).',
	'<b>%1</b> are now effective up to cursor level %2.':
		'<b>%1</b> теперь действуют до уровня курсора %2.',
	...
	'Golden and wrath cookie effect duration +%1%.':
		'+%1% к длительности эффекта золотого и злого печенья.',
	...
	'Selling buildings triggers a buff boosted by how many buildings were sold.':
		'Продажа зданий дает бафф, увеличивающийся в зависимости от количества проданных зданий.',
	'Buff boosts clicks by +%1% for every building sold for %2 seconds.':
		'Бафф увеличивает количество кликов на %1% в течение %2 сек. за каждое проданное здание.',
	'CpS bonus fluctuating between %1 and %2 over time.':
		'Бонус ПвС со временем переключается между %1 и %2.',
	...
	'All golden cookies are wrath cookies with a greater chance of a negative effect.':
		'Все золотое печенье становится злым с высоким шансом негативного эффекта.',
	'Wrinklers appear %1% faster and digest %2% more cookies.':
		'Морщинники появляются на %1% быстрее и съедают на %2% больше печенья.',
	'Effect is only active when your total amount of buildings ends with 0.':
		'Эффект действует, только если количество зданий оканчивается на 0.',
	...
	'Make <b>%1</b> by only having clicked <b>%2 times</b>.':
		'Испечь <b>%1</b> за всего <b>%2</b> кликов.',
	...
	'Get to <b>%1</b> baked with <b>no upgrades purchased</b>.':
		'Испечь <b>%1</b> <b>без покупки улучшений</b>.',
	...
	'Have <b>at least %1</b> of every building.':
		'Получить <b>хотя бы %1</b> шт. каждого типа строения.',
	'Have at least <b>1 of the most expensive object, 2 of the second-most expensive, 4 of the next</b> and so on (capped at %1).':
		'Получить хотя бы <b>1 самый дорогой объект, 2 вторых по дороговизне объекта, 4 следующих</b> и т. д. (не более %1).',
	'Have at least <b>10 of the most expensive object, 20 of the second-most expensive, 30 of the next</b> and so on.':
		'Получить хотя бы <b>1о самых дорогих объектов, 20 вторых по дороговизне объектов, 30 следующих</b> и т. д.',
	...
	'Appease the grandmatriarchs at least <b>once</b>.':
		'Успокоить бабульматриархов хотя бы <b>один раз</b>.',
	'Appease the grandmatriarchs at least <b>%1 times</b>.':
		'Успокоить бабульматриархов хотя бы <b>%1 раз</b>.',
	...
	'Unlock <b>100%</b> of your heavenly chips power.':
		'Разблокировать <b>100%</b> мощности своих небесных крошек.',
	'You have <b>1 chance in %1</b> every second of earning this achievement.':
		'У вас есть <b>1 шанс в %1</b> секунд получить это достижение.',
	...
	'Unlock <b>every Halloween-themed cookie</b>.<div class="line"></div>Owning this achievement makes Halloween-themed cookies drop more frequently in future playthroughs.':
		'Разблокировать <b>все хэллоуинские печеньки</b>.<div class="line"></div>Благодаря этому достижению в будущих играх хэллоуинские печеньки будут выпадать чаще.',
	...
	'Unlock <b>every Christmas-themed cookie</b>.<div class="line"></div>Owning this achievement makes Christmas-themed cookies drop more frequently in future playthroughs.':
		'Разблокировать <b>все рождественские печеньки</b>.<div class="line"></div>Благодаря этому достижению в будущих играх рождественские печеньки будут выпадать чаще.',
	'Pop <b>1 reindeer</b>.': 'Лопнуть <b>1 оленя</b>.',
	'Pop <b>%1 reindeer</b>.': 'Лопнуть <b>%1 оленей</b>.',
	'Pop a reindeer <b>during an elder frenzy</b>.':
		'Лопнуть оленя <b>во время безумия старушек</b>.',
	'Unlock <b>every Valentine-themed cookie</b>.':
		'Разблокировать <b>все печеньки, посвященные дню Святого Валентина</b>.',
	'Click the tiny cookie.': 'Кликнуть крошечное печенье.',
	'This is for baking %1 and making it on the local news.':
		'Это нужно для того, чтобы испечь %1 и попасть в местные новости.',
	'Name yourself <b>Orteil</b>.<div class="warning">Note: usurpers incur a -%1% CpS penalty until they rename themselves something else.</div>':
		'Назовите себя <b>Orteil</b>.<div class="warning">Примечание. Нарушители будут оштрафованы на -%1% печ/с, пока не переименуют себя.</div>',
	...
	'Unlock <b>all the eggs</b>.<div class="line"></div>Owning this achievement makes eggs drop more frequently in future playthroughs.':
		'Разблокировать <b>все яйца</b>.<div class="line"></div>Благодаря этому достижению в будущих играх яйца будут попадаться чаще.',
	...
	'Own <b>%1</b> upgrades and <b>%2</b> buildings.':
		'Получить <b>%1</b> улучшений и <b>%2</b> строений.',
	...
	'Click a golden cookie <b>less than 1 second after it spawns</b>.':
		'Кликнуть по золотому печенью <b>менее чем через 1 секунду после его появления</b>.',
	'Click a golden cookie <b>less than 1 second before it dies</b>.':
		'Кликнуть по золотому печенью <b>менее чем за 1 секунду до его исчезновения</b>.',
	...
	'Have <b>%1</b> golden cookies simultaneously.':
		'Получить одновременно <b>%1</b> золотых печенек.',
	'Manage a cookie legacy for <b>at least a year</b>.':
		'Управлять печеньем, накопленным <b>не менее чем за год</b>.',
	...
	'Convert a complete seed log into sugar lumps by sacrificing your garden to the sugar hornets.<div class="line"></div>Owning this achievement makes seeds <b>%1% cheaper</b>, plants mature <b>%2% sooner</b>, and plant upgrades drop <b>%3% more</b>.':
		'Превращает заполненный журнал семян в кусочки сахара, жертвуя сад сахарным шершням.<div class="line"></div>С этим достижением семена становятся на <b>%1% дешевле</b>, культуры созревают на <b>%2% быстрее</b>, а улучшения растений выпадают на <b>%3% чаще</b>.',
	...
	'Have your <b>reinforced membrane</b> protect the <b>shimmering veil</b>.':
		'Получить <b>усиленную мембрану</b>, которая защищает <b>мерцающую вуаль</b>.',
	'Own every <b>fortune upgrade</b>.<div class="line"></div>Owning this achievement makes fortunes appear <b>twice as often</b>; unlocked fortune upgrades also have a <b>%1% chance</b> to carry over after ascending.':
		'Дает каждое <b>улучшение удачи</b>.<div class="line"></div>С этим достижением удача появляется <b>вдвое чаще</b>. Разблокированные улучшения удачи также могут переноситься в следующее восхождение с <b>вероятностью %1%</b>.',
	'Make your first stock market profit.': 'Приносит первую прибыль на фондовой бирже.',
	'Own at least <b>%1</b> of a stock market good.':
		'Владеть не менее <b>%1</b> позиций на фондовой бирже.',
	'Own at least <b>%1</b> of every stock market good.':
		'Владеть не менее <b>%1</b> шт. для каждой позиции на фондовой бирже.',
	'Make <b>a day</b> of CpS ($%1) in 1 stock market sale.':
		'Получить <b>день</b> печ/с ($%1) за 1 продажу на фондовой бирже.',
	'Spend <b>a day</b> of CpS ($%1) in 1 stock market purchase.':
		'Потратить <b>день</b> печ/с ($%1) на 1 покупку на фондовой бирже.',
	'Have your stock market profits surpass <b>a whole year</b> of CpS ($%1).':
		'Сделать так, чтобы ваша прибыль на фондовом рынке превысила <b>годовой показатель</b> печ/с ($%1).',
	'Unlock the <b>highest-tier</b> stock market headquarters.':
		'Разблокировать штаб-квартиру на фондовом рынке <b>высшего уровня</b>.',
	'Have your stock market profits surpass <b>$%1</b>.':
		'Сделать так, чтобы ваша прибыль на фондовом рынке превысила <b>$%1</b>.',
	...
	'Cookie production halted for %1,<br>but each click is worth %2 of CpS.':
		'Производство печенья останавливается на %1,<br>но каждый клик стоит %2 печ/с.',
	...
	'You find %1% more golden cookies for the next %2.':
		'Вы найдете на %1% больше золотых печенек в течение следующих %2.',
	...
	"[Baker's wheat quote]A plentiful crop whose hardy grain is used to make flour for pastries.":
		'Высокоурожайное морозоустойчивое зерно, из которого делают муку для выпечки.',
	...
	'[Thumbcorn quote]A strangely-shaped variant of corn. The amount of strands that can sprout from one seed is usually in the single digits.':
		'Вид кукурузы странной формы. Количество ростков, которые могут прорасти из одного семени, обычно исчисляется однозначными числами.',
	...
	"[Cronerice quote]Not only does this wrinkly bulb look nothing like rice, it's not even related to it either; its closest extant relative is the weeping willow.":
		'Эта морщинистая луковица не только совсем не похожа на рис, но и даже не связана с ним; ближайший дошедший до нас родственник этого растения — плакучая ива.',
	...
	'[Gildmillet quote]An ancient staple crop, famed for its golden sheen. Was once used to bake birthday cakes for kings and queens of old.':
		'Древняя культура, известная своим золотистым блеском. В древние времена из нее пекли праздничные торты для королей и королев.',
	...
	'[Ordinary clover quote]<i>Trifolium repens</i>, a fairly mundane variety of clover with a tendency to produce four leaves. Such instances are considered lucky by some.':
		'<i>Трехлистник ползучий</i> — довольно распространенная разновидность клевера, у которого можно часто встретить четырехлистные лепестки. Считается, что такие лепестки приносят удачу.',
	...
	'[Golden clover quote]A variant of the ordinary clover that traded its chlorophyll for pure organic gold. Tragically short-lived, this herb is an evolutionary dead-end - but at least it looks pretty.':
		'Разновидность обычного клевера, у которого вместо хлорофиллов чистое органическое золото. К сожалению, из-за недолговечности эволюция этого растения зашла в тупик, но, по крайней мере, оно выглядит очень красиво.',
	...
	'[Shimmerlily quote]These little flowers are easiest to find at dawn, as the sunlight refracting in dew drops draws attention to their pure-white petals.':
		'Эти маленькие цветы легче всего найти на рассвете, поскольку солнечный свет, преломляющийся в каплях росы, красиво подсвечивает их белоснежные лепестки.',
	Elderwort: 'Бузина',
	'[Elderwort quote]A very old, long-forgotten subspecies of edelweiss that emits a strange, heady scent. There is some anecdotal evidence that these do not undergo molecular aging.':
		'Очень старый, давно забытый подвид эдельвейса, источающий странный пьянящий аромат. Есть неофициальные данные о том, что эти растения не подвергаются молекулярному старению.',
	...
	'[Bakeberry quote]A favorite among cooks, this large berry has a crunchy brown exterior and a creamy red center. Excellent in pies or chicken stews.':
		'Фаворит среди поваров, эта большая ягода имеет хрустящую коричневую оболочку и кремово-красную мякоть. Превосходно подходит для приготовления пирогов или тушеной курицы.',
	...
	'[Chocoroot quote]A tangly bramble coated in a sticky, sweet substance. Unknown genetic ancestry. Children often pick these from fields as-is as a snack.':
		'Колючая ежевика, покрытая липкой сладкой субстанцией. Генетическая родословная неизвестна. Дети часто собирают эту ягоду в полях, чтобы полакомиться.',
	...
	'[White chocoroot quote]A pale, even sweeter variant of the chocoroot. Often impedes travelers with its twisty branches.':
		'Более бледный и более сладкий вариант шоколадного корня. Часто мешает путешественникам своими цепкими ветвями.',
	...
	'[White mildew quote]A common rot that infests shady plots of earth. Grows in little creamy capsules. Smells sweet, but sadly wilts quickly.':
		'Распространенная гниль, поражающая тенистые участки почвы. Растет в маленьких кремовых капсулах. Имеет сладкий запах, но, к сожалению, быстро увядает.',
	...
	'[Brown mold quote]A common rot that infests shady plots of earth. Grows in odd reddish clumps. Smells bitter, but thankfully wilts quickly.':
		'Распространенная гниль, поражающая тенистые участки почвы. Растет неровными красноватыми комками. Имеет горький запах, но, к счастью, быстро увядает.',
	...
	'[Meddleweed quote]The sign of a neglected farmland, this annoying weed spawns from unused dirt and may sometimes spread to other plants, killing them in the process.':
		'Признак заброшенности сельскохозяйственных угодий. Этот раздражающий сорняк растет на необрабатываемой почве и иногда может заплетать другие растения, убивая их.',
	...
	"[Whiskerbloom quote]Squeezing the translucent pods makes them excrete a milky liquid, while producing a faint squeak akin to a cat's meow.":
		'При сдавливании его полупрозрачные стручки выделяют молочную жидкость и издают слабый писк, похожий на кошачье мяуканье.',
	Chimerose: 'Химероза',
	'[Chimerose quote]Originating in the greener flanks of polar mountains, this beautiful flower with golden accents is fragrant enough to make any room feel a little bit more festive.':
		'Этот красивый цветок с золотыми прожилками растет на зеленых склонах северных гор. Благодаря своему яркому аромату он легко может создать праздничное настроение в помещении.',
	...
	'[Nursetulip quote]This flower grows an intricate root network that distributes nutrients throughout the surrounding soil. The reason for this seemingly altruistic behavior is still unknown.':
		'Этот цветок имеет сложную корневую сеть, которая распределяет питательные вещества по окружающей почве. Причина такого альтруистического поведения до сих пор неизвестна.',
	Drowsyfern: 'Усыпляющий папоротник',
	'[Drowsyfern quote]Traditionally used to brew a tea that guarantees a good night of sleep.':
		'Традиционно заваривается в качестве чая, который гарантирует крепкий ночной сон.',
	...
	'[Wardlichen quote]The metallic stench that emanates from this organism has been known to keep insects and slugs away.':
		'Известно, что металлический запах этого растения отпугивает насекомых и слизней.',
	Keenmoss: 'Острый мох',
	'[Keenmoss quote]Fuzzy to the touch and of a vibrant green. In plant symbolism, keenmoss is associated with good luck for finding lost objects.':
		'Пушистое растение ярко-зеленого цвета. Считается, что острый мох приносит удачу в поиске потерянных вещей.',
	...
	'[Queenbeet quote]A delicious taproot used to prepare high-grade white sugar. Entire countries once went to war over these.':
		'Вкусный корнеплод, используемый для приготовления высококачественного белого сахара. Когда-то из-за них воевали целые страны.',
	...
	'[Juicy queenbeet quote]A delicious taproot used to prepare high-grade white sugar. Entire countries once went to war over these.<br>It looks like this one has grown especially sweeter and juicier from growing in close proximity to other queenbeets.':
		'Вкусный корнеплод, используемый для приготовления высококачественного белого сахара. Когда-то из-за них воевали целые страны.<br>Этот корень еще слаще и сочнее из-за выращивания в непосредственной близости от других королевских корней.',
	...
	'[Duketater quote]A rare, rich-tasting tuber fit for a whole meal, as long as its strict harvesting schedule is respected. Its starch has fascinating baking properties.':
		'Редкий клубень с насыщенным вкусом, используется как полноценное самостоятельное блюдо, если соблюдается строгий график сбора урожая. Его крахмал прекрасно подходит для выпечки.',
	...
	'[Crumbspore quote]An archaic mold that spreads its spores to the surrounding dirt through simple pod explosion.':
		'Древняя плесень, которая распространяет свои споры посредством взрыва стручка.',
	...
	'[Doughshroom quote]Jammed full of warm spores; some forest walkers often describe the smell as similar to passing by a bakery.':
		'Наполнен теплыми спорами; те, кто бывает в лесу, часто описывают запах, как будто они проходят мимо пекарни.',
	...
	'[Glovemorel quote]Touching its waxy skin reveals that the interior is hollow and uncomfortably squishy.':
		'Снаружи покрыт восковой кожицей, а внутри полый и неприятно мягкий.',
	...
	'[Cheapcap quote]Small, tough, and good in omelettes. Some historians propose that the heads of dried cheapcaps were once used as currency in some bronze age societies.':
		'Маленькие, плотные и вкусные в омлете. Некоторые историки предполагают, что в бронзовом веке сушеные шляпки этих грибов использовались в качестве валюты.',
	...
	"[Fool's bolete quote]Named for its ability to fool mushroom pickers. The fool's bolete is not actually poisonous, it's just extremely bland.":
		'Назван за способность обмануть грибников. Лжеборовик на самом деле не ядовит, он просто очень мягкий.',
	...
	"[Wrinklegill quote]This mushroom's odor resembles that of a well-done steak, and is said to whet the appetite - making one's stomach start gurgling within seconds.":
		'Запах этого гриба напоминает запах хорошо прожаренного стейка. Говорят, он возбуждает аппетит и провоцирует урчание в желудке в течение нескольких секунд.',
	...
	'[Shriekbulb quote]A nasty vegetable with a dreadful quirk : its flesh resonates with a high-pitched howl whenever it is hit at the right angle by sunlight, moonlight, or even a slight breeze.':
		'Противный овощ с ужасной особенностью: его мякоть издает пронзительный визг, когда на него под прямым углом попадает солнечный или лунный свет и даже легкий ветерок.',
	...
	'[Tidygrass quote]The molecules this grass emits are a natural weedkiller. Its stems grow following a predictable pattern, making it an interesting -if expensive- choice for a lawn grass.':
		'Эта трава испускает молекулы, которые уничтожают сорняки. Ее стебли растут по предсказуемой схеме, что делает ее интересной, хоть и дорогой, основой для газона.',
	Everdaisy: 'Эвердейзи',
	'[Everdaisy quote]While promoted by some as a superfood owing to its association with longevity and intriguing geometry, this elusive flower is actually mildly toxic.':
		'Хотя некоторые продвигают этот цветок как суперфуд из-за его свойств, связанных с долголетием, и интересной геометрии, на самом деле он в некоторой степени ядовит.',
	Ichorpuff: 'Ихорпафф',
	'[Ichorpuff quote]This puffball mushroom contains sugary spores, but it never seems to mature to bursting on its own. Surrounding plants under its influence have a very slow metabolism, reducing their effects but lengthening their lifespan.':
		'Этот гриб-дождевик содержит сладкие споры, но кажется, что он никогда не созревает и не лопается сам по себе. Он сильно замедляет обмен веществ находящихся рядом растений, что снижает их воздействие, но увеличивает продолжительность их жизни.',
	...
	"-You can cross-breed plants by planting them close to each other; new plants will grow in the empty tiles next to them.<br>-Unlock new seeds by harvesting mature plants.<br>-When you ascend, your garden plants are reset, but you keep all the seeds you've unlocked.<br>-Your garden has no effect and does not grow while the game is closed.":
		'- Чтобы смешивать растения, сажайте их рядом, и на соседних пустых клетках вырастут гибриды.<br>- Чтобы получить новые семена, собирайте урожай с созревших растений.<br>- Возвысившись, вы теряете все растения в саду, но сохраняете все полученные семена.<br>- Когда игра закрыта, сад не дает никаких эффектов и не растет.',
	...
	'%1 to harvest only mature, mortal plants.':
		'%1 на сбор урожая только с созревших, живых растений.',
	'%1 to harvest all mature plants of this type.':
		'%1 на сбор урожая со всех созревших растений такого типа.',
	Freeze: 'Заморозка',
	'Cryogenically preserve your garden.<br>Plants no longer grow, spread or die; they provide no benefits.<br>Soil cannot be changed.<div class="line"></div>Using this will effectively pause your garden.':
		'Криоконсервация сада.<br>Ничего не растет, не плодится и не умирает; не дает никаких преимуществ.<br>Почву менять нельзя.<div class="line"></div>Заморозка ставит сад на паузу.',
	...
	'A swarm of sugar hornets comes down on your garden, <span class="red">destroying every plant as well as every seed you\'ve unlocked</span> - leaving only a %1 seed.<br>In exchange, they will grant you <span class="green">%2</span>.<br>This action is only available with a complete seed log.':
		'В сад прилетает рой сахарных шершней и <span class="red">уничтожает все растения и все открытые вами семена,</span> оставляя лишь одно семя: %1.<br>Взамен вы получаете: <span class="green">%2</span>.<br>Действие доступно только при заполненном журнале семян.',
	'Do you REALLY want to sacrifice your garden to the sugar hornets?<br><small>You will be left with an empty plot and only the %1 seed unlocked.<br>In return, you will gain <b>%2 sugar lumps</b>.</small>':
		'Вы ТОЧНО хотите пожертвовать сад сахарным шершням?<br><small>Останется пустой участок и семя «%1».<br>Взамен вы получите <b>куски сахара (%2)</b>.</small>',
	...
	"You've sacrificed your garden to the sugar hornets, destroying your crops and your knowledge of seeds.<br>In the remains, you find <b>%1 sugar lumps</b>.":
		'Сад пожертвован сахарным шершням. Урожай и знания о семенах утеряны.<br>Среди остатков нашлись <b>куски сахара (%1)</b>.',
	...
	'surrounding plants (%1x%1) age %2% slower':
		'соседние растения (%1x%1) старятся на %2% медленнее',
	'surrounding plants (%1x%1) are %2% more efficient':
		'соседние растения (%1x%1) на %2% эффективнее',
	'surrounding plants (%1x%1) are %2% less efficient':
		'соседние растения (%1x%1) на %2% менее эффективны',
	'surrounding tiles (%1x%1) develop no weeds or fungus':
		'на соседних клетках (%1x%1) не растут сорняки и грибок',
	'harvest when mature for +%1 of CpS (max. %2% of bank)':
		'собрать созревшее за +%1 ПвС (максимум %2% банка)',
	...
	'explodes into up to %1 of CpS at the end of its lifecycle (max. %2% of bank)':
		'в конце жизненного цикла взрывается и дает до %1 ПвС (максимум %2% банка)',
	'cannot handle cold climates; %1% chance to die when frozen':
		'не переносит холода; %1% шанс умереть при заморозке',
	...
	'Click to use this type of soil for your whole field.':
		'Нажмите, чтобы заполнить почвой все поле.',
	Dirt: 'Грязь',
	...
	'Soil with a healthy helping of fresh manure. Plants grow faster but are less efficient.':
		'Почва с доброй порцией свежего навоза. Растения растут быстрее, но менее эффективны.',
	Clay: 'Глина',
	'Rich soil with very good water retention. Plants grow slower but are more efficient.':
		'Богатая почва, хорошо удерживающая воду. Растения растут медленнее, но более эффективны.',
	Pebbles: 'Гравий',
	"Dry soil made of small rocks tightly packed together. Not very conducive to plant health, but whatever falls off your crops will be easy to retrieve.<br>Useful if you're one of those farmers who just want to find new seeds without having to tend their garden too much.":
		'Сухая почва из спрессованных камушков. Не особо хороша для здоровья растений, но все упавшее с растений будет легко собрать.<br>Пригодится, если вы из тех фермеров, кто хочет только собирать семена и не тратить слишком много времени на уход за садом.',
	'Wood chips': 'Щепки',
	'Soil made of bits and pieces of bark and sawdust. Helpful for young sprouts to develop, not so much for mature plants.':
		'Почва из кусочков коры и опилок. Хороша для проращивания молодых побегов, а для зрелых растений не особо подходит.',
	...
	'<b>%1% chance</b> of collecting seeds automatically when plants expire':
		'<b>%1% шанс</b> автосбора семян при увядании растений',
	'plants spread and mutate <b>%1 times more</b>':
		'растения распространяются и мутируют <b>в %1 раз(-а) больше</b>',
	...
	'This tile of soil is empty.<br>Pick a seed and plant something!':
		'Клетка пуста.<br>Выберите семя и посадите туда.',
	...
	'Click to refill your soil timer and trigger <b>1</b> plant growth tick with <b>x%1</b> spread and mutation rate for %2.':
		'Нажмите, чтобы восполнить почвенный таймер и запустить <b>1</b> цикл роста растения с <b>x%1</b> скоростью распространения и мутации за %2.',
	...
	'Garden plants age and mutate %1% faster.':
		'Садовые растения взрослеют и мутируют на %1% быстрее.',
	...
	'This is your magic meter. Each spell costs magic to use.<div class="line"></div>Your maximum amount of magic varies depending on your amount of <b>Wizard towers</b>, and their level.<div class="line"></div>Magic refills over time. The lower your magic meter, the slower it refills.':
		'Это шкала магии, расходующейся на заклинания.<div class="line"></div>Максимальный запас магии зависит от <b>башен волшебника</b> и их уровня.<div class="line"></div>Магия восстанавливается со временем: чем ее меньше, тем медленнее.',
	...
	'Click to refill <b>%1 units</b> of your magic meter for %2.':
		'Нажмите, чтобы заполнить <b>%1 делен.</b> шкалы магии за %2.',
	'Grimoire spells are %1% cheaper but fail %1% more.':
		'Заклинания из гримуара стоят на %1% меньше, но на %1% чаще не удаются.',
	'Conjure Baked Goods': 'Наколдовать выпечку',
	'Summon half an hour worth of your CpS, capped at %1% of your cookies owned.':
		'Призовите полчаса ПвС, но не более %1% от имеющегося у вас печенья.',
	'Trigger a %1-minute clot and lose %1 minutes of CpS.':
		'Задействуйте %1-минутный сгусток и потеряйте %1 мин. ПвС.',
	...
	'Summon a random golden cookie. Each existing golden cookie makes this spell +%1% more likely to backfire.':
		'Призовите случайное золотое печенье. Каждое имеющееся золотое печенье дает +%1% шанс обратного эффекта этого заклинания.',
	...
	'All active buffs gain %1% more time (up to %2 more minutes).':
		'Все активные баффы продлеваются на %1% (до %2 доп. мин.)',
	'All active buffs are shortened by %1% (up to %2 minutes shorter).':
		'Все активные баффы сокращаются на %1% (до –%2 мин.)',
	...
	'The spell picks a random building you could afford if you had twice your current cookies, and gives it to you for free. The building selected must be under %1, and cannot be your most-built one (unless it is your only one).':
		'Заклинание выбирает случайное здание, которое вы могли бы купить, будь у вас вдвое больше печенья, и строит его бесплатно. Выбранное строение должно быть ниже %1 и не может быть самым часто возводимым (если только оно не ваше единственное).',
	...
	'Cast a random spell at half the magic cost, with twice the chance of backfiring.':
		'Прочитайте случайное заклинание за полцены, но с двойным шансом обратного эффекта.',
	...
	'Instantly summon a wrinkler if conditions are fulfilled.':
		'Мгновенный призыв морщинника при соблюденных условиях.',
	...
	'Spells backfire %1 times less for the next %2 minutes.':
		'Заклинания дают обратный эффект в %1 раз(-а) реже в след. %2 мин.',
	'Spells backfire %1 times more for the next %2 minutes.':
		'Заклинания дают обратный эффект в %1 раз(-а) чаще в след. %2 мин.',
	...
	'[GOD 1 QUOTE]An immortal life spent focusing on the inner self, away from the distractions of material wealth.':
		'Бессмертная жизнь, проведенная в самосозерцании, вдали от раздражителей и материальных благ.',
	...
	'[GOD 2 QUOTE]This sleazy spirit revels in the lust for quick easy gain and contempt for the value of steady work.':
		'Похабный дух одержим страстью к быстрой наживе и презрением к упорному труду.',
	...
	'[GOD 3 QUOTE]The embodiment of natural disasters. An impenetrable motive drives the devastation caused by this spirit.':
		'Воплощение природных катастроф. Неутолимая жажда движет этим сеющим разрушение духом.',
	...
	"[GOD 4 QUOTE]This spirit knows about everything you'll ever do, and enjoys dispensing a harsh judgment.":
		'Знает все, о чем вы только можете подумать, и любит высказывать резкие суждения.',
	...
	'[GOD 5 QUOTE]This is the spirit of merry getaways and regretful Monday mornings.':
		'Дух веселых путешествий и тяжкого утра понедельника.',
	...
	"[GOD 6 QUOTE]All things that be and ever will be were scripted long ago by this spirit's inscrutable tendrils.":
		'Все, что есть и будет, давным-давно описано загадочными щупальцами этого духа.',
	...
	'[GOD 7 QUOTE]This spirit enjoys a good cheese after a day of hard work.':
		'Любит поесть хорошего сыра после трудного рабочего дня.',
	...
	'[GOD 8 QUOTE]While this spirit has many regrets, helping you rule the world through constant industrialization is not one of them.':
		'Жалеет о многом, но не о том, что помог вам править миром с помощью непрестанной индустриализации.',
	...
	'[GOD 9 QUOTE]A caring spirit said to contain itself, inwards infinitely.':
		'Заботливый дух, якобы вечно держащийся внутри себя самого.',
	...
	'[GOD 10 QUOTE]This spirit enjoys poking foul beasts and watching them squirm, but has no love for its own family.':
		'Любит тыкать в чудовищ острой палкой и смотреть, как они корчатся, но не любит собственную семью.',
	...
	'[GOD 11 QUOTE]You will find that life gets just a little bit sweeter if you can motivate this spirit with tidy numbers and properly-filled tax returns.':
		'Если порадовать его аккуратными цифрами и правильно заполненными налоговыми декларациями, жить станет легче.',
	...
	'If a golden cookie is clicked, this spirit is unslotted and all worship swaps will be used up.':
		'Если нажать на золотое печенье, дух покинет ячейку, а все смены божеств израсходуются.',
	'Each time you slot a spirit, you use up one worship swap.<div class="line"></div>If you have 2 swaps left, the next one will refill after %1.<br>If you have 1 swap left, the next one will refill after %2.<br>If you have 0 swaps left, you will get one after %3.<div class="line"></div>Unslotting a spirit costs no swaps.':
		'На помещение духа в ячейку расходуется одна смена божества.<div class="line"></div>Если смен осталось 2, следующая появится через %1.<br>Если смена осталась 1, следующая появится через %2.<br>Если смен не осталось, следующая появится через %3.<div class="line"></div>На удаление духа смен не тратится.',
	...
	'The jade slot behaves as a ruby slot and the ruby slot behaves as a diamond slot.':
		'Нефритовая ячейка ведет себя как рубиновая ячейка, а рубиновая ячейка ведет себя как алмазная.',
	...
	'You may increase your storage space by upgrading your offices and by buying more %1. You also get %2 extra storage space per %3 level (currently: <b>+%4</b>).':
		'Расширить склады можно улучшая офисы и покупая %1. Также вы получаете еще %2 места для хранения за %3 ур. (сейчас <b>+%4</b>).',
	'The average worth of this stock and how high it can peak depends on the building it is tied to, along with the level of your %1.':
		'Средняя стоимость данных акций, и то, насколько они могут подорожать, зависит от привязанного к ним здания и от уровня %1.',
	'%1 the hide button to toggle all other stocks.':
		'%1 на кнопку скрытия, чтобы убрать все другие акции.',
	'stock:': 'акции:',
	...
	'You cannot buy and sell this stock in the same tick.':
		'Данные акции нельзя покупать и продавать в одном цикле.',
	...
	'It is fully upgraded. Its lavish interiors, spanning across innumerable floors, are host to many a decadent party, owing to your nigh-unfathomable wealth.':
		'Он полностью улучшен. В его роскошных интерьерах на нескольких этажах пройдет множество буйных вечеринок в честь вашего бессметного богатства.',
	...
	'Buying goods normally incurs overhead costs of <b>%1% extra</b>. Each broker you hire reduces that cost by <b>%2%</b>.':
		'На покупки обычно уходит на <b>%1% больше</b>. Каждый нанятый брокер снижает наценку на <b>%2%</b>.',
	'Current overhead costs thanks to your brokers: <b>+%1%</b>':
		'Текущая наценка с учетом брокеров: <b>+%1%</b>',
	...
	"Maximum number of brokers you can own: %1 (the highest amount of grandmas you've owned this run, divided by 10, plus your grandma level)":
		'Максимально возможное количество брокеров: %1 (максимум бабушек за этот заход, разделенный на 10, плюс уровень вашей бабушки)',
	'Brokers are Wall Street-class grandmas versed in the ways of finance. Stockbroker grandmas work hard and play hard, and will fight telephone in hand to get your clients the best possible deals - with a sizeable profit margin for you, of course.':
		'Брокеры — это бабушки, разбирающиеся в финансах не хуже работников с Уолл-стрит. Бабули-маклеры работают и играют по-взрослому и будут с телефоном в руке биться за то, чтобы предоставить вашим клиентам лучшие сделки. Вы, разумеется, получите с них наибольшую прибыль.',
	...
	'Click to refill your opportunity timer (and give a quick burst to your economy) for %1.':
		'Нажмите, чтобы восполнить таймер возможности (и дать быстрый толчок экономике) за %1.',
	'Profits: %1. All prices are in $econds of your highest raw cookies per second.':
		'Прибыль: %1. Все цены в секундах от высшего значения сырого печенья в секунду.',
	...
	'[Upgrade name 41]White chocolate macadamia nut cookies':
		'Печенье с орехами макадамии и белым шоколадом',
	...
	'[Upgrade name 97]Round british tea biscuits with heart motif':
		'Круглые бисквиты к чаю с сердечком',
	'[Upgrade name 98]Round chocolate british tea biscuits with heart motif':
		'Круглые шоколадные бисквиты к чаю с сердечком',
	...
	'[Upgrade name 318]Some other super-tiny fundamental particle? Probably?':
		'Какая-то другая сверхмаленькая элементарная частица? Возможно?',
	...
	'[Upgrade name 397]Distilled essence of redoubled luck':
		'Дистиллированная эссенция двойной удачи',
	...
	'[Upgrade name 442]Kitten assistants to the regional manager':
		'Котята-помощники регионального менеджера',
	...
	'[Upgrade name 477]Synthetic chocolate green honey butter biscuit':
		'Зеленый медово-масляный бисквит с синтетическим шоколадом',
	'[Upgrade name 478]Royal raspberry chocolate butter biscuit':
		'Королевский сливочный бисквит с малиновым шоколадом',
	'[Upgrade name 479]Ultra-concentrated high-energy chocolate butter biscuit':
		'Ультраконцентрированный высококалорийный шоколадно-масляный бисквит',
	...
	'[Upgrade name 497]Pure pitch-black chocolate butter biscuit':
		'Сливочный бисквит с чистым, черным как смоль шоколадом',
	...
	'[Upgrade name 553]A chocolate chip cookie but with the chips picked off for some reason':
		'Печенье с шоколадной крошкой, но крошку по какой-то причине вытащили',
	...
	'[Upgrade name 718]Milkhelp&reg; lactose intolerance relief tablets':
		'Таблетки для облегчения непереносимости лактозы Milkhelp®',
	...
	'[Achievement name 149]The old never bothered me anyway':
		'Все равно старое меня никогда не волновало',
	...
	'[Achievement name 230]Brought to you by the letter <div style="display:inline-block;background:url(img/money.png);width:16px;height:16px;"></div>':
		'Принесено вам в письме <div style="display:inline-block;background:url(img/money.png);width:16px;height:16px;"></div>',
	...
	'[Achievement name 259]cookie clicker forever and forever a hundred years cookie clicker, all day long forever, forever a hundred times, over and over cookie clicker adventures dot com':
		'cookie clicker навечно и навсегда, сто лет cookie clicker, весь день, вечно сто раз, снова и снова cookie clicker adventures точка com',
	...
	'[Achievement name 277]The proof of the cookie is in the baking':
		'Доказательство печенья — в выпечке',
	"[Achievement name 278]If it's worth doing, it's worth overdoing":
		'Если что-то действительно того стоит, то можно и переусердствовать',
	...
	'[Achievement name 376]All the other kids with the pumped up clicks':
		'Все остальные дети с прокаченными кликами',
	...
	'[Achievement name 397]When the cookies ascend just right':
		'Когда печенье поднимается прямо здесь',
	...
	"[Achievement name 422]I'm so meta, even this achievement":
		'Я такой мета, что это уже достижение',
	...
	'[Achievement name 544]A trademarked portmanteau of "imagination" and "engineering"':
		'Брэндовое складное слово от  "воображение" и "инженерия".',
