AddLanguage('DE', 'german', {
	...
	'%1 cookie': ['%1 Keks', '%1 Kekse'],
	'%1 sugar lump': ['%1 Würfelzucker', '%1 Würfelzucker'],
	'%1 heavenly chip': ['%1 himmlischer Splitter', '%1 himmlische Splitter'],
	'%1 golden cookie': ['%1 goldener Keks', '%1 goldene Kekse'],
	'%1 building': ['%1 Gebäude', '%1 Gebäude'],
	'%1 upgrade': ['%1 Upgrade', '%1 Upgrades'],
	Yes: 'Ja',
	No: 'Nein',
	...
	Cookies: 'Kekse',
	'%1 day': ['%1 Tag', '%1 Tage'],
	'%1 hour': ['%1 Stunde', '%1 Stunden'],
	'%1 minute': ['%1 Minute', '%1 Minuten'],
	'%1 second': ['%1 Sekunde', '%1 Sekunden'],
	...
	'visual improvements; disabling may improve performance':
		'visuelle Verbesserungen; Deaktivierung kann die Leistung verbessern',
	Particles: 'Partikel',
	Numbers: 'Zahlen',
	'numbers that pop up when clicking the cookie':
		'Zahlen, die beim Anklicken des Kekses auftauchen',
	'Milk [setting]': 'Milch',
	...
	'display boxes around upgrades and achievements in Stats':
		'Boxen um Upgrades und Erfolge in den Statistiken anzeigen',
	'Alt font': 'Alternative Schriftart',
	'your cookies are displayed using a monospace font':
		'Deine Kekse werden in einer Monospace-Schriftart angezeigt',
	...
	'the game will ask you to confirm when you close the window':
		'Das Spiel fragt dich nach einer Bestätigung, wenn du das Fenster schließt',
	Defocus: 'Defokussieren',
	'the game will be less resource-intensive when out of focus':
		'Das Spiel wird weniger ressourcenintensiv sein, wenn es unscharf ist',
	...
	'the game will ask you to confirm before spending sugar lumps':
		'Das Spiel wird dich vor dem Ausgeben von Würfelzucker um eine Bestätigung bitten',
	'Custom grandmas': 'Individuelle Omas',
	'some grandmas will be named after Patreon supporters':
		'einige Omas werden nach Patreon Unterstützern benannt werden',
	...
	"on slower computers, the game will put itself in sleep mode when it's inactive and starts to lag out; offline CpS production kicks in during sleep mode":
		'auf langsameren Computern versetzt sich das Spiel in den Schlafmodus, wenn es inaktiv ist und anfängt zu laggen; die Offline-KpS-Produktion setzt während des Schlafmodus ein',
	'Music in background': 'Musik im Hintergrund abspielen',
	"music will keep playing even when the game window isn't focused":
		'Die Musik spielt weiter, auch wenn das Spielfenster nicht aktiv ist.',
	'Cloud saving': 'Cloud-Speicherung',
	'allow use of Steam Cloud for save backups':
		'Nutzung der Steam Cloud für Speicher-Backups erlauben',
	...
	'allows optimizations for screen readers; game will reload':
		'Ermöglicht Optimierungen für Bildschirmleser; Spiel wird neu geladen',
	'Discord status': 'Discord-Status',
	'if Discord is on, show your game info as activity status':
		'Wenn Discord eingeschaltet ist, zeige deine Spielinformationen als Aktivitätsstatus an',
	Language: 'Sprache',
	'Language: %1': 'Sprache: %1',
	'Change language': 'Sprache wechseln',
	'note: this will save and reload your game':
		'Hinweis: Dies wird dein Spiel gespeichert und neu geladen.',
	...
	'These are feats that are either unfair or difficult to attain. They do not give milk.':
		'Das sind Errungenschaften, die entweder unfair oder schwer zu erreichen sind. Sie geben keine Milch.',
	...
	'with %1 ascension': ['mit %1 Aufstieg', 'mit %1 Aufstiegen'],
	...
	'Milk is gained with each achievement. It can unlock unique upgrades over time.':
		'Milch wird mit jedem Erfolg gewonnen. Sie kann mit der Zeit einzigartige Upgrades freischalten.',
	'Rank %1': 'Rang %1',
	...
	'Cookie Clicker is a javascript game by %1 and %2.':
		'Cookie Clicker ist ein Javascript-Spiel von %1 und %2.',
	...
	"This version of Cookie Clicker is 100% free, forever. Want to support us so we can keep developing games? Here's some ways you can help:%1":
		'Diese Version von Cookie Clicker ist 100% kostenlos, für immer. Möchtest du uns unterstützen, damit wir weiterhin Spiele entwickeln können? Hier sind einige Möglichkeiten, wie du helfen kannst:%1',
	"Note: if you find a new bug after an update and you're using a 3rd-party add-on, make sure it's not just your add-on causing it!":
		'Hinweis: Wenn du nach einem Update einen neuen Bug entdeckst und ein Add-on eines Drittanbieters verwendest, stelle sicher, dass es nicht nur an deinem Add-on liegt!',
	'Warning: clearing your browser cache or cookies <small>(what else?)</small> will result in your save being wiped. Export your save and back it up first!':
		'Warnung: Wenn du deinen Browser-Cache oder deine Cookies <small>(was sonst?)</small> löschst, wird dein Spielstand gelöscht. Exportiere deinen Spielstand und sichere ihn vorher!',
	'Version history': 'Versionsverlauf',
	'Official website': 'Offizielle Website',
	'Note: links will open in your web browser.':
		'Hinweis: Die Links werden in deinem Webbrowser geöffnet.',
	...
	'This feature is not yet available in your language.':
		'Diese Funktion ist in deiner Sprache noch nicht verfügbar.',
	...
	'Cookie Clicker is in sleep mode and generating offline cookies.':
		'Cookie Clicker befindet sich im Schlafmodus und erzeugt Offline-Kekse.',
	...
	'(this happens when too many frames are skipped at once,<br>usually when the game has been running in the background for a while)<br>(you can turn this feature off in the settings menu)':
		'(das passiert, wenn zu viele Frames auf einmal übersprungen werden,<br>normalerweise, wenn das Spiel eine Weile im Hintergrund gelaufen ist)<br>(du kannst diese Funktion im Einstellungsmenü ausschalten)',
	'Are you sure you want to close Cookie Clicker?':
		'Bist du sicher, dass du Cookie Clicker schließen möchtest?',
	...
	'Hello again! Just a reminder that you may want to back up your Cookie Clicker save every once in a while, just in case.<br>To do so, go to Options and hit "Export save" or "Save to file"!':
		'Hallo nochmal! Nur zur Erinnerung, dass du deinen Cookie Clicker von Zeit zu Zeit sichern solltest, nur für den Fall der Fälle.<br>Um das zu tun, gehe in die Optionen und klicke auf "Speicherstand exportieren" oder "In Datei speichern"!',
	'Save manually (the game autosaves every 60 seconds; shortcut: ctrl+S)':
		'Manuell speichern (das Spiel speichert automatisch alle 60 Sekunden; Tastenkombination: Strg+S)',
	'You can use this to backup your save or to transfer it to another computer (shortcut for import: ctrl+O)':
		'Damit kannst du deinen Spielstand sichern oder auf einen anderen Computer übertragen (Tastaturkürzel für Import: Strg+O)',
	'Save to file': 'In Datei speichern',
	'Load from file': 'Aus Datei laden',
	'Use this to keep backups on your computer':
		'Verwende dies, um Backups auf deinem Computer aufzubewahren',
	'Export save': 'Spielstand exportieren',
	'This is your save code.<br>Copy it and keep it somewhere safe!':
		'Das ist dein Speichercode.<br>Kopiere ihn und bewahre ihn irgendwo sicher auf!',
	'Import save': 'Speicherstand importieren',
	'Please paste in the code that was given to you on save export.':
		'Bitte füge den Code ein, den du beim Exportieren des Speicherstands erhalten hast.',
	...
	'Oops, looks like the import string is all wrong!':
		'Ups, sieht so aus, als ob der Importcode ganz falsch ist!',
	'You are attempting to load a save from a future version (v. %1; you are using v. %2).':
		'Du versuchst, einen Spielstand aus einer zukünftigen Version zu laden (V. %1; du verwendest V. %2).',
	"Sorry, you can't import saves from the classic version.":
		'Leider kannst du keine Spielstände aus der klassischen Version importieren.',
	'Wipe save': 'Speicherstände löschen',
	'Delete all your progress, including your achievements':
		'Lösche deinen gesamten Fortschritt, einschließlich deiner Erfolge',
	'Do you REALLY want to wipe your save?<br><small>You will lose your progress, your achievements, and your heavenly chips!</small>':
		'Willst du WIRKLICH deinen Spielstand löschen?<br><small>Du wirst deinen Fortschritt, deine Erfolge und deine himmlischen Splitter verlieren!</small>',
	"Whoah now, are you really, <b><i>REALLY</i></b> sure you want to go through with this?<br><small>Don't say we didn't warn you!</small>":
		'Bist du dir wirklich sicher, dass du das wirklich, <b><i>WIRKLICH</i></b> durchziehen willst?<br><small>Sage nicht, wir hätten dich nicht gewarnt!</small>',
	...
	'Only use mods from trusted sources. Some mods may require a game restart to take effect.':
		'Verwende nur Mods aus vertrauenswürdigen Quellen. Einige Mods können einen Neustart des Spiels erfordern, um wirksam zu werden.',
	Enable: 'Aktivieren',
	...
	'This tool allows you to upload new mods to the Steam Workshop.<br>You need to select a mod folder containing a properly-formatted %1 file.<br>See the included sample mods for examples.':
		'Mit diesem Tool kannst du neue Mods in den Steam Workshop hochladen.<br>Du musst einen Mod-Ordner auswählen, der eine richtig formatierte %1-Datei enthält.<br>Beispiele für Mods findest du in den mitgelieferten Beispielen.',
	'Mod data': 'Mod Daten',
	...
	'These are the mods present in your save data. You may delete some of this data to make your save file smaller.':
		'Dies sind die Mods, die in deinen Speicherdaten vorhanden sind. Du kannst einige dieser Daten löschen, um deine Speicherdatei kleiner zu machen.',
	'(loaded)': '(geladen)',
	'%1 char': ['%1 Zeichen', '%1 Zeichen'],
	'Check mod data': 'Mod Daten prüfen',
	'view and delete save data created by mods':
		'Von Mods erstellte Speicherdaten ansehen und löschen',
	...
	'You are currently playing Cookie Clicker on the <b>%1</b> protocol.<br>The <b>%2</b> version uses a different save slot than this one.<br>Click this lock to reload the page and switch to the <b>%2</b> version!':
		'Du spielst gerade Cookie Clicker auf dem <b>%1</b> Protokoll.<br>Die <b>%2</b> Version benutzt einen anderen Speicherplatz als diese.<br>Klicke auf dieses Schloss, um die Seite neu zu laden und zur <b>%2</b> Version zu wechseln!',
	'+%1 more notification.': ['+%1 weitere Benachrichtigung.', '+%1 weitere Benachrichtigungen.'],
	...
	"Because you've baked a <b>billion cookies</b> in total, you are now attracting <b>sugar lumps</b>. They coalesce quietly near the top of your screen, under the Stats button.<br>You will be able to harvest them when they're ripe, after which you may spend them on all sorts of things!":
		'Da du insgesamt eine <b>Milliarde Kekse</b> gebacken habst, ziehst du nun <b>Würfelzucker</b> an. Sie sammeln sich in der Nähe des oberen Bildschirmrandes unter der Schaltfläche "Statistik".<br> Wenn sie reif sind, kannst du sie ernten und für alles Mögliche ausgeben!',
	'A <b>sugar lump</b> is coalescing here, attracted by your accomplishments.':
		'Ein <b>Würfelzucker</b> sammelt sich hier, angezogen von deinen Errungenschaften.',
	'Your sugar lumps mature after <b>%1</b>,<br>ripen after <b>%2</b>,<br>and fall after <b>%3</b>.':
		'Dein Würfelzucker reift nach <b>%1</b>,<br>reift nach <b>%2</b>,<br>und fällt nach <b>%3</b>.',
	...
	'<b>This sugar lump is ripe! Click it to harvest it.</b><br>If you do nothing, it will auto-harvest in <b>%1</b>.':
		'<b>Dieser Würfelzucker ist reif! Klicke ihn an, um ihn zu ernten.</b><br>Wenn du nichts tust, wird er in <b>%1</b> automatisch geerntet.',
	'This sugar lump grew to be <b>bifurcated</b>; harvesting it has a 50% chance of yielding two lumps.':
		'Dieser Würfelzucker ist <b>gegabelt</b> gewachsen; bei der Ernte besteht eine 50%ige Chance, dass er zwei Würfel hervorbringt.',
	'This sugar lump grew to be <b>golden</b>; harvesting it will yield 2 to 7 lumps, your current cookies will be doubled (capped to a gain of 24 hours of your CpS), and you will find 10% more golden cookies for the next 24 hours.':
		'Dieser Würfelzucker ist <b>golden</b> gewachsen; wenn du ihn erntest, erhältst du 2 bis 7 Würfelzucker, deine aktuellen Kekse werden verdoppelt (gedeckelt auf einen Gewinn von 24 Stunden deiner KpS) und du findest 10% mehr goldene Kekse für die nächsten 24 Stunden.',
	'This sugar lump was affected by the elders and grew to be <b>meaty</b>; harvesting it will yield between 0 and 2 lumps.':
		'Dieser Würfelzucker wurde von den Ältesten befallen und ist <b>fleischig</b> geworden; die Ernte wird zwischen 0 und 2 Würfel ergeben.',
	'This sugar lump is <b>caramelized</b>, its stickiness binding it to unexpected things; harvesting it will yield between 1 and 3 lumps and will refill your sugar lump cooldowns.':
		'Dieser Würfelzucker ist <b>karamellisiert</b>, seine Klebrigkeit bindet ihn an unerwartete Dinge; ihn zu ernten ergibt zwischen 1 und 3 Würfel und füllt deine Würfelzucker-Abklingzeiten wieder auf.',
	'You harvested <b>%1</b> while you were away.':
		'Du hast <b>%1</b> geerntet, während du weg warst.',
	'Sugar blessing activated!': 'Zuckersegen aktiviert!',
	'Your cookies have been doubled.<br>+10% golden cookies for the next 24 hours.':
		'Deine Kekse wurden verdoppelt.<br>+10% goldene Kekse für die nächsten 24 Stunden.',
	...
	Heralds: 'Herolde',
	'%1 herald': ['%1 Herold', '%1 Herolde'],
	"Heralds couldn't be loaded. There may be an issue with our servers, or you are playing the game locally.":
		'Herolde konnten nicht geladen werden. Möglicherweise gibt es ein Problem mit unseren Servern, oder du spielst das Spiel lokal.',
	'There are no heralds at the moment. Please consider <b>donating to our Patreon</b>!':
		'Im Moment gibt es keine Herolde. Bitte erwäge eine <b>Spende für unser Patreon</b>!',
	'selflessly inspiring a boost in production for everyone, resulting in %1.':
		'selbstlos einen Produktionsschub für alle inspiriert, was zu %1 führt.',
	'+%1% cookies per second': '+%1% Kekse pro Sekunde',
	'You are in a <b>Born again</b> run, and are not currently benefiting from heralds.':
		'Du befindest dich in einem <b>Wiedergeboren</b>-Run und profitierst derzeit nicht von Herolden.',
	'You own the <b>Heralds</b> upgrade, and therefore benefit from the production boost.':
		'Du besitzt das Upgrade <b>Herolde</b> und profitierst daher von dem Produktionsschub.',
	'To benefit from the herald bonus, you need a special upgrade you do not yet own. You will permanently unlock it later in the game.':
		'Um vom Herold-Bonus zu profitieren, benötigst du ein spezielles Upgrade, das du noch nicht besitzt. Du wirst es später im Spiel dauerhaft freischalten.',
	'<b>Heralds</b> are people who have donated to our highest Patreon tier, and are limited to 100.<br>Each herald gives everyone +1% CpS.<br>Heralds benefit everyone playing the game, regardless of whether you donated.':
		'<b>Herald</b> sind Leute, die für unseren höchsten Patreon-Tier gespendet haben und auf 100 begrenzt sind.<br>Jeder Herold gibt jedem +1% KpS.<br>Heralds kommen jedem zugute, der das Spiel spielt, unabhängig davon, ob du gespendet hast.',
	'Every %1 current players on Steam generates <b>1 herald</b>, up to %2 heralds.<br>Each herald gives everyone +1% CpS.':
		'Jeder %1 aktuelle Spieler auf Steam erzeugt <b>1 Herold</b>, bis zu %2 Herolde.<br>Jeder Herold gibt jedem +1% KpS.',
	'+%1!': '/',
	...
	'Sweet!<br><small>Found 1 sugar lump!</small>':
		'Süß! <br><small>Stück Würfelzucker gefunden!</small>',
	'Lucky!': 'Glück!',
	'Ruin!': '/',
	...
	'Cookie chain broken.<br><small>You made %1.</small>':
		'Keks Kette gebrochen.<br><small>Du hast %1 verdient.</small>',
	'Cookie blab': [
	...
	'Lets you use two dragon auras simultaneously':
		'Lässt dich zwei Drachenauren gleichzeitig benutzen',
	...
	'Select an aura from those your dragon knows.':
		'Wähle eine Aura aus denen, die dein Drache kennt.',
	'<b>One tenth</b> of every other dragon aura, <b>combined</b>.':
		'<b>Ein Zehntel</b> von jeder anderen Drachenaura, <b>kombiniert</b>.',
	'Switching your aura is <b>free</b> because you own no buildings.':
		'Der Wechsel deiner Aura ist <b>kostenlos</b>, da du keine Gebäude besitzt.',
	'The cost of switching your aura is <b>%1</b>.<br>This will affect your CpS!':
		'Die Kosten für das Wechseln deiner Aura betragen <b>%1</b>.<br>Dies wird sich auf deine KpS auswirken!',
	...
	'You feel like making cookies. But nobody wants to eat your cookies.':
		'Du hast Lust, Kekse zu backen. Aber niemand will deine Kekse essen.',
	'Your first batch goes to the trash. The neighborhood raccoon barely touches it.':
		'Deine erste Ladung wandert in den Müll. Der Waschbär aus der Nachbarschaft rührt sie kaum an.',
	'Your family accepts to try some of your cookies.':
		'Deine Familie akzeptiert es, einige deiner Kekse zu probieren.',
	'Your cookies are popular in the neighborhood.':
		'Deine Kekse sind in der Nachbarschaft sehr beliebt.',
	'People are starting to talk about your cookies.':
		'Die Leute fangen an, über deine Kekse zu reden.',
	...
	'Your cookies sell very well in distant countries.':
		'Deine Kekse verkaufen sich sehr gut in fernen Ländern.',
	'People come from very far away to get a taste of your cookies.':
		'Die Leute kommen von sehr weit her, um deine Kekse zu probieren.',
	'Kings and queens from all over the world are enjoying your cookies.':
		'Könige und Königinnen aus der ganzen Welt erfreuen sich an deinen Keksen.',
	'There are now museums dedicated to your cookies.':
		'Es gibt jetzt Museen, die deinen Keksen gewidmet sind.',
	'A national day has been created in honor of your cookies.':
		'Zu Ehren deiner Kekse wurde ein nationaler Tag ins Leben gerufen.',
	'Your cookies have been named a part of the world wonders.':
		'Deine Kekse wurden zu einem Teil der Weltwunder ernannt.',
	'History books now include a whole chapter about your cookies.':
		'Geschichtsbücher enthalten jetzt ein ganzes Kapitel über deine Kekse.',
	'Your cookies have been placed under government surveillance.':
		'Deine Kekse wurden unter staatliche Überwachung gestellt.',
	...
	'Strange creatures from neighboring planets wish to try your cookies.':
		'Seltsame Kreaturen von benachbarten Planeten wollen deine Kekse probieren.',
	'Elder gods from the whole cosmos have awoken to taste your cookies.':
		'Ältere Götter aus dem ganzen Kosmos sind erwacht, um deine Kekse zu kosten.',
	'Beings from other dimensions lapse into existence just to get a taste of your cookies.':
		'Wesen aus anderen Dimensionen verfallen in die Existenz, nur um in den Genuss deiner Kekse zu kommen.',
	...
	'The universe has now turned into cookie dough, to the molecular level.':
		'Das Universum hat sich nun in Keksteig verwandelt, bis auf die molekulare Ebene.',
	'Your cookies are rewriting the fundamental laws of the universe.':
		'Deine Kekse schreiben die fundamentalen Gesetze des Universums neu.',
	'A local news station runs a 10-minute segment about your cookies. Success!<br><small>(you win a cookie)</small>':
		'Ein lokaler Nachrichtensender bringt einen 10-minütigen Beitrag über deine Kekse. Erfolg!<br><small>(du gewinnst einen Keks)</small>',
	...
	'You gain <b>one hour</b> of your CpS (capped at double your bank).':
		'Du erhältst <b>eine Stunde</b> deiner KpS (gedeckelt auf das Doppelte deiner Bank).',
	...
	'Your prestige level is currently <b>%1</b>.<br>(CpS +%2%)':
		'Dein Prestigelevel ist derzeit <b>%1</b>.<br>(KpS +%2%)',
	'Ascending now would grant you no prestige.':
		'Jetzt aufzusteigen würde dir kein Prestige einbringen.',
	'Ascending now would grant you<br><b>1 prestige level</b> (+1% CpS)<br>and <b>1 heavenly chip</b> to spend.':
		'Der Aufstieg würde dir<br><b>1 Prestigelevel</b> (+1% KpS)<br>und <b>1 himmlischen Splitter</b> zum Ausgeben geben.',
	'Ascending now would grant you<br><b>%1 prestige levels</b> (+%2% CpS)<br>and <b>%3 heavenly chips</b> to spend.':
		'Der Aufstieg jetzt würde dir<br><b>%1 Prestigelevel</b> (+%2% KpS)<br>und <b>%3 himmlische Splitter</b> zum Ausgeben geben.',
	'You need <b>%1 more cookies</b> for the next level.':
		'Du brauchst <b>%1 weitere Kekse</b> für das nächste Level.',
	'Do you REALLY want to ascend?<div class="line"></div>You will lose your progress and start over from scratch.<div class="line"></div>All your cookies will be converted into prestige and heavenly chips.':
		'Willst du WIRKLICH aufsteigen?<div class="line"></div>Du wirst deinen Fortschritt verlieren und von vorne beginnen.<div class="line"></div>Alle deine Kekse werden in Prestige und himmlische Splitter umgewandelt.',
	...
	'You will keep your achievements, building levels and sugar lumps.':
		'Du behältst deine Erfolge, Gebäudelevel und Würfelzucker.',
	...
	'%1 prestige level': ['%1 Prestigelevel', '%1 Prestigelevel'],
	...
	"You are ascending.<br>Drag the screen around<br>or use arrow keys!<br>When you're ready,<br>click Reincarnate.":
		'Du steigst auf.<br>Ziehe den Bildschirm herum<br>oder benutze die Pfeiltasten!<br>Wenn du bereit bist,<br>klicke Reinkarnation.',
	'Each prestige level grants you a permanent <b>+%1% CpS</b>.<br>The more levels you have, the more cookies they require.':
		'Jedes Prestigelevel gewährt dir einen permanenten <b>+%1% KpS</b>.<br>Je mehr Level du hast, desto mehr Kekse benötigen sie.',
	'Heavenly chips are used to buy heavenly upgrades.<br>You gain <b>1 chip</b> every time you gain a prestige level.':
		'Himmlische Splitter werden verwendet, um himmlische Upgrades zu kaufen.<br>Du erhältst <b>1 Splitter</b> jedes Mal, wenn du ein Prestigelevel gewinnst.',
	"Click this once you've bought<br>everything you need!":
		'Klicke hier, sobald du alles gekauft hast,<br> was du brauchst!',
	'Are you ready to return to the mortal world?':
		'Bist du bereit für die Rückkehr in die Welt der Sterblichen?',
	...
	'Challenge modes apply special modifiers to your next ascension.<br>Click to change.':
		'Herausforderungsmodi wenden spezielle Modifikatoren auf deinen nächsten Aufstieg an.<br>Klicke zum Ändern.',
	...
	"It's <b>Valentine's season</b>!<br>Love's in the air and cookies are just that much sweeter!":
		'Es ist <b>Valentinssaison</b>!<br>Liebe liegt in der Luft und Kekse sind einfach viel süßer!',
	'Business Day!': 'Tag der Arbeit!',
	"It's <b>Business season</b>!<br>Don't panic! Things are gonna be looking a little more corporate for a few days.":
		'Es ist <b>der Tag der Arbeit</b>!<br>Keine Panik! Die Dinge werden für ein paar Tage ein wenig geselliger aussehen.',
	'Halloween!': '/',
	"It's <b>Halloween season</b>!<br>Everything is just a little bit spookier!":
		'Es ist <b>Halloween</b>!<br>Alles ist ein bisschen gruseliger!',
	...
	"It's <b>Christmas season</b>!<br>Bring good cheer to all and you just may get cookies in your stockings!":
		'Es ist <b>Weihnachtszeit</b>!<br>Bringt gute Laune für alle und ihr bekommt vielleicht Kekse in eure Strümpfe!',
	'Easter!': 'Ostern!',
	"It's <b>Easter season</b>!<br>Keep an eye out and you just might click a rabbit or two!":
		'Es ist <b>Ostersaison</b>!<br>Halte die Augen offen und vielleicht klickst du ein oder zwei Kaninchen!',
	...
	'Upgrade is vaulted and will not be auto-purchased.':
		'Das Upgrade ist gesichert und wird nicht automatisch nachgekauft.',
	...
	'Will <b>instantly purchase</b> every upgrade you can afford, starting from the cheapest one.<br>Upgrades in the <b>vault</b> will not be auto-purchased.<br>You may place an upgrade into the vault by <b>Shift-clicking</b> on it.':
		'Kauft sofort jedes Upgrade, das du dir leisten kannst, beginnend mit dem billigsten.<br>Upgrades im <b>Tresor</b> werden nicht automatisch gekauft.<br> Du kannst ein Upgrade in den Tresor legen, indem du mit der <b>Umschalttaste</b> auf es klickst.',
	...
	'all combined, these boosts account for <b>%1</b> per second (<b>%2%</b> of total CpS)':
		'alle zusammen machen diese Verstärkungen <b>%1</b> pro Sekunde aus (<b>%2%</b> der gesamten KpS)',
	'owned: %1': 'In Besitz: %1',
	'free: %1!': 'Frei: %1!',
	'Level %1 %2': '/',
	...
	'Levelling up this building unlocks a minigame.':
		'Wenn du dieses Gebäude auflevelst, schaltest du ein Minispiel frei.',
	...
	'Names in white were submitted by our supporters on Patreon.':
		'Die Namen in weiß wurden von unseren Unterstützern auf Patreon eingereicht.',
	'You can also press %1 to bulk-buy or sell %2 of a building at a time, or %3 for %4.':
		'Du kannst auch %1 drücken, um %2 eines Gebäudes auf einmal zu kaufen oder zu verkaufen, oder %3 für %4.',
	Investment: '/',
	"You're not sure what this does, you just know it means profit.":
		'Du bist dir nicht sicher, was das bedeutet, du weißt nur, dass es Profit bedeutet.',
	Cursor: '/',
	cursor: 'Cursor',
	cursors: 'Cursor',
	...
	'[Cursor business quote]Essential in flattening dough. The first step in cookie-making.':
		'Unverzichtbar beim Flachdrücken von Teig. Der erste Schritt bei der Herstellung von Keksen.',
	Grandma: 'Oma',
	grandma: 'Oma',
	grandmas: 'Omas',
	'%1 grandma': ['%1 Oma', '%1 Omas'],
	...
	'[Grandma business quote]A crucial element of baking cookies.':
		'Ein entscheidendes Element beim Backen von Keksen.',
	Farm: '/',
	farm: 'Farm',
	farms: 'Farmen',
	'%1 farm': ['%1 Farm', '%1 Farmen'],
	...
	'[Farm business quote]The more kitchens, the more cookies your employees can produce.':
		'Je mehr Küchen, desto mehr Kekse können Ihre Mitarbeiter produzieren.',
	Mine: '/',
	mine: 'Mine',
	mines: 'Minen',
	'%1 mine': ['%1 Mine', '%1 Minen'],
	'[Mine quote]Mines out cookie dough and chocolate chips.':
		'Minen aus Keksteig und Schokoladenchips.',
	...
	'[Mine business quote]These give you the edge you need to outsell those pesky competitors.':
		'Diese geben Ihnen den Vorsprung, den Sie brauchen, um die lästige Konkurrenz auszustechen.',
	Factory: 'Fabrik',
	factory: 'Fabrik',
	factories: 'Fabriken',
	'%1 factory': ['%1 Fabrik', '%1 Fabriken'],
	...
	'[Factory business quote]Mass production is the future of baking. Seize the day, and synergize!':
		'Die Massenproduktion ist die Zukunft des Backens. Nutzen Sie den Tag, und nutzen Sie Synergien!',
	Bank: '/',
	bank: 'Bank',
	banks: 'Banken',
	'%1 bank': ['%1 Bank', '%1 Banken'],
	...
	"[Bank business quote]Business folks with a nose for profit, ready to finance your venture as long as there's money to be made.":
		'Geschäftsleute mit einem Gespür für Profit, die bereit sind, Ihr Projekt zu finanzieren, solange es Geld zu verdienen gibt.',
	Temple: 'Tempel',
	temple: 'Tempel',
	temples: 'Tempel',
	'%1 temple': ['%1 Tempel', '%1 Tempel'],
	...
	'[Temple business quote]Your social media page is going viral! Amassing likes is the key to a lasting online presence and juicy advertising deals.':
		'Ihre Social-Media-Seite geht viral! Das Anhäufen von Likes ist der Schlüssel zu einer dauerhaften Online-Präsenz und saftigen Werbeverträgen.',
	'Wizard tower': 'Zaubererturm',
	'wizard tower': 'Zaubererturm',
	'wizard towers': 'Zauberertürme',
	'%1 wizard tower': ['%1 Zaubererturm', '%1 Zauberertürme'],
	'[Wizard tower quote]Summons cookies with magic spells.':
		'Beschwört Kekse mit Zaubersprüchen herbei.',
	...
	'[Wizard tower business quote]Cookie memes are all the rage! With just the right amount of social media astroturfing, your brand image will be all over the cyberspace.':
		'Keks-Memes sind der letzte Schrei! Mit dem richtigen Maß an Social-Media-Astroturfing wird Ihr Markenimage im gesamten Cyberspace präsent sein.',
	Shipment: 'Verschiffung',
	shipment: 'Verschiffung',
	shipments: 'Verschiffungen',
	'%1 shipment': ['%1 Verschiffung', '%1 Verschiffungen'],
	'[Shipment quote]Brings in fresh cookies from the cookie planet.':
		'Bringt frische Kekse vom Keks-Planeten mit.',
	...
	'[Shipment business quote]A gigantic cookie emporium - your very own retail chain.':
		'Ein gigantisches Keks-Imperium - Deine ganz eigene Handelskette.',
	'Alchemy lab': 'Alchemielabor',
	'alchemy lab': 'Alchemielabor',
	'alchemy labs': 'Alchemielabore',
	'%1 alchemy lab': ['%1 Alchemielabor', '%1 Alchemielabore'],
	...
	"[Alchemy lab business quote]You're officially on the stock market, and everyone wants a piece!":
		'Du bist offiziell an der Börse und jeder will ein Stück!',
	Portal: '/',
	portal: 'Portal',
	portals: 'Portale',
	...
	'[Portal business quote]Your cookies have their own sitcom! Hilarious baking hijinks set to the cheesiest laughtrack.':
		'Deine Kekse haben ihre eigene Sitcom! Urkomische Backstreiche, untermalt mit den lustigsten Lachnummern.',
	'Time machine': 'Zeitmaschine',
	'time machine': 'Zeitmaschine',
	'time machines': 'Zeitmaschinen',
	'%1 time machine': ['%1 Zeitmaschine', '%1 Zeitmaschinen'],
	'[Time machine quote]Brings cookies from the past, before they were even eaten.':
		'Bringt Kekse aus der Vergangenheit mit, bevor sie überhaupt gegessen wurden.',
	...
	'[Time machine business quote]Cookie theme parks, full of mascots and roller-coasters. Build one, build a hundred!':
		'Keks-Themenparks, voll mit Maskottchen und Achterbahnen. Baue einen, baue hundert!',
	'Antimatter condenser': 'Antimaterie-Kondensator',
	'antimatter condenser': 'Antimaterie-Kondensator',
	'antimatter condensers': 'Antimaterie-Kondensatoren',
	'%1 antimatter condenser': ['%1 Antimaterie-Kondensator', '%1 Antimaterie-Kondensatoren'],
	'[Antimatter condenser quote]Condenses the antimatter in the universe into cookies.':
		'Kondensiert die Antimaterie im Universum zu Keksen.',
	...
	'[Antimatter condenser business quote]A virtual currency, already replacing regular money in some small countries.':
		'Eine virtuelle Währung, die in einigen kleinen Ländern bereits das reguläre Geld ersetzt.',
	Prism: 'Prisma',
	prism: 'Prisma',
	prisms: 'Prismen',
	'%1 prism': ['%1 Prisma', '%1 Prismen'],
	...
	"[Prism business quote]You've made it to the top, and you can now buy entire nations to further your corporate greed. Godspeed.":
		'Du hast es an die Spitze geschafft und kannst nun ganze Nationen kaufen, um deine Konzerngier zu fördern. Viel Glück!',
	Chancemaker: 'Glücksbringer',
	chancemaker: 'Glücksbringer',
	chancemakers: 'Glücksbringer',
	'%1 chancemaker': ['%1 Glücksbringer', '%1 Glücksbringer'],
	'[Chancemaker quote]Generates cookies out of thin air through sheer luck.':
		'Generiert Kekse aus dem Nichts durch reines Glück.',
	...
	"[Chancemaker business quote]Actually, you know what's cool? A whole planet dedicated to producing, advertising, selling, and consuming your cookies.":
		'Weißt du eigentlich, was cool ist? Ein ganzer Planet, der sich der Produktion, der Werbung, dem Verkauf und dem Verzehr deiner Kekse widmet.',
	'Fractal engine': 'Fraktalmaschine',
	'fractal engine': 'Fraktalmaschine',
	'fractal engines': 'Fraktalmaschinen',
	'%1 fractal engine': ['%1 Fraktalmaschine', '%1 Fraktalmaschinen'],
	'[Fractal engine quote]Turns cookies into even more cookies.':
		'Verwandelt Kekse in noch mehr Kekse.',
	...
	'[Fractal engine business quote]Only through political dominion can you truly alter this world to create a brighter, more cookie-friendly future.':
		'Nur durch politische Herrschaft kannst du diese Welt wirklich verändern, um eine hellere, Keks-freundlichere Zukunft zu schaffen.',
	'Javascript console': 'Javascript Konsole',
	'javascript console': 'Javascript Konsole',
	'javascript consoles': 'Javascript Konsolen',
	'%1 javascript console': ['%1 Javascript Konsole', '%1 Javascript Konsolen'],
	'[Javascript console quote]Creates cookies from the very code this game was written in.':
		'Erzeugt Kekse aus dem Code, in dem dieses Spiel geschrieben wurde.',
	...
	"[Idleverse quote]There's been countless other idle universes running alongside our own. You've finally found a way to hijack their production and convert whatever they've been making into cookies!":
		'Es gab schon unzählige andere Universen, die neben unserem liefen. Du hast endlich einen Weg gefunden, ihre Produktion zu kapern und das, was sie hergestellt haben, in Kekse zu verwandeln!',
	...
	'[Idleverse business quote]Sometimes the best way to keep going up is sideways. Diversify your ventures through non-cookie investments.':
		'Manchmal ist der beste Weg, um weiter nach oben zu kommen, seitwärts. Diversifiziere deine Unternehmungen durch Investitionen, die nicht auf Keksen basieren.',
	'Cortex baker': 'Kortex Bäcker',
	'cortex baker': 'Kortex-Bäcker',
	'cortex bakers': 'Kortex-Bäcker',
	'%1 cortex baker': ['%1 Kortex Bäcker', '%1 Kortex-Bäcker'],
	'[Cortex baker quote]These artificial brains the size of planets are capable of simply dreaming up cookies into existence. Time and space are inconsequential. Reality is arbitrary.':
		'Diese künstlichen Gehirne von der Größe eines Planeten sind in der Lage, Kekse einfach ins Leben zu träumen. Zeit und Raum sind unwichtig. Die Realität ist willkürlich.',
	...
	"[Cortex baker business quote]There's only so many ways you can bring in more profit. Or is there? Hire the most brilliant experts in the known universe and let them scrape their brains for you!":
		'Es gibt nur wenige Möglichkeiten, wie du mehr Gewinn machen kannst. Oder doch nicht? Engagiere die brillantesten Experten des bekannten Universums und lass sie sich für dich das Hirn zermartern!',
	CpS: 'KpS',
	...
	'All cookie production <b>multiplied by %1</b>.':
		'Alle Keks-Produktion <b>multipliziert mit %1</b>.',
	'+%1 CpS': '+%1 KpS',
	...
	'Tiered upgrades for <b>%1</b> provide an extra <b>+%2%</b> production.<br>Only works with unshackled upgrade tiers.':
		'Stufenweise Upgrades für <b>%1</b> bieten eine zusätzliche <b>+%2%</b> Produktion.<br> Funktioniert nur mit nicht gefesselten Upgrade-Stufen.',
	'Unshackles all <b>%1-tier upgrades</b>, making them more powerful.<br>Only applies to unshackled buildings.':
		'Entfesselt alle <b>%1-Tier Upgrades</b> und macht sie mächtiger.<br>Gilt nur für nicht gefesselte Gebäude.',
	'The mouse and cursors are <b>twice</b> as efficient.':
		'Die Maus und die Cursor sind <b>zweimal</b> so effizient.',
	'The mouse and cursors gain <b>+%1</b> cookies for each non-cursor building owned.':
		'Die Maus und die Cursor erhalten <b>+%1</b> Kekse für jedes Gebäude, das kein Cursor ist.',
	'Grandmas gain <b>+%1% CpS</b> for each non-grandma building.':
		'Omas erhalten <b>+%1% KpS</b> für jedes Nicht-Oma-Gebäude.',
	'You gain <b>more CpS</b> the more milk you have.':
		'Du bekommst <b>mehr KpS</b>, je mehr Milch du hast.',
	...
	'Cookie production multiplier <b>+%1% permanently</b>.':
		'Keks-Produktionsmultiplikator <b>+%1% dauerhaft</b>.',
	"Cookie production multiplier <b>+%1% per Santa's levels.</b>":
		'Keks-Produktionsmultiplikator <b>+%1% pro Stufe des Weihnachtsmanns.</b>',
	'Cookie production multiplier <b>+%1%</b> for every year Cookie Clicker has existed (currently: <b>+%2%</b>).':
		'Keks-Produktionsmultiplikator <b>+%1%</b> für jedes Jahr, in dem Cookie Clicker existiert (aktuell: <b>+%2%</b>).',
	'Cookie production multiplier <b>+%1%</b> for every building type level %2 or higher.':
		'Keks-Produktionsmultiplikator <b>+%1%</b> für jedes Gebäude der Stufe %2 oder höher.',
	...
	'Grandma-operated science lab and leisure club.<br>Grandmas are <b>4 times</b> as efficient.<br><b>Regularly unlocks new upgrades</b>.':
		'Oma-betriebenes Wissenschaftslabor und Freizeitclub. <br>Omas sind <b>4 mal</b> so effizient.<br><b>Schaltet regelmäßig neue Upgrades frei</b>.',
	...
	'Note: the grandmothers are growing restless. Do not encourage them.':
		'Beachte: Die Omas werden unruhig. Ermutige sie nicht.',
	'Note: proceeding any further in scientific research may have unexpected results. You have been warned.':
		'Hinweis: Wenn du in der wissenschaftlichen Forschung weitermachst, kann das zu unerwarteten Ergebnissen führen. Du wurdest gewarnt.',
	...
	"<b>Warning:</b> purchasing this will have unexpected, and potentially undesirable results!<br><small>It's all downhill from here. You have been warned!</small><br><br>Purchase anyway?":
		'<b>Warnung:</b> Der Kauf wird unerwartete und möglicherweise unerwünschte Folgen haben!<br><small> Von hier an geht es nur noch bergab. Du wurdest gewarnt!</small><br><br>Trotzdem kaufen?',
	'Contains the wrath of the elders, at least for a while.':
		'Hält den Zorn der Alten in Schach, zumindest eine Zeit lang.',
	"Puts a permanent end to the elders' wrath, at the cost of %1% of your CpS.":
		'Setzt dem Zorn der Alten ein dauerhaftes Ende, auf Kosten von %1% deiner KpS.',
	'You will get %1% of your CpS back, but the grandmatriarchs will return.':
		'Du wirst %1% deiner KpS zurückbekommen, aber die Großmatriarchen werden zurückkehren.',
	...
	'Golden cookies appear <b>twice as often</b> and stay <b>twice as long</b>.':
		'Goldene Kekse erscheinen <b>doppelt so oft</b> und bleiben <b>doppelt so lange</b>.',
	...
	'Golden cookies appear <b>%1%</b> more often during %2.':
		'Goldene Kekse erscheinen <b>%1%</b> öfters während %2.',
	...
	'Golden cookie effects last <b>twice as long</b>.':
		'Die Effekte des goldenen Kekses halten <b>zweifach so lange</b>.',
	'Golden cookie effects last <b>%1%</b> longer.':
		'Die Effekte des goldenen Kekses halten <b>%1%</b> länger an.',
	...
	'<b>+%1% CpS</b> per golden cookie on-screen, multiplicative.':
		'<b>+%1% KpS</b> pro goldenen Keks auf dem Bildschirm, multiplikativ.',
	'With no buffs and no golden cookies on screen, selling your most powerful building has <b>%1% chance to summon one</b>.':
		'Ohne Buffs und ohne goldene Kekse auf dem Bildschirm hat der Verkauf deines mächtigsten Gebäudes eine <b>%1%ige Chance, einen zu beschwören</b>.',
	'Confers various powers to your minigames while active.<br>See the bottom of each minigame for more details.':
		'Verleiht deinen Minispielen verschiedene Kräfte, während sie aktiv sind.<br>Siehe das Ende jedes Minispiels für weitere Details.',
	...
	'Can toggle upgrades on and off at will in the stats menu.':
		'Kann Upgrades nach Belieben im Statistikmenü ein- und ausschalten.',
	'You keep producing cookies even while the game is closed.':
		'Du produzierst weiterhin Kekse, auch wenn das Spiel geschlossen ist.',
	'Unlocks <b>%1%</b> of the potential of your prestige level.':
		'Schaltet <b>%1%</b> des Potenzials deines Prestigelevels frei.',
	'Subsequent research will be <b>%1 times</b> as fast.':
		'Die anschließende Forschung wird <b>%1 mal</b> so schnell sein.',
	...
	'Wrinklers explode into <b>%1% more cookies</b>.':
		'Falter explodieren zu <b>%1% mehr Keksen</b>.',
	...
	'Cost scales with how many eggs you own.':
		'Die Kosten hängen davon ab, wie viele Eier du besitzt.',
	...
	'Buildings sell back for <b>%1%</b> instead of %2%.':
		'Gebäude verkaufen sich wieder für <b>%1%</b> statt %2%.',
	...
	'All buildings and upgrades are <b>%1% cheaper</b>.':
		'Alle Gebäude und Upgrades sind <b>%1% günstiger</b>.',
	'%1 are <b>%2%</b> more efficient and <b>%3%</b> cheaper.':
		'%1 sind <b>%2%</b> effizienter und <b>%3%</b> billiger.',
	...
	'Allows you to <b>trigger seasonal events</b> at will, for a price.':
		'Erlaubt es dir, nach Belieben <b>saisonale Ereignisse</b> auszulösen, gegen einen Preis.',
	'Triggers <b>%1 season</b> for the next 24 hours.<br>Triggering another season will cancel this one.<br>Cost scales with unbuffed CpS and increases with every season switch.':
		'Löst die <b>%1 Jahreszeit</b> für die nächsten 24 Stunden aus.<br>Das Auslösen einer anderen Jahreszeit bricht diese ab.<br>Die Kosten skalieren mit ungepufferten KpS und erhöhen sich mit jedem Saisonwechsel.',
	...
	"You haven't switched seasons this ascension yet.":
		'Du hast die Jahreszeiten noch nicht gewechselt in diesem Aufstieg.',
	"You've switched seasons <b>once</b> this ascension.":
		'Du hast in diesem Aufstieg <b>einmal</b> die Jahreszeiten gewechselt.',
	"You've switched seasons <b>%1 times</b> this ascension.":
		'Du hast in diesem Aufstieg <b>%1 Mal</b> die Jahreszeit gewechselt.',
	...
	"You continually gain <b>more CpS the longer you've played</b> in the current ascension.":
		'Du erhältst kontinuierlich <b>mehr KpS, je länger du im aktuellen Aufstieg gespielt hast</b>.',
	...
	'Contains an assortment of rich butter cookies.':
		'Enthält ein Sortiment an reichhaltigen Butter Keksen.',
	...
	'Placing an upgrade in this slot will make its effects <b>permanent</b> across all playthroughs.':
		'Wenn du ein Upgrade in diesen Slot legst, werden seine Effekte über alle Durchgänge hinweg <b>permanent</b>.',
	...
	'Here are all the upgrades you\'ve purchased last playthrough.<div class="line"></div>Pick one to permanently gain its effects!<div class="line"></div>You can reassign this slot anytime you ascend.':
		'Hier sind alle Upgrades, die du im letzten Playthrough gekauft hast.<div class="line"></div>Wähle eines aus, um seine Effekte dauerhaft zu erhalten!<div class="line"></div>Diesen Slot kannst du jederzeit neu zuweisen, wenn du aufsteigst.',
	'You now <b>keep making cookies while the game is closed</b>, at the rate of <b>%1%</b> of your regular CpS and up to <b>1 hour</b> after the game is closed.<br>(Beyond 1 hour, this is reduced by a further %2% - your rate goes down to <b>%3%</b> of your CpS.)':
		'Du stellst nun <b>weiterhin Kekse her, während das Spiel geschlossen ist</b>, und zwar mit einer Rate von <b>%1%</b> deiner regulären KpS und bis zu <b>1 Stunde</b>, nachdem das Spiel geschlossen wurde.<br>(Jenseits von 1 Stunde wird diese Rate um weitere %2% reduziert - deine Rate sinkt auf <b>%3%</b> deiner KpS.)',
	'You gain another <b>+%1%</b> of your regular CpS while the game is closed.':
		'Du erhältst einen weiteren <b>+%1%</b> deiner regulären KpS, während das Spiel geschlossen ist.',
	'You gain another <b>+%1%</b> of your regular CpS while the game is closed, for a total of <b>%2%</b>.':
		'Du erhältst weitere <b>+%1%</b> deiner regulären KpS, während das Spiel geschlossen ist, für insgesamt <b>%2%</b>.',
	...
	'Allows you to purchase a <b>crumbly egg</b> once you have earned 1 million cookies.':
		'Ermöglicht es dir, ein <b>Krümel-Ei</b> zu kaufen, sobald du 1 Million Kekse verdient hast.',
	...
	'You retain optimal cookie production while the game is closed for <b>%1 more days</b>.':
		'Du behältst die optimale Keks-Produktion, während das Spiel für <b>%1 weitere Tage</b> geschlossen ist.',
	'You retain optimal cookie production while the game is closed for twice as long, for a total of <b>%1</b>.':
		'Du behältst die optimale Keks-Produktion, während das Spiel doppelt so lange geschlossen ist, für insgesamt <b>%1</b>.',
	'Unlocks the <b>golden switch</b>, which passively boosts your CpS by %1% but disables golden cookies.':
		'Schaltet den <b>goldenen Schalter</b> frei, der deine KpS passiv um %1% erhöht, aber goldene Kekse deaktiviert.',
	'Turning this on will give you a passive <b>+%1% CpS</b>, but prevents golden cookies from spawning.<br>Cost is equal to 1 hour of production.':
		'Wenn du dies aktivierst, erhältst du einen passiven <b>+%1% KpS</b>, verhinderst aber das Spawnen von goldenen Keksen.<br>Die Kosten entsprechen 1 Stunde Produktion.',
	'The switch is currently giving you a passive <b>+%1% CpS</b>; it also prevents golden cookies from spawning.<br>Turning it off will revert those effects.<br>Cost is equal to 1 hour of production.':
		'Der Schalter gibt dir derzeit einen passiven <b>+%1% KpS</b>; er verhindert auch, dass goldene Kekse spawnen.<br>Wenn du ihn ausschaltest, werden diese Effekte wieder rückgängig gemacht.<br>Die Kosten entsprechen 1 Stunde Produktion.',
	'Unlocks the <b>milk selector</b>, letting you pick which milk is displayed under your cookie.<br>Comes with a variety of basic flavors.':
		'Schaltet den <b>Milch-Auswahlschalter</b> frei, mit dem du auswählen kannst, welche Milch unter deinem Keks angezeigt wird.<br>Erhältlich mit einer Vielzahl von Grundgeschmacksrichtungen.',
	'Contains more exotic flavors for your milk selector.':
		'Enthält mehr exotische Geschmacksrichtungen für deinen Milchselektor.',
	'Lets you pick what flavor of milk to display.':
		'Lässt dich auswählen, welche Geschmacksrichtung der Milch angezeigt werden soll.',
	'Unlocks the <b>golden cookie sound selector</b>, which lets you pick whether golden cookies emit a sound when appearing or not.':
		'Schaltet den <b>Goldenen Keks-Sound-Selektor</b> frei, mit dem du auswählen kannst, ob goldene Kekse beim Erscheinen einen Ton von sich geben oder nicht.',
	'Lets you change the sound golden cookies make when they spawn.':
		'Lässt dich das Geräusch ändern, das goldene Kekse machen, wenn sie spawnen.',
	'No sound': 'Kein Ton',
	Chime: 'Glockenschlag',
	Fortune: 'Fortuna',
	Cymbal: '/',
	...
	'Unlocks the <b>jukebox</b>, which allows you to play through every sound file in the game.':
		'Schaltet die <b>Jukebox</b> frei, mit der du alle Sounddateien im Spiel durchspielen kannst.',
	...
	"Unlocks the <b>background selector</b>, letting you select the game's background.<br>Comes with a variety of basic flavors.":
		'Schaltet den <b>Hintergrundselektor</b> frei, mit dem du den Hintergrund des Spiels auswählen kannst.<br>Es gibt eine Vielzahl von Grundvarianten.',
	'Lets you pick which wallpaper to display.':
		'Lässt dich auswählen, welches Hintergrundbild angezeigt werden soll.',
	...
	'While the golden switch is on, you gain an additional <b>+%1% CpS</b> per golden cookie upgrade owned.':
		'Solange der goldene Schalter eingeschaltet ist, erhältst du zusätzlich <b>+%1% KpS</b> pro Upgrade für den goldenen Keks.',
	...
	'Unlocks a new tier of upgrades that affect <b>2 buildings at the same time</b>.<br>Synergies appear once you have <b>%1</b> of both buildings.':
		'Schaltet eine neue Stufe von Upgrades frei, die <b>2 Gebäude gleichzeitig</b> betreffen.<br>Synergien erscheinen, sobald du <b>%1</b> von beiden Gebäuden hast.',
	'Golden cookies (and all other things that spawn, such as reindeer) have <b>%1% chance of being doubled</b>.':
		'Goldene Kekse (und alle anderen Dinge, die spawnen, wie z.B. Rentiere) haben eine <b>%1%ige Chance, verdoppelt zu werden</b>.',
	'Cookie production <b>reduced to 0</b>.': 'Keks-Produktion <b>auf 0</b> reduziert.',
	'Sugar lumps coalesce <b>a whole lot faster</b>.':
		'Würfelzucker koaleszieren <b>viel schneller</b>.',
	...
	'<b>+%1%</b> prestige level effect on CpS.<br><b>+%2%</b> golden cookie effect duration.<br><b>+%3%</b> golden cookie lifespan.':
		'<b>+%1%</b> Prestigelevel-Effekt auf KpS.<br><b>+%2%</b> Effektdauer des goldenen Kekses.<br><b>+%3%</b> Lebensdauer des goldenen Kekses.',
	'Each unspent sugar lump (up to %1) gives <b>+%2% CpS</b>.<div class="warning">Note: this means that spending sugar lumps will decrease your CpS until they grow back.</div>':
		'Jeder nicht ausgegebene Würfelzucker (bis zu %1) gibt <b>+%2% KpS</b>.</div>Hinweis: Das bedeutet, dass das Ausgeben von Würfelzucker deine KpS verringert, bis sie nachwachsen.</div>',
	'Once an ascension, you may use the "Sugar frenzy" switch to <b>triple your CpS</b> for 1 hour, at the cost of <b>1 sugar lump</b>.':
		'Einmal pro Aufstieg kannst du den "Zuckerrausch"-Schalter benutzen, um deine KpS</b> für 1 Stunde zu verdreifachen, zum Preis von <b>1 Würfelzucker</b>.',
	'Each grandma (up to %1) makes sugar lumps ripen <b>%2</b> sooner.':
		'Jede Oma (bis zu %1) lässt Würfelzucker <b>%2</b> früher reifen.',
	'Activating this will <b>triple your CpS</b> for 1 hour, at the cost of <b>1 sugar lump</b>.':
		'Wenn du dies aktivierst, <b>verdreifacht sich deine KpS</b> für 1 Stunde, auf Kosten von <b>1 Würfelzucker</b>.',
	...
	'Garden plants grow every second.<br>Garden seeds are free to plant.<br>You can switch soils at any time.':
		'Gartenpflanzen wachsen im Sekundentakt.<br>Gartensamen sind frei zum Einpflanzen.<br>Du kannst jederzeit die Erde wechseln.',
	...
	'Sugar lumps are <b>twice as likely</b> to be unusual.':
		'Würfelzucker sind <b>zweifach so wahrscheinlich</b>, dass sie ungewöhnlich sind.',
	...
	'Bifurcated sugar lumps appear <b>%1% more often</b> and are <b>%2% more likely</b> to drop 2 lumps.':
		'Gegabelte Würfelzucker treten <b>%1% häufiger</b> auf und sind <b>%2% wahrscheinlicher</b>, dass 2 Würfel fallen.',
	'Mouse over a wrinkler to see how many cookies are in its stomach.':
		'Fahre mit der Maus über einen Falter, um zu sehen, wie viele Kekse in seinem Magen sind.',
	'Unlocks the <b>Buy all</b> feature, which lets you instantly purchase every upgrade in your store (starting from the cheapest one).<br>Also unlocks the <b>Vault</b>, a store section where you can place upgrades you do not wish to auto-buy.':
		'Schaltet die Funktion <b>Alles kaufen</b> frei, mit der du sofort alle Upgrades in deinem Laden kaufen kannst (beginnend mit dem billigsten).<br> Außerdem wird der <b>Vault</b> freigeschaltet, ein Ladenbereich, in dem du Upgrades platzieren kannst, die du nicht automatisch kaufen möchtest.',
	'Mouse over an upgrade to see its tier.<br><small>Note: only some upgrades have tiers. Tiers are purely cosmetic and have no effect on gameplay.</small>':
		'Fahre mit der Maus über ein Upgrade, um dessen Stufe zu sehen.<br><small>Hinweis: Nur einige Upgrades haben Stufen. Die Ränge sind rein kosmetisch und haben keinen Einfluss auf das Gameplay.</small>',
	'You now benefit from the boost provided by <b>heralds</b>.<br>Each herald gives you <b>+1% CpS</b>.<br>Look on the purple flag at the top to see how many heralds are active at any given time.':
		'Du profitierst nun vom Boost der <b>Herolde</b>.<br>Jeder Herold gibt dir <b>+1% KpS</b>.<br>Sieh auf die lila Fahne oben, um zu sehen, wie viele Herolde zu einem bestimmten Zeitpunkt aktiv sind.',
	'Seasonal random drops have a <b>1/5 chance</b> to carry over through ascensions.':
		'Saisonale Zufallsdrops haben eine <b>1/5 Chance</b>, sich durch Aufstiege zu übertragen.',
	"Unlocks <b>extra price information</b>.<br>Each displayed cost now specifies how long it'll take you to afford it, and how much of your bank it represents.":
		'Schaltet <b>zusätzliche Preisinformationen</b> frei.<br>Jeder angezeigte Preis gibt nun an, wie lange du brauchen wirst, um ihn zu bezahlen und wie viel von deiner Bank er ausmacht.',
	...
	'Boosts your cookie production by <b>%1%</b> when active.<br>The veil is very fragile and will break if you click the big cookie or any golden cookies or reindeer.<br><br>Once broken, turning the veil back on costs %2 of unbuffed CpS.':
		'Erhöht deine Keksproduktion um <b>%1%</b>, wenn er aktiv ist.<br>Der Schleier ist sehr zerbrechlich und zerbricht, wenn du den großen Keks oder irgendwelche goldenen Kekse oder Rentiere anklickst.<br><br>Sobald er zerbrochen ist, kostet das Wiedereinschalten des Schleiers %2 ungepuffte KpS.',
	...
	'The <b>shimmering veil</b> is more resistant, and has a <b>%1% chance</b> not to break. It also gives <b>+%2%</b> more CpS.':
		'Der <b>Schimmernde Schleier</b> ist widerstandsfähiger und hat eine <b>%1%ige Chance</b>, nicht zu brechen. Außerdem gibt er <b>+%2%</b> mehr KpS.',
	'Active.': 'Aktiv.',
	'The reinforced membrane protects the shimmering veil.':
		'Die verstärkte Membran schützt den schimmernden Schleier.',
	...
	'Prior to purchasing the <b>%1</b> upgrade in a run, random drops are <b>%2 times more common</b>.':
		'Vor dem Kauf des <b>%1</b> Upgrades in einem Run, sind zufällige Drops <b>%2 mal häufiger</b>.',
	...
	'The news ticker may occasionally have <b>fortunes</b>, which may be clicked for something good.':
		'Der Nachrichtenticker kann gelegentlich <b>Glück</b> haben, das für etwas Gutes angeklickt werden kann.',
	'Through clever accounting, this actually makes kitten upgrades <b>%1% cheaper</b>.':
		'Durch geschickte Buchhaltung macht dies die Kätzchen-Upgrades tatsächlich <b>%1% billiger</b>.',
	'Unlocks the ability to <b>pet your dragon</b> by clicking on it once hatched.':
		'Schaltet die Fähigkeit frei, deinen Drachen zu streicheln, indem du ihn anklickst, sobald er geschlüpft ist.',
	'Cost scales with CpS, but %1 times cheaper with a fully-trained dragon.':
		'Die Kosten skalieren mit KpS, aber %1 mal billiger mit einem voll ausgebildeten Drachen.',
	'Golden cookies may trigger a <b>Dragon Harvest</b>.':
		'Goldene Kekse können eine <b>Drachenernte</b> auslösen.',
	'Golden cookies may trigger a <b>Dragonflight</b>.':
		'Goldene Kekse können einen <b>Drachenflug</b> auslösen.',
	'Dragon harvest and Dragonflight are <b>%1% stronger</b>.':
		'Drachenernte und Drachenschwarm sind <b>%1% stärker</b>.',
	'Kittens are <b>%1%</b> more effective.': 'Kätzchen sind <b>%1%</b> effektiver.',
	'Each kitten upgrade boosts %1 CpS by <b>%2%</b>.':
		'Jedes Upgrade eines Kätzchens erhöht die KpS von %1 um <b>%2%</b>.',
	'Each rank of milk boosts %1 CpS by <b>%2%</b>.':
		'Jeder Rang der Milch erhöht %1 KpS um <b>%2%</b>.',
	'Cursor levels boost clicks by <b>%1%</b> each (up to cursor level %2).':
		'Cursor-Levels erhöhen Klicks um jeweils <b>%1%</b> (bis zu Cursor-Level %2).',
	'<b>%1</b> are now effective up to cursor level %2.':
		'<b>%1</b> sind jetzt bis zur Cursor-Ebene %2 wirksam.',
	...
	'Selling buildings triggers a buff boosted by how many buildings were sold.':
		'Der Verkauf von Gebäuden löst einen Buff aus, der davon abhängt, wie viele Gebäude verkauft wurden.',
	'Buff boosts clicks by +%1% for every building sold for %2 seconds.':
		'Der Buff erhöht die Klicks um +%1% für jedes verkaufte Gebäude für %2 Sekunden.',
	'CpS bonus fluctuating between %1 and %2 over time.':
		'KpS-Bonus, der im Laufe der Zeit zwischen %1 und %2 schwankt.',
	...
	'All golden cookies are wrath cookies with a greater chance of a negative effect.':
		'Alle goldenen Kekse sind Zorn-Kekse mit einer größeren Wahrscheinlichkeit für einen negativen Effekt.',
	'Wrinklers appear %1% faster and digest %2% more cookies.':
		'Falter erscheinen %1% schneller und verdauen %2% mehr Kekse.',
	'Effect is only active when your total amount of buildings ends with 0.':
		'Der Effekt ist nur aktiv, wenn deine Gesamtanzahl an Gebäuden bei 0 endet.',
	...
	'Make <b>%1</b> by only having clicked <b>%2 times</b>.':
		'Backe <b>%1</b>Kekse obwohl du nur <b>%2 mal</b> geklickt hast.',
	...
	'Get to <b>%1</b> baked with <b>no upgrades purchased</b>.':
		'Erreiche <b>%1</b> gebackene Kekse <b>ohne gekaufte Upgrades</b>.',
	...
	'Have at least <b>1 of the most expensive object, 2 of the second-most expensive, 4 of the next</b> and so on (capped at %1).':
		'Habe mindestens <b>1 des teuersten Objekts, 2 des zweitteuersten, 4 des nächsten</b> und so weiter (Obergrenze bei %1).',
	'Have at least <b>10 of the most expensive object, 20 of the second-most expensive, 30 of the next</b> and so on.':
		'Besitze mindestens <b>10 Stück vom teuersten Objekt, 20 Stück vom zweitteuersten, 30 Stück des nächsten</b> und so weiter.',
	...
	'Appease the grandmatriarchs at least <b>once</b>.':
		'Besänftige die Großmatriarchen wenigstens <b>einmal</b>.',
	'Appease the grandmatriarchs at least <b>%1 times</b>.':
		'Beschwöre die Großmatriarchen mindestens <b>%1 Mal</b>.',
	...
	'Unlock <b>100%</b> of your heavenly chips power.':
		'Schalte <b>100%</b> der Kraft deiner himmlischen Splitter frei.',
	'You have <b>1 chance in %1</b> every second of earning this achievement.':
		'Du hast <b>1 Chance in %1</b> pro Sekunde, diesen Erfolg zu verdienen.',
	...
	'Unlock <b>every Halloween-themed cookie</b>.<div class="line"></div>Owning this achievement makes Halloween-themed cookies drop more frequently in future playthroughs.':
		'Schalte <b>jeden Halloween-Keks</b> frei.</strong>Durch den Besitz dieses Erfolges werden Halloween-Kekse in zukünftigen Durchläufen häufiger gedropt.',
	...
	'Unlock <b>every Christmas-themed cookie</b>.<div class="line"></div>Owning this achievement makes Christmas-themed cookies drop more frequently in future playthroughs.':
		'Schalte <b>jeden weihnachtlichen Keks</b> frei.</strong>Durch den Besitz dieses Erfolges werden weihnachtliche Kekse in zukünftigen Durchläufen häufiger gedropt.',
	...
	'Pop a reindeer <b>during an elder frenzy</b>.':
		'Zerplatze ein Rentier <b>während eines Ältestenrausches</b>.',
	'Unlock <b>every Valentine-themed cookie</b>.':
		'Schalte <b>jeden Keks mit Valentinsthema</b> frei.',
	'Click the tiny cookie.': 'Klicke auf den kleinen Keks.',
	'This is for baking %1 and making it on the local news.':
		'Das ist dafür, dass du %1 backst und es in die Lokalnachrichten schaffst.',
	'Name yourself <b>Orteil</b>.<div class="warning">Note: usurpers incur a -%1% CpS penalty until they rename themselves something else.</div>':
		'Nenne dich <b>Orteil</b>.</div>Hinweis: Usurpatoren erleiden eine -%1% KpS Strafe, bis sie sich etwas anderes nennen.</div>',
	...
	'Unlock <b>all the eggs</b>.<div class="line"></div>Owning this achievement makes eggs drop more frequently in future playthroughs.':
		'Schalte <b>alle Eier</b> frei.</strong>Dieser Erfolg sorgt dafür, dass die Eier in zukünftigen Durchläufen häufiger fallen.',
	...
	'Own <b>%1</b> upgrades and <b>%2</b> buildings.':
		'Besitze <b>%1</b> Upgrades und <b>%2</b> Gebäude.',
	'Own <b>%1</b> heavenly upgrades.': 'Besitze <b>%1</b> himmlische Upgrades.',
	'Burst the near-extinct <b>shiny wrinkler</b>.':
		'Lass den fast ausgestorbenen <b>glänzenden Falter</b> platzen.',
	'Click a golden cookie <b>less than 1 second after it spawns</b>.':
		'Klicke einen goldenen Keks <b>weniger als 1 Sekunde nach dem Spawnen</b> an.',
	'Click a golden cookie <b>less than 1 second before it dies</b>.':
		'Klicke einen goldenen Keks <b>weniger als 1 Sekunde bevor er stirbt</b>.',
	...
	"Successfully harvest a coalescing sugar lump before it's ripe.":
		'Ernte erfolgreich einen zusammenfließenden Würfelzucker, bevor er reif ist.',
	...
	'Manage a cookie legacy for <b>at least a year</b>.':
		'Verwalte ein Keks-Vermächtnis für <b>mindestens ein Jahr</b>.',
	...
	'Fill every tile of the biggest garden plot with plants.':
		'Fülle jede Fliese des größten Gartengrundstücks mit Pflanzen.',
	...
	'Convert a complete seed log into sugar lumps by sacrificing your garden to the sugar hornets.<div class="line"></div>Owning this achievement makes seeds <b>%1% cheaper</b>, plants mature <b>%2% sooner</b>, and plant upgrades drop <b>%3% more</b>.':
		'Verwandle einen kompletten Samenstamm in Würfelzucker, indem du deinen Garten den Zuckerhornissen opferst.<div class="line"></div>Durch den Besitz dieses Erfolgs werden Samen <b>%1% billiger</b>, Pflanzen reifen <b>%2% früher</b> und Pflanzen-Upgrades werden öfters <b>%3% fallen lassen</b>.',
	'Ascend with exactly <b>%1</b>.': 'Steige mit genau <b>%1</b> auf.',
	'Have your <b>reinforced membrane</b> protect the <b>shimmering veil</b>.':
		'Lass deine <b>verstärkte Membran</b> den <b>schimmernden Schleier</b> schützen.',
	'Own every <b>fortune upgrade</b>.<div class="line"></div>Owning this achievement makes fortunes appear <b>twice as often</b>; unlocked fortune upgrades also have a <b>%1% chance</b> to carry over after ascending.':
		'Besitze jedes <b>Glücks-Upgrade</b>.<div class="line"></div>Durch den Besitz dieses Erfolges erscheint das Glück <b>doppelt so oft</b>; freigeschaltete Glücks-Upgrades haben außerdem eine <b>%1%ige Chance</b>, sich nach dem Aufstieg zu übertragen.',
	'Make your first stock market profit.': 'Mache deinen ersten Gewinn an der Börse.',
	'Own at least <b>%1</b> of a stock market good.':
		'Besitze mindestens <b>%1</b> eines Börsengutes.',
	'Own at least <b>%1</b> of every stock market good.':
		'Besitze mindestens <b>%1</b> von jedem Börsengut.',
	'Make <b>a day</b> of CpS ($%1) in 1 stock market sale.':
		'Verdiene <b>einen Tag</b> KpS ($%1) in 1 Börsenverkauf.',
	'Spend <b>a day</b> of CpS ($%1) in 1 stock market purchase.':
		'Gib <b>einen Tag</b> KpS ($%1) in 1 Börsenkauf aus.',
	'Have your stock market profits surpass <b>a whole year</b> of CpS ($%1).':
		'Lass deine Börsengewinne <b>ein ganzes Jahr</b> von KpS ($%1) übertreffen.',
	'Unlock the <b>highest-tier</b> stock market headquarters.':
		'Schalte die <b>höchste Stufe</b> der Börsenzentrale frei.',
	'Have your stock market profits surpass <b>$%1</b>.':
		'Lass deine Börsengewinne <b>$%1</b> übersteigen.',
	...
	"Click one of Santa's helper grandmas during Christmas season.":
		'Klicke in der Weihnachtszeit auf eine der helfenden Omas des Weihnachtsmanns.',
	Frenzy: 'Rausch',
	...
	'Cookie production halted for %1,<br>but each click is worth %2 of CpS.':
		'Die Keks-Produktion wurde für %1 angehalten,<br>aber jeder Klick ist %2 KpS wert.',
	...
	'You find %1% more golden cookies for the next %2.':
		'Du findest %1% mehr goldene Kekse für die nächsten %2.',
	...
	"[Baker's wheat quote]A plentiful crop whose hardy grain is used to make flour for pastries.":
		'Eine reichhaltige Ernte, deren widerstandsfähiges Korn zur Herstellung von Mehl für Gebäck verwendet wird.',
	...
	'[Thumbcorn quote]A strangely-shaped variant of corn. The amount of strands that can sprout from one seed is usually in the single digits.':
		'Eine seltsam geformte Variante des Mais. Die Anzahl der Stränge, die aus einem Samen sprießen können, liegt meist im einstelligen Bereich.',
	...
	"[Cronerice quote]Not only does this wrinkly bulb look nothing like rice, it's not even related to it either; its closest extant relative is the weeping willow.":
		'Diese runzlige Knolle sieht nicht nur nicht wie Reis aus, sie ist auch nicht mit ihm verwandt; ihr nächster Verwandter ist die Trauerweide.',
	...
	'[Gildmillet quote]An ancient staple crop, famed for its golden sheen. Was once used to bake birthday cakes for kings and queens of old.':
		'Ein altes Grundnahrungsmittel, berühmt für seinen goldenen Glanz. Sie wurde einst verwendet, um Geburtstagskuchen für Könige und Königinnen zu backen.',
	...
	'[Ordinary clover quote]<i>Trifolium repens</i>, a fairly mundane variety of clover with a tendency to produce four leaves. Such instances are considered lucky by some.':
		'<i>Trifolium repens</i>, eine ziemlich alltägliche Kleesorte mit der Tendenz, vier Blätter zu produzieren. Solche Exemplare werden von manchen als Glücksbringer angesehen.',
	...
	'[Golden clover quote]A variant of the ordinary clover that traded its chlorophyll for pure organic gold. Tragically short-lived, this herb is an evolutionary dead-end - but at least it looks pretty.':
		'Eine Variante des gewöhnlichen Klees, der sein Chlorophyll gegen reines organisches Gold getauscht hat. Tragisch kurzlebig, ist dieses Kraut eine evolutionäre Sackgasse - aber wenigstens sieht es hübsch aus.',
	...
	'[Shimmerlily quote]These little flowers are easiest to find at dawn, as the sunlight refracting in dew drops draws attention to their pure-white petals.':
		'Diese kleinen Blumen sind am einfachsten in der Dämmerung zu finden, da das Sonnenlicht, das sich in den Tautropfen bricht, die Aufmerksamkeit auf ihre reinweißen Blütenblätter lenkt.',
	...
	'[Elderwort quote]A very old, long-forgotten subspecies of edelweiss that emits a strange, heady scent. There is some anecdotal evidence that these do not undergo molecular aging.':
		'Eine sehr alte, längst vergessene Unterart des Edelweißes, die einen seltsamen, berauschenden Duft verströmt. Es gibt einige anekdotische Hinweise darauf, dass diese keine molekulare Alterung durchlaufen.',
	...
	'[Bakeberry quote]A favorite among cooks, this large berry has a crunchy brown exterior and a creamy red center. Excellent in pies or chicken stews.':
		'Ein Favorit unter den Köchen, diese große Beere hat eine knusprige braune Außenseite und eine cremig rote Mitte. Hervorragend in Torten oder Hühnereintöpfen.',
	...
	'[Chocoroot quote]A tangly bramble coated in a sticky, sweet substance. Unknown genetic ancestry. Children often pick these from fields as-is as a snack.':
		'Eine säuerliche Brombeere, die mit einer klebrigen, süßen Substanz überzogen ist. Unbekannte genetische Abstammung. Kinder pflücken sie oft als Snack von den Feldern.',
	...
	'[White chocoroot quote]A pale, even sweeter variant of the chocoroot. Often impedes travelers with its twisty branches.':
		'Eine blasse, noch süßere Variante des Schokorots. Behindert Reisende oft mit seinen verwinkelten Ästen.',
	...
	'[White mildew quote]A common rot that infests shady plots of earth. Grows in little creamy capsules. Smells sweet, but sadly wilts quickly.':
		'Eine häufige Fäule, die schattige Grundstücke befällt. Wächst in kleinen cremigen Kapseln. Riecht süß, verwelkt aber leider schnell.',
	...
	'[Brown mold quote]A common rot that infests shady plots of earth. Grows in odd reddish clumps. Smells bitter, but thankfully wilts quickly.':
		'Eine häufige Fäule, die schattige Grundstücke befällt. Wächst in seltsamen rötlichen Klumpen. Riecht bitter, verwelkt aber zum Glück schnell.',
	...
	'[Meddleweed quote]The sign of a neglected farmland, this annoying weed spawns from unused dirt and may sometimes spread to other plants, killing them in the process.':
		'Das Zeichen eines vernachlässigten Ackerlandes. Dieses lästige Unkraut wächst aus ungenutztem Dreck und kann sich manchmal auf andere Pflanzen ausbreiten und sie dabei abtöten.',
	...
	"[Whiskerbloom quote]Squeezing the translucent pods makes them excrete a milky liquid, while producing a faint squeak akin to a cat's meow.":
		'Wenn du die durchsichtigen Schoten drückst, scheiden sie eine milchige Flüssigkeit aus und geben ein leises Quietschen von sich, das an das Miauen einer Katze erinnert.',
	...
	'[Chimerose quote]Originating in the greener flanks of polar mountains, this beautiful flower with golden accents is fragrant enough to make any room feel a little bit more festive.':
		'Diese wunderschöne Blume mit goldenen Akzenten stammt ursprünglich aus den grüneren Flanken der polaren Berge und duftet so gut, dass sie jeden Raum ein wenig festlicher macht.',
	...
	'[Nursetulip quote]This flower grows an intricate root network that distributes nutrients throughout the surrounding soil. The reason for this seemingly altruistic behavior is still unknown.':
		'Diese Blume wächst ein kompliziertes Wurzelgeflecht, das die Nährstoffe im umliegenden Boden verteilt. Der Grund für dieses scheinbar altruistische Verhalten ist noch unbekannt.',
	Drowsyfern: 'Schlummerfarn',
	'[Drowsyfern quote]Traditionally used to brew a tea that guarantees a good night of sleep.':
		'Traditionell verwendet, um einen Tee zu brauen, der eine gute Nachtruhe garantiert.',
	...
	'[Wardlichen quote]The metallic stench that emanates from this organism has been known to keep insects and slugs away.':
		'Der metallische Gestank, der von diesem Organismus ausgeht, ist bekannt dafür, dass er Insekten und Schnecken fernhält.',
	...
	'[Keenmoss quote]Fuzzy to the touch and of a vibrant green. In plant symbolism, keenmoss is associated with good luck for finding lost objects.':
		'Fühlt sich flauschig an und hat ein leuchtendes Grün. In der Pflanzensymbolik wird Keenmoss mit Glück beim Auffinden verlorener Gegenstände in Verbindung gebracht.',
	...
	'[Queenbeet quote]A delicious taproot used to prepare high-grade white sugar. Entire countries once went to war over these.':
		'Eine köstliche Pfahlwurzel, aus der hochwertiger weißer Zucker hergestellt wird. Um sie führten einst ganze Länder Krieg.',
	...
	'[Juicy queenbeet quote]A delicious taproot used to prepare high-grade white sugar. Entire countries once went to war over these.<br>It looks like this one has grown especially sweeter and juicier from growing in close proximity to other queenbeets.':
		'Eine köstliche Pfahlwurzel, die zur Herstellung von hochwertigem weißen Zucker verwendet wird. Es sieht so aus, als ob diese hier besonders süß und saftig geworden ist, weil sie in unmittelbarer Nähe zu anderen Königinnenrüben wächst.',
	...
	'[Duketater quote]A rare, rich-tasting tuber fit for a whole meal, as long as its strict harvesting schedule is respected. Its starch has fascinating baking properties.':
		'Eine seltene, wohlschmeckende Knolle, die für eine ganze Mahlzeit taugt, solange der strenge Ernteplan eingehalten wird. Ihre Stärke hat faszinierende Backeigenschaften.',
	...
	'[Crumbspore quote]An archaic mold that spreads its spores to the surrounding dirt through simple pod explosion.':
		'Ein archaischer Schimmelpilz, der seine Sporen durch einfache Hülsenexplosion auf die umgebende Erde überträgt.',
	...
	'[Doughshroom quote]Jammed full of warm spores; some forest walkers often describe the smell as similar to passing by a bakery.':
		'Vollgestopft mit warmen Sporen; manche Waldspaziergänger beschreiben den Geruch oft als ähnlich wie beim Vorbeigehen an einer Bäckerei.',
	...
	'[Glovemorel quote]Touching its waxy skin reveals that the interior is hollow and uncomfortably squishy.':
		'Das Berühren der wachsartigen Haut verrät, dass das Innere hohl und unangenehm matschig ist.',
	Cheapcap: 'Geizkragen',
	'[Cheapcap quote]Small, tough, and good in omelettes. Some historians propose that the heads of dried cheapcaps were once used as currency in some bronze age societies.':
		'Klein, zäh und gut in Omeletts. Einige Historiker schlagen vor, dass die Köpfe von getrockneten Geizkragen einst als Währung in einigen bronzezeitlichen Gesellschaften verwendet wurden.',
	...
	"[Fool's bolete quote]Named for its ability to fool mushroom pickers. The fool's bolete is not actually poisonous, it's just extremely bland.":
		'Benannt nach seiner Fähigkeit, Pilzsammler zu täuschen. Der Knollenblätterpilz ist eigentlich nicht giftig, er ist nur extrem fade.',
	...
	"[Wrinklegill quote]This mushroom's odor resembles that of a well-done steak, and is said to whet the appetite - making one's stomach start gurgling within seconds.":
		'Der Geruch dieses Pilzes ähnelt dem eines gut durchgebratenen Steaks und soll den Appetit anregen - so dass der Magen innerhalb von Sekunden zu gluckern beginnt.',
	'Green rot': 'Grünfäule',
	'[Green rot quote]This short-lived mold is also known as "emerald pebbles", and is considered by some as a pseudo-gem that symbolizes good fortune.':
		'Diese kurzlebige Form ist auch als "Smaragdkiesel" bekannt und wird von manchen als Pseudo-Edelstein betrachtet, der Glück symbolisiert.',
	...
	'[Shriekbulb quote]A nasty vegetable with a dreadful quirk : its flesh resonates with a high-pitched howl whenever it is hit at the right angle by sunlight, moonlight, or even a slight breeze.':
		'Ein fieses Gemüse mit einer furchtbaren Eigenart: Sein Fleisch schwingt mit einem hohen Heulen, wenn es im richtigen Winkel von Sonnen- oder Mondlicht oder sogar einer leichten Brise getroffen wird.',
	...
	'[Tidygrass quote]The molecules this grass emits are a natural weedkiller. Its stems grow following a predictable pattern, making it an interesting -if expensive- choice for a lawn grass.':
		'Die Moleküle, die dieses Gras abgibt, sind ein natürliches Unkrautvernichtungsmittel. Seine Halme wachsen nach einem vorhersehbaren Muster, was es zu einer interessanten - wenn auch teuren - Wahl für ein Rasengras macht.',
	...
	'[Everdaisy quote]While promoted by some as a superfood owing to its association with longevity and intriguing geometry, this elusive flower is actually mildly toxic.':
		'Während sie von einigen als Superfood angepriesen wird, weil sie mit Langlebigkeit und faszinierender Geometrie assoziiert wird, ist diese schwer fassbare Blume tatsächlich leicht giftig.',
	...
	'[Ichorpuff quote]This puffball mushroom contains sugary spores, but it never seems to mature to bursting on its own. Surrounding plants under its influence have a very slow metabolism, reducing their effects but lengthening their lifespan.':
		'Dieser Puffball-Pilz enthält zuckerhaltige Sporen, aber er scheint nie von selbst zum Platzen zu reifen. Umliegende Pflanzen, die unter seinem Einfluss stehen, haben einen sehr langsamen Stoffwechsel, was ihre Wirkung reduziert, aber ihre Lebensdauer verlängert.',
	'Garden information': 'Garten Informationen',
	'Your garden is frozen, providing no effects.':
		'Dein Garten ist eingefroren und bietet keine Effekte.',
	...
	'%1 to harvest all mature plants of this type.':
		'%1 um alle reifen Pflanzen dieses Typs zu ernten.',
	Freeze: 'Einfrieren',
	'Cryogenically preserve your garden.<br>Plants no longer grow, spread or die; they provide no benefits.<br>Soil cannot be changed.<div class="line"></div>Using this will effectively pause your garden.':
		'Konserviere deinen Garten kryogenisch.<br>Pflanzen wachsen nicht mehr, breiten sich nicht mehr aus oder sterben ab; sie bieten keinen Nutzen.<br>Der Boden kann nicht verändert werden.<br>Damit wird dein Garten effektiv pausiert.',
	...
	'Do you REALLY want to sacrifice your garden to the sugar hornets?<br><small>You will be left with an empty plot and only the %1 seed unlocked.<br>In return, you will gain <b>%2 sugar lumps</b>.</small>':
		'Willst du deinen Garten WIRKLICH den Zuckerhornissen opfern?<br><small>Du wirst mit einem leeren Grundstück zurückgelassen und nur die %1 Saat freigeschaltet.<br>Im Gegenzug erhältst du <b>%2 Würfelzucker</b>.</small>',
	'Sacrifice!': 'Opfern!',
	"You've sacrificed your garden to the sugar hornets, destroying your crops and your knowledge of seeds.<br>In the remains, you find <b>%1 sugar lumps</b>.":
		'Du hast deinen Garten den Zuckerhornissen geopfert, die deine Ernte und dein Wissen über Saatgut vernichtet haben.<br>In den Überresten findest du <b>%1 Würfelzucker</b>.',
	...
	'surrounding plants (%1x%1) are %2% more efficient':
		'Umliegende Pflanzen (%1x%1) sind %2% effizienter',
	'surrounding plants (%1x%1) are %2% less efficient':
		'Umliegende Anlagen (%1x%1) sind %2% weniger effizient',
	'surrounding tiles (%1x%1) develop no weeds or fungus':
		'Umliegende Kacheln (%1x%1) entwickeln kein Unkraut oder Pilz',
	'harvest when mature for +%1 of CpS (max. %2% of bank)':
		'Ernte bei Reife für +%1 der KpS (max. %2% der Bank)',
	...
	'may sometimes drop spores when uprooted':
		'Kann manchmal Sporen fallen lassen, wenn er entwurzelt wird',
	'explodes into up to %1 of CpS at the end of its lifecycle (max. %2% of bank)':
		'Explodiert am Ende seines Lebenszyklus in bis zu %1 von KpS (max. %2% der Bank)',
	'cannot handle cold climates; %1% chance to die when frozen':
		'Kann nicht mit kaltem Klima umgehen; %1% Chance zu sterben, wenn es gefriert',
	'the unfortunate result of some plant combinations':
		'Das unglückliche Ergebnis einiger Pflanzenkombinationen',
	...
	'You will be able to change your soil again in %1.':
		'Du wirst deinen Boden in %1 wieder wechseln können.',
	'Click to use this type of soil for your whole field.':
		'Klicke, um diesen Bodentyp für dein ganzes Feld zu verwenden.',
	Dirt: 'Dreck',
	"Simple, regular old dirt that you'd find in nature.":
		'Einfacher, normaler alter Dreck, den du in der Natur finden würdest.',
	Fertilizer: 'Dünger',
	'Soil with a healthy helping of fresh manure. Plants grow faster but are less efficient.':
		'Boden mit einer gesunden Portion frischem Dünger. Die Pflanzen wachsen schneller, sind aber weniger effizient.',
	Clay: 'Lehm',
	'Rich soil with very good water retention. Plants grow slower but are more efficient.':
		'Reichhaltiger Boden mit sehr guter Wasserspeicherung. Die Pflanzen wachsen langsamer, sind aber effizienter.',
	Pebbles: 'Kiesel',
	...
	'Soil made of bits and pieces of bark and sawdust. Helpful for young sprouts to develop, not so much for mature plants.':
		'Erde, die aus Rindenstücken und Sägemehl besteht. Hilfreich für junge Triebe, um sich zu entwickeln, nicht so sehr für ausgewachsene Pflanzen.',
	...
	'<b>%1% chance</b> of collecting seeds automatically when plants expire':
		'<b>%1% Chance</b>, dass du automatisch Samen sammelst, wenn die Pflanzen verfallen.',
	'plants spread and mutate <b>%1 times more</b>':
		'Pflanzen verbreiten sich und mutieren <b>%1 mal öfter</b>.',
	...
	'Click to select this seed for planting.':
		'Klicke darauf, um diesen Samen für die Aussaat auszuwählen.',
	...
	'This tile of soil is empty.<br>Pick a seed and plant something!':
		'Dieses Stück Erde ist leer.<br>Pflücke einen Samen und pflanze etwas!',
	...
	'may reproduce, will drop seed when harvested':
		'Kann sich fortpflanzen, lässt Samen fallen, wenn sie geerntet wird',
	...
	'Click to refill your soil timer and trigger <b>1</b> plant growth tick with <b>x%1</b> spread and mutation rate for %2.':
		'Klicke, um deinen Boden-Timer aufzufüllen und <b>1</b> Pflanzenwachstumstick mit <b>x%1</b> Ausbreitung und Mutationsrate für %2 auszulösen.',
	...
	'while plant is alive; scales with plant growth':
		'Während die Pflanze lebt; Skalen mit Pflanzenwachstum',
	Dungeon: '/',
	Grimoire: '/',
	...
	'Click to refill <b>%1 units</b> of your magic meter for %2.':
		'Klicke, um <b>%1 Einheiten</b> deiner Magieanzeige für %2 aufzufüllen.',
	'Grimoire spells are %1% cheaper but fail %1% more.':
		'Grimoire-Zauber sind %1% billiger, versagen aber %1% häufiger.',
	'Conjure Baked Goods': 'Backwaren herbeizaubern',
	'Summon half an hour worth of your CpS, capped at %1% of your cookies owned.':
		'Beschwöre eine halbe Stunde lang deine KpS, begrenzt auf %1% deines Kekses.',
	'Trigger a %1-minute clot and lose %1 minutes of CpS.':
		'Löse ein %1-minütiges Gerinnsel aus und verliere den Gegenwert von %1 Minuten KpS.',
	...
	'Summon a random golden cookie. Each existing golden cookie makes this spell +%1% more likely to backfire.':
		'Beschwöre einen zufälligen goldenen Keks. Jeder vorhandene goldene Keks erhöht die Wahrscheinlichkeit, dass dieser Zauber nach hinten losgeht, um +%1%.',
	...
	'All active buffs gain %1% more time (up to %2 more minutes).':
		'Alle aktiven Buffs erhalten %1% mehr Zeit (bis zu %2 Minuten mehr).',
	'All active buffs are shortened by %1% (up to %2 minutes shorter).':
		'Alle aktiven Buffs werden um %1% verkürzt (bis zu %2 Minuten kürzer).',
	...
	'The spell picks a random building you could afford if you had twice your current cookies, and gives it to you for free. The building selected must be under %1, and cannot be your most-built one (unless it is your only one).':
		'Der Zauber wählt ein zufälliges Gebäude aus, das du dir leisten könntest, wenn du das Doppelte deiner aktuellen Kekse hättest, und gibt es dir umsonst. Das gewählte Gebäude muss unter %1 liegen und darf nicht dein meistgebautes sein (außer es ist dein einziges).',
	...
	'Cast a random spell at half the magic cost, with twice the chance of backfiring.':
		'Wirke einen zufälligen Zauber zu den halben Magiekosten, mit der doppelten Chance, dass er nach hinten losgeht.',
	...
	'Instantly summon a wrinkler if conditions are fulfilled.':
		'Rufe sofort einen Falter herbei, wenn die Bedingungen erfüllt sind.',
	...
	'Spells backfire %1 times less for the next %2 minutes.':
		'Zauber werden in den nächsten %2 Minuten %1 mal seltener nach hinten losgehen.',
	'Spells backfire %1 times more for the next %2 minutes.':
		'Zauber werden %1 Mal mehr für die nächsten %2 Minuten nach hinten losgehen.',
	...
	'[GOD 1 QUOTE]An immortal life spent focusing on the inner self, away from the distractions of material wealth.':
		'Ein unsterbliches Leben, das mit der Konzentration auf das innere Selbst verbracht wird, fernab von den Ablenkungen des materiellen Wohlstands.',
	...
	'[GOD 2 QUOTE]This sleazy spirit revels in the lust for quick easy gain and contempt for the value of steady work.':
		'Dieser schäbige Geist schwelgt in der Gier nach schnellem, einfachem Gewinn und der Verachtung für den Wert beständiger Arbeit.',
	...
	'[GOD 3 QUOTE]The embodiment of natural disasters. An impenetrable motive drives the devastation caused by this spirit.':
		'Die Verkörperung von Naturkatastrophen. Ein undurchdringliches Motiv treibt die Verwüstungen an, die dieser Geist verursacht.',
	...
	"[GOD 4 QUOTE]This spirit knows about everything you'll ever do, and enjoys dispensing a harsh judgment.":
		'Dieser Geist weiß über alles Bescheid, was du jemals tun wirst, und genießt es, ein hartes Urteil zu fällen.',
	...
	'[GOD 5 QUOTE]This is the spirit of merry getaways and regretful Monday mornings.':
		'Das ist der Geist der fröhlichen Flucht und des bedauernden Montagmorgens.',
	...
	"[GOD 6 QUOTE]All things that be and ever will be were scripted long ago by this spirit's inscrutable tendrils.":
		'Alle Dinge, die sind und jemals sein werden, wurden vor langer Zeit von den unergründlichen Ranken dieses Geistes geschrieben.',
	...
	'[GOD 7 QUOTE]This spirit enjoys a good cheese after a day of hard work.':
		'Dieser Geist genießt einen guten Käse nach einem Tag harter Arbeit.',
	...
	'[GOD 8 QUOTE]While this spirit has many regrets, helping you rule the world through constant industrialization is not one of them.':
		'Während dieser Geist viele Dinge bedauert, gehört es nicht dazu, dir dabei zu helfen, die Welt durch ständige Industrialisierung zu beherrschen.',
	...
	'[GOD 9 QUOTE]A caring spirit said to contain itself, inwards infinitely.':
		'Ein fürsorglicher Geist, von dem gesagt wird, dass er sich selbst enthält, unendlich nach innen.',
	...
	'[GOD 10 QUOTE]This spirit enjoys poking foul beasts and watching them squirm, but has no love for its own family.':
		'Dieser Geist genießt es, üble Biester zu stoßen und zu beobachten, wie sie sich winden, aber er hat keine Liebe für seine eigene Familie.',
	...
	'[GOD 11 QUOTE]You will find that life gets just a little bit sweeter if you can motivate this spirit with tidy numbers and properly-filled tax returns.':
		'Sie werden feststellen, dass das Leben ein wenig süßer wird, wenn Sie diesen Geist mit ordentlichen Zahlen und korrekt ausgefüllten Steuererklärungen motivieren können.',
	...
	'Drag a spirit onto this slot to assign it.':
		'Ziehe einen Geist auf diesen Platz, um ihn zuzuweisen.',
	'If a golden cookie is clicked, this spirit is unslotted and all worship swaps will be used up.':
		'Wenn ein goldener Keks angeklickt wird, ist dieser Geist ungeschlitzt und alle Swaps für Anbetung werden aufgebraucht.',
	'Each time you slot a spirit, you use up one worship swap.<div class="line"></div>If you have 2 swaps left, the next one will refill after %1.<br>If you have 1 swap left, the next one will refill after %2.<br>If you have 0 swaps left, you will get one after %3.<div class="line"></div>Unslotting a spirit costs no swaps.':
		'Jedes Mal, wenn du einen Geist einsetzt, verbrauchst du eine Anbetungsänderung.<div class="line"></div>Wenn du 2 Änderungen übrig hast, wird die nächste nach %1 aufgefüllt.<br>Wenn du 1 Änderung übrig hast, wird die nächste nach %2 aufgefüllt.<br>Wenn du 0 Änderungen übrig hast, bekommst du eine nach %3.<div class="line"></div>Das Einsetzen eines Geistes kostet keine Änderungen.',
	'Click to refill all your worship swaps for %1.':
		'Klicke darauf, um alle deine Anbetungsänderungen für %1 aufzufüllen.',
	...
	'The jade slot behaves as a ruby slot and the ruby slot behaves as a diamond slot.':
		'Der Jade-Slot verhält sich wie ein Rubin-Slot und der Rubin-Slot verhält sich wie ein Diamant-Slot.',
	...
	'You may increase your storage space by upgrading your offices and by buying more %1. You also get %2 extra storage space per %3 level (currently: <b>+%4</b>).':
		'Du kannst deinen Lagerplatz durch Upgrades deiner Büros und durch den Kauf von mehr %1 vergrößern. Du bekommst auch %2 zusätzlichen Lagerplatz pro %3 Level (derzeit: <b>+%4</b>).',
	'The average worth of this stock and how high it can peak depends on the building it is tied to, along with the level of your %1.':
		'Der durchschnittliche Wert dieser Aktie und wie hoch sie ausfallen kann, hängt von dem Gebäude ab, an das sie gebunden ist, sowie von der Höhe deines %1.',
	'%1 the hide button to toggle all other stocks.':
		'%1 den Ausblenden-Button, um alle anderen Bestände umzuschalten.',
	'stock:': 'Aktie:',
	...
	'You cannot buy and sell this stock in the same tick.':
		'Du kannst diese Aktie nicht im selben Tick kaufen und verkaufen.',
	...
	'It is fully upgraded. Its lavish interiors, spanning across innumerable floors, are host to many a decadent party, owing to your nigh-unfathomable wealth.':
		'Es ist komplett aufgewertet. Die üppigen Innenräume, die sich über unzählige Etagen erstrecken, sind dank deines unergründlichen Reichtums Gastgeber vieler dekadenter Partys.',
	...
	'Buying goods normally incurs overhead costs of <b>%1% extra</b>. Each broker you hire reduces that cost by <b>%2%</b>.':
		'Beim Kauf von Waren fallen normalerweise zusätzliche Gemeinkosten von <b>%1%</b> an. Jeder Makler, den du beauftragst, reduziert diese Kosten um <b>%2%</b>.',
	'Current overhead costs thanks to your brokers: <b>+%1%</b>':
		'Aktuelle Gemeinkosten dank der Makler: <b>+%1%</b>',
	"Buying a broker costs %1 of CpS (that's $%2).":
		'Der Kauf eines Maklers kostet %1 KpS (das sind $%2).',
	"Maximum number of brokers you can own: %1 (the highest amount of grandmas you've owned this run, divided by 10, plus your grandma level)":
		'Maximale Anzahl an Maklern, die du besitzen kannst: %1 (die höchste Anzahl an Omas, die du in diesem Lauf besessen hast, geteilt durch 10, plus deine Oma-Stufe)',
	'Brokers are Wall Street-class grandmas versed in the ways of finance. Stockbroker grandmas work hard and play hard, and will fight telephone in hand to get your clients the best possible deals - with a sizeable profit margin for you, of course.':
		'Börsenmakler sind Omas der Wall Street, die sich mit der Finanzwelt auskennen. Börsenmakler-Omas arbeiten hart und spielen hart und werden mit dem Telefon in der Hand kämpfen, um Ihren Kunden die bestmöglichen Angebote zu machen - natürlich mit einer beträchtlichen Gewinnspanne für Sie.',
	...
	"Buy that vintage car you've always wanted. Just pay us back.":
		'Kaufe den Oldtimer, den du schon immer haben wolltest. Zahl es uns einfach zurück.',
	'a pawnshop loan': 'ein Pfandhauskredit',
	"Bad credit? No problem. It's your money, and you need it now.":
		'Schlechte Bonität? Kein Problem! Es ist dein Geld, und du brauchst es jetzt.',
	'a retirement loan': 'ein Alterskredit',
	"Finance your next house, boat, spouse, etc. You've earned it.":
		'Finanziere dein nächstes Haus, Boot, Ehepartner, etc. Du hast es dir verdient.',
	'By taking this loan, you will get %1 CpS for the next %2.':
		'Wenn du dieses Darlehen nimmst, bekommst du %1 KpS für die nächsten %2.',
	'However, you will get %1 CpS for the next %2 after that.':
		'Du bekommst jedoch %1 KpS für die nächsten %2 danach.',
	'You must also pay an immediate downpayment of %1 (<b>%2%</b> of your current bank).':
		'Du musst außerdem eine sofortige Anzahlung von %1 (<b>%2%</b> deiner aktuellen Bank) leisten.',
	'Loan over': 'Kredit vorbei',
	'Your loan has expired, and you must now repay the interest.':
		'Dein Kredit ist ausgelaufen und du musst nun die Zinsen zurückzahlen.',
	...
	'Click to refill your opportunity timer (and give a quick burst to your economy) for %1.':
		'Klicke, um deinen Möglichkeiten-Timer aufzufüllen (und deiner Wirtschaft einen schnellen Schub zu geben) für %1.',
	'Profits: %1. All prices are in $econds of your highest raw cookies per second.':
		'Gewinne: %1. Alle Preise sind in $Sekunden deines höchsten KpS Grudnwertes.',
	...
	'[Upgrade name 96]Round chocolate british tea biscuits':
		'Runde britische Tee-Kekse aus Schokolade',
	'[Upgrade name 97]Round british tea biscuits with heart motif':
		'Rundes britisches Teegebäck mit Herzmotiv',
	'[Upgrade name 98]Round chocolate british tea biscuits with heart motif':
		'Runde Schokolade britische Teegebäck mit Herzmotiv',
	...
	'[Upgrade name 318]Some other super-tiny fundamental particle? Probably?':
		'Ein anderes superwinziges Elementarteilchen? Wahrscheinlich?',
	...
	'[Upgrade name 397]Distilled essence of redoubled luck':
		'Destillierte Essenz aus verdoppeltem Glück',
	...
	'[Upgrade name 442]Kitten assistants to the regional manager':
		'Kätzchen Assistenten des Regionalleiters',
	...
	'[Upgrade name 477]Synthetic chocolate green honey butter biscuit':
		'Synthetischer Schokoladen-Grünhonig-Butterkeks',
	'[Upgrade name 478]Royal raspberry chocolate butter biscuit':
		'Königlicher Himbeer-Schoko-Butterkeks',
	'[Upgrade name 479]Ultra-concentrated high-energy chocolate butter biscuit':
		'Ultra-konzentrierter hochenergetischer Schokoladen-Butterkeks',
	...
	'[Upgrade name 497]Pure pitch-black chocolate butter biscuit':
		'Reiner pechschwarzer Schokoladenbutterkeks',
	...
	'[Upgrade name 553]A chocolate chip cookie but with the chips picked off for some reason':
		'Ein Keks mit Schokoladensplittern, bei dem die Splitter aus irgendeinem Grund abgepflückt wurden',
	...
	'[Upgrade name 718]Milkhelp&reg; lactose intolerance relief tablets':
		'Milkhelp&reg; Tabletten gegen Laktoseintoleranz',
	...
	'[Achievement name 225]He who controls the cookies controls the universe':
		'Wer die Kekse kontrolliert, kontrolliert das Universum',
	...
	"[Achievement name 228]We're gonna need a bigger bakery":
		'Wir werden eine größere Bäckerei brauchen',
	...
	'[Achievement name 230]Brought to you by the letter <div style="display:inline-block;background:url(img/money.png);width:16px;height:16px;"></div>':
		'Präsentiert von dem Brief <div style="display:inline-block;background:url(img/money.png);width:16px;height:16px;"></div>',
	...
	'[Achievement name 246]Thumbs, phalanges, metacarpals':
		'Daumen, Fingerglieder, Mittelhandknochen',
	...
	"[Achievement name 255]And now for my next trick, I'll need a volunteer from the audience":
		'Und jetzt brauche ich für meinen nächsten Trick einen Freiwilligen aus dem Publikum',
	...
	'[Achievement name 259]cookie clicker forever and forever a hundred years cookie clicker, all day long forever, forever a hundred times, over and over cookie clicker adventures dot com':
		'Cookie Clicker für immer und ewig hundert Jahre Cookie Clicker, den ganzen Tag lang für immer, für immer hundert Mal, immer und immer wieder Cookie Clicker Abenteuer dot com',
	...
	"[Achievement name 275]Well the cookies start coming and they don't stop coming":
		'Nun, die Kekse fangen an zu kommen und sie hören nicht auf zu kommen',
	"[Achievement name 276]I don't know if you've noticed but all these icons are very slightly off-center":
		'Ich weiß nicht, ob Sie es bemerkt haben, aber alle diese Symbole sind sehr leicht dezentriert',
	'[Achievement name 277]The proof of the cookie is in the baking':
		'Der Beweis des Kekses liegt im Backen',
	"[Achievement name 278]If it's worth doing, it's worth overdoing":
		'Wenn es sich lohnt, etwas zu tun, dann lohnt es sich, es zu übertreiben',
	"[Achievement name 279]The dreams in which I'm baking are the best I've ever had":
		'Die Träume, in denen ich backe, sind die besten, die ich je hatte',
	...
	'[Achievement name 293]Click (starring Adam Sandler)':
		'Click (mit Adam Sandler in der Hauptrolle)',
	...
	'[Achievement name 301]Neither snow nor rain nor heat nor gloom of night':
		'Weder Schnee noch Regen noch Hitze noch Finsternis der Nacht',
	...
	'[Achievement name 349]What happens in the vortex stays in the vortex':
		'Was im Strudel passiert, bleibt im Strudel',
	...
	"[Achievement name 357]Save your breath because that's all you've got left":
		'Spar deinen Atem, denn das ist alles was du noch hast',
	...
	'[Achievement name 360]Space space space space space':
		'Weltraum Weltraum Weltraum Weltraum Weltraum',
	"[Achievement name 361]Don't get used to yourself, you're gonna have to change":
		'Gewöhne dich nicht an dich selbst, du wirst dich ändern müssen',
	'[Achievement name 362]Objects in the mirror dimension are closer than they appear':
		'Objekte in der Spiegeldimension sind näher als sie erscheinen',
	...
	'[Achievement name 376]All the other kids with the pumped up clicks':
		'All die anderen Kinder mit den aufgepumpten Klicks',
	...
	'[Achievement name 397]When the cookies ascend just right':
		'Wenn die Kekse genau richtig aufsteigen',
	...
	"[Achievement name 404]My world's on fire, how about yours":
		"Meine Welt brennt, wie steht's mit deiner?",
	...
	'[Achievement name 407]We could all use a little change':
		'Wir könnten alle ein wenig Abwechslung gebrauchen',
	'[Achievement name 408]Your brain gets smart but your head gets dumb':
		'Ihr Gehirn wird schlau, aber Ihr Kopf wird dumm',
	...
	'[Achievement name 421]For more information on this achievement, please refer to its title':
		'Weitere Informationen zu diesem Erfolg finden Sie in seinem Titel',
	"[Achievement name 422]I'm so meta, even this achievement":
		'Ich bin so meta, sogar dieser Erfolg',
	...
	"[Achievement name 429]I think it's safe to say you've got it made":
		'Ich denke, man kann mit Sicherheit sagen, dass Sie es geschafft haben',
	...
	"[Achievement name 442]Dude what if we're all living in a simulation like what if we're all just code on a computer somewhere":
		'Alter, was, wenn wir alle in einer Simulation leben, was, wenn wir alle nur Code auf einem Computer irgendwo sind',
	...
	"[Achievement name 449]You're #1 so why try harder":
		'Du bist die Nummer 1, warum solltest du dich also mehr anstrengen',
	"[Achievement name 450]Haven't even begun to peak":
		'Haben noch nicht einmal angefangen zu klettern',
	...
	'[Achievement name 467]What did we even eat before these':
		'Was haben wir überhaupt vorher gegessen?',
	...
	'[Achievement name 495]Mountain out of a molehill, but like in a good way':
		'Ein Berg aus einer Mücke, aber auf eine gute Art und Weise',
	...
	'[Achievement name 506]Flip a cookie. Chips, I win. Crust, you lose.':
		'Wirf einen Keks. Splitter, ich gewinne. Kruste, du verlierst.',
	...
	'[Achievement name 515]Nobody exists on purpose, nobody belongs anywhere':
		'Niemand existiert mit Absicht, niemand gehört irgendwo hin',
	...
	'[Achievement name 521]Reject reality, substitute your own':
		'Lehne die Realität ab, ersetze deine eigene',
	...
	"[Achievement name 532]But I didn't say stop, did I?":
		'Aber ich habe nicht gesagt, dass du aufhören sollst, oder?',
	...
	'[Achievement name 544]A trademarked portmanteau of "imagination" and "engineering"':
		'Ein geschütztes Portmanteau aus "Imagination" und "Ingenieurwesen".',
	...
	'[Achievement name 548]Though fools seldom differ':
		'Auch wenn Narren sich nur selten unterscheiden',
	...
	"[Achievement name 558]Don't let the walls cave in on you":
		'Lass die Wände nicht über dir zusammenbrechen',
	...
	'[Achievement name 566]But the future refused to change':
		'Aber die Zukunft wollte sich nicht ändern',
	...
	'[Achievement name 573]By will alone I set my mind in motion':
		'Allein durch meinen Willen setze ich meinen Geist in Bewegung',
	...
	'[Achievement name 586]What do you get for the baker who has everything':
		'Was schenkt man dem Bäcker, der alles hat',
