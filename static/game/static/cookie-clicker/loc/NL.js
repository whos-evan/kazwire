AddLanguage('NL', 'dutch', {
	...
	grandmapocalypse: '/',
	'%1 cookie': ['%1 koekje', '%1 koekjes'],
	'%1 sugar lump': ['%1 suikerklontje', '%1 suikerklontjes'],
	'%1 heavenly chip': ['%1 hemels stukje', '%1 hemelse stukjes'],
	'%1 golden cookie': ['%1 gouden koekje', '%1 gouden koekjes'],
	'%1 building': ['%1 gebouw', '%1 gebouwen'],
	...
	'%1 day': ['%1 dag', '%1 dagen'],
	'%1 hour': ['%1 uur', '%1 uur'],
	'%1 minute': ['%1 minuut', '%1 minuten'],
	'%1 second': ['%1 seconde', '%1 seconden'],
	...
	'visual improvements; disabling may improve performance':
		'spel ziet er mooier uit; uitzetten kan prestaties verbeteren',
	...
	'display boxes around upgrades and achievements in Stats':
		'je ziet kratten bij je upgrades en prestaties in stats',
	...
	'the game will ask you to confirm when you close the window':
		'het spel vraagt om bevestiging als je het venster sluit',
	Defocus: 'Antifocus',
	'the game will be less resource-intensive when out of focus':
		'het spel heeft minder systeembronnen nodig als het onscherp is',
	...
	'the game will ask you to confirm before spending sugar lumps':
		'het spel vraagt om bevestiging als je suikerklontjes uitgeeft',
	'Custom grandmas': "Speciale oma's",
	'some grandmas will be named after Patreon supporters':
		"sommige oma's zijn naar Patreon-supporters vernoemd",
	...
	"on slower computers, the game will put itself in sleep mode when it's inactive and starts to lag out; offline CpS production kicks in during sleep mode":
		'op langzame computers gaat het spel in de slaapmodus als het inactief is en uit begint te gaan. De KpS gaat offline in de slaapmodus gewoon door.',
	'Music in background': 'Muziek op de achtergrond',
	"music will keep playing even when the game window isn't focused":
		'muziek blijft ook spelen als het spelscherm niet openstaat',
	'Cloud saving': 'Cloudopslag',
	'allow use of Steam Cloud for save backups':
		'sta gebruik van Steam Cloud toe om back-ups op te slaan',
	...
	'allows optimizations for screen readers; game will reload':
		'staat optimalisaties toe voor schermlezers; het spel wordt opnieuw geladen',
	'Discord status': 'Discord-status',
	'if Discord is on, show your game info as activity status':
		'Als Discord aan staat, je game-informatie als activiteitenstatus tonen',
	Language: 'Taal',
	'Language: %1': 'Taal: %1',
	'Change language': 'Taal wijzigen',
	'note: this will save and reload your game':
		'opmerking: het spel wordt opgeslagen en opnieuw geladen',
	...
	'These are feats that are either unfair or difficult to attain. They do not give milk.':
		'Dit zijn prestaties die oneerlijk behaald worden of moeilijk te behalen zijn. Je krijgt er geen melk voor.',
	...
	'with %1 ascension': ['met %1 opstijging', 'met %1 opstijgingen'],
	...
	'Milk is gained with each achievement. It can unlock unique upgrades over time.':
		'Je krijgt melk voor elke prestatie. De melk kan unieke upgrades ontgrendelen.',
	'Rank %1': 'Niveau %1',
	...
	'Cookie Clicker is a javascript game by %1 and %2.':
		'Cookie Clicker is een javascriptspel van %1 en %2.',
	...
	"This version of Cookie Clicker is 100% free, forever. Want to support us so we can keep developing games? Here's some ways you can help:%1":
		'Deze versie van Cookie Clicker is voor altijd 100% gratis. Wil je ons steunen zodat we nog meer spellen kunnen maken? Dat kan op deze manieren:%1',
	"Note: if you find a new bug after an update and you're using a 3rd-party add-on, make sure it's not just your add-on causing it!":
		'Let op: als je na een update een nieuwe bug vindt en je gebruikt een add-on van een derde, zorg er dan voor dat je zeker weet dat deze add-on de bug niet veroorzaakt! ',
	'Warning: clearing your browser cache or cookies <small>(what else?)</small> will result in your save being wiped. Export your save and back it up first!':
		'Waarschuwing: als je je browsergegevens of cookies <small>(koekjes, hahaha)</small> wist, wordt alles wat je in dit spel hebt opgeslagen, ook gewist. Exporteer dat dus eerst en maak er een back-up van!',
	...
	'Note: older update notes are in English.':
		'Opmerking: oudere updatebeschrijvingen zijn in het Engels.',
	'This feature is not yet available in your language.':
		'Deze functie is nog niet beschikbaar in jouw taal.',
	...
	'Cookie Clicker is in sleep mode and generating offline cookies.':
		'Cookie Clicker staat in de slaapmodus en maakt offline cookies.',
	...
	'(this happens when too many frames are skipped at once,<br>usually when the game has been running in the background for a while)<br>(you can turn this feature off in the settings menu)':
		'(dit gebeurt als er te veel frames tegelijk worden overgeslagen,<br>meestal als het spel al een tijdje op de achtergrond draait)<br>(je kunt deze functie uitzetten in de instellingen)',
	'Are you sure you want to close Cookie Clicker?':
		'Weet je zeker dat je Cookie Clicker wilt afsluiten?',
	...
	'Hello again! Just a reminder that you may want to back up your Cookie Clicker save every once in a while, just in case.<br>To do so, go to Options and hit "Export save" or "Save to file"!':
		'Fijn dat je er weer bent! We willen je er even aan herinneren dat het handig is om je spel af en toe even op te slaan. Je weet nooit wat er kan gebeuren.<br>Dat doe je door naar Opties te gaan en op "Spelgegevens exporteren" of "In bestand opslaan" te klikken.',
	'Save manually (the game autosaves every 60 seconds; shortcut: ctrl+S)':
		'Handmatig opslaan (het spel slaat elke 60 seconden automatisch op. Je kunt ook ctrl+S indrukken)',
	'You can use this to backup your save or to transfer it to another computer (shortcut for import: ctrl+O)':
		'Dit kun je gebruiken om een back-up te maken van je spel of de gegevens over te zetten naar een andere computer (druk op ctrl+O voor importeren)',
	...
	'This is your save code.<br>Copy it and keep it somewhere safe!':
		'Dit is je code.<br>Kopieer deze code en bewaar hem op een veilige plek.',
	'Import save': 'Gegevens importeren',
	'Please paste in the code that was given to you on save export.':
		'Plak hier de code die je gekregen hebt bij het exporteren.',
	...
	'Oops, looks like the import string is all wrong!':
		'O jee, het lijkt erop dat de regel code niet goed is!',
	'You are attempting to load a save from a future version (v. %1; you are using v. %2).':
		'Je probeert een spel te laden van een nieuwere versie (v. %1; maar jij hebt v. %2).',
	"Sorry, you can't import saves from the classic version.":
		'Sorry, je kunt geen gegevens importeren van de klassieke versie.',
	'Wipe save': 'Spelgegevens wissen',
	'Delete all your progress, including your achievements':
		'Je wist al je voortgang, ook je prestaties.',
	'Do you REALLY want to wipe your save?<br><small>You will lose your progress, your achievements, and your heavenly chips!</small>':
		'Wil je ECHT je spelgegevens wissen?<br><small>Je verliest je voortgang, je prestaties en je hemelse stukjes!</small>',
	"Whoah now, are you really, <b><i>REALLY</i></b> sure you want to go through with this?<br><small>Don't say we didn't warn you!</small>":
		'Ho even. Weet je het echt, <b><i>ECHT</i></b> heel zeker dat je hiermee door wilt gaan?<br><small>We hebben je gewaarschuwd!</small>',
	...
	'Only use mods from trusted sources. Some mods may require a game restart to take effect.':
		'Gebruik alleen mods van betrouwbare bronnen. Sommige mods zijn alleen effectief na het opnieuw opstarten van het spel.',
	Enable: 'Inschakelen',
	...
	'This tool allows you to upload new mods to the Steam Workshop.<br>You need to select a mod folder containing a properly-formatted %1 file.<br>See the included sample mods for examples.':
		'Met deze tool kun je nieuwe mods uploaden naar de Steam Workshop.<br>Je moet een modmap selecteren waar een %1 bestand in de juiste indeling in staat.<br>Zie de inbegrepen voorbeeldmods als voorbeeld.',
	...
	'These are the mods present in your save data. You may delete some of this data to make your save file smaller.':
		'Deze mod-gegevens zijn aanwezig in je bestand. Je kunt wat van deze gegevens wissen om je bestand kleiner te maken.',
	'(loaded)': '(geladen)',
	'%1 char': ['%1 teken', '%1 tekens'],
	'Check mod data': 'Mod-gegevens bekijken',
	'view and delete save data created by mods':
		'spelgegevens die door mods zijn gecreëerd, bekijken en wissen',
	...
	'You are currently playing Cookie Clicker on the <b>%1</b> protocol.<br>The <b>%2</b> version uses a different save slot than this one.<br>Click this lock to reload the page and switch to the <b>%2</b> version!':
		'Je speelt Cookie Clicker nu op het <b>%1</b>-protocol.<br>De <b>%2</b>-versie gebruikt een andere opslaglocatie dan deze.<br>Klik op dit slot om de pagina opnieuw te laden en naar de <b>%2</b>-versie te gaan.',
	'+%1 more notification.': ['nog 1% melding.', 'nog 1% meldingen.'],
	Christmas: 'Kerst',
	...
	"Because you've baked a <b>billion cookies</b> in total, you are now attracting <b>sugar lumps</b>. They coalesce quietly near the top of your screen, under the Stats button.<br>You will be able to harvest them when they're ripe, after which you may spend them on all sorts of things!":
		'Omdat je in totaal 1 <b>miljard koekjes</b> hebt gebakken, trek je nu <b>suikerklontjes aan</b>. Ze verzamelen zich aan de bovenkant van je scherm, onder de knop Stats.<br>Je kunt ze oogsten als ze rijp zijn. Dan kun je ze aan allerlei dingen uitgeven!',
	'A <b>sugar lump</b> is coalescing here, attracted by your accomplishments.':
		'Er zit hier een <b>suikerklontje</b>. Die is aangetrokken door je prestaties. ',
	'Your sugar lumps mature after <b>%1</b>,<br>ripen after <b>%2</b>,<br>and fall after <b>%3</b>.':
		'Je suikerklontjes zijn volgroeid na <b>%1</b>,<br>rijp na <b>%2</b><br>en vallen na <b>%3</b>.',
	...
	"This sugar lump is mature and will be ripe in <b>%1</b>.<br>You may <b>click it to harvest it now</b>, but there is a <b>50% chance you won't get anything</b>.":
		'Dit suikerklontje is volgroeid en is rijp over <b>%1</b>.<br>Je kunt er <b>nu op klikken om hem te oogsten</b>, maar dan heb je <b>50% kans dat je niets krijgt</b>.',
	'<b>This sugar lump is ripe! Click it to harvest it.</b><br>If you do nothing, it will auto-harvest in <b>%1</b>.':
		'<b>Dit suikerklontje is rijp! Klik erop om hem te oogsten.</b><br>Als je niets doet, wordt hij over <b>%1</b> automatisch geoogst.',
	'This sugar lump grew to be <b>bifurcated</b>; harvesting it has a 50% chance of yielding two lumps.':
		'Dit suikerklontje heeft een <b>bijzondere vorm</b> gekregen. Als je hem oogst, heb je 50% kans om twee suikerklontjes te krijgen.',
	'This sugar lump grew to be <b>golden</b>; harvesting it will yield 2 to 7 lumps, your current cookies will be doubled (capped to a gain of 24 hours of your CpS), and you will find 10% more golden cookies for the next 24 hours.':
		'Dit suikerklontje is een <b>gouden</b> suikerklontje geworden. Als je hem oogst, krijg je 2 tot 7 nieuwe klontjes. Je huidige koekjes worden verdubbeld (tot maximaal 24 uur KpS) en je krijgt de komende 24 uur 10% meer gouden koekjes.',
	'This sugar lump was affected by the elders and grew to be <b>meaty</b>; harvesting it will yield between 0 and 2 lumps.':
		'Dit suikerklontje is aangetast door de ouderlingen en is <b>vlezig</b> geworden. Als je hem oogst, krijg je 0 tot 2 nieuwe klontjes.',
	'This sugar lump is <b>caramelized</b>, its stickiness binding it to unexpected things; harvesting it will yield between 1 and 3 lumps and will refill your sugar lump cooldowns.':
		'Dit suikerklontje is <b>gekarameliseerd</b>. Door zijn kleverigheid plakt hij aan allerlei onverwachte dingen. Als je hem oogst, krijg je 1 tot 3 nieuwe klontjes en hij reset de cooldown van je suikerklontjes.',
	...
	'Your cookies have been doubled.<br>+10% golden cookies for the next 24 hours.':
		'Je koekjes zijn verdubbeld.<br>+10% gouden koekjes in de komende 24 uur.',
	...
	'To benefit from the herald bonus, you need a special upgrade you do not yet own. You will permanently unlock it later in the game.':
		'Om te profiteren van de herautenbonus, heb je een speciale upgrade nodig die je nog niet hebt. Je kunt hem later in het spel ontgrendelen.',
	'<b>Heralds</b> are people who have donated to our highest Patreon tier, and are limited to 100.<br>Each herald gives everyone +1% CpS.<br>Heralds benefit everyone playing the game, regardless of whether you donated.':
		'<b>Herauten</b> zijn mensen die hebben gedoneerd aan ons hoogste Patreon-niveau. Dat kunnen er maximaal 100 zijn.<br>Elke heraut geeft iedereen +1% KpS.<br>Iedereen die het spel speelt, of je nu gedoneerd hebt of niet, profiteert van de herauten.',
	'Every %1 current players on Steam generates <b>1 herald</b>, up to %2 heralds.<br>Each herald gives everyone +1% CpS.':
		'Elke %1 huidige spelers op Steam genereren <b>1 heraut</b>, tot maximaal %2 herauten.<br>Elke heraut geeft iedereen +1% KpS.',
	'+%1!': '/',
	...
	'Sweet!<br><small>Found 1 sugar lump!</small>':
		'Geweldig!<br><small>1 suikerklontje gevonden!</small>',
	'Lucky!': 'Geluk!',
	'Ruin!': 'Geruïneerd!',
	...
	'Cookie chain broken.<br><small>You made %1.</small>':
		'Koekjesketen gebroken.<br><small>Je hebt %1 gekregen.</small>',
	'Cookie blab': [
	...
	'Lets you use two dragon auras simultaneously':
		"Hiermee kun je twee drakenaura's tegelijk gebruiken",
	...
	'<b>One tenth</b> of every other dragon aura, <b>combined</b>.':
		'<b>Eén tiende</b> van elke andere drakenaura <b>bij elkaar</b>.',
	'Switching your aura is <b>free</b> because you own no buildings.':
		'Van aura wisselen is <b>gratis</b> omdat je geen gebouwen hebt.',
	'The cost of switching your aura is <b>%1</b>.<br>This will affect your CpS!':
		'Het wisselen van je aura kost <b>%1</b>.<br>Dit is van invloed op je KpS!',
	...
	'You feel like making cookies. But nobody wants to eat your cookies.':
		'Je wil graag koekjes maken. Maar niemand wil je koekjes eten.',
	'Your first batch goes to the trash. The neighborhood raccoon barely touches it.':
		'De eerste serie gaat linea recta de vuilnisbak in. Zelfs de dikke kat van de buren kijkt er niet naar om.',
	'Your family accepts to try some of your cookies.':
		'Vooruit. Je moeder wil wel een koekje van je proeven.',
	...
	'Your cookies are talked about for miles around.':
		'Ze praten in de wijde omtrek over je koekjes.',
	...
	'People come from very far away to get a taste of your cookies.':
		'Mensen komen van heinde en verre om jouw koekjes te proeven.',
	'Kings and queens from all over the world are enjoying your cookies.':
		'Koningen en koninginnen over de hele wereld smullen van jouw koekjes.',
	'There are now museums dedicated to your cookies.':
		'Er zijn nu museums opgericht ter ere van jouw koekjes.',
	'A national day has been created in honor of your cookies.':
		'Er is een nationale feestdag uitgeroepen ter ere van jouw koekjes.',
	'Your cookies have been named a part of the world wonders.':
		'Je koekjes zijn uitgeroepen tot een van de wereldwonderen.',
	'History books now include a whole chapter about your cookies.':
		'Geschiedenisboeken hebben een heel hoofdstuk aan jouw koekjes gewijd.',
	'Your cookies have been placed under government surveillance.':
		'Je koekjes zijn door de overheid onder toezicht gesteld.',
	...
	'Strange creatures from neighboring planets wish to try your cookies.':
		'Vreemde wezens van andere planeten willen je koekjes graag proeven.',
	'Elder gods from the whole cosmos have awoken to taste your cookies.':
		'Oppergoden vanuit de hele kosmos komen je koekjes proeven.',
	'Beings from other dimensions lapse into existence just to get a taste of your cookies.':
		'Wezens van een andere dimensie komen helemaal naar deze dimensie om jouw koekjes te proeven.',
	...
	'The universe has now turned into cookie dough, to the molecular level.':
		'Het universum is in koekjesdeeg veranderd op moleculair niveau.',
	'Your cookies are rewriting the fundamental laws of the universe.':
		'Je koekjes herschrijven de fundamentele wetten van het universum.',
	'A local news station runs a 10-minute segment about your cookies. Success!<br><small>(you win a cookie)</small>':
		'Een plaatselijke nieuwszender praat tien minuten lang over jouw koekjes. Je hebt echt succes!<br><small>(je wint een koekje)</small>',
	...
	'You gain <b>one hour</b> of your CpS (capped at double your bank).':
		'Je krijgt <b>één uur</b> van je KpS (tot maximaal het dubbele van je voorraad).',
	...
	'Your prestige level is currently <b>%1</b>.<br>(CpS +%2%)':
		'Je prestigelevel is nu <b>%1</b>.<br>(KpS +%2%)',
	...
	'Ascending now would grant you<br><b>1 prestige level</b> (+1% CpS)<br>and <b>1 heavenly chip</b> to spend.':
		'Als je nu opstijgt, krijg je<br><b>1 prestigelevel</b> (+1%KpS)<br><b>1 hemels stukje</b> om uit te geven.',
	'Ascending now would grant you<br><b>%1 prestige levels</b> (+%2% CpS)<br>and <b>%3 heavenly chips</b> to spend.':
		'Als je nu opstijgt, krijg je<br><b>1 prestigelevels</b> (+1%KpS)<br><b>1 hemelse stukjes</b> om uit te geven.',
	'You need <b>%1 more cookies</b> for the next level.':
		'Je hebt nog <b>%1 koekjes</b> nodig voor het volgende level.',
	'Do you REALLY want to ascend?<div class="line"></div>You will lose your progress and start over from scratch.<div class="line"></div>All your cookies will be converted into prestige and heavenly chips.':
		'Wil je ECHT opstijgen?<div class="line"></div>Je verliest al je voortgang en begint helemaal opnieuw.<div class="line"></div>Al je koekjes worden omgezet in prestige en hemelse stukjes.',
	'You will keep your achievements.': 'Je prestaties hou je wel.',
	'You will keep your achievements, building levels and sugar lumps.':
		'Je houdt je prestaties, gebouwlevels en suikerklontjes.',
	Ascending: 'Opstijgen',
	'So long, cookies.': 'Dag koekjes.',
	'You forfeit your %1.': 'Je geeft je %1 op.',
	'Prestige level:': 'Prestigelevel:',
	'Heavenly chips:': 'Hemelse stukjes:',
	'%1 prestige level': ['%1 prestigelevel', '%1 prestigelevels'],
	...
	"You are ascending.<br>Drag the screen around<br>or use arrow keys!<br>When you're ready,<br>click Reincarnate.":
		'Je stijgt op.<br>Sleep het scherm heen en weer<br>of gebruik de pijltjestoetsen.<br>Als je klaar bent,<br>klik je op Reïncarneren.',
	'Each prestige level grants you a permanent <b>+%1% CpS</b>.<br>The more levels you have, the more cookies they require.':
		'Voor elk prestigelevel krijg je permanent <b>+%1% KpS</b>.<br>Hoe meer levels je hebt, hoe meer koekjes ze kosten.',
	'Heavenly chips are used to buy heavenly upgrades.<br>You gain <b>1 chip</b> every time you gain a prestige level.':
		'Hemelse stukjes kun je gebruiken om hemelse upgrades te kopen.<br>Elke keer dat je een prestigelevel haalt, krijg je <b>1 stukje</b>',
	"Click this once you've bought<br>everything you need!":
		'Klik hierop als je alles hebt gekocht<br>wat je nodig hebt!',
	'Are you ready to return to the mortal world?':
		'Ben je er al klaar voor om naar de wereld van de levenden terug te keren?',
	...
	'Challenge modes apply special modifiers to your next ascension.<br>Click to change.':
		'Voor uitdagingen krijg je speciale modificaties bij je volgende opstijging.<br>Klik hier om het te veranderen.',
	...
	'This run will behave as if you\'d just started the game from scratch. Prestige levels and heavenly upgrades will have no effect, as will sugar lumps and building levels. Perma-upgrades and minigames will be unavailable.<div class="line"></div>Some achievements are only available in this mode.':
		'In dit speltype begin je helemaal opnieuw. Prestigelevels, hemelse upgrades, suikerklontjes en gebouwlevels hebben geen enkel effect meer. Perma-upgrades en minispellen zijn niet beschikbaar.<div class="line"></div>Sommige prestaties zijn alleen in dit speltype te halen.',
	'Your bingo center/research facility is conducting experiments.':
		'Je bingocentrum/onderzoekslocatie voert experimenten uit.',
	...
	"It's <b>Valentine's season</b>!<br>Love's in the air and cookies are just that much sweeter!":
		'Het is <b>Valentijnsdag</b>!<br>De liefde hangt in de lucht en koekjes zijn nóg zoeter geworden.',
	'Business Day!': 'Werkdag!',
	"It's <b>Business season</b>!<br>Don't panic! Things are gonna be looking a little more corporate for a few days.":
		'Het is weer <b>tijd om te werken</b>!<br>Geen paniek! We gaan deze dagen gewoon iets harder ons best doen.',
	'Halloween!': '/',
	"It's <b>Halloween season</b>!<br>Everything is just a little bit spookier!":
		'Het is <b>Halloween</b>!<br>Alles is nu een beetje griezeliger.',
	'Christmas time!': 'Kerst!',
	"It's <b>Christmas season</b>!<br>Bring good cheer to all and you just may get cookies in your stockings!":
		'Het is <b>Kerst</b>!<br>Maak er een vrolijke boel van en misschien liggen er straks wel koekjes onder de kerstboom.',
	'Easter!': 'Pasen!',
	"It's <b>Easter season</b>!<br>Keep an eye out and you just might click a rabbit or two!":
		'Het is <b>Pasen</b>!<br>Let goed op. Misschien verschijnen er wel wat konijnen waar je op kunt klikken.',
	'[Tag]Heavenly': 'Hemels',
	'[Tag]Tech': 'Tech',
	'[Tag]Cookie': 'Koek',
	'[Tag]Debug': 'Debug',
	...
	'Upgrade is vaulted and will not be auto-purchased.':
		'Upgrade staat in de kluis en wordt niet automatisch gekocht.',
	...
	'Will <b>instantly purchase</b> every upgrade you can afford, starting from the cheapest one.<br>Upgrades in the <b>vault</b> will not be auto-purchased.<br>You may place an upgrade into the vault by <b>Shift-clicking</b> on it.':
		'<b>Koopt onmiddellijk</b> alle upgrades die je kunt betalen, en begint bij de goedkoopste.<br>Upgrades in de <b>kluis</b> worden niet automatisch gekocht.<br>Je kunt een upgrade in de kluis zetten door erop <b>te klikken terwijl je shift ingedrukt houdt</b>.',
	...
	'all combined, these boosts account for <b>%1</b> per second (<b>%2%</b> of total CpS)':
		'bij elkaar zijn deze boosts goed voor <b>%1</b> per seconde (<b>%2%</b> van je totale KpS)',
	'owned: %1': 'in bezit: %1',
	'free: %1!': 'gratis: %1!',
	'Level %1 %2': '/',
	...
	'Levelling up this building unlocks a minigame.':
		'Als je dit gebouw naar het volgende level brengt, ontgrendel je een minispel.',
	...
	'Names in white were submitted by our supporters on Patreon.':
		'De witte namen zijn ingestuurd door onze supporters op Patreon.',
	'You can also press %1 to bulk-buy or sell %2 of a building at a time, or %3 for %4.':
		'Je kunt ook op %1 klikken om %2 gebouwen tegelijk in bulk te kopen of verkopen, of op %3 voor %4.',
	Investment: 'Investering',
	"You're not sure what this does, you just know it means profit.":
		'Je weet niet precies wat het betekent, maar je weet wel dat je winst krijgt.',
	Cursor: '/',
	cursor: '/',
	cursors: '/',
	'%1 cursor': ['%1 cursor', '%1 cursors'],
	...
	'[Cursor business quote]Essential in flattening dough. The first step in cookie-making.':
		'Essentieel voor het uitrollen van deeg. De eerste stap bij het maken van koekjes.',
	Grandma: 'Oma',
	grandma: 'oma',
	grandmas: "oma's",
	'%1 grandma': ['%1 oma', "%1 oma's"],
	'[Grandma quote]A nice grandma to bake more cookies.':
		'Een lief omaatje die koekjes voor je bakt.',
	'[Grandma business name]Oven': 'Oven',
	'[Grandma business quote]A crucial element of baking cookies.':
		'Een essentieel apparaat om koekjes te kunnen bakken.',
	Farm: 'Boerderij',
	farm: 'boerderij',
	farms: 'boerderijen',
	'%1 farm': ['%1 boerderij', '%1 boerderijen'],
	...
	'[Farm business quote]The more kitchens, the more cookies your employees can produce.':
		'Hoe meer keukens, hoe meer koekjes je werknemers kunnen bakken.',
	Mine: 'Mijn',
	mine: 'mijn',
	mines: 'mijnen',
	'%1 mine': ['%1 mijn', '%1 mijnen'],
	'[Mine quote]Mines out cookie dough and chocolate chips.':
		'Delft koekjesdeeg en chocoladestukjes.',
	...
	'[Mine business quote]These give you the edge you need to outsell those pesky competitors.':
		'Dat heb je nodig om meer te kunnen verkopen dan je concurrenten.',
	Factory: 'Fabriek',
	factory: 'fabriek',
	factories: 'fabrieken',
	'%1 factory': ['%1 fabriek', '%1 fabrieken'],
	...
	'[Factory business quote]Mass production is the future of baking. Seize the day, and synergize!':
		'Massaproductie is de toekomst van bakken. Maak er gebruik van!',
	Bank: '/',
	bank: '/',
	banks: 'banken',
	...
	"[Bank business quote]Business folks with a nose for profit, ready to finance your venture as long as there's money to be made.":
		'Zakenmensen die een neus hebben voor winst en die jouw onderneming best willen financieren, als er maar geld mee te verdienen is.',
	Temple: 'Tempel',
	temple: 'tempel',
	temples: 'tempels',
	'%1 temple': ['%1 tempel', '%1 tempels'],
	'[Temple quote]Full of precious, ancient chocolate.':
		'Tjokvol eeuwenoude chocolade van onschatbare waarde',
	...
	'[Temple business quote]Your social media page is going viral! Amassing likes is the key to a lasting online presence and juicy advertising deals.':
		'Je socialemediapagina gaat viraal! Verzamel zoveel mogelijk vind-ik-leuks zodat je online goed te vinden bent en de beste deals krijgt.',
	'Wizard tower': 'Tovenaarstoren',
	'wizard tower': 'tovenaarstoren',
	'wizard towers': 'tovenaarstorens',
	'%1 wizard tower': ['%1 tovenaarstoren', '%1 tovenaarstorens'],
	'[Wizard tower quote]Summons cookies with magic spells.':
		'Roept koekjes op met magische toverspreuken.',
	...
	'[Wizard tower business quote]Cookie memes are all the rage! With just the right amount of social media astroturfing, your brand image will be all over the cyberspace.':
		'Koekjesmemes zijn helemaal hot! Zorg dat je genoeg reviews op sociale media hebt, en dan gaat je merk de hele cyberspace over.',
	Shipment: 'Verzending',
	shipment: 'verzending',
	shipments: 'verzendingen',
	'%1 shipment': ['%1 verzending', '%1 verzendingen'],
	'[Shipment quote]Brings in fresh cookies from the cookie planet.':
		'Haalt verse koekjes van de koekjesplaneet.',
	...
	'[Shipment business quote]A gigantic cookie emporium - your very own retail chain.':
		'Een gigantisch koekjesmagazijn: je eigen retailketen.',
	'Alchemy lab': 'Alchemielab',
	'alchemy lab': 'alchemielab',
	'alchemy labs': 'alchemielabs',
	'%1 alchemy lab': ['%1 alchemielab', '%1 alchemielabs'],
	...
	"[Alchemy lab business quote]You're officially on the stock market, and everyone wants a piece!":
		'Je zit nu officieel op de aandelenmarkt, en iedereen wil daarvan meegenieten!',
	Portal: 'Poort',
	portal: 'portaal',
	portals: 'portalen',
	'%1 portal': ['%1 portaal', '%1 portalen'],
	...
	'[Portal business quote]Your cookies have their own sitcom! Hilarious baking hijinks set to the cheesiest laughtrack.':
		"Je koekjes hebben hun eigen sitcom! Hilarische bakgrappen met natuurlijk zo'n lachband op de achtergrond.",
	'Time machine': 'Tijdmachine',
	'time machine': 'tijdmachine',
	'time machines': 'tijdmachines',
	'%1 time machine': ['%1 tijdmachine', '%1 tijdmachines'],
	'[Time machine quote]Brings cookies from the past, before they were even eaten.':
		'Haalt koekjes uit het verleden voordat ze opgegeten zijn.',
	...
	'[Time machine business quote]Cookie theme parks, full of mascots and roller-coasters. Build one, build a hundred!':
		'Koekjespretparken met mascottes en achtbanen. Bouw er eens één. Of honderd! Waarom ook niet?',
	'Antimatter condenser': 'Antimateriecondensator',
	'antimatter condenser': 'antimateriecondensator',
	'antimatter condensers': 'antimateriecondensators',
	'%1 antimatter condenser': ['%1 antimateriecondensator', '%1 antimateriecondensators'],
	'[Antimatter condenser quote]Condenses the antimatter in the universe into cookies.':
		'Condenseert de antimaterie in het universum in koekjes.',
	...
	'[Antimatter condenser business quote]A virtual currency, already replacing regular money in some small countries.':
		'Een virtueel betaalmiddel, dat in sommige kleine landen het echte geld al aan het vervangen is.',
	Prism: 'Prisma',
	prism: 'prisma',
	prisms: "prisma's",
	'%1 prism': ['%1 prisma', "%1 prisma's"],
	...
	"[Prism business quote]You've made it to the top, and you can now buy entire nations to further your corporate greed. Godspeed.":
		'Je hebt de top bereikt, en nu kun je hele landen kopen om je zaken nóg verder te brengen. Veel succes!',
	Chancemaker: 'Kansgenerator',
	chancemaker: 'kansgenerator',
	chancemakers: 'kansgenerators',
	'%1 chancemaker': ['%1 kansgenerator', '%1 kansgenerators'],
	'[Chancemaker quote]Generates cookies out of thin air through sheer luck.':
		'Maakt koekjes uit lucht op basis van stom geluk.',
	...
	"[Chancemaker business quote]Actually, you know what's cool? A whole planet dedicated to producing, advertising, selling, and consuming your cookies.":
		'Weet je wat echt cool zou zijn? Een hele planeet die gewijd is aan het produceren, adverteren, verkopen en consumeren van je koekjes.',
	'Fractal engine': 'Fractaalmotor',
	'fractal engine': 'fractaalmotor',
	'fractal engines': 'fractaalmotoren',
	'%1 fractal engine': ['%1 fractaalmotor', '%1 fractaalmotoren'],
	'[Fractal engine quote]Turns cookies into even more cookies.':
		'Zet koekjes om in nog meer koekjes.',
	...
	'[Fractal engine business quote]Only through political dominion can you truly alter this world to create a brighter, more cookie-friendly future.':
		'Alleen als je het in de politiek voor het zeggen hebt, kun je deze wereld écht veranderen en voor een mooie, koekjesvriendelijke toekomst zorgen.',
	'Javascript console': 'Javascript-console',
	'javascript console': 'javascript-console',
	'javascript consoles': 'javascript-consoles',
	'%1 javascript console': ['%1 javascript-console', '%1 javascript-consoles'],
	'[Javascript console quote]Creates cookies from the very code this game was written in.':
		'Maakt koekjes van de code waarin dit spel geschreven is.',
	...
	"[Idleverse quote]There's been countless other idle universes running alongside our own. You've finally found a way to hijack their production and convert whatever they've been making into cookies!":
		'Er bestaan heel veel inactieve universums naast die van ons. Je hebt eindelijk een manier gevonden om hun productie te kapen en alles wat ze maken om te zetten in koekjes!',
	...
	'[Idleverse business quote]Sometimes the best way to keep going up is sideways. Diversify your ventures through non-cookie investments.':
		'Soms moet je om verder te komen niet verticaal, maar horizontaal denken. Spreid je ondernemingen via investeringen in dingen die geen koekjes zijn.',
	'Cortex baker': 'Cortex-bakker',
	'cortex baker': 'cortex-bakker',
	'cortex bakers': 'cortex-bakkers',
	'%1 cortex baker': ['%1 cortex-bakker', '%1 cortex-bakkers'],
	'[Cortex baker quote]These artificial brains the size of planets are capable of simply dreaming up cookies into existence. Time and space are inconsequential. Reality is arbitrary.':
		'Deze kunstmatige hersenen ter grootte van planeten kunnen koekjes creëren door over ze te dromen. Tijd en ruimte doen er niet toe. De realiteit is afhankelijk van willekeur. ',
	...
	"[Cortex baker business quote]There's only so many ways you can bring in more profit. Or is there? Hire the most brilliant experts in the known universe and let them scrape their brains for you!":
		'Op een gegeven moment heb je geen manieren meer om meer winst binnen te halen. Of toch wel? Huur de beste experts in het universum in en laat hun hersenen voor jou werken!',
	CpS: 'KpS',
	...
	'All cookie production <b>multiplied by %1</b>.':
		'Alle koekjesproductie <b>vermenigvuldigd met %1</b>.',
	'+%1 CpS': '+%1 KpS',
	...
	'Tiered upgrades for <b>%1</b> provide an extra <b>+%2%</b> production.<br>Only works with unshackled upgrade tiers.':
		'Upgrades met niveaus voor <b>%1</b> zorgen voor een extra productie van <b>+%2%</b>.Werkt alleen bij ontgrendelde upgradeniveaus.',
	'Unshackles all <b>%1-tier upgrades</b>, making them more powerful.<br>Only applies to unshackled buildings.':
		'Ontgrendelt alle upgrades voor het <b>%1-niveau, waardoor ze krachtiger worden.<br>Geldt alleen voor ontgrendelde gebouwen.',
	'The mouse and cursors are <b>twice</b> as efficient.':
		'De muis en de cursors zijn <b>twee</b> keer zo efficiënt.',
	'The mouse and cursors gain <b>+%1</b> cookies for each non-cursor building owned.':
		'De muis en cursors genereren <b>+%1</b> meer koekjes voor elk niet-cursorgebouw in je bezit.',
	'Grandmas gain <b>+%1% CpS</b> for each non-grandma building.':
		"Oma's genereren <b>+%1% KpS</b> voor elk niet-omagebouw.",
	'You gain <b>more CpS</b> the more milk you have.':
		'Hoe meer melk je hebt, hoe <b>meer KpS</b> je krijgt.',
	...
	'Cookie production multiplier <b>+%1% permanently</b>.':
		'Koekjesproductievermenigvuldiger <b>permanent +%1%</b>.',
	"Cookie production multiplier <b>+%1% per Santa's levels.</b>":
		'Koekjesproductievermenigvuldiger <b>+%1% per level van de kerstman.</b>',
	'Cookie production multiplier <b>+%1%</b> for every year Cookie Clicker has existed (currently: <b>+%2%</b>).':
		'Koekjesproductievermenigvuldiger <b>+%1%</b> voor elk jaar dat Cookie Clicker bestaat (nu is dat <b>+%2%</b>).',
	'Cookie production multiplier <b>+%1%</b> for every building type level %2 or higher.':
		'Koekjesproductievermenigvuldiger <b>+%1%</b> voor elk type gebouw met level %2 of hoger.',
	...
	'Grandma-operated science lab and leisure club.<br>Grandmas are <b>4 times</b> as efficient.<br><b>Regularly unlocks new upgrades</b>.':
		"Door oma's gerund wetenschapslaboratorium en hobbyclub.<br>Oma's zijn <b>4 keer</b> zo efficiënt.<br><b>Ontgrendelt regelmatig nieuwe upgrades</b>.",
	...
	'Note: the grandmothers are growing restless. Do not encourage them.':
		"Let op: de oma's worden onrustig. Moedig ze vooral niet aan.",
	'Note: proceeding any further in scientific research may have unexpected results. You have been warned.':
		'Let op: het voortzetten van wetenschappelijk onderzoek kan onverwachte resultaten opleveren. Je bent gewaarschuwd.',
	...
	"<b>Warning:</b> purchasing this will have unexpected, and potentially undesirable results!<br><small>It's all downhill from here. You have been warned!</small><br><br>Purchase anyway?":
		'<b>Waarschuwing:</b> als je dit koopt, gebeurt er iets onverwachts dat je waarschijnlijk niet wil!<br><small>Vanaf nu wordt het alleen maar erger. Je bent gewaarschuwd!</small><br><br>Toch kopen?',
	'Contains the wrath of the elders, at least for a while.':
		'Houdt de toorn van de ouderlingen een tijdje tegen. ',
	"Puts a permanent end to the elders' wrath, at the cost of %1% of your CpS.":
		'Stopt de toorn van de ouderlingen volledig. Dat kost je %1% van je KpS.',
	'You will get %1% of your CpS back, but the grandmatriarchs will return.':
		"Je krijgt %1% van je KpS terug, maar dan komen de opperoma's ook terug.",
	...
	'Golden cookies appear <b>twice as often</b> and stay <b>twice as long</b>.':
		'Gouden koekjes verschijnen <b>twee keer zo vaak</b> en blijven <b>twee keer zo lang</b>.',
	...
	'Golden cookies appear <b>%1%</b> more often during %2.':
		'Gouden koekjes verschijnen <b>%1%</b> vaker tijdens %2.',
	...
	'Golden cookie effects last <b>twice as long</b>.':
		'De effecten van een gouden koekje duren <b>twee keer zo lang</b>.',
	'Golden cookie effects last <b>%1%</b> longer.':
		'De effecten van een gouden koekje duren <b>%1%</b> langer.',
	...
	'<b>+%1% CpS</b> per golden cookie on-screen, multiplicative.':
		'<b>+%1% KpS</b> per gouden koekje op het scherm, vermenigvuldigend.',
	'With no buffs and no golden cookies on screen, selling your most powerful building has <b>%1% chance to summon one</b>.':
		"Als je geen extra's en geen gouden koekjes op het scherm hebt, heb je door je meest effectieve gebouw te verkopen <b>%1% kans om er één op te roepen</b>.",
	'Confers various powers to your minigames while active.<br>See the bottom of each minigame for more details.':
		'Geeft je minigames verschillende krachten als ze actief zijn.<br>Onderaan je minigames vind je meer informatie hierover.',
	'Elder pledges last <b>twice</b> as long.':
		'Beloften aan de ouderlingen duren <b>twee</b> keer zo lang.',
	'Can toggle upgrades on and off at will in the stats menu.':
		'Kan upgrades willekeurig aan- en uitzetten in het stats-menu.',
	'You keep producing cookies even while the game is closed.':
		'Ook als je het spel hebt afgesloten, gaat de koekjesproductie door.',
	'Unlocks <b>%1%</b> of the potential of your prestige level.':
		'Ontgrendelt <b>%1%</b> van het potentieel van je prestigelevel.',
	'Subsequent research will be <b>%1 times</b> as fast.':
		'Volgend onderzoek is <b>%1 keer</b> zo snel.',
	...
	'Wrinklers explode into <b>%1% more cookies</b>.':
		'Mee-eters ontploffen in <b>%1% meer koekjes</b>.',
	...
	'Buildings sell back for <b>%1%</b> instead of %2%.':
		'Gebouwen die je verkoopt, leveren <b>%1%</b> op in plaats van %2%.',
	...
	'All buildings and upgrades are <b>%1% cheaper</b>.':
		'Alle gebouwen en upgrades zijn <b>%1% goedkoper</b>.',
	'%1 are <b>%2%</b> more efficient and <b>%3%</b> cheaper.':
		'%1 zijn <b>%2%</b> efficiënter en <b>%3%</b> goedkoper.',
	...
	'Allows you to <b>trigger seasonal events</b> at will, for a price.':
		'Geeft je de mogelijkheid om tegen betaling willekeurig <b>evenementen te activeren</b>.',
	'Triggers <b>%1 season</b> for the next 24 hours.<br>Triggering another season will cancel this one.<br>Cost scales with unbuffed CpS and increases with every season switch.':
		'Activeert <b>%1 evenement</b> voor de komende 24 uur.<br>Het activeren van een ander evenement annuleert deze.<br>Hoe meer onversterkte KpS je hebt, hoe meer het kost en de kosten worden hoger als je van evenement wisselt.',
	...
	"You haven't switched seasons this ascension yet.":
		'Je hebt tijdens deze opstijging nog niet van evenement gewisseld.',
	"You've switched seasons <b>once</b> this ascension.":
		'Je hebt tijdens deze opstijging <b>één keer</b> van evenement gewisseld.',
	"You've switched seasons <b>%1 times</b> this ascension.":
		'Je hebt tijdens deze opstijging <b>%1 keer</b> van evenement gewisseld.',
	'Cookie production <b>multiplied by 1,000</b>.':
		'Koekjesproductie <b>vermenigvuldigd met 1.000</b>.',
	...
	"You continually gain <b>more CpS the longer you've played</b> in the current ascension.":
		'In deze opstijging verdien je voortdurend <b>meer KpS naarmate je langer speelt.',
	...
	'Placing an upgrade in this slot will make its effects <b>permanent</b> across all playthroughs.':
		'Als je een upgrade in dit vakje plaatst, zijn de effecten ervan <b>permanent</b> bij alle keren dat je het spel opnieuw begint.',
	...
	'Here are all the upgrades you\'ve purchased last playthrough.<div class="line"></div>Pick one to permanently gain its effects!<div class="line"></div>You can reassign this slot anytime you ascend.':
		'Dit zijn alle upgrades die je in het vorige spel hebt gekocht.<div class="line"></div>Kies er één waarvan je de effecten permanent wil maken!<div class="line"></div>Je kunt dit vak bij elke opstijging opnieuw toewijzen.',
	'You now <b>keep making cookies while the game is closed</b>, at the rate of <b>%1%</b> of your regular CpS and up to <b>1 hour</b> after the game is closed.<br>(Beyond 1 hour, this is reduced by a further %2% - your rate goes down to <b>%3%</b> of your CpS.)':
		'Je <b>blijft nu koekjes maken als het spel is afgesloten</b>, op een snelheid van <b>%1%</b> van je normale KpS en tot <b>1 uur</b> nadat het spel is afgesloten.<br>(Na 1 uur wordt dit verlaagd met nog eens %2%. Je snelheid wordt in totaal dus verlaagd tot <b>%3%</b> van je KpS.)',
	'You gain another <b>+%1%</b> of your regular CpS while the game is closed.':
		'Je krijgt nog <b>+%1%</b> van je normale KpS als het spel is afgesloten.',
	'You gain another <b>+%1%</b> of your regular CpS while the game is closed, for a total of <b>%2%</b>.':
		'Je krijgt nog <b>+%1%</b> van je normale KpS als het spel is afgesloten, en dat is dan in totaal <b>+%2%</b>.',
	'You start with <b>%1</b>.': 'Je begint met <b>+%1%</b> .',
	'Allows you to purchase a <b>crumbly egg</b> once you have earned 1 million cookies.':
		'Geeft je de mogelijkheid om een <b>kruimelei</b> te kopen als je 1 miljoen koekjes hebt verdiend.',
	...
	'You retain optimal cookie production while the game is closed for <b>%1 more days</b>.':
		'Je houdt een optimale koekjesproductie als het spel is afgesloten. Dat duurt nog <b>%1 dagen</b>.',
	'You retain optimal cookie production while the game is closed for twice as long, for a total of <b>%1</b>.':
		'Je houdt een optimale koekjesproductie als het spel is afgesloten, en dat twee keer zo lang. Totaal <b>%1</b>.',
	'Unlocks the <b>golden switch</b>, which passively boosts your CpS by %1% but disables golden cookies.':
		'Ontgrendelt de <b>gouden schakelaar</b>, die je KpS passief een boost geeft met %1%, maar gouden koekjes uitschakelt.',
	'Turning this on will give you a passive <b>+%1% CpS</b>, but prevents golden cookies from spawning.<br>Cost is equal to 1 hour of production.':
		'Als je dit aanzet, krijg je passief <b>+%1% KpS</b>, maar er verschijnen geen gouden koekjes meer.<br>De kosten hiervan zijn gelijk aan 1 uur productie.',
	'The switch is currently giving you a passive <b>+%1% CpS</b>; it also prevents golden cookies from spawning.<br>Turning it off will revert those effects.<br>Cost is equal to 1 hour of production.':
		'De schakelaar geeft je nu passief <b>+%1% KpS</b>, maar er verschijnen geen gouden koekjes meer.<br>Deze effecten worden ongedaan gemaakt als je hem weer uitzet.<br>De kosten hiervan zijn gelijk aan 1 uur productie.',
	'Unlocks the <b>milk selector</b>, letting you pick which milk is displayed under your cookie.<br>Comes with a variety of basic flavors.':
		'Ontgrendelt de <b>melkkiezer</b>, waarmee je kunt kiezen welke melk wordt weergegeven onder je koekje.<br>Er zijn verschillende basissmaken beschikbaar.',
	'Contains more exotic flavors for your milk selector.':
		'Bevat meer exotische smaken voor je melkkiezer.',
	'Lets you pick what flavor of milk to display.':
		'Hiermee kun je kiezen welke melksmaak je wilt weergeven.',
	'Unlocks the <b>golden cookie sound selector</b>, which lets you pick whether golden cookies emit a sound when appearing or not.':
		'Ontgrendelt de <b>kiezer voor het geluid van het gouden koekje</b>, waarmee je kunt kiezen of gouden koekjes wel of geen geluid laten horen als ze verschijnen.',
	'Lets you change the sound golden cookies make when they spawn.':
		'Hiermee kun je het geluid veranderen dat gouden koekjes maken als ze verschijnen.',
	...
	'Unlocks the <b>jukebox</b>, which allows you to play through every sound file in the game.':
		'Ontgrendelt de <b>jukebox</b>, waarmee je elk geluidsbestand in het spel kunt afspelen.',
	...
	"Unlocks the <b>background selector</b>, letting you select the game's background.<br>Comes with a variety of basic flavors.":
		'Ontgrendelt de <b>achtergrondkiezer</b>, waarmee je een achtergrond kunt kiezen.<br>Er zijn verschillende basissmaken beschikbaar.',
	...
	'This is the first heavenly upgrade; it unlocks the <b>Heavenly chips</b> system.<div class="line"></div>Each time you ascend, the cookies you made in your past life are turned into <b>heavenly chips</b> and <b>prestige</b>.<div class="line"></div><b>Heavenly chips</b> can be spent on a variety of permanent transcendental upgrades.<div class="line"></div>Your <b>prestige level</b> also gives you a permanent <b>+1% CpS</b> per level.':
		'Dit is je eerste hemelse upgrade, het ontgrendelt het systeem van <b>hemelse stukjes</b>.<div class="line"></div>Elke keer dat je opstijgt, worden de koekjes die je in je vorige leven hebt gemaakt, omgezet in <b>hemelse stukjes</b> en <b>prestige</b>.<div class="line"></div>Je kunt <b>Hemelse stukjes</b> uitgeven aan verschillende permanente transcendentale upgrades.<div class="line"></div>Voor elk <b>prestigelevel</b> krijg je ook een permanente <b>+1% KpS</b>.',
	...
	'While the golden switch is on, you gain an additional <b>+%1% CpS</b> per golden cookie upgrade owned.':
		'Als de gouden schakelaar aanstaat, krijg je <b>+%1% extra KpS</b> voor elke gouden koekje-upgrade in je bezit.',
	...
	'Unlocks a new tier of upgrades that affect <b>2 buildings at the same time</b>.<br>Synergies appear once you have <b>%1</b> of both buildings.':
		'Ontgrendelt een nieuw niveau van upgrades die effect hebben op <b>2 gebouwen tegelijk</b>.<br>Synergieën verschijnen als je er van elk gebouw <b>%1</b> hebt.',
	'Golden cookies (and all other things that spawn, such as reindeer) have <b>%1% chance of being doubled</b>.':
		'Er is <b>%1% kans op verdubbeling</b> van gouden koekjes (en al het andere wat verschijnt, zoals rendieren).',
	'Cookie production <b>reduced to 0</b>.': 'Koekjesproductie <b>teruggebracht naar 0</b>.',
	'Sugar lumps coalesce <b>a whole lot faster</b>.':
		'Suikerklontjes verzamelen zich <b>een heel stuk sneller</b>.',
	...
	'<b>+%1%</b> prestige level effect on CpS.<br><b>+%2%</b> golden cookie effect duration.<br><b>+%3%</b> golden cookie lifespan.':
		'<b>+%1%</b> effect van prestigelevel op KpS.<br><b>+%2%</b> duur van effect gouden koekje.<br><b>+%3%</b> levensduur van gouden koekje.',
	'Each unspent sugar lump (up to %1) gives <b>+%2% CpS</b>.<div class="warning">Note: this means that spending sugar lumps will decrease your CpS until they grow back.</div>':
		'Elk suikerklontje dat je niet hebt uitgegeven (tot 1%) zorgt voor <b>+%2% KpS</b>.<div class="warning">Let op: dat betekent dat als je suikerklontjes uitgeeft, je KpS wordt verlaagd tot ze teruggroeien.</div>',
	'Once an ascension, you may use the "Sugar frenzy" switch to <b>triple your CpS</b> for 1 hour, at the cost of <b>1 sugar lump</b>.':
		'Bij een opstijging kun je de schakelaar "Suikerfrenzy" gebruiken om je <b>KpS</b> 1 uur lang te verdriedubbelen. Dat kost <b>1 suikerklontje</b>.',
	'Each grandma (up to %1) makes sugar lumps ripen <b>%2</b> sooner.':
		'Elke oma (tot %1) zorgt dat je suikerklontjes <b>%2</b> sneller rijpen. ',
	'Activating this will <b>triple your CpS</b> for 1 hour, at the cost of <b>1 sugar lump</b>.':
		'Als je dit activeert, wordt je <b>KpS</b> 1 uur lang verdriedubbeld. Dat kost <b>1 suikerklontje</b>.',
	...
	'Garden plants grow every second.<br>Garden seeds are free to plant.<br>You can switch soils at any time.':
		'Tuinplantjes groeien elke seconde.<br>Je kunt tuinzaadjes gratis planten.<br>Je kunt op elk moment van grond wisselen.',
	...
	'Sugar lumps are <b>twice as likely</b> to be unusual.':
		'Suikerklontjes hebben <b>twee keer zoveel kans</b> om bijzonder te zijn.',
	...
	'Bifurcated sugar lumps appear <b>%1% more often</b> and are <b>%2% more likely</b> to drop 2 lumps.':
		'Suikerklontjes met een bijzondere vorm verschijnen <b>%1% vaker</b> en het is <b>%2% waarschijnlijker</b> dat ze 2 klontjes geven.',
	'Mouse over a wrinkler to see how many cookies are in its stomach.':
		'Beweeg met je muis over een mee-eter om te zien hoeveel koekjes er in zijn maag zitten.',
	'Unlocks the <b>Buy all</b> feature, which lets you instantly purchase every upgrade in your store (starting from the cheapest one).<br>Also unlocks the <b>Vault</b>, a store section where you can place upgrades you do not wish to auto-buy.':
		'Ontgrendelt de functie <b>Alles kopen</b>, waarmee je direct alle upgrades in je winkel kunt kopen (begint bij de goedkoopste).<br>Ontgrendelt ook de <b>Kluis</b>, een gedeelte van je winkel waar je upgrades in kunt zetten die je niet automatisch wilt kopen.',
	'Mouse over an upgrade to see its tier.<br><small>Note: only some upgrades have tiers. Tiers are purely cosmetic and have no effect on gameplay.</small>':
		'Beweeg met je muis over een upgrade om zijn niveau te zien.<br><small>Let op: niet alle upgrades hebben niveaus. Niveaus zijn alleen cosmetisch en hebben geen effect op het spel.</small>',
	'You now benefit from the boost provided by <b>heralds</b>.<br>Each herald gives you <b>+1% CpS</b>.<br>Look on the purple flag at the top to see how many heralds are active at any given time.':
		'Je profiteert nu van de boost die je hebt gekregen van <b>herauten</b>.<br>Elke heraut geeft je <b>+1% KpS</b>.<br>Beweeg je muis over de paarse vlag aan de bovenkant om te zien hoeveel herauten er actief zijn.',
	'Seasonal random drops have a <b>1/5 chance</b> to carry over through ascensions.':
		"Er is <b>een kans van 1/5</b> dat extra's van evenementen na een opstijging nog aanwezig zijn. ",
	"Unlocks <b>extra price information</b>.<br>Each displayed cost now specifies how long it'll take you to afford it, and how much of your bank it represents.":
		'Ontgrendelt <b>extra informatie over prijzen</b>.<br>Bij elke weergegeven prijs staat nu hoe lang het duurt voor je het hebt en hoeveel percentage van dit bedrag je op voorraad hebt.',
	'Unlocks the <b>shimmering veil</b>, a switch that passively boosts your CpS by <b>%1%</b>.<br>You start with the veil turned on; however, it is very fragile, and clicking the big cookie or any golden cookie or reindeer will turn it off, requiring %2 of CpS to turn back on.':
		'Ontgrendelt de <b>glanzende sluier</b>, een schakelaar die je KpS passief een boost geeft van <b>%1%</b>.<br>De sluier staat eerst aan, maar hij is erg breekbaar. Als je op het grote koekje, een gouden koekje of een rendier klikt, gaat hij uit. Het kost %2 KpS om hem weer aan te zetten.',
	'Boosts your cookie production by <b>%1%</b> when active.<br>The veil is very fragile and will break if you click the big cookie or any golden cookies or reindeer.<br><br>Once broken, turning the veil back on costs %2 of unbuffed CpS.':
		'Geeft je koekjesproductie een boost van <b>%1%</b> als hij actief is.<br>De sluier is erg breekbaar en breekt als je op het grote koekje, een gouden koekje of een rendier klikt.<br><br>Als hij gebroken is, kost het je %2 onversterkte KpS.',
	...
	'The <b>shimmering veil</b> is more resistant, and has a <b>%1% chance</b> not to break. It also gives <b>+%2%</b> more CpS.':
		'De <b>glanzende sluier</b> kan iets meer hebben en heeft een <b>kans van %1%</b> om niet te breken. Hij zorgt ook voor <b>+%2%</b> meer KpS.',
	'Active.': 'Actief.',
	'The reinforced membrane protects the shimmering veil.':
		'Het verstevigde membraan beschermt de glanzende sluier.',
	...
	'Prior to purchasing the <b>%1</b> upgrade in a run, random drops are <b>%2 times more common</b>.':
		"Voordat je de upgrade <b>%1</b> koopt, komen willekeurige extra's <b>%2 keer vaker voor</b>.",
	...
	'You think you have it bad? Look at me.':
		'Denk jij dat jij het slecht hebt? Kijk dan eens naar mij.',
	'The news ticker may occasionally have <b>fortunes</b>, which may be clicked for something good.':
		'In de lichtkrant komen soms <b>gelukjes</b> voorbij, waar je op kunt klikken om iets moois te krijgen.',
	'Through clever accounting, this actually makes kitten upgrades <b>%1% cheaper</b>.':
		'Door slim boekhouden maakt deze upgrade kattenupgrades <b>%1% goedkoper</b>.',
	'Unlocks the ability to <b>pet your dragon</b> by clicking on it once hatched.':
		'Ontgrendelt de mogelijkheid om <b>je draak te aaien</b> door erop te klikken als hij uitgekomen is.',
	'Cost scales with CpS, but %1 times cheaper with a fully-trained dragon.':
		'Hoe meer KpS je hebt, hoe meer het kost, maar het is %1 keer zo goedkoop als je een volledig getrainde draak hebt.',
	'Golden cookies may trigger a <b>Dragon Harvest</b>.':
		'Gouden koekjes kunnen een <b>Drakenoogst activeren</b>.',
	'Golden cookies may trigger a <b>Dragonflight</b>.':
		'Gouden koekjes kunnen een <b>Drakenvlucht activeren</b>.',
	'Dragon harvest and Dragonflight are <b>%1% stronger</b>.':
		'Drakenoogst en Drakenvlucht zijn <b>%1% krachtiger</b>.',
	'Kittens are <b>%1%</b> more effective.': 'Katjes zijn <b>%1%</b> effectiever.',
	'Each kitten upgrade boosts %1 CpS by <b>%2%</b>.':
		'Elke kattenupgrade versterkt de KpS van %1 met <b>%2%</b>.',
	'Each rank of milk boosts %1 CpS by <b>%2%</b>.':
		'Elk melkniveau versterkt de KpS van %1 met <b>%2%</b>.',
	'Cursor levels boost clicks by <b>%1%</b> each (up to cursor level %2).':
		'Cursorlevels versterkten kliks met elk <b>%1%</b> (tot cursorlevel %2).',
	'<b>%1</b> are now effective up to cursor level %2.':
		'<b>%1</b> zijn nu effectief tot cursorlevel %2.',
	...
	'Golden and wrath cookies appear %1% less.':
		'Gouden en woedende koekjes verschijnen %1% minder vaak.',
	'Buildings grant -%1% CpS.': 'Gebouwen leveren -%1% KpS op.',
	'Selling buildings triggers a buff boosted by how many buildings were sold.':
		'Het verkopen van gebouwen activeert een versterking die geboost wordt door hoeveel gebouwen er verkocht werden.',
	'Buff boosts clicks by +%1% for every building sold for %2 seconds.':
		'De versterking boost kliks met +%1% voor elk gebouw dat in %2 seconden verkocht werd.',
	'CpS bonus fluctuating between %1 and %2 over time.':
		'KpS-bonus fluctueert in de loop der tijd tussen %1 en %2.',
	...
	'All golden cookies are wrath cookies with a greater chance of a negative effect.':
		'Alle gouden koekjes zijn woedende koekjes met een grotere kans op een negatief effect.',
	'Wrinklers appear %1% faster and digest %2% more cookies.':
		'Mee-eters verschijnen %1% sneller en consumeren %2% meer koekjes.',
	'Effect is only active when your total amount of buildings ends with 0.':
		'Het effect is alleen actief als je totale aantal gebouwen op 0 eindigt.',
	...
	'Make <b>%1</b> by only having clicked <b>%2 times</b>.':
		'Maak <b>%1</b> door maar <b>%2 keer</b> te klikken.',
	'Make <b>%1</b> with <b>no</b> cookie clicks.':
		'Maak <b>%1</b> <b>zonder</b> te klikken op het grote koekje. ',
	'Get to <b>%1</b> baked with <b>no upgrades purchased</b>.':
		'Bak <b>%1</b> <b>zonder upgrades te kopen</b>.',
	...
	'Have at least <b>1 of the most expensive object, 2 of the second-most expensive, 4 of the next</b> and so on (capped at %1).':
		'Bezit ten minste <b>1 van het duurste object, 2 van het op één na duurste, 4 van het volgende</b>, enzovoorts (maximaal %1).',
	'Have at least <b>10 of the most expensive object, 20 of the second-most expensive, 30 of the next</b> and so on.':
		'Bezit ten minste <b>10 van het duurste object, 20 van het op één na duurste, 30 van het volgende</b>, enzovoorts.',
	...
	'Appease the grandmatriarchs at least <b>once</b>.':
		"Kalmeer de opperoma's ten minste <b>één keer</b>.",
	'Appease the grandmatriarchs at least <b>%1 times</b>.':
		"Kalmeer de opperoma's ten minste <b>%1 keer</b>.",
	...
	'Unlock <b>100%</b> of your heavenly chips power.':
		'Ontgrendel <b>100%</b> van de kracht van je hemelse stukjes.',
	'You have <b>1 chance in %1</b> every second of earning this achievement.':
		'Je hebt elke seconde een kans van <b>1 op de %1</b> om deze prestatie te verdienen.',
	...
	'Unlock <b>every Halloween-themed cookie</b>.<div class="line"></div>Owning this achievement makes Halloween-themed cookies drop more frequently in future playthroughs.':
		'Ontgrendel <b>elk Halloweenkoekje</b>.<div class="line"></div>Als je deze prestatie hebt, krijg je vaker Halloweenkoekjes in volgende spellen.',
	...
	'Unlock <b>every Christmas-themed cookie</b>.<div class="line"></div>Owning this achievement makes Christmas-themed cookies drop more frequently in future playthroughs.':
		'Ontgrendel <b>elk kerstkoekje</b>.<div class="line"></div>Als je deze prestatie hebt, krijg je vaker kerstkoekjes in volgende spellen.',
	...
	'Pop a reindeer <b>during an elder frenzy</b>.':
		'Klik op een rendier <b>tijdens een ouderlingenfrenzy</b>.',
	...
	'This is for baking %1 and making it on the local news.':
		'Deze krijg je omdat je %1 hebt gebakken en op het lokale nieuws bent gekomen.',
	'Name yourself <b>Orteil</b>.<div class="warning">Note: usurpers incur a -%1% CpS penalty until they rename themselves something else.</div>':
		'Geef jezelf de naam <b>Orteil</b>.<div class="warning">Let op: overweldigers krijgen een straf van -%1% KpS tot ze zichzelf een andere naam geven.</div>',
	...
	'Unlock <b>all the eggs</b>.<div class="line"></div>Owning this achievement makes eggs drop more frequently in future playthroughs.':
		'Ontgrendel <b>alle eieren</b>.<div class="line"></div>Als je deze prestatie hebt, krijg je vaker eieren in volgende spellen.',
	...
	'Own <b>%1</b> upgrades and <b>%2</b> buildings.':
		'Bezit <b>%1</b> upgrades en <b>%2</b> gebouwen.',
	'Own <b>%1</b> heavenly upgrades.': 'Bezit <b>%1</b>hemelse upgrades.',
	'Burst the near-extinct <b>shiny wrinkler</b>.':
		'Laat de bijna uitgestorven <b>glimmende mee-eter</b> ontploffen.',
	'Click a golden cookie <b>less than 1 second after it spawns</b>.':
		'Klik <b>in minder dan 1 seconde nadat hij verschijnt</b> op een gouden koekje. ',
	'Click a golden cookie <b>less than 1 second before it dies</b>.':
		'Klik <b>in minder dan 1 seconde voordat hij weg is</b> op een gouden koekje. ',
	...
	"Successfully harvest a coalescing sugar lump before it's ripe.":
		'Oogst een suikerklontje met succes voordat hij rijp is.',
	'Harvest a <b>bifurcated sugar lump</b>.':
		'Oogst een <b>suikerklontje met een bijzondere vorm</b>.',
	...
	'Have <b>%1</b> golden cookies simultaneously.':
		'Heb op hetzelfde moment <b>%1</b> gouden koekjes.',
	'Manage a cookie legacy for <b>at least a year</b>.':
		'Zorg dat je al <b>minstens een jaar</b> een koekjeserfenis hebt.',
	...
	'Fill every tile of the biggest garden plot with plants.':
		'Zet elke tegel op het grootste stukje grond van je tuin vol met planten.',
	...
	'Convert a complete seed log into sugar lumps by sacrificing your garden to the sugar hornets.<div class="line"></div>Owning this achievement makes seeds <b>%1% cheaper</b>, plants mature <b>%2% sooner</b>, and plant upgrades drop <b>%3% more</b>.':
		'Zet een compleet zaadjeslog om in suikerklontjes door je tuin op te offeren aan de suikerhoornaars.<div class="line"></div>Als je deze prestatie hebt, worden zaadjes <b>%1% goedkoper</b>, zijn planten <b>%2% sneller</b> volgroeid en krijg je <b>%3% vaker</b> plantupgrades.',
	'Ascend with exactly <b>%1</b>.': 'Stijg op met precies <b>%1</b>.',
	'Have your <b>reinforced membrane</b> protect the <b>shimmering veil</b>.':
		'Laat je <b>verstevigde membraan</b> je <b>glanzende sluier beschermen</b>. ',
	'Own every <b>fortune upgrade</b>.<div class="line"></div>Owning this achievement makes fortunes appear <b>twice as often</b>; unlocked fortune upgrades also have a <b>%1% chance</b> to carry over after ascending.':
		'Bezit elke <b>geluksupgrade</b>.<div class="line"></div>Als je deze prestatie hebt, verschijnen gelukjes <b>twee keer zo vaak</b>. En ontgrendelde upgrades hebben een <b>kans van %1%</b> om na een opstijging nog te bestaan.',
	'Make your first stock market profit.': 'Maak je eerste winst op de aandelenmarkt.',
	'Own at least <b>%1</b> of a stock market good.':
		'Bezit ten minste <b>%1</b> van een product op de aandelenmarkt.',
	'Own at least <b>%1</b> of every stock market good.':
		'Bezit ten minste <b>%1</b> van elk product op de aandelenmarkt.',
	'Make <b>a day</b> of CpS ($%1) in 1 stock market sale.':
		'Verdien <b>een dag</b> aan KpS ($ %1) in 1 aandelenverkoop.',
	'Spend <b>a day</b> of CpS ($%1) in 1 stock market purchase.':
		'Besteed <b>een dag</b> aan KpS ($ %1) in 1 aandelenverkoop.',
	'Have your stock market profits surpass <b>a whole year</b> of CpS ($%1).':
		'Zorg dat je winst op de aandelenmarkt meer is dan <b>een heel jaar</b> aan KpS ($ %1).',
	'Unlock the <b>highest-tier</b> stock market headquarters.':
		'Ontgrendel het <b>hoogste niveau</b> van het hoofdkantoor van de aandelenmarkt.',
	'Have your stock market profits surpass <b>$%1</b>.':
		'Zorg dat je winst op de aandelenmarkt meer is dan <b>$%1</b>.',
	...
	"Click one of Santa's helper grandmas during Christmas season.":
		"Klik tijdens het kerstseizoen op een van de oma's die de Kerstman helpen.",
	Frenzy: '/',
	...
	'Cookie production halted for %1,<br>but each click is worth %2 of CpS.':
		'Koekjesproductie %1 lang stopgezet,<br>maar elke klik is %2 van de KpS waard.',
	...
	'You find %1% more golden cookies for the next %2.':
		'Je vindt de komende %2 %1% meer gouden koekjes.',
	...
	"[Baker's wheat quote]A plentiful crop whose hardy grain is used to make flour for pastries.":
		'Een rijkelijk groeiend gewas waarvan het stevige graan wordt verwerkt tot meel om mee te bakken.',
	...
	'[Thumbcorn quote]A strangely-shaped variant of corn. The amount of strands that can sprout from one seed is usually in the single digits.':
		'Een maïskorrel met een bijzondere vorm. Het aantal uitlopers dat één korrel krijgt, is vaak op één hand te tellen.',
	...
	"[Cronerice quote]Not only does this wrinkly bulb look nothing like rice, it's not even related to it either; its closest extant relative is the weeping willow.":
		'Dit verschrompelde zaadje lijkt niet op rijst en is er ook niet eens aan verwant. Hij is wel familie van de treurwilg.',
	...
	'[Gildmillet quote]An ancient staple crop, famed for its golden sheen. Was once used to bake birthday cakes for kings and queens of old.':
		'Een oud gewas dat heel populair werd vanwege zijn gouden glans. Werd vroeger veel gebruikt om verjaardagstaarten te bakken voor koningen en koninginnen.',
	...
	'[Ordinary clover quote]<i>Trifolium repens</i>, a fairly mundane variety of clover with a tendency to produce four leaves. Such instances are considered lucky by some.':
		'<i>Trifolium repens</i> is een zeer gewone klaversoort die geregeld vier blaadjes heeft. Sommigen denken dat dat geluk brengt.',
	...
	'[Golden clover quote]A variant of the ordinary clover that traded its chlorophyll for pure organic gold. Tragically short-lived, this herb is an evolutionary dead-end - but at least it looks pretty.':
		'Een variant van de gewone klaver die geen bladgroen heeft, maar puur, biologisch goud. Deze plant leeft helaas niet lang en zal het in de evolutie dan ook niet ver schoppen. Maar hij ziet er wel prachtig uit.',
	...
	'[Shimmerlily quote]These little flowers are easiest to find at dawn, as the sunlight refracting in dew drops draws attention to their pure-white petals.':
		'Deze bloemetjes zijn het makkelijkst te vinden in de vroege ochtend, als het zonlicht weerkaatst in de dauwdruppels en zo de helderwitte blaadjes laat schitteren.',
	...
	'[Elderwort quote]A very old, long-forgotten subspecies of edelweiss that emits a strange, heady scent. There is some anecdotal evidence that these do not undergo molecular aging.':
		'Een eeuwenoude vergeten ondersoort van de edelweiss die een vreemde, sterke geur afgeeft. Er is anekdotisch bewijs dat deze plant niet veroudert.',
	Bakeberry: 'Bakbes',
	'[Bakeberry quote]A favorite among cooks, this large berry has a crunchy brown exterior and a creamy red center. Excellent in pies or chicken stews.':
		'Deze grote bes is zeer populair bij koks. Hij heeft een knapperige, bruine buitenkant en een romige, rode binnenkant. Heerlijk in pastei en stoofgerechten met kip.',
	...
	'[Chocoroot quote]A tangly bramble coated in a sticky, sweet substance. Unknown genetic ancestry. Children often pick these from fields as-is as a snack.':
		'Een braam die bedekt is met een zoete, kleverige substantie. Genetische herkomst is onbekend. Kinderen plukken deze vruchten vaak om ze meteen op te eten.',
	...
	'[White chocoroot quote]A pale, even sweeter variant of the chocoroot. Often impedes travelers with its twisty branches.':
		'Een witte, nog zoetere variant van de chocobraam. Het komt vaak voor dat wandelaars vast komen te zitten in de takken van de struik.',
	...
	'[White mildew quote]A common rot that infests shady plots of earth. Grows in little creamy capsules. Smells sweet, but sadly wilts quickly.':
		'Een veel voorkomende schimmel die graag op schaduwrijke plekken groeit en de vorm van een kleine, romige capsule heeft. Ruikt heerlijk zoet, maar verwelkt helaas heel snel.',
	...
	'[Brown mold quote]A common rot that infests shady plots of earth. Grows in odd reddish clumps. Smells bitter, but thankfully wilts quickly.':
		'Een veel voorkomende schimmel die graag op schaduwrijke plekken groeit en de vorm van een vreemde, rode klont heeft. Geeft een nare, scherpe geur af, maar verwelkt gelukkig heel snel.',
	...
	'[Meddleweed quote]The sign of a neglected farmland, this annoying weed spawns from unused dirt and may sometimes spread to other plants, killing them in the process.':
		'Dit vervelende onkruid groeit op grond die niet wordt gebruikt, en is een duidelijk teken dat je dat stukje grond hebt verwaarloosd. Soms groeit het ook bij andere planten, waardoor die doodgaan.',
	...
	"[Whiskerbloom quote]Squeezing the translucent pods makes them excrete a milky liquid, while producing a faint squeak akin to a cat's meow.":
		'Als je in de doorzichtige peulen knijpt, komt er een melkachtige substantie uit en maakt de plant een geluidje dat lijkt op het miauwen van een kat.',
	Chimerose: 'Goudroos',
	'[Chimerose quote]Originating in the greener flanks of polar mountains, this beautiful flower with golden accents is fragrant enough to make any room feel a little bit more festive.':
		'Deze prachtige bloem met gouden accenten groeit op de groene flanken van het poolgebergte. Hij ruikt heerlijk en fleurt elk huis op. Is vooral populair rond de feestdagen.',
	Nursetulip: 'Zorgtulp',
	'[Nursetulip quote]This flower grows an intricate root network that distributes nutrients throughout the surrounding soil. The reason for this seemingly altruistic behavior is still unknown.':
		'Deze bloem heeft een ingewikkeld wortelnetwerk waarmee hij voedingsstoffen om zich heen verspreidt voor andere planten. Waarom deze plant dit onbaatzuchtige gedrag vertoont, is nog onbekend.',
	Drowsyfern: 'Droomvaren',
	'[Drowsyfern quote]Traditionally used to brew a tea that guarantees a good night of sleep.':
		'Oorspronkelijk gebruikt voor het zetten van thee die een goede nachtrust bevordert.',
	...
	'[Wardlichen quote]The metallic stench that emanates from this organism has been known to keep insects and slugs away.':
		'Deze plant geeft een metalige stank af die insecten en slakken op afstand houdt.',
	Keenmoss: 'IJvermos',
	'[Keenmoss quote]Fuzzy to the touch and of a vibrant green. In plant symbolism, keenmoss is associated with good luck for finding lost objects.':
		'Voelt zacht aan en heeft een felgroene kleur. In de plantsymboliek wordt de plant beschouwd als geluksbrenger bij het zoeken naar verloren voorwerpen.',
	...
	'[Queenbeet quote]A delicious taproot used to prepare high-grade white sugar. Entire countries once went to war over these.':
		'Een heerlijke penwortel die wordt gebruikt voor witte suiker van hoge kwaliteit. Ze zijn zo gewild dat er ooit oorlog is gevoerd om ze in handen te krijgen.',
	...
	'[Juicy queenbeet quote]A delicious taproot used to prepare high-grade white sugar. Entire countries once went to war over these.<br>It looks like this one has grown especially sweeter and juicier from growing in close proximity to other queenbeets.':
		'Een heerlijke penwortel die wordt gebruikt voor witte suiker van hoge kwaliteit. Ze zijn zo gewild dat er ooit oorlog is gevoerd om ze in handen te krijgen.<br>Deze is nóg zoeter en sappiger geworden omdat hij in de buurt van andere koninginnebieten groeide.',
	...
	'[Duketater quote]A rare, rich-tasting tuber fit for a whole meal, as long as its strict harvesting schedule is respected. Its starch has fascinating baking properties.':
		'Een zeldzaam knolgewas met een sterke smaak die goed is voor een volledige maaltijd, maar dan moet je wel het strenge oogstschema aanhouden. Dankzij het zetmeel is hij ook geschikt om te bakken.',
	...
	'[Crumbspore quote]An archaic mold that spreads its spores to the surrounding dirt through simple pod explosion.':
		'Een eeuwenoude schimmelsoort die zijn sporen om zich heen verspreidt door zijn peulen te laten ontploffen.',
	...
	'[Doughshroom quote]Jammed full of warm spores; some forest walkers often describe the smell as similar to passing by a bakery.':
		'Deze paddenstoel zit vol met warme sporen. Wandelaars beschrijven de geur vaak als de geur die je ruikt als je een bakkerij binnenkomt.',
	...
	'[Glovemorel quote]Touching its waxy skin reveals that the interior is hollow and uncomfortably squishy.':
		'Als je de wasachtige buitenkant aanraakt, merk je dat de binnenkant hol en zompig is. ',
	Cheapcap: 'Armoezwam',
	'[Cheapcap quote]Small, tough, and good in omelettes. Some historians propose that the heads of dried cheapcaps were once used as currency in some bronze age societies.':
		'Klein, stevig en heerlijk in een omelet. Geschiedkundigen beweren dat de armoezwam in het bronzen tijdperk soms als betaalmiddel werd gebruikt.',
	...
	"[Fool's bolete quote]Named for its ability to fool mushroom pickers. The fool's bolete is not actually poisonous, it's just extremely bland.":
		'Staat erom bekend dat hij paddenstoelenplukkers voor de gek houdt. De dwazenboleet is niet giftig, maar hij smaakt ook niet zo lekker.',
	...
	"[Wrinklegill quote]This mushroom's odor resembles that of a well-done steak, and is said to whet the appetite - making one's stomach start gurgling within seconds.":
		'De geur van deze champignon doet denken aan een goed doorbakken biefstukje en schijnt de eetlust dan ook op te wekken. Na een paar seconden begint je maag al te knorren.',
	...
	'[Green rot quote]This short-lived mold is also known as "emerald pebbles", and is considered by some as a pseudo-gem that symbolizes good fortune.':
		'Deze kortlevende schimmel wordt ook wel "smaragdkiezelsteen" genoemd, en wordt door sommigen als een nepedelsteen beschouwd die geluk brengt.',
	...
	'[Shriekbulb quote]A nasty vegetable with a dreadful quirk : its flesh resonates with a high-pitched howl whenever it is hit at the right angle by sunlight, moonlight, or even a slight breeze.':
		'Een nare groente met een verschrikkelijke eigenschap: het vruchtvlees laat een hoog gehuil horen als hij in de juiste hoek wordt geraakt door zonlicht, maanlicht en soms zelfs een licht briesje.',
	Tidygrass: 'Rooigras',
	'[Tidygrass quote]The molecules this grass emits are a natural weedkiller. Its stems grow following a predictable pattern, making it an interesting -if expensive- choice for a lawn grass.':
		'De moleculen die dit gras afgeeft, roeien onkruid van nature uit. De stengels groeien in een voorspelbaar patroon en daarom is het mooi gras voor in je tuin. Maar daar moet je wel je portemonnee voor trekken.',
	...
	'[Everdaisy quote]While promoted by some as a superfood owing to its association with longevity and intriguing geometry, this elusive flower is actually mildly toxic.':
		'Dit tere bloemetje wordt door sommigen aangemerkt als superfood omdat hij in verband is gebracht met een lang leven en een interessante vorm heeft, maar niets is minder waar. Hij is zelfs een beetje giftig.',
	...
	'[Ichorpuff quote]This puffball mushroom contains sugary spores, but it never seems to mature to bursting on its own. Surrounding plants under its influence have a very slow metabolism, reducing their effects but lengthening their lifespan.':
		'Deze stuifzwam bevat suikersporen, maar raakt nooit uit zichzelf volgroeid. Planten om hem heen raken onder zijn invloed en vertragen hun metabolisme sterk, waardoor ze minder effect hebben maar wel langer leven.',
	...
	"-You can cross-breed plants by planting them close to each other; new plants will grow in the empty tiles next to them.<br>-Unlock new seeds by harvesting mature plants.<br>-When you ascend, your garden plants are reset, but you keep all the seeds you've unlocked.<br>-Your garden has no effect and does not grow while the game is closed.":
		'-Je kunt planten kruisen door ze dicht bij elkaar te planten; nieuwe planten groeien in de lege tegels ernaast.<br>-Ontgrendel nieuwe zaden door volwassen planten te oogsten.<br>-Als je opstijgt worden je planten gereset, maar behoud je alle zaden die je hebt ontgrendeld.<br>-Terwijl het spel gesloten is heeft je tuin geen effect en groeit hij niet.',
	...
	'%1 to harvest only mature, mortal plants.':
		'%1 om uitsluitend volwassen, sterfelijke planten te oogsten.',
	'%1 to harvest all mature plants of this type.':
		'%1 om alle volwassen planten van dit type te oogsten.',
	Freeze: 'Vriezen',
	'Cryogenically preserve your garden.<br>Plants no longer grow, spread or die; they provide no benefits.<br>Soil cannot be changed.<div class="line"></div>Using this will effectively pause your garden.':
		'Houd je tuin intact door hem te bevriezen.<br>Planten groeien, verspreiden en sterven niet meer; ze leveren geen voordeel op.<br>De grond kan niet gewijzigd worden.<div class="line"></div>Door dit te gebruiken wordt de tuin in feite gepauzeerd.',
	...
	'A swarm of sugar hornets comes down on your garden, <span class="red">destroying every plant as well as every seed you\'ve unlocked</span> - leaving only a %1 seed.<br>In exchange, they will grant you <span class="green">%2</span>.<br>This action is only available with a complete seed log.':
		'Een zwerm suikerhoornaars daalt neer op jouw tuin <span class="red">en vernietigt elke plant en elk zaadje dat je hebt ontgrendeld</span>, waardoor alleen een %1-zaadje overblijft.<br>In ruil leveren ze je <span class="green">%2</span> op.<br>Deze actie is alleen beschikbaar met een volledig zaadjeslog.',
	'Do you REALLY want to sacrifice your garden to the sugar hornets?<br><small>You will be left with an empty plot and only the %1 seed unlocked.<br>In return, you will gain <b>%2 sugar lumps</b>.</small>':
		'Wil je ECHT je tuin aan suikerhoornaars opofferen?<br><small>Je houdt een leeg stuk grond over en alleen het %1-zaad dat je had ontgrendeld.<br>In ruil krijg je <b>%2 suikerklontjes</b>.</small>',
	'Sacrifice!': 'Opofferen!',
	"You've sacrificed your garden to the sugar hornets, destroying your crops and your knowledge of seeds.<br>In the remains, you find <b>%1 sugar lumps</b>.":
		'Je hebt je tuin aan de suikerhoornaars opgeofferd, en zo je gewassen en kennis over zaden vernietigd.<br>In de overblijfselen vind je <b>%1 suikerklontjes</b>.',
	...
	'surrounding plants (%1x%1) age %2% slower':
		'omringende planten (%1x%1) verouderen %2% langzamer',
	'surrounding plants (%1x%1) are %2% more efficient':
		'omringende planten (%1x%1) zijn %2% efficiënter',
	'surrounding plants (%1x%1) are %2% less efficient':
		'omringende planten (%1x%1) zijn %2% minder efficiënt',
	'surrounding tiles (%1x%1) develop no weeds or fungus':
		'omringende tegels (%1x%1) ontwikkelen geen onkruid of schimmel',
	'harvest when mature for +%1 of CpS (max. %2% of bank)':
		'oogst zodra volwassen voor +%1 van KpS (max. %2% van de voorraad)',
	...
	'may sometimes drop spores when uprooted':
		'kan soms sporen laten vallen wanneer hij uit de grond komt',
	'explodes into up to %1 of CpS at the end of its lifecycle (max. %2% of bank)':
		'explodeert aan het einde van zijn levenscyclus tot maximaal %1 van KpS (max. %2% van de voorraad)',
	'cannot handle cold climates; %1% chance to die when frozen':
		'kan niet tegen koude klimaten; %1% kans om te sterven wanneer bevroren',
	'the unfortunate result of some plant combinations':
		'het onfortuinlijke resultaat van enkele plantencombinaties',
	...
	'Click to use this type of soil for your whole field.':
		'Klik om deze grondsoort voor je hele veld te gebruiken.',
	Dirt: 'Grond',
	"Simple, regular old dirt that you'd find in nature.":
		'Simpele, normale, ouderwetse grond die je in de natuur kunt tegenkomen.',
	Fertilizer: 'Kunstmest',
	'Soil with a healthy helping of fresh manure. Plants grow faster but are less efficient.':
		'Grond met een gezonde dosis verse mest. Planten groeien sneller maar zijn minder efficiënt.',
	Clay: 'Klei',
	'Rich soil with very good water retention. Plants grow slower but are more efficient.':
		'Rijke grond met zeer goede waterretentie. Planten groeien langzamer maar zijn efficiënter.',
	Pebbles: 'Kiezels',
	"Dry soil made of small rocks tightly packed together. Not very conducive to plant health, but whatever falls off your crops will be easy to retrieve.<br>Useful if you're one of those farmers who just want to find new seeds without having to tend their garden too much.":
		"Droge grond van kleine steentjes die dicht op elkaar zitten. Niet bepaald goed voor de gezondheid van planten, maar wat van je gewassen afvalt zal makkelijk te vinden zijn.<br>Nuttig als je zo'n boer bent die wel nieuwe zaadjes wil vinden, maar daarvoor liever niet te veel in z'n tuin wil werken.",
	...
	'Soil made of bits and pieces of bark and sawdust. Helpful for young sprouts to develop, not so much for mature plants.':
		'Grond gemaakt van stukjes boomschors en zaagsel. Handig voor het ontwikkelen van jonge spruiten, maar niet echt voor volwassen planten.',
	...
	'<b>%1% chance</b> of collecting seeds automatically when plants expire':
		'<b>%1% kans</b> om automatisch zaad te verzamelen als planten sterven',
	'plants spread and mutate <b>%1 times more</b>':
		'planten verspreiden en muteren <b>%1 keer sneller</b>',
	...
	'This tile of soil is empty.<br>Pick a seed and plant something!':
		'Deze grondtegel is leeg.<br>Pak zaad op en plant iets!',
	...
	'may reproduce, will drop seed when harvested':
		'kan reproduceren, laat bij het oogsten zaad vallen',
	...
	'Click to refill your soil timer and trigger <b>1</b> plant growth tick with <b>x%1</b> spread and mutation rate for %2.':
		'Klik om je grondtimer opnieuw aan te vullen en activeer <b>1</b> plantgroeitik met een <b>%1</b> keer snellere verspreidings- en mutatieratio voor %2.',
	...
	'Plot size: %1<br>(Upgrades with farm level)':
		'Landgrootte: %1<br>(Wordt groter bij hoger boerderijlevel)',
	...
	'while plant is alive; scales with plant growth':
		'tijdens het leven van de plant; schaalt op met de groei van de plant',
	Dungeon: 'Kerker',
	Grimoire: '/',
	'This is your magic meter. Each spell costs magic to use.<div class="line"></div>Your maximum amount of magic varies depending on your amount of <b>Wizard towers</b>, and their level.<div class="line"></div>Magic refills over time. The lower your magic meter, the slower it refills.':
		'Dit is je magiemeter. Elke spreuk kost magie.<div class="line"></div>Je maximale hoeveelheid magie varieert op basis van je aantal <b>Tovenaarstorens</b> en hun level.<div class="line"></div>Magie vult in de loop der tijd bij. Hoe lager je magiemeter, hoe langzamer hij bijvult.',
	...
	'Click to refill <b>%1 units</b> of your magic meter for %2.':
		'Klik om <b>%1 eenheden</b> van je magiemeter voor %2 bij te vullen.',
	'Grimoire spells are %1% cheaper but fail %1% more.':
		'Grimoire-toverspreuken zijn %1% goedkoper, maar mislukken %1% vaker.',
	'Conjure Baked Goods': 'Bezweer gebakken waren',
	'Summon half an hour worth of your CpS, capped at %1% of your cookies owned.':
		'Roep een half uur aan KpS op, beperkt tot %1% van de koekjes in jouw bezit.',
	'Trigger a %1-minute clot and lose %1 minutes of CpS.':
		'Veroorzaak een prop van %1 minuten en verlies %1 minuten aan KpS.',
	...
	'Summon a random golden cookie. Each existing golden cookie makes this spell +%1% more likely to backfire.':
		'Roep een willekeurig gouden koekje op. Elk bestaande gouden koekje maakt het +%1% waarschijnlijker dat deze spreuk mislukt.',
	...
	'All active buffs gain %1% more time (up to %2 more minutes).':
		'Alle actieve versterkingen duren %1% langer (maximaal %2 extra minuten).',
	'All active buffs are shortened by %1% (up to %2 minutes shorter).':
		'Alle actieve versterkingen zijn met %1% verkort (maximaal %2 minuten korter).',
	...
	'The spell picks a random building you could afford if you had twice your current cookies, and gives it to you for free. The building selected must be under %1, and cannot be your most-built one (unless it is your only one).':
		'De spreuk kiest een willekeurig gebouw dat je had kunnen betalen als je twee keer zoveel koekjes als op dat moment hebt, en geeft het je gratis. Het geselecteerde gebouw dient onder de %1 te zijn, en kan niet je meest gebouwde zijn (tenzij het je enige is).',
	...
	'Cast a random spell at half the magic cost, with twice the chance of backfiring.':
		'Tover een willekeurige spreuk voor de helft van de magiekosten, met een dubbele kans op mislukking.',
	...
	'Instantly summon a wrinkler if conditions are fulfilled.':
		'Roep onmiddellijk een mee-eter op zodra de voorwaarden vervuld zijn.',
	...
	'Spells backfire %1 times less for the next %2 minutes.':
		'Spreuken mislukken de komende %2 minuten %1 minder vaak.',
	'Spells backfire %1 times more for the next %2 minutes.':
		'Spreuken mislukken de komende %2 minuten %1 vaker.',
	...
	'[GOD 1 QUOTE]An immortal life spent focusing on the inner self, away from the distractions of material wealth.':
		'Een onsterfelijk leven, besteed aan een focus op de innerlijke zelf, weg van de afleidingen van de materialistische wereld.',
	...
	'[GOD 2 QUOTE]This sleazy spirit revels in the lust for quick easy gain and contempt for the value of steady work.':
		'Deze slonzige geest zwelgt van de lust naar de snelle en makkelijke vervulling van verlangens en haat voor de waarde van stabiel werk.',
	...
	'[GOD 3 QUOTE]The embodiment of natural disasters. An impenetrable motive drives the devastation caused by this spirit.':
		'De belichaming van natuurrampen. Een ondoordringbaar motief spoort de door deze geest veroorzaakte vernietiging aan.',
	...
	"[GOD 4 QUOTE]This spirit knows about everything you'll ever do, and enjoys dispensing a harsh judgment.":
		'Deze geest weet alles wat jij ooit zult doen, en geniet ervan om een hard vonnis te vellen.',
	...
	'[GOD 5 QUOTE]This is the spirit of merry getaways and regretful Monday mornings.':
		'Dit is de geest van gezellige uitjes en berouwvolle maandagochtenden.',
	...
	"[GOD 6 QUOTE]All things that be and ever will be were scripted long ago by this spirit's inscrutable tendrils.":
		'Alle dingen die zijn en ooit zullen zijn, zijn lang geleden opgetekend door de ondoorgrondelijke ranken van deze geest.',
	...
	'[GOD 7 QUOTE]This spirit enjoys a good cheese after a day of hard work.':
		'Deze geest houdt van een lekker stukje kaas na een dag hard werken.',
	...
	'[GOD 8 QUOTE]While this spirit has many regrets, helping you rule the world through constant industrialization is not one of them.':
		'Alhoewel deze geest van veel dingen spijt heeft, is jou helpen om middels voortdurende industrialisatie de wereld te overheersen er niet een van.',
	...
	'[GOD 9 QUOTE]A caring spirit said to contain itself, inwards infinitely.':
		'Een zorgzame geest waarvan gezegd wordt dat ze alles oneindig in zichzelf verwerkt.',
	...
	'[GOD 10 QUOTE]This spirit enjoys poking foul beasts and watching them squirm, but has no love for its own family.':
		'Deze geest geniet ervan om kwade beesten te porren en te kijken hoe ze piepen, maar houdt niet van zijn eigen familie.',
	...
	'[GOD 11 QUOTE]You will find that life gets just a little bit sweeter if you can motivate this spirit with tidy numbers and properly-filled tax returns.':
		'Je zal zien dat het leven een klein beetje mooier wordt als je deze geest met nette getallen en degelijk ingevulde belastingformulieren weet te motiveren.',
	...
	'If a golden cookie is clicked, this spirit is unslotted and all worship swaps will be used up.':
		'Als er op een gouden koekje wordt geklikt, wordt deze geest van zijn vakje gehaald en worden alle aanbiddingswisselingen opgebruikt.',
	...
	'The jade slot behaves as a ruby slot and the ruby slot behaves as a diamond slot.':
		'Het jadevak gedraagt zich als een robijnvak en het robijnvak gedraagt zich als een diamantvak.',
	...
	'You may increase your storage space by upgrading your offices and by buying more %1. You also get %2 extra storage space per %3 level (currently: <b>+%4</b>).':
		'Je kunt je opslagruimte vergroten door je kantoren te upgraden en door meer %1 te kopen. Je krijgt ook %2 extra opslagruimte per %3 level (momenteel: <b>+%4</b>).',
	'The average worth of this stock and how high it can peak depends on the building it is tied to, along with the level of your %1.':
		'De gemiddelde waarde van dit aandeel en hoe hoog hij kan pieken is afhankelijk van het gebouw waar het aan gekoppeld is, samen met het level van je %1.',
	'%1 the hide button to toggle all other stocks.':
		'%1 de knop Verbergen om naar alle andere aandelen over te schakelen.',
	'stock:': 'aandeel:',
	...
	'You cannot buy and sell this stock in the same tick.':
		'Je kunt dit aandeel niet in dezelfde tik kopen en verkopen.',
	...
	'It is fully upgraded. Its lavish interiors, spanning across innumerable floors, are host to many a decadent party, owing to your nigh-unfathomable wealth.':
		'Hij is volledig geüpgraded. Het uitbundige interieur dat zich over ontelbare verdiepingen uitspreidt, ziet talloze decadente feestjes, met dank aan je bijna onvoorstelbare rijkdom.',
	...
	'Buying goods normally incurs overhead costs of <b>%1% extra</b>. Each broker you hire reduces that cost by <b>%2%</b>.':
		'Bij het kopen van goederen gelden normaal gesproken overheadkosten van <b>%1% extra</b>. Elke bemiddelaar die je inhuurt verlaagt die kosten met <b>%2%</b>.',
	'Current overhead costs thanks to your brokers: <b>+%1%</b>':
		'De huidige overheadkosten, dankzij je bemiddelaars: <b>+%1%</b>',
	"Buying a broker costs %1 of CpS (that's $%2).":
		'Het kopen van een bemiddelaar kost %1 van KpS (dat is $%2).',
	"Maximum number of brokers you can own: %1 (the highest amount of grandmas you've owned this run, divided by 10, plus your grandma level)":
		"Het maximale aantal bemiddelaars dat je kunt bezitten: %1 (het hoogste aantal oma's dat je dit spel hebt bezeten gedeeld door 10, plus je omalevel)",
	'Brokers are Wall Street-class grandmas versed in the ways of finance. Stockbroker grandmas work hard and play hard, and will fight telephone in hand to get your clients the best possible deals - with a sizeable profit margin for you, of course.':
		"Bemiddelaars zijn oma's op Wall-Street-niveau die verstand van financiën hebben. Aandelenbemiddelaarsoma's werken en spelen hard, en vechten met een telefoon in hun hand om de best mogelijke deals voor hun klanten te regelen - en een degelijke winstmarge voor jou natuurlijk.",
	...
	'Click to refill your opportunity timer (and give a quick burst to your economy) for %1.':
		'Klik om voor %1 je kansentimer bij te vullen (en geef je economie een snelle groei).',
	'Profits: %1. All prices are in $econds of your highest raw cookies per second.':
		'Winst: %1. Alle prijzen zijn in seconden van je hoogste hoeveelheid rauwe koekjes per seconde.',
	...
	'[Upgrade name 96]Round chocolate british tea biscuits':
		'Ronde Britse theebiscuitjes van chocolade',
	'[Upgrade name 97]Round british tea biscuits with heart motif':
		'Ronde Britse theebiscuitjes met een hartje',
	'[Upgrade name 98]Round chocolate british tea biscuits with heart motif':
		'Ronde Britse theebiscuitjes van chocolade met een hartje',
	...
	'[Upgrade name 318]Some other super-tiny fundamental particle? Probably?':
		"Nog zo'n superklein fundamenteel deeltje? Misschien?",
	...
	'[Upgrade name 442]Kitten assistants to the regional manager':
		'Kattenassistenten voor de regiomanager',
	...
	'[Upgrade name 477]Synthetic chocolate green honey butter biscuit':
		'Groen honingboterkoekje met synthetische chocolade',
	'[Upgrade name 478]Royal raspberry chocolate butter biscuit':
		'Koninklijk chocoladeboterkoekje met framboos',
	'[Upgrade name 479]Ultra-concentrated high-energy chocolate butter biscuit':
		'Ultrageconcentreerd chocoladeboterkoekje voor veel energie',
	...
	'[Upgrade name 487]Restaurants at the end of the universe':
		'Restaurants aan het eind van het universum',
	...
	'[Upgrade name 497]Pure pitch-black chocolate butter biscuit':
		'Boterkoekje met zeer pure chocolade',
	...
	'[Upgrade name 553]A chocolate chip cookie but with the chips picked off for some reason':
		'Een chocolate chip cookie maar zonder de stukjes chocolade. Die zijn er vanaf gehaald, en niemand weet waarom.',
	...
	'[Upgrade name 718]Milkhelp&reg; lactose intolerance relief tablets':
		'Melkhulp® tabletten ter verlichting van lactose-intolerantie',
	...
	'[Achievement name 70]Cheated cookies taste awful':
		'Vals verkregen koekjes smaken verschrikkelijk',
	...
	'[Achievement name 149]The old never bothered me anyway':
		'Ik heb nooit last gehad van die oudjes',
	...
	'[Achievement name 196]Too many rabbits, not enough hats':
		'Te veel konijnen, te weinig hoge hoeden',
	...
	'[Achievement name 225]He who controls the cookies controls the universe':
		'Degene die over de koekjes heerst, heerst over het universum',
	...
	'[Achievement name 230]Brought to you by the letter <div style="display:inline-block;background:url(img/money.png);width:16px;height:16px;"></div>':
		'Vooral de allerlekkerste koekjes <div style="display:inline-block;background:url(img/money.png);width:16px;height:16px;"></div>',
	...
	"[Achievement name 255]And now for my next trick, I'll need a volunteer from the audience":
		'En voor mijn volgende truc heb ik een vrijwilliger uit het publiek nodig',
	...
	'[Achievement name 259]cookie clicker forever and forever a hundred years cookie clicker, all day long forever, forever a hundred times, over and over cookie clicker adventures dot com':
		'cookie clicker voor altijd en eeuwig honderd jaar cookie clicker, de hele dag lang, honderden keren, opnieuw en opnieuw cookie clicker avonturen punt com',
	'[Achievement name 260]Scientists baffled everywhere':
		'Wetenschappers over de hele wereld staan versteld',
	...
	"[Achievement name 275]Well the cookies start coming and they don't stop coming":
		'De koekjes blijven maar komen',
	"[Achievement name 276]I don't know if you've noticed but all these icons are very slightly off-center":
		'Ik weet niet of je het gemerkt hebt, maar al deze icoontjes staan niet helemaal in het midden.',
	'[Achievement name 277]The proof of the cookie is in the baking':
		'Als je koekjes wil bakken, moet je met het deeg beginnen',
	"[Achievement name 278]If it's worth doing, it's worth overdoing":
		'Als je het fijn vindt om te doen, kun je het makkelijk nog een keer doen',
	"[Achievement name 279]The dreams in which I'm baking are the best I've ever had":
		'De dromen waarin ik aan het bakken ben, zijn de allerbeste dromen ooit.',
	...
	'[Achievement name 349]What happens in the vortex stays in the vortex':
		'Wat er in de vortex gebeurt, blijft in de vortex',
	...
	'[Achievement name 353]Maybe a chance in hell, actually':
		'Misschien hebben we in de hel een kans',
	...
	"[Achievement name 357]Save your breath because that's all you've got left":
		'Neem eens een adempauze, anders heb je geen lucht meer',
	...
	"[Achievement name 361]Don't get used to yourself, you're gonna have to change":
		'Raak maar niet aan jezelf gewend, je zal moeten veranderen',
	'[Achievement name 362]Objects in the mirror dimension are closer than they appear':
		'Voorwerpen in de spiegeldimensie zijn dichterbij dan ze lijken',
	...
	'[Achievement name 376]All the other kids with the pumped up clicks':
		'Al die anderen die sneller kunnen klikken...',
	...
	'[Achievement name 397]When the cookies ascend just right':
		'Als de koekjes precies goed opstijgen',
	...
	"[Achievement name 404]My world's on fire, how about yours":
		'Mijn wereld staat in de fik. Hoe gaat het met die van jou?',
	'[Achievement name 405]The meteor men beg to differ':
		'De meteorenmannetjes zijn het er niet mee eens',
	...
	'[Achievement name 407]We could all use a little change':
		'We kunnen wel wat verandering gebruiken',
	'[Achievement name 408]Your brain gets smart but your head gets dumb':
		'Je hersenen werken wel, maar je hoofd niet',
	...
	"[Achievement name 411]You'll never shine if you don't glow":
		'Je gaat het nooit maken als je niet enthousiast bent',
	...
	'[Achievement name 421]For more information on this achievement, please refer to its title':
		'Kijk naar de titel van deze prestatie voor meer informatie hierover',
	"[Achievement name 422]I'm so meta, even this achievement":
		'Je bent geweldig, net als deze prestatie',
	...
	"[Achievement name 429]I think it's safe to say you've got it made":
		'We kunnen wel zeggen dat je het hebt gemaakt',
	...
	"[Achievement name 442]Dude what if we're all living in a simulation like what if we're all just code on a computer somewhere":
		'Man, wat als we allemaal in een simulatie leven, wat als we allemaal code zijn die ergens op een computer staat',
	...
	"[Achievement name 449]You're #1 so why try harder":
		'Je staat al bovenaan, dus doe eens rustig aan',
	...
	'[Achievement name 502]Reduced to gibbering heaps':
		'Teruggebracht tot snaterende hoopjes ellende',
	...
	'[Achievement name 515]Nobody exists on purpose, nobody belongs anywhere':
		'Niemand bestaat met een doel, niemand hoort ergens',
	...
	'[Achievement name 521]Reject reality, substitute your own':
		'Wijs de realiteit af en vervang hem door de jouwe',
	...
	'[Achievement name 542]The organ that named itself':
		'Het orgaan dat zichzelf een naam gegeven heeft',
	...
	'[Achievement name 544]A trademarked portmanteau of "imagination" and "engineering"':
		'Een gepatenteerde samenstelling van "verbeelding" en "techniek"',
	...
	'[Achievement name 566]But the future refused to change':
		'Maar de toekomst wilde niet veranderen',
	...
	'[Achievement name 573]By will alone I set my mind in motion':
		'Ik heb met alleen mijn wil mijn verstand in gang gezet',
	...
	'[Achievement name 586]What do you get for the baker who has everything':
		'Wat koop je nou voor de bakker die alles al heeft',
