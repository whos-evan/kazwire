function createUnityInstance(e, t, n) {
	...
	function i(e, t, n) {
		...
		if (
			!(
				(c.errorHandler && c.errorHandler(e, t, n)) ||
	...
	function o(e, t) {
		if ('symbolsUrl' != e) {
			...
			r ||
				(r = c.downloadProgress[e] =
					{ started: !1, finished: !1, lengthComputable: !1, total: 0, loaded: 0 }),
				'object' != typeof t ||
					('progress' != t.type && 'load' != t.type) ||
					(r.started ||
						((r.started = !0), (r.lengthComputable = t.lengthComputable), (r.total = t.total)),
					(r.loaded = t.loaded),
	...
	function s(e, t, n) {
		for (var r in m)
			if (m[r].hasUnityMarker(e)) {
				...
				return (
					(a.worker.callbacks[o] = n),
					void a.worker.postMessage({ id: o, compressed: e }, [e.buffer])
				);
			}
		n(e);
	}
	...
	(c.SystemInfo = (function () {
		...
		(c.XMLHttpRequest = (function () {
			...
			function r() {
				function t(t) {
					if ('undefined' == typeof r.database)
						for (
							r.database = t, r.database || e('indexedDB database could not be opened');
							r.queue.length;

						) {
							var n = r.queue.shift();
							r.database
								? r.execute.apply(r, n.arguments)
								: 'function' == typeof n.onerror && n.onerror(new Error('operation cancelled'));
						}
				}
				function n() {
				...
				try {
					...
					(i.onupgradeneeded = function (e) {
						...
						['version', 'company', 'product', 'updated', 'revalidated', 'accessed'].forEach(
							function (e) {
								t.createIndex(e, e);
							}
						);
						...
						function () {
							...
							n.enabled &&
								...
								(304 == t.status
									...
									: 200 == t.status
									? ((n.result = a(n.result.url, n.company, n.product, n.result.accessed, t)),
									  (n.revalidated = !0),
									  d.execute(
											s.name,
											'put',
			...
			var o = { name: 'UnityCache', version: 2 },
				...
				if (this.database)
					try {
						var i = this.database
							.transaction(
								[e],
								['put', 'delete', 'clear'].indexOf(t) != -1 ? 'readwrite' : 'readonly'
							)
							.objectStore(e);
					...
					'undefined' == typeof this.database
						? this.queue.push({ arguments: arguments, onerror: a })
			...
			(i.prototype.send = function (t) {
					...
					a.enabled
						? void d.execute(
								...
								function (t) {
									...
									if (((a.result = t), (a.result.accessed = Date.now()), 'immutable' == a.control))
										(a.revalidated = !0),
											d.execute(s.name, 'put', [a.result]),
										...
										n(a.result.url) &&
										(a.result.responseHeaders['Last-Modified'] || a.result.responseHeaders.ETag)
									) {
										var o = new XMLHttpRequest();
										o.open('HEAD', a.result.url),
											(o.onload = function () {
												(a.revalidated = ['Last-Modified', 'ETag'].every(function (e) {
													return (
														!a.result.responseHeaders[e] ||
														a.result.responseHeaders[e] == o.getResponseHeader(e)
													);
												})),
													a.revalidated
										...
										a.result.responseHeaders['Last-Modified']
											...
											: a.result.responseHeaders.ETag &&
											  (r.setRequestHeader('If-None-Match', a.result.responseHeaders.ETag),
											  r.setRequestHeader('Cache-Control', 'no-cache')),
											r.send.apply(r, i);
								},
								function (e) {
				...
				(i.prototype.open = function (e, n, r, i, o) {
					return (
						(this.cache.result = a(t(n), this.cache.company, this.cache.product, Date.now())),
						(this.cache.enabled =
					...
					!(function (e) {
						Object.defineProperty(
							...
							'function' == typeof u[e]
								...
								: {
										get: function () {
											return this.cache.revalidated && this.cache.result.xhr.hasOwnProperty(e)
	...
	var m = {
		gzip: {
			require: function (e) {
				var t = {
					'inflate.js': function (e, t, n) {
						...
						(r.prototype.push = function (e, t) {
							...
							(r = t === ~~t ? t : t === !0 ? d.Z_FINISH : d.Z_NO_FLUSH),
								'string' == typeof e
							...
							do {
								if (
									(0 === f.avail_out &&
										((f.output = new s.Buf8(p)), (f.next_out = 0), (f.avail_out = p)),
									(n = o.inflate(f, d.Z_NO_FLUSH)),
									n === d.Z_NEED_DICT &&
										m &&
										((c =
											'string' == typeof m
									...
									n === d.Z_BUF_ERROR && b === !0 && ((n = d.Z_OK), (b = !1)),
								...
								f.next_out &&
									((0 !== f.avail_out &&
										n !== d.Z_STREAM_END &&
										(0 !== f.avail_in || (r !== d.Z_FINISH && r !== d.Z_SYNC_FLUSH))) ||
										('string' === this.options.to
											? ((a = l.utf8border(f.output, f.next_out)),
											  (i = f.next_out - a),
											  (u = l.buf2string(f.output, a)),
											  (f.next_out = i),
											  (f.avail_out = p - i),
											  i && s.arraySet(f.output, f.output, a, i, 0),
											  this.onData(u))
							...
							return (
								n === d.Z_STREAM_END && (r = d.Z_FINISH),
								r === d.Z_FINISH
									? ((n = o.inflateEnd(this.strm)), this.onEnd(n), (this.ended = !0), n === d.Z_OK)
									: r !== d.Z_SYNC_FLUSH || (this.onEnd(d.Z_OK), (f.avail_out = 0), !0)
							);
						}),
						...
						(n.setTyped = function (e) {
							e
								? ((n.Buf8 = Uint8Array),
								  ...
								  (n.Buf32 = Int32Array),
								  n.assign(n, a))
								: ((n.Buf8 = Array), (n.Buf16 = Array), (n.Buf32 = Array), n.assign(n, i));
						}),
							n.setTyped(r);
					},
					'utils/strings.js': function (e, t, n) {
						...
						for (var s = new a.Buf8(256), l = 0; l < 256; l++)
						...
						(s[254] = s[254] = 1),
							(n.string2buf = function (e) {
								...
								for (t = new a.Buf8(l), o = 0, i = 0; o < l; i++)
									(n = e.charCodeAt(i)),
										55296 === (64512 & n) &&
											i + 1 < s &&
											((r = e.charCodeAt(i + 1)),
							...
							(n.binstring2buf = function (e) {
								for (var t = new a.Buf8(e.length), n = 0, r = t.length; n < r; n++)
									t[n] = e.charCodeAt(n);
								return t;
							}),
					...
					'zlib/inflate.js': function (e, t, n) {
						...
						function i(e) {
							...
							return e && e.state
								? ((t = e.state),
								  ...
								  (t.distcode = t.distdyn = new w.Buf32(be)),
								  (t.sane = 1),
								  (t.back = -1),
								  R)
								: A;
						...
						function u(e) {
							if (ve) {
								...
								for (x(S, e.lens, 0, 288, b, 0, e.work, { bits: 9 }), t = 0; t < 32; )
									e.lens[t++] = 5;
								x(E, e.lens, 0, 32, g, 0, e.work, { bits: 5 }), (ve = !1);
							}
						...
						function c(e, t, n, r) {
							...
							return (
								null === i.window &&
									...
									(i.wnext = 0),
									(i.whave = 0),
									(i.window = new w.Buf8(i.wsize))),
								r >= i.wsize
									? (w.arraySet(i.window, t, n - i.wsize, i.wsize, 0),
									  (i.wnext = 0),
									  (i.whave = i.wsize))
									: ((a = i.wsize - i.wnext),
									  a > r && (a = r),
									  w.arraySet(i.window, t, n - r, a, i.wnext),
									  (r -= a),
									  r
											? (w.arraySet(i.window, t, n - r, r, 0), (i.wnext = r), (i.whave = i.wsize))
											: ((i.wnext += a),
						...
						function f(e, t) {
								...
								switch (n.mode) {
										...
										if (
											...
											b &&
												(n.head &&
													...
													w.arraySet(n.head.extra, a, o, b, xe)),
												512 & n.flags && (n.check = y(n.check, a, b, o)),
												(l -= b),
												(o += b),
												(n.length -= b)),
											n.length)
									...
									case P:
										if (2048 & n.flags) {
											...
											while (xe && b < l);
											if (
												(512 & n.flags && (n.check = y(n.check, a, b, o)), (l -= b), (o += b), xe)
											)
												break e;
									...
									case ee:
										...
										if (
											...
											(n.lenbits = 7),
											(Se = { bits: n.lenbits }),
											(_e = x(_, n.lens, 0, 19, n.lencode, 0, n.work, Se)),
											(n.lenbits = Se.bits),
											_e)
										) {
									...
									case te:
										...
										if (
											((n.lenbits = 9),
											(Se = { bits: n.lenbits }),
											(_e = x(S, n.lens, 0, n.nlen, n.lencode, 0, n.work, Se)),
											(n.lenbits = Se.bits),
											_e)
										) {
										...
										if (
											...
											(Se = { bits: n.distbits }),
											(_e = x(E, n.lens, n.nlen, n.ndist, n.distcode, 0, n.work, Se)),
											(n.distbits = Se.bits),
											_e)
										) {
									...
									case re:
										...
										if (ge && 0 === (240 & ge)) {
											for (
												ve = be, ye = ge, ke = we;
												(Le = n.lencode[ke + ((f & ((1 << (ve + ye)) - 1)) >> ve)]),
													(be = Le >>> 24),
													(ge = (Le >>> 16) & 255),
													(we = 65535 & Le),
													!(ve + be <= h);
									...
									case ie:
										for (
											;
											(Le = n.distcode[f & ((1 << n.distbits) - 1)]),
												(be = Le >>> 24),
												(ge = (Le >>> 16) & 255),
												(we = 65535 & Le),
												!(be <= h);
										...
										if (0 === (240 & ge)) {
											for (
												ve = be, ye = ge, ke = we;
												(Le = n.distcode[ke + ((f & ((1 << (ve + ye)) - 1)) >> ve)]),
													(be = Le >>> 24),
													(ge = (Le >>> 16) & 255),
													(we = 65535 & Le),
													!(ve + be <= h);
									...
									case se:
										...
										if (((b = m - d), n.offset > b)) {
											...
											b > n.wnext ? ((b -= n.wnext), (g = n.wsize - b)) : (g = n.wnext - b),
									...
									case de:
										if (n.wrap) {
											...
											if (
												...
												m &&
													(e.adler = n.check =
														n.flags ? y(n.check, i, m, s - m) : v(n.check, i, m, s - m)),
												(m = d),
							...
							return (
								...
								(n.hold = f),
								(n.bits = h),
								(n.wsize || (m !== e.avail_out && n.mode < fe && (n.mode < de || t !== L))) &&
								c(e, e.output, e.next_out, m - e.avail_out)
									...
									: ((p -= e.avail_in),
									  ...
									  n.wrap &&
											...
											(e.adler = n.check =
												n.flags
													? y(n.check, i, m, e.next_out - m)
													: v(n.check, i, m, e.next_out - m)),
									  (e.data_type =
											n.bits +
											(n.last ? 64 : 0) +
											(n.mode === K ? 128 : 0) +
											(n.mode === ne || n.mode === Q ? 256 : 0)),
									  ((0 === p && 0 === m) || t === L) && _e === R && (_e = T),
									  _e)
							);
						}
						function h(e) {
						...
						function p(e, t) {
							var n;
							return e && e.state
								? ((n = e.state), 0 === (2 & n.wrap) ? A : ((n.head = t), (t.done = !1), R))
								: A;
						}
						function m(e, t) {
							var n,
							...
							return e && e.state
								? ((n = e.state),
								  0 !== n.wrap && n.mode !== X
										? A
										: n.mode === X && ((r = 1), (r = v(r, t, i, 0)), r !== n.check)
										? I
										: (a = c(e, t, i, i))
										? ((n.mode = he), N)
										: ((n.havedict = 1), R))
					...
					'zlib/inffast.js': function (e, t, n) {
						...
						t.exports = function (e, t) {
							...
							(n = e.state),
								...
								(y = (1 << n.distbits) - 1);
							e: do {
								b < 15 && ((m += B[i++] << b), (b += 8), (m += B[i++] << b), (b += 8)),
									(k = g[m & v]);
								t: for (;;) {
									if (((x = k >>> 24), (m >>>= x), (b -= x), (x = (k >>> 16) & 255), 0 === x))
										C[s++] = 65535 & k;
									else {
										if (!(16 & x)) {
											if (0 === (64 & x)) {
										...
										n: for (;;) {
											if (
												((x = k >>> 24), (m >>>= x), (b -= x), (x = (k >>> 16) & 255), !(16 & x))
											) {
												if (0 === (64 & x)) {
													k = w[(65535 & k) + (m & ((1 << x) - 1))];
													continue n;
											...
											if (((m >>>= x), (b -= x), (x = s - l), S > x)) {
												...
												for (; _ > 2; )
													(C[s++] = L[E++]), (C[s++] = L[E++]), (C[s++] = L[E++]), (_ -= 3);
												_ && ((C[s++] = L[E++]), _ > 1 && (C[s++] = L[E++]));
											} else {
												E = s - S;
												do (C[s++] = C[E++]), (C[s++] = C[E++]), (C[s++] = C[E++]), (_ -= 3);
												while (_ > 2);
					...
					'zlib/inftrees.js': function (e, t, n) {
						...
						t.exports = function (e, t, n, p, m, b, g, w) {
							...
							if ((I > A && (I = A), 0 === A))
								return (m[b++] = 20971520), (m[b++] = 20971520), (w.bits = 1), 0;
							for (U = 1; U < A && 0 === j[U]; U++);
							...
							for (;;) {
								(E = R - T),
									...
									(y = 1 << N),
									(U = y);
								do (y -= v), (m[_ + (Z >> T) + y] = (E << 24) | (L << 16) | B | 0);
								while (0 !== y);
								for (v = 1 << (R - 1); Z & v; ) v >>= 1;
				...
				var r = function (e) {
					...
					i = function (e, t) {
						...
						return (
							n.exports || ((n.parent = e), n(i.bind(null, n), n, (n.exports = {}))), n.exports
						);
					};
				return i(null, e);
			},
			...
			hasUnityMarker: function (e) {
				...
				return (
					16 & r && String.fromCharCode.apply(null, e.subarray(t, t + n.length + 1)) == n + '\0'
				);
			}
		}
	};
