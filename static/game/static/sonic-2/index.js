...
(function () {
	...
	loadPackage({
		files: [{ filename: '/Data.rsdk', start: 0, end: 46736131 }],
		remote_package_size: 46736131,
		package_uuid: '26f65515-2c61-4d42-8a99-3898c2eaf05f'
	});
})();
...
function doRequestFullscreen(target, strategy) {
	...
	if (!canPerformRequests) {
		if (strategy.deferUntilInEventHandler) {
			JSEvents.deferCall(_JSEvents_requestFullscreen, 1 /* priority over pointer lock */, [
				target,
				strategy
			]);
			return 1;
