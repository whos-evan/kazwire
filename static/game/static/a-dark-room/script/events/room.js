...
Events.Room = [
	{
		/* The Nomad  --  Merchant */ title: _('The Nomad'),
	...
	{
		/* Noises Outside  --  gain wood/fur */ title: _('Noises'),
		isAvailable: function () {
		...
		scenes: {
			...
			nothing: {
				text: [_('vague shapes move, just out of sight.'), _('the sounds stop.')],
				buttons: {
					backinside: {
	...
	{
		/* Noises Inside  --  trade wood for better good */ title: _('Noises'),
		isAvailable: function () {
			return Engine.activeModule == Room && $SM.get('stores.wood');
		},
		scenes: {
			...
			scales: {
				text: [_('some wood is missing.'), _('the ground is littered with small scales')],
				onLoad: function () {
			...
			teeth: {
				text: [_('some wood is missing.'), _('the ground is littered with small teeth')],
				onLoad: function () {
					var numWood = $SM.get('stores.wood', true);
					numWood = Math.floor(numWood * 0.1);
					if (numWood === 0) numWood = 1;
			...
			cloth: {
				text: [_('some wood is missing.'), _('the ground is littered with scraps of cloth')],
				onLoad: function () {
					var numWood = $SM.get('stores.wood', true);
					numWood = Math.floor(numWood * 0.1);
					if (numWood === 0) numWood = 1;
	...
	{
		/* The Beggar  --  trade fur for better good */ title: _('The Beggar'),
		isAvailable: function () {
			return Engine.activeModule == Room && $SM.get('stores.fur');
		},
		scenes: {
			start: {
				text: [_('a beggar arrives.'), _('asks for any spare furs to keep him warm at night.')],
			...
			scales: {
				reward: { scales: 20 },
				text: [_('the beggar expresses his thanks.'), _('leaves a pile of small scales behind.')],
				buttons: {
					leave: {
						text: _('say goodbye'),
						nextScene: 'end'
			...
			teeth: {
				reward: { teeth: 20 },
				text: [_('the beggar expresses his thanks.'), _('leaves a pile of small teeth behind.')],
				buttons: {
					leave: {
						text: _('say goodbye'),
						nextScene: 'end'
			...
			cloth: {
				reward: { cloth: 20 },
				text: [_('the beggar expresses his thanks.'), _('leaves some scraps of cloth behind.')],
				buttons: {
					leave: {
						text: _('say goodbye'),
						nextScene: 'end'
	...
	{
		/* The Shady Builder */ title: _('The Shady Builder'),
		isAvailable: function () {
			return (
		...
		scenes: {
			start: {
				text: [_('a shady builder passes through'), _('says he can build you a hut for less wood')],
			...
			steal: {
				text: [_('the shady builder has made off with your wood')],
			...
			build: {
				text: [_('the shady builder builds a hut')],
	...
	{
		/* Mysterious Wanderer  --  wood gambling */ title: _('The Mysterious Wanderer'),
		isAvailable: function () {
			return Engine.activeModule == Room && $SM.get('stores.wood');
		},
		scenes: {
			...
			wood100: {
				text: [_('the wanderer leaves, cart loaded with wood')],
					...
					Events.saveDelay(
						function () {
							...
							Notifications.notify(
								Room,
								_('the mysterious wanderer returns, cart piled high with wood.')
							);
						},
						'Room[4].scenes.wood100.action',
						delay
					);
				},
				onLoad: function () {
	...
	{
		/* Mysterious Wanderer  --  fur gambling */ title: _('The Mysterious Wanderer'),
		isAvailable: function () {
			return Engine.activeModule == Room && $SM.get('stores.fur');
		},
		scenes: {
			...
			fur100: {
				text: [_('the wanderer leaves, cart loaded with furs')],
				action: function (inputDelay) {
					var delay = inputDelay || false;
					Events.saveDelay(
						function () {
							...
							Notifications.notify(
								Room,
								_('the mysterious wanderer returns, cart piled high with furs.')
							);
						},
						'Room[5].scenes.fur100.action',
						delay
					);
				},
				onLoad: function () {
	...
	{
		/* The Scout  --  Map Merchant */ title: _('The Scout'),
		isAvailable: function () {
	...
	{
		/* The Wandering Master */ title: _('The Master'),
		isAvailable: function () {
			return Engine.activeModule == Room && $SM.get('features.location.world');
		},
		scenes: {
			...
			agree: {
				text: [_('in exchange, the wanderer offers his wisdom.')],
				buttons: {
					evasion: {
						text: _('evasion'),
						available: function () {
	...
	{
		/* The Sick Man */ title: _('The Sick Man'),
		isAvailable: function () {
			return Engine.activeModule == Room && $SM.get('stores.medicine', true) > 0;
		},
		scenes: {
			start: {
				text: [_('a man hobbles up, coughing.'), _('he begs for medicine.')],
			...
			nothing: {
				text: [_('the man expresses his thanks and hobbles off.')],
				buttons: {
					bye: {
						text: _('say goodbye'),
						nextScene: 'end'
