				...
				!(function (i, o) {
					if (i) {
						...
						(s.noConflict = function () {
							...
							(s.report = (function () {
								...
								function c(t, i, n, r, a) {
									if (d) s.computeStackTrace.augmentStackTraceWithInitialElement(d, i, n, t), h();
										...
										(c.func = s.computeStackTrace.guessFunctionName(c.url, c.line)),
											...
											A({ name: o, message: p, mode: 'onerror', stack: [c] }, !0, null);
									}
								...
								return (
									...
									(m.unsubscribe = function (o) {
										...
										0 === a.length &&
											(t && ((i.onerror = e), (t = !1)),
											r && ((i.onunhandledrejection = n), (r = !1)));
									}),
									m
								);
							})()),
							(s.computeStackTrace = (function () {
								...
								function m(e) {
									...
									for (
										...
										if ((i = o.exec(h[v]))) {
											...
											i[3] && i[3].indexOf(' > eval') > -1 && (t = A.exec(i[3]))
												? ((i[3] = t[1]), (i[4] = t[2]), (i[5] = null))
												: 0 !== v ||
												  i[5] ||
												  u(e.columnNumber) ||
										...
										!n.func && n.line && (n.func = r(n.url, n.line)),
											(n.context = n.line ? a(n.url, n.line) : null),
											m.push(n);
									}
									return m.length
										? (m[0] &&
												...
												!m[0].column &&
												g &&
												(m[0].column = l(g[1], m[0].url, m[0].line)),
								...
								function v(e, t) {
									for (
										...
										if (u !== f && u !== s.report) {
											if (
												((n = { url: null, func: c, args: [], line: null, column: null }),
												u.name ? (n.func = u.name) : (i = o.exec(u.toString())) && (n.func = i[1]),
												void 0 === n.func)
											)
												try {
									...
									t && d.splice(0, t);
									var b = { mode: 'callers', name: e.name, message: e.message, stack: d };
									return (
										g(
											b,
												...
												if (t) {
													for (
														...
														if (
															...
															if ((!c.func && c.line && (c.func = r(c.url, c.line)), c.line))
																try {
													...
													return d.length
														? { mode: 'stacktrace', name: e.name, message: e.message, stack: d }
														: null;
												}
											})(t)),
											s)
										...
										if (
											((s = (function (e) {
												...
												for (var v = 2; v < t.length; v += 2) {
													var f = null;
													if ((o = s.exec(t[v])))
														f = { url: o[2], func: o[3], args: [], line: +o[1], column: null };
													else if ((o = c.exec(t[v]))) {
														f = { url: o[3], func: o[4], args: [], line: +o[1], column: null };
														var b = +o[1],
															y = m[o[2] - 1];
														if (y) {
															var k = n(f.url);
												...
												return u.length
													? { mode: 'multiline', name: e.name, message: t[0], stack: u }
													: null;
											})(t)),
											s)
										)
								...
								var e = function (e) {
									...
									i[e] = function () {
										var e = A.call(arguments),
											i = e[0];
										return (
											'function' == typeof i && (e[0] = s.wrap(i)),
							...
							(r = []),
							void 0 === (a = 'function' == typeof (n = s) ? n.apply(t, r) : n) || (e.exports = a);
					}
					function p(e, t) {
	...
	(i.n = (e) => {
		...
		(() => {
				...
				return (
					...
					(e.dispatchEvent = function (e, t) {
						...
						for (var i = Object.keys(this.listeners), n = 0; n < i.length; n++) {
							var o = i[n];
							if (e === o)
								for (var s = this.listeners[o], d = 0; d < s.length; d++)
									s[d](a(a({}, this.dataAnnotations), t));
						}
					}),
			...
			function d() {
				var e,
					t =
						(null === (e = null === window || void 0 === window ? void 0 : window.location) ||
						void 0 === e
							? void 0
							: e.hostname) || '';
			...
			var A = {
				...
				c = {
					AE: { video: { amazon: 0.7, appnexus: 0.76 } },
					AL: { video: { amazon: 0.75 } },
					AT: { video: { appnexus: 0.6, onetag: 0.81, pubmatic: 0.82 } },
					AU: { video: { pubmatic: 0.43, rubicon: 0.38 } },
					AZ: { video: { amazon: 0.72, onetag: 0.84 } },
					BE: { video: { amazon: 0.83, appnexus: 0.79 } },
					BG: { video: { appnexus: 0.72 } },
					BO: { video: { ix: 0.84 } },
					CA: { video: { amazon: 0.84, pubmatic: 0.81 } },
					CL: { video: { amazon: 0.78 } },
					CO: { video: { amazon: 0.85 } },
					CZ: { video: { appnexus: 0.77 } },
					DE: { video: { appnexus: 0.21, onetag: 0.81 } },
					DO: { video: { onetag: 0.84 } },
					DZ: { video: { amazon: 0.41 } },
					EG: { video: { amazon: 0.15, rubicon: 0.63 } },
					ES: { video: { appnexus: 0.66, ix: 0.84, onetag: 0.82, openx: 0.84, pubmatic: 0.79 } },
					FI: { video: { appnexus: 0.43 } },
					FR: { video: { appnexus: 0.26, ix: 0.53, onetag: 0.81 } },
					GB: { video: { districtm: 0.83, onetag: 0.8 } },
					GT: { video: { amazon: 0.74 } },
					HU: { video: { amazon: 0.55, appnexus: 0.65 } },
					IE: { video: { onetag: 0.66 } },
					IN: { video: { appnexus: 0.72 } },
					IT: { video: { appnexus: 0.46, onetag: 0.46 } },
					JP: { video: { onetag: 0.84 } },
					KE: { video: { onetag: 0.84 } },
					KW: { video: { onetag: 0.83 } },
					KZ: { video: { onetag: 0.8 } },
					LU: { video: { onetag: 0.82 } },
					MA: { video: { amazon: 0.68 } },
					MD: { video: { onetag: 0.7 } },
					MX: { video: { amazon: 0.47, pubmatic: 0.75 } },
					NL: { video: { ix: 0.39, onetag: 0.81, openx: 0.71, richaudience: 0.72 } },
					NZ: { video: { amazon: 0.76, openx: 0.83 } },
					OM: { video: { onetag: 0.84 } },
					PE: { video: { amazon: 0.82 } },
					PL: { video: { appnexus: 0.84, districtm: 0.71, onetag: 0.73 } },
					PR: { video: { amazon: 0.83 } },
					RU: { video: { amazon: 0.78, onetag: 0.84 } },
					SA: { video: { amazon: 0.83, appnexus: 0.74 } },
					SK: { video: { appnexus: 0.79 } },
					TN: { video: { amazon: 0.61 } },
					UA: { video: { onetag: 0.8 } },
					US: { video: { pubmatic: 0.01 } },
					VE: { video: { onetag: 0.8 } },
					VN: { video: { appnexus: 0.81 } }
				};
			const l = A;
			const p = function (e) {
			...
			const u = (function () {
				function e(e) {
					void 0 === e && (e = {}),
						...
						o.addEventListener(n.ads.requested, this.startTimeBetweenAdsTimer.bind(this)),
						o.addEventListener(n.ads.completed, this.startTimeBetweenAdsTimer.bind(this)),
						o.addEventListener(n.ads.stopped, this.startTimeBetweenAdsTimer.bind(this));
				}
				return (
			...
			function g(e, t) {
				document.cookie =
					e + '=' + t + '; path=/; samesite=none; secure; max-age=15552000; domain=' + h;
			}
			...
			const w = (function () {
					...
					return (
									...
									switch (a.label) {
										...
										case 4:
											return (
												...
												(r = { cookies: n, p4d_game_id: tt.gameId, user_id: k }),
												window
						...
						(e.trackSavegames = function () {
							window.cookieStore &&
								...
								tt.gameId &&
								(Math.random() > 0.01 ||
									(k || ((k = Math.random().toString(36).substr(2, 9)), g(y, k)),
									e.collectAndLog(),
				...
				_ = function (e, t) {
					...
					var n = new RegExp('(?:[\\?&]|^)' + e + '=([^&#]*)').exec(
						t ||
							(null === (i = null === window || void 0 === window ? void 0 : window.location) ||
							void 0 === i
								? void 0
								: i.search) ||
							''
			...
			function R(e) {
				return B.includes(e) ? 0.13 : P.includes(e) ? 0.07 : D.includes(e) ? 0.04 : 0.02;
			}
			function L(e) {
				return 'US' === e
					? 1.5
			...
			var O = [
				'https://a.poki.com/houseads/duo_survival_3.xml',
				'https://a.poki.com/houseads/like_a_king.xml',
				'https://a.poki.com/houseads/merge_cyber_racers.xml',
				'https://a.poki.com/houseads/subway_surfers.xml',
				'https://a.poki.com/houseads/tower_crush_compressed.xml'
			];
			function G() {
			...
			var X = 'rewarded',
				...
				W = function (e) {
					var t =
						...
						i = U(
							...
							{ boxingallowed: 1, pos: 1, api: [2] }
						);
					return {
						bids: [
							{ bidder: 'appnexus', params: { placementId: 13184250, supplyType: 'web' } },
							{ bidder: 'openx', params: { delDomain: 'poki-d.openx.net', unit: '540105196' } },
							{
								bidder: 'spotx',
								params: { channel_id: '265590', ad_unit: 'instream', secure: !0, hide_skin: !0 }
							},
							{ bidder: 'ix', params: { siteId: '436284', video: U({}, i) } },
							{ bidder: 'richaudience', params: { pid: T(H), supplyType: 'site' } },
							{ bidder: 'onetag', params: { pubId: '6da09f566a9dc06' } },
							{
								bidder: 'onetag',
								params: {
									pubId: '6da09f566a9dc06',
									ext: { override_maxduration: 3600, enforce_skip: !0 }
								}
							},
							{
								bidder: 'rubicon',
							...
							{ bidder: 'pubmatic', params: { publisherId: '156838', adSlot: '3607869@640x360' } },
							{ bidder: 'districtm', params: { placementId: 12906789 } }
						],
						mediaTypes: { video: U({ context: 'instream', playerSize: [640, 480] }, i) }
					};
				},
				V = W(!0),
				q = W(!1),
				J = [
					{ code: Z, mediaTypes: q.mediaTypes, bids: N([], q.bids, !0) },
					{ code: X, mediaTypes: V.mediaTypes, bids: N([], V.bids, !0) },
					{
						code: K['728x90'],
						...
						bids: [
							...
							{ bidder: 'emx_digital', params: { tagid: '80117' } },
							{ bidder: 'conversant', params: { site_id: '117477', secure: 1, position: 1 } },
							{
								bidder: 'rubicon',
								params: { accountId: '18608', siteId: '204596', zoneId: '1008080' }
							},
							{ bidder: 'onetag', params: { pubId: '6da09f566a9dc06' } },
							{
								bidder: 'richaudience',
								params: { pid: 15 === H ? 'MP_gIE1VDieUi' : '1V6a2fgLvX', supplyType: 'site' }
							}
						]
					},
					{
						...
						bids: [
							...
							{ bidder: 'emx_digital', params: { tagid: '80118' } },
							{ bidder: 'conversant', params: { site_id: '117477', secure: 1, position: 1 } },
							{
								bidder: 'rubicon',
								params: { accountId: '18608', siteId: '204596', zoneId: '1008080' }
							...
							{
								bidder: 'richaudience',
								params: { pid: 15 === H ? 'MP_gIE1VDieUi' : 'pKqNt5LyvF', supplyType: 'site' }
							}
						]
					},
					{
						...
						bids: [
							...
							{ bidder: 'emx_digital', params: { tagid: '123738' } },
							{ bidder: 'conversant', params: { site_id: '117477', secure: 1, position: 1 } },
							{ bidder: 'onetag', params: { pubId: '6da09f566a9dc06' } },
							{
								bidder: 'richaudience',
								params: { pid: 15 === H ? 'MP_gIE1VDieUi' : 'yYyae7vnIh', supplyType: 'site' }
							}
						]
					},
					{
						...
						bids: [
							...
							{ bidder: 'emx_digital', params: { tagid: '80119' } },
							{ bidder: 'conversant', params: { site_id: '117477', secure: 1, position: 1 } },
							{
								bidder: 'rubicon',
								params: { accountId: '18608', siteId: '204596', zoneId: '1008080' }
							...
							{
								bidder: 'richaudience',
								params: { pid: 15 === H ? 'MP_gIE1VDieUi' : 'rAEnPimPzC', supplyType: 'site' }
							}
						]
					},
					{
						...
						bids: [
							...
							{ bidder: 'emx_digital', params: { tagid: '123737' } },
							{ bidder: 'onetag', params: { pubId: '6da09f566a9dc06' } },
							{
								bidder: 'richaudience',
								params: { pid: 15 === H ? 'MP_gIE1VDieUi' : '1DP5EtcOip', supplyType: 'site' }
							}
						]
					},
					{
						...
						bids: [
							...
							{
								bidder: 'ix',
								params: { siteId: '268177', placementId: '625562', size: [728, 90] }
							},
							{ bidder: 'pubmatic', params: { publisherId: '156838', adSlot: '3457872' } },
							{ bidder: 'emx_digital', params: { tagid: '132973' } },
							{
								bidder: 'conversant',
								params: { site_id: '117477', tag_id: '96373699', secure: 1, position: 1 }
							},
							{
								bidder: 'rubicon',
								params: { accountId: '18608', siteId: '362566', zoneId: '1962680-2' }
							},
							{ bidder: 'onetag', params: { pubId: '6da09f566a9dc06' } },
							{
								bidder: 'richaudience',
					...
					},
					{
						...
						bids: [
							...
							{ bidder: 'emx_digital', params: { tagid: '132975' } },
							{
								bidder: 'conversant',
								params: { site_id: '117477', tag_id: '94f55c24', secure: 1, position: 1 }
							},
							{
								bidder: 'rubicon',
								params: { accountId: '18608', siteId: '362566', zoneId: '1962680-15' }
							},
							{ bidder: 'onetag', params: { pubId: '6da09f566a9dc06' } },
							{
								bidder: 'richaudience',
					...
					},
					{
						...
						bids: [
							...
							{ bidder: 'emx_digital', params: { tagid: '132979' } },
							{
								bidder: 'conversant',
								params: { site_id: '117477', tag_id: '62235ccb', secure: 1, position: 1 }
							},
							{
								bidder: 'rubicon',
								params: { accountId: '18608', siteId: '362566', zoneId: '1962680-57' }
							},
							{ bidder: 'onetag', params: { pubId: '6da09f566a9dc06' } },
							{
								bidder: 'richaudience',
					...
					},
					{
						...
						bids: [
							...
							{ bidder: 'emx_digital', params: { tagid: '132974' } },
							{
								bidder: 'conversant',
								params: { site_id: '117477', tag_id: '9960183e', secure: 1, position: 1 }
							},
							{
								bidder: 'rubicon',
								params: { accountId: '18608', siteId: '362566', zoneId: '1962680-9' }
							},
							{ bidder: 'onetag', params: { pubId: '6da09f566a9dc06' } },
							{
								bidder: 'richaudience',
					...
					},
					{
						...
						bids: [
							...
							{
								bidder: 'conversant',
								params: { site_id: '117477', tag_id: '402db827', secure: 1, position: 1 }
							},
							{
								bidder: 'rubicon',
								params: { accountId: '18608', siteId: '362566', zoneId: '1962680-43' }
							},
							{ bidder: 'emx_digital', params: { tagid: '132978' } },
							{ bidder: 'onetag', params: { pubId: '6da09f566a9dc06' } },
							{
								bidder: 'richaudience',
								params: { pid: 15 === H ? 'MP_gIE1VDieUi' : '1DP5EtcOip', supplyType: 'site' }
				...
				Y = {
					...
					currency: {
						...
						defaultRates: {
							EUR: { EUR: 1, GBP: 0.86408, USD: 1.2212 },
							GBP: { EUR: 1.157300249976854, GBP: 1, USD: 1.4132950652717342 },
							USD: { EUR: 0.8188666885031116, GBP: 0.7075663282017687, USD: 1 }
						}
					},
					...
					userSync: {
						...
						userIds: [
							{
								name: 'pubCommonId',
								storage: { type: 'cookie', name: 'poki_pubcid', expires: 180 }
							}
						]
					}
				},
										...
										for (
											var d = e[s],
												A =
													a[
														(
															null === (n = null == d ? void 0 : d.mediaTypes) || void 0 === n
																? void 0
																: n.video
														)
															? 'video'
												...
												c =
													(null === (r = null == d ? void 0 : d.bids) || void 0 === r
														? void 0
														: r.length) - 1;
											c >= 0;
											c--
					...
					(function (e, t) {
						var i,
							...
							r =
								null ===
									(n =
										null === (i = e[(t = t.toUpperCase())]) || void 0 === i ? void 0 : i.video) ||
								void 0 === n
									? void 0
									: n.amazon;
					...
					!(function () {
						if (!window.__tcfapi) {
							...
							(window.__tcfapi = function (i, n, r, a) {
								var o = '' + Math.random(),
									s = { __tcfapiCall: { command: i, parameter: a, version: n, callId: o } };
								...
								window.addEventListener(
									...
									function (e) {
										...
										n &&
											...
											(t[n.callId](n.returnValue, n.success), (t[n.callId] = null));
									},
									!1
								);
						}
					...
					!(function () {
						if (!window.__uspapi) {
							...
							(window.__uspapi = function (i, n, r) {
								var a = '' + Math.random(),
									o = { __uspapiCall: { command: i, version: n, callId: a } };
				...
				if (window.pbjs && window.pbjs.que && window.pbjs.getConfig) {
							...
							if (!(--m > 0))
								try {
									...
									if (s) {
											...
											var b = (function (e) {
												...
												return n
													? {
															bid: n,
															vast:
																'https://aax.amazon-adsystem.com/e/dtb/vast?b=' +
																_('amzniid', t) +
																'&rnd=' +
										...
										if ((!f || !f.videoCacheKey || f.cpm < L(a)) && (r || Math.random() > 0.5)) {
											var y = void 0;
											(y = (function (e) {
												return 'US' === e
													? 6.1
												...
												(f = { cpm: 2 * y, vast: G(), bidder: 'poki', videoCacheKey: 'poki' });
										}
										...
										switch (f.bidder) {
											...
											case 'rubicon':
												l =
													'https://prebid-server.rubiconproject.com/cache?uuid=' + f.videoCacheKey;
												break;
											case 'spotx':
									...
									if ((o.setDataAnnotations({ vhbOnlyMode: v, adTagUrl: l }), g.length > 0)) {
										f = g[0];
										o.setDataAnnotations({
											prebidBidder: null == f ? void 0 : f.bidder,
											prebidBid: null == f ? void 0 : f.cpm
										});
									} else o.setDataAnnotations({ prebidBidder: void 0, prebidBid: void 0 });
									e.requestAd(l);
								} catch (t) {
									e.requestAd(A);
								}
					...
					ee &&
						...
						window.apstag.fetchBids(
							{
								slots: [{ slotID: r ? 'Rewarded' : 'Midroll', mediaType: 'video' }],
			...
			var ae = (function () {
				function e(e, t) {
					void 0 === t && (t = {}),
						...
						(this.timing = t.timing || new u(l.adTiming)),
						d() && (this.totalRetries = 1),
						o.addEventListener(n.ads.video.error, this.moveThroughWaterfall.bind(this)),
						o.addEventListener(n.ads.video.loaderError, this.moveThroughWaterfall.bind(this)),
						o.addEventListener(n.ads.ready, this.timing.stopWaterfallTimer.bind(this.timing)),
						o.addEventListener(n.ads.started, this.stopWaterfall.bind(this));
				}
				return (
					(e.prototype.moveThroughWaterfall = function () {
						if (!1 !== this.running) {
							...
							(this.running = !1),
								...
								o.dispatchEvent(n.ads.error, { message: 'No ads' });
						}
					}),
					...
					(e.prototype.buildAdUnitPaths = function (e) {
						...
						return nt.GetIsPokiIFrame()
							...
							: [
									o + 'external_' + i + '_video_1/external_' + i + '_ingame_' + a + '_1',
									o + 'external_' + i + '_video_2/external_' + i + '_ingame_' + a + '_2'
							  ];
					}),
					...
					(e.prototype.requestAd = function () {
						...
						var e = (this.retries - 1) % this.adUnitPaths.length,
							...
							i =
								'https://securepubads.g.doubleclick.net/gampad/ads?sz=640x360|640x480&iu=' +
								t +
						...
						nt.consentString &&
							nt.consentString.length > 0 &&
							(this.criteria.consent_string = nt.consentString);
						var r =
							Math.max(document.documentElement.clientWidth || 0, window.innerWidth || 0) > 970;
						...
						var a,
							...
							A =
								(function (e) {
									...
									return (e = e.split('{descriptionUrl}').join(i))
										.split('{timestamp}')
						...
						nt.childDirected && (A += '&tfcd=1'),
							nt.nonPersonalized && (A += '&npa=1'),
							o.setDataAnnotations({ adUnitPath: t, adTagUrl: A, waterfall: this.retries }),
							o.dispatchEvent(n.ads.requested),
							d() || (1 === this.retries && !S() && !E())
								? (console.debug('adRequest started with Prebid Video enabled'),
								  re(this.ima, A, this.criteria, this.rewarded, this.country))
								: (console.debug('adRequest started in plain mode'), this.ima.requestAd(A));
					}),
			...
			const we = (function () {
				function e(e) {
					...
					if (
						...
						(this.progressFaker = new Ie(function (e) {
				...
				return (
					...
					(e.prototype.createElements = function () {
						if (
							...
							(this.containerDiv.className = se),
							(this.insideContainer.className = le),
							(this.pauseButton.className = pe),
							(this.pauseButtonBG.className = ue),
							this.pauseButton.appendChild(this.pauseButtonBG),
							(this.startAdButton.className = he),
							(this.startAdButton.innerHTML = 'Tap anywhere to play ad'),
							(this.progressBar.className = me),
							(this.progressContainer.className = ge),
							(this.spinnerContainer.className = ve),
							(this.adContainer.className = ye),
							(this.videoContainer.className = fe),
							this.hide(),
							...
							this.containerDiv.classList.add(de);
						else {
			...
			var Ie = (function () {
					function e(e) {
						...
						(this.storedQueue = []),
							...
							this.reset(),
							o.addEventListener(n.ads.video.progress, function (e) {
					...
					return (
						(e.prototype.queueFakeProgress = function (e, t, i) {
							var n = this;
							this.storedQueue.push({ progressToFake: e, duration: t, stopEvent: i }),
						...
						(e.prototype.fakeProgress = function (e, t, i) {
							this.activeQueue.push({ progressToFake: e, duration: t, stopEvent: i }),
								(this.fakeProgressEvents = !0),
								this.continue();
						}),
						(e.prototype.start = function () {
							this.activeQueue.length > 0 ||
								((this.activeQueue = ke([], this.storedQueue, !0)),
								(this.active = !0),
								this.continue());
						}),
						...
						(e.prototype.tick = function () {
							...
							(this.currentProgress = this.startProgress + e.progressToFake * i),
								this.fakeProgressEvents &&
									o.dispatchEvent(n.ads.video.progress, {
							...
							o.addEventListener(n.ads.started, function (t) {
								...
								o.addEventListener(n.ads.video.progress, function () {
									e.progressWatcherTimeout &&
										(clearTimeout(e.progressWatcherTimeout), (e.progressWatcherTimeout = 0));
								});
						}),
				...
				if (document.body && document.body.appendChild) {
					...
					if (
						...
						e.contentWindow &&
							...
							!window.location.hostname.endsWith('poki-gdn.com') && tt.gameId))
					) {
						var t = document.createElement('iframe');
						(t.style.display = 'none'),
							(t.src = 'https://' + tt.gameId + '.poki-gdn.com/poki-savegame-store.html'),
							(t.onload = function () {
								if (
									(setInterval(function () {
										...
										window.pokiKeysChanged.forEach(function (t, i) {
											...
											e.length > 0 &&
												(t.contentWindow &&
													t.contentWindow.postMessage({ type: 'store', data: e }, '*'),
				...
				return (
							...
							return Me(this, function (i) {
								switch (i.label) {
									...
									case 1:
										return (
											i.sent()
												? (t.setAdWillPlayMuted(!1), (this.currentRequestIsMuted = !1))
												: (t.setAdWillPlayMuted(!0), (this.currentRequestIsMuted = !0)),
					...
					(e.prototype.onAdsManagerLoaded = function (e) {
						...
						(t.enablePreloading = !0),
							...
							(t.mimeTypes =
								x() || S() || E() ? ['video/mp4'] : ['video/mp4', 'video/webm', 'video/ogg']),
							...
							this.allowedToPlayAd
								? (this.attachAdEvents(), o.dispatchEvent(n.ads.ready))
								: this.tearDown();
					}),
					...
					(e.prototype.onAdEvent = function (e) {
						...
						switch (e.type) {
								...
								(e.remainingTime = this.adsManager.getRemainingTime()),
									...
									i.isLinear() ||
										(this.bannerTimeout = window.setTimeout(function () {
											o.dispatchEvent(n.ads.completed, { rewardAllowed: !!e.rewardAllowed }),
												t.tearDown();
										}, 1e3 * (e.remainingTime + 1))),
									o.setDataAnnotations({ creativeId: i.getCreativeId() }),
									o.dispatchEvent(n.ads.started, { duration: i.getDuration() });
								break;
							case google.ima.AdEvent.Type.COMPLETE:
								o.dispatchEvent(n.ads.completed, { rewardAllowed: !0 }), this.tearDown();
								break;
							...
							case google.ima.AdEvent.Type.SKIPPED:
								o.dispatchEvent(n.ads.skipped),
									o.dispatchEvent(n.ads.completed, { rewardAllowed: !0 }),
					...
					(e.prototype.onAdLoaderError = function (e) {
						...
						o.dispatchEvent(n.ads.video.loaderError, { message: t });
					}),
					(e.prototype.onAdError = function (e) {
						this.tearDown();
						var t = (e.getError && e.getError().toString()) || 'Unknown';
						o.dispatchEvent(n.ads.video.error, { message: t });
					}),
				...
				return new Promise(function (t, i) {
					...
					var r = function () {
						(n.readyState && 'loaded' !== n.readyState && 'complete' !== n.readyState) ||
							(t(), (n.onload = null), (n.onreadystatechange = null));
					};
			...
			const Ke = function () {
				...
				} else for (i = 0; i < 12; i++) t += String.fromCharCode(Math.floor(256 * Math.random()));
			...
			var He = (function () {
				...
				return (
					...
					(e.prototype.validateDisplaySettings = function (e) {
						return (
							!!(S() || E() || ['970x250', '300x250', '728x90', '160x600', '320x50'].includes(e)) &&
							!((S() || E()) && !['320x50'].includes(e))
						);
					}),
							...
							r.debug ||
								(i = nt.GetIsPokiIFrame()
									...
									: '/21682198607/external_' +
									  ...
									  '_ingame_' +
									  e),
							{ id: 'poki-' + Ke(), adUnitPath: i, size: e, width: t[0], height: t[1], refresh: !1 }
						);
					}),
					(e.prototype.renderIGDAd = function (e, t, i, n, r) {
						...
						o &&
							this.slotMap.get(o) &&
							(console.error('displayAd called with a container that already contains an ad'),
							this.clearIGDAd(e));
									...
									t[0].isIntersecting &&
										...
										a.waitUntilReady(function () {
											...
											if (t && t.opportunityId === n) {
												...
												(r.id = s.id),
													(r.className = 'poki-ad-slot'),
													(r.style.width = s.width + 'px'),
													(r.style.height = s.height + 'px'),
													(r.style.position = 'relative'),
													(r.style.zIndex = '2'),
													r.setAttribute('data-poki-ad-size', s.size),
													e.appendChild(r),
													a.setupGPT(s, i),
													a.requestAd(s);
											}
					...
					(e.prototype.clearIGDAd = function (e) {
						var t,
							i = this.getIGDSlotID(e);
						if (i) {
							var r = this.slotMap.get(i) || null;
							if (r) {
								for (
									dt.track(n.tracking.screen.destroyAd, { opportunityId: r.opportunityId }),
										null === (t = r.intersectionObserver) || void 0 === t || t.disconnect(),
										r.gptSlot && googletag.destroySlots([r.gptSlot]);
									e.lastChild;
						...
						(t.prototype.bidsBackHandler = function (e) {
							...
							if (r) {
								...
								a.setAttribute('frameborder', '0'),
									...
									a.setAttribute('topmargin', '0'),
									a.setAttribute('leftmargin', '0'),
									a.setAttribute('allowtransparency', 'true'),
									a.setAttribute('width', '' + r.width),
									a.setAttribute('height', '' + r.height);
								var o = document.getElementById(r.id);
								if (o) {
									o.appendChild(a);
									var s =
										null === (t = null == a ? void 0 : a.contentWindow) || void 0 === t
											? void 0
											: t.document;
									if (!s)
										return (
											console.error('IGD error - iframe injection for ad failed', e),
											void this.clearIGDAd(o.parentNode)
										);
									if (
										((r.adserverTargeting = window.pbjs.getAdserverTargetingForAdUnitCode([
											r.adUnitPath
										])),
										!r.adserverTargeting.hb_adid)
									)
										return (
											console.error('IGD info - nothing to render', e, r.adserverTargeting),
											void this.clearIGDAd(o.parentNode)
										);
									var d = r.adserverTargeting.hb_bidder,
										A = parseFloat(r.adserverTargeting.hb_pb);
									isNaN(A) && (A = 0),
										window.pbjs.renderAd(s, r.adserverTargeting.hb_adid),
										dt.track(n.tracking.ads.display.impression, {
											size: r.size,
											opportunityId: r.opportunityId,
											duringGameplay:
												null === (i = r.duringGameplayFn) || void 0 === i ? void 0 : i.call(r),
										...
										(r.intersectionObserver = new IntersectionObserver(
											function (e) {
												e.forEach(function (e) {
													e.isIntersecting
														? r.intersectingTimer ||
														  (r.intersectingTimer = setTimeout(function () {
																var t, i;
																null === (t = r.intersectionObserver) ||
																	void 0 === t ||
																	t.unobserve(e.target),
																	dt.track(n.tracking.ads.display.viewable, {
																		size: r.size,
																		opportunityId: r.opportunityId,
																		duringGameplay:
																			null === (i = r.duringGameplayFn) || void 0 === i
																				? void 0
																				: i.call(r),
																		adUnitPath: r.adUnitPath
																	}),
														...
														: r.intersectingTimer &&
														  (clearTimeout(r.intersectingTimer), (r.intersectingTimer = void 0));
												});
											},
											{ threshold: 0.5 }
										)),
			...
			var $e = function () {
				...
				tt = { gameId: _('game_id'), versionId: _('game_version_id') },
				it = (function () {
					function e() {
						...
						'' !== t && (this.setDebug('true' === t), (this.debugIsOverwritten = !0)),
							'' !== _('pokiLogging') && this.setLogging(!0);
					}
					return (
							...
							if ((void 0 === e && (e = {}), 'undefined' != typeof window)) {
								...
								return (
									...
									this.isInitialized
										...
										: (this.initializingPromise || (this.initializingPromise = this.lazyLoadInit()),
						...
						(e.prototype.lazyLoadInit = function () {
							...
							(this.isBot = '1' === _('bot') || {}),
								...
								dt.setupDefaultEvents(),
								e.GetIsPokiIFrame() && _e(),
							...
							x &&
								void 0 !== C &&
								(k = function () {
									return Promise.resolve({ ISO: x, ccpaApplies: C });
								});
							var T = !1;
							x && ($(A, x), (T = !0)),
								...
								this.debugTouchOverlayController && (S() || E()) && Ze();
							var B = [y(), k()],
								P = et([], B, !0);
							...
							var D = function (e, i, a) {
								if (
									...
									[''].includes(tt.gameId) && (S() || E()) && Ze(),
										(b.adTiming = e.adTiming),
										(b.customCriteria = $e($e({}, b.customCriteria), { p4d_game_id: tt.gameId }));
								}
								Be(t.country) &&
									!r.debug &&
									(ie(),
							...
							return Promise.all(P)
								...
								.then(function (e) {
									if (void 0 !== e) {
										...
										te(p, t.country, s),
											(t.isInitialized = !0),
											t.isCCPA || s || o.dispatchEvent(n.ready),
											r.debug && o.dispatchEvent(n.ready);
									}
								});
						}),
						(e.prototype.requestAd = function (e) {
							...
							if (
								...
								this.forceDisableCommercialBreak &&
									[n.ads.position.midroll, n.ads.position.preroll].includes(p))
							)
								d && d();
								...
								if (!this.sdkBooted)
									return (
										o.dispatchEvent(n.ads.error, { message: 'Requesting ad on unbooted SDK' }),
								...
								} else o.dispatchEvent(n.ads.limit, { reason: n.info.messages.timeLimit });
							}
						}),
											...
											if (e)
												if (this.sdkImaError)
													...
													if (!this.IGD.validateDisplaySettings(t))
														return o.dispatchEvent(n.ads.error, {
						...
						(e.prototype.setDebug = function (e) {
							this.debugIsOverwritten
								? e && dt.track(n.tracking.debugTrueInProduction)
								: (r.debug = e);
						}),
								...
								switch (e.data.type) {
									case 'toggleNonPersonalized':
										this.toggleNonPersonalized(
											!(!e.data.content || !e.data.content.nonPersonalized)
										);
										break;
						...
						(e.prototype.startAd = function () {
							...
							this.sdkImaError ||
								(this.adReady
									...
									: o.dispatchEvent(n.ads.error, { message: 'No ads ready to start' }));
						}),
						...
						(e.prototype.skipAd = function () {
							this.stopAd(),
								this.callHandler('onFinish', { type: n.ads.completed, rewardAllowed: !0 });
						}),
						(e.prototype.muteAd = function () {
							if (!this.sdkBooted) return this.sdkNotBootedButCalled();
						...
						(e.prototype.setupDefaultEvents = function () {
							...
							o.addEventListener(n.ready, function () {
								...
								o.addEventListener(n.ads.started, function () {
									e.playerSkin.hideSpinner(), e.callHandler('onStart', { type: n.ads.limit });
								}),
								o.addEventListener(n.ads.video.paused, function () {
									e.playerSkin.showPauseButton();
								}),
								o.addEventListener(n.ads.limit, function () {
									e.callHandler('onFinish', { type: n.ads.limit, rewardAllowed: !1 });
								}),
								o.addEventListener(n.ads.stopped, function () {
									e.callHandler('onFinish', { type: n.ads.stopped, rewardAllowed: !1 });
								}),
								o.addEventListener(n.ads.error, function () {
									e.callHandler('onFinish', { type: n.ads.error, rewardAllowed: !1 });
								}),
								o.addEventListener(n.ads.busy, function () {
									e.callHandler('onFinish', { type: n.ads.busy, rewardAllowed: !1 });
								}),
								...
								[n.ads.limit, n.ads.stopped, n.ads.error, n.ads.busy, n.ads.completed].forEach(
									function (t) {
			...
			const rt = (function () {
				...
				return (
					(e.sendMessage = function (e, t) {
						...
						tt.gameId &&
							tt.versionId &&
							(a.pokifordevs = { game_id: tt.gameId, game_version_id: tt.versionId }),
							i.postMessage({ type: e, content: a }, '*');
					}),
					e
				);
			})();
			...
			const dt = (function () {
				...
				return (
					(e.track = function (e, t) {
						if ((void 0 === t && (t = {}), -1 === st.indexOf(e)))
							throw new TypeError("Invalid 'event', must be one of " + st.join(', '));
						...
						if (null == i ? void 0 : i.vhbOnlyMode)
							switch (e) {
								case n.tracking.ads.status.impression:
									z(ot({ event: 'video-impression', size: '640x360v' }, i));
									break;
								case n.tracking.ads.video.error:
									z(ot({ event: 'video-error', size: '640x360v' }, i));
									break;
								case n.tracking.ads.video.loaderError:
									z(ot({ event: 'video-adsloader-error', size: '640x360v' }, i));
									break;
								case n.tracking.ads.status.completed:
									z(ot({ event: 'video-complete', size: '640x360v' }, i));
							}
						if (r.debug || r.log) {
						...
						rt.sendMessage(n.message.event, { event: e, data: t });
					}),
					(e.setupDefaultEvents = function () {
						var t,
							i =
								(((t = {})[n.ready] = n.tracking.sdk.status.initialized),
								(t[n.adblocked] = console.log(n.tracking.sdk.status.failed)),
								(t[n.ads.busy] = n.tracking.ads.status.busy),
								(t[n.ads.completed] = n.tracking.ads.status.completed),
								(t[n.ads.error] = console.log(n.tracking.ads.status.error)),
								(t[n.ads.displayError] = console.log(n.tracking.ads.status.displayError)),
			...
			'undefined' != typeof window &&
				...
				(window.onunhandledrejection = function (e) {
					At(e.reason)
						? t().report(e.reason)
						: ut({ name: 'unhandledrejection', message: JSON.stringify(e.reason) });
				}));
			var ht = function () {
					return (
						(ht =
						...
						(this.gameStarted = !1),
								...
								return (
									...
									new Promise(function (i, r) {
										t.SDK.init(
											...
											rt.sendMessage(n.message.sdkDetails, { version: '2.234.2' });
									})
								);
							}),
							...
							(this.gameLoadingProgress = function (e) {
								...
								void 0 !== e.percentageDone && (t.percentageDone = Number(e.percentageDone)),
									...
									dt.track(n.tracking.screen.gameLoadingProgress, t);
							}),
							(this.gameLoadingStart = function () {
								...
								dt.track(n.tracking.screen.gameLoadingStarted, {
									now:
										Math.round(
											null ===
												(t = null === (e = window.performance) || void 0 === e ? void 0 : e.now) ||
												void 0 === t
												? void 0
												: t.call(e)
										) || void 0
							...
							(this.gameLoadingFinished = function () {
								...
								dt.track(n.tracking.screen.gameLoadingFinished, {
									...
									trackers: ((r = window),
									(a = []),
									'function' != typeof r.ga,
									r.mixpanel && 'function' == typeof r.mixpanel.track && a.push('mixpanel'),
									r.Countly && a.push('countly'),
									r.amplitude && a.push('amplitude'),
									a).join(','),
									now:
										Math.round(
											null ===
							...
							(this.gameplayStart = function (e) {
								t.gameplayStartCounter++,
									...
									t.gameStarted ||
										((t.gameStarted = !0),
										dt.track(n.tracking.screen.firstRound),
										t.SDK.startStartAdsAfterTimer()),
									dt.track(
										n.tracking.screen.gameplayStart,
										ht(ht({}, e), { playId: t.gameplayStartCounter })
									);
							}),
							...
							(this.gameplayStop = function (e) {
								t.gameplayStopCounter++,
									(t.duringGameplay = !1),
									dt.track(
										n.tracking.screen.gameplayStop,
										ht(ht({}, e), { playId: t.gameplayStartCounter, stopId: t.gameplayStopCounter })
									);
							}),
							(this.roundStart = function (e) {
								void 0 === e && (e = ''),
									(e = String(e)),
									dt.track(n.tracking.screen.roundStart, { identifier: e });
							}),
							(this.roundEnd = function (e) {
								void 0 === e && (e = ''),
									(e = String(e)),
									dt.track(n.tracking.screen.roundEnd, { identifier: e });
							}),
								...
								void 0 === r && (r = {}),
									e && i
										? ((e = String(e)),
										  (i = String(i)),
										  (r = ht({}, r)),
										  dt.track(n.tracking.custom, { eventNoun: e, eventVerb: i, eventData: r }))
							...
							(this.commercialBreak = function (e) {
								return new Promise(function (i) {
									...
									o.clearAnnotations(),
										o.setDataAnnotations({ opportunityId: Ke(), position: r }),
										dt.track(n.tracking.screen.commercialBreak),
										t.SDK.requestAd({ position: r, onFinish: i, onStart: e });
								});
							}),
							(this.rewardedBreak = function (e) {
								return new Promise(function (i) {
									...
									o.clearAnnotations(),
										o.setDataAnnotations({ opportunityId: Ke(), position: r }),
										dt.track(n.tracking.screen.rewardedBreak),
										t.SDK.requestAd({
											position: r,
											onFinish: function (e) {
							...
							(this.happyTime = function (e) {
								void 0 === e && (e = 1),
									((e = Number(e)) < 0 || e > 1) &&
										...
										t.warning(
											'happyTime',
											'Intensity should be a value between 0 and 1, adjusted to ' + e
										)),
									dt.track(n.tracking.screen.happyTime, { intensity: e });
							}),
							...
							(this.togglePlayerAdvertisingConsent = function (e) {
								dt.track(n.tracking.togglePlayerAdvertisingConsent, { didConsent: e }),
									t.SDK.togglePlayerAdvertisingConsent(e),
									rt.sendMessage(n.message.toggleProgrammaticAds, {
							...
							(this.logError = function (t) {
								At(t) ? e.report(t) : ut({ name: 'logError', message: JSON.stringify(t) });
							}),
