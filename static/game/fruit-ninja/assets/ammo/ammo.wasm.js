var Ammo = (function () {
	...
	return function (Ammo) {
		...
		var ta,
			ua = new WebAssembly.Table({ initial: 1832, maximum: 1832, element: 'anyfunc' }),
			wa = !1;
		function assert(a, c) {
		...
		if ((ta = g.wasmMemory ? g.wasmMemory : new WebAssembly.Memory({ initial: Ja / 65536 })))
			buffer = ta.buffer;
		...
		function $a() {
			return sa || (!da && !ea) || 'function' !== typeof fetch
		...
		g.asm = function () {
			function a(a) {
				...
				0 == Ta &&
					(null !== Ua && (clearInterval(Ua), (Ua = null)), Va && ((a = Va), (Va = null), a()));
			}
			function c(c) {
				a(c.instance);
			}
			...
			(function () {
				if (
					...
					return d(c);
				fetch(Xa, { credentials: 'same-origin' }).then(function (a) {
		...
		function zb(a, c, d, e) {
			...
			function r(a, c) {
				...
				var e;
				0 === (e = d(a.getFullYear() - c.getFullYear())) &&
					0 === (e = d(a.getMonth() - c.getMonth())) &&
					(e = d(a.getDate() - c.getDate()));
				return e;
			}
			function N(a) {
				switch (a.getDay()) {
			...
			function ba(a) {
				...
				return 0 >= r(N(new Date(a.getFullYear(), 0, 4)), a)
					? 0 >= r(c, a)
						? a.getFullYear() + 1
						: a.getFullYear()
					: a.getFullYear() - 1;
					...
					return 0 > r(d, a)
						? n(
								Math.ceil(
									(31 -
										d.getDate() +
										(vb(ub(a.getFullYear()) ? wb : xb, a.getMonth() - 1) - 31) +
										a.getDate()) /
										7
								),
								2
		...
		var ab = {
				...
				i: function (a) {
					...
					for (var c = Math.max(nb(), 16777216); c < a; )
						c = 536870912 >= c ? Da(2 * c) : Math.min(Da((3 * c + 2147483648) / 4), 2147418112);
					a: {
						try {
		...
		var Bb = (g.__ZSt18uncaught_exceptionv = function () {
			...
			Hb = (g._emscripten_bind_AllHitsRayResultCallback_get_m_collisionFilterGroup_0 = function () {
			...
			Rb = (g._emscripten_bind_AllHitsRayResultCallback_hasHit_0 = function () {
			...
			$b = (g._emscripten_bind_AllHitsRayResultCallback_set_m_rayFromWorld_1 = function () {
			...
			bc = (g._emscripten_bind_ClosestConvexResultCallback_ClosestConvexResultCallback_2 =
				function () {
			...
			dc = (g._emscripten_bind_ClosestConvexResultCallback_get_m_closestHitFraction_0 =
				function () {
					return g.asm.ca.apply(null, arguments);
				}),
			ec = (g._emscripten_bind_ClosestConvexResultCallback_get_m_collisionFilterGroup_0 =
				function () {
			...
			mc = (g._emscripten_bind_ClosestConvexResultCallback_set_m_closestHitFraction_1 =
				function () {
			...
			oc = (g._emscripten_bind_ClosestConvexResultCallback_set_m_collisionFilterMask_1 =
				function () {
			...
			wc = (g._emscripten_bind_ClosestRayResultCallback_get_m_collisionFilterGroup_0 = function () {
			...
			Gc = (g._emscripten_bind_ClosestRayResultCallback_set_m_collisionFilterGroup_1 = function () {
				return g.asm.Da.apply(null, arguments);
			}),
			...
			Nc = (g._emscripten_bind_ConcreteContactResultCallback_ConcreteContactResultCallback_0 =
				function () {
					return g.asm.Ka.apply(null, arguments);
				}),
			...
			Pc = (g._emscripten_bind_ConcreteContactResultCallback_addSingleResult_7 = function () {
				return g.asm.Ma.apply(null, arguments);
			}),
			...
			Uc = (g._emscripten_bind_ConvexHull_get_m_nPoints_0 = function () {
				return g.asm.Ra.apply(null, arguments);
			}),
			...
			Zc = (g._emscripten_bind_ConvexResultCallback_get_m_closestHitFraction_0 = function () {
				return g.asm.Wa.apply(null, arguments);
			}),
			...
			yd = (g._emscripten_bind_HACD_SetNVerticesPerCH_1 = function () {
			...
			Id = (g._emscripten_bind_LocalConvexResult_get_m_hitPointLocal_0 = function () {
				return g.asm.Eb.apply(null, arguments);
			}),
			...
			ze = (g._emscripten_bind_RayResultCallback_get_m_collisionFilterGroup_0 = function () {
			...
			Ee = (g._emscripten_bind_RayResultCallback_set_m_collisionFilterGroup_1 = function () {
			...
			Oe = (g._emscripten_bind_VHACD___destroy___0 = function () {
				return g.asm.Jc.apply(null, arguments);
			}),
			...
			Ue = (g._emscripten_bind_Vec3Real_Vec3Real_3 = function () {
				return g.asm.Pc.apply(null, arguments);
			}),
			...
			$e = (g._emscripten_bind_btActionInterface___destroy___0 = function () {
				return g.asm.Vc.apply(null, arguments);
			}),
			...
			ef = (g._emscripten_bind_btAxisSweep3_btAxisSweep3_4 = function () {
			...
			kf = (g._emscripten_bind_btBoxShape_getLocalScaling_0 = function () {
			...
			pf = (g._emscripten_bind_btBroadphaseInterface_getOverlappingPairCache_0 = function () {
			...
			yf = (g._emscripten_bind_btBvhTriangleMeshShape_calculateLocalInertia_2 = function () {
			...
			Df = (g._emscripten_bind_btCapsuleShapeX_calculateLocalInertia_2 = function () {
			...
			If = (g._emscripten_bind_btCapsuleShapeX_getUpAxis_0 = function () {
				return g.asm.Bd.apply(null, arguments);
			}),
			...
			Nf = (g._emscripten_bind_btCapsuleShapeZ_calculateLocalInertia_2 = function () {
				return g.asm.Gd.apply(null, arguments);
			}),
			...
			Sf = (g._emscripten_bind_btCapsuleShapeZ_getUpAxis_0 = function () {
				return g.asm.Ld.apply(null, arguments);
			}),
			...
			Xf = (g._emscripten_bind_btCapsuleShape_calculateLocalInertia_2 = function () {
				return g.asm.Qd.apply(null, arguments);
			}),
			...
			bg = (g._emscripten_bind_btCapsuleShape_getUpAxis_0 = function () {
				return g.asm.Vd.apply(null, arguments);
			}),
			...
			gg = (g._emscripten_bind_btCollisionDispatcher_btCollisionDispatcher_1 = function () {
			...
			ug = (g._emscripten_bind_btCollisionObject_getRestitution_0 = function () {
			...
			zg = (g._emscripten_bind_btCollisionObject_isActive_0 = function () {
			...
			Eg = (g._emscripten_bind_btCollisionObject_setAnisotropicFriction_2 = function () {
			...
			Jg = (g._emscripten_bind_btCollisionObject_setContactProcessingThreshold_1 = function () {
				return g.asm.Be.apply(null, arguments);
			}),
			...
			Sg = (g._emscripten_bind_btCollisionShape_getLocalScaling_0 = function () {
				return g.asm.Ke.apply(null, arguments);
			}),
			...
			Xg = (g._emscripten_bind_btCollisionWorld_addCollisionObject_1 = function () {
				return g.asm.Pe.apply(null, arguments);
			}),
			...
			bh = (g._emscripten_bind_btCollisionWorld_convexSweepTest_5 = function () {
				return g.asm.Ue.apply(null, arguments);
			}),
			...
			gh = (g._emscripten_bind_btCollisionWorld_getDispatchInfo_0 = function () {
				return g.asm.Ze.apply(null, arguments);
			}),
			...
			lh = (g._emscripten_bind_btCollisionWorld_setDebugDrawer_1 = function () {
			...
			qh = (g._emscripten_bind_btCompoundShape_btCompoundShape_0 = function () {
			...
			vh = (g._emscripten_bind_btCompoundShape_getMargin_0 = function () {
			...
			Ah = (g._emscripten_bind_btCompoundShape_setMargin_1 = function () {
			...
			Fh = (g._emscripten_bind_btConcaveShape_getLocalScaling_0 = function () {
			...
			Kh = (g._emscripten_bind_btConeShapeX_getLocalScaling_0 = function () {
				return g.asm.Cf.apply(null, arguments);
			}),
			...
			Ph = (g._emscripten_bind_btConeShapeZ_getLocalScaling_0 = function () {
				return g.asm.Hf.apply(null, arguments);
			}),
			...
			Uh = (g._emscripten_bind_btConeShape_getLocalScaling_0 = function () {
				return g.asm.Mf.apply(null, arguments);
			}),
			...
			Zh = (g._emscripten_bind_btConeTwistConstraint_enableFeedback_1 = function () {
				return g.asm.Rf.apply(null, arguments);
			}),
			...
			di = (g._emscripten_bind_btConeTwistConstraint_setBreakingImpulseThreshold_1 = function () {
				return g.asm.Wf.apply(null, arguments);
			}),
			...
			hi = (g._emscripten_bind_btConeTwistConstraint_setMaxMotorImpulse_1 = function () {
			...
			vi = (g._emscripten_bind_btConstraintSetting_set_m_tau_1 = function () {
			...
			Ci = (g._emscripten_bind_btContactSolverInfo_set_m_splitImpulsePenetrationThreshold_1 =
				function () {
			...
			Ei = (g._emscripten_bind_btConvexHullShape___destroy___0 = function () {
			...
			Ji = (g._emscripten_bind_btConvexHullShape_btConvexHullShape_2 = function () {
				return g.asm.Ag.apply(null, arguments);
			}),
			...
			Yi = (g._emscripten_bind_btConvexShape___destroy___0 = function () {
				return g.asm.Pg.apply(null, arguments);
			}),
			...
			cj = (g._emscripten_bind_btConvexShape_setMargin_1 = function () {
				return g.asm.Ug.apply(null, arguments);
			}),
			...
			lj = (g._emscripten_bind_btCylinderShapeX___destroy___0 = function () {
			...
			qj = (g._emscripten_bind_btCylinderShapeX_setLocalScaling_1 = function () {
			...
			vj = (g._emscripten_bind_btCylinderShapeZ_getLocalScaling_0 = function () {
			...
			Fj = (g._emscripten_bind_btCylinderShape_setMargin_1 = function () {
			...
			Nj =
				(g._emscripten_bind_btDefaultCollisionConstructionInfo_btDefaultCollisionConstructionInfo_0 =
					function () {
						return g.asm.Dh.apply(null, arguments);
					}),
			...
			Xj = (g._emscripten_bind_btDiscreteDynamicsWorld_addAction_1 = function () {
				return g.asm.Nh.apply(null, arguments);
			}),
			...
			gk = (g._emscripten_bind_btDiscreteDynamicsWorld_contactPairTest_3 = function () {
				return g.asm.Wh.apply(null, arguments);
			}),
			...
			pk = (g._emscripten_bind_btDiscreteDynamicsWorld_getGravity_0 = function () {
			...
			uk = (g._emscripten_bind_btDiscreteDynamicsWorld_removeCollisionObject_1 = function () {
			...
			Dk = (g._emscripten_bind_btDiscreteDynamicsWorld_stepSimulation_1 = function () {
			...
			Ik = (g._emscripten_bind_btDispatcherInfo_get_m_allowedCcdPenetration_0 = function () {
				return g.asm.wi.apply(null, arguments);
			}),
			Jk = (g._emscripten_bind_btDispatcherInfo_get_m_convexConservativeDistanceThreshold_0 =
				function () {
			...
			Uk = (g._emscripten_bind_btDispatcherInfo_set_m_convexConservativeDistanceThreshold_1 =
				function () {
					return g.asm.Ii.apply(null, arguments);
				}),
			...
			$k = (g._emscripten_bind_btDispatcherInfo_set_m_timeStep_1 = function () {
				return g.asm.Oi.apply(null, arguments);
			}),
			...
			el = (g._emscripten_bind_btDispatcher_getManifoldByIndexInternal_1 = function () {
				return g.asm.Ti.apply(null, arguments);
			}),
			...
			jl = (g._emscripten_bind_btDynamicsWorld_addCollisionObject_2 = function () {
				return g.asm.Yi.apply(null, arguments);
			}),
			...
			ol = (g._emscripten_bind_btDynamicsWorld_debugDrawObject_3 = function () {
			...
			tl = (g._emscripten_bind_btDynamicsWorld_getDispatcher_0 = function () {
			...
			yl = (g._emscripten_bind_btDynamicsWorld_removeCollisionObject_1 = function () {
			...
			Dl = (g._emscripten_bind_btEmptyShape_btEmptyShape_0 = function () {
			...
			Il = (g._emscripten_bind_btFaceArray_at_1 = function () {
			...
			Xl = (g._emscripten_bind_btGeneric6DofConstraint_btGeneric6DofConstraint_3 = function () {
				return g.asm.Kj.apply(null, arguments);
			}),
			...
			fm = (g._emscripten_bind_btGeneric6DofConstraint_setLinearLowerLimit_1 = function () {
				return g.asm.Tj.apply(null, arguments);
			}),
			...
			Cm = (g._emscripten_bind_btGhostObject___destroy___0 = function () {
			...
			Hm = (g._emscripten_bind_btGhostObject_getBroadphaseHandle_0 = function () {
			...
			Mm = (g._emscripten_bind_btGhostObject_getOverlappingObject_1 = function () {
			...
			Rm = (g._emscripten_bind_btGhostObject_getWorldTransform_0 = function () {
				return g.asm.Ck.apply(null, arguments);
			}),
			...
			Wm = (g._emscripten_bind_btGhostObject_setActivationState_1 = function () {
				return g.asm.Hk.apply(null, arguments);
			}),
			...
			an = (g._emscripten_bind_btGhostObject_setCollisionShape_1 = function () {
				return g.asm.Mk.apply(null, arguments);
			}),
			...
			fn = (g._emscripten_bind_btGhostObject_setUserIndex_1 = function () {
				return g.asm.Rk.apply(null, arguments);
			}),
			...
			ln = (g._emscripten_bind_btHeightfieldTerrainShape___destroy___0 = function () {
				return g.asm.Wk.apply(null, arguments);
			}),
			...
			zn = (g._emscripten_bind_btHingeConstraint_enableAngularMotor_3 = function () {
			...
			En = (g._emscripten_bind_btHingeConstraint_setAngularOnly_1 = function () {
			...
			Jn = (g._emscripten_bind_btHingeConstraint_setMotorTarget_2 = function () {
			...
			mo = (g._emscripten_bind_btKinematicCharacterController_setFallSpeed_1 = function () {
				return g.asm.Vl.apply(null, arguments);
			}),
			...
			uo = (g._emscripten_bind_btKinematicCharacterController_setVelocityForTimeInterval_2 =
				function () {
			...
			zo = (g._emscripten_bind_btManifoldPoint_getAppliedImpulse_0 = function () {
			...
			Eo = (g._emscripten_bind_btManifoldPoint_get_m_localPointB_0 = function () {
			...
			No = (g._emscripten_bind_btManifoldPoint_set_m_positionWorldOnB_1 = function () {
			...
			So = (g._emscripten_bind_btMatrix3x3_setEulerZYX_3 = function () {
			...
			bp = (g._emscripten_bind_btOverlappingPairCache_getNumOverlappingPairs_0 = function () {
				return g.asm.Jm.apply(null, arguments);
			}),
			...
			kp = (g._emscripten_bind_btPairCachingGhostObject_getBroadphaseHandle_0 = function () {
				return g.asm.Sm.apply(null, arguments);
			}),
			...
			tp = (g._emscripten_bind_btPairCachingGhostObject_getUserPointer_0 = function () {
				return g.asm.$m.apply(null, arguments);
			}),
			...
			Cp = (g._emscripten_bind_btPairCachingGhostObject_setCcdSweptSphereRadius_1 = function () {
			...
			Fp = (g._emscripten_bind_btPairCachingGhostObject_setContactProcessingThreshold_1 =
				function () {
			...
			Lp = (g._emscripten_bind_btPairCachingGhostObject_setWorldTransform_1 = function () {
			...
			Qp = (g._emscripten_bind_btPersistentManifold_getContactPoint_1 = function () {
			...
			Zp = (g._emscripten_bind_btPoint2PointConstraint_getPivotInB_0 = function () {
				return g.asm.Gn.apply(null, arguments);
			}),
			...
			iq = (g._emscripten_bind_btQuadWord_setY_1 = function () {
				return g.asm.Qn.apply(null, arguments);
			}),
			...
			oq = (g._emscripten_bind_btQuaternion___destroy___0 = function () {
				return g.asm.Wn.apply(null, arguments);
			}),
			...
			zq = (g._emscripten_bind_btQuaternion_normalize_0 = function () {
			...
			Kq = (g._emscripten_bind_btQuaternion_setX_1 = function () {
			...
			Sq = (g._emscripten_bind_btRigidBodyConstructionInfo_btRigidBodyConstructionInfo_3 =
				function () {
					return g.asm.zo.apply(null, arguments);
				}),
			Tq = (g._emscripten_bind_btRigidBodyConstructionInfo_btRigidBodyConstructionInfo_4 =
				function () {
					return g.asm.Ao.apply(null, arguments);
				}),
			...
			cr = (g._emscripten_bind_btRigidBodyConstructionInfo_get_m_linearSleepingThreshold_0 =
				function () {
					return g.asm.Ko.apply(null, arguments);
				}),
			...
			jr =
				(g._emscripten_bind_btRigidBodyConstructionInfo_set_m_additionalLinearDampingThresholdSqr_1 =
					function () {
						return g.asm.Ro.apply(null, arguments);
					}),
			...
			lr = (g._emscripten_bind_btRigidBodyConstructionInfo_set_m_angularSleepingThreshold_1 =
				function () {
					return g.asm.To.apply(null, arguments);
				}),
			...
			sr = (g._emscripten_bind_btRigidBody_activate_0 = function () {
			...
			Cr = (g._emscripten_bind_btRigidBody_applyTorque_1 = function () {
			...
			Hr = (g._emscripten_bind_btRigidBody_getAngularFactor_0 = function () {
			...
			Mr = (g._emscripten_bind_btRigidBody_getCollisionFlags_0 = function () {
			...
			ls = (g._emscripten_bind_btRigidBody_setCollisionFlags_1 = function () {
				return g.asm.Rp.apply(null, arguments);
			}),
			...
			rs = (g._emscripten_bind_btRigidBody_setFriction_1 = function () {
				return g.asm.Wp.apply(null, arguments);
			}),
			...
			xs = (g._emscripten_bind_btRigidBody_setMotionState_1 = function () {
				return g.asm.$p.apply(null, arguments);
			}),
			...
			Cs = (g._emscripten_bind_btRigidBody_setUserPointer_1 = function () {
			...
			Ms = (g._emscripten_bind_btShapeHull_btShapeHull_1 = function () {
			...
			Rs = (g._emscripten_bind_btSliderConstraint_btSliderConstraint_3 = function () {
			...
			Ws = (g._emscripten_bind_btSliderConstraint_setBreakingImpulseThreshold_1 = function () {
			...
			at = (g._emscripten_bind_btSliderConstraint_setUpperLinLimit_1 = function () {
				return g.asm.Dq.apply(null, arguments);
			}),
			...
			ft = (g._emscripten_bind_btSphereShape_getMargin_0 = function () {
				return g.asm.Iq.apply(null, arguments);
			}),
			...
			kt = (g._emscripten_bind_btStaticPlaneShape_calculateLocalInertia_2 = function () {
				return g.asm.Nq.apply(null, arguments);
			}),
			...
			pt = (g._emscripten_bind_btTransform___destroy___0 = function () {
				return g.asm.Sq.apply(null, arguments);
			}),
			...
			At = (g._emscripten_bind_btTransform_setRotation_1 = function () {
			...
			Tt = (g._emscripten_bind_btTypedConstraint_setBreakingImpulseThreshold_1 = function () {
			...
			du = (g._emscripten_bind_btVector3_normalize_0 = function () {
				return g.asm.Fr.apply(null, arguments);
			}),
			...
			uu = (g._emscripten_bind_btVector4_length_0 = function () {
				return g.asm.Wr.apply(null, arguments);
			}),
			...
			Fu = (g._emscripten_bind_btVector4_x_0 = function () {
				return g.asm.fs.apply(null, arguments);
			}),
			...
			Lu = (g._emscripten_enum_PHY_ScalarType_PHY_INTEGER = function () {
			...
			Qu = (g._emscripten_enum_btConstraintParams_BT_CONSTRAINT_STOP_CFM = function () {
		...
		b = {
			...
			Vs: function (a, c) {
				...
				a = (a + 7) & -8;
				b.Qs + a >= b.size
					? (assert(0 < a), (b.Ps += a), (c = g._malloc(a)), b.Ws.push(c))
					: ((c = b.buffer + b.Qs), (b.Qs += a));
				return c;
			},
			copy: function (a, c, d) {
		...
		Object.defineProperty(x.prototype, 'm_timeStep', { get: x.prototype.tu, set: x.prototype.Jv });
		...
		Object.defineProperty(x.prototype, 'm_stepCount', { get: x.prototype.qu, set: x.prototype.Gv });
		...
		Object.defineProperty(x.prototype, 'm_enableSPU', { get: x.prototype.Dt, set: x.prototype.Wu });
		...
		Object.defineProperty(x.prototype, 'm_useEpa', { get: x.prototype.yu, set: x.prototype.Nv });
		...
		Object.defineProperty(D.prototype, 'm_friction', { get: D.prototype.Gt, set: D.prototype.Zu });
		...
		xv.prototype.Compute = function (a, c, d, e, f, n, r) {
			...
			'object' == typeof e &&
				'object' === typeof e &&
				((ba = b.Vs(e, h)), b.copy(e, h, ba), (e = ba));
			f && 'object' === typeof f && (f = f.zs);
			n && 'object' === typeof n && (n = n.zs);
			r && 'object' === typeof r && (r = r.zs);
		...
		Object.defineProperty(H.prototype, 'm_tau', { get: H.prototype.ru, set: H.prototype.Hv });
		...
		Object.defineProperty(H.prototype, 'm_damping', { get: H.prototype.At, set: H.prototype.Tu });
		...
		Object.defineProperty(I.prototype, 'm_shapePart', { get: I.prototype.nu, set: I.prototype.Dv });
		...
		Object.defineProperty(K.prototype, 'm_concavity', { get: K.prototype.ut, set: K.prototype.Nu });
		...
		Object.defineProperty(K.prototype, 'm_alpha', { get: K.prototype.pt, set: K.prototype.Iu });
		...
		Object.defineProperty(K.prototype, 'm_beta', { get: K.prototype.st, set: K.prototype.Lu });
		...
		Object.defineProperty(K.prototype, 'm_gamma', { get: K.prototype.Ht, set: K.prototype.$u });
		...
		Object.defineProperty(K.prototype, 'm_depth', { get: K.prototype.Bt, set: K.prototype.Uu });
		...
		Object.defineProperty(K.prototype, 'm_pca', { get: K.prototype.du, set: K.prototype.uv });
		...
		Object.defineProperty(K.prototype, 'm_mode', { get: K.prototype.Xt, set: K.prototype.pv });
		...
		Object.defineProperty(O.prototype, 'm_vertices', { get: O.prototype.Au, set: O.prototype.Pv });
		...
		Object.defineProperty(O.prototype, 'm_faces', { get: O.prototype.Ft, set: O.prototype.Yu });
		...
		Object.defineProperty(W.prototype, 'm_setting', { get: W.prototype.mu, set: W.prototype.Cv });
		W.prototype.__destroy__ = function () {
			Sp(this.zs);
		};
		function v() {
		...
		Object.defineProperty(T.prototype, 'm_indices', { get: T.prototype.Pt, set: T.prototype.hv });
		...
		Object.defineProperty(T.prototype, 'm_plane', { get: T.prototype.eu, set: T.prototype.vv });
		T.prototype.__destroy__ = function () {
			Kl(this.zs);
		};
		function ew() {
		...
		Object.defineProperty(Y.prototype, 'm_points', { get: Y.prototype.gu });
		Y.prototype.get_m_triangles = Y.prototype.vu = function (a) {
			var c = this.zs;
			a && 'object' === typeof a && (a = a.zs);
			return Xc(c, a);
		};
		Object.defineProperty(Y.prototype, 'm_triangles', { get: Y.prototype.vu });
		Y.prototype.get_m_nPoints = Y.prototype.Yt = function () {
			return Uc(this.zs);
		};
		Object.defineProperty(Y.prototype, 'm_nPoints', { get: Y.prototype.Yt });
		Y.prototype.get_m_nTriangles = Y.prototype.Zt = function () {
			return Vc(this.zs);
		};
		Object.defineProperty(Y.prototype, 'm_nTriangles', { get: Y.prototype.Zt });
		Y.prototype.__destroy__ = function () {
			Tc(this.zs);
		};
