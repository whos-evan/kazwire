class Game {
    ...
    generateSticks() {
      ...
      for (let i = 0; i <= numberOfSticks; i++) {if (window.CP.shouldStopExecution(0)) break;
        new Stick();}window.CP.exitedLoop(0);
    }
    ...
    /**
       ...
       */
    showGrade(score) {
      if (score > 30) return "Godlike!";else
      if (score > 25) return "GG!";else
      if (score > 20) return "Epic!";else
