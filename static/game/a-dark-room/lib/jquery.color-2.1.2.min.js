						...
						c instanceof f
							...
							: l(g, function (b, d) {
									...
									l(d.props, function (a, b) {
										...
										i[e] &&
											a.inArray(null, i[e].slice(0, 3)) < 0 &&
											((i[e][3] = 1), d.from && (i._rgba = d.from(i[e])));
							  }),
						this
					);
			},
			...
			transition: function (a, b) {
				...
				return (
					...
					l(e.props, function (a, d) {
						...
						f === null
							? (k[e] = g)
							: (i.mod && (g - f > i.mod / 2 ? (f += i.mod) : f - g > i.mod / 2 && (f -= i.mod)),
							  (k[e] = m((g - f) * b + f, d)));
					}),
					this[d](k)
				);
			...
			toHslaString: function () {
				var b = 'hsla(',
					c = a.map(this.hsla(), function (a, b) {
						return (
							a == null && (a = b > 2 ? 1 : 0), b && b < 3 && (a = Math.round(a * 100) + '%'), a
						);
					});
						...
						return g === 'undefined'
							...
							: (g === 'function' && ((f = f.call(this, j)), (g = a.type(f))),
							  f == null && e.empty
									? this
									: (g === 'string' &&
											((k = d.exec(f)), k && (f = j + parseFloat(k[2]) * (k[1] === '+' ? 1 : -1))),
									  (i[e.idx] = f),
									  this[h](i)));
					};
				});
