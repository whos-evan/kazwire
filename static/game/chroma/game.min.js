...
(e = function () {
	var t = function () {
		...
		if (self.performance && self.performance.memory) var d = e(new t.Panel('MB', '#f08', '#201'));
		return (
			i(0),
			{
				REVISION: 16,
				...
				begin: function () {
					...
					if (
						(l.update(t - o, 200),
						t > r + 1e3 && (h.update((1e3 * a) / (t - r), 100), (r = t), (a = 0), d))
					) {
	...
	return (
		(t.Panel = function (t, e, i) {
			...
			(y.width = a), (y.height = h), (y.style.cssText = 'width:80px;height:48px');
	...
	(function () {
		...
		Object.getOwnPropertyNames(d).forEach((t) => (e[t] = e[t] || d[t])),
			...
			(dither = [
				65535, 65527, 65015, 65013, 62965, 62901, 58805, 58789, 42405, 42401, 42145, 42144, 41120,
				40992, 32800, 32768, 0
			]),
			(pat = 65535),
			(palDefault = [
		...
		var p = document.getElementById('canvas'),
			f = (document.createElement('canvas').getContext('2d'), p.getContext('2d')),
			y = 0,
			w = r,
			g = [
				4278715910, 4279439380, 4280620859, 4281145203, 4280950964, 4280499935, 4278872826,
				4280001529, 4282504703, 4282449151, 4284805846, 4282637212, 4281712985, 4281245716,
				4282284570, 4282077732, 4280295442, 4284757012, 4291058728, 4292779812, 4291286560,
				4292607142, 4294967295, 4290835454, 4290303738, 4288127221, 4285754088, 4288367292,
				4286593657, 4283642688, 4281606692, 4279901218, 4280822578, 4282073457, 4282873275,
				4284720347, 4288467700, 4293583066, 4291934643, 4289696651, 4287460717, 4284634186,
				4282464563, 4281541698, 4281872731, 4283585166, 4285167034, 4288919017, 4294960867,
				4294688697, 4293172100, 4290678104, 4286938439, 4283328291, 4284777522, 4287475549,
				4290436242, 4293064653, 4289385188, 4287344839, 4284647072, 4283787129, 4282666586,
				4281612610, 4278190080
			];
		(pal = [
		...
		function X(t, e, i, s, n = cursorColor, o = cursorColor2) {
			...
			else for (d = l - (h >> 1); e != s; ) 0 > d || ((t += r), (d -= h)), (d += l), S(t, (e += a));
		}
		function R(t, e, i = 5, s = cursorColor, n = cursorColor2) {
			if (((cursorColor2 = n), (cursorColor = s), (t |= 0), (e |= 0), (s |= 0), (i |= 0) >= 0)) {
				(t |= 0), (e |= 0), (s |= 0);
				var o = -(i |= 0),
					r = 0,
					a = 2 - 2 * i;
		...
		function M(t = cursorX, e = cursorY, i, s, n = cursorColor, o = cursorColor2) {
			...
			for (; d > e - h; ) S(t - 1, e), S(a + 1, e++), S(t - 1, h), S(a + 1, h--);
		}
		...
		function A(t, e, i = 16, s = 16, n = cursorColor, o = cursorColor2) {
			(cursorColor2 = o), (cursorColor = n), (x1 = 0 | t), (y1 = 0 | e), (i |= 0), (n |= 0);
			var r = (s |= 0) - y1;
			if ((X(x1, y1, i, y1, n), r > 0)) for (; --r; ) X(x1, y1 + r, i, y1 + r, n);
			else if (0 > r) for (; ++r; ) X(x1, y1 + r, i, y1 + r, n);
			X(x1, s, i, s, n);
		}
		function P(t = 0, e = 0, n = i, o = s, r = 0, a = 0, h = !1, l = !1, d = pal) {
			...
			for (var c = 0; o > c; c++)
				for (var u = 0; n > u; u++)
					s > a + c &&
						...
						(h & l
							? 0 > C[w + ((e + (o - c)) * i + t + (n - u))] ||
							  (C[y + ((a + c) * i + r + u)] = d[C[w + ((e + (o - c - 1)) * i + t + (n - u - 1))]])
							: l && !h
							? 0 > C[w + ((e + (o - c)) * i + t + u)] ||
							  (C[y + ((a + c) * i + r + u)] = d[C[w + ((e + (o - c - 1)) * i + t + u)]])
							: h && !l
							? 0 > C[w + ((e + c) * i + t + (n - u - 1))] ||
							  (C[y + ((a + c) * i + r + u)] = d[C[w + ((e + c) * i + t + (n - u - 1))]])
							: h ||
							  l ||
							  0 > C[w + ((e + c) * i + t + u)] ||
							  (C[y + ((a + c) * i + r + u)] = d[C[w + ((e + c) * i + t + u)]]));
		}
		function L(e) {
			e[7] || (e[7] = 1), e[8] || (e[8] = 1);
						...
						if (1 == n[5 * o + r])
							if (1 == e[4])
								S(
									...
									(e[2] + (e[6] ? Math.sin((1 * (t + s * e[8])) / e[7]) * e[6] : 0) + o * e[4]) | 0
								);
							else {
								let i = e[1] + r * e[4] + (5 * e[4] + e[3]) * s,
									n =
										(e[2] + (e[6] ? Math.sin((1 * (t + s * e[8])) / e[7]) * e[6] : 0) + o * e[4]) |
										0;
		...
		function O(t) {
			...
			for (var u = h + r / 2, p = l + a / 2, f = 0; n > f; f++) {
				var y = i[f],
					...
					g = t[1],
					x = t[2] + (e + t[4]) * f;
				'center' == t[5] ? (g = t[1] - w / 2) : 'right' == t[5] && (g = t[1] - w),
		...
		function K(t = Date.now(), e = 1664525, i = 1013904223, s = Math.pow(2, 32)) {
		...
		(audioCtx = new AudioContext()),
			...
			(K.prototype.nextColor = function () {
				for (
					var t = this.nextIntRange(0, Math.pow(2, 24)).toString(16).toUpperCase();
					6 > t.length;
		...
		var T = function () {
				var t,
					...
					a = function (t, e, i) {
						...
						for (s = 0, n = 0; m + v + b > s; s++, n++)
							0 > n ||
								((n -= I),
								(d = r(e + (15 & (E = (E >> 8) | ((255 & E) << 4))) + t.i[2] - 128)),
				...
				(this.init = function (o) {
					...
					(this.generate = function () {
						...
						for (d = 0; e >= d; ++d)
							for (f = E.p[d], c = 0; D > c; ++c) {
								...
								M && ((E.i[M - 1] = E.c[f - 1].f[c + D] || 0), 16 > M && (R = []));
								var G = h[E.i[15]],
									A = E.i[16] / 512,
								...
								for (x = (d * D + c) * I, u = 0; 4 > u; ++u)
									if ((p = f ? E.c[f - 1].n[c + u * D] : 0)) {
										R[p] || (R[p] = a(E, p, I));
										var B = R[p];
										for (l = 0, r = 2 * x; l < B.length; l++, r += 2) C[r] += B[l];
									}
								for (l = 0; I > l; l++)
									(g = C[(y = 2 * (x + l))]) || X
										? ((m = k),
										  L && (m *= G(P * y) * A + 0.5),
										  (Y += (m = 1.5 * Math.sin(m)) * (v = K * (g - Y) - (S += m * Y))),
										  (g = 3 == O ? Y : 1 == O ? v : S),
										  T && ((g = 1 > (g *= T) ? (g > -1 ? o(0.25 * g) : -1) : 1), (g /= T)),
										  (X = (g *= H) * g > 1e-5),
					...
					(this.getData = function (t, e) {
						for (var i = 2 * Math.floor(44100 * t), s = new Array(e), o = 0; 2 * e > o; o += 1) {
							var r = i + o;
			...
			H = {
				songData: [
					{
						i: [
							3, 138, 116, 0, 0, 138, 128, 4, 0, 0, 47, 48, 166, 124, 3, 0, 139, 4, 1, 3, 64, 160,
							3, 32, 147, 4, 121, 5
						],
						p: [1, 1, 4, 2, 3],
						c: [
			...
			N = {
				songData: [
					{
						i: [
							1, 100, 128, 1, 3, 201, 128, 0, 1, 55, 0, 6, 36, 40, 1, 0, 195, 6, 1, 2, 135, 44, 40,
							32, 125, 6, 0, 6
						],
						p: [1],
						c: [{ n: [140], f: [] }]
			...
			F = {
				songData: [
					{
						i: [
							1, 100, 128, 1, 2, 201, 128, 0, 1, 75, 0, 6, 93, 40, 1, 0, 195, 6, 0, 2, 60, 0, 1, 15,
							125, 4, 0, 0
						],
						p: [1],
						c: [{ n: [123], f: [] }]
			...
			j = {
				songData: [
					{
						i: [
							0, 147, 128, 0, 0, 127, 116, 1, 0, 0, 0, 22, 34, 0, 0, 0, 41, 1, 1, 1, 23, 167, 0, 32,
							77, 6, 25, 6
						],
						p: [1, 1, 2],
						c: [
					...
					{
						i: [
							2, 45, 128, 0, 2, 41, 140, 18, 0, 0, 0, 29, 9, 0, 0, 0, 0, 0, 0, 2, 5, 0, 0, 32, 0, 0,
							24, 8
						],
						p: [1, 1, 2],
						c: [
							{
								n: [
									116, 113, 116, 113, 116, 113, 116, 113, 116, 113, 116, 113, 116, 113, 116, 113,
									113, 109, 113, 109, 113, 109, 113, 109, 113, 109, 113, 109, 113, 109, 113, 109
								],
								f: []
							},
							{
								n: [
									109, 106, 109, 106, 109, 106, 109, 106, 109, 106, 109, 106, 109, 106, 109, 106,
									112, 108, 112, 108, 112, 108, 112, 108, 112, 108, 112, 108, 112, 108, 112, 108
								],
								f: []
							}
						]
			...
			z = {
				songData: [
					{
						i: [
							2, 100, 128, 0, 3, 201, 128, 0, 0, 0, 5, 6, 58, 0, 0, 0, 195, 6, 1, 2, 135, 0, 0, 32,
							147, 6, 40, 3
						],
						p: [1],
						c: [{ n: [147, 154], f: [] }]
			...
			B = {
				songData: [
					{
						i: [
							2, 138, 116, 0, 2, 138, 128, 4, 0, 0, 1, 29, 52, 124, 3, 0, 139, 4, 1, 3, 64, 160, 3,
							32, 147, 4, 57, 5
						],
						p: [1],
						c: [
			...
			U = {
				songData: [
					{
						i: [
							3, 51, 128, 1, 2, 80, 128, 4, 1, 0, 45, 0, 0, 0, 0, 0, 195, 6, 1, 2, 135, 0, 0, 32,
							147, 6, 48, 1
						],
						p: [1],
						c: [{ n: [156], f: [] }]
			...
			W = {
				songData: [
					{
						i: [
							0, 56, 128, 0, 3, 134, 128, 0, 0, 0, 5, 6, 58, 0, 0, 0, 195, 6, 1, 2, 135, 0, 0, 32,
							147, 6, 121, 6
						],
						...
						c: [
							{
								n: [
									135, 142, 140, 142, 145, 142, 140, 142, 135, 142, 140, 142, 145, 142, 140, 142,
									135, 142, 140, 142, 145, 142, 140, 142, 135, 142, 140, 142, 145, 142, 140, 142
								],
								f: []
							}
					...
					{
						i: [
							0, 61, 128, 0, 3, 131, 128, 0, 0, 0, 0, 45, 29, 0, 0, 0, 195, 4, 1, 3, 50, 184, 119,
							244, 147, 6, 17, 3
						],
		...
		function _(e, i, s, n = 8, o = 0) {
			(this.colors = [58, 59, 38, 39]),
				...
				(this.draw = function () {
					...
					if (E(e, i, 24)) {
						(pat = dither[8]),
							...
							(function (t = cursorX, e = cursorY, i, s, n = cursorColor, o = cursorColor2) {
								(cursorColor2 = o), (cursorColor = n);
								let r,
									a = ((t |= 0) + i) | 0,
									h = ((e |= 0) + s) | 0,
						...
						D(22, 22),
							t % 40 > this.blinkTimer &&
								(M(e + n, i + n, n, n, 22, 22), M(e + 3 * n, i + n, n, n, 22, 22)),
							this.biting,
							this.health < this.startHealth && (D(12, 12), G(e, i - 3, e + this.health, i - 2)),
				...
				(this.update = function () {
					...
					let s = 10 > t % 30;
					if (E(e, i, 24)) {
						(this.x += random() > 0.5 ? s : -s), (this.y += random() > 0.5 ? s : -s);
						...
						100 > i &&
							...
							this.hit && ((this.health -= 3), (score += 5 * multiplier), (this.hit = !1)),
				...
				(this.kill = function () {
					...
					let s = random(),
						...
						r = random();
					for (let t = 0; 40 > t; t++)
						particles.push(new q(this.x, this.y, 7, 3 * random() - 1.5, 3 * random() - 1.5));
					for (let t = 0; 50 > t; t++)
						particles.push(new q(this.x, this.y, 19, cos(360 / t) * s, sin(360 / t) * (1 + n), 15));
					for (let t = 0; 50 > t; t++)
						particles.push(new q(this.x, this.y, 19, cos(360 / t) * (1 + o), sin(360 / t) * r, 15));
		...
		function V(t, e, i, s, n, o = 15, r = 0) {
			(this.x = t),
				...
				(this.kill = function () {
					...
					R(t + this.width / 2, e + this.width / 2, 2 * this.width, 22, 22);
					for (let t = 0; 20 > t; t++)
						particles.push(new q(this.x, this.y, 22, random() - 0.5, 0.5 * random(), 20));
			...
			(this.x = t),
				...
				(this.update = function () {
					if (E(this.x - viewX, this.y - viewY)) {
						rectCollision(this, player) && (this.kill(), player.batteries++, multiplier++);
						for (let t = 0; 3 > t; t++)
							particles.push(
								new q(
									(this.x + 4 * random()) | 0,
				...
				(this.draw = function () {
					let t = this.x - viewX,
						e = this.y - viewY;
					E(t, e) && (D((63 * random()) | 0, (63 * random()) | 0), R(t + 2, e + 2, 2));
				}),
				(this.kill = function () {
					for (let t = 0; 40 > t; t++)
						particles.push(new q(this.x, this.y, 22, 3 * random() - 1.5, 3 * random() - 1.5));
					for (let t = 0; 50 > t; t++)
						particles.push(new q(this.x, this.y, 12, 3 * cos(360 / t), 3 * sin(360 / t), 20));
					k(sounds.batteryPickup, 1, 0, 0.6, 0), batteries.splice(batteries.indexOf(this), 1);
				});
		}
		player = {
			x: 3840,
			...
			fire: function (e) {
				...
				switch (o) {
					...
					case 2:
						1 > t % 14 &&
							(bullets.push(new V(this.x + 3, this.y + 5, 11, i + u(0.1), s + c(0.1))),
							bullets.push(new V(this.x + 3, this.y + 5, 11, i, s)),
							bullets.push(new V(this.x + 3, this.y + 5, 11, i - u(0.2), s - c(0.2))),
							bullets.push(new V(this.x + 3, this.y + 5, 11, i - u(0.3), s - c(0.3))),
							bullets.push(new V(this.x + 3, this.y + 5, 11, i - u(0.4), s - c(0.4))),
							bullets.push(new V(this.x + 3, this.y + 5, 11, i - u(0.5), s - c(0.5))),
							k(sounds.sndGun, 1, 0, 0.5, 0));
						break;
					case 3:
						1 > t % 2 &&
							(bullets.push(new V(this.x + 3, this.y + 5, 20, i * cos(t), s * sin(t), 90)),
							k(sounds.sndGun, 1, 0, 0.5, 0));
						break;
					case 4:
						1 > t % 2 &&
			...
			mouseFire: function () {
				if (1 > t % 5) {
					let t = this.x - viewX,
						...
						o = (i / n) * 6,
						r = (s / n) * 6;
					bullets.push(new V(this.x + 3, this.y + 5, 9, o, r)), k(sounds.sndGun, 0.7, 0, 0.3, 0);
				}
			},
			update: function () {
				(this.color = 22),
					...
					viewY,
					(this.xm = 1),
					this.hit && ((player.health -= 0.3), (this.hit = !1), (this.color = 6), (multiplier = 1)),
					0 > player.health && (this.kill(), (state = 'gameover')),
					Key.isDown(Key.d) || Key.isDown(Key.RIGHT)
						? ((this.x += this.vx), this.steps++)
						: (Key.isDown(Key.a) || Key.isDown(Key.LEFT) || Key.isDown(Key.q)) &&
						  ((this.x -= this.vx), this.steps++),
					Key.isDown(Key.w) || Key.isDown(Key.UP) || Key.isDown(Key.z)
						? ((this.y -= this.vy), this.steps++)
						: (Key.isDown(Key.s) || Key.isDown(Key.DOWN)) && ((this.y += this.vy), this.steps++),
					gp &&
						(abs(gp.axes[0]) > 0.1 && ((this.x += this.vx * gp.axes[0]), this.steps++),
						abs(gp.axes[1]) > 0.1 && ((this.y += this.vy * gp.axes[1]), this.steps++),
							...
							(foundSwitch.state > 3 ||
								(player.batteries > 0 &&
									(3 == foundSwitch.state &&
										...
										(player.health += 2),
										(y = h),
										R(player.x / J, player.y / J, 4, foundSwitch.color, foundSwitch.color),
										(y = o)),
			...
			kill: function () {
				(counts.enemiesKilled = counts.totalEnemies - enemies.length),
					(counts.switchesActivated = switches.filter((t) => 4 == t.state).length),
		...
		(score = 0),
			...
			(init = () => {
				window.addEventListener(
					...
					window.addEventListener('gamepadconnected', function (t) {
						t.gamepad.index, t.gamepad.id, t.gamepad.buttons.length, t.gamepad.axes.length;
					}),
			...
			(drawMap = (t) => {
				rooms.push({ x: 156, y: 96, width: 10, height: 10 }), (y = l), A(0, 0, 320, 200, 1, 1);
				for (let t = 0; 1e5 > t; t++)
					(roomCandidate = {
			...
			(drawCorridor = (t) => {
				...
				for (let s = 0; t > s; s++) {
					for (
						let t = 0;
						5e4 > t && 1 != Y((e = lcg.nextIntRange(0, 320)), (i = lcg.nextIntRange(0, 200)), l);
						t++
					);
					(y = l), D(0, 0), S(e, i);
					for (let t = 0; 100 > t; t++) {
			...
			(createSwitches = (t) => {
				rooms.forEach((t) => {
					[
						...
						{ x: lcg.nextIntRange(t.x, t.x + t.width), y: lcg.nextIntRange(t.y, t.x + t.height) },
						{ x: lcg.nextIntRange(t.x, t.x + t.width), y: lcg.nextIntRange(t.y, t.x + t.height) },
						{ x: lcg.nextIntRange(t.x, t.x + t.width), y: lcg.nextIntRange(t.y, t.x + t.height) }
					].forEach((t) => {
						(y = l),
					...
					if (E(i, e, J))
						switch (((y = o), t.state)) {
							...
							case 3:
								(pat = dither[8]),
									(e = t.y * Q - viewY),
									A(4 + (i = t.x * J - viewX), e + 4, i + J - 4, e + Q - 4, t.color, 22),
							...
							default:
								(pat = dither[8]),
									(e = t.y * Q - viewY),
									A(4 + (i = t.x * J - viewX), e + 4, i + J - 4, e + Q - 4, t.color, 0);
						}
				});
			}),
			...
			(states.menu = {
				...
				step: function (t) {
					for (let t = 0; 10 > t; t++)
						particles.push(new q(100 - viewX, 100 - viewY, 22, 3 * random(), 3 * random()));
					(this.ready = soundsReady == sndData.length),
						!this.musicPlaying &&
							this.ready &&
							((titleMusic = k(sounds.titleSong, 1, 0, 0.4, !0)), (this.musicPlaying = !0)),
						this.ready &&
							(Key.justReleased(Key.SPACE) || Key.justReleased(Key.w) || mouse.pressed
								? ((state = 'game'),
				...
				draw: function (t) {
					(y = o), I(0), (w = l), (mapPal = [1, 31]), P(0, 0, i, s, 0, 0, 0, 0, mapPal);
					...
					(pat = dither[8]),
						...
						D(22, 22),
						O([
							this.ready ? 'PRESS OR CLICK TO PLAY' : 'ASSETS OFFLINE. LOADING...',
							i / 2,
							191,
							1,
							9,
			...
			(states.game = {
				...
				draw: function (t) {
							...
							switch (n) {
								case 1:
									...
									(pat = dither[C[a + 320 * e + t]]),
										...
										0 == getGID(t * J, (e - 1) * Q) && X(i, s, i + J, s, o[0], o[0]),
										0 == getGID((t + 1) * J, e * Q) &&
											(0 == getGID(t * J, (e + 1) * Q)
										...
										0 == getGID((t - 1) * J, e * Q) &&
											(0 == getGID(t * J, (e + 1) * Q)
												? (X(i, s, i, s + r, o[0], o[0]), X(i, s + r, i, s + Q - 1, 1, 1))
					...
					drawSwitches(),
						...
						player.draw(),
						D(22, 22),
						O(['HEALTH', 5, 5, 1, 1, 'left', 'top', 1, 22, player.hit ? 2 : 0, 4]),
						(pat = dither[8]),
						...
						(function (t = cursorX, e = cursorY, i = 5, s = cursorColor, n = cursorColor2) {
							(cursorColor2 = n), (cursorColor = s), (t |= 0), (e |= 0), (s |= 0);
							var o = -(i |= 0),
								r = 0,
								a = 2 - 2 * i;
							do {
			...
			(states.gameover = {
				...
				draw: function (t) {
					(y = o),
						...
						D(22, 22),
						O(['PRESS SPACE TO PLAY AGAIN', i / 2, 175, 2, 9, 'center', 'top', 1, 7, 0]);
				}
			}),
			window.init();
	})();
