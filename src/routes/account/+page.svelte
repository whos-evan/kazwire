...
<div class="text-white h-[80vh] w-full text-center">
	...
	<p class="text-lg mb-5">The login system is still being worked on. Login with Google now to get access to more features in the future! <br> 
		As of now, account holders can save games to their account to access their favorite games anytime and anywhere.</p>
	{#if loggedIn}
