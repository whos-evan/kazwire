...
<div id="home" class="h-full w-full pl-10 pt-10 pr-10 text-white">
	...
	<p>
		...
		recorded by Kazwire and how we use it.
	</p>
	<br />
	<p>
	...
	<p>
		...
		website with regards to the information that they shared and/or collect in Kazwire. This policy
	...
	<br />
	<p>
		Kazwire follows a standard procedure of using log files. These files log visitors when they
	...
	<br />
	<p>
		Like any other website, Kazwire uses 'cookies'. These cookies are used to store information
	...
	<p>
		...
		that are used in their respective advertisements and links that appear on Kazwire, which are
	...
	<br />
	<p>
		Note that Kazwire has no access to or control over these cookies that are used by third-party
		advertisers.
	</p>
	<br />
	...
	<br />
	<p>
		Kazwire's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising
	...
	<br />
	<p>
		Kazwire does not knowingly collect any Personal Identifiable Information from children under the
